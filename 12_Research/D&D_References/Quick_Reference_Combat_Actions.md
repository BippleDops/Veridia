...
Depth 500+ fathoms:     -2 to Dex saves, disadvantage on ranged attacks

UNDERWATER COMBAT:

• Melee weapons: Normal damage
...
Altitude 8,000+ ft:     -2 to Con saves, exhaustion risk

AIRBORNE COMBAT:

• Ranged attacks: Advantage if above target
...
😴 PARALYZED     • Incapacitated and can't move/speak
...
• Healing Word (bonus action, ranged)
...
• More than half the party is unconscious
