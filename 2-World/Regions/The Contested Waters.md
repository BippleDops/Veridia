...
cssclasses: 
  ...
  - wide-page
status: active
region_type: Maritime Territory
political_control: Disputed (Multiple Claims)
primary_conflict: Trade Route Control
danger_level: High
notable_features:
...
# Political Claims
territorial_claimants:
  - "Shadowhaven Merchant Marine"
  - "Bexley Commercial Fleet" 
  - "Port Sorrow Trading Company"
  - "The Crimson Tide Pirates"
  - "Ancient Mer-Folk Empire" (historical claim)
# Geography
coordinates: "45 nautical miles southwest of Shadowhaven"
area_size: "300 square nautical miles"
depth_range: "50-800 fathoms"
key_landmarks:
...
environmental_hazards:
  ...
  - Sea monster territories
  - Magical anomalies
# Meta
created: 2025-01-25 16:00
modified: 2025-01-25 16:00
ai_generated: false
---
...
## Quick Actions
`BUTTON[addIncident]` ⚠️ Report Incident | `BUTTON[updateClaims]` 🏛️ Update Political Claims | `BUTTON[trackShipping]` 🚢 Track Vessel Movement | `BUTTON[recordEncounter]` 👹 Log Sea Encounter
...
dv.paragraph(`**⚓ Contested Waters Activity Summary**`);
...
dv.paragraph("**🚢 Current Shipping Conditions**");
...
### Connected Quests
- **[[The Vanishing Merchant Vessels]]** - Ships disappearing in these waters
...
- **[[Bloodwater Shoals]]** - Dangerous reef system
- **[[Shadowhaven]]** - Primary staging port
