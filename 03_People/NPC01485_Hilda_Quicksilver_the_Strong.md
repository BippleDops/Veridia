...
- **Quirks**: Always rhymes when speaking, Writes everything down, Collects buttons
- **Fear**: Fire
...
### Alaric Thornweave the Strong (Personal - Ex-lover)
...
- Action Surge: Extra action once per combat
- Action Surge: Extra action once per combat
- Spellcasting: 6 spell slots, knows Lightning Bolt, Scorching Ray, Fireball, Misty Step, Invisibility, Charm Person, Sleep, Fly
