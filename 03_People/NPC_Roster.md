...
- **Mannerisms**: *[Distinctive habits or behaviors]* --- title: NPC Roster
type: resource
tags:
- active
- resource created: '2025-08-14'
modified: '2025-08-14' --- ## Major NPCs | Name | Role | Location | Status |
|------|------|----------|--------|
| - | - | - | - | ## Minor NPCs | Name | Role | Location | Notes |
|------|------|----------|-------| ## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:* - Can be adapted to fit current story needs
- Scalable threat/reward based on party level
- Multiple entry points for different play styles
- Connections to overarching campaign themes ## Stats```statblock creature: Custom NPC```### Quick Stats - **AC**: *[Armor Class]*
- **HP**: *[Hit Points]*
