...
type: note
created: 2025-07-23
updated: '2025-08-13T01:18:32.235151+00:00'
...
Strahd bequeathed the winery and vineyard to the noble Krezkov family as a reward for the family's loyalty. Later, an arranged marriage between the Krezkovs and the Martikov family led to the land being taken over by a Martikov descendant. The winery and vineyard have been tended by the Martikovs ever since. At some point, the Martikov family became infected with widespread lycanthropy. The current patriarch, [Davian Martikov](/03_Mechanics/CLI/bestiary/npc/davian-martikov-cos.md), is a wereraven, as are his children and grandchildren.

![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/110-cos12-01.webp#center)
...
The winery is known for three wines: the unremarkable Purple Grapemash No. 3, the slightly more tantalizing Red Dragon Crush, and the rich Champagne du le Stomp. Ten years ago, one of the vineyard's magic gems was dug up and stolen, and as a result, the winery stopped producing its best vintage, the champagne. No one knows what happened to the gem. [Davian Martikov](/03_Mechanics/CLI/bestiary/npc/davian-martikov-cos.md) blames his middle son, Urwin (see chapter 5, area N2), for the loss because Urwin was on watch the night the gem was taken. Davian is convinced that Urwin shirked his duty to spend time with his betrothed, and the two men have been at odds ever since. To this day, Urwin steadfastly denies his father's accusation.

Adding to Davian's misery, the wereravens have been fending off frequent attacks by [Baba Lysaga](/03_Mechanics/CLI/bestiary/npc/baba-lysaga-cos.md)'s scarecrow constructs. Three weeks ago, during one such attack, another gem was found, dug up, and taken. Davian believes that it is in the possession of [Baba Lysaga](/03_Mechanics/CLI/bestiary/npc/baba-lysaga-cos.md) (see chapter 10, area U3).

Davian's belief is correct. The gem was a lucky find for [Baba Lysaga](/03_Mechanics/CLI/bestiary/npc/baba-lysaga-cos.md), who had previously suspected that magic was the root of the vineyard's health but knew nothing of its source. Even after this great discovery, [Baba Lysaga](/03_Mechanics/CLI/bestiary/npc/baba-lysaga-cos.md) continues to send her scarecrows against the winery, antagonizing the wereravens like a bad neighbor.
...
Thirty [needle blights](/03_Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) (in six groups of five) emerge from the surrounding vineyard and make their way toward the characters and the winery. The blights are 120 feet away when they first become visible, and they have a walking speed of 30 feet. Characters can either barricade themselves inside the winery, thus keeping the needle blights at bay, or stand and fight. If they stay outside and fight, druids and blights from inside the winery join the battle on the rounds shown below.

| Round | Creatures |
|-------|-----------|
| 3 | 1 [druid](/03_Mechanics/CLI/bestiary/humanoid/druid-xmm.md) and 24 [twig blights](/03_Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) (from area W9) |
| 4 | 1 [druid](/03_Mechanics/CLI/bestiary/humanoid/druid-xmm.md) and 5 [needle blights](/03_Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) (from area W14) |
| 5 | 1 [druid](/03_Mechanics/CLI/bestiary/humanoid/druid-xmm.md) and 2 [vine blights](/03_Mechanics/CLI/bestiary/plant/vine-blight-xmm.md) (from area W20) |
^round-creatures

The druid lurking in area W16 carries a [Gulthias staff](/03_Mechanics/CLI/items/gulthias-staff-cos.md) (see appendix C). If the staff is destroyed, all blights within 300 feet of it instantly wither and die.
...
> [!gallery]
> ![Map 12.1: Wizard of Wines Winery (Area W)](/03_Mechanics/CLI/adventures/curse-of-strahd/img/111-028.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/curse-of-strahd/img/112-cos1201.webp#gallery)

### W1. Stables

The Martikovs keep two [draft horses](/03_Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) here and use them to pull their wine wagon.
...
Four [swarms of ravens](/03_Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) perch on the rafters but don't attack the characters under any circumstances.

Unless they have been drawn outside, twenty-four [twig blights](/03_Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) and one [druid](/03_Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (NE female human) are also present. If they are here, read:
...
![Twig Blight](/03_Mechanics/CLI/adventures/curse-of-strahd/img/113-cos12-03.webp#center)

The druid is poisoning the fermentation vats. The three westernmost vats contain poisoned wine, enough to fill a total of twenty barrels. Drinking the poisoned wine has the same effect as drinking a [potion of poison](/03_Mechanics/CLI/items/potion-of-poison-xdmg.md). Pouring antitoxin into a vat neutralizes the poison, but it also spoils the taste of the wine. Casting a [purify food and drink](/03_Mechanics/CLI/spells/purify-food-and-drink-xphb.md) spell on a vat neutralizes the poison without spoiling the wine.
...
Unless they have been drawn outside, five [needle blights](/03_Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) and one [druid](/03_Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (NE male human) lurk in the eastern portion of the cellar. If they are here when the characters enter that part of the cellar, read:
...
On his first turn, from behind the wine rack, the druid casts a [thunderwave](/03_Mechanics/CLI/spells/thunderwave-xphb.md) spell, which shatters ` + 10` of the wine bottles as it resounds throughout the cellar. The druid then orders the needle blights to attack.
...
The man is a [druid](/03_Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (NE male human) who fights only if cornered. Otherwise, he tries to flee by dropping onto the wagon in the loading dock (area W2). He then looks for a place in the winery to hide. A character who understands Druidic can translate the his words: "Nature bows to my every whim, for I have the vampire's staff!"

A secret door in the north corner of the west wall can be pulled open to reveal a bedroom (area W17).

#### Treasure

The druid wields a [Gulthias staff](/03_Mechanics/CLI/items/gulthias-staff-cos.md) (see appendix C), which can be used to destroy the blights in the winery.

### W17. Master Bedroom

This bedroom normally belongs to [Davian Martikov](/03_Mechanics/CLI/bestiary/npc/davian-martikov-cos.md) but is currently being used by his daughter, Stefania, and son-in-law, Dag, while they raise their baby daughter.
...
![Davian Martikov](/03_Mechanics/CLI/adventures/curse-of-strahd/img/114-cos12-04.webp#center)
...
Inside the chest are 50 gp, 270 ep (each electrum coin stamped with the profiled visage of [Strahd von Zarovich](/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos.md)), and 350 sp. A secret compartment in the lid can be found with a successful DC 15 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check. It holds a gold locket (worth 25 gp) containing a painted portrait of a beautiful woman (Davian's deceased wife, Angelika), as well as a pouch containing five 50 gp gemstones.
...
Two [vine blights](/03_Mechanics/CLI/bestiary/plant/vine-blight-xmm.md) and one [druid](/03_Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (NE female human) are in the room unless they have been drawn elsewhere, If they are here, read:
...
The contraption standing near the north wall is a printing press, which [Davian Martikov](/03_Mechanics/CLI/bestiary/npc/davian-martikov-cos.md) uses to make wine bottle labels. The ink is made from wine and stored in bottles in the cabinet, along with pieces of parchment and jars of glue.
...
If the characters leave the winery and return at a later time before dealing with Wintersplinter (see the "Druids' Ritual" section in chapter 14), the enormous [tree blight](/03_Mechanics/CLI/bestiary/plant/tree-blight-xmm.md) (see appendix D) is sent from Yester Hill to ravage the vineyard and destroy the winery.
