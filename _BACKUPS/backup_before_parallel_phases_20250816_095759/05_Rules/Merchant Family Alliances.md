...
- **[[Border Patrol Unit|[Border Patrol Units]]:** Exclusive supply contracts for frontier defense
...
1. **Crystal Mining → Processing → Manufacturing → Retail**
...
2. **Deep Agriculture → Processing → Distribution → Restaurants**
...
3. **Memory Extraction → Storage → Enhancement → Application**
...
— Memory Merchant Valeria Siltweave, "Reflections on Commerce and Survival"
