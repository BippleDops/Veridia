...
- world/both
type: note
updated: '2025-08-13T12:34:21.799273+00:00'
world: Both
---
...
A Wizard spell on a Spell Scroll can be copied into a spellbook. When a level 1 spell is copied in this way, the copier must succeed on a DC 11 Intelligence ([[/03_Mechanics/CLI/skills#Arcana|Arcana]]). On a successful check, the spell is copied. Whether the check succeeds or fails, the Spell Scroll is destroyed.
...
Spell scroll level 1 xdmg is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
