...
created: "2025-08-15T12:24:37.099289"
modified: "2025-08-15T12:24:37.099291"
aliases: [Session 20 (06 Sessions)]
---

# Session 20 (06 Sessions)
...
**Themes**: Mystery, Combat, Exploration ## Background The events leading to this adventure have been building for some time. Forces are in motion that the party must confront or redirect. Consequently, ## [[locations|Locations 1. **Starting Point**: Where the adventure begins 2. **Investigation Sites**: [Places|Places]] to gather information
3. **Challenge Areas**: Combat or puzzle locations
4. **Climax Location**: Where everything comes together ### Primary Hook The main reason parties acquire involved ## Treasure Parcels ### Parcel A (Combat Victory) - `dice: 2d6` × 10 gp
- Potion of [[healing|Healing]]
- Clue to next location ### Parcel B (Exploration) - Magic item (roll on Table F)
- Ancient map fragment
- `dice: 1d4` gems (50 gp each) ## Pronunciation Guide - **Theme**: [THEME]
- **Theme**: [THEME]
...
subcategory: Session 20 (06 Sessions).Md
related: []
cssclass: standard
publish: false --- -|--------|
| 1 | Option A |
