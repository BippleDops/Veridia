---
aliases: ["The Sacred Treasure", "the sacred treasure", "Treasure Sacred The"]
...
## Key Locations
- **NorthGate** (City): Key location for quest progression
- **SouthGate** (Dungeon): Key location for quest progression
- **EastGate** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Constructs** led by Ezra Brightblade
