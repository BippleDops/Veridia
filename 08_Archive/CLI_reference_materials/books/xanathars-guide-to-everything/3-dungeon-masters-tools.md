...
updated: '2025-08-13T01:18:32.379784+00:00'
world: Both
status: active
---
...
Falling from a great height is a significant risk for adventurers and their foes. The rule given in the player's handbook is simple: at the end of a fall, you take `d6` bludgeoning damage for every 10 feet you fell, to a maximum of `20d6`. You also land [prone](/03_Mechanics/CLI/conditions.md#Prone), unless you somehow avoid taking damage from the fall. Here are two optional rules that expand on that simple rule.

### Rate of Falling

The rule for falling assumes that a creature immediately drops the entire distance when it falls. But what if a creature is at a high altitude when it falls, perhaps on the back of a [griffon](/03_Mechanics/CLI/bestiary/monstrosity/griffon-xmm.md) or on board an [airship](/03_Mechanics/CLI/items/airship-xphb.md)? Realistically, a fall from such a height can take more than a few seconds, extending past the end of the turn when the fall occurred. If you'd like high-altitude falls to be properly time-consuming, use the following optional rule.

When you fall from a great height, you instantly descend up to 500 feet. If you're still falling on your next turn, you descend up to 500 feet at the end of that turn. This process continues until the fall ends, either because you hit the ground or the fall is otherwise halted.

### Flying Creatures and Falling

A flying creature in flight falls if it is knocked [prone](/03_Mechanics/CLI/conditions.md#Prone), if its speed is reduced to 0 feet, or if it otherwise loses the ability to move, unless it can hover or it is being held aloft by magic, such as the [fly](/03_Mechanics/CLI/spells/fly-xphb.md) spell.

If you'd like a flying creature to have a better chance of surviving a fall than a non-flying creature does, use this rule: subtract the creature's current flying speed from the distance it fell before calculating falling damage. This rule is helpful to a flier that is knocked [prone](/03_Mechanics/CLI/conditions.md#Prone) but is still conscious and has a current flying speed that is greater than 0 feet. The rule is designed to simulate the creature flapping its wings furiously or taking similar measures to slow the velocity of its fall.

If you use the rule for rate of falling in the previous section, a flying creature descends 500 feet on the turn when it falls, just as other creatures do. But if that creature starts any of its later turns still falling and is [prone](/03_Mechanics/CLI/conditions.md#Prone), it can halt the fall on its turn by spending half its flying speed to counter the [prone](/03_Mechanics/CLI/conditions.md#Prone) condition (as if it were standing up in midair).

## Sleep

Just as in the real world, D&D characters spend many hours sleeping, most often as part of a long rest. Most monsters also need to sleep. While a creature sleeps, it is subjected to the [unconscious](/03_Mechanics/CLI/conditions.md#Unconscious) condition. Here are a few rules that expand on that basic fact.
...
When you finish a long rest during which you slept in medium or heavy armor, you regain only one quarter of your spent Hit Dice (minimum of one die). If you have any levels of [exhaustion](/03_Mechanics/CLI/conditions.md#Exhaustion), the rest doesn't reduce your [exhaustion](/03_Mechanics/CLI/conditions.md#Exhaustion) level.
...
The creature who ties the knot makes an Intelligence ([Sleight of Hand](/03_Mechanics/CLI/skills.md#Sleight%20of%20Hand)) check when doing so. The total of the check becomes the DC for an attempt to untie the knot with an Intelligence ([Sleight of Hand](/03_Mechanics/CLI/skills.md#Sleight%20of%20Hand)) check or to slip out of it with a Dexterity ([Acrobatics](/03_Mechanics/CLI/skills.md#Acrobatics)) check.

This rule intentionally links [Sleight of Hand](/03_Mechanics/CLI/skills.md#Sleight%20of%20Hand) with Intelligence, rather than Dexterity. This is an example of how to apply the rule in the ["Variant: Skills with Different Abilities"](/03_Mechanics/CLI/variant-rules/skills-with-different-abilities-phb.md) section in chapter 7 of the player's handbook.
...
Tools have more specific applications than skills. The [History](/03_Mechanics/CLI/skills.md#History) skill applies to any event in the past. A tool such as a [forgery kit](/03_Mechanics/CLI/items/forgery-kit-xphb.md) is used to make fake objects and little else. Thus, why would a character who has the opportunity to acquire one or the other want to gain a tool proficiency instead of proficiency in a skill?
...
In addition, consider giving characters who have both a relevant skill and a relevant tool proficiency an added benefit on a successful check. This benefit might be in the form of more detailed information or could simulate the effect of a different sort of successful check. For example, a character proficient with [mason's tools](/03_Mechanics/CLI/items/masons-tools-xphb.md) makes a successful Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check to find a secret door in a stone wall. Not only does the character notice the door's presence, but you decide that the tool proficiency entitles the character to an automatic success on an Intelligence ([Investigation](/03_Mechanics/CLI/skills.md#Investigation)) check to determine how to open the door.
...
See the [Identify a Spell](/03_Mechanics/CLI/actions.md#Identify%20a%20Spell) entry.
...
![Determine Numbers and Challenge Ratings; Solo Monster Challenge Rating](/03_Mechanics/CLI/tables/determine-numbers-and-challenge-ratings-solo-monster-challenge-rating-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 1st-5th Level](/03_Mechanics/CLI/tables/determine-numbers-and-challenge-ratings-multiple-monsters-1st-5th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 6th-10th Level](/03_Mechanics/CLI/tables/determine-numbers-and-challenge-ratings-multiple-monsters-6th-10th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 11th-15th Level](/03_Mechanics/CLI/tables/determine-numbers-and-challenge-ratings-multiple-monsters-11th-15th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 16th-20th Level](/03_Mechanics/CLI/tables/determine-numbers-and-challenge-ratings-multiple-monsters-16th-20th-level-xge.md)
...
![Monster Personality](/03_Mechanics/CLI/tables/monster-personality-xge.md)
...
![Monster Relationships](/03_Mechanics/CLI/tables/monster-relationships-xge.md)
...
![Quick Matchups](/03_Mechanics/CLI/tables/quick-matchups-xge.md)
...
To prepare for using a simple trap in play, start by making note of the characters' passive Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) scores. Most traps allow Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) checks to detect their triggers or other elements that can tip off their presence. If you stop to ask players for this information, they might suspect a hidden danger.
...
- [Bear Trap](/03_Mechanics/CLI/traps-hazards/bear-trap-xge.md)  
- [Crossbow Trap](/03_Mechanics/CLI/traps-hazards/crossbow-trap-xge.md)  
- [Falling Portcullis](/03_Mechanics/CLI/traps-hazards/falling-portcullis-xge.md)  
- [Fiery Blast Trap](/03_Mechanics/CLI/traps-hazards/fiery-blast-trap-xge.md)  
- [Net Trap](/03_Mechanics/CLI/traps-hazards/net-trap-xge.md)  
- [Pit Trap](/03_Mechanics/CLI/traps-hazards/pit-trap-xge.md)  
- [Poison Needle Trap](/03_Mechanics/CLI/traps-hazards/poison-needle-trap-xge.md)  
- [Scything Blade Trap](/03_Mechanics/CLI/traps-hazards/scything-blade-trap-xge.md)  
- [Sleep of Ages Trap](/03_Mechanics/CLI/traps-hazards/sleep-of-ages-trap-xge.md)  
...
![Level and Lethality; Trap Save DCs and Attack Bonuses](/03_Mechanics/CLI/tables/level-and-lethality-trap-save-dcs-and-attack-bonuses-xge.md)

![Level and Lethality; Damage Severity by Level](/03_Mechanics/CLI/tables/level-and-lethality-damage-severity-by-level-xge.md)

![Level and Lethality; Spell Equivalent by Level](/03_Mechanics/CLI/tables/level-and-lethality-spell-equivalent-by-level-xge.md)
...
A trigger requires a Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check if simply spotting it reveals its nature. The characters can foil a pit trap hidden by a leaf-covered net if they spot the pit through a gap in the leaves. A trip wire is foiled if it is spotted, as is a pressure plate.

Other traps require careful inspection and deduction to notice. A doorknob opens a door when turned to the left, but activates a trap when turned to the right. Such a subtle trap requires a successful Intelligence ([Investigation](/03_Mechanics/CLI/skills.md#Investigation)) check to notice. The trigger is obvious. Understanding its nature is not.
...
Once you determine how a trap can be disarmed or avoided, decide the appropriate ability and skill combinations that characters can use. A Dexterity check using [thieves' tools](/03_Mechanics/CLI/items/thieves-tools-xphb.md), a Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) check, and an Intelligence ([Arcana](/03_Mechanics/CLI/skills.md#Arcana)) check are all commonly used for this purpose.

A Dexterity check using [thieves' tools](/03_Mechanics/CLI/items/thieves-tools-xphb.md) can apply to any trap that has a mechanical element. [Thieves' tools](/03_Mechanics/CLI/items/thieves-tools-xphb.md) can be used to disable a trip wire or a pressure plate, disassemble a poison needle mechanism, or clog a valve that leaks poisonous gas into a room.
...
![Experience for Complex Traps; Complex Trap Experience Awards](/03_Mechanics/CLI/tables/experience-for-complex-traps-complex-trap-experience-awards-xge.md)

### Example Complex Traps

The following complex traps can be used to challenge characters or to inspire your own creations.

- [Path of Blades](/03_Mechanics/CLI/traps-hazards/path-of-blades-xge.md)  
- [Poisoned Tempest](/03_Mechanics/CLI/traps-hazards/poisoned-tempest-xge.md)  
- [Sphere of Crushing Doom](/03_Mechanics/CLI/traps-hazards/sphere-of-crushing-doom-xge.md)  
...
The trigger for a complex trap should be as foolproof as you can make it. A complex trap represents a serious expenditure of effort and magical power. No one builds such a trap and makes it easy to avoid. Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) and Intelligence ([Investigation](/03_Mechanics/CLI/skills.md#Investigation)) checks might be unable to spot a trigger, especially a magical one, but they can still give hints about the trap before it triggers. Bloodstains, ashes, gouges in the floor, and other clues of that sort can serve as evidence of the trap's presence.
...
Not all of the characters' options need to be focused on stopping a trap from operating. Think of what characters can do to mitigate or avoid a trap's effects. Making the trap vulnerable to this sort of effort is a way to engage characters who might be ill-suited to confront the trap directly. A successful Intelligence ([Religion](/03_Mechanics/CLI/skills.md#Religion)) check might provide insight into the imagery displayed by a trap in a temple or shrine, giving other characters a clue about how and where to direct their efforts. A character could stand in front of a dart trap while holding a shield that the darts can target harmlessly, while other characters trigger that element as they work to disable it.
...
![Creating a Rival; Rival](/03_Mechanics/CLI/tables/creating-a-rival-rival-xge.md)
...
![Buying a Magic Item; Buying Magic Items](/03_Mechanics/CLI/tables/buying-a-magic-item-buying-magic-items-xge.md)

![Buying a Magic Item; Magic Item Price](/03_Mechanics/CLI/tables/buying-a-magic-item-magic-item-price-xge.md)
...
A character with the noble background can mingle with the upper class, but other characters can do so only if you judge that the character has made sufficient contacts. Alternatively, a character might use a [disguise kit](/03_Mechanics/CLI/items/disguise-kit-xphb.md) and the [Deception](/03_Mechanics/CLI/skills.md#Deception) skill to pass as a noble visiting from a distant city.

##### Resolution

After a workweek of carousing, a character stands to make contacts within the selected social class. The character makes a Charisma ([Persuasion](/03_Mechanics/CLI/skills.md#Persuasion)) check using the Carousing table.

![Carousing](/03_Mechanics/CLI/tables/carousing-xge.md)
...
![Lower-Class Carousing Complications](/03_Mechanics/CLI/tables/lower-class-carousing-complications-xge.md)
...
![Crafting an Item; Resources and Resolution](/03_Mechanics/CLI/tables/crafting-an-item-resources-and-resolution-xge.md)
...
![Crafting Magic Items; Magic Item Ingredients](/03_Mechanics/CLI/tables/crafting-magic-items-magic-item-ingredients-xge.md)
...
![Crafting Magic Items; Magic Item Crafting Time and Cost](/03_Mechanics/CLI/tables/crafting-magic-items-magic-item-crafting-time-and-cost-xge.md)

To complete a magic item, a character also needs whatever tool proficiency is appropriate, as for crafting a nonmagical object, or proficiency in the [Arcana](/03_Mechanics/CLI/skills.md#Arcana) skill.
...
![Crafting Complications](/03_Mechanics/CLI/tables/crafting-complications-xge.md)
...
![Brewing Potions of Healing; Potion of Healing Creation](/03_Mechanics/CLI/tables/brewing-potions-of-healing-potion-of-healing-creation-xge.md)
...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](/03_Mechanics/CLI/skills.md#Stealth)), Dexterity using [thieves' tools](/03_Mechanics/CLI/items/thieves-tools-xphb.md), and the player's choice of Intelligence ([Investigation](/03_Mechanics/CLI/skills.md#Investigation)), Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)), or Charisma ([Deception](/03_Mechanics/CLI/skills.md#Deception)).
...
![Crime; Loot Value](/03_Mechanics/CLI/tables/crime-loot-value-xge.md)
...
The character makes three checks: Wisdom ([Insight](/03_Mechanics/CLI/skills.md#Insight)), Charisma ([Deception](/03_Mechanics/CLI/skills.md#Deception)), and Charisma ([Intimidation](/03_Mechanics/CLI/skills.md#Intimidation)). If the character has proficiency with an appropriate gaming set, that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Gambling Results table to see how the character did.

![Gambling Results](/03_Mechanics/CLI/tables/gambling-results-xge.md)
...
![Gambling Complications](/03_Mechanics/CLI/tables/gambling-complications-xge.md)
...
The character makes three checks: Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)), Dexterity ([Acrobatics](/03_Mechanics/CLI/skills.md#Acrobatics)), and a special Constitution check that has a bonus equal to a roll of the character's largest Hit Die (this roll doesn't spend that die). If desired, the character can replace one of these skill checks with an attack roll using one of the character's weapons. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Pit Fighting Results table to see how the character did.

![Pit Fighting Results](/03_Mechanics/CLI/tables/pit-fighting-results-xge.md)
...
At the end of the required time, the character chooses to make either an Intelligence ([Religion](/03_Mechanics/CLI/skills.md#Religion)) check or a Charisma ([Persuasion](/03_Mechanics/CLI/skills.md#Persuasion)) check. The total of the check determines the benefits of service, as shown on the Religious Service table.

![Religious Service](/03_Mechanics/CLI/tables/religious-service-xge.md)
...
![Research Outcomes](/03_Mechanics/CLI/tables/research-outcomes-xge.md)
...
Scribing a spell scroll takes an amount of time and money related to the level of the spell the character wants to scribe, as shown in the Spell Scroll Costs table. In addition, the character must have proficiency in the [Arcana](/03_Mechanics/CLI/skills.md#Arcana) skill and must provide any material components required for the casting of the spell. Moreover, the character must have the spell prepared, or it must be among the character's known spells, in order to scribe a scroll of that spell.

If the scribed spell is a cantrip, the version on the scroll works as if the caster were 1st level.

![Resources; Spell Scroll Costs](/03_Mechanics/CLI/tables/resources-spell-scroll-costs-xge.md)
...
A character who wants to sell an item must make a Charisma ([Persuasion](/03_Mechanics/CLI/skills.md#Persuasion)) check to determine what kind of offer comes in. The character can always opt not to sell, instead forfeiting the workweek of effort and trying again later. Use the Magic Item Base Prices and Magic Item Offer tables to determine the sale price.

![Selling a Magic Item; Magic Item Base Prices](/03_Mechanics/CLI/tables/selling-a-magic-item-magic-item-base-prices-xge.md)

![Selling a Magic Item; Magic Item Offer](/03_Mechanics/CLI/tables/selling-a-magic-item-magic-item-offer-xge.md)
...
![Distribution by Rarity; Magic Items Awarded by Tier](/03_Mechanics/CLI/tables/distribution-by-rarity-magic-items-awarded-by-tier-xge.md)
...
![Magic Items Awarded by Rarity - Minor](/03_Mechanics/CLI/tables/magic-items-awarded-by-rarity-minor-xge.md)

![Magic Items Awarded by Rarity - Major](/03_Mechanics/CLI/tables/magic-items-awarded-by-rarity-major-xge.md)
