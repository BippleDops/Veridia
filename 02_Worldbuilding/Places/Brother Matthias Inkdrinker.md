...
accessibility:
  screen_reader_summary: "Brother Matthias Inkdrinker is a notable location in Aquabyssos shaped by tidal politics and Convergence anomalies. This entry is structured for fast table use."
...
- A rumor ties Brother Matthias Inkdrinker to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at Brother Matthias Inkdrinker to avert a public scandal.
- A map overlay reveals a hidden approach to Brother Matthias Inkdrinker active only during specific tides/storms.
