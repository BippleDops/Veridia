...
title: physical-variations-pureblood-characteristics-vgm
type: note
tags: 
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["physical-variations-pureblood-characteristics-vgm"]
status: active
priority: normal
...
---
 ...
 # physical-variations-pureblood-characteristics-vgm ---
...
*Source: Volo's Guide to Monsters p. 97* **Pureblood Characteristics**`dice: [](physical-variations-pureblood-characteristics-vgm.md#^pureblood-characteristics)`| dice: d20 | Pureblood Characteristic |
|-----------|--------------------------|
| 1-3 | Fangs |
| 4-5 | forked tongue |
...
^pureblood-characteristics ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Physical variations pureblood characteristics vgm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of physical variations pureblood characteristics vgm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around physical variations pureblood characteristics vgm. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Plot Hooks - Strange accidents suggest a conspiracy

- Someone is protecting information for love
- Someone is protecting a artifact for love ## 12_Research Specific Content Contextual improvement based on 12_Research ## Unearthed Arcana & Playtest Content ### Latest UA Documents
