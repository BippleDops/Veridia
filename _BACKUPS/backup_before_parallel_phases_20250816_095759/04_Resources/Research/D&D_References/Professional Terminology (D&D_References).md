...
title: Professional Terminology (D&D_References)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Professional Terminology (D&D References)"]
status: active
priority: normal
...
- **"Bubble-back"** - Emergency ascent procedure when equipment fails **Safety Signals:**
...
- **"Dark-water"** - Contaminated area requiring evacuation **Quality Assessment:**
...
- **"Void-tainted"** - Potentially dangerous materials requiring special handling **Guild Secrets:**
...
- **"Bubble-architecture"** - Building techniques using controlled air pockets **Equipment Terminology:**
...
- **"Flotation-balance"** - Buoyancy control systems for structures **Professional Assessments:**
...
- **"Emergency-buoyant"** - Safety systems for catastrophic failure scenarios ### **Deep Sea Navigation Guild** **Navigation Techniques:**
...
- **"Memory-current navigation"** - Using inherited traditional knowledge **Route Classifications:**
...
- **"Emergency-ascent"** - Backup routes to surface in case of equipment failure **Communication Codes:**
...
- **"Emergency-beacon"** - Distress signals for rescue operations ### **Shadow Surgeon Collective** **Medical Procedures:**
...
- **"Deep-anesthesia"** - Pressure-based unconsciousness induction **Diagnostic Terms:**
...
- **"Deep-calling"** - Compulsive desire to descend to dangerous depths **Guild Secrets:**
...
- **"Deep-oath"** - Loyalty vows enforced through surgical modification ### **Crystal Engineering Guild** **Technical Terminology:**
...
- **"Resoce-feedback"** - Dangerous crystal system overload conditions **Quality Classifications:**
...
- **"Chaos-touched"** - Dangerously unstable crystals requiring careful handling **Manufacturing Processes:**
...
- **"Discord-dampening"** - Techniques for reducing crystal instability **Guild Secrets:**
...
- **"Silence-punishment"** - Disciplinary measures involving crystal deactivation ### **Wind Song Academy** **Musical Theory:**
...
- **"Resoce-projection"** - Methods for making voice carry over long distances **Performance Categories:**
...
- **"Wind-dance"** - Combination of vocal and physical movement arts **Technical Skills:**
...
- **"Silence-weaving"** - Strategic use of pauses and quiet moments ### **Windwright Navigation Academy** **Flight Terminology:**
...
- **"Emergency-gliding"** - Powerless flight techniques for mechanical failure **Weather Prediction:**
...
- **"Cloud-reading"** - Using cloud formations for weather and navigation information **Safety Protocols:**
...
- **"Equipment-failure protocols"** - Emergency procedures for mechanical breakdowns ### **Sky Knight Military Orders** **Combat Terminology:**
...
- **"Storm-warfare"** - Combat techniques adapted for severe weather conditions **Tactical Classifications:**
...
- **"Emergency-extraction"** - Rescue operations in dangerous conditions **Command Structure:**
...
- **"Weather-master"** - Officer specializing in meteorological warfare ### **Inter-Realm Trading Companies** **Commercial Terminology:**
...
- **"Environmental-insurance"** - Coverage for realm-specific transportation hazards **Market Classifications:**
...
- **"Emergency-supplies"** - Critical materials for inter-realm survival **Negotiation Codes:**
...
- **"Void-clause"** - Legal protection against otherworldly shipping risks ### **Diplomatic Translation Services** **Communication Protocols:**
...
- **"Altitude-respect protocols"** - Proper social behavior for sky-culture encounters **Professional Standards:**
...
- **"Cultural-sensitivity clearance"** - Authorization to handle sensitive inter-realm negotiations ### **Mixed Heritage Communities** **Identity Terminology:**
...
- **"Depth-sky balance"** - Personal harmony between opposing cultural pressures **Social Integration:**
...
- **"Unity-celebration"** - Events that honor both cultural traditions ### **Protection Methods** **Aquabyssos Guilds:**
...
- **"Memory-lock"** - Knowledge restriction through selective information sharing **Aethermoor Guilds:**
...
- **"Harmony-binding"** - Loyalty enforcement through shared musical traditions ### **Professional Honor Codes** **Universal Principles:**
...
- **"Emergency-cooperation"** - Professional rivalries suspended during crises **Enforcement Mechanisms:**
...
- **"Emergency-conscription"** - Mandatory service during community crises --- *"Every profession develops its own language not just for efficiency, but for identity. The words we use in our work define not just what we do, but who we are."* - Guild Master Artificer Nerissa Stormwright ## Player-Facing Summary Professional Terminology is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of Professional Terminology as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Professional Terminology. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Secret Connections *[Hidden from players]* Connected to The Secret Pact - Summon ancient evil ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research
