...
- **The Choice**: Use the remaining shards to strengthen the seal, or claim them to prevent The Collector from getting them ### Alliance Negotiation **Skill Challenge**: Forging the Alliance (8 successes before 3 failures) **Skills Available**: - **Persuasion DC 16**: Unite the delegations around shared threat
...
- **Arcana DC 17**: Understand magical flux patterns - **Investigation DC 14**: Spot landmarks between reality shifts
...
- Timeline accelerates as other forces move to fill the power vacuum **If Aurelius Allies with the Party**:
