---
title: 04 Resources Assets Locations location city memory parasite infection v1 memory
  parasite infection.svg
aliases:
- 04 Resources Assets Locations location city memory parasite infection v1 memory
  parasite infectionsvg
type: location
tags:
- place
- active
...
The atmosphere of this location shifts throughout the day. Midday shows vibrant festivals, while evening transforms the area with mysterious shadows.


04_Resources/Assets/Locations/location-city-memory-parasite-infection-v1-memory-parasite-infection.svg stands as a significant city in the region, serving both strategic and economic purposes. Its location provides advantages for trade, defense, and regional influence.
...
### Founding
Established generations ago as a strategic settlement, 04_Resources/Assets/Locations/location-city-memory-parasite-infection-v1-memory-parasite-infection.svg has grown from humble beginnings to its current significance.
...
### Landmarks
- **Central Structure**: The defining feature of 04_Resources_Assets_Locations_location-city-memory-parasite-infection-v1-memory-parasite-infection.svg
...
### Common Knowledge
- What everyone knows about 04_Resources_Assets_Locations_location-city-memory-parasite-infection-v1-memory-parasite-infection.svg
