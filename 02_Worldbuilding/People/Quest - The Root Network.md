...
![[04_Resources/Assets/04_Resources/Assets/Art/NPCs/Quest_-_The_Root_Network.png|Quest - The Root Network Portrait]]
...
- Failure Still Progresses: Even when rebuffed, Quest - The Root Network sends a warning of a raid that creates a time-sensitive window.
...
Quest - The Root Network presents a distinctive figure. Their bearing suggests both competence and experience. Notable features include:
...
Quest - The Root Network's path to their current position involved:
...
Quest - The Root Network harbors secrets that could change everything:
...
Quest - The Root Network is currently engaged in:
...
1. **The Request**: Quest - The Root Network needs assistance with a delicate matter
...
5. **The Crisis**: Quest - The Root Network is caught in a situation requiring intervention
...
- [[04_Resources_Assets_Symbols_symbol-heraldry-ancient-mer-folk-empire-ancient-mer-folk-empire.svg]]: *bitter rival*
- [[The Shadow Singer Naia]]: *family member*
- [[04_Resources_Assets_Locations_location-city-dr-reef-brightwater-v1-dr-reef-brightwater.svg]]: *patron*
- [[04_Resources_Assets_Vehicles_vehicle-ship-resonance-drive-yacht-v2-resonance-drive-yacht.svg]]: *bitter rival*
