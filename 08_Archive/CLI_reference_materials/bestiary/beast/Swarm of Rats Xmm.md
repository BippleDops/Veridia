...
# [[3-Mechanics\CLI\bestiary\beast/swarm-of-rats-xmm|Swarm of Rats]]
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/beast/token/swarm-of-rats-xmm.webp"
```
^statblock
...
Swarm of rats xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of swarm of rats xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around swarm of rats xmm.

## Adventure Hooks

- A rumor ties swarm of rats xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at swarm of rats xmm to avert a public scandal.
- A map overlay reveals a hidden approach to swarm of rats xmm active only during specific tides/storms.
