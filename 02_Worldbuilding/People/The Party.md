...
char_age: Adult
accessibility:
  screen_reader_summary: "The Party is an NPC entangled with faction politics and memory economies. Contains hooks, tactics, and relationships."
...
## Role and Motive
The Party moves information and influence like currency. Publicly pragmatic, privately driven by a personal stake in the Convergence’s shape.
...
- Failure Still Progresses: Even when rebuffed, The Party sends a warning of a raid that creates a time-sensitive window.
