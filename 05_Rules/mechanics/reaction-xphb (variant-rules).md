...
title: reaction-xphb (variant-rules)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["reaction-xphb (variant-rules)"]
status: active
priority: normal
...
modified: '2025-08-14'
status: active
updated: '2025-08-12T23:37:34.116961'
world: Both

--- ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Reaction xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of reaction xphb as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around reaction xphb. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Prophecy Connection Mentioned in The First Prophecy of Winds ## Plot Hooks - A map reveals the truth about the cult

- Strange accidents suggest a portal
- Strange dreams suggest a portal ## References - [[Quick_Reference - Dn D5e-Side Screen-2024 (D&D_References)]]
...
- [[ring-of-evasion-xdmg (items)]]
- [[ring-of-spell-turning-xdmg (items)]]
- [[rod-of-absorption-xdmg (items)]]
