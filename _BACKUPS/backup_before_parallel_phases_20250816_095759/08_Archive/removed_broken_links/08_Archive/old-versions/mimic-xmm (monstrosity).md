...
updated: '2025-08-12T23:37:34.995989'
world: Both
...
"actions": - "desc": "Melee Attack Roll: +5 (with [Advantage Xphb]]\ \ if the target is [[conditions#Grappled|Grappled by the\ \ mimic), reach 5 ft. Hit: 7 (`dice: 1d8` + 3) Piercing damage—or 12 (`dice: 2d8` + 3) Piercing\ \ damage if the target is [conditions#Grappled|Grappled]]\ \ by the mimic—plus 4 (d8) Acid damage." "name": "Bite" - "desc": "Melee Attack Roll: +5, reach 5 ft. Hit: 7 (`dice: 1d8` + 3) Bludgeoning damage\ \ plus 4 (d8) Acid damage. If the target is a Large or smaller creature, it\ \ has the [[conditions#Grappled|Grappled condition (escape\ \ **DC 13**). Ability checks made to escape this grapple have [Advantage Xphb]]." "name": "Pseudopod"
