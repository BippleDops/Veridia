...
[Morgantha](/3-Mechanics/CLI/bestiary/npc/morgantha-cos.md) gave her coven's [hag eye](/3-Mechanics/CLI/items/hag-eye-xdmg.md) to [Cyrus Belview](/3-Mechanics/CLI/bestiary/npc/cyrus-belview-cos.md), Strahd's disfigured manservant (see chapter 4, area K62), so that she could spy on Castle Ravenloft and keep an eye on the vampire. The hags are fearful of Strahd and respect his dominion over this land. For more information on the *hag eye*, see the hags entry in the Monster Manual.

## Dream Pastries

These pastries look and taste like small mincemeat pies. A creature that eats one in its entirety must succeed on a DC 16 Constitution saving throw or fall into a trance that lasts for `1d4 + 4` hours, during which time the creature is [incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated) and has a speed of 0 feet. The trance ends if the affected creature takes any damage or if someone else uses an action to shake the creature out of its stupor.
...
The windmill's stone walls are easily climbed. Wooden floors separate the various levels. There are no lights within, since the hags have [darkvision](/3-Mechanics/CLI/senses.md#Darkvision).
...
A character who succeeds on a DC 12 Wisdom ([Insight](/3-Mechanics/CLI/skills.md#Insight)) check senses that the [raven](/3-Mechanics/CLI/bestiary/beast/raven-xmm.md) is trying to warn the party. After delivering its message, the raven flies off toward Vallaki, the town in the valley below (see chapter 5).
...
The barrel holds glistening, greenish-black demon ichor. [Morgantha](/3-Mechanics/CLI/bestiary/npc/morgantha-cos.md) can use the barrel as a font for a [scrying](/3-Mechanics/CLI/spells/scrying-xphb.md) spell. She can also knock on the barrel three times as an action to summon a [dretch](/3-Mechanics/CLI/bestiary/fiend/dretch-xmm.md). The demon crawls out of the barrel at the end of [Morgantha](/3-Mechanics/CLI/bestiary/npc/morgantha-cos.md)'s turn and obeys the night hag's commands for 1 hour, after which it dissolves into a pool of ichor. [Morgantha](/3-Mechanics/CLI/bestiary/npc/morgantha-cos.md) can summon up to nine dretches in this manner before the ichor is gone.
...
The wooden trunk has tiny holes bored into its lid and contains a hundred croaking [toads](/3-Mechanics/CLI/bestiary/beast/frog-xmm.md). Several toads escape if the lid is lifted, but they are harmless.
...
The [night hags](/3-Mechanics/CLI/bestiary/fiend/night-hag-xmm.md) Bella Sunbane and Offalia Wormwiggle are here, unless they have been drawn elsewhere.
