...
title: Faction_Quick_Reference (D&D_References)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Faction Quick Reference (D&D References)"]
status: active
priority: normal
...
--- ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Faction Relationship Matrix | Faction | Shadow Conspiracy | Crystal Cults | Deep Mother | Parliament | Royal Court |
...
| **Royal Court** | Suspicious | Fighting | Unaware | Strained | - | ### Shadow Conspiracy Encounters
...
| Exposes operations | Cover-up initiated | False flag operation | ### Crystal Cult Encounters
...
| Destroys crystals | Mourning and anger | Ecosystem-wide response | ### Deep Mother Cult Encounters
...
| Disrupts rituals | Time delay | Cosmic consequences | ### Random Faction Encounter (d10)
...
4. **Desperate**: Mass consciousness override ### Crystal Plague Outbreak
...
4. **Desperate**: Destroy infected areas completely ### Deep Mother Stirring


1. **Immediate**: Locate and contain void breaches
2. **Short-term**: Eliminate cult leadership
3. **Long-term**: Strengthen reality anchors
4. **Desperate**: Wake rival cosmic entities ### Government Crisis
...
4. **Desperate**: Surrender or exile leadership ## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:*


- Can be adapted to fit current story needs
- Scalable threat/reward based on party level
- Multiple entry points for different play styles
- Connections to overarching campaign themes ## Secret Connections *[Hidden from players]* Connected to The Hidden Covenant - Control trade routes ## Plot Hooks - A journal reveals ancient history about the government

- A noble needs help finding before winter
- A letter reveals a betrayal about this place
- A corpse reveals a conspiracy about a local noble ## 12_Research Specific Content Contextual improvement based on 12_Research
