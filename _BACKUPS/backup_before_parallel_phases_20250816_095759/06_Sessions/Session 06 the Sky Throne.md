...
subcategory: Session 06 The Sky Throne.Md
related: []
cssclass: standard
publish: false --- ---
...
- [[Time|Timeline moveded up due to the Queen's deteriorating condition
...
- **Intelligence/Wisdom checks **DC 18****: Understand deeper meanings ### The Fifth Shard: Shard of Ascension Located in the monastery's highest chamber, the **[Fifth Shard of Ascension|Fifth Shard Of Ascension]]** is embedded in a crystal formation that regulates the monastery's flight. **Guardian**: **[[The Ascending Spirit|The Ascending Spirit** - An ancient monk who achieved wind-body transformation centuries ago. **Stats**: Use **Air Elemental** with these modifications: - **Intelligence**: 18
- **Wisdom**: 20
...
**Excellent answers** gain the Guardian as a future ally ### The Collector's Ambush As the party attempts to claim or secure the Fifth Shard, **The Collector's** agents attack: **Encounter**: - **[Elite Wind Rider Captain|Elite Wind Rider Captain]]** (use **[[Knight|Knight** stats with fly speed)
