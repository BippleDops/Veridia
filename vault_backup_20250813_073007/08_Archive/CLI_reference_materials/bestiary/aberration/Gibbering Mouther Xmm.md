...
- world/both
type: monster
updated: '2025-08-13T12:34:19.753645+00:00'
world: Both
---
...
# [[3-Mechanics\CLI\bestiary\aberration/gibbering-mouther-xmm|Gibbering Mouther]]
...
"cr": "2"
"traits":
  - "desc": "The ground in a 10-foot [[/03_Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb|Emanation]]\
      \ originating from the mouther is [[/03_Mechanics/CLI/variant-rules/difficult-terrain-xphb|Difficult Terrain]]."
    "name": "Aberrant Ground"
  - "desc": "The mouther babbles incoherently while it doesn't have the [[/03_Mechanics/CLI/conditions#Incapacitated|Incapacitated]]\
      ...
      \ The target does nothing.  \n- 5-6. The target takes no action or [[/03_Mechanics/CLI/variant-rules/bonus-action-xphb|Bonus\
      \ Action]] and uses all\
...
"actions":
  - "desc": "Melee Attack Roll: +2, reach 5 ft. Hit: 7 (2d6) Piercing damage.\
      ...
      \ condition. The target dies if it is reduced to 0 [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Points]]\
      \ by this attack. Its body is then absorbed into the mouther, leaving only equipment\
      \ behind."
    "name": "Bite"
  - "desc": "Dexterity Saving Throw: DC 10, each creature in a 10-foot-radius [[/03_Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb|Sphere]]\
      \ centered on a point within 30 feet. Failure: 7 (2d6) Radiant damage, and\
      \ the target has the [[/03_Mechanics/CLI/conditions#Blinded|Blinded]] condition\
