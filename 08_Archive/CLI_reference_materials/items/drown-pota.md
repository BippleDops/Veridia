...
- Drown
created: 2025-07-23
updated: '2025-08-13T01:18:34.269678+00:00'
...
# Drown
*Weapon ([trident](/03_Mechanics/CLI/items/trident-xphb.md)), legendary (requires attunement)*  
...
- You can cast [dominate monster](/03_Mechanics/CLI/spells/dominate-monster-xphb.md) (save DC 17) on a [water elemental](/03_Mechanics/CLI/bestiary/elemental/water-elemental-xmm.md). Once you have done so, Drown can't be used this way again until the next dawn.  

## Tears of Endless Anguish

While inside a water node, you can perform a ritual called the Tears of Endless Anguish, using Drown to create a [devastation orb of water](/03_Mechanics/CLI/items/devastation-orb-of-water-pota.md). Once you perform the ritual, Drown can't be used to perform the ritual again until the next dawn.
