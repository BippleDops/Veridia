...
A flint dagger, Tinderstrike is uncommonly sharp, and sparks cascade off its edge whenever it strikes something solid. Its handle is always warm to the touch, and the blade smolders for `d4` minutes after it is used to deal damage. It contains a spark of [Imix](/3-Mechanics/CLI/bestiary/npc/imix-pota.md), Prince of Evil Fire.
...
- You can cast [dominate monster](/3-Mechanics/CLI/spells/dominate-monster-xphb.md) (save DC 17) on a [fire elemental](/3-Mechanics/CLI/bestiary/elemental/fire-elemental-xmm.md). Once you have done so, Tinderstrike can't be used this way again until the next dawn.  
