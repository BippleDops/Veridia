...
## Quest Giver
**Nora Darkwater** - Dying adventurer
...
## Key Locations
- **Gateridge** (City): Key location for quest progression
- **Hillridge** (Dungeon): Key location for quest progression
- **Valeridge** (Wilderness): Key location for quest progression
- **Marshridge** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Wild Beasts** led by Nora Shadowmere the Elder
