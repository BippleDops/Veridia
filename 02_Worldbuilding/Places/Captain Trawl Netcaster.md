...
accessibility:
  ...
  - X-Card
  - Open Door
  screen_reader_summary: Captain Trawl Netcaster is a notable location in Aquabyssos
    shaped by tidal politics and Convergence anomalies. This entry is structured for
    fast table use.
obsidianUIMode: preview
updated: '2025-08-13T12:34:16.724099+00:00'
world: Aquabyssos
---
...
![[04_Resources/Assets/04_Resources/Assets/Art/Places/Captain_Trawl_Netcaster.png|Captain Trawl Netcaster Portrait]]

## Overview

Captain Trawl Netcaster is a living crossroads where memory-currents and trade flows intersect. Merchants, informants, and faiths compete to steer the tides of influence. The Convergence leaves subtle scars here: whispers cling to stone, and bargains echo across depths.
...
Captain Trawl Netcaster is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of Captain Trawl Netcaster as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Captain Trawl Netcaster.

## Adventure Hooks

- A rumor ties Captain Trawl Netcaster to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at Captain Trawl Netcaster to avert a public scandal.
- A map overlay reveals a hidden approach to Captain Trawl Netcaster active only during specific tides/storms.
...
- [[04_Resources_Assets_Locations_location-city-wealthy-goldcurrent-v1-wealthy-goldcurrent.svg]]
- [[04_Resources_Assets_Locations_location-city-pressure-guard-steelwall-v1-pressure-guard-steelwall.svg]]
...
Captain Trawl Netcaster is a notable location characterized by its unique features and strategic importance. The area serves as a hub for local activity and holds significance in the broader region.
...
### Landmarks
- **Central Structure**: The defining feature of Captain Trawl Netcaster
...
### Founding
Captain Trawl Netcaster was established in the distant past, growing from humble beginnings to its current state.
...
Ongoing situations affecting Captain Trawl Netcaster:
...
### Common Knowledge
- What everyone knows about Captain Trawl Netcaster
