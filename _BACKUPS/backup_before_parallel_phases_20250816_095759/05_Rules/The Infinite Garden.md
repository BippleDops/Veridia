...
The Infinite Garden defies conventional understanding of space and dimension. Each crystal tree in this submarine forest contains a complete garden within its crystalline fruit, and each garden within contains more trees with more gardens, recursing into infinity. Visitors often spend life[[Times exploring a single branch, only to discover they've never left the entrance.
...
**Probability Flower Effects** (Roll `dice: 1d12`):
