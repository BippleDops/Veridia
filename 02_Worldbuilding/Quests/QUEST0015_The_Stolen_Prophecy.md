---
aliases: ["The Stolen Prophecy", "the stolen prophecy", "Prophecy Stolen The"]
tags: [generated]
id: QUEST0015
...
## Quest Giver
**Petra Goldleaf** - Guild representative
...
## Key Locations
- **Valeshire** (City): Key location for quest progression
- **OldBridge** (Dungeon): Key location for quest progression
- **Peakshire** (Wilderness): Key location for quest progression
