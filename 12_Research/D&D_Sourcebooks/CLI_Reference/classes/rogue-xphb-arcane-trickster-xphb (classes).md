...
You know three cantrips: [[mage-hand-xphb (spells)]] and two other cantrips of your choice from the Wizard spell list (see that class's section for its list). [[mind-sliver-xphb (spells)]] and [[Minor Illusion Xphb]] are recommended.

Whenever you gain a Rogue level, you can replace one of your cantrips, except [[mage-hand-xphb (spells)]], with another Wizard cantrip of your choice.
...
You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose three level 1 Wizard spells. [[Charm Person Xphb]], [[disguise-self-xphb (spells)]], and [[fog-cloud-xphb (spells)]] are recommended.
...
You can use an [[arcane-focus-xphb (items)]] as a [[spellcasting-focus-xphb (variant-rules)]] for your Wizard spells.

### Mage Hand Legerdemain (Level 3)

When you cast [[mage-hand-xphb (spells)]], you can cast it as a [[Action Xphb]], and you can make the spectral hand [[conditions#Invisible|Invisible]]. You can control the hand as a [[Action Xphb]], and through it, you can make Dexterity ([[skills#Sleight%20of%20Hand|Sleight of Hand]]) checks.

### Magical Ambush (Level 9)

If you have the [[conditions#Invisible|Invisible]] condition when you cast a spell on a creature, it has [[Advantage Xphb]] on any saving throw it makes against the spell on the same turn.

### Versatile Trickster (Level 13)

You gain the ability to distract targets with your [[mage-hand-xphb (spells)]]. When you use the Trip option of your Cunning Strike on a creature, you can also use that option on another creature within 5 feet of the spectral hand.

### Spell Thief (Level 17)

You gain the ability to magically steal the knowledge of how to cast a spell from another spellcaster.

Immediately after a creature casts a spell that targets you or includes you in its area of effect, you can take a [[reaction-xphb (variant-rules)]] to force the creature to make an Intelligence saving throw. The DC equals your spell save DC. On a failed save, you negate the spell's effect against you, and you steal the knowledge of the spell if it is at least level 1 and of a level you can cast (it doesn't need to be a Wizard spell). For the next 8 hours, you have the spell prepared. The creature can't cast it until the 8 hours have passed.
