---
updated: '2025-08-13T01:18:32.922837+00:00'
created: 2025-08-11
type: monster
...
"actions":
  - "desc": "Melee Attack Roll: +7, reach 5 ft. Hit: 7 (1d4 + 5) Piercing damage\
    ...
    "name": "Bite"
  - "desc": "Wisdom Saving Throw: DC 13, each creature in a 15-foot [Cone](/03_Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ Failure: The target has the [Incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated)\
      \ condition and repeats the save at the end of each of its turns, ending the\
      \ effect on itself on a success. After 1 minute, it succeeds automatically.\
      \ While [Incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated), the target\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \n1/day each: [Hallucinatory Terrain](/03_Mechanics/CLI/spells/hallucinatory-terrain-xphb.md),\
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/dragon/token/faerie-dragon-adult-xmm.webp"
```
^statblock
...
Faerie dragon adult xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of faerie dragon adult xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around faerie dragon adult xmm.

## Adventure Hooks

- A rumor ties faerie dragon adult xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at faerie dragon adult xmm to avert a public scandal.
- A map overlay reveals a hidden approach to faerie dragon adult xmm active only during specific tides/storms.
