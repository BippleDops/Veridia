...
- world/both
type: monster
updated: '2025-08-13T12:34:19.601999+00:00'
world: Both
---
...
# [[3-Mechanics\CLI\bestiary\beast/swarm-of-piranhas-xmm|Swarm of Piranhas]]
...
"actions":
  - "desc": "Melee Attack Roll: +5 (with [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]]\
      ...
      \ if the swarm is [[/03_Mechanics/CLI/variant-rules/bloodied-xphb|Bloodied]]."
    "name": "Bites"
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/beast/token/swarm-of-piranhas-xmm.webp"
```
^statblock
...
Swarm of piranhas xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of swarm of piranhas xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around swarm of piranhas xmm.

## Adventure Hooks

- A rumor ties swarm of piranhas xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at swarm of piranhas xmm to avert a public scandal.
- A map overlay reveals a hidden approach to swarm of piranhas xmm active only during specific tides/storms.
