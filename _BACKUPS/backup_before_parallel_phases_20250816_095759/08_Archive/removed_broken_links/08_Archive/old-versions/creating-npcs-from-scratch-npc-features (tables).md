...
title: creating-npcs-from-scratch-npc-features (tables)
type: npc
tags: 
- npc
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["creating-npcs-from-scratch-npc-features (tables)"]
status: active
priority: normal
...
updated: '2025-08-12T23:37:33.532474'
world: Both

--- # Creating NPCs from Scratch; NPC Features

*Source: Dungeon Master's Guide p. 282* **NPC Features** | Race | Ability Modifiers | Features |
|------|-------------------|----------|
...
| Skeleton | +2 Dex, -4 Int, -4 Cha | Vulnerable to bludgeoning damage, immune to poison damage and [[conditions#Exhaustion|exhaustion]], can't be poisoned, darkvision 60 ft., can't speak but understands the languages it knew in life |
...
^npc-features * See the *Player's Handbook* for descriptions of this race's features, none of which alter the NPC's challenge rating. ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Creating npcs from scratch npc features is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of creating npcs from scratch npc features as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around creating npcs from scratch npc features. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research
