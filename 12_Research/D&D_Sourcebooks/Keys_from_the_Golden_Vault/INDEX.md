...
# Keys from the Golden Vault - Integration Index
...
## Description
Heist-themed adventure anthology
...
TABLE WITHOUT ID
    ...
    cr as "CR",
    status as "Status"
FROM "Keys_from_the_Golden_Vault/Monsters"  
WHERE type = "Monster"
SORT cr
```
...
TABLE WITHOUT ID
    ...
    status as "Status" 
FROM "Keys_from_the_Golden_Vault/Adventures"
