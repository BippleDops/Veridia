...
"actions":
  ...
  - "desc": "Ranged Attack Roll: +6, range 40/160 ft. Hit: 1 Piercing damage,\
      \ and the target has the [Charmed](/03_Mechanics/CLI/conditions.md#Charmed) condition\
  ...
  - "desc": "Charisma Saving Throw: DC 10, one creature within 5 feet the sprite\
    ...
    "name": "Heart Sight"
  - "desc": "The sprite casts [Invisibility](/03_Mechanics/CLI/spells/invisibility-xphb.md)\
...
"source":
  - "XMM"
  - "XPHB"
"image": "/03_Mechanics/CLI/bestiary/fey/token/sprite-xmm.webp"
```
^statblock
...
Sprite xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of sprite xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around sprite xmm.

## Adventure Hooks

- A rumor ties sprite xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at sprite xmm to avert a public scandal.
- A map overlay reveals a hidden approach to sprite xmm active only during specific tides/storms.
