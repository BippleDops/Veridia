...
If the sphere comes into contact with a planar portal (such as that created by the [[gate-xphb (spells)]] spell) or an extradimensional space (such as that within a Portable Hole), the DM determines randomly what happens using the following table.
