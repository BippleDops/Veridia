...
If you use Reckless Attack, you can forgo any [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on one Strength-based attack roll of your choice on your turn. The chosen attack roll mustn't have [Disadvantage](/3-Mechanics/CLI/variant-rules/disadvantage-xphb.md). If the chosen attack roll hits, the target takes an extra `d10` damage of the same type dealt by the weapon or [Unarmed Strike](/3-Mechanics/CLI/variant-rules/unarmed-strike-xphb.md), and you can cause one Brutal Strike effect of your choice. You have the following effect options.
