...
- Connections to major factions or storylines ### Primary Sensory Experience

Detailed paragraph about what visitors first notice - sights, sounds, smells, and feelings that define this place. ### Environmental Details

Specific details about weather, lighting, architecture, or natural features that create mood. ### Unique Phenomena

Any supernatural, magical, or unusual aspects that set this location apart. ### [Landmark Name 1]

**Purpose**: What it's for
**Description**: Physical details and atmosphere
**Significance**: Why it matters to the story
**Secrets**: Hidden aspects (GM only) ### [Landmark Name 2]

**Purpose**: What it's for
**Description**: Physical details and atmosphere
**Significance**: Why it matters to the story
**Secrets**: Hidden aspects (GM only) ### [Landmark Name 3]

Continue pattern as needed... ### [NPC Name]
...
**Connections**: Links to other NPCs/factions > **For the Table - Running [NPC Name]:**

> - **First Meeting:** Suggested introduction scene
> - **Information:** What they know/will share
> - **Quest Hook:** How they can involve the party ### [Additional NPCs] ### [Hook Name 1]
...
**Reward**: What the party gains ### [Hook Name 2]

Continue pattern... ## Secrets and Hidden Elements > **For the Table - Revelation Timing:**

> These secrets should be discovered through play, not given freely. 1. **[Secret Name]**: Description and implications
...
> - **Fail Forward**: What happens if party fails major objectives ## Random Encounters (d12) 1. [Encounter description]
