...
Your connection to the plane of absolute order allows you to equalize chaotic moments. When a creature you can see within 60 feet of yourself is about to roll a `d20` with [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) or [Disadvantage](/3-Mechanics/CLI/variant-rules/disadvantage-xphb.md), you can take a [Reaction](/3-Mechanics/CLI/variant-rules/reaction-xphb.md) to prevent the roll from being affected by [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) and [Disadvantage](/3-Mechanics/CLI/variant-rules/disadvantage-xphb.md).
