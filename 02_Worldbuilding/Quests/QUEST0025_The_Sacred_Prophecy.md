...
*Kill Quest for levels 2-6*

**ID**: QUEST0025

## Quest Giver
**Zara Goldleaf the Swift** - Mysterious stranger
...
## Key Locations
- **LowerWatch** (City): Key location for quest progression
- **OldWatch** (Dungeon): Key location for quest progression
- **NewWatch** (Wilderness): Key location for quest progression
- **Fallsford** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Bandits** led by Zara Brightblade
...
- **Gold**: 1,740 gp
- **Experience**: 2,000 XP
- **Magic Items**: Blessed Orb of Power
