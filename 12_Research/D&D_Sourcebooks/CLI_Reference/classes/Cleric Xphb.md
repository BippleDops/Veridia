...
- **Skill Proficiencies**: *Choose 2:* [[/03_Mechanics/CLI/skills#History|History]], [[/03_Mechanics/CLI/skills#Insight|Insight]], [[/03_Mechanics/CLI/skills#Medicine|Medicine]], [[/03_Mechanics/CLI/skills#Persuasion|Persuasion]], or [[/03_Mechanics/CLI/skills#Religion|Religion]]
...
**Starting Equipment:** *Choose A or B:* (A) [[/03_Mechanics/CLI/items/chain-shirt-xphb|Chain Shirt]], [[/03_Mechanics/CLI/items/shield-xphb|Shield]], [[/03_Mechanics/CLI/items/mace-xphb|Mace]], [[/03_Mechanics/CLI/items/holy-symbol-xphb|Holy Symbol]], [[/03_Mechanics/CLI/items/priests-pack-xphb|Priest's Pack]], 7 GP; or (B) 110 GP
...
You know three cantrips of your choice from the Cleric spell list. [[/03_Mechanics/CLI/spells/guidance-xphb|Guidance]], [[/03_Mechanics/CLI/spells/sacred-flame-xphb|Sacred Flame]], and [[/03_Mechanics/CLI/spells/thaumaturgy-xphb|Thaumaturgy]] are recommended.
...
The Cleric Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]].

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Cleric spell list. [[/03_Mechanics/CLI/spells/bless-xphb|Bless]], [[/03_Mechanics/CLI/spells/cure-wounds-xphb|Cure Wounds]], [[/03_Mechanics/CLI/spells/guiding-bolt-xphb|Guiding Bolt]], and [[/03_Mechanics/CLI/spells/shield-of-faith-xphb|Shield of Faith]] are recommended.
...
Whenever you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]], you can change your list of prepared spells, replacing any of the spells there with other Cleric spells for which you have spell slots.
...
You can use a [[/03_Mechanics/CLI/items/holy-symbol-xphb|Holy Symbol]] as a [[/03_Mechanics/CLI/variant-rules/spellcasting-focus-xphb|Spellcasting Focus]] for your Cleric spells.
...
- **Thaumaturge**  
    ...
    You know one extra cantrip from the Cleric spell list. In addition, your mystical connection to the divine gives you a bonus to your Intelligence ([[/03_Mechanics/CLI/skills#Arcana|Arcana]] or [[/03_Mechanics/CLI/skills#Religion|Religion]]) checks. The bonus equals your Wisdom modifier (minimum of +1).  

### Channel Divinity (Level 2)

You can channel divine energy directly from the Outer Planes to fuel magical effects. You start with two such effects: Divine Spark and Turn Undead, each of which is described below. Each time you use this class's Channel Divinity, choose which Channel Divinity effect from this class to create. You gain additional effect options at higher Cleric levels.

You can use this class's Channel Divinity twice. You regain one of its expended uses when you finish a [[/03_Mechanics/CLI/variant-rules/short-rest-xphb|Short Rest]], and you regain all expended uses when you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]]. You gain additional uses when you reach certain Cleric levels, as shown in the Channel Divinity column of the Cleric Features table.

If a Channel Divinity effect requires a saving throw, the DC equals the spell save DC from this class's Spellcasting feature.

### Divine Spark (Level 2)

As a [[/03_Mechanics/CLI/actions#Magic|Magic]] action, you point your [[/03_Mechanics/CLI/items/holy-symbol-xphb|Holy Symbol]] at another creature you can see within 30 feet of yourself and focus divine energy at it. Roll `d8` and add your Wisdom modifier. You either restore [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Points]] to the creature equal to that total or force the creature to make a Constitution saving throw. On a failed save, the creature takes Necrotic or Radiant damage (your choice) equal to that total. On a successful save, the creature takes half as much damage (round down).

You roll an additional `d8` when you reach Cleric levels 7 (`2d8`), 13 (`3d8`), and 18 (`4d8`).

### Turn Undead (Level 2)

As a [[/03_Mechanics/CLI/actions#Magic|Magic]] action, you present your [[/03_Mechanics/CLI/items/holy-symbol-xphb|Holy Symbol]] and censure Undead creatures. Each Undead of your choice within 30 feet of you must make a Wisdom saving throw. If the creature fails its save, it has the [[/03_Mechanics/CLI/conditions#Frightened|Frightened]] and [[/03_Mechanics/CLI/conditions#Incapacitated|Incapacitated]] conditions for 1 minute. For that duration, it tries to move as far from you as it can on its turns. This effect ends early on the creature if it takes any damage, if you have the [[/03_Mechanics/CLI/conditions#Incapacitated|Incapacitated]] condition, or if you die.
...
You gain the [[/03_Mechanics/CLI/feats/ability-score-improvement-xphb|Ability Score Improvement]] feat or another feat of your choice for which you qualify. You gain this feature again at Cleric levels 8, 12, and 16.
...
You can call on your deity or pantheon to intervene on your behalf. As a [[/03_Mechanics/CLI/actions#Magic|Magic]] action, choose any Cleric spell of level 5 or lower that doesn't require a [[/03_Mechanics/CLI/variant-rules/reaction-xphb|Reaction]] to cast. As part of the same action, you cast that spell without expending a spell slot or needing Material components. You can't use this feature again until you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]].
...
When you cast a Cleric cantrip and deal damage to a creature with it, you can give vitality to yourself or another creature within 60 feet of yourself, granting a number of [[/03_Mechanics/CLI/variant-rules/temporary-hit-points-xphb|Temporary Hit Points]] equal to twice your Wisdom modifier.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [[/03_Mechanics/CLI/feats/boon-of-fate-xphb|Boon of Fate]] is recommended.

### Greater Divine Intervention (Level 20)

You can call on even more powerful divine intervention. When you use your Divine Intervention feature, you can choose [[/03_Mechanics/CLI/spells/wish-xphb|Wish]] when you select a spell. If you do so, you can't use Divine Intervention again until you finish `2d4` Long Rests.
