...
created: "2025-08-15T12:25:29.633427"
modified: "2025-08-15T12:25:29.633430"
...
subcategory: Quest - Breaking The Scales.Md
related: []
cssclass: standard
publish: false
...
![](04_Resources
*The [texture] surface feels [description] to the touch.*/Assets/Portraits/portrait-npc-quest-breaking-the-scales-quest-breaking-the-scales.svg) # Quest - Breaking the Scales ---
...
- Hidden goals ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Quest Breaking the Scales is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of Quest Breaking the Scales as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Quest Breaking the Scales. Consequently, ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## 12_Research Specific Content Contextual improvement based on 12_Research ## Background
...
| 4 | Option D |
| 5 | Option E |
| 6 | Option F | ## References - [[Watch Captain Roderick Shieldbreaker
