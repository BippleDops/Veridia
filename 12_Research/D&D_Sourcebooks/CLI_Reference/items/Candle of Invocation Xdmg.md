...
While lit, the candle sheds [[Light Xphb]] in a 30-foot radius. While you are within that light, you have [[Advantage Xphb]] on [[d20-test-xphb (variant-rules)]]. In addition, a Cleric or Druid in the light can cast level 1 spells they have prepared without expending spell slots.

Alternatively, when you light the candle for the first time, you can cast [[gate-xphb (spells)]] with it. Doing so destroys the candle. The portal created by the spell links to a particular Outer Plane chosen by the DM or determined by rolling on the following table.
