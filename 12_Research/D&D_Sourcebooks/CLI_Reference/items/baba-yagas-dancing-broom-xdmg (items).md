...
If the broom is reduced to 0 [[hit-points-xphb (variant-rules)]], it shatters and is destroyed. If the broom reverts to its iimate form before losing all its [[hit-points-xphb (variant-rules)]] it regains all of them.
