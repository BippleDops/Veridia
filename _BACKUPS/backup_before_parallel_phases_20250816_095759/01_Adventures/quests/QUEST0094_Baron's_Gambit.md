---
aliases: ["Baron's Gambit", "baron's gambit", "Gambit Baron's"]
...
*Defend Quest for levels 5-9*

**ID**: QUEST0094

## Quest Giver
**Osric Brightblade** - Powerful merchant
...
## Key Locations
- **Hillthorpe** (City): Key location for quest progression
- **Valethorpe** (Dungeon): Key location for quest progression
- **OldGrove** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Constructs** led by Osric Fireborn
...
- **Gold**: 4,112 gp
- **Experience**: 5,000 XP
- **Magic Items**: Glorious Orb of the Dawn
...
---
*Generated: 2025-08-15T03:21:04.094Z*
