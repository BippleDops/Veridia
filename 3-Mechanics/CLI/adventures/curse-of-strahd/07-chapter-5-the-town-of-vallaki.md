...
Two town [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) (LG male and female humans) stand just inside each gate. Instead of spears, they carry pikes (reach 10 ft., `1d10 + 1` piercing damage on a hit). These weapons are long enough to stab creatures through the bars of the gate. The guards greet all visitors with suspicion, particularly those who arrive at night. If the characters arrive at night, one or more of them must succeed on a DC 20 Charisma ([Persuasion](/3-Mechanics/CLI/skills.md#Persuasion)) check to convince the guards to unlock the gate and let them enter.

If trouble breaks out at one of the gates, the guards there cry out, "To arms!" Their shouts are echoed across Vallaki, putting the entire town on alert within minutes. Vallaki has twenty-four human [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md), half of whom are on duty at any given time (six stand watch at the gates, six patrol the walls). The town can also muster a militia of fifty able-bodied human [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) armed with clubs, daggers, and torches.
...
|-----------|----------|
| 1–3 | None |
| 4–5 | `2d4` [swarms of rats](/3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) |
...
Father Lucian Petrovich (LG male human [priest](/3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md)) oversees the church and does his best to raise spirits. Assisting him is an orphan and altar boy named Yeska (LG male human noncombatant). A brawny lad with a perpetually furrowed brow named [Milivoj](/3-Mechanics/CLI/bestiary/npc/milivoj-cos.md) (see below) tends the grounds and digs graves.

At night, the church is packed with `2d6 + 6` [frightened](/3-Mechanics/CLI/conditions.md#Frightened) Vallakian adults (male and female human [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) and `2d6` equally terrified Vallakian children (male and female human noncombatants). Father Lucian offers his nightly congregation his prayers and the promise of St. Andral's protection. Among Father Lucian's nightly flock is a sad old woman named Willemina Rikalova. Her son, the shoemaker Udo Lukovich, has been imprisoned for speaking out against the burgomaster (see area N3m). She prays that her son will be set free.

![Milivoj](/3-Mechanics/CLI/adventures/curse-of-strahd/img/049-cos05-03.webp#center)

[Milivoj](/3-Mechanics/CLI/bestiary/npc/milivoj-cos.md) (N male human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) is rarely seen without a shovel, which he wields like a club. Modify his statistics as follows:
...
From noon to dusk, the taproom holds `2d4` local patrons (male and female [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). Between dusk and midnight, `2d8` Vallakians are here. In addition, one or more of the following people might be present during this time.
...
[Rictavio](/3-Mechanics/CLI/bestiary/npc/rictavio-cos.md) wears a [hat of disguise](/3-Mechanics/CLI/items/hat-of-disguise-xdmg.md) and a [ring of mind shielding](/3-Mechanics/CLI/items/ring-of-mind-shielding-xdmg.md) to conceal his identity. He carries an iron key that unlocks the door to his carnival wagon (area N5).
...
Any character who has a horse can keep it here for 1 sp per night. The gray mare is a [draft horse](/3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) named Drusilla, and she likes apples. The horse belongs to [Rictavio](/3-Mechanics/CLI/bestiary/npc/rictavio-cos.md) (see area N2c).
...
Characters who search the loft thoroughly find three pitchforks and a locked wooden chest buried under a pile of hay (see "Treasure" below), next to a secret door. If the characters tamper with the chest, the ravens gather into four [swarms of ravens](/3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) and attack. If two swarms are killed, the others flee. Otherwise, they cease their attacks if the characters leave the chest alone. If the fighting continues for more than 3 rounds, [Urwin Martikov](/3-Mechanics/CLI/bestiary/npc/urwin-martikov-cos.md) and two other wereravens hear the ruckus and investigate (in human form).
...
Inside the locked chest are 140 ep, 70 pp, two [elixirs of health](/3-Mechanics/CLI/items/elixir-of-health-xdmg.md), three [potions of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md), and a [gray bag of tricks](/3-Mechanics/CLI/items/bag-of-tricks-gray-xdmg.md). The coins are embossed with the profiled likeness of [Strahd von Zarovich](/3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos.md).
...
[Rictavio](/3-Mechanics/CLI/bestiary/npc/rictavio-cos.md) sleeps here between midnight and dawn. At dawn, he leaves to check on his horse (area N2f) and his wagon (area N5), returning to the inn around noon. Between noon and dusk, there's a 40 percent chance he is here; otherwise, he's in the taproom (area N2c). At dusk, he leaves the inn to tend to his horse and his wagon again, then returns to his room to retire for the night.
...
Urwin carries the key to the locked iron strongbox. The lock can be picked with thieves' tools and a successful DC 20 Dexterity check. The box contains a sack of 150 ep (each coin bearing the profiled visage of [Strahd von Zarovich](/3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos.md)), six pieces of jewelry (worth 250 gp each), and three [potions of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
If the characters knock on the front doors, a maid (LG female human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) lets them in, escorts them to the den (area N3e), and leaves to fetch the baron.
...
The burgomaster, [Baron Vargas Vallakovich](/3-Mechanics/CLI/bestiary/npc/baron-vargas-vallakovich-cos.md) (NE male human [noble](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)), is a ruthless heel who prides himself on his good breeding and finely honed leadership skills. He stages repeated celebrations to foster happiness, and his "All will be well!" catchphrase has become a sad and tiresome punchline. Baron Vallakovich has convinced himself that if he can make everyone in Vallaki happy, the town will slip free of Strahd's dark grasp.
...
If the characters get on his bad side, the baron accuses them of being "spies of the devil Strahd" and sends twelve [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) to arrest them, seize their weapons, and run them out of town. If the guards fail in their duty, the baron sends Izek to rally a mob of thirty [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) to lynch the party. If the commoners also fail, the baron summons the twelve remaining guards to defend his mansion, giving characters the run of the town.
...
At the risk of sacrificing her sanity, the baron's wife, Lydia Petrovna (LG female human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), has embraced her husband's philosophy of happiness. She laughs at the baron's every comment, to the extent that it has become a nervous reflex, and she tries to spread good cheer by throwing daily tea-and-sandwich parties in the parlor for her "dearest friends," many of them poor folk who tolerate the baroness only because they crave something warm to eat and drink. Lydia is a gods-fearing woman and the younger sister of the town priest, Father Lucian Petrovich. She is a descendant of Tasha Petrovna, a priest entombed in Castle Ravenloft (chapter 4, area K84, crypt 11).

##### The Baronet

The baron's miserable son, [Victor Vallakovich](/3-Mechanics/CLI/bestiary/npc/victor-vallakovich-cos.md) (NE male human [mage](/3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md)), has confined himself to the attic (area N3t), where he is content to avoid the unwanted attention of his mother and the disapproving glares of his father. Years ago, Victor found an old spellbook in the mansion's library and used it to teach himself magic. He has been busy constructing a [teleportation circle](/3-Mechanics/CLI/spells/teleportation-circle-xphb.md) in the hope of escaping Barovia and leaving his parents to their doom.
...
The women seated at the table are eight Vallakian peasants (female [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) invited to spend time with the baroness, Lydia Petrovna, who is bribing them with tea and cake. Lydia has assigned these women the task of stitching children's costumes and weaving together a wicker sun for the Festival of the Blazing Sun.
...
The household staff consists of a maid (LG female human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) and a cook (LG male human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). The other two beds belonged to the butler and the baroness's lady-in-waiting, both of whom have gone missing (see area N3t). The trunks contain the staff's clothing and uniforms.
...
[Baron Vargas Vallakovich](/3-Mechanics/CLI/bestiary/npc/baron-vargas-vallakovich-cos.md) never goes anywhere without his two [mastiffs](/3-Mechanics/CLI/bestiary/beast/mastiff-xmm.md). A paranoid man, he wears his breastplate and rapier even while relaxing in his library. Two of his servants, the butler and his wife's lady-in-waiting, have vanished without a trace in the past week, so he has good cause to be worried.
...
The man is a Vallakian shoemaker named Udo Lukovich (LN male human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). He was arrested during the Wolf's Head Jamboree for carrying a sign that suggested that Vallakians should feed the baron to the wolves.
...
A [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the gilded mirror on the wall radiates an aura of conjuration magic. None of the mansion's current occupants are aware of this fact, because the mirror's magic hasn't been used in generations. Casting an [identify](/3-Mechanics/CLI/spells/identify-xphb.md) spell on the mirror reveals that an assassin's ghost is magically bound to it. The spell also reveals the forgotten rhyme needed to summon the ghost:
...
Anyone who inspects the carving and succeeds on a DC 14 Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check notices a small, nearly invisible glyph etched into the skull's forehead. This is a [glyph of warding](/3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) (`5d8` lightning damage) that triggers if anyone other than Victor opens the door.

The voice belongs to Victor. He is reading aloud from his spellbook. Anyone who listens at the door and succeeds on a DC 14 Intelligence ([Arcana](/3-Mechanics/CLI/skills.md#Arcana)) check can tell he's badly pronouncing some kind of teleportation spell.
...
If the characters trigger the [glyph of warding](/3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) or otherwise announce their arrival, Victor casts a [greater invisibility](/3-Mechanics/CLI/spells/greater-invisibility-xphb.md) spell on himself and hides in a corner. Otherwise, he's visible. If the characters can see Victor, read:
...
For practice and for fun, Victor dug up some old cat bones behind the Wachter estate (see area N4) and animated them, creating six cat skeletons (use the [cat](/3-Mechanics/CLI/bestiary/beast/cat-xmm.md) stat block, but give them [darkvision](/3-Mechanics/CLI/senses.md#Darkvision) out to a range of 60 feet and immunity to poison damage, [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion), and the [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) condition). The skeletons attack only when Victor commands them to.
...
The sheets of parchment are covered with elaborate diagrams of teleportation circles. Victor drew them in an effort to learn the [teleportation circle](/3-Mechanics/CLI/spells/teleportation-circle-xphb.md) spell, which he's still trying to master (see "Teleportation Circle" below).
...
Victor's spellbook contains incomplete text for a [teleportation circle](/3-Mechanics/CLI/spells/teleportation-circle-xphb.md) spell, along with the sigil sequences of three permanent teleportation circles, the locations of which aren't described. There's not enough text to prepare the spell properly, but that hasn't stopped Victor from trying to learn to cast it.

Victor recently inscribed his own version of a teleportation circle on the floor. It's hidden under the rug so that his parents don't find it. In the past couple of weeks, Victor has managed to imbue the circle with magic, but he failed to account for several factors. His circle doesn't fade after use, nor does it function like the [teleportation circle](/3-Mechanics/CLI/spells/teleportation-circle-xphb.md) spell. If the circle is used in the casting of a [teleportation circle](/3-Mechanics/CLI/spells/teleportation-circle-xphb.md) spell, whether the actual spell or Victor's version of it, any creature standing on the circle when the spell is cast takes `3d10` force damage and isn't teleported anywhere. If this damage reduces the creature to 0 hit points, the creature is disintegrated. Any character who studies the circle and succeeds on a DC 15 Intelligence ([Arcana](/3-Mechanics/CLI/skills.md#Arcana)) check realizes that Victor's circle is horribly flawed and potentially deadly when used.

Victor has tested his circle on two reluctant servants (compelled by his [suggestion](/3-Mechanics/CLI/spells/suggestion-xphb.md) spell), in both cases linking his circle to one of the other circles whose sigils are in his spellbook. Each servant was torn apart before Victor's eyes before vanishing in a flash of purple light. Victor doesn't know how to fix the circle but plans to make more modifications to it before testing it again.

##### Treasure

Victor's spellbook contains all the spells Victor has prepared (see the [mage](/3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) stat block in the "Monster Manual") as well as the following spells: [animate dead](/3-Mechanics/CLI/spells/animate-dead-xphb.md), [blight](/3-Mechanics/CLI/spells/blight-xphb.md), [cloudkill](/3-Mechanics/CLI/spells/cloudkill-xphb.md), [darkvision](/3-Mechanics/CLI/spells/darkvision-xphb.md), [glyph of warding](/3-Mechanics/CLI/spells/glyph-of-warding-xphb.md), [levitate](/3-Mechanics/CLI/spells/levitate-xphb.md), [remove curse](/3-Mechanics/CLI/spells/remove-curse-xphb.md), and [thunderwave](/3-Mechanics/CLI/spells/thunderwave-xphb.md).
...
Another secret of Fiona's is that she sleeps with the corpse of her dead husband, Nikolai, who died of sickness nearly three years ago and whom Fiona cherished. Lady Wachter casts [gentle repose](/3-Mechanics/CLI/spells/gentle-repose-xphb.md) spells on the corpse to keep it from deteriorating.
...
Lady Wachter has a different list of prepared spells from that of the [priest](/3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) in the "Monster Manual":

> [!note] 
> 
> - Cantrips (at will): [light](/3-Mechanics/CLI/spells/light-xphb.md), [mending](/3-Mechanics/CLI/spells/mending-xphb.md), [thaumaturgy](/3-Mechanics/CLI/spells/thaumaturgy-xphb.md)  
> - 1st level (4 slots): [command](/3-Mechanics/CLI/spells/command-xphb.md), [purify food and drink](/3-Mechanics/CLI/spells/purify-food-and-drink-xphb.md), [sanctuary](/3-Mechanics/CLI/spells/sanctuary-xphb.md)  
> - 2nd level (3 slots): [augury](/3-Mechanics/CLI/spells/augury-xphb.md), [gentle repose](/3-Mechanics/CLI/spells/gentle-repose-xphb.md), [hold person](/3-Mechanics/CLI/spells/hold-person-xphb.md)  
> - 3rd level (2 slots): [animate dead](/3-Mechanics/CLI/spells/animate-dead-xphb.md), [create food and water](/3-Mechanics/CLI/spells/create-food-and-water-xphb.md)  
^39e

##### Fiona's Sons

Fiona sees a lot of her husband in her sons, Nikolai and Karl (N male human [nobles](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)), who have grown into young men with a fondness for wine and trouble. They aren't home during the day, because they don't like attending to their mother or listening to her tiresome prattle. The characters might encounter them at the Blue Water Inn (area N2) or wandering about town. The brothers are home most nights, passed out in their beds after hours of heavy drinking.
...
Fiona employs a money-grubbing [spy](/3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) named Ernst Larnak (LE male human) to keep her informed about everything that happens in town. Ernst knows Lady Wachter's secrets, and he would blackmail her in a heartbeat if their relationship went sour.
...
Anyone who searches the closet and makes a successful DC 10 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check finds a secret door in the south wall. The door can be pulled open to reveal a stone staircase (area N4g) that leads to the cellar.
...
Lady Wachter's husband, Nikolai, lies in his bed, impeccably dressed, quite deceased, and under the effect of the [gentle repose](/3-Mechanics/CLI/spells/gentle-repose-xphb.md) spell. Nothing of value is on him.

The closet contains shelves of fancy footwear and many fine garments, including a black ceremonial robe with a hood (similar to the ones worn by the cult fanatics in area N4t). On a high shelf rests a locked iron chest. Lady Wachter hides the key to the chest on a tiny hook in the fireplace, under the mantel. A character who takes a minute to search the fireplace finds the key with a successful DC 10 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check. Use of the key disables a poison needle trap hidden in the lock (see ""Sample Traps"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). A creature that triggers the trap and fails the saving throw against the needle's poison falls [unconscious](/3-Mechanics/CLI/conditions.md#Unconscious) for 1 hour instead of being [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) for 1 hour.
...
Eight [cats](/3-Mechanics/CLI/bestiary/beast/cat-xmm.md) have the run of the library. These family pets have vicious dispositions, attacking anyone who tries to pick them up. Characters who have a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 10 or higher notice that one cat has a small key hanging from its collar. The key opens the locked chest in area N4q.
...
The four people are town residents (LE male and female human [cult fanatics](/3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md)) whom Lady Wachter has seduced with promises of power, wealth, and long life. They are members of her "book club," eagerly waiting for Lady Wachter to join them, read passages from her manifesto (see area N4q), and maybe conjure up a few coins. Resting on the fifth chair, quietly eavesdropping on the cultists, is the lady's [invisible](/3-Mechanics/CLI/conditions.md#Invisible) [imp](/3-Mechanics/CLI/bestiary/fiend/imp-xmm.md), [Majesto](/3-Mechanics/CLI/bestiary/npc/majesto-cos.md).
...
The stockyard is a general store and a facility where storage sheds can be rented. It is owned by a middle-aged married couple, Gunther and Yelena Arasek (LG male and female [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). They sell items from the "Adventuring Gear" table in the "Player's Handbook" that have a price of 25 gp or less, but at five times the price.
...
Inside the wagon is a [saber-toothed tiger](/3-Mechanics/CLI/bestiary/beast/saber-toothed-tiger-xmm.md) with 84 hit points. It is clad in specially fitted half plate (AC 17) and has been trained to hunt Strahd's Vistani servants.

The wagon also contains the torn-up remains of a doll. A character who makes a successful DC 10 Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check discovers that the doll was once a colorfully dressed Vistani effigy. Stitched into its tattered pants is a slogan: "Is No Fun, Is No Blinsky!"
...
The front seat of the wagon conceals a secret compartment that requires a successful DC 15 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check to find and open. The compartment holds several items:
...
- A [healer's kit](/3-Mechanics/CLI/items/healers-kit-xphb.md)  
- Three wooden [holy symbols](/3-Mechanics/CLI/items/holy-symbol-xphb.md) inlaid with silver and in the shape of a sunburst (worth 50 gp each)  
- A silvered [shortsword](/3-Mechanics/CLI/items/shortsword-xphb.md)  
- A [hand crossbow](/3-Mechanics/CLI/items/hand-crossbow-xphb.md) inlaid with mother-of-pearl (worth 250 gp)  
- A bundle of twenty silvered [crossbow bolts](/3-Mechanics/CLI/items/bolts-20-xphb.md)  
- A worn leather case with gold buckles (worth 100 gp) containing three sharpened wooden stakes, a sack of garlic, a jar of salt, a box of holy wafers, six [vials of holy water](/3-Mechanics/CLI/items/holy-water-xphb.md), a polished steel mirror, and a bone scroll tube with a silver stopper and chain (worth 25 gp). The tube contains a [spell scroll of protection from fiends](/3-Mechanics/CLI/items/scroll-of-protection-xdmg.md) and a [spell scroll of protection from undead](/3-Mechanics/CLI/items/scroll-of-protection-xdmg.md).  
...
[Henrik van der Voort](/3-Mechanics/CLI/bestiary/npc/henrik-van-der-voort-cos.md) (LE male human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) is a mediocre carpenter and a troubled, lonely man. He profits from the deaths of others, and no one desires his company, because of the ghastly nature of his handiwork. One night several months ago, Strahd visited Henrik in the guise of an imposing, well-dressed nobleman named Vasili von Holtz and promised the coffin maker "good business" in exchange for his help. Since then, Henrik's workshop has become the lair of a pack of vampire spawn—former adventurers who were turned by Strahd. These vampires are lying low for the time being.
...
The Wolf's Head Jamboree has already occurred, making the square's proclamations out of date. If the characters linger, they see the burgomaster's henchman, [Izek Strazni](/3-Mechanics/CLI/bestiary/npc/izek-strazni-cos.md) (see appendix D), arrive with two town [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md). Izek orders one guard to tear down all of the old proclamations while the other posts the following new one:
...
Three men, two women, and two boys are trapped in the stocks—all of them tired, wet, and famished. The five adults have the statistics of human [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), and the children are noncombatants. The plaster donkey heads they wear are meant to encourage ridicule.

Freeing one or more prisoners without the baron's consent is a crime. If the characters are witnessed doing so, Izek rallies the town [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) (twenty-four in all) and orders the characters to leave town at once or suffer the consequences. If the characters stand their ground, Izek orders the guards to beat them into submission, seize their weapons, and cast them out of Vallaki to be "food for the wolves."
...
The cloaked figures are three [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) (N male dusk elves). If the characters seem friendly and are looking for someone to talk to, the guards direct them inside to Kasimir or point them toward the Vistani camp on the hilltop.
...
Kasimir wears a [ring of warmth](/3-Mechanics/CLI/items/ring-of-warmth-xdmg.md) and has a leather-bound spellbook containing all the spells he has prepared (see appendix D) plus the following spells: [arcane lock](/3-Mechanics/CLI/spells/arcane-lock-xphb.md), [comprehend languages](/3-Mechanics/CLI/spells/comprehend-languages-xphb.md), [hold person](/3-Mechanics/CLI/spells/hold-person-xphb.md), [identify](/3-Mechanics/CLI/spells/identify-xphb.md), [locate object](/3-Mechanics/CLI/spells/locate-object-xphb.md), [nondetection](/3-Mechanics/CLI/spells/nondetection-xphb.md), [polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md), [protection from evil and good](/3-Mechanics/CLI/spells/protection-from-evil-and-good-xphb.md), and [wall of stone](/3-Mechanics/CLI/spells/wall-of-stone-xphb.md).
...
Twenty-four [draft horses](/3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) and six [riding horses](/3-Mechanics/CLI/bestiary/beast/riding-horse-xmm.md) are tethered here.
...
Each of these wagons contains `d4` sleeping Vistani (CN male and female human [bandits](/3-Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos.md)). These Vistani wake up if their wagon is shaken or if they take damage and have at least 1 hit point remaining.
...
- An onyx jewelry box with gold filigree (worth 250 gp) containing six pieces of cheap jewelry (worth 50 gp each) and a [potion of poison](/3-Mechanics/CLI/items/potion-of-poison-xdmg.md) in an unlabeled crystal vial (worth 100 gp)  
...
Ernst Larnak (see area N4) begins shadowing the characters. Characters who have a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 14 or higher notice him doing so. If they confront him, he claims that he keeps a watchful eye on all strangers, though he doesn't mention the name of his employer. If the characters threaten him, he backs off and reports to Lady Wachter after he believes he's not being watched or pursued.
...
The vampire spawn begin the attack that night. They cling to the outer walls and roof of St. Andral's church while four [swarms of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) enter the church through the belfry and terrify the congregation. As the townsfolk flee the church, the vampire spawn leap down and attack them.
