...
## Quest Giver
**Helena Goldleaf** - Worried parent
...
## Key Locations
- **Gatestead** (City): Key location for quest progression
- **UpperGate** (Dungeon): Key location for quest progression
- **Valestead** (Wilderness): Key location for quest progression
