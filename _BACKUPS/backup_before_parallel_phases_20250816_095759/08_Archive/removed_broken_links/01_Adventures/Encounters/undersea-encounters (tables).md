...
title: undersea-encounters (tables)
type: note
tags: 
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["undersea-encounters (tables)"]
status: active
priority: normal
...
*Source: Dungeon Master's Guide p. 116* **Undersea Encounters** | d12 + d8 | Encounter |
|----------|-----------|
...
| 3 | Sunken ship with [[Reef Shark Xmm (shallow waters) or [hunter-shark-xmm (beast)]] (deep waters) circling around it (50 percent chance that the ship contains treasure—roll randomly on the treasure tables in chapter 7) |
...
| 9 | Friendly and curious [[giant |
| 10 | Patrol of friendly [Merfolk Skirmisher Xmm]] |
| 11 | Patrol of hostile [[merrow-xmm (monstrosity) (coastal waters) or [sahuagin-warrior-xmm]] (deep waters) |
| 12 | Enormous kelp bed (roll again on the table to determine what's hidden in the kelp bed) |
| 13 | Undersea cave (empty) |
| 14 | Undersea cave ([[sea-hag-xmm (fey) lair) |
| 15 | Undersea cave ([Merfolk Skirmisher Xmm]] lair) |
| 16 | Undersea cave ([[giant lair) |
| 17 | Undersea cave ([dragon-turtle-xmm (dragon)]] lair) |
| 18 | Bronze dragon searching for treasure |
| 19 | [[giant walking on the ocean floor |
...
^undersea-encounters ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Undersea encounters is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of undersea encounters as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around undersea encounters. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Related Notes - [Similar Topic 1]]
