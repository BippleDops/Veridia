...
An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting ethereal forms in its path and carrying the debris for leagues. Travelers with a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 15 or more receive `d4` rounds of warning: a deep hum in the ethereal matter.
...
If a corrupted creature doesn't leave the plane within `1d4+2` days, its alignment changes to chaotic evil. Casting the [dispel evil and good](/3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md) spell on the creature restores its original alignment.
