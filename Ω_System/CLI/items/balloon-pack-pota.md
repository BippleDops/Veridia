...
This backpack contains the spirit of an [air elemental](/3-Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md) and a compact leather balloon. While you're wearing the backpack, you can deploy the balloon as an action and gain the effect of the [levitate](/3-Mechanics/CLI/spells/levitate-xphb.md) spell for 10 minutes, targeting yourself and requiring no [concentration](/3-Mechanics/CLI/conditions.md#Concentration). Alternatively, you can use a reaction to deploy the balloon when you're falling and gain the effect of the [feather fall](/3-Mechanics/CLI/spells/feather-fall-xphb.md) spell for yourself.
