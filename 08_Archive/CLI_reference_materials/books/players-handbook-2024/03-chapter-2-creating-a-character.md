...
type: note
created: 2025-07-23
updated: '2025-08-13T01:18:32.384697+00:00'
...
![World-traveling explorers ...](/03_Mechanics/CLI/books/players-handbook-2024/img/012-02-001-world-traveling-explorers.webp#center "World-traveling explorers Hank, Bobby, Sheila, Diana, and Presto stand on the threshold of their next adventure")
...
![Choose a Class; Class Overview](/03_Mechanics/CLI/tables/choose-a-class-class-overview-xphb.md)

> [!note] A Balanced Party
> 
> The classic D&D party comprises a [Cleric](/03_Mechanics/CLI/classes/cleric-xphb.md), [Fighter](/03_Mechanics/CLI/classes/fighter-xphb.md), [Rogue](/03_Mechanics/CLI/classes/rogue-xphb.md), and [Wizard](/03_Mechanics/CLI/classes/wizard-xphb.md). Those four classes have the longest history in the game, but more importantly, they bring a balanced mix of capabilities to adventures. You're welcome to use that party setup or modify it using these guidelines:
> 
> - **Cleric.** Replace with [Bard](/03_Mechanics/CLI/classes/bard-xphb.md) or [Druid](/03_Mechanics/CLI/classes/druid-xphb.md)  
> - **Fighter.** Replace with [Barbarian](/03_Mechanics/CLI/classes/barbarian-xphb.md), [Monk](/03_Mechanics/CLI/classes/monk-xphb.md), [Paladin](/03_Mechanics/CLI/classes/paladin-xphb.md), or [Ranger](/03_Mechanics/CLI/classes/ranger-xphb.md)  
> - **Rogue.** Replace with [Bard](/03_Mechanics/CLI/classes/bard-xphb.md) or [Ranger](/03_Mechanics/CLI/classes/ranger-xphb.md)  
> - **Wizard.** Replace with [Bard](/03_Mechanics/CLI/classes/bard-xphb.md), [Sorcerer](/03_Mechanics/CLI/classes/sorcerer-xphb.md), or [Warlock](/03_Mechanics/CLI/classes/warlock-xphb.md)  
^a-balanced-party

#### Write Your Level

Write your character's level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [Experience Points](/03_Mechanics/CLI/variant-rules/experience-points-xphb.md) (XP).
...
![Choose a Background; Ability Scores and Backgrounds](/03_Mechanics/CLI/tables/choose-a-background-ability-scores-and-backgrounds-xphb.md)
...
Your background and class both provide starting equipment. Any coins that you gain at this step can be immediately spent on equipment from "chapter 6". In addition, you can have one [trinket](/03_Mechanics/CLI/items/trinket-xphb.md) at no cost at the end of this chapter.
...
![Consider how your choices ...](/03_Mechanics/CLI/books/players-handbook-2024/img/013-02-002-character-choices.webp#center "Consider how your choices combine to set your character on the path to adventure")

#### Choose a Species

Choose a species for your character. The following species options are detailed in "chapter 4": [Aasimar](/03_Mechanics/CLI/races/aasimar-xphb.md), [Dragonborn](/03_Mechanics/CLI/races/dragonborn-xphb.md), [Dwarf](/03_Mechanics/CLI/races/dwarf-xphb.md), [Elf](/03_Mechanics/CLI/races/elf-xphb.md), [Gnome](/03_Mechanics/CLI/races/gnome-xphb.md), [Goliath](/03_Mechanics/CLI/races/goliath-xphb.md), [Halfling](/03_Mechanics/CLI/races/halfling-xphb.md), [Human](/03_Mechanics/CLI/races/human-xphb.md), [Orc](/03_Mechanics/CLI/races/orc-xphb.md), and [Tiefling](/03_Mechanics/CLI/races/tiefling-xphb.md). Once you've chosen a species, write it on your character sheet. Then record your species' traits.

Your character's [size](/03_Mechanics/CLI/variant-rules/size-xphb.md) and [Speed](/03_Mechanics/CLI/variant-rules/speed-xphb.md) are determined by the character's species; record these in the appropriate places on your character sheet as well (you may write just the first letter of your size).
...
![Choose Languages; Standard Languages](/03_Mechanics/CLI/tables/choose-languages-standard-languages-xphb.md)
...
![Choose Languages; Rare Languages](/03_Mechanics/CLI/tables/choose-languages-rare-languages-xphb.md)
...
![Ability Score Point Costs](/03_Mechanics/CLI/tables/ability-score-point-costs-xphb.md)
...
![Assign Ability Scores; Standard Array by Class](/03_Mechanics/CLI/tables/assign-ability-scores-standard-array-by-class-xphb.md)
...
![Determine Ability Modifiers; Ability Scores and Modifiers](/03_Mechanics/CLI/tables/determine-ability-modifiers-ability-scores-and-modifiers-xphb.md)
...
![Describe Appearance and Personality; Strength](/03_Mechanics/CLI/tables/describe-appearance-and-personality-strength-xphb.md)

![](/03_Mechanics/CLI/books/players-handbook-2024/img/015-02-004-dexterity-icon.webp#center)

![Describe Appearance and Personality; Dexterity](/03_Mechanics/CLI/tables/describe-appearance-and-personality-dexterity-xphb.md)

![](/03_Mechanics/CLI/books/players-handbook-2024/img/016-02-005-constitution-icon.webp#center)

![Describe Appearance and Personality; Constitution](/03_Mechanics/CLI/tables/describe-appearance-and-personality-constitution-xphb.md)

![](/03_Mechanics/CLI/books/players-handbook-2024/img/017-02-006-intelligence-icon.webp#center)

![Describe Appearance and Personality; Intelligence](/03_Mechanics/CLI/tables/describe-appearance-and-personality-intelligence-xphb.md)

![](/03_Mechanics/CLI/books/players-handbook-2024/img/018-02-007-wisdom-icon.webp#center)

![Describe Appearance and Personality; Wisdom](/03_Mechanics/CLI/tables/describe-appearance-and-personality-wisdom-xphb.md)

![](/03_Mechanics/CLI/books/players-handbook-2024/img/019-02-008-charisma-icon.webp#center)

![Describe Appearance and Personality; Charisma](/03_Mechanics/CLI/tables/describe-appearance-and-personality-charisma-xphb.md)
...
![Alignments might be visual...](/03_Mechanics/CLI/books/players-handbook-2024/img/020-02-009-alignments.webp#center "Alignments might be visualized as a grid like this—along with creatures that embody those alignments")
...
> 
> Most creatures that lack the capacity for rational thought don't have alignments; they are unaligned. [Sharks](/03_Mechanics/CLI/bestiary/beast/reef-shark-xmm.md) are savage predators, for example, but they aren't evil; they are unaligned.
^unaligned-creatures
...
![Alignment and Personality; Personality Traits by Alignment](/03_Mechanics/CLI/tables/alignment-and-personality-personality-traits-by-alignment-xphb.md)
...
Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you're not actively looking for something. Use this formula to determine your Passive Perception score:

<span class='abilityGeneric'>**Passive Perception.**</span>

Include all modifiers that apply to your Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) checks. For example, if your character has a Wisdom of 15 and proficiency in the [Perception](/03_Mechanics/CLI/skills.md#Perception) skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
![Level 1 Hit Points by Class](/03_Mechanics/CLI/tables/level-1-hit-points-by-class-xphb.md)

The character sheet includes room to note your current Hit Points when you take damage, as well as any [Temporary Hit Points](/03_Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md) you might gain. There's also space to track [Death Saving Throws](/03_Mechanics/CLI/variant-rules/death-saving-throw-xphb.md).
...
Without armor or a shield, your base [Armor Class](/03_Mechanics/CLI/variant-rules/armor-class-xphb.md) is 10 plus your Dexterity modifier. If your starting equipment includes armor or a Shield (or both), calculate your AC using the rules in "chapter 6". A class feature might give you a different way to calculate your AC.
...
![Adventuring equipment impr...](/03_Mechanics/CLI/books/players-handbook-2024/img/021-02-010-adventuring-equipment.webp#center "Adventuring equipment improves as a character progresses through the tiers of play")

While going on adventures, your character gains experience, represented by [Experience Points](/03_Mechanics/CLI/variant-rules/experience-points-xphb.md) (XP). A character who reaches a specified Experience Point total advances in capability. This advancement is called gaining a level.
...
![Level Advancement; Character Advancement](/03_Mechanics/CLI/tables/level-advancement-character-advancement-xphb.md)
...
- **Adjust Hit Points and Hit Point Dice.** Each time you gain a level, you gain an additional Hit Die. Roll that die, add your Constitution modifier to the roll, and add the total (minimum of 1) to your Hit Point maximum. Instead of rolling, you can use the fixed value shown in the Fixed Hit Points by Class table.  
    ...
    ![Adjust Hit Points and Hit Point Dice; Fixed Hit Points by Class](/03_Mechanics/CLI/tables/adjust-hit-points-and-hit-point-dice-fixed-hit-points-by-class-xphb.md)  
...
In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [Fireball](/03_Mechanics/CLI/spells/fireball-xphb.md), [Lightning Bolt](/03_Mechanics/CLI/spells/lightning-bolt-xphb.md), and [Raise Dead](/03_Mechanics/CLI/spells/raise-dead-xphb.md). Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.
...
![Starting Equipment at Higher Levels](/03_Mechanics/CLI/tables/starting-equipment-at-higher-levels-xphb.md)
...
If you have multiple ways to calculate your [Armor Class](/03_Mechanics/CLI/variant-rules/armor-class-xphb.md), you can benefit from only one at a time. For example, a Monk/Sorcerer with a Monk's Unarmored Defense feature and a Sorcerer's Draconic Resilience feature must choose only one of those features as a way to calculate Armor Class.
...
![Spellcasting; Multiclass Spellcaster: Spell Slots per Spell Level](/03_Mechanics/CLI/tables/spellcasting-multiclass-spellcaster-spell-slots-per-spell-level-xphb.md)
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [Burning Hands](/03_Mechanics/CLI/spells/burning-hands-xphb.md), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
![A character with Paladin a...](/03_Mechanics/CLI/books/players-handbook-2024/img/022-02-011-paladin-warlock-multiclass.webp#center "A character with Paladin and Warlock levels might call on both a mighty oath and an otherworldly patron")
