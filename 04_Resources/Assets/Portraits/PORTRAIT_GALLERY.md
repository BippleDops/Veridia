...
- **Npcs**: 783 characters
- **Pcs**: 1 characters
- **Monsters**: 7 characters
- **Deities**: 151 characters
...
- **Best for**: Human NPCs, serious campaigns

### Fantasy Art
Classic fantasy illustration style
- **Techniques**: watercolor, acrylic, digital fantasy art
- **Best for**: Magic users, fantasy races

### Anime
Anime/manga character art style
- **Techniques**: cell shaded, soft shading, lineart with color
- **Best for**: Young characters, lighthearted games

### Portrait Miniature
Medieval illuminated manuscript style
- **Techniques**: gold leaf details, flat perspective, decorative borders
- **Best for**: Deities, historical figures

### Noir
Dark, atmospheric noir style
- **Techniques**: high contrast, shadow play, monochromatic
- **Best for**: Villains, dark campaigns
