...
- world/both
type: note
updated: '2025-08-13T12:34:19.210459+00:00'
world: Both
---
...
![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/023-cos04-01.webp#center)
...
| d12 + d8 | Encounter |
|----------|-----------|
| 2 | [[/03_Mechanics/CLI/bestiary/npc/ezmerelda-davenir-cos|Ezmerelda d'Avenir]] (see appendix D) |
| 3 | [[/03_Mechanics/CLI/bestiary/npc/rahadin-cos|Rahadin]] (see appendix D) |
| 4 | 1 black [[/03_Mechanics/CLI/bestiary/beast/cat-xmm|cat]] |
| 5 | 1 [[/03_Mechanics/CLI/bestiary/construct/broom-of-animated-attack-cos|broom of animated attack]] (see appendix D) |
| 6 | `1d4 + 1` [[/03_Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm|flying swords]] |
| 7 | Blinsky toy |
| 8 | [[/03_Mechanics/CLI/spells/unseen-servant-xphb|Unseen servant]] |
| 9 | `d4` [[/03_Mechanics/CLI/bestiary/humanoid/barovian-commoner-cos|commoners]] |
| 10 | `2d6` [[/03_Mechanics/CLI/bestiary/undead/crawling-claw-xmm|crawling claws]] |
| 11 | `d6` [[/03_Mechanics/CLI/bestiary/undead/shadow-xmm|shadows]] |
| 12 | `d6` [[/03_Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm|swarms of bats]] |
| 13 | 1 crawling [[/03_Mechanics/CLI/bestiary/undead/strahd-zombie-cos|Strahd zombie]] (see appendix D) |
| 14 | `1d4 + 1` Vistani [[/03_Mechanics/CLI/bestiary/humanoid/vistana-thug-cos|thugs]] |
| 15 | `d4` [[/03_Mechanics/CLI/bestiary/undead/wight-xmm|wights]] |
| 16 | Trinket |
| 17 | Giant spider cocoon |
| 18 | 1 [[/03_Mechanics/CLI/bestiary/humanoid/barovian-witch-cos|Barovian witch]] (see appendix D) |
| 19 | `1d4 + 1` [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] |
| 20 | [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] (see appendix D) |
^random-encounters-in-castle-ravenloft
...
Characters can try to hide from the witch (who has [[/03_Mechanics/CLI/senses#Darkvision|darkvision]]) or catch her by surprise. This [[/03_Mechanics/CLI/bestiary/humanoid/barovian-witch-cos|Barovian witch]] is one of the servants of Strahd dwelling in area K56. She is calling out the name of her black cat familiar, which has gone missing. If the characters confront her, the old bat spits at them and begins casting a spell.
...
If the characters capture or kill the [[/03_Mechanics/CLI/bestiary/beast/cat-xmm|cat]], this encounter doesn't occur again. If this result comes up again, treat it as no encounter.
...
When it gets within 5 feet of a party member, the [[/03_Mechanics/CLI/bestiary/construct/broom-of-animated-attack-cos|broom]] attacks.
...
The [[/03_Mechanics/CLI/bestiary/undead/crawling-claw-xmm|crawling claws]] gang up on one party member. During the confusion, one of the claws tries to crawl into the character's backpack and hide there. It makes a Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check contested by the character's passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score. If the claw loses the contest, the character sees the claw enter the backpack. If the claw wins the contest, it waits until the character takes a long rest before scuttling out to attack.
...
The groans are coming from a [[/03_Mechanics/CLI/bestiary/undead/strahd-zombie-cos|Strahd zombie]] that is missing both of its legs, so that only its head, torso, and arms remain. It uses its arms to drag itself across the floor. The crawling zombie has 15 hit points remaining.

If the characters are moving quietly and not using light sources, they can try to hide from the crawling zombie.

#### Ezmerelda d'Avenir

[[/03_Mechanics/CLI/bestiary/npc/ezmerelda-davenir-cos|Ezmerelda]] has cast a [[/03_Mechanics/CLI/spells/greater-invisibility-xphb|greater invisibility]] spell on herself and is stealthily exploring the castle. Choose one character in the back rank of the party's marching order, and read the following text to that character's player:
...
If more than two [[/03_Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm|flying swords]] are encountered, the others aren't far behind. These weapons drift about the castle and attack intruders within range of their [[/03_Mechanics/CLI/senses#Blindsight|blindsight]].
...
| 2 | A [[/03_Mechanics/CLI/bestiary/humanoid/barovian-witch-cos|Barovian witch]] (see appendix D). She screams like a wild animal and begins casting spells. |
| 3 | A [[/03_Mechanics/CLI/bestiary/undead/strahd-zombie-cos|Strahd zombie]] (see appendix D). It fights until killed. |
| 4 | A Barovian lunatic (CN male [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]). If freed, he cackles until silenced or until a [[/03_Mechanics/CLI/spells/calm-emotions-xphb|calm emotions]] spell is cast on him. A [[/03_Mechanics/CLI/spells/lesser-restoration-xphb|lesser restoration]] spell cures his madness, at which point he tries to flee the castle. |
| 5 | A dead Barovian that serves as host to a [[/03_Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm|swarm of insects (spiders)]]. The baby giant spiders (each one the size of a tarantula) crawl out of the Barovian's gaping mouth or burst forth from its distended belly. |
| 6 | A [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|Vistana bandit]] (CN male or female). The Vistana knows the castle's layout and helps the characters until Strahd or more Vistani appear, at which point the treacherous Vistana turns on the characters. |
^cocoons-contents

#### Rahadin

If [[/03_Mechanics/CLI/bestiary/npc/rahadin-cos|Rahadin]] was killed or captured in a previous encounter, this encounter doesn't occur. Otherwise, Strahd's mysterious chamberlain approaches quietly. A character whose passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score meets or exceeds [[/03_Mechanics/CLI/bestiary/npc/rahadin-cos|Rahadin]]'s Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check hear him.
...
[[/03_Mechanics/CLI/bestiary/npc/rahadin-cos|Rahadin]] directs the characters to a random location in the castle, determined by rolling a `d6`:
...
If the characters ask [[/03_Mechanics/CLI/bestiary/npc/rahadin-cos|Rahadin]] to lead the way, he declines. If the characters ask for directions, he tells them whether they need to ascend, descend, or remain on the level they're at. If they attack him, he fights to the death. Otherwise, he doesn't leave until after they do.

#### Shadows

If one or more characters have a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 16 or higher, read:
...
If more than one [[/03_Mechanics/CLI/bestiary/undead/shadow-xmm|shadow]] is present, the others are close by but hidden in the darkness. These undead shadows follow the characters but do not attack unless attacked first. They otherwise obey Strahd's commands.

#### Strahd von Zarovich

[[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] makes a surprise appearance.
...
Any character who has a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score lower than 19 is [[/03_Mechanics/CLI/conditions#Surprised|surprised]] as Strahd appears seemingly out of nowhere. The vampire prefers to attack a [[/03_Mechanics/CLI/conditions#Surprised|surprised]] character, choosing the one closest to him. Otherwise, see appendix D for the vampire's tactics.
...
To determine what the character finds, roll on the [[/03_Mechanics/CLI/items/trinket-cos|Trinkets table]] in appendix A.
...
This unseen servant was created by Strahd and is permanent until destroyed (see the [[/03_Mechanics/CLI/spells/unseen-servant-xphb|unseen servant]] spell in the "Player's Handbook"). Roll a `d6` to determine what the servant is carrying, or choose one of the options below.

`dice: [](06-chapter-4-castle-ravenloft.md#^items)`

| dice: d6 | Items |
|----------|-------|
| 1 | A tarnished silver platter with a lid (worth 25 gp). If a character comes within 5 feet of the servant, it lifts the lid, revealing a bunch of moldy scones. The first character to eat a scone gains inspiration. On later occurrences of this encounter, the platter holds a [[/03_Mechanics/CLI/bestiary/undead/crawling-claw-xmm|crawling claw]] that attacks the nearest character. |
| 2 | A silver goblet (worth 50 gp) filled to the brim with wine. A character who drinks the wine must make a DC 15 Constitution saving throw, taking 44 (`8d10`) poison damage on a failed save, or half as much damage on a successful one. On future occurrences of this encounter, the wine acts as a [[/03_Mechanics/CLI/items/potion-of-healing-xdmg|potion of healing]]. |
...
| 5 | A crystal dinner bell (worth 25 gp). The unseen servant rings the bell if the characters come within 10 feet of it. The sound attracts `d4` hungry [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] (see below), which arrive in `1d4 + 1` rounds. |
...
If any character has a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 16 or higher, the party isn't [[/03_Mechanics/CLI/conditions#Surprised|surprised]]. In that case, read:
...
These minions of Strahd—former adventurers all—creep along ceilings and drop down on unsuspecting prey. The [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] fight until destroyed.
...
If the characters are moving quietly and not carrying light sources, they can try to hide from the [[/03_Mechanics/CLI/bestiary/undead/wight-xmm|wights]]. These undead soldiers once served as guard captains in Castle Ravenloft. They still wear bits of tattered livery, and they attack the living on sight.

##### Treasure

The wights carry longswords that have the crest of Barovia worked into their cross guards. Each wight also carries a pouch holding `2d20` ep, each coin of Barovian mintage and featuring the profiled visage of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]].
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/024-005.webp#gallery|Map 2: Walls of Ravenloft]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/024-005-player.webp#gallery|Player Version]]

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-02-walls.webp#gallery|Walls of Ravenloft (Battlemap; DM Version)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-02-walls-player.webp#gallery|Walls of Ravenloft (Battlemap; Player Version)]]
...
Characters who enter a gate tower find themselves on a flagstone floor with a hollow tower stretching high above them. The mechanisms for raising and lowering the drawbridge and portcullis fill both gate towers. The latch mechanism in each tower is magically activated by a word that only Strahd knows. It can also be activated with a successful casting of [[/03_Mechanics/CLI/spells/dispel-magic-xphb|dispel magic]] (DC 14). Neither the drawbridge nor the portcullis will move until both latches are activated.
...
The portcullis is unlocked and can be lifted with a successful DC 15 Strength check. It can also be opened with a command word that only Strahd and [[/03_Mechanics/CLI/bestiary/npc/cyrus-belview-cos|Cyrus Belview]] (area K62) know. Unless the portcullis is wedged or propped open, it falls back into place once it is let go.
...
If a character who has a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 15 or higher peers over the wall, add:
...
If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is looking out over the balcony.
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/025-006.webp#gallery|Map 3: Main Floor]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/025-006-player.webp#gallery|Player Version]]

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-03-main-floor.webp#gallery|Main Floor (Battlemap; DM Version)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-03-main-floor-player.webp#gallery|Main Floor (Battlemap; Player Version)]]
...
The figure slumped on the altar is all that remains of Gustav Herrenghast, a lawful evil human cleric who tried to obtain the [[/03_Mechanics/CLI/items/icon-of-ravenloft-cos|Icon of Ravenloft]] and did not survive the attempt. See "Treasure" below for more information on the icon and Gustav's possessions.

A sculpted stone railing cordons off the upstairs balcony, which is described in area K28.

#### Treasure

The statuette on the altar is an artifact called the [[/03_Mechanics/CLI/items/icon-of-ravenloft-cos|Icon of Ravenloft]] (see appendix C). Any evil creature that touches the statuette must make a DC 17 Constitution saving throw, taking 88 (`16d10`) radiant damage on a failed save, or half as much damage on a successful one. The statuette is safe for all creatures to handle once it is no longer in contact with the altar.

Gustav's corpse wears a handsome, fur-lined black cloak embroidered with golden thread (worth 250 gp) and a suit of [[/03_Mechanics/CLI/items/chain-mail-xphb|chain mail]], both nonmagical. Gustav's black mace is a [[/03_Mechanics/CLI/items/mace-of-terror-xdmg|mace of terror]].

#### Fortunes of Ravenloft

If your card reading reveals that a treasure is here, it lies on the floor behind the altar.

If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is among the bats fluttering below the ceiling or he is standing at one end of the chapel—a dark shape in the vast hall.
...
Both suits of armor are mechanical traps, each one activated by a pressure plate hidden in the floor in front of its alcove. A character who searches for traps in one of these locations notices both pressure plates with a successful DC 15 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check.
...
![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/027-cos04-05.webp#center)
...
The Heart of Sorrow is held aloft by the will of Strahd. Casting [[/03_Mechanics/CLI/spells/dispel-magic-xphb|dispel magic]] on it has no effect.

##### Animated Halberds

Mounted on the walls along the section of staircase nearest the heart are ten [[/03_Mechanics/CLI/bestiary/construct/animated-halberd-cos|animated halberds]]; use the stat block for the [[/03_Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm|flying sword]] in the "Monster Manual", but increase each halberd's damage to `1d10 + 1` and reduce its AC to 15. The halberds attack any creature that threatens the Heart of Sorrow.

##### Vampire Spawn

Strahd senses if any damage is done to the Heart of Sorrow and sends four [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] to destroy those responsible. These vampire spawn are former adventurers whom Strahd defeated long ago. They use their Spider Climb feature to scuttle along the tower walls and arrive in 3 rounds.
...
The skeletons, which were assembled by [[/03_Mechanics/CLI/bestiary/npc/cyrus-belview-cos|Cyrus Belview]] (see area K62), are held together with wire frames and hung on pegs. They pose no threat.
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/028-007.webp#gallery|Map 4: Court of the Count]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/028-007-player.webp#gallery|Player Version]]

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-04-court-revised.webp#gallery|Court of the Count (Battlemap; DM Version)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-04-court-player-revised.webp#gallery|Court of the Count (Battlemap; Player Version)]]
...
A secret door in the south wall leads to area K13. It is hidden by dust and cobwebs, and requires a successful DC 16 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check to find.
...
If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is sitting on the wooden throne.
...
Characters who examine the ceiling can, with a successful DC 20 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check, spot pulleys and a rope that run the full length of the corridor along the ceiling, well hidden by the cobwebs. These items are explained in "Flight of the Vampire" below.
...
Two [[/03_Mechanics/CLI/bestiary/undead/strahd-zombie-cos|Strahd zombies]] (see appendix D) are slouched on the thrones. They remain motionless until one of them is disturbed or another creature comes within a zombie's reach, whereupon they attack.
...
The staircase climbs from area K16 to area K28. It seems unstable but is sturdy. The creatures in area K28 can't be [[/03_Mechanics/CLI/conditions#Surprised|surprised]] by anyone climbing the creaky steps.
...
The figure is [[/03_Mechanics/CLI/bestiary/npc/lief-lipsiege-cos|Lief Lipsiege]] (CE male human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]), an accountant. He is chained to the heavy wooden desk and has no interest in the characters or their concerns. Under no circumstances does he voluntarily leave the room. Lief pulls the rope the instant he feels threatened.

![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/029-cos04-07.webp#center|Lief Lipsiege]]
...
| dice: d4 | Creature |
|----------|----------|
| 1 | `d6` [[/03_Mechanics/CLI/bestiary/undead/shadow-xmm|shadows]] |
| 2 | `d4` [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] |
| 3 | `d4` [[/03_Mechanics/CLI/bestiary/undead/wight-xmm|wights]] |
| 4 | 1 [[/03_Mechanics/CLI/bestiary/undead/wraith-xmm|wraith]] and `1d4 + 1` [[/03_Mechanics/CLI/bestiary/undead/specter-xmm|specters]] |
^creature

Lief was pressed into service by Strahd many years ago. He keeps all the books for Strahd, recording the vampire's riches and conquests. Lief has been here longer than he can remember. He is grumpy because Strahd doesn't allow him to know about all his treasures. Even so, Lief has found out where one of Strahd's secret treasures lies. If he is treated with kindness, Lief will divulge the hiding place of the [[/03_Mechanics/CLI/items/holy-symbol-of-ravenkind-cos|Holy Symbol of Ravenkind]], as indicated by your card reading. Lief can draw a crude map showing a route to that location. His map is geographically accurate, but he admits that it doesn't acknowledge or avoid any dangers that might lie along the way. Lief doesn't necessarily know the most direct path to the symbol's location.
...
The room contains hundreds of worthless books and scrolls describing accounting procedures. The first character who spends at least 10 minutes searching the room and succeeds on a DC 15 Intelligence ([[/03_Mechanics/CLI/skills#Investigation|Investigation]]) check finds a book with a bloodstained leather cover. The pages of this book have been hollowed out, creating a hole in which Lief has hidden the iron key that unlocks the four wooden chests in this room.

Two of the locked chests contain 10,000 cp each. A third chest contains 1,000 gp. The fourth chest holds 500 pp, hidden under which is a [[/03_Mechanics/CLI/items/manual-of-bodily-health-xdmg|manual of bodily health]].
...
The maid, [[/03_Mechanics/CLI/bestiary/npc/helga-ruvak-cos|Helga Ruvak]], is a [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] who claims to be the daughter of the village bootmaker, kidnapped and forced into service by Strahd. She pleads, on her hands and knees if necessary, to be saved from this awful place.
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/030-008.webp#gallery|Map 5: Rooms of Weeping]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/030-008-player.webp#gallery|Player Version]]

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-05-weeping.webp#gallery|Rooms of Weeping (Battlemap; DM Version)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-05-weeping-player.webp#gallery|Rooms of Weeping (Battlemap; Player Version)]]
...
The dark figures are four [[/03_Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm|swarms of rats]] piled atop one another to form manlike shapes (two swarms per alcove). These rats are under Strahd's control and attack anyone that tries to move through this area.
...
- Strahd's hate assumes a corporeal form, bursts out of the cake (the symbol of Sergei and Tatyana's love), and escapes through the window. "Strahd's hate" has the statistics of an [[/03_Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm|invisible stalker]] and tries to kill whichever character is carrying the groom figurine.  
...
A character who plays the harp and succeeds on a DC 15 Charisma ([[/03_Mechanics/CLI/skills#Performance|Performance]]) check does well enough to summon the ghost of Pidlwick, a short little man dressed as a fool, with a tiny jingling bell at the end of his pointy dunce cap. He asks, "Why have you summoned me from beyond the grave?" Regardless of the answer, he commends the character for playing well and says, "In my crypt below the castle, thou shalt find a treasure worthy of one so talented as thee! May it help thee set this troubled place to rest." If the characters think to ask him who he is, the fool replies, "Pidlwick." If asked how he died, he replies humorlessly, "I fell down the stairs." If [[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]] (see area K59) is with the party, the ghost points at the clockwork effigy and says, "He pushed me down the stairs."
...
The painting above the fireplace depicts Tatyana, a beautiful young woman with auburn hair. Strahd commissioned the painting over four centuries ago to impress his beloved. The fact that [[/03_Mechanics/CLI/bestiary/npc/ireena-kolyana-cos|Ireena Kolyana]] looks exactly like Tatyana is proof to Strahd that both women were born with the same soul.
...
![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/031-cos04-09.webp#center|Tatyana]]
...
If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is sitting back in one of the overstuffed chairs, staring into the fire.
...
Most of the hall is full of giant spider [[/03_Mechanics/CLI/traps-hazards/webs-xdmg|webs]] (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). Characters who stray from the unobstructed path through the webs risk becoming stuck.

#### Secret Doors

At the west end of the hall are two secret doors.

The secret door on the west wall can't be opened from this side, except by magic (such as a [[/03_Mechanics/CLI/spells/knock-xphb|knock]] spell). See area K38 for more information on this secret door. If the characters pass through this door coming from area K38, it closes and locks behind them if they don't take measures to prop it open.

A narrow secret door at the western end of the south wall is hidden behind a mass of webs. If these webs are cleared away, characters can search for the secret door, finding it with a successful DC 15 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check. The door can be pulled open to reveal area K31b.
...
The rope is attached to a great bell mounted in a wooden framework 50 feet overhead. Pulling the rope or attempting to climb it brings forth a loud, long "GONG." That sound causes five [[/03_Mechanics/CLI/bestiary/beast/giant-spider-xmm|giant spiders]] to drop from their webs and attack. The spiders attack only if they are attacked or if the bell is sounded.

Most of the belfry is filled with giant spider [[/03_Mechanics/CLI/traps-hazards/webs-xdmg|webs]] (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). Characters who blunder into them risk becoming stuck.
...
The plundered riches of Strahd's secret hoard lie within this adamantine tower, which is actually a [[/03_Mechanics/CLI/items/daerns-instant-fortress-xdmg|Daern's instant fortress]] (see chapter 7, "Treasure," of the "Dungeon Master's Guide"). Only Strahd knows the command word to alter its shape and size, which can't be done until every bit of treasure inside it is removed. Only Strahd can open the two means of entry: a sealed adamantine door set into the base of the tower on the north side, and an adamantine trapdoor on the roof.
...
The ground floor of the [[/03_Mechanics/CLI/items/daerns-instant-fortress-xdmg|Daern's instant fortress]] contains 50,000 cp, 10,000 sp, 10,000 gp, 1,000 pp, 15 assorted gems (100 gp each), and a [[/03_Mechanics/CLI/items/2-shield-xdmg|+2 shield]] emblazoned with a stylized silver dragon that is the emblem of the Order of the Silver Dragon (see chapter 7). The shield whispers warnings to its bearer, granting a +2 bonus to initiative if the bearer isn't [[/03_Mechanics/CLI/conditions#Incapacitated|incapacitated]].

The upper floor of the tower contains 10 pieces of jewelry (250 gp each) in a red velvet sack, an [[/03_Mechanics/CLI/items/alchemy-jug-xdmg|alchemy jug]], a [[/03_Mechanics/CLI/items/helm-of-brilliance-xdmg|helm of brilliance]], a [[/03_Mechanics/CLI/items/1-rod-of-the-pact-keeper-xdmg|rod of the pact keeper, +1]], and an unlocked wooden coffer with four compartments, each one containing a [[/03_Mechanics/CLI/items/potion-of-greater-healing-xdmg|potion of greater healing]].

#### Fortunes of Ravenloft

If your card reading reveals that a treasure is here, it is lying atop the coins on the ground floor inside the tower.

If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is perched atop the tower.
...
![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/032-cos04-10.webp#center|Gertruda]]
...
The figure on the bed is [[/03_Mechanics/CLI/bestiary/npc/gertruda-cos|Gertruda]] (NG female human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]), the daughter of [[/03_Mechanics/CLI/bestiary/npc/mad-mary-cos|Mad Mary]] (see chapter 3, area E3). [[/03_Mechanics/CLI/bestiary/npc/gertruda-cos|Gertruda]] is oblivious to any danger to herself—especially from Strahd, who has [[/03_Mechanics/CLI/conditions#Charmed|charmed]] her. Sheltered by her mother, she was never allowed to leave home as a child. She finally slipped away and made her way to the castle, drawn by its majesty.

[[/03_Mechanics/CLI/bestiary/npc/gertruda-cos|Gertruda]] is innocent, and years spent as a shut-in have twisted her sense of reality. Consequently, she maintains a fairy-tale view of life. When faced with a decision, she almost always makes the most simplistic choice. She is naive to the point of being a danger to herself and others. Fortunately for her, Strahd has not yet bitten her, though he intends to. (If he can do so while the characters look on helplessly, so much the better.)

Next to the bed, set into the north wall, is a secret door. It can be pushed open to reveal a dusty hall that ends at a similar secret door in the back of an alcove (see area K45 for details). [[/03_Mechanics/CLI/bestiary/npc/gertruda-cos|Gertruda]] doesn't know that this secret door exists.
...
If the characters loiter on the parapets or atop the castle walls for more than 5 minutes, they encounter [[/03_Mechanics/CLI/bestiary/npc/strahds-animated-armor-cos|Strahd's animated armor]] (see appendix D) making the rounds. It patrols the parapets and the outer walls of Ravenloft day and night. Under a darkened sky, characters without [[/03_Mechanics/CLI/senses#Darkvision|darkvision]] are more likely to hear the clatter of the armor approaching before they can see it.
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/033-009.webp#gallery|Map 6: Spires of Ravenloft]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/033-009-player.webp#gallery|Player Version]]

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-06-spires12.webp#gallery "Spires and Tower of Ravenloft (Battlemap; DM Version|Spires and Tower of Ravenl...]]")
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-06-spires12-player.webp#gallery "Spires and Tower of Ravenloft (Battlemap; Player Version|Spires and Tower of Ravenl...]]")
...
![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/034-cos04-11.webp#center)

The ornate rug is actually a [[/03_Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm|rug of smothering]]. It attacks creatures, other than undead, that move across it or anyone who tries to move it or otherwise disturb it. Underneath the rug is a bare stone floor.
...
The portrait on the wall depicts [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] before he became a vampire. Even in life, he was pale. The eyes of the portrait seem to watch and follow the characters as they explore the area. The picture frame is bolted to the wall and can't be removed without destroying it.

If the characters attack the rug or the picture, or if they attempt to remove either item, the [[/03_Mechanics/CLI/bestiary/construct/guardian-portrait-cos|guardian portrait]] (see appendix D) attacks.
...
The youthful man on the couch is [[/03_Mechanics/CLI/bestiary/npc/escher-cos|Escher]], a dashing [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] to whom Strahd has shown favor in the past. [[/03_Mechanics/CLI/bestiary/npc/escher-cos|Escher]] is feeling somewhat neglected of late and has retreated here until Strahd's mood improves. If attacked, he hurls himself out the window and lands like a cat on the roof of the keep (area K53). He leads pursuers right to Strahd, wherever the lord of the castle happens to be (and regardless of whether the characters are ready to face Strahd).

![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/035-cos04-20.webp#center|Escher and the Three Brides]]

In conversation, [[/03_Mechanics/CLI/bestiary/npc/escher-cos|Escher]] displays wit with a hint of melancholy. Beneath his arch mood is a dread that Strahd is growing bored of him and will lock him in the catacombs (area K84) with Strahd's other castoff consorts.

The leaded windows are fitted with iron hinges and can be opened. They can be locked from the inside, though they are currently unlocked. The leaded glass doesn't allow for much of a view. If a character opens a window and leaves it open, there's a 50 percent chance that a [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] crawling around the outside wall of the tower notices the open window and investigates.
...
On the third finger of his left hand, [[/03_Mechanics/CLI/bestiary/npc/escher-cos|Escher]] wears a platinum ring engraved with tiny roses and thorns (worth 150 gp). Around his neck, he wears a gold and ruby pendant (worth 750 gp).
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `d4` [[/03_Mechanics/CLI/bestiary/humanoid/barovian-witch-cos|Barovian witches]] from area K56. They try to subdue the party with [[/03_Mechanics/CLI/spells/sleep-xphb|sleep]] spells. A witch retreats to area K56 if wounded.
...
A character must succeed on a DC 15 Dexterity ([[/03_Mechanics/CLI/skills#Acrobatics|Acrobatics]]) check to traverse the roof. The check succeeds automatically if the character crawls. If the check fails by 5 or more, the character slides off the edge of the roof and falls 40 feet to the castle parapet (area K46).
...
The three [[/03_Mechanics/CLI/bestiary/beast/cat-xmm|cats]] are familiars of the witches in area K56. If the familiars see the characters here, the witches are alerted to their presence.
...
There is a secret trapdoor in the northeast corner of the floor. Because of the trail through the dust, the trapdoor can be found without an ability check. Tapping or knocking on the trapdoor three times releases a hidden latch, causing the trapdoor to swing down. Area K51 lies below. (There's no ability check that will let the characters figure out the trick to opening the door. They can get that information from the witches, or perhaps by using a [[/03_Mechanics/CLI/spells/divination-xphb|divination]] spell or similar magic.)

### K56. Cauldron

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/036-010.webp#gallery|Maps 7-10: Spires and Tower of Ravenloft]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/036-010-player.webp#gallery|Player Version]]
...
The [[/03_Mechanics/CLI/bestiary/humanoid/barovian-witch-cos|Barovian witches]] (see appendix D) that dwell in this area have sworn themselves to Strahd's service in exchange for arcane power. Seven witches are present when the characters arrive, minus any that might have been encountered and defeated in area K50. If the witches are expecting the characters, they cast [[/03_Mechanics/CLI/spells/invisibility-xphb|invisibility]] spells and stand quietly in the corners of the room, hoping that the cauldron draws their prey inside. Although they prefer to attack at range with their spells, they can grow magic claws using [[/03_Mechanics/CLI/spells/alter-self-xphb|alter self]].
...
Each witch carries a [[/03_Mechanics/CLI/items/potion-of-healing-xdmg|potion of healing]] that she made herself. There is a 30 percent chance that a potion has "gone bad," in which case it's actually a [[/03_Mechanics/CLI/items/potion-of-poison-xdmg|potion of poison]].
...
> [!note] 
> 
> 1st level: [[/03_Mechanics/CLI/spells/burning-hands-xphb|burning hands]], [[/03_Mechanics/CLI/spells/charm-person-xphb|charm person]], [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]], [[/03_Mechanics/CLI/spells/find-familiar-xphb|find familiar]], [[/03_Mechanics/CLI/spells/fog-cloud-xphb|fog cloud]], [[/03_Mechanics/CLI/spells/mage-armor-xphb|mage armor]], [[/03_Mechanics/CLI/spells/protection-from-evil-and-good-xphb|protection from evil and good]], [[/03_Mechanics/CLI/spells/ray-of-sickness-xphb|ray of sickness]], [[/03_Mechanics/CLI/spells/sleep-xphb|sleep]], [[/03_Mechanics/CLI/spells/tashas-hideous-laughter-xphb|Tasha's hideous laughter]], [[/03_Mechanics/CLI/spells/unseen-servant-xphb|unseen servant]], [[/03_Mechanics/CLI/spells/witch-bolt-xphb|witch bolt]]
> 
> 2nd level: [[/03_Mechanics/CLI/spells/alter-self-xphb|alter self]], [[/03_Mechanics/CLI/spells/arcane-lock-xphb|arcane lock]], [[/03_Mechanics/CLI/spells/cloud-of-daggers-xphb|cloud of daggers]], [[/03_Mechanics/CLI/spells/darkness-xphb|darkness]], [[/03_Mechanics/CLI/spells/enlarge-reduce-xphb|enlarge/reduce]], [[/03_Mechanics/CLI/spells/invisibility-xphb|invisibility]], [[/03_Mechanics/CLI/spells/knock-xphb|knock]], [[/03_Mechanics/CLI/spells/misty-step-xphb|misty step]]
^23d
...
Hiding in the rafters is [[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]] (see appendix D). A character spots [[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]] with a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score that meets or exceeds its Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check. If [[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]] is spotted, read:
...
Although he appears to be a petite man wearing face paint and a fool's costume, [[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]] is actually a clockwork effigy of the real-life Pidlwick, who lies entombed in the catacombs. The dark paint on his face is soot.

If the characters see [[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]] in bright light, read:
...
[[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]] can't speak and doesn't have an expressive face, so he relies mostly on hand gestures and simple diagrams to communicate. He understands Common but can't read or write.
...
If one or more characters are mean toward [[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]], its quiet resentment of them grows, and at some point when the group is at the top of a staircase, it pushes one of the offending party members down the stairs. The target must succeed on a DC 10 Dexterity saving throw or tumble to the bottom of the staircase, taking `d6` bludgeoning damage per 10 feet fallen.
...
![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/037-cos19-10.webp#center)

#### Treasure

The iron chest is locked, and its key is with [[/03_Mechanics/CLI/bestiary/npc/cyrus-belview-cos|Cyrus Belview]] in area K62.
...
If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is standing next to the iron chest.
...
Characters who remain on the roof are accosted by ten [[/03_Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm|swarms of bats]], which arrive in 3 rounds. If the characters descend into the tower, the bats don't follow and instead fly into the high tower (area K59), descend its central shaft (area K18a), and roost in the catacombs (area K84).
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/038-011.webp#gallery "Map 11: Larders of Ill Omen & Map 12: Dungeon and Catacombs"|Map 11: Larders of Ill Ome...]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/038-011-player.webp#gallery|Player Version]]

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-08-larders.webp#gallery|Larders of Ill Omen (Battlemap; DM Version)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-08-larders-player.webp#gallery|Larders of Ill Omen (Battlemap; Player Version)]]

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-09-dungeons-and-catacombs.webp#gallery|Dungeon and Catacombs (Battlemap; DM Version)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/map-4-09-dungeons-and-catacombs-player.webp#gallery|Dungeon and Catacombs (Battlemap; Player Version)]]
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/039-012.webp#gallery|Map: Elevator Trap]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/040-cos401.webp#gallery|Player Version]]
...
A character who searches for traps while crossing the hall and succeeds on a DC 15 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check detects seams in the floor, walls, and ceiling that suggest that the middle section isn't attached to the rest of the hall. A character who makes a successful DC 15 Intelligence ([[/03_Mechanics/CLI/skills#Investigation|Investigation]]) check discerns that the trap can't be disarmed from this location.

The middle 10-foot section of the hall is a cleverly hidden elevator compartment, open to the north and south so that it appears to be part of the passageway. When the trap is sprung, two steel portcullises drop from the ceiling at lightning speed to seal off the compartment, trapping within those creatures that triggered the trap. An instant later, the closed-off elevator is propelled up the western half of a 20-foot-wide, 170-foot-tall shaft (area K31a) to the sounds of turning gears and rattling chains. Magic sleep gas fills the compartment as it rises, and a creature trapped inside must succeed on a DC 15 Constitution saving throw or fall [[/03_Mechanics/CLI/conditions#Unconscious|unconscious]] as though affected by a [[/03_Mechanics/CLI/spells/sleep-xphb|sleep]] spell.
...
All creatures trapped inside the elevator (including [[/03_Mechanics/CLI/conditions#Unconscious|unconscious]] ones) must roll initiative. The compartment takes 1 round to reach the top of the shaft, stopping just beneath area K47. Each creature inside has one turn to act before the compartment comes to a dead stop. Their initiative rolls determine the order in which the occupants act. Conscious party members can take whatever actions they like. They might search for a way out, wake sleeping party members, cast spells, or take other actions. [[/03_Mechanics/CLI/conditions#Unconscious|Unconscious]] ones can do nothing.

A character who uses an action to search the ceiling of the elevator finds a secret trapdoor with a successful DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check. The trapdoor opens downward.
...
The figure approaching is [[/03_Mechanics/CLI/bestiary/npc/cyrus-belview-cos|Cyrus Belview]], a [[/03_Mechanics/CLI/bestiary/humanoid/mongrelfolk-cos|mongrelfolk]] (see appendix D) and Strahd's faithful servant. He stands 4 feet, 9 inches tall but appears shorter because of his hunched posture. He has the Keen Hearing and Smell feature. The left side his face is covered with lizard scales, and he has the ears of a panther. His left foot looks like a duck's webbed foot, and his arms have patches of black dog fur.

The light in the hall comes from a lantern on the floor behind Cyrus. If the characters have their own light sources, Cyrus sees them, but he will not attack first. He wears a loop of twine around his neck, hanging from which is an iron key and a decorative wooden pendant fitted with a varnished human eyeball. The key unlocks the iron chest in area K60. The wooden pendant is a *hag eye* given to Cyrus by the [[/03_Mechanics/CLI/bestiary/fiend/night-hag-xmm|night hag]] [[/03_Mechanics/CLI/bestiary/npc/morgantha-cos|Morgantha]] (see chapter 6), so that she could spy on Strahd. Cyrus doesn't know that the necklace is magical. See the "Hag Covens" sidebar in the hags entry in the "Monster Manual" for information about the *hag eye*.

![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/041-cos04-16.webp#center|Cyrus Belview]]
...
If the characters follow Cyrus, he tells them to stay close to him as he leads them through the south door to area K61 and deliberately sets off the elevator trap there. Cyrus tries his best not to succumb to the sleeping gas as the elevator compartment climbs the shaft (area K31), and he has advantage on the saving throw. Assuming he's still conscious when the elevator compartment reaches the top of the shaft, Cyrus opens the trapdoor to area K47 and either leads the characters to area K49 or, if they're [[/03_Mechanics/CLI/conditions#Unconscious|unconscious]], drags them there. After assuring characters who are conscious that "the master will be along shortly," Cyrus then makes his way back downstairs to the kitchen (area K65).

If the characters don't go to their room, Cyrus shakes his head and returns to the work of preparing his dinner in area K65. If the characters take his key, he screams, "The master will not be pleased!" and begins to moan and slap his head, obviously upset. A successful DC 10 Charisma ([[/03_Mechanics/CLI/skills#Intimidation|Intimidation]]) check is enough to make him divulge the key's purpose, the location of the iron chest, and the chest's contents.
...
The rats are harmless. [[/03_Mechanics/CLI/bestiary/npc/cyrus-belview-cos|Cyrus Belview]] (see area K62) treats them like pets.
...
Five of these casks are rotted and empty. The wine name burned on each is Red Dragon Crush. Lining the interior of the sixth one is a patch of [[/03_Mechanics/CLI/traps-hazards/yellow-mold-xdmg|yellow mold]] (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). A character who inspects the cask closely and succeeds on a DC 13 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check sees yellow mold in the cracks between the planks of the cask. If this cask is smashed open, the yellow mold releases a cloud of spores.

##### Southern Casks

Two of these casks are rotted and empty. The wine name burned on each is Purple Grapemash No. 3. The middle one is home to a purplish [[/03_Mechanics/CLI/bestiary/ooze/black-pudding-xmm|black pudding]] that bursts forth if the cask is broken open.

#### Fortunes of Ravenloft

If your card reading reveals that a treasure is here, it is inside one of the empty casks along the north wall, hidden there by [[/03_Mechanics/CLI/bestiary/npc/cyrus-belview-cos|Cyrus Belview]].
...
If a character looks into the pot, three human [[/03_Mechanics/CLI/bestiary/undead/zombie-xmm|zombies]] rise up from the bubbling depths and attack. The zombies are slowly being boiled to death, and each has only 13 hit points remaining. If [[/03_Mechanics/CLI/bestiary/npc/cyrus-belview-cos|Cyrus Belview]] (see area K62) is present when the zombies attack, he grabs a heavy club and tries to beat them back into the pot. Cyrus explains that he just isn't the cook he used to be, and his meals tend to get out of hand these days.
...
[[/03_Mechanics/CLI/bestiary/npc/cyrus-belview-cos|Cyrus Belview]] (see area K62) uses this room as his lair. There is nothing of value here.
...
Once a mess hall for the castle guards, this room is now [[/03_Mechanics/CLI/traps-hazards/desecrated-ground|desecrated ground]] (see ""Wilderness Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide").
...
If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is sitting comfortably at one end of the table, holding the skull of a long-dead foe.
...
The yellow lichen is harmless. When one or more characters reach the midpoint of the hall, ten human [[/03_Mechanics/CLI/bestiary/undead/skeleton-xmm|skeletons]] leap from the alcoves and attack.
...
Three of the alcoves contain nothing of value. A loose flagstone in the southeast alcove covers a hidden cubbyhole in the floor, in which is hidden a moldy sack containing 150 ep. The coins have the profiled visage of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] stamped on them. A character who searches the alcove can find the loose flagstone with a successful DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check.
...
If he has not been defeated elsewhere, [[/03_Mechanics/CLI/bestiary/npc/rahadin-cos|Rahadin]] (see appendix D) is here, waiting for the characters to arrive so he can kill them.

A [[/03_Mechanics/CLI/bestiary/fiend/shadow-demon-xmm|shadow demon]] also haunts this room. In the round after the characters engage [[/03_Mechanics/CLI/bestiary/npc/rahadin-cos|Rahadin]], the demon leaps out and attacks the nearest character from behind. The character doesn't notice the demon, unless the character's passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score meets or exceeds the demon's Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check. Both [[/03_Mechanics/CLI/bestiary/npc/rahadin-cos|Rahadin]] and the shadow demon fight until slain.
...
![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/042-cos04-17.webp#center|Map: Traps in Area K73]]
...
The rusty iron door connecting this hall to area K73 is submerged in 5 feet of water and requires a successful DC 10 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check to open.
...
Scattered across the floor of this cell are 3,000 ep. The coins have the profiled visage of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] stamped on them. A character can scoop up one hundred coins every minute.
...
Scattered across the floor of this cell are 300 pp. The coins have the profiled visage of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] stamped on them. A character can scoop up one hundred coins every minute.
...
A search of the corpse yields a sheathed [[/03_Mechanics/CLI/items/longsword-xphb|longsword]] and two belt pouches, one containing five gemstones (50 gp each) and the other containing a [[/03_Mechanics/CLI/items/potion-of-heroism-xdmg|potion of heroism]].
...
A secret door is 5 feet up from the floor on the north wall of this cell. The secret door can't be opened from this side without the use of a [[/03_Mechanics/CLI/spells/knock-xphb|knock]] spell or similar magic. Behind the secret door is a chute of polished black marble that slants upward (area K82).
...
Clinging to the floor of this cell is a [[/03_Mechanics/CLI/bestiary/ooze/gray-ooze-xmm|gray ooze]] that attacks anything that enters. While underwater, the ooze is effectively [[/03_Mechanics/CLI/conditions#Invisible|invisible]].
...
The source of the underwater glow is a sentient lawful good [[/03_Mechanics/CLI/items/1-weapon-xdmg|+1 shortsword]] (Intelligence 11, Wisdom 13, Charisma 13). It has hearing and normal vision out to a range of 120 feet. It communicates by transmitting emotion to the creature carrying or wielding it.
...
- While attuned to the weapon, the sword's wielder can use the sword to cast the [[/03_Mechanics/CLI/spells/crusaders-mantle-xphb|crusader's mantle]] spell. Once used, this property of the sword can't be used again until the next dawn.  
...
The man is [[/03_Mechanics/CLI/bestiary/npc/emil-toranescu-cos|Emil Toranescu]], a [[/03_Mechanics/CLI/bestiary/monstrosity/werewolf-xmm|werewolf]] with 72 hit points. He claims to be a resident of Vallaki who was chased by dire wolves to the castle. He begs the characters to rescue him, offering to help them in exchange.

![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/043-cos04-18.webp#center|Emil Toranescu]]
...
Scattered across the floor of this cell are 2,100 ep. The coins have the profiled visage of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] stamped on them. A character can scoop up one hundred coins every minute.
...
This cell is linked to a teleport trap in area K73. The skeletal remains of a dwarf fighter lie at the bottom of the cell, enclosed in rusted plate armor. The dwarf's nonmagical but usable [[/03_Mechanics/CLI/items/battleaxe-xphb|battleaxe]] lies nearby.
...
As soon as one or more characters move more than 10 feet into the room, six [[/03_Mechanics/CLI/bestiary/undead/strahd-zombie-cos|Strahd zombies]] rise slowly out of the water, their slime-gray arms clawing upward through the water as they attack.

![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/044-cos04-19.webp#center)
...
The brazier's flame is magical and sheds no warmth. A successful casting of [[/03_Mechanics/CLI/spells/dispel-magic-xphb|dispel magic]] (DC 16) extinguishes the flame for 1 hour. The fire is permanently extinguished if the brazier is destroyed. The brazier has AC 17, 25 hit points, immunity to poison and psychic damage, and resistance to all other damage.
...
Inscribed on the landing, hidden under years of dust, is a [[/03_Mechanics/CLI/spells/glyph-of-warding-xphb|glyph of warding]]. If the characters brush away the dust, someone can spot the glyph with a successful DC 15 Intelligence ([[/03_Mechanics/CLI/skills#Investigation|Investigation]]) check.

The glyph triggers the first time a living creature passes over it. Triggering it activates a [[/03_Mechanics/CLI/spells/major-image-xphb|major image]] spell, conjuring an illusion of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] that appears either halfway up the stairs leading to area K72 or halfway down the stairs leading to area K78, so that the vampire appears in front of the triggering character. When "Strahd" appears, read:
...
The catacombs are home to tens of thousands of bats. The bats hang here during daytime hours and fly out in the evening through the high tower's central shaft (area K18a) to hunt at night. They will not attack intruders unless they are provoked or are specifically commanded to do so by Strahd. If one or more bats within a 10-foot square on the map are attacked or caught in the area of a harmful spell, `2d4` [[/03_Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm|swarms of bats]] form in that area and attack. No more swarms can be formed in that square until the next dawn, when more bats arrive to replenish those that were killed.

#### Teleport Traps

Invisible teleport traps are located between crypts 37 and 38, between crypt 37 and the wall south of it, and between crypt 38 and the wall south of it. The traps can't be perceived except with a [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell, which reveals an aura of conjuration magic in the trapped areas. Although the traps can't be disarmed, a successful casting of [[/03_Mechanics/CLI/spells/dispel-magic-xphb|dispel magic]] (DC 16) on a trap suppresses its magic for 1 minute, allowing characters to move safely through its area. A trap is also suppressed while wholly or partly in the area of an [[/03_Mechanics/CLI/spells/antimagic-field-xphb|antimagic field]].

These teleport traps form a protective ring around the entrance to Strahd's tomb (area K86). Any creature that enters one of these 10-foot-square spaces is instantly teleported away, switching places with one of the [[/03_Mechanics/CLI/bestiary/undead/wight-xmm|wights]] in crypt 14. The wight materializes in the creature's previous location and attacks any living creature it sees.
...
Prince Ariel was a terrible man who longed to fly. He attached artificial wings to a harness and empowered the device with magic, but the apparatus still couldn't bear his weight, and he plunged from the Pillarstone of Ravenloft to his death. His evil [[/03_Mechanics/CLI/bestiary/undead/ghost-xmm|ghost]] attacks the characters on sight. If Ariel succeeds in possessing a character, his host climbs the high tower (area K18) until it reaches the peak (area K59), then hurls itself down the tower's central shaft (area K18a), screaming, "I can fly!" the whole way down.
...
A [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell reveals that the thighbone radiates an aura of evocation magic. See appendix C for more information on [[/03_Mechanics/CLI/items/saint-markovias-thighbone-cos|Saint Markovia's thighbone]].
...
Endorovich's spirit is trapped inside one of the gargoyles. If anyone disturbs the bones on the slab, one of the [[/03_Mechanics/CLI/bestiary/elemental/gargoyle-xmm|gargoyles]] awakens and attacks. If the gargoyle is reduced to 0 hit points, Endorovich's spirit moves to the second gargoyle, which then awakens and attacks. Both gargoyles have maximum hit points (77). Once the second [[/03_Mechanics/CLI/bestiary/elemental/gargoyle-xmm|gargoyle]] is destroyed, Endorovich's spirit is laid to rest.
...
If [[/03_Mechanics/CLI/bestiary/npc/pidlwick-ii-cos|Pidlwick II]] (see area K59) is with the party, it refuses to enter the crypt. The slab in this crypt is 4 feet long (instead of the usual 6 feet long). The bones atop the slab belong to the fool servant of Duchess Dorfniya Dilisnya (see crypt 8).

##### Treasure

If the characters explore this crypt after summoning the ghost of Pidlwick in area K36, they find a small, flat wooden box on the marble slab next to Pidlwick's bones. The box contains a full [[/03_Mechanics/CLI/items/deck-of-illusions-xdmg|deck of illusions]].
...
The stoppered drinking horn is a water-resistant [[/03_Mechanics/CLI/items/gunpowder-powder-horn-xdmg|powder horn]] loaded with gunpowder, and the "weird-looking scepter" is a [[/03_Mechanics/CLI/items/musket-xphb|musket]]. The fat pouch contains 20 silver marbles (silvered bullets for the musket). For more information on firearms and explosives, see chapter 9, ""Dungeon Master's Workshop"," of the "Dungeon Master's Guide".
...
The glider has AC 12, 1 hit point, and a 15-foot wingspan. Any damage causes it to break and become inoperable. A [[/03_Mechanics/CLI/spells/mending-xphb|mending]] cantrip can repair the damage, provided all the broken pieces are present.
...
This vault contains fifteen [[/03_Mechanics/CLI/bestiary/undead/wight-xmm|wights]] (one per coffin), minus any that have been teleported away (see "Teleport Traps" at the start of this section). Lifting a coffin's lid requires an action and a successful DC 15 Strength check.

Each wight remains inactive until it is teleported away or until its coffin is opened, whereupon it attacks.

The bones and rusty swords cover the floor to a depth of 6 inches, and are the remains of servants who swore to avenge Stahbal Indi-Bhak's family. Whenever a wight is killed in this vault, some of the bones knit together, forming `2d6` animated human [[/03_Mechanics/CLI/bestiary/undead/skeleton-xmm|skeletons]]. These skeletons attack intruders on sight but have no ranged attacks. There are enough bones and swords in the room for one hundred skeletons to form in this manner.
...
The skull's [[/03_Mechanics/CLI/items/black-opal-xdmg|black opal eye-gems]] are worth 1,000 gp apiece. The skull also has eight amber teeth worth 100 gp each.

Any creature that stands inside the crypt and boldly speaks the name "Khazan" causes the Pillarstone of Ravenloft to tremble as a [[/03_Mechanics/CLI/items/staff-of-power-xdmg|staff of power]] materializes above the marble slab and hovers in place. The first creature to grab hold of the staff must make a DC 17 Constitution saving throw, taking 44 (`8d10`) lightning damage on a failed save, or half as much damage on a successful one. Afterward, the [[/03_Mechanics/CLI/items/staff-of-power-xdmg|staff of power]] can be held and used normally. If no one grabs the staff within 1 round of its appearance, it vanishes, never to return.
...
The stone door of this crypt has been carefully laid to one side. Through the swirly mists of the perpetual fog, freshly engraved letters spell out the words "[[/03_Mechanics/CLI/bestiary/npc/ireena-kolyana-cos|Ireena Kolyana]]: Wife."
...
This [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] is an old wife of Strahd's. Once she realizes that the characters aren't her husband, Sasha tears away her web shroud like an unloved wedding dress and attacks.
...
The spectral elf is a [[/03_Mechanics/CLI/bestiary/undead/banshee-xmm|banshee]] that attacks the characters on sight, using her wail immediately. Once awakened, the banshee is free to roam Castle Ravenloft, but she can't travel more than 5 miles from this crypt.

In life, [[/03_Mechanics/CLI/bestiary/npc/patrina-velikovna-cos|Patrina Velikovna]] was a dusk elf who, having learned a great deal about the black arts, was nearly a match for Strahd's powers. She felt a great bond with him and asked to solemnize that bond in a dark marriage. Drawn to her knowledge and power, Strahd consented, but before he could drain all life from Patrina, her own people stoned her to death in an act of mercy to thwart Strahd's plans. Strahd demanded, and got, Patrina's body. She then became the banshee trapped here.

Reducing the banshee to 0 hit points causes it to discorporate. Patrina's spirit can't rest, however, until she is formally wed to Strahd; the banshee re-forms in her crypt 24 hours later. Casting a [[/03_Mechanics/CLI/spells/hallow-xphb|hallow]] spell on the crypt prevents the banshee from returning for as long as the spell lasts.
...
A [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell cast here reveals that Stefan's skull radiates a faint aura of necromancy magic. As long as the skull remains in the crypt, it will answer up to five questions put to it, as though a [[/03_Mechanics/CLI/spells/speak-with-dead-xphb|speak with dead]] spell had been cast on it. This property recharges each day at dawn. In life, Stefan was neither observant nor well informed. If the skull is questioned about Strahd or Castle Ravenloft, all the information it provides is untrue.
...
A [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell cast here reveals that Intree's skull radiates a faint aura of necromancy magic. As long as the skull remains in the crypt, it will answer up to five questions put to it, as though a [[/03_Mechanics/CLI/spells/speak-with-dead-xphb|speak with dead]] spell had been cast on it. This property recharges each day at dawn. Unlike Stefan Gregorovich in crypt 25, Intree was well educated and astute. If the skull is questioned about Strahd or the castle, the information it provides is true.
...
Three [[/03_Mechanics/CLI/bestiary/beast/giant-wolf-spider-xmm|giant wolf spiders]] infest this otherwise empty crypt. The spiders make no noise and leap out to attack anyone who moves in front of the crypt's gaping doorway.
...
A patch of [[/03_Mechanics/CLI/traps-hazards/brown-mold-xdmg|brown mold]] (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide") fills the crypt. Characters within 5 feet of the crypt's open doorway are affected.
...
Hidden under the brown mold next to the baron's bones is a [[/03_Mechanics/CLI/items/luck-blade-xdmg|luck blade]] with one wish remaining. If a creature uses the wish to try to escape from Barovia, the spell fails. If a creature uses the sword to wish for Strahd's destruction, the wish doesn't destroy Strahd but rather teleports him to within 5 feet of the sword.
...
The floor of the crypt is actually the cover of a 30-foot-deep spiked pit. The cover opens if 100 pounds of weight or more are placed on it. It splits down the middle, east to west, and its doors are spring-loaded. After a victim or victims fall into the pit, its doors snap shut. (See ""Sample Traps"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide" the rules on locking pits and spiked pits.) The spikes at the bottom of the pit are made of iron but aren't [[/03_Mechanics/CLI/conditions#Poisoned|poisoned]].

##### Treasure

A human skeleton (the remains of a dead adventurer) wrapped in bits of studded leather armor lies amid the spikes at the bottom of the pit. A shattered lantern and a rusty [[/03_Mechanics/CLI/items/crowbar-xphb|crowbar]] lie nearby. Tied to the corpse's leather belt is a [[/03_Mechanics/CLI/items/rope-xphb|50-foot coil of hempen rope]], a [[/03_Mechanics/CLI/items/dagger-xphb|dagger]] in a worn scabbard, a pouch containing 25 pp, and a stoppered wooden tube containing a [[/03_Mechanics/CLI/items/spell-scroll-xdmg|spell scroll]] of [[/03_Mechanics/CLI/spells/magic-circle-xphb|magic circle]].
...
A [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell reveals that both alcoves radiate strong auras of conjuration magic.
...
If the sword is pulled from the armor, Sir Klutz appears as a [[/03_Mechanics/CLI/bestiary/undead/phantom-warrior-cos|phantom warrior]] (see appendix D), thanks whoever pulled his weapon free, and agrees to fight alongside that character for the next seven days. Sir Klutz perished years before Strahd became a vampire, so the phantom warrior knows nothing of Strahd's downfall or the curse afflicting Barovia.
...
An [[/03_Mechanics/CLI/conditions#Invisible|invisible]] [[/03_Mechanics/CLI/bestiary/fiend/imp-xmm|imp]] is perched atop the owlbear. If someone tries to open the sarcophagus, the imp says in Common, "I wouldn't do that if I were you!" The imp is magically bound to King Dostron's remains and must watch over them for several more centuries before its contract are fulfilled. It isn't obligated to protect the contents of the crypt (so it will not attack), and it delights in telling lies and engaging in mischief. For instance, it warns the characters that the sarcophagus is trapped, and that opening the lid will free a pit fiend bound within.
...
The floor here is an illusion that hides a 20-foot-deep pit. The sides of the pit are polished smooth; a creature without a climbing speed can't move along them without the aid of magic or a climber's kit. At the bottom of the pit are six starving [[/03_Mechanics/CLI/bestiary/undead/ghoul-xmm|ghouls]]. A permanent [[/03_Mechanics/CLI/spells/silence-xphb|silence]] spell suppresses sound in the pit. The silence can be dispelled, as can the illusory floor (DC 14 for both).

##### Treasure

Sir Jarnwald was "entombed" here, so far as he was pushed into the crypt and devoured by the ghouls. What remains of him lies scattered on the pit floor: a few scraps of clothing, a handful of teeth, and a [[/03_Mechanics/CLI/items/signet-ring|signet ring]] that bears a stylized "J" (worth 25 gp).
...
The compartment under the slab holds a small, black leather case containing three [[/03_Mechanics/CLI/items/spell-scroll-xdmg|spell scrolls]] ([[/03_Mechanics/CLI/spells/cone-of-cold-xphb|cone of cold]], [[/03_Mechanics/CLI/spells/fireball-xphb|fireball]], and [[/03_Mechanics/CLI/spells/lightning-bolt-xphb|lightning bolt]]).
...
A [[/03_Mechanics/CLI/spells/mending-xphb|mending]] cantrip can repair the spear, which is broken into three pieces of roughly equal length. If repaired, it can be wielded as a silvered, nonmagical spear.
...
The [[/03_Mechanics/CLI/bestiary/fiend/nightmare-xmm|nightmare]], [[/03_Mechanics/CLI/bestiary/npc/beucephalus-cos|Beucephalus]], is Strahd's steed. It has 104 hit points. If the characters slay it, Strahd hunts them down mercilessly. When the steed wants to leave the castle, it flies up the central shaft of the high tower (area K18a), exiting through the gash in the tower roof (area K59).
...
Sergei's embalmed body is clothed in shining [[/03_Mechanics/CLI/items/2-armor-xdmg|+2 plate armor]].

#### Fortunes of Ravenloft

If your card reading reveals that a treasure is here, it is inside the coffin next to Sergei's body.

If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is lying across Sergei's coffin, weeping.
...
Lying under the earth near the east wall of the tomb are three [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] brides dressed in soiled gowns and wearing dirt-encrusted jewelry (see "Treasure" below). They rise to attack anyone who approaches Strahd's coffin.

A [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell reveals that the western and eastern alcoves radiate strong auras of conjuration magic. The central alcove is nonmagical.
...
[[/03_Mechanics/CLI/bestiary/npc/ludmilla-vilisevic-cos|Ludmilla Vilisevic]] wears a soiled white wedding gown, a gold tiara (worth 750 gp), and ten gold bracelets (worth 100 gp each).

[[/03_Mechanics/CLI/bestiary/npc/anastrasya-karelova-cos|Anastrasya Karelova]] wears a stained and tattered red wedding gown, a black and crimson silk head scarf sewn with precious jewels (worth 750 gp), and a platinum necklace with a black opal pendant (worth 1,500 gp).

[[/03_Mechanics/CLI/bestiary/npc/volenta-popofsky-cos|Volenta Popofsky]] wears a faded gold wedding gown, a platinum mask shaped vaguely like a skull (750 gp), and ten platinum rings set with gemstones (worth 250 gp each).
...
If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is in his coffin, ready to attack anyone who opens the lid.
...
![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/045-cos04-21.webp#center|King Barov and Queen Ravenovia]]
...
If your card reading indicates an encounter with [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] in this area, he is in a frenzy of rage and despair.
