...
improvements: 20
status: active
aliases: ["Mechanics Cli Books Players Handbook 2024 02 Chapter 1 Playing the Game#advantage Disadvantage"]
priority: normal
category: 05 Rules
subcategory: Mechanics Cli Books Players Handbook 2024 02 Chapter 1 Playing The Game#Advantage Disadvantage.Md
related: []
cssclass: standard
publish: false
...
- Connections to overarching campaign themes ## Plot Hooks - A journal reveals ancient history about the government

- A corpse reveals a betrayal about this place
- A map reveals a conspiracy about this place ## Examples of Play ### Basic Example
...
Elena tries to jump while carrying an unconscious ally in heavy rain. DC increases to 15, disadvantage, and STR check to not drop ally. ## Quick Reference | Situation | Roll | DC | Effect on Failure |
