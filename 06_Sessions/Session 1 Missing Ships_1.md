...
> "The Merchant's Covet has posted a reward of 500 gold pieces for information leading to the recovery of their vessels. The Harbor Master may have additional resources for the right people."
...
**Discovery**: A concealed pressure hatch leading to a maintece tunnel system.
...
**Trigger**: If the party enters the maintece tunnels or investigates too far from the main pier.
...
- **Tactics**: Uses lair (maintece tunnels) to advantage, attacks from multiple directions
...
By order of the Merchant's Covet and Harbor Authority:
