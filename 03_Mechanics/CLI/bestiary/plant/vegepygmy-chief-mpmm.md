...
As a [vegepygmy](/03_Mechanics/CLI/bestiary/plant/vegepygmy-mpmm.md) ages, it grows tougher and develops spore clusters on its body. Other vegepygmies defer to these so-called chiefs. A chief can expel its spores in a burst, infecting nearby creatures. If a creature dies while infected, its corpse produces vegepygmies the same way [russet mold](/03_Mechanics/CLI/traps-hazards/russet-mold-vgm.md) does.
...
"cr": "2"
"traits":
  - "desc": "The vegepygmy has advantage on Dexterity ([Stealth](/03_Mechanics/CLI/skills.md#Stealth))\
...
"actions":
  ...
  - "desc": "A 15-foot-radius cloud of toxic spores extends out from the vegepygmy.\
      ...
      \ Plant must succeed on a DC 12 Constitution saving throw or be [poisoned](/03_Mechanics/CLI/conditions.md#Poisoned).\
      \ While [poisoned](/03_Mechanics/CLI/conditions.md#Poisoned) in this way, a target\
...
"source":
  - "MPMM"
  - "VGM"
"image": "/03_Mechanics/CLI/bestiary/plant/token/vegepygmy-chief-mpmm.webp"
```
^statblock
...
Vegepygmy chief mpmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
