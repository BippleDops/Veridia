...
- **Exhaustion.** The obstacle fatigues the characters, causing them to gain [Exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion) levels. For example, marching through a blizzard instead of taking shelter might cause each character to gain `d4` [Exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion) levels.  
