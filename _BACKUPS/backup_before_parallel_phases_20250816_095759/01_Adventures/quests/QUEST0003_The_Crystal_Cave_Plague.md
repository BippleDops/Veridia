...
## Quest Giver
**Dara Goldleaf** - Military officer
...
## Key Locations
- **WestHaven** (City): Key location for quest progression
- **Hillton** (Dungeon): Key location for quest progression
- **Valeton** (Wilderness): Key location for quest progression
...
- **Gold**: 501 gp
- **Experience**: 1,000 XP
- **Magic Items**: Divine Blade of Power
