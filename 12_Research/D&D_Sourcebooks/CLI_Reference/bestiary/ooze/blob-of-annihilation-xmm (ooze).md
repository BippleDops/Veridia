...
"cr": "23"
"traits":
  - "desc": "If the blob is reduced to 0 [[hit-points-xphb (variant-rules)]],\
...
"actions":
  ...
  - "desc": "Melee Attack Roll: +15, reach 30 ft. Hit: 24 (3d10 + 8) Force damage."
    "name": "Pseudopod"
  - "desc": "The blob moves up to its [[Fly Speed Xphb]]\
      ...
      \ creature that is reduced to 0 [[hit-points-xphb (variant-rules)]]\
