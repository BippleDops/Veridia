...
## Quest Giver
**Gareth Darkwater** - Dying adventurer
...
## Key Locations
- **OldHill** (City): Key location for quest progression
- **NewHill** (Dungeon): Key location for quest progression
- **FortHill** (Wilderness): Key location for quest progression
