...
"traits":
  - "desc": "While [Bloodied](/03_Mechanics/CLI/variant-rules/bloodied-xphb.md), the\
      \ boar has [Advantage](/03_Mechanics/CLI/variant-rules/advantage-xphb.md) on\
      \ attack rolls."
    "name": "Bloodied Fury"
"actions":
  - "desc": "Melee Attack Roll: +3, reach 5 ft. Hit: 4 (1d6 + 1) Piercing damage.\
      ...
      \ (d6) Piercing damage and has the [Prone](/03_Mechanics/CLI/conditions.md#Prone)\
      \ condition."
    "name": "Gore"
"source":
  - "XMM"
  - "XPHB"
"image": "/03_Mechanics/CLI/bestiary/beast/token/boar-xmm.webp"
```
^statblock
...
Boar xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of boar xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around boar xmm.

## Adventure Hooks

- A rumor ties boar xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at boar xmm to avert a public scandal.
- A map overlay reveals a hidden approach to boar xmm active only during specific tides/storms.
