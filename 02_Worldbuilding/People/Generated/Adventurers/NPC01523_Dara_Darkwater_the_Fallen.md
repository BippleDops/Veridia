...
## Appearance
Average height and stocky, with Shaved gray hair and Heterochromic eyes. Dark skin. Missing finger on left hand.
...
## Current Situation
- **Occupation**: Monster slayer
- **Resources**: Treasure maps, Magic items, Monster lore
...
### Felicia Stormwind the Fallen (Criminal - Handler)
...
- Longbow: +5 to hit, 1d8+4 piercing
...
- Uncanny Dodge: Half damage from one attack
- Spellcasting: 7 spell slots, knows Shield, Misty Step, Counterspell, Fly, Hold Person, Lightning Bolt, Charm Person, Scorching Ray
