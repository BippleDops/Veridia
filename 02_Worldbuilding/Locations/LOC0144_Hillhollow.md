...
## Important NPCs
- **Ewan Wolfsbane the Cunning** - Guard Captain: Key figure in local affairs
- **Fiora Wolfsbane the Cunning** - Innkeeper: Key figure in local affairs
- **Gareth Wolfsbane** - Merchant: Key figure in local affairs
