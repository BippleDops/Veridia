...
**Atmosphere**: Gloomy atmosphere where an eerie silence hangs in the air
...
## Important NPCs
- **Vera Dragonheart the Ancient** - Innkeeper: Key figure in local affairs
- **Willem Dragonheart** - Merchant: Key figure in local affairs
- **Xara Dragonheart** - Priest: Key figure in local affairs
...
### Trade
- **Exports**: Textiles, Weapons
- **Imports**: Medicines, Rare metals
