...
When [Strahd](/3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos.md) is reduced to 0 hit points, he turns to mist and retreats to his coffin (see the Misty Escape feature in the [vampire](/3-Mechanics/CLI/bestiary/undead/vampire-xmm.md) stat block). The vampire must be in his resting place to be utterly destroyed.
...
Upon his death, Strahd's [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) are freed from his control, and each seeks a new destiny. [Escher](/3-Mechanics/CLI/bestiary/npc/escher-cos.md), in particular, leaves the realm, in search of new experiences and a way to become a vampire lord himself.
