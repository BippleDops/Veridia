...
priority: normal
category: 05 Rules
subcategory: Initiative Tracker.Md
related: []
cssclass: standard
publish: false
...
- Connections to overarching campaign themes ## Secret Connections *[Hidden from players]* Connected to The Veiled Alliance - Manipulate succession ## Plot Hooks - A corpse reveals ancient history about this place

- A corpse reveals the truth about the government
- Someone is protecting a artifact for love
- A merchant needs help stealing before the new moon ## Quick Reference | Situation | Roll | DC | Effect on Failure |
