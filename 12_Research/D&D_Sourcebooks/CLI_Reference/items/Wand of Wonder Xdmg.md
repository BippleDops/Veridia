...
| dice: 1d100 | Effect |
|-------------|--------|
| 01-20 | You cast a spell originating from the chosen point. Roll `d10` to determine the spell: on a **1-2**, [[darkness-xphb|Darkness]]; on a **3-4**, [[faerie-fire-xphb|Faerie Fire]]; on a **5-6**, [[fireball-xphb|Fireball]]; on a **7-8**, [[slow-xphb|Slow]]; on a **9-10**, [[stinking-cloud-xphb|Stinking Cloud]]. |
...
| 93-97 | You cast [[polymorph-xphb|Polymorph]], targeting the creature closest to the chosen point of origin. Roll `d4` to determine the target's new form. On a **1**, the new form is a [[black-bear-xmm|Black Bear]]; on a **2**, the new form is a [[giant-wasp-xmm|Giant Wasp]]; on a **3-4**, the new form is a [[frog-xmm|Frog]]. |
