...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Surface Signals (D&D Statblocks)"]
status: active
priority: normal
...
accessibility: screen_reader_summary: Surface Signals is a notable location in Aquabyssos shaped by tidal politics and Convergence anomalies. This entry is structured for fast table use. Content_warnings: - political coercion - environmental hazards pronunciation: Surface Signals safety_tools: - Lines & Veils - X-Card - Open Door

--- # Surface Signals *The crackling voices from the world above the waves* ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Overview Surface Signals is both a location and a phenomenon—a series of crystalline receiver stations scattered throughout the upper reaches of Aquabyssos that intercept communications from the surface world. These stations, built by an unknown civilization, translate electromagnetic waves into pressure vibrations that can be understood underwater, creating windows into the air-breathing world above. The primary station, located in the Twilight Reaches just 500 feet below the surface, has become a pilgrimage site for those seeking news of the surface, messages from lost loved ones, or intelligence about the world above the waves. However, the signals received are not always from the present—some come from the past, others from the future, and some from surfaces that may not exist in this reality. ### Types of Transmissions **Contemporary Broadcasts**
...
- Weather warnings and navigation data **Temporal Echoes**
...
- Victory announcements from wars not yet fought **Dimensional Bleed**
...
- Messages from surfaces that are underwater **Consciousness Streams**
- Dying thoughts of drowning sailors
- Dreams of surface dwellers about the ocean
- Collective unconscious of coastal cities
- Prayers to sea gods
- Love letters never sent to those below ### Signal Patterns **The Dawn Chorus**
...
- Whale songs from above the water **The Midnight Static**
...
- Thunder as divine communication ### The Primary Station **The Resoce Cathedral**
...
- **Age**: Predates recorded history **Architectural Features**:
...
- Reality filters to separate dimensional signals ### Secondary Stations **The Echo Pods**
...
| Echo-27 | Divine broadcasts | Burns heretics | ### The Broken Transmitter A destroyed station that still receives but can also send:
...
- **Emergency Broadcast (Costs 2 Actions).** Send a message to any receiver within 100 miles. ### The Transcribers Monks who dedicate their lives to recording signals:
...
- Eventually become living receivers ### The Code Breakers Specialists in encrypted or alien transmissions:

- Speak in mathematical equations
- Think in probability clouds
- Can decrypt reality itself
- Sometimes break from too much truth
- Know codes that haven't been invented ### Signal Addicts People who've become dependent on surface signals:
...
- Eventually merge with stations ### Historical Significance **The Last Day Broadcasts**
...
- Then sudden silence **The Frequency Wars**
...
- Victory claimed by all sides **The God Calls**
...
- Divine arguments on open channels ### Current Intelligence **Surface Politics**
...
- Exploration ships seeking the depths **Economic Data**
...
- Market crashes before they happen **Personal Messages**
...
- Messages in bottles electronically ### The Prophecy Frequencies
...
- Next century's certainties ### The Memory Channels
...
- Civilizations before the waters ### The Dream Bandwidth
...
- Prophetic dreams becoming real ### The Silence Between
...
- The voice of the void ### Information Brokerage **Signal Intelligence Packages**:
...
- **Dimensional Tuning** (1,000 gp/session): Alternate surface access ### Communication Services **Surface Messaging** (Limited availability):
...
- Complete loss of self to signal stream ### Infectious Transmissions
...
- Reality errors that corrupt existence ### Temporal Paradoxes
...
- Existence failures ### The Watchers
...
- Things that shouldn't exist but do ### The Drowning Forecast

The stations begin broadcasting a massive catastrophe that will sink another surface city in seven days. The party must decide whether to warn them, knowing that surface contact is forbidden and might cause the very disaster they're trying to prevent. ### The Love Frequency

A noble offers vast wealth to maintain communication with their surface lover through the broken transmitter. But each message sent changes reality slightly, and the changes are becoming dangerous. ### The Silent Station

Echo-13 has gone completely silent for the first time in recorded history. The last transmission was a single word: "Run." Investigation reveals something is consuming the signals themselves. ### The God Wave

A new frequency appears claiming to be a surface god offering to raise Aquabyssos back to the surface. But the price is forgetting the centuries underwater, erasing all current culture and identity. ### The Revolution Broadcast

Someone is using the stations to coordinate a simultaneous uprising across all of Aquabyssos. The signals are coming from the future, describing a revolution that hasn't happened yet—unless someone stops it. ### The Truth About Surface Signals The signals aren't from the surface at all. They're from Aquabyssos itself—from potential futures where the city rose again. Every broadcast is a possibility, a maybe, a could-be. The stations don't receive; they dream. The "surface world" being monitored doesn't exist yet. It's the collective unconscious of Aquabyssos imagining what could be if they ever escape the depths. The signals are prophecies disguised as news, hopes disguised as intelligence, fears disguised as warnings. Those who discover this truth face a choice: maintain the comforting lie that a surface world exists, or reveal that Aquabyssos might be more alone than anyone imagined. ### Running Surface Signals **Information Management**:

- Use signals to introduce plot hooks
- Provide conflicting information
- Create urgency through "breaking news"
- Foreshadow events through future signals
- Mislead through alternate dimension broadcasts **Signal Content Generation**:
...
20: Something impossible **Addiction Mechanics**:
- Track exposure hours
- Constitution saves after extended listening
- Gradual dependency development
- Physical and mental symptoms ### Campaign Integration Surface Signals serves as:
