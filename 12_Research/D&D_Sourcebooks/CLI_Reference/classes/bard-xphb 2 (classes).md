...
**Starting Equipment:** *Choose A or B:* (A) [[studded-leather-armor-xphb (items)]], 2 [[Dagger Xphb]], [[musical-instrument-xphb (items)]] of your choice, [[entertainers-pack-xphb (items)]], 19 GP; or (B) 90 GP
...
As a [[Action Xphb]], you can inspire another creature within 60 feet of yourself who can see or hear you. That creature gains one of your Bardic Inspiration dice. A creature can have only one Bardic Inspiration die at a time.

Once within the next hour when the creature fails a [[d20-test-xphb (variant-rules)]], the creature can roll the Bardic Inspiration die and add the number rolled to the `d20`, potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.
...
You know two cantrips of your choice from the Bard spell list. [[dancing-lights-xphb (spells)]] and [[Vicious Mockery Xphb]] are recommended.
...
You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Bard spell list. [[Charm Person Xphb]], [[color-spray-xphb (spells)]], [[dissot-whispers-xphb|Dissot Whispers]], and [[mass-healing-word-xphb (spells)]] are recommended.
...
You can use a [[musical-instrument-xphb (items)]] as a [[spellcasting-focus-xphb (variant-rules)]] for your Bard spells.

### Expertise (Level 2)

You gain [[Expertise Xphb]] in two of your skill proficiencies of your choice. [[skills#Performance|Performance]] and [[skills#Persuasion|Persuasion]] are recommended if you have proficiency in them.
...
For example, if you make a Strength ([[skills#Athletics|Athletics]]) check and lack [[skills#Athletics|Athletics]] proficiency, you can add half your [[Proficiency Xphb]] to the check.
...
You gain the [[Ability Score Improvement Xphb]] feat or another feat of your choice for which you qualify. You gain this feature again at Bard levels 8, 12, and 16.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [[boon-of-spell-recall-xphb (feats)]] is recommended.

### Words of Creation (Level 20)

You have mastered two of the Words of Creation: the words of life and death. You therefore always have the [[Power Word Heal Xphb]] and [[power-word-kill-xphb (spells)]] spells prepared. When you cast either spell, you can target a second creature with it if that creature is within 10 feet of the first target.

## Player-Facing Summary

Bard xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
