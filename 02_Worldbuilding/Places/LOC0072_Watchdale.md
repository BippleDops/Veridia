...
**Atmosphere**: Mysterious atmosphere crackling with barely contained conflict
...
## Important NPCs
- **Magnus Ravencrest** - Guard Captain: Key figure in local affairs
- **Nora Ravencrest the Swift** - Innkeeper: Key figure in local affairs
