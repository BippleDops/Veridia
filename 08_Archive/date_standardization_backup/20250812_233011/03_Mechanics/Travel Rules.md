...
## Summary
Practical, table-ready rules for Travel Rules across Aquabyssos and Aethermoor.
...
Travel Rules is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of Travel Rules as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Travel Rules.

## Adventure Hooks

- A rumor ties Travel Rules to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at Travel Rules to avert a public scandal.
- A map overlay reveals a hidden approach to Travel Rules active only during specific tides/storms.
