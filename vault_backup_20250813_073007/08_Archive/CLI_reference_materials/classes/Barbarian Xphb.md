...
- world/both
type: note
updated: '2025-08-13T12:34:19.075735+00:00'
world: Both
---
...
- **Skill Proficiencies**: *Choose 2:* [[/03_Mechanics/CLI/skills#Animal%20Handling|Animal Handling]], [[/03_Mechanics/CLI/skills#Athletics|Athletics]], [[/03_Mechanics/CLI/skills#Intimidation|Intimidation]], [[/03_Mechanics/CLI/skills#Nature|Nature]], [[/03_Mechanics/CLI/skills#Perception|Perception]], or [[/03_Mechanics/CLI/skills#Survival|Survival]]
- **Weapon Proficiencies**: Simple weapons and Martial weapons
- **Armor Training**: [[/03_Mechanics/CLI/item-types#Light%20Armor|Light armor]], [[/03_Mechanics/CLI/item-types#Medium%20Armor|Medium armor]], and [[/03_Mechanics/CLI/items/shield-xphb|Shields]]

**Starting Equipment:** *Choose A or B:* (A) [[/03_Mechanics/CLI/items/greataxe-xphb|Greataxe]], 4 [[/03_Mechanics/CLI/items/handaxe-xphb|Handaxes]], [[/03_Mechanics/CLI/items/explorers-pack-xphb|Explorer's Pack]], and 15 GP; or (B) 75 GP

## Multiclassing Barbarian

- **Weapon Proficiencies**: Martial weapons
- **Armor Training**: [[/03_Mechanics/CLI/items/shield-xphb|Shields]]
...
You can imbue yourself with a primal power called Rage, a force that grants you extraordinary might and resilience. You can enter it as a [[/03_Mechanics/CLI/variant-rules/bonus-action-xphb|Bonus Action]] if you aren't wearing Heavy armor.

You can enter your Rage the number of times shown for your Barbarian level in the Rages column of the Barbarian Features table. You regain one expended use when you finish a [[/03_Mechanics/CLI/variant-rules/short-rest-xphb|Short Rest]], and you regain all expended uses when you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]].

While active, your Rage follows the rules below.

#### Damage Resistance

You have [[/03_Mechanics/CLI/variant-rules/resistance-xphb|Resistance]] to Bludgeoning, Piercing, and Slashing damage.

#### Rage Damage

When you make an attack using Strength—with either a weapon or an [[/03_Mechanics/CLI/variant-rules/unarmed-strike-xphb|Unarmed Strike]]—and deal damage to the target, you gain a bonus to the damage that increases as you gain levels as a Barbarian, as shown in the Rage Damage column of the Barbarian Features table.

#### Strength Advantage

You have [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]] on Strength checks and Strength saving throws.

#### No Concentration or Spells

You can't maintain [[/03_Mechanics/CLI/conditions#Concentration|Concentration]], and you can't cast spells.

#### Duration

The Rage lasts until the end of your next turn, and it ends early if you don Heavy armor or have the [[/03_Mechanics/CLI/conditions#Incapacitated|Incapacitated]] condition. If your Rage is still active on your next turn, you can extend the Rage for another round by doing one of the following:

- Make an attack roll against an enemy.  
- Force an enemy to make a saving throw.  
- Take a [[/03_Mechanics/CLI/variant-rules/bonus-action-xphb|Bonus Action]] to extend your Rage.  

Each time the Rage is extended, it lasts until the end of your next turn. You can maintain a Rage for up to 10 minutes.

### Unarmored Defense (Level 1)

While you aren't wearing any armor, your base [[/03_Mechanics/CLI/variant-rules/armor-class-xphb|Armor Class]] equals 10 plus your Dexterity and Constitution modifiers. You can use a [[/03_Mechanics/CLI/items/shield-xphb|Shield]] and still gain this benefit.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [[/03_Mechanics/CLI/variant-rules/weapon-mastery-properties-xphb|mastery properties]] of two kinds of Simple or Martial Melee weapons of your choice, such as [[/03_Mechanics/CLI/items/greataxe-xphb|Greataxes]] and [[/03_Mechanics/CLI/items/handaxe-xphb|Handaxes]]. Whenever you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]], you can practice weapon drills and change one of those weapon choices.

When you reach certain Barbarian levels, you gain the ability to use the [[/03_Mechanics/CLI/variant-rules/weapon-mastery-properties-xphb|mastery properties]] of more kinds of weapons, as shown in the Weapon Mastery column of the Barbarian Features table.

### Danger Sense (Level 2)

You gain an uncanny sense of when things aren't as they should be, giving you an edge when you dodge perils. You have [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]] on Dexterity saving throws unless you have the [[/03_Mechanics/CLI/conditions#Incapacitated|Incapacitated]] condition.

### Reckless Attack (Level 2)

You can throw aside all concern for defense to attack with increased ferocity. When you make your first attack roll on your turn, you can decide to attack recklessly. Doing so gives you [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]] on attack rolls using Strength until the start of your next turn, but attack rolls against you have [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]] during that time.
...
In addition, while your Rage is active, you can channel primal power when you attempt certain tasks; whenever you make an ability check using one of the following skills, you can make it as a Strength check even if it normally uses a different ability: [[/03_Mechanics/CLI/skills#Acrobatics|Acrobatics]], [[/03_Mechanics/CLI/skills#Intimidation|Intimidation]], [[/03_Mechanics/CLI/skills#Perception|Perception]], [[/03_Mechanics/CLI/skills#Stealth|Stealth]], or [[/03_Mechanics/CLI/skills#Survival|Survival]]. When you use this ability, your Strength represents primal power coursing through you, honing your agility, bearing, and senses.

### Ability Score Improvement (Level 4)

You gain the [[/03_Mechanics/CLI/feats/ability-score-improvement-xphb|Ability Score Improvement]] feat or another feat of your choice for which you qualify. You gain this feature again at Barbarian levels 8, 12, and 16.
...
Your instincts are so honed that you have [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]] on [[/03_Mechanics/CLI/variant-rules/initiative-xphb|Initiative]] rolls.

### Instinctive Pounce (Level 7)

As part of the [[/03_Mechanics/CLI/variant-rules/bonus-action-xphb|Bonus Action]] you take to enter your Rage, you can move up to half your [[/03_Mechanics/CLI/variant-rules/speed-xphb|Speed]].
...
If you use Reckless Attack, you can forgo any [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]] on one Strength-based attack roll of your choice on your turn. The chosen attack roll mustn't have [[/03_Mechanics/CLI/variant-rules/disadvantage-xphb|Disadvantage]]. If the chosen attack roll hits, the target takes an extra `d10` damage of the same type dealt by the weapon or [[/03_Mechanics/CLI/variant-rules/unarmed-strike-xphb|Unarmed Strike]], and you can cause one Brutal Strike effect of your choice. You have the following effect options.

#### Forceful Blow

The target is pushed 15 feet straight away from you. You can then move up to half your [[/03_Mechanics/CLI/variant-rules/speed-xphb|Speed]] straight toward the target without provoking [[/03_Mechanics/CLI/actions#Opportunity%20Attack|Opportunity Attacks]].

#### Hamstring Blow

The target's [[/03_Mechanics/CLI/variant-rules/speed-xphb|Speed]] is reduced by 15 feet until the start of your next turn. A target can be affected by only one Hamstring Blow at a time—the most recent one.
...
Your Rage can keep you fighting despite grievous wounds. If you drop to 0 [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Points]] while your Rage is active and don't die outright, you can make a DC 10 Constitution saving throw. If you succeed, your [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Points]] instead change to a number equal to twice your Barbarian level.

Each time you use this feature after the first, the DC increases by 5. When you finish a [[/03_Mechanics/CLI/variant-rules/short-rest-xphb|Short]] or [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]], the DC resets to 10.
...
The target has [[/03_Mechanics/CLI/variant-rules/disadvantage-xphb|Disadvantage]] on the next saving throw it makes, and it can't make [[/03_Mechanics/CLI/actions#Opportunity%20Attack|Opportunity Attacks]] until the start of your next turn.
...
When you roll [[/03_Mechanics/CLI/variant-rules/initiative-xphb|Initiative]], you can regain all expended uses of Rage. After you regain uses of Rage in this way, you can't do so again until you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]].

In addition, your Rage is so fierce that it now lasts for 10 minutes without you needing to do anything to extend it from round to round. Your Rage ends early if you have the [[/03_Mechanics/CLI/conditions#Unconscious|Unconscious]] condition (not just the [[/03_Mechanics/CLI/conditions#Incapacitated|Incapacitated]] condition) or don Heavy armor.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [[/03_Mechanics/CLI/feats/boon-of-irresistible-offense-xphb|Boon of Irresistible Offense]] is recommended.
