...
The [[/03_Mechanics/CLI/items/eye-of-vecna-xdmg|Eye of Vecna]] and the [[/03_Mechanics/CLI/items/hand-of-vecna-xdmg|Hand of Vecna]] are separate Artifacts that might be found together or separately. The eye looks like a bloodshot organ torn free from the socket. The hand is a shriveled left extremity.

## Random Properties of the Eye and Hand

The [[/03_Mechanics/CLI/items/eye-of-vecna-xdmg|Eye of Vecna]] and the [[/03_Mechanics/CLI/items/hand-of-vecna-xdmg|Hand of Vecna]] each have the following random properties
...
- **Truesight.** You have [[/03_Mechanics/CLI/senses#Truesight|Truesight]] out to 240 feet.  
- **Spellcasting.** The eye has 8 charges and regains `1d4 + 4` expended charges daily at dawn. You can cast a spell on the [[/03_Mechanics/CLI/items/eye-of-vecna-xdmg|Eye of Vecna]] Spells table from the eye (save DC 18). The table indicates how many charges you must expend to cast the spell. Each time you cast a spell from the eye, there is a 5 percent chance that Vecna tears your soul from your body, devours it, and then takes control of the body like a puppet. If that happens, you become an NPC under the DM's control.  

    **Eye of Vecna Spells**  

    | Spell | Charge Cost |  
    |-------|-------------|  
    | [[/03_Mechanics/CLI/spells/clairvoyance-xphb|Clairvoyance]] | 2 |  
    | [[/03_Mechanics/CLI/spells/crown-of-madness-xphb|Crown of Madness]] | 1 |  
    | [[/03_Mechanics/CLI/spells/disintegrate-xphb|Disintegrate]] | 4 |  
    | [[/03_Mechanics/CLI/spells/dominate-monster-xphb|Dominate Monster]] | 5 |  
    | [[/03_Mechanics/CLI/spells/eyebite-xphb|Eyebite]] | 4 |  
    ^eye-of-vecna-spells  
- **X-ray Vision.** You can take a [[/03_Mechanics/CLI/actions#Magic|Magic]] action to gain X-ray vision with a range of 30 feet for 1 minute. To you, solid objects within that radius appear transparent and don't prevent light from passing through themselves. The vision can penetrate 1 foot of stone, 1 inch of common metal, or up to 3 feet of wood or dirt. Thicker substances block the vision, as does a thin sheet of lead.  
...
- **Danger Sense.** You have [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]] on [[/03_Mechanics/CLI/variant-rules/initiative-xphb|Initiative]] rolls.  
- **Necrotic Reduction.** As a [[/03_Mechanics/CLI/actions#Magic|Magic]] action, you can target one creature you can see within 5 feet of yourself. The target makes a DC 18 Constitution saving throw, taking `7d6` Necrotic damage on a failed save or half as much damage on a successful one. A creature reduced to 0 [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Points]] by this damage is transformed into [[/03_Mechanics/CLI/traps-hazards/green-slime-xdmg|green slime]] (see chapter 3) that covers the ground in its space, each 5-foot square of slime representing a separate patch. Nonmagical objects worn or carried by the target that are made of metal or organic material are destroyed by the slime.  
- **Poison Immunity.** You have [[/03_Mechanics/CLI/variant-rules/immunity-xphb|Immunity]] to Poison damage and the [[/03_Mechanics/CLI/conditions#Poisoned|Poisoned]] condition.  
- **Regeneration.** If you start your turn with at least 1 [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Point]], you regain `d10` [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Points]].  
- **Wish.** You can cast [[/03_Mechanics/CLI/spells/wish-xphb|Wish]]. Once used, this property can't be used again until 30 days have passed.  

## Destroying the Eye and Hand

If the [[/03_Mechanics/CLI/items/eye-of-vecna-xdmg|Eye of Vecna]] and the [[/03_Mechanics/CLI/items/hand-of-vecna-xdmg|Hand of Vecna]] are both attached to the same creature and that creature is slain by the [[/03_Mechanics/CLI/items/sword-of-kas-xdmg|Sword of Kas]], both the eye and the hand burst into flame, turn to ash, and are destroyed. Any other attempt to destroy the eye or hand seems to work, but the Artifact reappears in one of Vecna's many hidden vaults, where it waits to be rediscovered.

**Items in this group:**

- [[/03_Mechanics/CLI/items/eye-of-vecna-xdmg|Eye of Vecna]]
- [[/03_Mechanics/CLI/items/hand-of-vecna-xdmg|Hand of Vecna]]

*Source: Dungeon Master's Guide (2024) p. 259*

## Player-Facing Summary

Eye and hand of vecna xdmg is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
