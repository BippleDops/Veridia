...
--- # The Deep Uprising *"From the crushing depths came voices that would not be silenced."* ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Overview
...
Active uprising lasted two years, with political ramifications continuing to present day. ## Adventure Hooks
...
3. **Counter-Revolution**: Surface loyalists attempt to reverse reforms ## Campaign Use
