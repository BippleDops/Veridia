---
aliases: ["The Sacred Alliance", "the sacred alliance", "Alliance Sacred The"]
tags: [generated]
id: QUEST0055
...
## Quest Giver
**Petra Darkwater** - Religious leader
...
## Key Locations
- **LowerVale** (City): Key location for quest progression
- **Marshridge** (Dungeon): Key location for quest progression
- **NewVale** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Elementals** led by Petra Shadowmere the Ancient
  - Strength: 18 combatants
...
- **Gold**: 1,734 gp
- **Experience**: 3,000 XP
- **Magic Items**: Hidden Pendant of Power
