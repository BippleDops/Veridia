...
|-----------|-----------|
| 1–10 | No encounter |
| 11 | 1 [behir](/3-Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) |
| 12 | `2d4` [flumphs](/3-Mechanics/CLI/bestiary/aberration/flumph-xmm.md) |
| 13 | [Gnoll](/3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) pack |
| 14 | `d4` [grells](/3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) |
| 15 | `d4` [hezrous](/3-Mechanics/CLI/bestiary/fiend/hezrou-xmm.md) |
| 16 | `4d8` [manes](/3-Mechanics/CLI/bestiary/fiend/manes-xmm.md) |
| 17 | `2d4` [minotaurs](/3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) |
| 18 | 1 [monodrone](/3-Mechanics/CLI/bestiary/construct/modron-monodrone-xmm.md) |
| 19 | `2d6` [quaggoths](/3-Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md) |
| 20 | `d4` [shriekers](/3-Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md) |
^encounter

#### Behir

This long-bodied reptile is either prowling a tunnel or resting in a cave when the characters encounter it. The [behir](/3-Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) retreats if reduced to 80 or fewer hit points.

#### Flumphs

This cloister of [flumphs](/3-Mechanics/CLI/bestiary/aberration/flumph-xmm.md) feeds on the psychic energy they detect from a nearby [mind flayer](/3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) that has enslaved `2d4` [quaggoths](/3-Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md). The flumphs warn adventurers who communicate with them about the nearby threats, but it is up to the characters whether they wish to engage those threats.

#### Gnoll Pack

![](/3-Mechanics/CLI/adventures/out-of-the-abyss/img/100-ooa14-02.webp#center)

A [gnoll fang of Yeenoghu](/3-Mechanics/CLI/bestiary/fiend/gnoll-fang-of-yeenoghu-xmm.md) named [Kurr](/3-Mechanics/CLI/bestiary/npc/kurr-oota.md) made his way into the Labyrinth shortly after Yeenoghu was summoned to the Underdark. [Kurr](/3-Mechanics/CLI/bestiary/npc/kurr-oota.md) brought with him a pack of hyenas and had them feast on the corpses of his slain victims. This heinous act transformed the hyenas into ten [gnolls](/3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md). [Kurr's](/3-Mechanics/CLI/bestiary/npc/kurr-oota.md) pack now prowls the Labyrinth in search of Yeenoghu, slaughtering anything and anyone they happen upon.
...
The encounter with [Kurr](/3-Mechanics/CLI/bestiary/npc/kurr-oota.md)'s pack occurs only once. Any subsequent occurrence of this encounter is with a pack of `3d6` [gnolls](/3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md). These gnolls came to the Underdark with Yeenoghu. They cackle and scream the demon lord's name as they tear into their prey.

#### Grells

The [grells](/3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) drop from an overhead shaft to feed.

#### Hezrous

These demons are tearing apart an iron ore cart, a rusted section of mining track, or some other old fixture. Party members can attempt to slip past the demons without arousing their attention. Doing so requires a successful DC 11 Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check. On a failed check, the [demons](/3-Mechanics/CLI/bestiary/fiend/hezrou-xmm.md) detect the party member and attack.

#### Manes

Characters can hear the mewling of this vile mob long before it appears. The [manes](/3-Mechanics/CLI/bestiary/fiend/manes-xmm.md) scour the Labyrinth for easy prey and move like a tide of putrid flesh.

#### Minotaurs

These [minotaurs](/3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) roams the Labyrinth, slaying creatures in the name of Baphomet.

#### Monodrone

This modron has become separated from its fellows (see "March to Nowhere"), and there is a 75 percent chance that it is looking to rejoin them. If the characters can understand its language, the [monodrone](/3-Mechanics/CLI/bestiary/construct/modron-monodrone-xmm.md) repeatedly says, "We are on the march!"
...
These [quaggoths](/3-Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md) are hungry and attack the party regardless of its size. If there are five or more quaggoths in the group, one of them is a quaggoth thonot (see the "Variant: Quaggoth Thonot" sidebar in the "Quaggoth" entry of the *Monster Manual*). If the thonot dies, the other quaggoths immediately break off their attack and begin feasting on the thonot's remains, hoping to gain its psionic power.

#### Shriekers

The [shriekers](/3-Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md) sound off when bright light or a creature is within 30 feet of them. Their shrieking has a 75 percent chance of attracting other monsters, in which case roll again on the Labyrinth Encounters table, treating another shrieker encounter as "no encounter."
...
Searching through the remains turns up two empty potion bottles and a [potion of mind reading](/3-Mechanics/CLI/items/potion-of-mind-reading-xdmg.md).
...
The two [shadow demons](/3-Mechanics/CLI/bestiary/fiend/shadow-demon-xmm.md) lurk in the darkness of this room and attack the first character who enters, likely taking their prey by surprise.

### Battlements

The top of the tower features an open space surrounded by a crenelated wall. If the four [gargoyles](/3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) have not yet attacked the adventurers, they do so here.
...
[Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md) is a [gnoll](/3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) with the following modifications:

- [Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md) has 11 hit points.  
- He has a walking speed of 25 feet.  
- He has disadvantage on Wisdom checks and Wisdom saving throws because of the physical and mental abuse he has suffered. A [lesser restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spell rids him of these effects.  
...
Any aggressive action sends [Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md) skittering back into the maze and to his masters. If the characters capture him, he shrieks and screams, drawing one [minotaur](/3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) to investigate the racket.
...
If the adventurers show pity or kindness, [Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md) becomes confused, as he has never experienced such things. A character can befriend the gnoll with a successful DC 20 Charisma ([Persuasion](/3-Mechanics/CLI/skills.md#Persuasion)) check. If any character uses magical healing on [Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md), the check is automatically successful.

If the characters befriend [Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md), he warns them to turn back, flee, and never return. He says his masters are vile minotaurs who wait in the maze, eager to kill all trespassers. If asked, [Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md) explains that the minotaurs spared his life in exchange for leading travelers into the maze. If the characters insist on entering the maze, [Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md) goes with them, trying to keep his new friends safe. If the characters defeat the minotaurs and move deeper into the Labyrinth, [Gash](/3-Mechanics/CLI/bestiary/npc/gash-oota.md) can accompany them as a follower and guide, giving the characters advantage on Wisdom ([Survival](/3-Mechanics/CLI/skills.md#Survival)) checks to avoid becoming lost in the Labyrinth.
...
When the characters enter the maze, have them choose their pace (fast, normal, or slow). It takes 1 hour to navigate the maze at a fast pace, 2 hours at a normal pace, or 3 hours at a slow pace. Halfway through the journey, the navigator must make a DC 15 Wisdom ([Survival](/3-Mechanics/CLI/skills.md#Survival)) check. A fast pace imposes a −5 penalty to the check. A slow pace grants a +5 bonus. On a success, the characters find their way out. On a failure, the characters must start the journey from the beginning.
...
| 11–12 | Corpse |
| 13–14 | Gnawed bones |
| 15–17 | `2d4` [gnolls](/3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) |
| 18–20 | `d6` [minotaurs](/3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) |
^encounter
...
A frenzied group of `2d4` [gnolls](/3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) is lost in the maze. The gnolls attack any creatures they see.

#### Minotaurs

These bloodthirsty [minotaurs](/3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) are hunting gnolls but attack any other creatures they happen upon.
...
Twelve [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) (a mix of shield dwarves, halflings, and humans) support [Grisha](/3-Mechanics/CLI/bestiary/npc/grisha-oota.md) if a fight breaks out. Ten of them are hidden in the shanties. Two more stand next to a zurkhwood door, beyond which lies a small side cave where cultists who have died and risen as undead are kept. If battle erupts, the cultists open the door and release six [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md). The ghouls ignore the cultists as long as there are other creatures to feed on.
...
As the party travels deeper into the Labyrinth, any character with a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 15 or higher hears the sounds of marching feet off in the distance. To investigate the source of the noise, the characters must travel for 15 minutes through cramped tunnels requiring as much climbing as crawling. At the end of this time, the adventurers emerge onto a shelf 15 feet up the wall of a broad, straight tunnel some 20 feet high.
...
Twelve [monodrones](/3-Mechanics/CLI/bestiary/construct/modron-monodrone-xmm.md) and a [tridrone](/3-Mechanics/CLI/bestiary/construct/modron-tridrone-xmm.md) have been wandering the Labyrinth since the last Great Modron March. The modrons became separated from their fellows and trapped here. Unable to find their way back to Mechanus, the modrons have been pressing on (and on), knowing that they must find their way back or be destroyed in the process.
...
If the characters stay hidden and observe, Yeenoghu leaves in short order. He is restless and eager for new prey. Yeenoghu gathers up most of the gnolls and hyenas and leads them down a tunnel on the right side of the cavern. Eight [gnolls](/3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) led by a [gnoll pack lord](/3-Mechanics/CLI/bestiary/fiend/gnoll-pack-lord-xmm.md) remain in the cavern, feasting on the goristro's corpse.
...
The close brush with Yeenoghu pays dividends to the adventurers by delivering two components of Vizeran's ritual into their hands. The first is the heart of the goristro, which the characters can remove from its corpse. The massive heart is the size of a small trunk and weighs nearly one hundred pounds. Any characters close to it while it is being transported imagine that they can occasionally hear it beating. A character who carries the heart, even in a [bag of holding](/3-Mechanics/CLI/items/bag-of-holding-xdmg.md) or similar extradimensional space, makes saving throws against madness with disadvantage.

The second component takes the form of a few spatters of a demon lord's blood. A successful DC 10 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check finds some of Yeenoghu's black blood on the fallen goristro's horns.
...
This chamber houses the [petrified](/3-Mechanics/CLI/conditions.md#Petrified) remains of eight fallen angels, condemned by the gods to pass the ages in the dark depths. Each appears to have been carved from stone in some position of fear, suffering, hatred, or longing. Each statue is spotted with lichen and marred by mineral deposits, which have crystallized out of the water dripping from the ceiling over uncounted years.

Even though they are transformed into stone statues, the fallen angels remain very much alive, their [petrified](/3-Mechanics/CLI/conditions.md#Petrified) bodies having become prisons for their minds and souls. They remember who they were. They know what they did and why they are here. They know everything transpiring around them. Yet they can do nothing. They are trapped forever, and the isolation, darkness, and endless torment of their fate have driven them mad. No spell can undo the angels' curse or free them from their [petrified](/3-Mechanics/CLI/conditions.md#Petrified) state.
...
A successful DC 15 Intelligence ([Arcana](/3-Mechanics/CLI/skills.md#Arcana)) check is needed to activate the device by puzzling out its array of gears and levers. It then takes 12 rounds for the engine to "align itself" and activate its magical effect. If an initiative order hasn't already been established by the time the engine activates, have everyone in the party roll initiative.
...
The engine shuts down if any part of it comes into contact with an [antimagic field](/3-Mechanics/CLI/spells/antimagic-field-xphb.md) or if it is targeted by a successful [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 19). Otherwise, it can only be shut down by a [wish](/3-Mechanics/CLI/spells/wish-xphb.md) spell or divine intervention.
...
| 11–15 | The engine makes a loud "WHAAAH" sound until the start of its next turn. For as long as the sound lasts, the engine projects an [antimagic field](/3-Mechanics/CLI/spells/antimagic-field-xphb.md) (as the spell) around itself. |
| 16–19 | The hollow interior of the engine flickers with crimson light until the end of its turn, whereupon one dead character or NPC of the DM's choice is restored to life, as though subjected to a [resurrection](/3-Mechanics/CLI/spells/resurrection-xphb.md) spell. The revived creature appears in a safe, unoccupied space within 120 feet of the engine. |
...
| 28–32 | The engine hums until the end of its turn, at which point a [green slaad](/3-Mechanics/CLI/bestiary/aberration/green-slaad-xmm.md) appears in a safe space within 120 feet of the engine. The slaad rolls initiative and, on its turn, attacks any other creatures it sees. |
| 33–35 | The engine groans loudly and turns each creature within 120 feet of it [invisible](/3-Mechanics/CLI/conditions.md#Invisible). A creature's invisibility lasts until it attacks or casts a spell. |
...
| 40–43 | Multicolored arcs of light play across the surface of the engine, which casts a [polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md) spell (save DC 18) on each creature within 20 feet of it. Any creature that fails the saving throw is polymorphed into a [flying snake](/3-Mechanics/CLI/bestiary/monstrosity/flying-snake-xmm.md). |
...
| 58–60 | The engine flickers with blue light and casts [faerie fire](/3-Mechanics/CLI/spells/faerie-fire-xphb.md), targeting all creatures within 20 feet of it (save DC 18). The spell's effect has a duration of 1 minute. |
| 61–66 | The engine spews harmless, multicolored sparks until the start of its next turn. |
| 67–70 | The engine emits a flash of violet light. Each creature within 20 feet of the engine must succeed on a DC 18 Constitution saving throw or be [petrified](/3-Mechanics/CLI/conditions.md#Petrified) until the engine's next turn. |
