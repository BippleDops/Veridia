...
"actions":
  ...
  - "desc": "Melee Attack Roll: +8, reach 10 ft. Hit: 10 (1d10 + 5) Bludgeoning\
      ...
      \ (escape DC 15). Until the grapple ends, the target is suffocating. The revet\
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/undead/token/graveyard-revet-xmm.webp"
```
^statblock
...
Graveyard revet xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of graveyard revet xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around graveyard revet xmm.
