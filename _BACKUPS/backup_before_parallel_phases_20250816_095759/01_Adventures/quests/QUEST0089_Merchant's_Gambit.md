---
aliases: ["Merchant's Gambit", "merchant's gambit", "Gambit Merchant's"]
...
*Kill Quest for levels 5-9*

**ID**: QUEST0089

## Quest Giver
**Jora Brightblade** - Mysterious stranger
...
## Key Locations
- **PortFalls** (City): Key location for quest progression
- **Haventhorpe** (Dungeon): Key location for quest progression
- **SouthGrove** (Wilderness): Key location for quest progression
- **Watchthorpe** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Bandits** led by Jora Fireborn
  - Strength: 20 combatants
...
- **Gold**: 2,741 gp
- **Experience**: 5,000 XP
- **Magic Items**: Blessed Orb of the Dawn
