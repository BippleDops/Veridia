...
The Prismari Primer is a magic textbook created at Strixhaven's Prismari College. The primer has 3 charges, and it regains `d3` expended charges daily at dawn. If you make a Dexterity ([Acrobatics](/3-Mechanics/CLI/skills.md#Acrobatics)) or a Charisma ([Performance](/3-Mechanics/CLI/skills.md#Performance)) check while holding the primer, you can expend 1 charge to give yourself a `d4` bonus to the check, immediately after you roll the `d20`.
