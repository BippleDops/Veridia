...
- **Quirks**: Always carries a lucky charm, Writes everything down, Taps fingers when thinking
- **Fear**: Poverty
...
### Zephyr Proudmore the Strong (Personal - Nemesis)
- **Status**: Strained but maintaining
- **History**: United by common enemy
- **Secret**: Share a terrible crime

### Hilda Proudmore the Broken (Personal - Nemesis)
...
- Summon Minions: Call 1d4 lesser creatures
- Spellcasting: 6 spell slots, knows Fly, Charm Person, Fireball, Magic Missile, Counterspell, Misty Step, Invisibility
