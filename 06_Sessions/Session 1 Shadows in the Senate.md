...
cr: 2 - name: Multiattack desc: Two shadow blade attacks - name: Shadow Blade desc: "Melee Attack: +6 to hit, 5 ft., one target. Hit: 7 (1d6 + 4) slashing plus 3 (1d6) necrotic damage." - name: Shadow Step desc: "Bonus action teleport 30 ft. To a shadow." name: Shadow Enforcer
ac: 16
hp: 58 (9d8 + 18)
str: 16
con: 15
...
cr: 4
traits: - name: Shadow Strike desc: First attack each turn deals extra 2d6 necrotic damage desc: Two attacks with shadow mace - name: Shadow Mace desc: "Melee Attack: +6 to hit, 5 ft., one target. Hit: 10 (2d6 + 3) bludgeoning damage." - name: Commanding Darkness desc: "All shadow operatives within 30 ft. Gain advantage on next attack." **Tactics**:
...
5. Trust is a precious commodity ### Random Encounters (if needed)`dice: 1d6`| d6 | Encounter | | aliases: ["Session 1 Shadows in the Senate"]
priority: normal
