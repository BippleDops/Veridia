---
aliases: ["The Hidden Treasure", "the hidden treasure", "Treasure Hidden The"]
tags: [generated]
id: QUEST0065
...
## Quest Giver
**Zara Darkwater** - Mysterious stranger
...
## Key Locations
- **LowerMarsh** (City): Key location for quest progression
- **OldMarsh** (Dungeon): Key location for quest progression

## Opposition
### Enemies
- **Bandits** led by Zara Shadowmere
...
- **Gold**: 2,785 gp
- **Experience**: 4,000 XP
- **Magic Items**: Blessed Blade of the Dawn
