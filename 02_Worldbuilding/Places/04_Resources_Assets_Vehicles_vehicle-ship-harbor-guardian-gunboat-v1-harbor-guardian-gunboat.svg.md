---
title: 04 Resources Assets Vehicles vehicle ship harbor guardian gunboat v1 harbor
  guardian gunboat.svg
aliases:
- 04 Resources Assets Vehicles vehicle ship harbor guardian gunboat v1 harbor guardian
  gunboatsvg
type: location
tags:
- place
...
The atmosphere of this location shifts throughout the day. Midday shows shadowy alleys, while evening transforms the area with warm lamplight.


### Atmosphere

The atmosphere of this location shifts throughout the day. Mornings see ancient ruins, while dusk transforms the area with quiet contemplation.


04_Resources/Assets/Vehicles/vehicle-ship-harbor-guardian-gunboat-v1-harbor-guardian-gunboat.svg stands as a significant harbor in the region, serving both strategic and economic purposes. Its location provides advantages for trade, defense, and regional influence.
...
### Architecture
The harbor features architecture typical of the region, with buildings constructed from local materials. Key structures include:
...
### Founding
Established generations ago as a strategic settlement, 04_Resources/Assets/Vehicles/vehicle-ship-harbor-guardian-gunboat-v1-harbor-guardian-gunboat.svg has grown from humble beginnings to its current significance.
...
- First mentioned: ![[04_Resources/Assets/Vehicles/vehicle-ship-harbo...
...
### Landmarks
- **Central Structure**: The defining feature of 04_Resources_Assets_Vehicles_vehicle-ship-harbor-guardian-gunboat-v1-harbor-guardian-gunboat.svg
...
### Common Knowledge
- What everyone knows about 04_Resources_Assets_Vehicles_vehicle-ship-harbor-guardian-gunboat-v1-harbor-guardian-gunboat.svg
