...
While Strahd is in Castle Ravenloft, he can take lair actions as long as he isn't [[conditions#Incapacitated|incapacitated]].
...
- Strahd summons the angry spirit of one who has died in the castle. The apparition appears next to a hostile creature that Strahd can see, makes an attack against that creature, and then disappears. The apparition has the statistics of a [[specter-xmm (undead)]].  
- Strahd targets one Medium or smaller creature that casts a shadow. The target's shadow must be visible to Strahd and within 30 feet of him. If the target fails a DC 17 Charisma saving throw, its shadow detaches from it and becomes a [[Shadow Xmm]] that obeys Strahd's commands, acting on initiative count 20. A [[greater-restoration-xphb (spells)]] spell or a [[Remove Curse Xphb]] spell cast on the target restores its natural shadow, but only if its undead shadow has been destroyed.
