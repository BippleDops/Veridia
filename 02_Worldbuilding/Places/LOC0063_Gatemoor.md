...
- **Ewan Ravencrest the Cunning** - Guard Captain: Key figure in local affairs
- **Fiora Ravencrest** - Innkeeper: Key figure in local affairs
...
### Trade
- **Exports**: Spices, Armor
- **Imports**: Medicines, Slaves
