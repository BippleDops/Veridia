...
# [[3-Mechanics\CLI\bestiary\dragon/kobold-warrior-xmm|Kobold Warrior]]
...
"cr": "1/8"
"traits":
  - "desc": "The kobold has [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]]\
      ...
      \ condition."
    "name": "Pack Tactics"
  - "desc": "While in sunlight, the kobold has [[/03_Mechanics/CLI/variant-rules/disadvantage-xphb|Disadvantage]]\
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/dragon/token/kobold-warrior-xmm.webp"
```
^statblock
...
Kobold warrior xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of kobold warrior xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around kobold warrior xmm.

## Adventure Hooks

- A rumor ties kobold warrior xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at kobold warrior xmm to avert a public scandal.
- A map overlay reveals a hidden approach to kobold warrior xmm active only during specific tides/storms.
