...
Thirty [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) (in six groups of five) emerge from the surrounding vineyard and make their way toward the characters and the winery. The blights are 120 feet away when they first become visible, and they have a walking speed of 30 feet. Characters can either barricade themselves inside the winery, thus keeping the needle blights at bay, or stand and fight. If they stay outside and fight, druids and blights from inside the winery join the battle on the rounds shown below.

| Round | Creatures |
|-------|-----------|
| 3 | 1 [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) and 24 [twig blights](/3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) (from area W9) |
| 4 | 1 [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) and 5 [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) (from area W14) |
| 5 | 1 [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) and 2 [vine blights](/3-Mechanics/CLI/bestiary/plant/vine-blight-xmm.md) (from area W20) |
^round-creatures
...
The Martikovs keep two [draft horses](/3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) here and use them to pull their wine wagon.
...
Four [swarms of ravens](/3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) perch on the rafters but don't attack the characters under any circumstances.

Unless they have been drawn outside, twenty-four [twig blights](/3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) and one [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (NE female human) are also present. If they are here, read:
...
The druid is poisoning the fermentation vats. The three westernmost vats contain poisoned wine, enough to fill a total of twenty barrels. Drinking the poisoned wine has the same effect as drinking a [potion of poison](/3-Mechanics/CLI/items/potion-of-poison-xdmg.md). Pouring antitoxin into a vat neutralizes the poison, but it also spoils the taste of the wine. Casting a [purify food and drink](/3-Mechanics/CLI/spells/purify-food-and-drink-xphb.md) spell on a vat neutralizes the poison without spoiling the wine.
...
Unless they have been drawn outside, five [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) and one [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (NE male human) lurk in the eastern portion of the cellar. If they are here when the characters enter that part of the cellar, read:
...
On his first turn, from behind the wine rack, the druid casts a [thunderwave](/3-Mechanics/CLI/spells/thunderwave-xphb.md) spell, which shatters ` + 10` of the wine bottles as it resounds throughout the cellar. The druid then orders the needle blights to attack.
...
Two [vine blights](/3-Mechanics/CLI/bestiary/plant/vine-blight-xmm.md) and one [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (NE female human) are in the room unless they have been drawn elsewhere, If they are here, read:
...
If the characters escort the wagon, check for a random encounter once for each mile traveled. The wagon is also watched over by two [swarms of ravens](/3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) that swoop down to attack anything that threatens the wagon or the characters.
...
If the characters leave the winery and return at a later time before dealing with Wintersplinter (see the "Druids' Ritual" section in chapter 14), the enormous [tree blight](/3-Mechanics/CLI/bestiary/plant/tree-blight-xmm.md) (see appendix D) is sent from Yester Hill to ravage the vineyard and destroy the winery.
...
Three days after Wintersplinter's attack, [Baba Lysaga](/3-Mechanics/CLI/bestiary/npc/baba-lysaga-cos.md) (see chapter 10, area U3) dispatches the seven [scarecrows](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) from Berez and orders them to take up positions in the vineyard, to discourage the wereravens from returning. These scarecrows attack anyone who crosses the vineyard or approaches the ruined winery.
