---
aliases: ["Princess's Secret", "princess's secret", "Secret Princess's"]
tags: [generated]
id: QUEST0064
...
*Fetch Quest for levels 4-8*

**ID**: QUEST0064

## Quest Giver
**Yorick Darkwater** - Powerful merchant
...
## Key Locations
- **Hillmoor** (City): Key location for quest progression
- **LowerMarsh** (Dungeon): Key location for quest progression
- **Marshmoor** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Cultists** led by Yorick Shadowmere
...
- **Gold**: 3,178 gp
- **Experience**: 4,000 XP
- **Magic Items**: Ancient Blade of the Dawn
