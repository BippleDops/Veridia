...
accessibility:
  ...
  pronunciation: The Sunken Crown Cipher
  safety_tools:
  - Lines & Veils
  - X-Card
  - Open Door
  screen_reader_summary: The Sunken Crown Cipher is a notable location in Aquabyssos
    shaped by tidal politics and Convergence anomalies. This entry is structured for
    fast table use.
obsidianUIMode: preview
updated: '2025-08-13T12:34:16.991482+00:00'
world: Aquabyssos
---
...
The Sunken Crown Cipher is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of The Sunken Crown Cipher as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around The Sunken Crown Cipher.

## Adventure Hooks

- A rumor ties The Sunken Crown Cipher to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at The Sunken Crown Cipher to avert a public scandal.
- A map overlay reveals a hidden approach to The Sunken Crown Cipher active only during specific tides/storms.
...
- [[Spymaster Crow]]
- [[04_Resources_Assets_Locations_location-city-memory-coral-reefs-v1-memory-coral-reefs.svg]]
...
The Sunken Crown Cipher is a notable location characterized by its unique features and strategic importance. The area serves as a hub for local activity and holds significance in the broader region.
...
### Landmarks
- **Central Structure**: The defining feature of The Sunken Crown Cipher
...
### Founding
The Sunken Crown Cipher was established in the distant past, growing from humble beginnings to its current state.
...
Ongoing situations affecting The Sunken Crown Cipher:
...
### Common Knowledge
- What everyone knows about The Sunken Crown Cipher
