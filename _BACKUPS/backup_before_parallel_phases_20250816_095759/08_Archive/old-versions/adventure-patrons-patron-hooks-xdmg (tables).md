...
title: adventure-patrons-patron-hooks-xdmg (tables)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["adventure-patrons-patron-hooks-xdmg (tables)"]
status: active
priority: normal
...
title: adventure patrons patron hooks xdmg
aliases:
...
updated: '2025-08-12T23:37:33.398241'
world: Both

--- # Adventure Patrons; Patron Hooks

*Source: Dungeon Master's Guide (2024) p. 110* **Patron Hooks**`dice: [](adventure-patrons-patron-hooks-xdmg.md#^patron-hooks)`| dice: `dice: 1d6` | Hook |
|-----------|------|
...
^patron-hooks ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Adventure patrons patron hooks xdmg is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of adventure patrons patron hooks xdmg as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around adventure patrons patron hooks xdmg. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Plot Hooks - Someone is hunting an heir for money
