...
type: note
created: 2025-07-23
updated: '2025-08-13T01:18:33.592379+00:00'
...
- **Chaining.** Chains firmly rooted in the ground hold the target in place. The target has the [Restrained](/03_Mechanics/CLI/conditions.md#Restrained) condition and can't be moved by any means.  
...
- **Slumber.** The target has the [Unconscious](/03_Mechanics/CLI/conditions.md#Unconscious) condition and can't be awoken.  
...
A [Dispel Magic](/03_Mechanics/CLI/spells/dispel-magic-xphb.md) spell can end the spell only if it is cast with a level 9 spell slot, targeting either the prison or the component used to create it.

## Summary

**Classes**: [Warlock](/03_Mechanics/CLI/lists/list-spells-classes-warlock.md); [Wizard (Abjurer)](/03_Mechanics/CLI/lists/list-spells-classes-abjurer-xphb.md "subclass=XPHB;class=XPHB"); [Bard](/03_Mechanics/CLI/lists/list-spells-classes-bard.md); [Wizard](/03_Mechanics/CLI/lists/list-spells-classes-wizard.md)
...
Imprisonment xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
