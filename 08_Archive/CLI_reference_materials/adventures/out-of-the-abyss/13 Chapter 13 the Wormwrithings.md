...
- world/both
type: note
updated: '2025-08-13T12:34:05.002464+00:00'
world: Both
---
...
The nearest purple worm nesting area mapped out for the characters by [[/03_Mechanics/CLI/bestiary/npc/vizeran-devir-oota|Vizeran DeVir]] lies forty-eight miles west of the archmage's tower. The Vast Oblivium lies some twelve miles south of this nursery. Use the guidelines in chapters 2 and 10 as the party travels through the Underdark, but use the Wormwrithings Encounters table instead of the random encounter tables in chapter 2. Foraging is more difficult in the Wormwrithings, requiring successful DC 20 Wisdom ([[/03_Mechanics/CLI/skills#Survival|Survival]]) checks.
...
|-----------|-----------|
| 1–10 | No encounter |
| 11 | 1 [[/03_Mechanics/CLI/bestiary/monstrosity/drider-xmm|drider]] |
| 12 | [[/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm|Drow]] hunting party |
| 13 | `3d6` dwarf [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]] |
| 14 | `d6` [[/03_Mechanics/CLI/bestiary/giant/ettin-xmm|ettins]] |
| 15 | `3d6` [[/03_Mechanics/CLI/bestiary/aberration/flumph-xmm|flumphs]] |
| 16 | [[/03_Mechanics/CLI/bestiary/aberration/grick-xmm|Grick]] nest |
| 17 | 1 [[/03_Mechanics/CLI/bestiary/monstrosity/purple-worm-xmm|purple worm]] |
| 18 | `2d6` [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodytes]] |
| 19 | `d4` [[/03_Mechanics/CLI/bestiary/giant/troll-xmm|trolls]] |
| 20 | 1 [[/03_Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm|umber hulk]] |
^encounter

#### Drider

This creature clings to the ceiling and prefers to make ranged attacks against the party. There is a 25 percent chance that the [[/03_Mechanics/CLI/bestiary/monstrosity/drider-xmm|drider]] can cast spells (use the spellcasting variant in the *Monster Manual*). The drider flees if reduced to 30 or fewer hit points.

#### Drow Hunting Party

A [[/03_Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm|drow mage]] of House Melarn leads a group of `d6` [[/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm|drow]] and `2d6` [[/03_Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm|bugbear]] slaves through the tunnels in search of a purple worm nursery, where they hope to find a purple worm egg as a gift for their matron mother. If the characters have an egg clearly in their possession, the drow party tries to take it. Otherwise, the drow mage is happy to let the characters and their expeditionary force pass by unchallenged.

#### Dwarf Commoners

There is a 75 percent chance that these [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|shield dwarves]] are prospectors from Mithral Hall, hunting for precious stones and minerals. Otherwise, they are refugees who became lost in the Underdark after orcs attacked their stronghold and chased them underground. These dwarves are searching for a route to the surface.
...
These [[/03_Mechanics/CLI/bestiary/giant/ettin-xmm|ettins]] used to be orogs until the *faerzress* and the corrupting influence of Demogorgon transformed them into two-headed giants. Their transformation can't be undone. They are starving and attack the party on sight.

#### Flumphs

A cloister of [[/03_Mechanics/CLI/bestiary/aberration/flumph-xmm|flumphs]] floats through the tunnels. These peaceful creatures have been disturbed by the powerful thoughts of the demon lords. They warn the characters that these evil thoughts have polluted the Underdark, and that kindness is the only response to such evil.

#### Grick Nest

The characters stumble upon a naturally formed cyst in a tunnel wall. A [[/03_Mechanics/CLI/bestiary/aberration/grick-ancient-xmm|grick alpha]] and `2d4` [[/03_Mechanics/CLI/bestiary/aberration/grick-xmm|gricks]] are using the cyst as a nest, attacking anything that passes by.
...
Roll a `d6` and consult the [[/03_Mechanics/CLI/bestiary/monstrosity/purple-worm-xmm|Purple Worm]] Direction table to determine where the purple worm comes from.
...
These [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodytes]] are heading toward their lair (see "Troglodyte Lair") and attack any other creatures they come across.

#### Trolls

These ravenous, insane [[/03_Mechanics/CLI/bestiary/giant/troll-xmm|trolls]] attack the party on sight.

#### Umber Hulk

This [[/03_Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm|creature]] is hidden behind a wall and uses its [[/03_Mechanics/CLI/senses#Tremorsense|tremorsense]] to detect passing prey, bursting out of a nearby wall to attack the nearest party member. Randomly determine who is attacked, taking into account any NPCs traveling with the characters.
...
Any character who understands the troglodytes quickly learns what drives the conflict. Otherwise, a successful DC 13 Wisdom ([[/03_Mechanics/CLI/skills#Insight|Insight]]) check can provide a general sense of what's going on. The troglodytes ambushed and killed a drow scouting party whose leader wielded a magic sword that S'slaar, the troglodyte chieftain, claimed as a trophy. However, S'slaar's war marshal, H'slaat, was the one who killed the drow leader, and who now claims the right to wield the blade.
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/out-of-the-abyss/img/094-13-01.webp#gallery|Map 13.1: Troglodyte Lair]]
> ![[/03_Mechanics/CLI/adventures/out-of-the-abyss/img/095-troglodyte-lair-player-version.webp#gallery|Player Version]]
...
Rubble is piled up along the walls on either side of the tunnel. The rubble on the east side of the tunnel conceals a hidden passageway. Any character with a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 15 or higher notices the hidden passage. Anyone actively searching the rubble finds it with a successful DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check. Adventurers who head into the passage beyond the rubble discover the hidden entryway to area 5 at the end of the tunnel.

### 2. Cave Floor

H'slaat, a [[/03_Mechanics/CLI/bestiary/humanoid/troglodyte-champion-of-laogzed-oota|troglodyte champion of Laogzed]] (see appendix C), and twenty-two [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodytes]] are arrayed in a rough battle line along the south bank of a freshwater stream that nearly bisects the cavern. The stream runs west to east, tumbling down a short waterfall and forming a small pool (area 9). The stream is about 15 feet wide and 3 feet deep at its deepest point. It can be crossed on foot but is difficult terrain.

The troglodytes are so distracted that it's possible to sneak through this area undetected as long as the adventurers stay close to the cavern walls. Each character must succeed on a DC 10 Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check or be noticed by the troglodytes.

#### Development

Any wounded creature entering the stream attracts the [[/03_Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm|swarm of quippers]] from area 11.

### 3. Rise

This upthrust section of the cavern floor is edged by a steep slope to the southwest and a 6-foot-high cliff elsewhere. The cliff requires a successful DC 11 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check to climb.

Five [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodytes]] loyal to H'slaat are stationed here. In addition to their regular attacks, they are armed with javelins that they throw from a pile of twenty-five javelins on the cavern floor near them.
...
H'hoort, a [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodyte]] and Chieftain S'slaar's mate, is lashed between two stalagmites here. Another [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodyte]] stands guard next to her. Releasing H'hoort won't earn the adventurers a respite from the opportunistic troglodytes, but if the characters hold her captive, both sides are reluctant to attack them.
...
The troglodyte chieftain has arrayed his forces along the narrow strip of high ground between the basin and the stream. Chieftain S'slaar is a [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodyte]] with 20 hit points and a [[/03_Mechanics/CLI/items/2-weapon-xdmg|+2 longsword]]. While he wields the sword, S'slaar gains the following action option:
...
S'slaar is accompanied by five [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodytes]] with 20 hit points each and three ordinary [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodytes]].

#### Treasure

S'slaar's [[/03_Mechanics/CLI/items/2-weapon-xdmg|+2 longsword]] is of drow manufacture (see the "Drowcraft Items" sidebar in appendix B). It has a cross guard shaped like a stylized spider with tiny gems for eyes. Etched into its blade are the words *Oloth tlu malla*, which is a drow expression meaning "Darkness be praised."

### 5. Supplies and Captives

This area is held by H'slaat's forces. One [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodyte]] guards the cave. A character can sneak past the guard with a successful DC 12 Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check.

The cave floor is strewn with gnawed bones—the remains of dead dwarves and drow. A circular pit, nine feet deep, holds six captives—two [[/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm|drow]] and four shield dwarf [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]. These unfortunates were separated from larger groups (see "Random Encounters" earlier in this chapter) and captured by the troglodytes. Every couple of days, one of them is eaten by the tribe. The captives are filthy and weak; each has four levels of [[/03_Mechanics/CLI/conditions#Exhaustion|exhaustion]] and 1 hit point remaining. Any of the captives can explain the nature of the conflict between H'slaat and S'slaar. If freed, the drow immediately flee into the Underdark, but the dwarves offer to join the expeditionary force if the adventurers liberate them. The drow are male members of House Melarn and are named Rinil and Xol. The shield dwarves hail from the Silver Marches and are named Dauthorn Brightmantle (male), Traldak Xornbane (male), Zulia Stonewhisper (female), and Hargritt Hammerhome (female).

Rubble is piled up along the south wall of the cavern, concealing a hidden passageway to area 1. Anyone with a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 15 or higher notices the passage. Anyone actively searching the rubble must succeed on a DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check to find it.

#### Treasure

Within the cave, four zurkhwood boxes hold a 50-foot length of spider silk rope, four flasks of oil, twenty pounds of rancid food, a pile of moldy blankets, six maces and sixteen javelins (all battered but usable), four casks of unspoiled wine worth 10 gp each, and a locked tribute chest. It takes a successful DC 15 Dexterity check using thieves' tools to open the chest, which contains 180 gp (minted in Menzoberranzan and Gracklstugh), three gems each worth 50 gp each, a [[/03_Mechanics/CLI/items/potion-of-gaseous-form-xdmg|potion of gaseous form]], and a [[/03_Mechanics/CLI/items/1-weapon-xdmg|+1 dagger]] with silvery, weblike filigree worked into the hilt. The dagger is of drow manufacture (see the "Drowcraft Items" sidebar in appendix B). The crude litters that the troglodytes use to bear these goods are propped up against the cave wall.
...
H'slaat stationed four [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodytes]] here to watch for any of S'slaar's forces that might try to make their way into attack position through the outer caverns. These guards are always on alert. One of them carries a horn that it sounds in the event of an attack. If the horn is blown, eight of the troglodytes in area 2 come through area 5 and into this cave to investigate and shore up the defenses.
...
Two of the stalagmites are [[/03_Mechanics/CLI/bestiary/aberration/roper-xmm|ropers]], while four of the stalactites are [[/03_Mechanics/CLI/bestiary/aberration/piercer-xmm|piercers]] (the ropers' offspring). While lying in wait, the creatures are virtually undetectable. Any party member with a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 20 or higher notices something unusual about the rock formations in the cave. Unless they are recognized, the ropers and piercers surprise anyone entering the area.

#### Treasure

Searching the cave reveals the remains of a half-eaten male drow lying against one wall. The drow carries a small pouch containing 30 gp and two [[/03_Mechanics/CLI/items/spell-scroll-xdmg|spell scrolls]] ([[/03_Mechanics/CLI/spells/shield-xphb|shield]] and [[/03_Mechanics/CLI/spells/phantasmal-force-xphb|phantasmal force]]) written on sheets of trillimac (see "Fungi of the Underdark" in chapter 2).

If the ropers are killed and cut open, the adventurers find 25 pp in the gizzard of one, and a [[/03_Mechanics/CLI/items/ring-of-protection-xdmg|ring of protection]] in the gizzard of the other.
...
The underground stream passes through this cave, traveling west to east. The adventurers can hear something splashing in the water as soon as they enter this area. Any character who enters the stream is immediately attacked by the [[/03_Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm|swarm of quippers]] that has spawned here.
...
At the end of every minute the adventurers spend here, roll a `d6`. On a roll of 1, `d4` [[/03_Mechanics/CLI/bestiary/elemental/magma-mephit-xmm|magma mephits]] emerge from a crack in the floor and attack. No more than twelve mephits appear in a given 24-hour period.

### 13. Empty Cave

Rocks and small boulders are piled up along the north wall of this otherwise empty cave. The rubble conceals a passageway to area 14, buried during a rockslide. Anyone with a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 15 or higher notices the hidden passage. Anyone actively searching the rubble must succeed on a DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check to find it.

### 14. Rally Point

S'slaar's cavalry troops are gathered in this cavern, waiting for their master's order to attack. Six [[/03_Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm|troglodytes]] are mounted on six [[/03_Mechanics/CLI/bestiary/beast/giant-lizard-xmm|giant lizards]].

Rocks and small boulders are piled up along the south wall. The rubble conceals a tunnel to area 13. Anyone with a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 15 or higher notices the hidden passage. Anyone actively searching the rubble must succeed on a DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check to find it.
...
- The troglodytes in areas 5 and 7 try to make their way through the side caverns to attack the chieftain's forces in area 4 from the rear. However, if the ropers and piercers in area 8 have not already been killed by the adventurers, the troglodytes are [[/03_Mechanics/CLI/conditions#Surprised|surprised]] and massacred.  
...
While the battle is underway, a character can sneak through an area occupied by troglodytes with a successful DC 10 Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check.
...
The voice is actually a [[/03_Mechanics/CLI/spells/minor-illusion-xphb|minor illusion]] cantrip. If no one in the party understands Undercommon, the dire warning is just loud gibberish to them. The cantrip was cast by [[/03_Mechanics/CLI/bestiary/npc/hanne-hallen-oota|Hanne Hallen]], a young drow allied with House Mizzrym. Hanne has the statistics of a [[/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm|drow]], with the following modifications:

- Hanne's AC is 12, or 15 with [[/03_Mechanics/CLI/spells/mage-armor-xphb|mage armor]]. She doesn't wear a chain shirt.  
- Her Intelligence is 17 (+3).  
- Add [[/03_Mechanics/CLI/skills#Arcana|Arcana]] +5 and [[/03_Mechanics/CLI/skills#Investigation|Investigation]] +5 to her skills.  
...
> 
> 1st Level (2 slots): [[/03_Mechanics/CLI/spells/shield-xphb|shield]], [[/03_Mechanics/CLI/spells/mage-armor-xphb|mage armor]]
^45e
...
Hanne spotted the adventurers as they approached and tried to scare them away. She's hiding in the rubble along the cavern wall but can be spotted with a successful DC 15 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check.

If the adventurers decide to turn back, finding another tunnel going in the right direction adds twenty miles to their journey to the worm nursery. If they press ahead, the voice shouts in Undercommon again: "Fools! Flee now! This is your final warning!" Once the adventurers enter the cavern, Hanne can be spotted with a DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check. If spotted, Hanne threatens the party with her "powerful magic," but drops her hostile attitude if offered food and water. She can be convinced to tell her story with a successful DC 12 Charisma ([[/03_Mechanics/CLI/skills#Persuasion|Persuasion]]) check.
...
The passage to area 3 is a steep slope leading 10 feet upward, and covered in small rocks and gravel. Moving up the slope requires a successful DC 12 Dexterity ([[/03_Mechanics/CLI/skills#Acrobatics|Acrobatics]]) check. On a failed check, a character slips and tumbles down to the bottom of the slope, taking no damage. If someone at the top of the slope lowers a rope to help other characters climb, no check is necessary.
...
Scaling the chasm walls without gear requires a successful DC 15 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check.

#### Treasure

The skeleton still wears a [[/03_Mechanics/CLI/items/ring-of-free-action-xdmg|ring of free action]] on one bony finger.
...
Any noise in one of these chambers (including a normal speaking voice or metal striking metal) causes the strands to reverberate, creating a loud humming that echoes throughout the surrounding caverns, alerting the [[/03_Mechanics/CLI/bestiary/monstrosity/purple-worm-xmm|purple worms]] to the presence of trespassers.
...
Phosphorescent lichen clings to the walls of this 30-foot-high cavern. Stronk, a brutish [[/03_Mechanics/CLI/bestiary/giant/fomorian-xmm|fomorian]], lairs here. Somehow the giant formed a bond with the purple worms, becoming a caretaker of their eggs. He regularly checks the eggs, brushes fungus off them, and defends them against predators.
...
Venturing into Stronk's lair without waking him requires a successful DC 12 Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check. If awakened, the fomorian shouts out about "killing egg thieves" and "protecting my precious ones," then fights to defend the nesting area and protect the eggs. If Stronk is reduced to half his hit points or fewer, he charges into the adjoining echo chamber (area 5) and bellows to summon a [[/03_Mechanics/CLI/bestiary/monstrosity/purple-worm-xmm|purple worm]] before rejoining the battle.

#### Treasure

All the treasure Stronk has taken from his victims has been placed under his sleeping skins for safekeeping: 40 pp, an electrum brooch worth 120 gp, six gems worth 50 gp each, two [[/03_Mechanics/CLI/items/potion-of-greater-healing-xdmg|potions of greater healing]], and a book of drow poetry worth 100 gp.

### 7. Entry Chamber

This cavern rises to a height of 50 feet and contains many stalagmites and stalactites. A purple worm tunnel leads out into the Wormwrithings through this area, but the tunnel's mouth is 40 feet above the cavern floor. Scaling the rock wall to reach the tunnel requires a successful DC 15 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check.
...
|-----------|-----------|
| 1–15 | No encounter |
| 16–18 | 1 [[/03_Mechanics/CLI/bestiary/beast/giant-spider-xmm|giant spider]] from area 11 |
| 19–20 | 1 [[/03_Mechanics/CLI/bestiary/monstrosity/purple-worm-xmm|purple worm]] |
^encounter

The giant spider walks on the ceiling and surprises the adventurers unless someone in the party has a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 14 or higher.

If a purple worm appears, it enters the nursery through the tunnel in area 7 and circles the outside of the cavern. Any party member in the egg chamber can try to hide with a successful DC 10 Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check. A failed check means the party member attracts the worm's attention.
...
For every minute the adventurers spend in this cave, there is a 25 percent chance they attract the attention of `d4` [[/03_Mechanics/CLI/bestiary/beast/giant-spider-xmm|giant spiders]] from area 11. The spiders scuttle along the walls and ceiling, avoiding the gooey floor.
...
The eastern half of this cavern floor is covered in webs stretching up to the ceiling. See ""Dungeon Hazards"" in chapter 5 of the *Dungeon Master's Guide* for rules about webs. Eight [[/03_Mechanics/CLI/bestiary/beast/giant-spider-xmm|giant spiders]] lurk in the nest, minus any killed elsewhere in the nursery.

### 12. Chasm

A chasm cuts across this cavern, stretching from wall to wall. The chasm is 10 feet wide, 200 feet deep, and slopes down to the southwest at a sixty degree angle. The chasm's slope can be climbed with a successful DC 15 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check. A creature that fails the check by 5 or more goes tumbling down the slop to the bottom of the chasm, taking damage from the fall as normal.

#### Treasure

At the bottom of the chasm lie the skeletons of two svirfneblin who tried to leap across the chasm while being chased by a purple worm. Lying near the remains are two miner's picks and a small leather pouch containing a [[/03_Mechanics/CLI/items/gem-of-brightness-xdmg|gem of brightness]].
...
The beholder's favorite slave is a human named [[/03_Mechanics/CLI/bestiary/npc/shedrak-of-the-eyes-oota|Shedrak of the Eyes]]. As Karazikar's "high priest," he leads other slaves in worship of their master and carries out the beholder's commands.
...
All of the slaves fear Karazikar, and the notion of acting against the beholder seems impossible to them. However, witnessing the bravery of the adventurers has a chance to sway them. If the characters demonstrate their willingness to challenge the beholder (including by killing Shedrak), surviving slaves can be convinced to aid them with a successful DC 16 Charisma ([[/03_Mechanics/CLI/skills#Persuasion|Persuasion]]) check. On a failed check, slaves either attack the characters or hide from them, waiting for Karazikar to deal with them.
...
Shedrak meets visitors at the chasm, greeting them in the name of his master, the great [[/03_Mechanics/CLI/bestiary/aberration/beholder-xmm|Karazikar]], and asking their business. Use the [[/03_Mechanics/CLI/bestiary/humanoid/mage-xmm|mage]] statistics to represent Shedrak, with the following modifications:

- Shedrak is chaotic evil.  
- He has ten small eyes tattooed on his bald head that allow him to see [[/03_Mechanics/CLI/conditions#Invisible|invisible]] creatures and objects as if they were visible.  
...
- He carries a [[/03_Mechanics/CLI/items/potion-of-healing-xdmg|potion of healing]], a [[/03_Mechanics/CLI/items/potion-of-poison-xdmg|potion of poison]], and a [[/03_Mechanics/CLI/items/spell-scroll-xdmg|spell scroll]] of [[/03_Mechanics/CLI/spells/globe-of-invulnerability-xphb|globe of invulnerability]].  
...
If the characters become hostile, Shedrak orders them to depart, lest they provoke the wrath of his all-powerful master. If attacked, he uses his [[/03_Mechanics/CLI/spells/globe-of-invulnerability-xphb|globe of invulnerability]] scroll, casts [[/03_Mechanics/CLI/spells/fly-xphb|fly]] on himself, and flies into the chasm.
...
Whether they're escorted by Shedrak or make their own way into Karazikar's Maw, the adventurers first encounter the [[/03_Mechanics/CLI/bestiary/aberration/beholder-xmm|beholder]] as they cross the chasm. The beholder descends from the shadowy ceiling, staying at least 20 feet away from the bridge.
...
- 21 shield dwarf [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]  
- 17 human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]  
- 11 moon elf [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]  
- 8 female [[/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm|drow]] and 1 male [[/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm|drow]]  
- 5 [[/03_Mechanics/CLI/bestiary/humanoid/deep-gnome-svirfneblin|deep gnomes]]  
- 23 [[/03_Mechanics/CLI/bestiary/fey/goblin-warrior-xmm|goblins]]  
- 15 [[/03_Mechanics/CLI/bestiary/humanoid/berserker-xmm|orogs]]  

All of the slaves have four levels of [[/03_Mechanics/CLI/conditions#Exhaustion|exhaustion]] (see "appendix A" of the *Player's Handbook*) and can't do much more than eat and follow simple instructions. They join the party's expeditionary force if urged or ordered to do so, but they aren't effective combatants until they've rested and reduced their [[/03_Mechanics/CLI/conditions#Exhaustion|exhaustion]] level.
...
One or more slaves can lead characters to a small room on the uppermost level of the complex. The room is sealed off with a 6-inch-thick circular stone door that can be rolled aside with a DC 20 Strength check or opened with a [[/03_Mechanics/CLI/spells/knock-xphb|knock]] spell or similar magic. The room holds a damaged [[/03_Mechanics/CLI/bestiary/construct/modron-duodrone-xmm|duodrone]] that Karazikar recently captured in the hopes of unlocking more information about the Maze Engine.

The duodrone has 1 hit point remaining and speaks its own language of clicks and whirs, always referring to itself as "we" or "us." The demonic madness as scrambled its memory, but if a [[/03_Mechanics/CLI/spells/greater-restoration-xphb|greater restoration]] spell is cast on it, the modron remembers two things:
...
The beholder used its disintegration eye ray to carve a rough likeness of itself in the ceiling of Karazikar's Maw—a great stone beholder face glaring down upon the gaping chasm, its central eye a hollow shaft that leads up to a hemispherical vault where the beholder hides its considerable hoard: 15,000 gp, 1,300 pp, ten assorted gems worth 500 gp each, a [[/03_Mechanics/CLI/items/gem-of-seeing-xdmg|gem of seeing]], a [[/03_Mechanics/CLI/items/necklace-of-adaptation-xdmg|necklace of adaptation]], and a [[/03_Mechanics/CLI/items/robe-of-eyes-xdmg|robe of eyes]].
