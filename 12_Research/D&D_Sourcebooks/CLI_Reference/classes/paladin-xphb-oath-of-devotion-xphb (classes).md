...
The weapon also emits [[Light Xphb]] in a 20-foot radius and [[Light Xphb]] 20 feet beyond that.

You can end this effect early (no action required). This effect also ends if you aren't carrying the weapon.

### Aura of Devotion (Level 7)

You and your allies have [[immunity-xphb (variant-rules)]] to the [[conditions#Charmed|Charmed]] condition while in your Aura of Protection. If a [[conditions#Charmed|Charmed]] ally enters the aura, that condition has no effect on that ally while there.
...
The aura is filled with [[Light Xphb]] that is sunlight.
