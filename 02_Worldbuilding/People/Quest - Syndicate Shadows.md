...
accessibility:
  ...
  - coercion
  - memory manipulation
  pronunciation: Quest - Syndicate Shadows
  safety_tools:
  - Lines & Veils
  - X-Card
  - Open Door
  screen_reader_summary: Quest - Syndicate Shadows is an NPC entangled with faction
...
![[04_Resources/Assets/04_Resources/Assets/Art/NPCs/Quest_-_Syndicate_Shadows.png|Quest - Syndicate Shadows Portrait]]
...
- Failure Still Progresses: Even when rebuffed, Quest - Syndicate Shadows sends a warning of a raid that creates a time-sensitive window.
...
Quest - Syndicate Shadows presents a distinctive figure. Their bearing suggests both competence and experience. Notable features include:
...
Quest - Syndicate Shadows's path to their current position involved:
...
Quest - Syndicate Shadows harbors secrets that could change everything:
...
Quest - Syndicate Shadows is currently engaged in:
...
1. **The Request**: Quest - Syndicate Shadows needs assistance with a delicate matter
...
5. **The Crisis**: Quest - Syndicate Shadows is caught in a situation requiring intervention
...
- [[04_Resources_Assets_Locations_location-city-temple-guardian-marcus-the-drowned-v1-temple-guardian-marcus-the-drowned.svg]]: *sworn enemy*
- [[04_Resources_Assets_Symbols_symbol-heraldry-divine-transformation-theolog-divine-transformation-theolog.svg]]: *childhood friend*
- [[04_Resources_Assets_Locations_location-city-lord-reginald-seaworthy-v1-lord-reginald-seaworthy.svg]]: *business partner*
- [[Envoy Blackwater Jr]]: *informant*
