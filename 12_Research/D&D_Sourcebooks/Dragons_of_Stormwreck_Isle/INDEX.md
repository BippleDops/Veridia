...
# Dragons of Stormwreck Isle - Integration Index
...
## Description
Beginner-friendly dragon adventure
...
TABLE WITHOUT ID
    ...
    cr as "CR",
    status as "Status"
FROM "Dragons_of_Stormwreck_Isle/Monsters"  
WHERE type = "Monster"
SORT cr
```
...
TABLE WITHOUT ID
    ...
    status as "Status" 
FROM "Dragons_of_Stormwreck_Isle/Adventures"
