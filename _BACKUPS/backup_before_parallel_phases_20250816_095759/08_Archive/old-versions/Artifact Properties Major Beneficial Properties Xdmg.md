...
*Source: Dungeon Master's Guide (2024) p. 224* **Major Beneficial Properties**`dice: [](artifact-properties-major-beneficial-properties-xdmg.md#^major-beneficial-properties)`| dice: `dice: 1d100` | Property |
|-------------|----------|
