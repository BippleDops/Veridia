...
title: secondary-tables-tragedies-xge (tables)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["secondary-tables-tragedies-xge (tables)"]
status: active
priority: normal
...
title: secondary tables tragedies xge
aliases:
...
updated: '2025-08-12T23:37:33.352570'
world: Both

--- # Secondary Tables; Tragedies

*Source: Xanathar's Guide to Everything p. 70* **Tragedies**`dice: [](secondary-tables-tragedies-xge.md#^tragedies)`| dice: d12 | Tragedy |
|-----------|---------|
...
^tragedies ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Secondary tables tragedies xge is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of secondary tables tragedies xge as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around secondary tables tragedies xge. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Prophecy Connection Mentioned in The Hidden Prophecy of Winds ## 12_Research Specific Content Contextual improvement based on 12_Research
