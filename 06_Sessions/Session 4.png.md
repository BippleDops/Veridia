...
race: Unknown
tags:
- session title: Session 4.png
type: npc
updated: 2025-08-14
status: active
priority: normal
category: 06 Sessions
subcategory: Session 4.Png.Md
related: []
cssclass: standard
publish: false --- # Session 4.png ## Overview ## Description {#description} Detailed description pending. Session 4.png is a notable figure in the realm, known for their unique skills and complex motivations. ## Appearance - **Age**: Middle-aged
...
- **Flaws**: Tendency to overthink situations ## Background Born into modest circumstances, Session 4.png rose through dedication and cunning to their current position. ## Abilities - **Skills**: Investigation, Persuasion, Insight
...
3. May become an ally or adversary based on party actions ## DM Notes *This NPC can serve multiple roles depending on campaign needs. Their true loyalties are intentionally ambiguous.* ## Notes {#notes} *Additional notes* #story/plot
#story/background
#world/location
#character/npc
#character/person
