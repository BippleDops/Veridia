...
A creature of your choice that you can see within range regains [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md) equal to `2d4` plus your spellcasting ability modifier.
