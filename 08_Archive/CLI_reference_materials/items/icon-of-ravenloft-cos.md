...
- Icon of Ravenloft
created: 2025-07-23
updated: '2025-08-13T01:18:34.227465+00:00'
...
While within 30 feet of the icon, a creature is under the effect of a [protection from evil and good](/03_Mechanics/CLI/spells/protection-from-evil-and-good-xphb.md) spell against fiends and undead. Only a creature attuned to the icon can use its other properties.

## Augury

You can use an action to cast an [augury](/03_Mechanics/CLI/spells/augury-xphb.md) spell from the icon, with no material components required. Once used, this property can't be used again until the next dawn.
