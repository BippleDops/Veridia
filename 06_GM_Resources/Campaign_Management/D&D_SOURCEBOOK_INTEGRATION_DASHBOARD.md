...
### Available Sourcebooks (13)

### 🎲 Campaign Books (9)

#### 📋 [[Curse_of_Strahd/INDEX|Curse of Strahd]]
- **Level Range**: 1-10
...
#### 📋 [[Tomb_of_Annihilation/INDEX|Tomb of Annihilation]]
- **Level Range**: 1-11
...
#### 📋 [[Waterdeep_Dragon_Heist/INDEX|Waterdeep: Dragon Heist]]
- **Level Range**: 1-5
...
#### 📋 [[Waterdeep_Dungeon_of_the_Mad_Mage/INDEX|Waterdeep: Dungeon of the Mad Mage]]
- **Level Range**: 5-20
...
#### 📋 [[Ghosts_of_Saltmarsh/INDEX|Ghosts of Saltmarsh]]
- **Level Range**: 1-12
...
#### 📋 [[Baldur's_Gate_Descent_into_Avernus/INDEX|Baldur's Gate: Descent into Avernus]]
- **Level Range**: 1-13
...
#### 📋 [[Icewind_Dale_Rime_of_the_Frostmaiden/INDEX|Icewind Dale: Rime of the Frostmaiden]]
- **Level Range**: 1-12
...
#### 📋 [[The_Wild_Beyond_the_Witchlight/INDEX|The Wild Beyond the Witchlight]]
- **Level Range**: 1-8
...
#### 📋 [[Call_of_the_Netherdeep/INDEX|Call of the Netherdeep]]
- **Level Range**: 3-12
...
### 📖 Adventure Collections (4)

#### 📋 [[Candlekeep_Mysteries/INDEX|Candlekeep Mysteries]]
- **Level Range**: 1-16
...
#### 📋 [[Journeys_through_the_Radiant_Citadel/INDEX|Journeys through the Radiant Citadel]]
- **Level Range**: 1-14
...
#### 📋 [[Dragons_of_Stormwreck_Isle/INDEX|Dragons of Stormwreck Isle]]
- **Level Range**: 1-3
...
#### 📋 [[Keys_from_the_Golden_Vault/INDEX|Keys from the Golden Vault]]
- **Level Range**: 1-11
...
<div class="sourcebook-selector">
    ...
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="curse_of_strahd">
        <span class="book-title">Curse of Strahd</span>
        <span class="book-meta">(CoS) - Levels 1-10</span>
        <span class="book-themes">horror, undead, gothic</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="tomb_of_annihilation">
        <span class="book-title">Tomb of Annihilation</span>
        <span class="book-meta">(ToA) - Levels 1-11</span>
        <span class="book-themes">exploration, jungle, undead</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="waterdeep_dragon_heist">
        <span class="book-title">Waterdeep: Dragon Heist</span>
        <span class="book-meta">(WDH) - Levels 1-5</span>
        <span class="book-themes">urban, intrigue, crime</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="waterdeep_dungeon_of_the_mad_mage">
        <span class="book-title">Waterdeep: Dungeon of the Mad Mage</span>
        <span class="book-meta">(WDMM) - Levels 5-20</span>
        <span class="book-themes">dungeon, magic, exploration</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="ghosts_of_saltmarsh">
        <span class="book-title">Ghosts of Saltmarsh</span>
        <span class="book-meta">(GoS) - Levels 1-12</span>
        <span class="book-themes">nautical, pirates, coastal</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="baldur's_gate_descent_into_avernus">
        <span class="book-title">Baldur's Gate: Descent into Avernus</span>
        <span class="book-meta">(DiA) - Levels 1-13</span>
        <span class="book-themes">planar, devils, redemption</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="icewind_dale_rime_of_the_frostmaiden">
        <span class="book-title">Icewind Dale: Rime of the Frostmaiden</span>
        <span class="book-meta">(RotFM) - Levels 1-12</span>
        <span class="book-themes">arctic, horror, survival</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="candlekeep_mysteries">
        <span class="book-title">Candlekeep Mysteries</span>
        <span class="book-meta">(CM) - Levels 1-16</span>
        <span class="book-themes">mystery, investigation, magic</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="the_wild_beyond_the_witchlight">
        <span class="book-title">The Wild Beyond the Witchlight</span>
        <span class="book-meta">(WBtW) - Levels 1-8</span>
        <span class="book-themes">fey, carnival, whimsical</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="call_of_the_netherdeep">
        <span class="book-title">Call of the Netherdeep</span>
        <span class="book-meta">(CoN) - Levels 3-12</span>
        <span class="book-themes">epic, multiverse, ancient</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="journeys_through_the_radiant_citadel">
        <span class="book-title">Journeys through the Radiant Citadel</span>
        <span class="book-meta">(JttRC) - Levels 1-14</span>
        <span class="book-themes">diverse, cultural, anthology</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="dragons_of_stormwreck_isle">
        <span class="book-title">Dragons of Stormwreck Isle</span>
        <span class="book-meta">(DoSI) - Levels 1-3</span>
        <span class="book-themes">dragons, beginner, island</span>
    </label>
    <label class="sourcebook-option">
        <input type="checkbox" name="sourcebooks" value="keys_from_the_golden_vault">
        <span class="book-title">Keys from the Golden Vault</span>
        <span class="book-meta">(KftGV) - Levels 1-11</span>
        <span class="book-themes">heist, crime, stealth</span>
    </label>
</div>
```
