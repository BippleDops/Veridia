...
updated: '2025-08-13T01:18:32.257374+00:00'
world: Both
status: active
---
...
The new leader of the cult is a Calishite named [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) Silrajin, who believes that real draconic knowledge and power belongs to living dragons, not undead ones.

[Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s ambition amused [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md), so she revealed the existence of five dragon masks to him—one for each chromatic dragon color. Individually, these ancient masks allow wearers to communicate with dragons. More importantly, a person who is erudite in draconic lore becomes a wyrmspeaker while wearing the mask, which allows the wearer to think like a dragon, gain favor among dragons, and subtly influence their behavior. When all five are brought together, they magically merge into a single Mask of the Dragon Queen. With the assembled mask, the cult can release [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) from her prison in the Nine Hells.

After [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) (subtly guided by [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)) discovered that secret, he bent all the cult's resources to finding the long-lost dragon masks in their secret hiding places. When he recovered the red mask, [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) became the first of the wyrmspeakers, but others soon followed.

#### Secrets

The Cult of the Dragon has kept secret its goal to bring [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) into the world thus far. Many know of the cult's increased activity along the Sword Coast, especially in the north, but the reasons behind the resurgence are unknown.

Besides his cultists, [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) has forged an alliance with a splinter faction of the Red Wizards of Thay. This small and secretive group, led by an outcast named Rath Modar, plots to unseat the lich Szass Tam from his position over the Red Wizards. Rath believes that in exchange for his help in releasing [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md), she will grant him the power he needs to overthrow Szass Tam.
...
During the time covered by the first half of this adventure, the cult already has several of the five dragon masks. While the cult works to gain more, [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) initiates the second part of his plan to release [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md): recruiting dragons and assembling a treasure hoard worthy of the queen of evil dragons. These efforts draw the characters' attention to the cult.
...
In the first volume of *Tyranny of Dragons*, the Cult of the Dragon gathered up a hoard for [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)—then lost a portion of that hoard when Skyreach Castle fell. All the while, the cult kept secret its goal of bringing back [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) and its alliance with an exiled group of Red Wizards of Thay. The cult now needs only to gather enough sacrifices to power the ritual by which the dragon masks will open a portal to the Nine Hells, allowing [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) to travel to the Material Plane.
...
- Chapter 11: Death to the Wyrmspeakers ([Varram](/03_Mechanics/CLI/bestiary/npc/varram-rot.md))  
- Chapter 10: The Sea of Moving Ice  
- Chapter 13: The Cult Strikes Back (First Attack)  
- Chapter 12: Death to the Wyrmspeakers ([Neronvain](/03_Mechanics/CLI/bestiary/npc/neronvain-rot.md))  
...
> 
> In the event that important nonplayer characters such as [Wyrmspeaker Rezmir](/03_Mechanics/CLI/bestiary/npc/rezmir-hotdq.md) or the [Red Wizard](/03_Mechanics/CLI/bestiary/humanoid/red-wizard-rot.md) [Rath Modar](/03_Mechanics/CLI/bestiary/npc/rath-modar-hotdq.md) were killed or captured, simply replace them with new nonplayer characters here—or assume that they were resurrected between the previous adventure and this one. NPCs returning from the dead show the level of magical power the cult and its [Red Wizard](/03_Mechanics/CLI/bestiary/humanoid/red-wizard-rot.md) allies wield—and their dedication to seeing [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s plans brought to fruition.
^recurring-villains
...
Lord Volmer also tells the party that the lords of the Nine Hells are divided when it comes to the matter of [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)'s release. He tells the party that if [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) is prevented from escaping, the party will earn "powerful friends" in the Nine Hells. If the characters attack Lord Volmer, he and his allies retaliate. The devil is not worried about dying, since he reforms at full strength in the Nine Hells upon his demise.
...
The plot to return [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) to the mortal realm has brought some of Faerûn's most sinister organizations and most powerful monsters into deadly alliance.
...
Inspired by [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md), [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) reexamined the texts translated by Sammaster and discovered a different interpretation, believing that "naught will be left save shattered thrones, with no rulers but the dead. Dragons shall rule the world entire..." [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s quest to reshape the cult led him to the dragon Hoondarrh, "the Red Rage of Mintarn." The fact that [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) not only survived this encounter but befriended the dragon impressed [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) in her exile in the Nine Hells. As a reward and further test, she allowed [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) a scrap of knowledge regarding the existence of the five dragon masks. [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) took that bit of information and did what few others could have accomplished, searching for and finding all five masks. The task took years to complete, and it led directly to the crisis that Faerûn now faces.

[Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) kept the red mask for himself. As other masks were found, he presented them to his closest allies in the Cult of the Dragon, granting each the power of a wyrmspeaker. Using the magic of the dragon masks, this Inner Circle of Wyrmspeakers helps [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) prepare the way for [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)'s return.
...
Cultists avoid this regalia in public, but a character who knows what to look for can often pick an incognito dragon cultist out of a crowd. Cultists sometimes greet one another with the sign of [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md): right hand extended, palm forward, with all five fingers spread in imitation of [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)'s five heads. Characters trying to pass as cultists might find this sign useful if they don't overdo it.

Cult members venerate dragons as powerful icons and masters, but their worship is reserved for [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md). They look forward to the Dragon Queen's return, believing that she will destroy mortal civilization and usher in a glorious reign of dragons—and of those who helped bring about draconic rule. The complex plot dedicated to bring [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) to Faerûn has so far seen the cult recover the five dragon masks and collect an immense treasure worthy of the Dragon Queen. All that now remains is to raise her temple in the Well of Dragons, sacrifice hundreds of victims whose souls will power an ancient ritual, and then use that ritual to open a portal through which [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) will emerge from the Nine Hells.

#### Cult Structure

The cult has a simple hierarchical structure, consisting of initiates on the bottom, four ranks for cultists, and one highest rank for "Wearers of Purple"—the lords, leaders, and cult masters of particular locales. The cult is ruled by a secretive inner group led by [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) and four other wyrmspeakers—a term of respect given to those whose bond with dragons is supernaturally strong.
...
Only [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s inner circle can promote a dragonsoul to a Wearer of Purple, granting that character a base of operations and funds. Most new Wearers of Purple have already developed a working relationship with a dragon as part of their power and authority. Those who do not cultivate and expand this relationship are sometimes demoted. A number of priests of [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) have recently been made Wearers of Purple, and have been charged with establishing temples for her open worship in Faerûn. This aspect of the cult's plans is still in the early stages, and the inner circle remains divided on how the Cult of the Dragon should interact with the faithful of [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md).

#### The Inner Circle

![Severin](/03_Mechanics/CLI/adventures/rise-of-tiamat/img/000-tod-00-01.webp#center)

These four Wearers of Purple are the keepers of the dragon masks and [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s most devoted servants in the effort to summon [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md). Each of these wyrmspeakers bears one of the dragon masks, which they never part with except under the direst circumstances—and then only at the request of [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) or a draconic ally. The members of the inner circle each have an affinity for a particular color of chromatic dragon. They treat with dragons of those colors to recruit more dragons to the cause, and plan cult missions that advance [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s plots.

In addition to [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md), the Red Wyrmspeaker, the members of the inner circle are: [Galvan](/03_Mechanics/CLI/bestiary/npc/galvan-rot.md) (male human), the Blue Wyrmspeaker; [Neronvain](/03_Mechanics/CLI/bestiary/npc/neronvain-rot.md) (male moon elf), the Green Wyrmspeaker and son of Melandrach, King of the Misty Forest; Rezmir (female half-black dragon), the Black Wyrmspeaker; and [Varram](/03_Mechanics/CLI/bestiary/npc/varram-rot.md) (male dwarf), the White Wyrmspeaker.

If any wyrmspeakers are killed or captured in your campaign—including Rezmir, who the characters might have defeated in Hoard of the Dragon Queen—[Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) appoints new followers to his inner council.

#### Dissent in the Ranks

Under [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s leadership, most cultists are devoted to [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)—but not all. Some of the old guard dislike the cult's new direction, and long for the established traditions and the rise of the dracoliches. A common thought among the dracolich loyalists is that [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) is being played by the fiendish [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md). Notable among these members of the old guard are [Naergoth Bladelord](/03_Mechanics/CLI/bestiary/npc/naergoth-bladelord-rot.md), the former commander of the stronghold at the Well of Dragons, and Jorgen Pawl and [Iskander](/03_Mechanics/CLI/bestiary/npc/iskander-rot.md), two high-ranking cultists in command of Xonthal's Tower.
...
One such [Red Wizard](/03_Mechanics/CLI/bestiary/humanoid/red-wizard-rot.md) exile is [Rath Modar](/03_Mechanics/CLI/bestiary/npc/rath-modar-hotdq.md), an illusionist of great skill who long ago made the Sword Coast his home. Having a natural interest in dragons, it wasn't long before Rath Modar came into contact with the Cult of the Dragon and [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md). The young, ambitious cult leader sought powerful magic to locate the scattered dragon masks and to perform the ritual that would summon [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) from the Nine Hells. Rath Modar dreamed of an army that could confront and defeat Szass Tam. Out of mutual need, their alliance was born.

The secret cornerstone of this union is Rath Modar's belief that once [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) returns, she will see that the Red Wizards are more useful allies than the devoted but magically weak cultists. Rath Modar hopes that [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) will show her gratitude for the pivotal role he and his fellow Red Wizards played in her return, granting them an army of dragons with which to assault Thay. After unseating Szass Tam, Rath Modar plans to take his place at the head of all Red Wizards. Whether [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) will grant such a reward—or have any further use for the Red Wizards at all—remains unknown.

Not all members of the Cult of the Dragon are happy about the Red Wizards' involvement in the cult's plans. Wyrmspeaker [Varram](/03_Mechanics/CLI/bestiary/npc/varram-rot.md) foresees trouble in the cult joining forces with Rath Modar's splinter sect. He has warned [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) about the potential danger, to no avail.

#### Using the Red Wizards

Red Wizards can be encountered anywhere on the Sword Coast (use [mage](/03_Mechanics/CLI/bestiary/humanoid/mage-xmm.md) stats if necessary), whether operating alongside cultists or on their own. They most often work alone, but two or three Red Wizards might join forces for an important assignment. In a public area where their appearance could put them at risk, Red Wizards favor deep hoods and scarves to hide their faces. Their undead [wight](/03_Mechanics/CLI/bestiary/undead/wight-xmm.md) bodyguards are usually nearby—and often [invisible](/03_Mechanics/CLI/conditions.md#Invisible). Each [Red Wizard](/03_Mechanics/CLI/bestiary/humanoid/red-wizard-rot.md) specializes in a single school of magic, but all learn spells outside their specialty schools.

Red Wizards don't share the cultists' fanaticism for [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md). For them, bringing the Dragon Queen into the world is just one stage of what they call the Thayan Resurrection—the larger plan to destroy Szass Tam and reclaim Thay. They tolerate the dragon cultists but do not acknowledge them as equals.

Not every [Red Wizard](/03_Mechanics/CLI/bestiary/humanoid/red-wizard-rot.md) on the Sword Coast is working for Rath Modar or the Cult of the Dragon. Some pursue their own interests, while others are spies for Szass Tam. The adventurers might thus find themselves making uneasy alliances with characters they would normally never trust, since the easiest and surest way to eliminate a [Red Wizard](/03_Mechanics/CLI/bestiary/humanoid/red-wizard-rot.md) in service to the cult is to betray that wizard's location to an agent of Szass Tam. However, characters who get too close to Szass Tam's servants and his paranoid vendetta against the [Red Wizard](/03_Mechanics/CLI/bestiary/humanoid/red-wizard-rot.md) exiles might find themselves at the mercy of the Thayans. This possibility is explored more fully in chapter 16.

### Hosts of the Nine Hells

[Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) has long threatened Faerûn, often appearing in lands such as Chessenta and Unther to drive mortals to worship her awesome power. Although mortals don't know it, the end of the Sundering and the Era of Upheaval also put an end to such direct meddling by the gods. Without powerful magic and mortal aid, [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) cannot travel from her home in Avernus into the world.
...
Asmodeus recently reinstated the fallen angel Zariel as the Archduchess of Avernus, reversing an earlier decision that allowed a pit fiend named Bel to take the throne. While in exile from her seat of power, Zariel was at the mercy of [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)—a fate that rankles her still. Despite her power as ruler of the first layer of the Nine Hells, Zariel cannot kill the dragon goddess, and she sees the summoning of [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) to the world as a way to be rid of her.

Zariel has directed her mortal agents to assist those who seek to free [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md), and her power has made it easier for the Red Wizards to summon devils and for the Cult of the Dragon to find more adherents. However, just as Zariel wants [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) out, other devils would be happy to see the Dragon Queen stay in Avernus. Foremost among them is the deposed pit fiend Bel and the devils still loyal to him.

Ordinarily, the Cult of the Dragon has nothing to do with devils. However, releasing [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) into the world is a massive undertaking, and [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) has called on every resource he can. Though many of his allies among the Red Wizards are well schooled in summoning and commanding devils, doing so is never a straightforward process. Devils cannot leave the Nine Hells of their own accord, and though Asmodeus can bend these laws, he seldom does. Most devils in the Material Plane were summoned there by mortal mages who expended tremendous amounts of magical power to breach the barriers that separate the Nine Hells from other planes.
...
[Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md) and his supporters intend to use the ancient draconic artifact known as the [Draakhorn](/03_Mechanics/CLI/items/draakhorn-rot.md) to rally the chromatic dragons to [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)'s cause. However, chromatic dragons are notoriously arrogant, territorial, greedy, and suspicious of any creatures begging favors—especially if those creatures might be a threat. Getting dragons to cooperate is a monumental task, even when bringing the Queen of Dragons into the world is the ultimate goal.
...
With lifetimes of a thousand years or more to lose, chromatic dragons have no interest in dying in battle against mere humanoids, and they don't sacrifice themselves nobly for any cause—[Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) included. A dragon caught in a losing battle takes any escape that presents itself, most often simply soaring away. This changes during the final showdown at the Well of Dragons, however, when [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) can be seen clawing her way through the portal from the Nine Hells.
...
![](/03_Mechanics/CLI/adventures/rise-of-tiamat/img/001-symbol-harpers.webp#center)
...
Remi is convinced that the rumors of [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md)'s return are true, and she is frustrated by the unwillingness of the other Harpers to commit to fighting the Cult of the Dragon. She understands their hesitation, however. The Harpers' have only recently been reformed, and the cause of their near-destruction was the decision to act more openly and aggressively.
...
![](/03_Mechanics/CLI/adventures/rise-of-tiamat/img/002-ooa08-03.webp#center)
...
The Order of the Gauntlet is an invaluable asset at the final showdown at the Well of Dragons. No other faction can muster more paladins and priests to heal the wounded and combat [Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s devil allies directly.
...
![](/03_Mechanics/CLI/adventures/rise-of-tiamat/img/003-ooa08-05a.webp#center)
...
[Severin](/03_Mechanics/CLI/bestiary/npc/severin-rot.md)'s plan to release [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) from the Nine Hells represents a grave threat to the natural order. The Dragon Queen's reign and the ascendancy of chromatic dragons would trigger a continent-wide catastrophe that the Emerald Enclave cannot allow.
...
Delaan's oldest friend and mentor is a mighty treant named Turlang who resides in the High Forest. With Delaan's support, many treants will join the fight against [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md).

### The Lords' Alliance

![](/03_Mechanics/CLI/adventures/rise-of-tiamat/img/004-symbol-alliance.webp#center)
...
**Ideals**: Tradition, honor ("Against [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md), we either stand together or fall alone. Who will stand with Cormyr?")
...
![](/03_Mechanics/CLI/adventures/rise-of-tiamat/img/005-symbol-zhentarim.webp#center)
...
However, engaging in mainstream corruption and wanting to see [Tiamat](/03_Mechanics/CLI/bestiary/npc/tiamat-rot.md) ascendant are two different things. The Zhentarim have no illusions about what the Dragon Queen's return would mean for their plans. Wanting to secretly rule the world from the shadows for themselves, the leaders of the Black Network have no desire to become agents and errand-runners for some petty god and her dragon cohorts.
...
At least one Black Network mission is carried out regardless of payment. Without the knowledge of anyone outside the Zhentarim, one of their agents has infiltrated the cult and gets close enough to Wyrmspeaker [Varram](/03_Mechanics/CLI/bestiary/npc/varram-rot.md) to steal the *White Dragon Mask*. This theft sets off a sequence of events that culminates in [Varram](/03_Mechanics/CLI/bestiary/npc/varram-rot.md)'s portion of the "Death to the Wyrmspeakers" chapter.
...
01 campaign overview is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
