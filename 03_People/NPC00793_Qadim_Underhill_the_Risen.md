...
## Appearance
Average height and heavyset, with Partially shaved silver hair and Heterochromic eyes. Pale skin. Missing ear from old battle.

**Clothing**: Merchant's outfit with many hidden pockets
**Accessories**: Decorated dagger

## Personality
- **Traits**: Incredibly optimistic despite evidence; Never uses people's real names; Flirts with everyone regardless of interest
...
## Relationships
### Rhiannon Lightbringer the Strong (Criminal - Target)
...
### Aldric Brightblade the Fallen (Personal - Best friend)
...
### Skills
Perception, Animal Handling, Investigation
