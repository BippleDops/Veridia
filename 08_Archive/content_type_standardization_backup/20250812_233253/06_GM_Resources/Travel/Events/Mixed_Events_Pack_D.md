...
Mixed Events Pack D is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of Mixed Events Pack D as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Mixed Events Pack D.

## Adventure Hooks

- A rumor ties Mixed Events Pack D to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at Mixed Events Pack D to avert a public scandal.
- A map overlay reveals a hidden approach to Mixed Events Pack D active only during specific tides/storms.
