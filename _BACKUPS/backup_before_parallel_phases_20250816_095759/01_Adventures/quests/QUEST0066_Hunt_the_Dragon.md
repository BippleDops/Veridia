...
*Escort Quest for levels 4-8*

**ID**: QUEST0066

## Quest Giver
**Alistair Darkwater the Merciful** - Military officer
...
## Key Locations
- **OldMarsh** (City): Key location for quest progression
- **NewMarsh** (Dungeon): Key location for quest progression
- **FortMarsh** (Wilderness): Key location for quest progression
- **PortMarsh** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Undead** led by Alistair Shadowmere
...
- **Gold**: 3,171 gp
- **Experience**: 4,000 XP
- **Magic Items**: Cursed Blade of the Dawn
- **Other**: Property deed
