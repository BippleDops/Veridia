...
- world/both
type: note
updated: '2025-08-13T12:34:19.272730+00:00'
world: Both
---
...
| Roll | Result |
|------|--------|
| 1-3 | [[/03_Mechanics/CLI/bestiary/monstrosity/stirge-xmm|Stirges]] (`2d4`) |
| 4-5 | [[/03_Mechanics/CLI/bestiary/undead/ghoul-xmm|Ghouls]] (`d4`) |
| 6 | [[/03_Mechanics/CLI/bestiary/aberration/grick-xmm|Gricks]] (`d4`) |
| 7-8 | [[/03_Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm|Bugbears]] (`d4`) |
| 9 | [[/03_Mechanics/CLI/bestiary/undead/skeleton-xmm|Skeletons]] (`d6`) |
| 10 | [[/03_Mechanics/CLI/bestiary/undead/zombie-xmm|Zombies]] (`d6`) |
| 11-12 | [[/03_Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm|Ochre Jelly]] (1) |
^wandering-monsters

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/lost-mine-of-phandelver/img/wave-echo-cave.webp#gallery|Wave Echo Cave]]
> ![[/03_Mechanics/CLI/adventures/lost-mine-of-phandelver/img/wave-echo-cave-player.webp#gallery|Player Version]]
...
None unless otherwise indicated. The boxed text assumes that the characters have light sources or [[/03_Mechanics/CLI/senses#Darkvision|darkvision]].
...
Climbing up or down the wall of the pit without a rope requires a successful DC 15 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check. A character who fails the check by 5 or more falls and takes `d6` bludgeoning damage per 10 feet fallen, landing [[/03_Mechanics/CLI/conditions#Prone|prone]] at the bottom. The tunnel at the bottom of the pit leads northwest toward 2 and east toward 3.

### Treasure

Tharden wears a pair of [[/03_Mechanics/CLI/items/boots-of-striding-and-springing-xdmg|boots of striding and springing]]. In his haste to explore the rest of Wave Echo Cave, Nezznar overlooked them.
...
Clinging to the ceiling like bats are ten [[/03_Mechanics/CLI/bestiary/monstrosity/stirge-xmm|stirges]]. The monsters find scant living prey in the mines, and they are ravenous. If the characters are looking down at the skeletons on the floor, the stirges are likely get the drop on them. Any character who isn't watching the ceiling is [[/03_Mechanics/CLI/conditions#Surprised|surprised]] unless his or her passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score is higher than the stirges' Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check total (roll once for all of them). Characters who aren't [[/03_Mechanics/CLI/conditions#Surprised|surprised]] hear a flapping noise as the stirges descend to attack.
...
In the round after any living creature enters this chamber, the bones begin to stir and knit together, forming nine [[/03_Mechanics/CLI/bestiary/undead/skeleton-xmm|skeletons]]. They fight until destroyed.
...
Behind the counter sits a locked iron strongbox, requiring [[/03_Mechanics/CLI/items/thieves-tools-xphb|thieves' tools]] and a successful DC 20 Dexterity check to open. This pay chest was overlooked in the fighting and contains 600 cp, 180 sp, 90 ep, and 60 gp.

## 6. South Barracks

This was a miners' barracks, where the skilled delvers working in Wave Echo Cave rested between shifts. Any character who listens at the partially open door hears faint crunching and splintering sounds with a successful DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check.
...
Three [[/03_Mechanics/CLI/bestiary/undead/ghoul-xmm|ghouls]] from the pack in 9 are here, cracking and gnawing on the ancient bones of the fallen in the vain hope that some tasty morsel of marrow remains. The ghouls, eager for a fresh meal, attack immediately.
...
Most of the fungi is harmless, and the green-glowing fungi allow creatures to see the entire cavern without the aid of [[/03_Mechanics/CLI/senses#Darkvision|darkvision]] or a light source.

### Poison Gas

Whenever a creature attempts to cross the cavern, the carpets of fungi that cover most of the floor release poisonous gas into the air. Each creature in the cavern must succeed on a DC 11 Constitution saving throw or take `3d6` poison damage and be [[/03_Mechanics/CLI/conditions#Poisoned|poisoned]] for 10 minutes (see the rulebook for more information on the [[/03_Mechanics/CLI/conditions#Poisoned|poisoned]] condition). The gas disperses after 1 minute, but until then, any living creature that ends its turn in the cavern must repeat the saving throw.
...
Seven [[/03_Mechanics/CLI/bestiary/undead/ghoul-xmm|ghouls]] lurk in the shadows on the western ledge.
...
The escarpments are 10 feet high and require a successful DC 12 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check to climb. A creature that falls or is knocked from the top of a ledge takes `d6` bludgeoning damage and lands [[/03_Mechanics/CLI/conditions#Prone|prone]].
...
The skeleton wears two platinum rings (75 gp each) and clutches a [[/03_Mechanics/CLI/items/wand-of-magic-missiles-xdmg|wand of magic missiles]] in its bony fingers.

## 11. North Barracks

The eastern door is barricaded from inside the room and requires a successful DC 20 Strength check to force open. A character who listens at either door and succeeds on a DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check hears gruff voices speaking Goblin and talking about how hungry they are.
...
The largest bugbear carries a pouch containing 15 cp. 13ep, and a [[/03_Mechanics/CLI/items/potion-of-vitality-xdmg|potion of vitality]].
...
Eight of the fallen dwarf warriors are [[/03_Mechanics/CLI/bestiary/undead/zombie-xmm|zombies]]. They rise and pursue any living creatures that enter the room, but they do not pursue creatures outside this area for more than 1 round. In addition, a far more intelligent undead guards this area: a [[/03_Mechanics/CLI/bestiary/undead/flameskull-xmm|flameskull]]. This creature was a servant of the human wizards allied with the Phandelver dwarves and gnomes, and it continues to act on ancient instructions to prevent intruders from passing through.
...
Any character proficient in [[/03_Mechanics/CLI/skills#Arcana|Arcana]] can sense a subtle aura of magic in this cavern. (A [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell reveals the same.) The aura becomes stronger as one approaches the northern building (15).
...
This room contains the restless spirit of the last wizard to die here: [[/03_Mechanics/CLI/bestiary/npc/mormesk-the-wraith-lmop|Mormesk the wraith]]. He is not immediately visible but rises up out of the floor when a living creature enters the room.

Mormesk was a powerful mage until he met his end in the spell battle at the climax of the orc attack. Centuries of anger have [[/03_Mechanics/CLI/conditions#Poisoned|poisoned]] his soul, transforming him into a hate-filled apparition.
...
On the worktable in the southeast corner of the room are the last items the spectator was charged to protect: [[/03_Mechanics/CLI/items/lightbringer-lmop|Lightbringer]] and [[/03_Mechanics/CLI/items/dragonguard-lmop|Dragonguard]].
...
Three [[/03_Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm|bugbears]] are stationed here. Two of them are clearing rock on the rift floor while one more stands guard in the western half of the cavern. A [[/03_Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm|doppelganger]] named Vhalak supervises the operation in the guise of a male drow. If a fight breaks out in the main cavern, the two bugbears in the rift climb up the ropes to join the fray.

### Rift

The rift is 20 feet deep. Climbing up or down without using a rope requires a successful DC 10 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check. A creature that fails the check by 5 or more falls and takes `d6` bludgeoning damage per 10 feet fallen, landing [[/03_Mechanics/CLI/conditions#Prone|prone]] at the bottom.
...
Nezznar's divinations are accurate. Buried under heavy rubble at the bottom of the rift is the crushed skeleton of a dwarf wearing [[/03_Mechanics/CLI/items/gauntlets-of-ogre-power-xdmg|gauntlets of ogre power]]. The remains are hidden from view but can be found with a successful DC 20 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check. Each character searching can attempt one check per hour.
...
[[/03_Mechanics/CLI/bestiary/npc/nezznar-the-black-spider-lmop|Nezznar the Black Spider]] is joined by four [[/03_Mechanics/CLI/bestiary/beast/giant-spider-xmm|giant spiders]] that defend their master to the death. If they are expecting trouble, the spiders hide behind pillars, and Nezznar casts [[/03_Mechanics/CLI/spells/invisibility-xphb|invisibility]] on himself and stands near the table. Make a Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check for the spiders. When intruders appear, the spiders try to entangle them in webs before closing to melee range. Nezznar joins the fray on the round after the spiders attack.

If the [[/03_Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm|doppelganger]] from 18 retreated to this area, it assumes the guise of [[/03_Mechanics/CLI/bestiary/npc/nundro-rockseeker-lmop|Nundro Rockseeker]] so that Nezznar can use the "dwarf" as leverage to force the party's surrender (although the drow won't actually harm the doppelganger). See the "Roleplaying Nezznar" section for more information on the drow villain.

### Statue

The statue depicts Dumathoin, the dwarven god of mining. Any character who has proficiency in [[/03_Mechanics/CLI/skills#Religion|Religion]] recognizes the deity. The statue is beautifully carved, and its emerald eyes appear extremely valuable. However, the jewels are clever fakes made of worthless glass, as close inspection and a successful DC 15 Intelligence ([[/03_Mechanics/CLI/skills#Investigation|Investigation]]) check reveals. Nevertheless, a powerful spell protects them, and a [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell reveals a strong aura of abjuration magic surrounding the statue.

A character can climb the statue easily and pry a jewel loose with a successful DC 10 Strength check. However, if either eye is removed, the pillars that line the walls crack, triggering a ceiling collapse. Each creature in the room must make a DC 15 Dexterity saving throw, taking `4d10` bludgeoning damage from falling rubble and falling [[/03_Mechanics/CLI/conditions#Prone|prone]] on a failure, or taking only half the damage on a success.
...
If the characters capture Nezznar and deliver him to the townmaster's hall in Phandalin, the drow is locked up until [[/03_Mechanics/CLI/bestiary/npc/sildar-hallwinter-lmop|Sildar Hallwinter]] or another representative of the Lords' Alliance can escort him to Neverwinter to face justice and interrogation. However, unless the characters post guards outside Nezznar's cell, Halia Thornton (see page 17) breaks him out of jail, smuggles him out of Phandalin, and delivers him into the waiting arms of the Zhentarim. The Zhents want to learn everything the Black Spider knows about Wave Echo Cave. What happens to Nezznar at that point is up to you.

### Treasure

Nezznar carries a [[/03_Mechanics/CLI/items/potion-of-healing-xdmg|potion of healing]] and a [[/03_Mechanics/CLI/items/spider-staff-lmop|spider staff]]. In addition, the drow carries an iron key with a head shaped like an anvil. This key unlocks the door to 20.
...
If Nezznar is captured alive and delivered to [[/03_Mechanics/CLI/bestiary/npc/sildar-hallwinter-lmop|Sildar Hallwinter]] or Townmaster Wester in Phandalin, award the party double his XP value.

## 20. Priests' Quarters

The door to this room is locked, requiring [[/03_Mechanics/CLI/items/thieves-tools-xphb|thieves' tools]] and a successful DC 15 Dexterity check to open. Nezznar (19) carries the key.
...
> [!readaloud] 
> 
> Dusty draperies adorn the walls of this room, which also contains a bed and brazier. A badly disheveled dwarf lies bound and [[/03_Mechanics/CLI/conditions#Unconscious|unconscious]] on the cold stone floor.
^195

This room formerly belonged to the priest in charge of Dumathoin's temple (19), but Nezznar has appropriated it for use as a cell. The figure lying on the floor is [[/03_Mechanics/CLI/bestiary/npc/nundro-rockseeker-lmop|Nundro]], a dwarf [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]] and the youngest of the three Rockseeker brothers. Nezznar spared him because he thought the dwarf might know more about the mine than he admitted. The drow has interrogated Nundro harshly once or twice a day ever since capturing him.
...
Gundren and [[/03_Mechanics/CLI/bestiary/npc/nundro-rockseeker-lmop|Nundro Rockseeker]] take over administration of the new mine. For the adventurers' service to their family, they gladly award the party a 10 percent share of the mine's profits. If the characters want to remain in Phandalin and perhaps restore Tresendar Manor or establish homes of their own, the people of the area are glad to have them stay. Even if they choose to move on in search of new adventures, they'll always have a warm welcome in Phandalin.
