...
"actions":
  ...
  - "desc": "Strength Saving Throw: DC 21, each creature that isn't currently affected\
      \ by this breath in a 60-foot [Cone](/03_Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
...
"legendary_actions":
  - "desc": "Charisma Saving Throw: DC 21, one creature the dragon can see within\
      \ 120 feet. Failure: 10 (3d6) Force damage, and the target has the [Incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated)\
