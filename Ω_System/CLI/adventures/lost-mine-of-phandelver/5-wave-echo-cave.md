...
| 4-5 | [Ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) (`d4`) |
| 6 | [Gricks](/3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) (`d4`) |
| 7-8 | [Bugbears](/3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) (`d4`) |
| 9 | [Skeletons](/3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) (`d6`) |
| 10 | [Zombies](/3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) (`d6`) |
...
Whenever a creature attempts to cross the cavern, the carpets of fungi that cover most of the floor release poisonous gas into the air. Each creature in the cavern must succeed on a DC 11 Constitution saving throw or take `3d6` poison damage and be [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) for 10 minutes (see the rulebook for more information on the [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) condition). The gas disperses after 1 minute, but until then, any living creature that ends its turn in the cavern must repeat the saving throw.
...
The escarpments are 10 feet high and require a successful DC 12 Strength ([Athletics](/3-Mechanics/CLI/skills.md#Athletics)) check to climb. A creature that falls or is knocked from the top of a ledge takes `d6` bludgeoning damage and lands [prone](/3-Mechanics/CLI/conditions.md#Prone).
...
A successful DC 15 Intelligence ([Arcana](/3-Mechanics/CLI/skills.md#Arcana)) check identifies the brazier as the source of the magic that suffuses the surrounding caverns. This magic has waned over the years, to the extent that it can no longer be harnessed to permanently enchant magic items. However, any nonmagical weapon or armor bathed in the green flame for at least 1 minute becomes a [+1 weapon](/3-Mechanics/CLI/items/1-weapon-xdmg.md) or [+1 armor](/3-Mechanics/CLI/items/1-armor-xdmg.md), respectively, for `d12` hours. The brazier cannot be removed from the Forge of Spells.
