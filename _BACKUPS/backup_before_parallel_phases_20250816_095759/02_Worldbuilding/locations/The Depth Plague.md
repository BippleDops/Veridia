...
- **Infected Claw.** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 8 (`dice: 1d10` + 3) slashing damage plus 4 (`dice: 1d8`) necrotic damage.
...
- **Purified Trident.** *Melee or Ranged Weapon Attack:* +7 to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* 7 (`dice: 1d6` + 4) piercing damage plus 4 (`dice: 1d8`) radiant damage. If the target is diseased, it takes an additional 4 (`dice: 1d8`) radiant damage.
...
Ongoing situations affecting The Depth Plague:
