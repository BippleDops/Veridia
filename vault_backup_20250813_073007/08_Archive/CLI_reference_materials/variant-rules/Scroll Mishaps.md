...
- world/both
type: note
updated: '2025-08-13T12:34:18.803801+00:00'
world: Both
---
...
A creature who tries and fails to cast a spell from a [[/03_Mechanics/CLI/items/spell-scroll-xdmg|spell scroll]] must make a DC 10 Intelligence saving throw. If the saving throw fails, roll on the Scroll Mishap table.
...
| 4 | The spell's effect is contrary to its normal one, but neither harmful nor beneficial. For instance, a [[/03_Mechanics/CLI/spells/fireball-xphb|fireball]] might produce an area of harmless cold. |
| 5 | The caster suffers a minor but bizarre effect related to the spell. Such effects last only as long as the original spell's duration, or `d10` minutes for spells that take effect instantaneously. For example, a [[/03_Mechanics/CLI/spells/fireball-xphb|fireball]] might cause smoke to billow from the caster's ears for `d10` minutes.  |
