...
subcategory: Quest Tree System.Md
related: []
cssclass: standard
publish: false
...
5. Nevertheless, **Epilogue**: World changed ### Quest Chain_34 1. **Introduction**: Cry for help


2. **Investigation**: Gather 7 clues
5. **Epilogue**: Rewards granted ### Quest Chain_35 3. **Confrontation**: Face the betrayer


4. **Resolution**: Justice served ### Quest Chain_36 2. **Investigation**: Gather 4 clues

5. **Epilogue**: New quests unlocked ## Objectives
