...
While these pipes are on your person, ordinary [rats](/03_Mechanics/CLI/bestiary/beast/rat-xmm.md) and [giant rats](/03_Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) are [Indifferent](/03_Mechanics/CLI/variant-rules/indifferent-attitude-xphb.md) toward you and won't attack you unless you threaten or harm them.

The pipes have 3 charges and regain `d3` expended charges daily at dawn. If you play the pipes as a [Magic](/03_Mechanics/CLI/actions.md#Magic) action, you can take a [Bonus Action](/03_Mechanics/CLI/variant-rules/bonus-action-xphb.md) to expend 1 to 3 charges, calling forth one [Swarm of Rats](/03_Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) with each expended charge if enough rats are within half a mile of you to be called in this fashion (as determined by the DM). If there aren't enough rats to form a swarm, the charge is wasted. Called swarms move toward the music by the shortest available route but aren't under your control otherwise.
