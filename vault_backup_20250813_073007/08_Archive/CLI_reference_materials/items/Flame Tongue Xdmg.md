...
- world/both
type: note
updated: '2025-08-13T12:34:21.717816+00:00'
world: Both
---
...
While holding this magic weapon, you can take a [[/03_Mechanics/CLI/variant-rules/bonus-action-xphb|Bonus Action]] and use a command word to cause flames to engulf the damage-dealing part of the weapon. These flames shed [[/03_Mechanics/CLI/variant-rules/bright-light-xphb|Bright Light]] in a 40-foot radius and [[/03_Mechanics/CLI/variant-rules/dim-light-xphb|Dim Light]] for an additional 40 feet. While the weapon is ablaze, it deals an extra `2d6` Fire damage on a hit. The flames last until you take a [[/03_Mechanics/CLI/variant-rules/bonus-action-xphb|Bonus Action]] to issue the command again or until you drop, stow, or sheathe the weapon.
...
Flame tongue xdmg is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of flame tongue xdmg as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around flame tongue xdmg.

## Adventure Hooks

- A rumor ties flame tongue xdmg to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at flame tongue xdmg to avert a public scandal.
- A map overlay reveals a hidden approach to flame tongue xdmg active only during specific tides/storms.
