...
## Appearance
Very short and heavyset, with Partially shaved brown hair and Hazel eyes. Tan skin. Burn scars on one side of face.

**Clothing**: Merchant's outfit with many hidden pockets
**Accessories**: Decorated dagger

## Personality
- **Traits**: Never backs down from any challenge; Flirts with everyone regardless of interest; Collects unusual and worthless objects
- **Ideal**: Redemption: Everyone deserves a second chance
- **Bond**: I would die to protect my family from harm
- **Flaw**: I'll do anything to avoid a real fight
- **Quirks**: Taps fingers when thinking, Hums when nervous, Never eats meat
...
- Uncanny Dodge: Half damage from one attack
- Spellcasting: 7 spell slots, knows Hold Person, Counterspell, Lightning Bolt, Charm Person, Misty Step, Sleep, Scorching Ray
