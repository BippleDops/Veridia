...
"actions":
  ...
  - "desc": "The oblex casts one of the following spells, requiring no spell components\
      ...
      \ (as 5th-level spell), [[detect-thoughts-xphb (spells)]],\
...
Adult oblex mpmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
