...
related: []
cssclass: standard
publish: false --- # NPC1 ## Portrait![[Npc|Npc]] *Portrait reference for NPC1* ## Overview This topic is referenced in [[Npc|Npc]] and other parts of the campaign. ## Description An important element of the campaign world that connects to various other aspects of the adventure. ## Connections - Referenced by: [[Npc|Npc]]
