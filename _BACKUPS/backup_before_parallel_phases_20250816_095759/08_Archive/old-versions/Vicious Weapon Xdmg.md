...
*Rare* ![](/03_Mechanics/CLI/items/img/vicious-weapon.webp#right) This magic weapon deals an extra``dice: 2d6``damage to any creature it hits. This extra damage is of the same type as the weapon's normal damage. **Variants**:
...
- [Vicious Yklwa](#Vicious%20Yklwa) ### Vicious Yklwa - **Damage**: `dice: 1d8` piercing
