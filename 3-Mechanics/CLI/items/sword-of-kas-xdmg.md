...
You gain a +3 bonus to attack rolls and damage rolls made with the sword, which scores a [Critical Hit](/3-Mechanics/CLI/variant-rules/critical-hit-xphb.md) on a roll of 19 or 20 on the `d20` and deals an extra `2d10` Slashing damage to Undead.
...
- **Battle Hunger.** You add `d10` to your [Initiative](/3-Mechanics/CLI/variant-rules/initiative-xphb.md) rolls.  
