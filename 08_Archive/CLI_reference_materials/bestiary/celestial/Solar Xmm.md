...
# [[3-Mechanics\CLI\bestiary\celestial/solar-xmm|Solar]]
...
"traits":
  ...
  - "desc": "The solar has [[/03_Mechanics/CLI/variant-rules/advantage-xphb|Advantage]]\
...
"actions":
  ...
  - "desc": "Dexterity Saving Throw: DC 21, one creature the solar can see within\
      \ 600 feet. Failure: If the creature has 100 [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Points]]\
  ...
  - "desc": "The solar casts one of the following spells, requiring no Material components\
      ...
      \ Good]], [[/03_Mechanics/CLI/spells/resurrection-xphb|Resurrection]]"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The solar casts [[/03_Mechanics/CLI/spells/cure-wounds-xphb|Cure Wounds]]\
      \ (level 2 version), [[/03_Mechanics/CLI/spells/lesser-restoration-xphb|Lesser Restoration]],\
...
"legendary_actions":
  - "desc": "Constitution Saving Throw: DC 25, one creature the solar can see within\
      \ 120 feet. Failure: The target has the [[/03_Mechanics/CLI/conditions#Blinded|Blinded]]\
  ...
  - "desc": "The solar teleports up to 60 feet to an unoccupied space it can see.\
      \ Dexterity Saving Throw: DC 25, each creature in a 10-foot [[/03_Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb|Emanation]]\
...
Solar xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
