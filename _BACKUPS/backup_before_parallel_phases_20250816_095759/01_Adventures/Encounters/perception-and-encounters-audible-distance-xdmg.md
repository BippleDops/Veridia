...
title: perception-and-encounters-audible-distance-xdmg
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["perception-and-encounters-audible-distance-xdmg"]
status: active
priority: normal
...
---
 ...
 # perception-and-encounters-audible-distance-xdmg ---
...
updated: '2025-08-12T23:37:33.341648'
world: Both

--- # Perception and Encounters; Audible Distance

*Source: Dungeon Master's Guide (2024) p. 34* **Audible Distance** | Noise | Distance |
|-------|----------|
| Trying to be quiet |``dice: 2d6` × 5`feet |
| Normal noise level |``dice: 2d6` × 10`feet |
| Very loud |``dice: 2d6` × 50`feet |

^audible-distance ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Perception and encounters audible distance xdmg is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of perception and encounters audible distance xdmg as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around perception and encounters audible distance xdmg. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. Enriched: true --> ## Related *Links to related content will be added here.* ## Plot Hooks - A journal reveals a conspiracy about the government

- A noble needs help investigating before dawn
- Someone is protecting a artifact for money
- An heirloom has gone missing and evil awakens ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research ## Scaling by Party Level
