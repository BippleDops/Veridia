...
- **Mission Status:** Conducting "routine maintece" while crew attends shore leave rotations
...
- Security Chief Lieutet Helena Wardwell (recently assigned, unknown loyalties)  
...
**Fleet Disposition:**
The Crown Fleet maintains a defensive formation designed to protect the flagship while conducting maintece operations:
...
- **Crystal Resoce:** Magical effects enhanced by thin air and crystal formations
...
- **Workshop Spaces:** Maintece and repair facilities
...
- **Bypass Methods:** Crystal resoce dampening, magical signature masking, system overload
...
#### **Scenario A: Maintece Access**

**Cover Story:** PCs pose as civilian contractors performing routine maintece on ship systems.
...
- Magical detection system alerts (Yellow → Orange)
...
- **Ficial Indicators:** Lifestyle improvements inconsistent with naval salary and benefits
...
- **Crystal Resoce:** Enhanced magical effects but also increased detection risk
