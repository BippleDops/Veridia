...
## Appearance
Towering and lanky, with Mohawk bald hair and Gray eyes. Scarred skin. Constantly changing hair color.

**Clothing**: Noble's finery, slightly out of current fashion
**Accessories**: Silk handkerchief, Spectacles on chain

## Personality
- **Traits**: Never uses people's real names; Compulsive liar about minor things; Speaks to inanimate objects
...
## Relationships
### Nerys Thornweave the Lost (Professional - Employer)
- **Status**: Complicated history
- **History**: Grew up together in the same neighborhood
- **Secret**: Both serve same hidden master

### Gavril Jadeclaw the Mystic (Criminal - Handler)
- **Status**: Complicated history
