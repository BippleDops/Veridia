---
aliases: ["Princess's Gambit", "princess's gambit", "Gambit Princess's"]
tags: [generated]
id: QUEST0084
...
## Quest Giver
**Ewan Brightblade** - Military officer
...
- **Valewick** (Dungeon): Key location for quest progression
- **OldFalls** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Corrupt Guards** led by Ewan Fireborn
  - Strength: 13 combatants
