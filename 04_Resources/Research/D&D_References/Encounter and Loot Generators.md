...
- Coin Purse:`dice: 3d6*10|Gold (gp)`- Gem Cache:`dice: 2d6*25|Gem Value (gp)`- Scroll Rarity:`dice: 1d6|1-3 Common,4-5 Uncommon,6 Rare`Party level modifier:`dice: 2d6*{level}|Parcel (gp)`### Network Position
