...
improvements: 20
status: active
aliases: ["Mechanics Magic Items"]
priority: normal
category: 05 Rules
subcategory: Mechanics Magic Items.Md
related: []
cssclass: standard
publish: false
...
*Tags*: #mechanics #rules #homebrew #variant #system ## Rule Summary 03_Mechanics_Magic_Items provides a systematic approach to handling specific game situations. This mechanic integrates with core D&D 5e rules while adding depth to gameplay. ## When to Use Apply this rule when:
...
- Connections to overarching campaign themes ## Plot Hooks - A merchant needs help stealing before dawn

- Strange sightings suggest a curse ## Examples of Play ### Basic Example
