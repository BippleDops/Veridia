...
title: dragon-slayer-xdmg (items)
type: item
tags:
- item
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["dragon-slayer-xdmg (items)"]
status: active
priority: normal
...
updated: '2025-08-12T23:37:37.189231'
world: Both

--- # Dragon Slayer

*Rare* ![](/03_Mechanics/CLI/items/img/dragon-slayer.webp#right) You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon. The weapon deals an extra``dice: 3d6``damage of the weapon's type if the target is a Dragon. **Variants**:
...
- [Dragon Slayer Yklwa](#Dragon%20Slayer%20Yklwa) ### Dragon Slayer Yklwa - **Damage**: `dice: 1d8` piercing
