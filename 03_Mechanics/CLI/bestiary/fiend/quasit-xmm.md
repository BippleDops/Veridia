...
"cr": "1"
"traits":
  - "desc": "The quasit has [Advantage](/03_Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "Wisdom Saving Throw: DC 10, one creature within 20 feet. Failure:\
    ...
    "name": "Scare (1/Day)"
  - "desc": "The quasit shape-shifts to resemble a bat ([Speed](/03_Mechanics/CLI/variant-rules/speed-xphb.md)\
      ...
      \ same in each form, except for its [Speed](/03_Mechanics/CLI/variant-rules/speed-xphb.md).\
      \ Any equipment it is wearing or carrying isn't transformed."
    "name": "Shape-Shift"
  - "desc": "The quasit casts [Invisibility](/03_Mechanics/CLI/spells/invisibility-xphb.md)\
