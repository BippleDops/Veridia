...
- world/both
type: note
updated: '2025-08-13T12:34:19.269611+00:00'
world: Both
---
...
|-----------|-----------|
| 1–10 | No encounter |
| 11 | 1 [[/03_Mechanics/CLI/bestiary/monstrosity/behir-xmm|behir]] |
| 12 | `2d4` [[/03_Mechanics/CLI/bestiary/aberration/flumph-xmm|flumphs]] |
| 13 | [[/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm|Gnoll]] pack |
| 14 | `d4` [[/03_Mechanics/CLI/bestiary/aberration/grell-xmm|grells]] |
| 15 | `d4` [[/03_Mechanics/CLI/bestiary/fiend/hezrou-xmm|hezrous]] |
| 16 | `4d8` [[/03_Mechanics/CLI/bestiary/fiend/manes-xmm|manes]] |
| 17 | `2d4` [[/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm|minotaurs]] |
| 18 | 1 [[/03_Mechanics/CLI/bestiary/construct/modron-monodrone-xmm|monodrone]] |
| 19 | `2d6` [[/03_Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm|quaggoths]] |
| 20 | `d4` [[/03_Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm|shriekers]] |
^encounter

#### Behir

This long-bodied reptile is either prowling a tunnel or resting in a cave when the characters encounter it. The [[/03_Mechanics/CLI/bestiary/monstrosity/behir-xmm|behir]] retreats if reduced to 80 or fewer hit points.

#### Flumphs

This cloister of [[/03_Mechanics/CLI/bestiary/aberration/flumph-xmm|flumphs]] feeds on the psychic energy they detect from a nearby [[/03_Mechanics/CLI/bestiary/aberration/mind-flayer-xmm|mind flayer]] that has enslaved `2d4` [[/03_Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm|quaggoths]]. The flumphs warn adventurers who communicate with them about the nearby threats, but it is up to the characters whether they wish to engage those threats.

#### Gnoll Pack

![](/03_Mechanics/CLI/adventures/out-of-the-abyss/img/100-ooa14-02.webp#center)

A [[/03_Mechanics/CLI/bestiary/fiend/gnoll-fang-of-yeenoghu-xmm|gnoll fang of Yeenoghu]] named [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] made his way into the Labyrinth shortly after Yeenoghu was summoned to the Underdark. [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] brought with him a pack of hyenas and had them feast on the corpses of his slain victims. This heinous act transformed the hyenas into ten [[/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm|gnolls]]. [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr's]] pack now prowls the Labyrinth in search of Yeenoghu, slaughtering anything and anyone they happen upon.

Unknown to his gnoll progeny, [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] has succumbed to a form of madness that quells his feral demeanor. He's lost his appetite for carnage and is overcome with guilt for all of the creatures he has slain. When his pack happens upon the party, he sends his gnolls into battle but doesn't partake of the violence, hoping that the characters slaughter his brethren. Once they are dead, [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] bows his head solemnly, begs Yeenoghu's forgiveness (first in his own language and then in Abyssal), and then throws himself at the party's mercy.

[[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] is suffering from a form of indefinite madness (see ""Madness"" in chapter 8 of the *Dungeon Master's Guide*) which, if cured, reverts him to a typically feral gnoll. While afflicted with madness, [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] can't bring himself to kill any living creature except in self-defense. If the characters spare his life, [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] can act as a guide, for he has explored a great deal of the Labyrinth and can lead the characters along a safe route to an Underdark shanty town (see "Filthriddens"). Characters have no random encounters if they follow [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] along this route, although they periodically stumble upon the corpses and bones of Underdark creatures slain by his gnolls.

The encounter with [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]]'s pack occurs only once. Any subsequent occurrence of this encounter is with a pack of `3d6` [[/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm|gnolls]]. These gnolls came to the Underdark with Yeenoghu. They cackle and scream the demon lord's name as they tear into their prey.

#### Grells

The [[/03_Mechanics/CLI/bestiary/aberration/grell-xmm|grells]] drop from an overhead shaft to feed.

#### Hezrous

These demons are tearing apart an iron ore cart, a rusted section of mining track, or some other old fixture. Party members can attempt to slip past the demons without arousing their attention. Doing so requires a successful DC 11 Dexterity ([[/03_Mechanics/CLI/skills#Stealth|Stealth]]) check. On a failed check, the [[/03_Mechanics/CLI/bestiary/fiend/hezrou-xmm|demons]] detect the party member and attack.

#### Manes

Characters can hear the mewling of this vile mob long before it appears. The [[/03_Mechanics/CLI/bestiary/fiend/manes-xmm|manes]] scour the Labyrinth for easy prey and move like a tide of putrid flesh.

#### Minotaurs

These [[/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm|minotaurs]] roams the Labyrinth, slaying creatures in the name of Baphomet.

#### Monodrone

This modron has become separated from its fellows (see "March to Nowhere"), and there is a 75 percent chance that it is looking to rejoin them. If the characters can understand its language, the [[/03_Mechanics/CLI/bestiary/construct/modron-monodrone-xmm|monodrone]] repeatedly says, "We are on the march!"
...
These [[/03_Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm|quaggoths]] are hungry and attack the party regardless of its size. If there are five or more quaggoths in the group, one of them is a quaggoth thonot (see the "Variant: Quaggoth Thonot" sidebar in the "Quaggoth" entry of the *Monster Manual*). If the thonot dies, the other quaggoths immediately break off their attack and begin feasting on the thonot's remains, hoping to gain its psionic power.

#### Shriekers

The [[/03_Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm|shriekers]] sound off when bright light or a creature is within 30 feet of them. Their shrieking has a 75 percent chance of attracting other monsters, in which case roll again on the Labyrinth Encounters table, treating another shrieker encounter as "no encounter."
...
Searching through the remains turns up two empty potion bottles and a [[/03_Mechanics/CLI/items/potion-of-mind-reading-xdmg|potion of mind reading]].
...
The two [[/03_Mechanics/CLI/bestiary/fiend/shadow-demon-xmm|shadow demons]] lurk in the darkness of this room and attack the first character who enters, likely taking their prey by surprise.

### Battlements

The top of the tower features an open space surrounded by a crenelated wall. If the four [[/03_Mechanics/CLI/bestiary/elemental/gargoyle-xmm|gargoyles]] have not yet attacked the adventurers, they do so here.
...
This wretched gnoll is named [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]]. Thanks to treachery he committed against his kind, the minotaurs spared his life. However, their mercy comes with regular abuse and torment. The gnoll now sees himself as a loyal and willing servant of the brutes, and he is eager to lead gnolls and anyone else to his minotaur masters.

[[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] is a [[/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm|gnoll]] with the following modifications:

- [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] has 11 hit points.  
- He has a walking speed of 25 feet.  
- He has disadvantage on Wisdom checks and Wisdom saving throws because of the physical and mental abuse he has suffered. A [[/03_Mechanics/CLI/spells/lesser-restoration-xphb|lesser restoration]] spell rids him of these effects.  
...
Any aggressive action sends [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] skittering back into the maze and to his masters. If the characters capture him, he shrieks and screams, drawing one [[/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm|minotaur]] to investigate the racket.

Accepting [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]]'s offer transforms the cringing gnoll into a dutiful guide. He leads the characters through passage after passage, choosing directions seemingly at random until the characters encounter the minotaurs. If the battle turns against the minotaurs, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] flees.

If the adventurers show pity or kindness, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] becomes confused, as he has never experienced such things. A character can befriend the gnoll with a successful DC 20 Charisma ([[/03_Mechanics/CLI/skills#Persuasion|Persuasion]]) check. If any character uses magical healing on [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]], the check is automatically successful.

If the characters befriend [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]], he warns them to turn back, flee, and never return. He says his masters are vile minotaurs who wait in the maze, eager to kill all trespassers. If asked, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] explains that the minotaurs spared his life in exchange for leading travelers into the maze. If the characters insist on entering the maze, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] goes with them, trying to keep his new friends safe. If the characters defeat the minotaurs and move deeper into the Labyrinth, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] can accompany them as a follower and guide, giving the characters advantage on Wisdom ([[/03_Mechanics/CLI/skills#Survival|Survival]]) checks to avoid becoming lost in the Labyrinth.
...
When the characters enter the maze, have them choose their pace (fast, normal, or slow). It takes 1 hour to navigate the maze at a fast pace, 2 hours at a normal pace, or 3 hours at a slow pace. Halfway through the journey, the navigator must make a DC 15 Wisdom ([[/03_Mechanics/CLI/skills#Survival|Survival]]) check. A fast pace imposes a −5 penalty to the check. A slow pace grants a +5 bonus. On a success, the characters find their way out. On a failure, the characters must start the journey from the beginning.
...
If [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] was attacked by the characters and fled into the maze, he does his best to bring threats down on them, in which case roll two d20s and take the higher result. If [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] is friendly to the party and accompanying them, he tries to steer them away from danger, in which case roll two d20s and take the lower result.
...
| 11–12 | Corpse |
| 13–14 | Gnawed bones |
| 15–17 | `2d4` [[/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm|gnolls]] |
| 18–20 | `d6` [[/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm|minotaurs]] |
^encounter
...
A frenzied group of `2d4` [[/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm|gnolls]] is lost in the maze. The gnolls attack any creatures they see.

#### Minotaurs

These bloodthirsty [[/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm|minotaurs]] are hunting gnolls but attack any other creatures they happen upon.
...
Filthriddens was, until recently, a shanty town of Underdark exiles and refugees. The greatest threat to inhabitants—apart from food shortages—was the minotaurs that raided the settlement from time to time, dragging off screaming prisoners to meet a grisly fate. The recent arrival of the demon lords changed things. A group of minotaurs was on its way to raid Filthriddens when Yeenoghu and a pack of his frenzied followers tore through this part of the Labyrinth, catching the minotaurs off guard and slaughtering them. The sole witness to this carnage was [[/03_Mechanics/CLI/bestiary/npc/grisha-oota|Grisha]], an escaped human slave of the drow. Yeenoghu's intercession saved him from the minotaurs.

Yeenoghu and his pack moved on, but [[/03_Mechanics/CLI/bestiary/npc/grisha-oota|Grisha]] took the head of a slain minotaur and brought it back to Filthriddens. The skull became a talisman as [[/03_Mechanics/CLI/bestiary/npc/grisha-oota|Grisha]] named Yeenoghu as the new protector and patron of Filthriddens. Residents who opposed this dark worship were exiled or executed in short order. The cult of Yeenoghu now controls the settlement, and [[/03_Mechanics/CLI/bestiary/npc/grisha-oota|Grisha]] rules with an iron fist. He senses the power of Yeenoghu in all things—and particularly in the way in which cultists have begun to rise as undead ghouls after death.
...
[[/03_Mechanics/CLI/bestiary/npc/grisha-oota|Grisha]] (see appendix C) can recount the history of Filthriddens and how Yeenoghu saved its denizens from the oppression of the minotaurs. He can also reveal how he spent years as a slave of the drow. [[/03_Mechanics/CLI/bestiary/npc/grisha-oota|Grisha]] seeks new disciples to grow his cult's power.

Twelve [[/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm|cultists]] (a mix of shield dwarves, halflings, and humans) support [[/03_Mechanics/CLI/bestiary/npc/grisha-oota|Grisha]] if a fight breaks out. Ten of them are hidden in the shanties. Two more stand next to a zurkhwood door, beyond which lies a small side cave where cultists who have died and risen as undead are kept. If battle erupts, the cultists open the door and release six [[/03_Mechanics/CLI/bestiary/undead/ghoul-xmm|ghouls]]. The ghouls ignore the cultists as long as there are other creatures to feed on.
...
Twelve [[/03_Mechanics/CLI/bestiary/construct/modron-monodrone-xmm|monodrones]] and a [[/03_Mechanics/CLI/bestiary/construct/modron-tridrone-xmm|tridrone]] have been wandering the Labyrinth since the last Great Modron March. The modrons became separated from their fellows and trapped here. Unable to find their way back to Mechanus, the modrons have been pressing on (and on), knowing that they must find their way back or be destroyed in the process.
...
[[/03_Mechanics/CLI/bestiary/npc/yeenoghu-mpmm|Yeenoghu]] (see appendix D) has been wandering the Underdark since he was first summoned, and the adventurers have run across him and his pack. The characters' only advantage at this moment is that they haven't yet been detected. Considering their level at this stage of the adventure, the players might be creating new characters quite soon if they dare confront the demon lord.

If the characters stay hidden and observe, Yeenoghu leaves in short order. He is restless and eager for new prey. Yeenoghu gathers up most of the gnolls and hyenas and leads them down a tunnel on the right side of the cavern. Eight [[/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm|gnolls]] led by a [[/03_Mechanics/CLI/bestiary/fiend/gnoll-pack-lord-xmm|gnoll pack lord]] remain in the cavern, feasting on the goristro's corpse.
...
The close brush with Yeenoghu pays dividends to the adventurers by delivering two components of Vizeran's ritual into their hands. The first is the heart of the goristro, which the characters can remove from its corpse. The massive heart is the size of a small trunk and weighs nearly one hundred pounds. Any characters close to it while it is being transported imagine that they can occasionally hear it beating. A character who carries the heart, even in a [[/03_Mechanics/CLI/items/bag-of-holding-xdmg|bag of holding]] or similar extradimensional space, makes saving throws against madness with disadvantage.

The second component takes the form of a few spatters of a demon lord's blood. A successful DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check finds some of Yeenoghu's black blood on the fallen goristro's horns.
...
This chamber houses the [[/03_Mechanics/CLI/conditions#Petrified|petrified]] remains of eight fallen angels, condemned by the gods to pass the ages in the dark depths. Each appears to have been carved from stone in some position of fear, suffering, hatred, or longing. Each statue is spotted with lichen and marred by mineral deposits, which have crystallized out of the water dripping from the ceiling over uncounted years.

Even though they are transformed into stone statues, the fallen angels remain very much alive, their [[/03_Mechanics/CLI/conditions#Petrified|petrified]] bodies having become prisons for their minds and souls. They remember who they were. They know what they did and why they are here. They know everything transpiring around them. Yet they can do nothing. They are trapped forever, and the isolation, darkness, and endless torment of their fate have driven them mad. No spell can undo the angels' curse or free them from their [[/03_Mechanics/CLI/conditions#Petrified|petrified]] state.
...
This angel appears to be reaching out as if offering something. A character making contact with the angel must succeed on a DC 15 Charisma saving throw or become [[/03_Mechanics/CLI/conditions#Charmed|charmed]] for 1 minute.

While the character is [[/03_Mechanics/CLI/conditions#Charmed|charmed]], the angel has a telepathic link with the character as long as it and the character remain on the same plane of existence. The angel issues commands to the character, and the character does its best to obey those commands if it is conscious. The angel typically commands a character to kill, maim, rob, or otherwise harm its companions.
...
A successful DC 15 Intelligence ([[/03_Mechanics/CLI/skills#Arcana|Arcana]]) check is needed to activate the device by puzzling out its array of gears and levers. It then takes 12 rounds for the engine to "align itself" and activate its magical effect. If an initiative order hasn't already been established by the time the engine activates, have everyone in the party roll initiative.
...
The engine shuts down if any part of it comes into contact with an [[/03_Mechanics/CLI/spells/antimagic-field-xphb|antimagic field]] or if it is targeted by a successful [[/03_Mechanics/CLI/spells/dispel-magic-xphb|dispel magic]] (DC 19). Otherwise, it can only be shut down by a [[/03_Mechanics/CLI/spells/wish-xphb|wish]] spell or divine intervention.
...
| 11–15 | The engine makes a loud "WHAAAH" sound until the start of its next turn. For as long as the sound lasts, the engine projects an [[/03_Mechanics/CLI/spells/antimagic-field-xphb|antimagic field]] (as the spell) around itself. |
| 16–19 | The hollow interior of the engine flickers with crimson light until the end of its turn, whereupon one dead character or NPC of the DM's choice is restored to life, as though subjected to a [[/03_Mechanics/CLI/spells/resurrection-xphb|resurrection]] spell. The revived creature appears in a safe, unoccupied space within 120 feet of the engine. |
...
| 28–32 | The engine hums until the end of its turn, at which point a [[/03_Mechanics/CLI/bestiary/aberration/green-slaad-xmm|green slaad]] appears in a safe space within 120 feet of the engine. The slaad rolls initiative and, on its turn, attacks any other creatures it sees. |
| 33–35 | The engine groans loudly and turns each creature within 120 feet of it [[/03_Mechanics/CLI/conditions#Invisible|invisible]]. A creature's invisibility lasts until it attacks or casts a spell. |
...
| 40–43 | Multicolored arcs of light play across the surface of the engine, which casts a [[/03_Mechanics/CLI/spells/polymorph-xphb|polymorph]] spell (save DC 18) on each creature within 20 feet of it. Any creature that fails the saving throw is polymorphed into a [[/03_Mechanics/CLI/bestiary/monstrosity/flying-snake-xmm|flying snake]]. |
...
| 58–60 | The engine flickers with blue light and casts [[/03_Mechanics/CLI/spells/faerie-fire-xphb|faerie fire]], targeting all creatures within 20 feet of it (save DC 18). The spell's effect has a duration of 1 minute. |
| 61–66 | The engine spews harmless, multicolored sparks until the start of its next turn. |
| 67–70 | The engine emits a flash of violet light. Each creature within 20 feet of the engine must succeed on a DC 18 Constitution saving throw or be [[/03_Mechanics/CLI/conditions#Petrified|petrified]] until the engine's next turn. |
