...
## Appearance
Very short and compact, with Carefully styled blonde hair and Blue eyes. Fair skin. Crooked nose from multiple breaks.

**Clothing**: Priest's vestments with holy symbol prominent
**Accessories**: Spectacles on chain

## Personality
- **Traits**: Believes in every conspiracy theory; Incredibly optimistic despite evidence; Sees doom and gloom everywhere
...
### Gavril Ravenheart the Wise (Personal - Childhood friend)
- **Status**: Mutually beneficial
- **History**: United by common enemy
- **Secret**: Planning betrayal

### Erasmus Oakenshield the Scholar (Criminal - Informant)
...
### Gareth Ironforge the Redeemed (Political - Spy)
...
### Attacks
- Longsword: +6 to hit, 1d8+4 slashing
- Longbow: +6 to hit, 1d8+4 piercing
...
- Action Surge: Extra action once per combat
- Spellcasting: 7 spell slots, knows Invisibility, Scorching Ray, Fly, Shield, Magic Missile, Sleep, Fireball, Counterspell, Lightning Bolt
