...
"cr": "1"
"traits":
  - "desc": "The stone cursed has advantage on the attack rolls of [[actions#Opportunity%20Attack|opportunity attacks]]."
  ...
  - "desc": "If the stone cursed is motionless at the start of combat, it has advantage\
      ...
      \ cursed move or act, that creature must succeed on a DC 18 Intelligence ([[skills#Investigation|Investigation]])\
...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 12\
      ...
      \ a DC 12 Constitution saving throw, or it begins to turn to stone and is [[conditions#Restrained|restrained]]\
      \ until the end of its next turn, when it must repeat the saving throw. The\
      \ effect ends if the second save is successful; otherwise the target is [[conditions#Petrified|petrified]]\
      \ for 24 hours."
