...
The wall is an object that can be damaged and thus breached. It has AC 12 and 30 [[hit-points-xphb (variant-rules)]] per 10-foot section, and it has [[immunity-xphb (variant-rules)]] to Cold, Poison, and Psychic damage and [[Vulnerability Xphb]] to Fire damage. Reducing a 10-foot section of wall to 0 [[hit-points-xphb (variant-rules)]] destroys it and leaves behind a sheet of frigid air in the space the wall occupied.
