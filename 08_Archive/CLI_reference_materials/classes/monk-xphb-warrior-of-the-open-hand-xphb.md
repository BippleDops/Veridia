...
type: note
created: 2025-07-23
updated: '2025-08-13T01:18:32.140005+00:00'
...
The target can't make [Opportunity Attacks](/03_Mechanics/CLI/actions.md#Opportunity%20Attack) until the start of its next turn.
...
The target must succeed on a Dexterity saving throw or have the [Prone](/03_Mechanics/CLI/conditions.md#Prone) condition.

### Wholeness of Body (Level 6)

You gain the ability to heal yourself. As a [Bonus Action](/03_Mechanics/CLI/variant-rules/bonus-action-xphb.md), you can roll your Martial Arts die. You regain a number of [Hit Points](/03_Mechanics/CLI/variant-rules/hit-points-xphb.md) equal to the number rolled plus your Wisdom modifier (minimum of 1 [Hit Point](/03_Mechanics/CLI/variant-rules/hit-points-xphb.md) regained).
...
When you take a [Bonus Action](/03_Mechanics/CLI/variant-rules/bonus-action-xphb.md) other than Step of the Wind, you can also use Step of the Wind immediately after that [Bonus Action](/03_Mechanics/CLI/variant-rules/bonus-action-xphb.md).
