...
--- > [!figure] Asset
![](04_Resources/Assets/Creatures/creature-creature-zombie-xmm-v1-zombie-xmm.svg) # Zombie Xmm ## Overview

This document contains important information regarding Zombie Xmm and its role within the greater narrative. ## Description

Zombie Xmm represents a significant element within the campaign world, offering various opportunities for engagement and development. ## Key Information
...
*Customize as needed for your specific campaign requirements.* ## References - [[7 Appendix B Monsters]]

- [[7-appendix-b-monsters (lost-mine-of-phandelver)]]
- [[Green Dragon]]
- [[green-dragon (legendary-group)]]
- [[Corpse Flower Mpmm]]
- [[corpse-flower-mpmm (plant)]]
