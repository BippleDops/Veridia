...
**Damage**: [`dice: 2d6`]] fire/cold damage per round without proper protection  
...
**Effect**: WIS save **DC 16** or stunned for `dice: 1d4` rounds, `dice: 2d6` psychic damage  
...
**Properties**: Constantly burning with sunlight, `dice: 2d6` extra radiant damage to undead  
...
**AC**: 18 (Natural Armor) | **HP**: 157 (`dice: 15d12` + 60)  
**Speed**: 20 ft.  
...
- **Self-Repair**: As a bonus action, regain `dice: 2d8` + 4 hit points
...
**Damage**: `dice: 1d4` thunder damage per round to those in affected area  
...
**Success**: Create item with de[[Sired legendary properties  
