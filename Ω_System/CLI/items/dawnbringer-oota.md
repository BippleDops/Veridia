...
---
# Dawnbringer
*Weapon ([longsword](/3-Mechanics/CLI/items/longsword-xphb.md)), legendary (requires attunement by a creature of non-evil alignment)*  
![](/3-Mechanics/CLI/items/img/dawnbringer.webp#right)
...
While holding the weapon, you can use an action to touch a creature with the blade and cast [lesser restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md) on that creature. Once used, this ability can't be used again until the next dawn.

## Sentience

Dawnbringer is a sentient neutral good weapon with an Intelligence of 12, a Wisdom of 15, and a Charisma of 14. It has hearing and [darkvision](/3-Mechanics/CLI/senses.md#Darkvision) out to a range of 120 feet.
