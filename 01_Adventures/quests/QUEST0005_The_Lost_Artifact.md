---
aliases: ["The Lost Artifact", "the lost artifact", "Artifact Lost The"]
tags: [generated]
id: QUEST0005
...
## Quest Giver
**Fiora Goldleaf** - Dying adventurer
...
## Key Locations
- **LowerHaven** (City): Key location for quest progression
- **OldHaven** (Dungeon): Key location for quest progression
- **Peakton** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Wild Beasts** led by Fiora Brightblade the Swift
