...
"cr": "2"
"traits":
  - "desc": "The ground in a 10-foot [[Area of Effect Xphb]]\
      \ originating from the mouther is [[Difficult Terrain Xphb]]."
  ...
  - "desc": "The mouther babbles incoherently while it doesn't have the [[conditions#Incapacitated|Incapacitated]]\
      ...
      \ The target does nothing.  \n- 5-6. The target takes no action or [[Action Xphb]]
      \ Action]] and uses all\
...
"actions":
  - "desc": "Melee Attack Roll: +2, reach 5 ft. Hit: 7 (2d6) Piercing damage.\
      ...
      \ condition. The target dies if it is reduced to 0 [[hit-points-xphb (variant-rules)]]\
      \ by this attack. Its body is then absorbed into the mouther, leaving only equipment\
      \ behind."
    "name": "Bite"
  - "desc": "Dexterity Saving Throw: DC 10, each creature in a 10-foot-radius [[Area of Effect Xphb]]\
