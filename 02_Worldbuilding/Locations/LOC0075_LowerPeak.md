...
## Important NPCs
- **Petra Ravencrest the Ancient** - Priest: Key figure in local affairs
- **Quinn Ravencrest the Merciful** - Noble: Key figure in local affairs
- **Rhea Ravencrest the Swift** - Criminal: Key figure in local affairs
