...
title: Social_Encounter_Reference
type: note
tags: 
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Social Encounter Reference"]
status: active
priority: normal
...
| **Court Intrigue** | Navigate political maze | 30-90 minutes | Very High | ### Challenge Rating System
...
| **13+** | Master-tier intrigue | 24+ | Campaign-changing results | ### Attitude Levels
...
| **Helpful** | Eager to assist | Goes above/beyond | Secrets and rumors | ### Primary Social Skills
...
| **Performance** | Entertainment, distraction | 10-18 | Embarrassment, attention | ### Secondary Skills
...
| **Medicine** | Health matters | Diagnose conditions, healing | ### Depth-Based Hierarchy
...
| **Abyssal Tolerant** | Elite/Noble | Reverence expected | ### Altitude-Based Hierarchy
...
| **Extreme Heights** | Royal/Divine | Complete subservience | #### Conversion Attempts
...
| **Force** | Threats or actual force | 25 | Violence or departure | #### Bureaucratic Protocol
...
5. **Official Response**: Formal written documentation ### Direct Questioning
...
| **Friendly Chat** | Low | Very Low | Relaxed atmosphere | ### Indirect Methods
...
| **Surveillance** | Behavioral only | Days/weeks | High | ### Payment for Information
...
| **Life-Threatening Intel** | 1000+ gp | New identity | ### Mid-Encounter Complications (d12)
...
| 12 | **Double Agent** | NPC has conflicting loyalties | ### Resolution Twists (d8)
...
| 8 | **Unexpected Alliance** | Former enemy becomes ally | ### Random Social Encounters (d10)
...
10. **Local Celebrity** drawing crowd attention ### Quick NPC Motivations (d8)
...
8. **Moral Obligation** - Doing what's right ### Success Rewards
...
| **Perfect** | Complete trust | Shares dangerous secrets | ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:*

- Can be adapted to fit current story needs
- Scalable threat/reward based on party level
- Multiple entry points for different play styles
- Connections to overarching campaign themes ## Secret Connections *[Hidden from players]* Connected to The Secret Covenant - Summon ancient evil ## Plot Hooks - Someone is searching for an heir for revenge
