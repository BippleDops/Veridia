...
"cr": "1/2"
"traits":
  - "desc": "If the swarm has a [Climb Speed](/03_Mechanics/CLI/variant-rules/climb-speed-xphb.md),\
...
"actions":
  - "desc": "Melee Attack Roll: +3, reach 5 ft. Hit: 6 (2d4 + 1) Poison damage,\
      \ or 3 (1d4 + 1) Poison damage if the swarm is [Bloodied](/03_Mechanics/CLI/variant-rules/bloodied-xphb.md)."
    "name": "Bites"
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/beast/token/swarm-of-insects-xmm.webp"
```
^statblock
...
Swarm of insects xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of swarm of insects xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around swarm of insects xmm.

## Adventure Hooks

- A rumor ties swarm of insects xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at swarm of insects xmm to avert a public scandal.
- A map overlay reveals a hidden approach to swarm of insects xmm active only during specific tides/storms.
