...
![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/116-cos13-01.webp#center)
...
> [!gallery]
> ![Map 13.1: Amber Temple (Area X) - Upper Level](/03_Mechanics/CLI/adventures/curse-of-strahd/img/117-029.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/curse-of-strahd/img/118-cos1301.webp#gallery)
...
The skeleton clutches a [wand of secrets](/03_Mechanics/CLI/items/wand-of-secrets-xdmg.md).
...
An [arcanaloth](/03_Mechanics/CLI/bestiary/fiend/arcanaloth-xmm.md) named Neferon guards this temple from within the hollow head of the great statue (area X5a) and attacks characters on sight with its longer-ranged spells. Thanks to its [truesight](/03_Mechanics/CLI/senses.md#Truesight), the arcanaloth can see the [invisible](/03_Mechanics/CLI/conditions.md#Invisible) and can see through magical darkness. Characters can't see Neferon unless they can penetrate the magical darkness that envelops the statue's face and head.

Once the arcanaloth begins casting spells, the three [flameskulls](/03_Mechanics/CLI/bestiary/undead/flameskull-xmm.md) in area X17 take up positions behind the arrow slits that overlook the temple and cast [magic missile](/03_Mechanics/CLI/spells/magic-missile-xphb.md) and [fireball](/03_Mechanics/CLI/spells/fireball-xphb.md) spells at characters they can see.
...
This 40-foot-tall statue, carved out of granite, depicts a faceless god of secrets. At the base of the statue, in the back, is a secret door that can be found with a successful DC 20 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check. It can be pulled open to reveal a spiral staircase that climbs to a stone trapdoor set into the floor of the statue's hollow head.

#### Statue's Head

Neferon the [arcanaloth](/03_Mechanics/CLI/bestiary/fiend/arcanaloth-xmm.md) lairs inside the statue's hollow head, within a field of magical darkness that fills the interior of the head and hides the statue's humanlike face. The darkness can be dispelled (DC 17).
...
Neferon wears gold spectacles and a magic robe (see "Treasure" below). It uses its [alter self](/03_Mechanics/CLI/spells/alter-self-xphb.md) spell and [Deception](/03_Mechanics/CLI/skills.md#Deception) skill to pass itself off as an old human wizard with a long white beard named Heinrich Stolt. "Heinrich" feigns confusion. If the characters ask him why he attacked, he claims that he was guarding the temple. If the arcanaloth loses more than half of its hit points, it teleports to the temple floor, turns [invisible](/03_Mechanics/CLI/conditions.md#Invisible), and flees by the safest route, attacking the characters again when it's safe to do so. The arcanaloth will not, under any circumstances, leave the Amber Temple.

#### Treasure

The arcanaloth carries a spellbook containing the wizard spells it has prepared (see its stat block in the Monster Manual). It wears small gold spectacles with pink crystal lenses (worth 250 gp) and a [robe of useful items](/03_Mechanics/CLI/items/robe-of-useful-items-xdmg.md) with the following eight patches remaining:

- Bag of 100 gp  
- Iron door  
- [Wooden ladder](/03_Mechanics/CLI/items/ladder-xphb.md)  
- [Riding horse](/03_Mechanics/CLI/items/riding-horse-xphb.md)  
- Pit  
- [Rowboat](/03_Mechanics/CLI/items/rowboat-xphb.md)  
- [Spell scroll](/03_Mechanics/CLI/items/spell-scroll-xdmg.md) ([moonbeam](/03_Mechanics/CLI/spells/moonbeam-xphb.md))  
- [Mastiffs](/03_Mechanics/CLI/items/mastiff-xphb.md)  
...
The hanging lanthorns have [continual flame](/03_Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on them. The black slate slab once served as a chalkboard and has a few chalk marks on it.

![Vilnius and Quasit](/03_Mechanics/CLI/adventures/curse-of-strahd/img/119-cos13-03.webp#center)

Hiding behind the lectern is [Vilnius](/03_Mechanics/CLI/bestiary/npc/vilnius-cos.md) (NE male human [mage](/03_Mechanics/CLI/bestiary/humanoid/mage-xmm.md)) and his [invisible](/03_Mechanics/CLI/conditions.md#Invisible) [quasit](/03_Mechanics/CLI/bestiary/fiend/quasit-xmm.md) familiar. Characters who have a passive Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) score of 17 or higher notice him. A character who actively searches the room for hidden occupants spots [Vilnius](/03_Mechanics/CLI/bestiary/npc/vilnius-cos.md) with a successful DC 12 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check.

[Vilnius](/03_Mechanics/CLI/bestiary/npc/vilnius-cos.md) wears scorched robes, his unkempt hair is half burned away, and his face and arms are covered with blisters from magic fire. He is the apprentice of Jakarion, the dead wizard in area X17. After the flameskulls there incinerated his master, the wounded [Vilnius](/03_Mechanics/CLI/bestiary/npc/vilnius-cos.md) retreated here. He eats vermin to survive. The [amber golem](/03_Mechanics/CLI/bestiary/construct/amber-golem-cos.md) has been patrolling the hallway outside (area X8), and [Vilnius](/03_Mechanics/CLI/bestiary/npc/vilnius-cos.md) won't leave this room until he knows the golem has been destroyed.

[Vilnius](/03_Mechanics/CLI/bestiary/npc/vilnius-cos.md) is a greedy, treacherous coward. He curses his dead master for leading them to this wretched land. If the characters try to befriend him, he is suspicious of their intentions. He would like to retrieve his dead master's staff and spellbook, but otherwise he has no interest in exploring more of the Amber Temple. He knows the following information about the place:
...
[Vilnius](/03_Mechanics/CLI/bestiary/npc/vilnius-cos.md) carries his spellbook, which contains all the spells he has prepared. He also has a gold amulet shaped like an upside-down V hidden under his robes. Of exquisite design, the amulet is worth 1,000 gp. It is the [control amulet](/03_Mechanics/CLI/items/command-amulet-xmm.md) for the [shield guardian](/03_Mechanics/CLI/bestiary/construct/shield-guardian-xmm.md) in area X35.

Although he can tell that the amulet is magical, he doesn't know its purpose. The amulet thrums when it comes within 10 feet of the shield guardian. If [Vilnius](/03_Mechanics/CLI/bestiary/npc/vilnius-cos.md) realizes what the amulet does, he won't part with it.
...
The ceiling here is 20 feet high, and the walls are lined with empty torch sconces. The statue is a damaged [amber golem](/03_Mechanics/CLI/bestiary/construct/amber-golem-cos.md) (use the stat block for the [stone golem](/03_Mechanics/CLI/bestiary/construct/stone-golem-xmm.md) in the "Monster Manual"). It has 145 hit points and attacks any creature it sees, stopping only when it can't see any.
...
The [amber golem](/03_Mechanics/CLI/bestiary/construct/amber-golem-cos.md) in area X10 knocked over the candlesticks and pulverized the obsidian statue, which depicted the same nameless god that stands in area X5. Amber doors in the west wall open into area X13.
...
This room contains a [gladiator](/03_Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) (CE female human), five [berserkers](/03_Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) (CE male and female humans), and one [dire wolf](/03_Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md). The gladiator and the berserkers are bloodthirsty mountain folk, the dire wolf a servant of Strahd. The dire wolf can't be [charmed](/03_Mechanics/CLI/conditions.md#Charmed) or [frightened](/03_Mechanics/CLI/conditions.md#Frightened).
...
Three [flameskulls](/03_Mechanics/CLI/bestiary/undead/flameskull-xmm.md) guard this hall, attacking creatures that enter. The flameskulls will not leave the hall.
...
The wooden chest contains an old map case in which Artimus kept floor plans of Castle Ravenloft, but the maps were lost long ago. The chest has a false bottom that can be found with a successful DC 10 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check. Inside the hidden compartment is a [tome of understanding](/03_Mechanics/CLI/items/tome-of-understanding-xdmg.md).
...
The table is real, but the torches, the feast, and the chairs are illusions created by a [programmed illusion](/03_Mechanics/CLI/spells/programmed-illusion-xphb.md) spell that triggers when a door to the room is opened. The illusion can be dispelled (DC 17).

Hidden in plain sight amid the feast on the table is a green copper ewer embossed with images of dancing bears, elks, and wolves. The ewer, like the table, isn't illusory. A [detect magic](/03_Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of transmutation magic around the ewer. If a character picks up the ewer, the illusions fade away (including the torches and their light), and seven [specters](/03_Mechanics/CLI/bestiary/undead/specter-xmm.md) materialize and attack whoever has the ewer.
...
The iron chest on the ceiling is held in place with [sovereign glue](/03_Mechanics/CLI/items/sovereign-glue-xdmg.md), and its lid is sealed with an [arcane lock](/03_Mechanics/CLI/spells/arcane-lock-xphb.md) spell. The chest is impervious to weapon damage. Prying it open requires a successful DC 25 Strength check, assuming the characters can reach it. The inside of the chest is lined with lead.

If the chest's lid is opened, the floor of this room disappears (as if affected by a [disintegrate](/03_Mechanics/CLI/spells/disintegrate-xphb.md) spell), creating a 10-foot-square hole above area X39. Creatures standing on the floor when it disappears fall 30 feet, landing in the northwest corner of area X39.
...
The [lich](/03_Mechanics/CLI/bestiary/undead/lich-xmm.md) has fewer hit points than normal (99 hit points), doesn't remember its name ([Exethanter](/03_Mechanics/CLI/bestiary/npc/exethanter-cos.md)), and has forgotten all of its prepared spells. It does know its cantrips. In its current condition, the lich has a challenge rating of 10 (5,900 XP). A [greater restoration](/03_Mechanics/CLI/spells/greater-restoration-xphb.md) spell restores the lich's memory and all of its spells. Another casting of the spell restores its normal hit point maximum (135).
...
There are three secret doors in this room. The secret door to area X28 has an [arcane lock](/03_Mechanics/CLI/spells/arcane-lock-xphb.md) spell cast on it. The password to suppress the spell is "[Exethanter](/03_Mechanics/CLI/bestiary/npc/exethanter-cos.md)."

#### Treasure

The lich's ancient, bronze-covered spellbook sits on a rotted divan, in plain view. Inscribed on its spine is a title: *The Incants of Exethanter*. The spellbook contains all the spells on the lich's list of prepared spells (see the [lich](/03_Mechanics/CLI/bestiary/undead/lich-xmm.md) stat block in the "Monster Manual"). The lich attacks anyone who tries to take its spellbook.

### X28. Hidden Phylactery

The secret door to this room has an [arcane lock](/03_Mechanics/CLI/spells/arcane-lock-xphb.md) spell cast on it (see area X27 for details).
...
The scaly arm is merely a carved pedestal. The bone box is [Exethanter](/03_Mechanics/CLI/bestiary/npc/exethanter-cos.md)'s phylactery. If it takes 20 or more radiant damage from a single source, the phylactery is destroyed.
...
There are no ladders here to reach the high bookshelves. (The wizards who built this place used [mage hand](/03_Mechanics/CLI/spells/mage-hand-xphb.md) spells.) All the books appear to have blank covers and empty pages. Holding a book while speaking its secret command word causes the book's text to magically appear. Only the lich in area X27 knows the command word for each book, and only if its memory is restored. A [true seeing](/03_Mechanics/CLI/spells/true-seeing-xphb.md) spell also allows one to see the magically obfuscated text. The tomes mostly contain vile, forbidden lore. Many spellbooks are hidden here, collectively holding every wizard spell in the "Player's Handbook".
...
> [!gallery]
> ![Map 13.2: Amber Temple (Area X) - Lower Level](/03_Mechanics/CLI/adventures/curse-of-strahd/img/120-030.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/curse-of-strahd/img/121-cos1302.webp#gallery)
...
An earth tremor collapsed the northern part of the hall. Three [Barovian witches](/03_Mechanics/CLI/bestiary/humanoid/barovian-witch-cos.md) (see appendix D) are trying to open the amber door to area X33a by trying different passwords, unaware that they could gain entry through the shaft in area X6. Frustrated by their lack of progress, they vent their rage by attacking the characters. The witches let loose their three [brooms of animated attack](/03_Mechanics/CLI/bestiary/construct/broom-of-animated-attack-cos.md) (see appendix D) while they cast spells.

#### Development

If two of the witches are killed or [incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated), the surviving witch attempts to escape by flying away on her broom. Only the witches can use the brooms of animated attack in this fashion.
...
Three [flameskulls](/03_Mechanics/CLI/bestiary/undead/flameskull-xmm.md) guard this room. They attack intruders on sight.
...
The amber door to this room is sealed with an [arcane lock](/03_Mechanics/CLI/spells/arcane-lock-xphb.md) spell. The password to suppress the spell is "Maverus." The door is otherwise identical to the door of area X33a.
...
The vestige within this sarcophagus offers the dark gift of Shami-Amourae, the Lady of Delights. Shami-Amourae's gift is the power of persuasion. This dark gift allows its beneficiary to cast the [suggestion](/03_Mechanics/CLI/spells/suggestion-xphb.md) spell as an action, and saving throws against the spell have disadvantage. After it has been used three times, the dark gift vanishes.
...
The ceiling here is 10 feet high. The seven hungry [ghasts](/03_Mechanics/CLI/bestiary/undead/ghast-xmm.md) that lair here fight to the death. The ghasts have the following additional feature:
...
The creatures huddled in this room are four [nothics](/03_Mechanics/CLI/bestiary/aberration/nothic-xmm.md)—former wizards reduced to this evil state by their mad quest for forbidden lore. The nothics use their Weird Insight feature to pry secrets from the characters. Although this power is wickedly invasive, the nothics don't consider their prying to be offensive, and so they are taken aback if the characters retaliate. The nothics fight only if one of them is accosted, or if the characters try to destroy the amber sarcophagi.

Characters who touch the amber sarcophagi are offered dark gifts by the evil vestiges contained within them (see the "Amber Sarcophagi" sidebar).

##### West Sarcophagus

The vestige within this sarcophagus offers the dark gift of Delban, the Star of Ice and Hate. Delban's gift is the power to unleash deadly cold. This dark gift allows its beneficiary to cast the [cone of cold](/03_Mechanics/CLI/spells/cone-of-cold-xphb.md) spell as an action. After it has been used seven times, the dark gift vanishes. Until it vanishes, the beneficiary also gains the benefits of a [ring of warmth](/03_Mechanics/CLI/items/ring-of-warmth-xdmg.md).
...
The vestige within this sarcophagus offers the dark gift of Khirad, the Star of Secrets. Khirad's gift is the power of divination. This gift allows its beneficiary to cast the [scrying](/03_Mechanics/CLI/spells/scrying-xphb.md) spell as an action. After it has been used three times, the dark gift vanishes.

The beneficiary's voice becomes a low whisper, and its smile becomes cruel and evil.

#### X33e. Vault of Harkotha

The amber door to this room is sealed with an [arcane lock](/03_Mechanics/CLI/spells/arcane-lock-xphb.md) spell. The password to suppress the spell is "Harkotha." The door is otherwise identical to the door of area X33a.
...
In the center of the room, a [death slaad](/03_Mechanics/CLI/bestiary/aberration/death-slaad-xmm.md) has cast [invisibility](/03_Mechanics/CLI/spells/invisibility-xphb.md) on itself and stands ready with its greatsword in hand. The slaad attacks anyone who enters the room, fighting until slain. It can't leave the Amber Temple.

Characters who touch the amber sarcophagi are offered dark gifts by the evil vestiges contained within them (see the "Amber Sarcophagi" sidebar).

##### North Sarcophagus

The vestige within this sarcophagus offers the dark gift of Yrrga, the Eye of Shadows. Yrrga's gift is the power of true seeing. This dark gift grants its beneficiary the benefits of [truesight](/03_Mechanics/CLI/senses.md#Truesight) out to a range of 60 feet. These benefits last for 30 days, after which the dark gift vanishes.
...
The vestige within this sarcophagus offers the dark gift of Great Taar Haak, the Five-Headed Destroyer. Taar Haak's gift is great strength. This dark gift grants its beneficiary the benefit of a [belt of fire giant strength](/03_Mechanics/CLI/items/belt-of-fire-giant-strength-xdmg.md). This benefit lasts for 10 days, after which the dark gift vanishes.
...
The amber door to this room is sealed with an [arcane lock](/03_Mechanics/CLI/spells/arcane-lock-xphb.md) spell. The password to suppress the spell is "Thangob." The door is otherwise identical to the door of area X33a.
...
The vestige within this sarcophagus offers the dark gift of Vaund the Evasive. Vaund's gift is the power of evasion. This dark gift grants its beneficiary the benefits of an [amulet of proof against detection and location](/03_Mechanics/CLI/items/amulet-of-proof-against-detection-and-location-xdmg.md) and a [ring of evasion](/03_Mechanics/CLI/items/ring-of-evasion-xdmg.md). These benefits last for 10 days, after which the dark gift vanishes.
...
The vestige within this sarcophagus offers the dark gift of Seriach, the Hell Hound Whisperer. Seriach's gift is the power to summon and control hell hounds. As an action, the beneficiary of this dark gift can summon and control two [hell hounds](/03_Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md). Both hounds appear at the same time. The beneficiary can summon hounds only once, and the dark gift vanishes when they die.
...
This room was once a wizard's bedchamber. The construct is an [incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated) [shield guardian](/03_Mechanics/CLI/bestiary/construct/shield-guardian-xmm.md). Its control amulet can be found in area X9.
...
The ceiling here is 10 feet high. A [poltergeist](/03_Mechanics/CLI/bestiary/undead/poltergeist-xmm.md) (see the [specter](/03_Mechanics/CLI/bestiary/undead/specter-xmm.md) entry in the "Monster Manual") haunts this room and telekinetically hurls broken furnishings at intruders so as not to give away its location.

#### Treasure

A search of the room yields a wooden scroll tube containing an intact [spell scroll](/03_Mechanics/CLI/items/spell-scroll-xdmg.md) of [wall of fire](/03_Mechanics/CLI/spells/wall-of-fire-xphb.md).
...
An [amber golem](/03_Mechanics/CLI/bestiary/construct/amber-golem-cos.md) once stood guard here, but it escaped after thieves broke into the treasury and looted it. The golem has since made its way upstairs (see area X10).

Not all of the thieves escaped, and the pulverized remains of those who died here lie strewn upon the floor. Their restless spirits survive here as four [poltergeists](/03_Mechanics/CLI/bestiary/undead/poltergeist-xmm.md) (see the [specter](/03_Mechanics/CLI/bestiary/undead/specter-xmm.md) entry in the "Monster Manual"). The poltergeists can't leave the room and fight until destroyed.

### X40. Sealed Treasury

The amber doors to the south are sealed with an [arcane lock](/03_Mechanics/CLI/spells/arcane-lock-xphb.md) spell. The password to suppress the spell is "Dhaviton." A character can push open the doors with a successful DC 25 Strength check. The doors (AC 15, 60 hit points) can also be smashed. If the doors are reduced to 0 hit points, a [greater invisibility](/03_Mechanics/CLI/spells/greater-invisibility-xphb.md) spell is cast on the [amber golem](/03_Mechanics/CLI/bestiary/construct/amber-golem-cos.md) in this room. The spell lasts for 1 minute.
...
The ceiling here is 30 feet high and flat. The statue in the northern alcove is an [amber golem](/03_Mechanics/CLI/bestiary/construct/amber-golem-cos.md) (use the stat block for the [stone golem](/03_Mechanics/CLI/bestiary/construct/stone-golem-xmm.md) in the "Monster Manual"). It attacks any creature that disturbs the treasure. The golem can leave the room but can't leave the Amber Temple.

![Amber Golem](/03_Mechanics/CLI/adventures/curse-of-strahd/img/122-cos13-05.webp#center)
...
- A silvered [rapier](/03_Mechanics/CLI/items/rapier-xphb.md) with a pink glass hilt  
...
- Thirty [holy symbols](/03_Mechanics/CLI/items/holy-symbol-xphb.md) (worth 5 gp each) of gods from various worlds  
...
- Eight [warhammers](/03_Mechanics/CLI/items/warhammer-xphb.md) and six [war picks](/03_Mechanics/CLI/items/war-pick-xphb.md)  
...
Inside the wooden crates, buried in earth, are six [vampire spawn](/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) created by Strahd from a dead party of adventurers. As soon as they hear intruders in the room, the vampire spawn burst out of their crates and attack, fighting until destroyed.
...
When the conditions are met, the beneficiary instantly becomes a [vampire](/03_Mechanics/CLI/bestiary/undead/vampire-xmm.md) under the Dungeon Master's control (use the stat block in the "Monster Manual").
...
Construction of the phylactery takes 10 days. Concocting the potion takes 3 days. The two items can't be crafted concurrently. When the beneficiary drinks the potion, he or she instantly transforms into a [lich](/03_Mechanics/CLI/bestiary/undead/lich-xmm.md) under the Dungeon Master's control (use the stat block in the "Monster Manual", altering the lich's prepared spells as desired).

The beneficiary of this dark gift gains the following flaw: "All I care about is acquiring new magic and arcane knowledge."

##### East Sarcophagus

The vestige within this sarcophagus offers the dark gift of Zhudun, the Corpse Star. Zhudun's gift is the power to raise the ancient dead. As an action, the beneficiary of this dark gift can touch the remains of a dead creature and restore it to life. The effect is identical to that of the [resurrection](/03_Mechanics/CLI/spells/resurrection-xphb.md) spell, except that it works regardless of how long the creature has been dead. After it has been used once, the dark gift vanishes.
...
Strahd's loyal chamberlain, [Rahadin](/03_Mechanics/CLI/bestiary/npc/rahadin-cos.md) (see appendix D), believes that his master forged a pact with the nameless god of secrets to whom the Amber Temple is dedicated. The dusk elf comes to the temple on occasion to petition the dark god into releasing his master from his torment.

[Rahadin](/03_Mechanics/CLI/bestiary/npc/rahadin-cos.md) rides a [phantom steed](/03_Mechanics/CLI/spells/phantom-steed-xphb.md) along Tsolenka Pass to the Amber Temple and kneels before the great statue in area X5. (The arcanaloth that guards the temple knows [Rahadin](/03_Mechanics/CLI/bestiary/npc/rahadin-cos.md) and doesn't harm him. The arcanaloth and the flameskulls don't attack other visitors until [Rahadin](/03_Mechanics/CLI/bestiary/npc/rahadin-cos.md) is killed or leaves.) [Rahadin](/03_Mechanics/CLI/bestiary/npc/rahadin-cos.md) then pulls out a live toad, swallows it whole as a sacrifice, and offers a gesture of supplication to the secret god.

#### Development

[Rahadin](/03_Mechanics/CLI/bestiary/npc/rahadin-cos.md) knows that Strahd will deal with the characters when he sees fit. If the characters confront the dusk elf, he defends himself but won't cause them any permanent harm. Strahd's chamberlain would sooner die than allow himself to be captured. [Rahadin](/03_Mechanics/CLI/bestiary/npc/rahadin-cos.md) doesn't divulge his reason for visiting the temple, or even who is he or what role he serves. Left to his own devices, he rides back to Castle Ravenloft.

### Kasimir's Dark Gift

If [Kasimir Velikov](/03_Mechanics/CLI/bestiary/npc/kasimir-velikov-cos.md) (see appendix D and chapter 5, area N9a) finds his way to area X42 and accepts the dark gift of Zhudun, he then asks the characters to accompany him to the catacombs of Castle Ravenloft so that he can restore the life of his centuries-dead sister, [Patrina Velikovna](/03_Mechanics/CLI/bestiary/npc/patrina-velikovna-cos.md) (see chapter 4, area K84, crypt 21).
