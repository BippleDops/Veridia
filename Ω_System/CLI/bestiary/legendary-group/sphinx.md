...
- The effects of time are altered such that every creature in the lair must succeed on a DC 15 Constitution saving throw or become `d20` years older or younger (the sphinx's choice), but never any younger than 1 year old. A [greater restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell can restore a creature's age to normal.  
