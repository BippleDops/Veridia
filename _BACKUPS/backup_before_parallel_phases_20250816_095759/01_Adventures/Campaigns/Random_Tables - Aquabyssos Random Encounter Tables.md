...
|------|-----------|---------|
| 01-05 | **Crystal Plague Refugees** | `dice: 2d6` commoners fleeing transformation, may have early symptoms |
| 06-10 | **Tidecaller Patrol** | `dice: 1d4`+1 guards investigating dimensional bleeds |
...
| 21-25 | **Drowning Ghosts** | `dice: 1d6` specters of the original drowning |
| 26-30 | **Bioluminescent Swarm** | Harmless but marks party with glow for 24 hours |
| 31-35 | **Depth Pilgrims** | `dice: 2d4` cultists seeking deeper waters |
| 36-40 | **Floating Wreckage** | Recent shipwreck, `dice: 1d4` survivors in water |
...
| 66-70 | **Coral Zombies** | `dice: 1d6`+2 zombies covered in living coral |
| 71-75 | **Diplomatic Envoy** | Noble with `dice: 2d4` guards, may offer employment |
| 76-80 | **Giant Octopus** | Intelligent, may negotiate instead of fight |
| 81-85 | **Time Eddy** | Ages or de-ages by `dice: 1d4` years |
| 86-90 | **Smuggler's Cache** | Hidden goods worth `dice: 2d100` gp |
...
| 09-12 | **Depth Adapted Patrol** | `dice: 1d4`+1 veterans with pressure immunity |
| 13-16 | **Memory Shepherds** | `dice: 1d3` shepherds harvesting memories |
| 17-20 | **Crystallized Battlefield** | Ancient battle frozen in crystal, may animate |
| 21-24 | **Refugee Camp** | `dice: 3d6` civilians fleeing deeper horror |
...
| 37-40 | **Consciousness Coral Colony** | `dice: 2d4` corals sharing thoughts |
| 41-44 | **Time Skip** | Lose `dice: 1d4` hours, no memory of events |
...
| 57-60 | **Leviathan Parasites** | `dice: 1d3` hunting for divine flesh |
...
8. Emotional current (feel overwhelming specific emotion) --- ## Middle Depths (2,501-5,000ft) *Where humanity becomes negotiable* ### d100 Encounter Table | 01-03 | **The Forgotten Ones** | `dice: 1d3` antimemetic entities |
...
| 19-21 | **Fractal Spiders** | `dice: 1d4`+1 existing at multiple scales |
...
| 34-36 | **Divine Antibodies** | `dice: 2d6` constructs attacking "infection" |
...
1-2: Gain `dice: 1d4` Adaptation Points instantly
...
| 15-17 | **Divine Parasite Swarm** | `dice: 3d6` feeding on flesh |
...
| Void Hour | Reality most unstable | --- ## Quick Encounter Generator **Roll `dice: 3d6`:**
