---
aliases: ["Princess's Revenge", "princess's revenge", "Revenge Princess's"]
tags: [generated]
id: QUEST0034
...
*Escort Quest for levels 2-6*

**ID**: QUEST0034

## Quest Giver
**Jasper Goldleaf** - Military officer
...
## Key Locations
- **UpperGate** (City): Key location for quest progression
- **Valestead** (Dungeon): Key location for quest progression
- **Marshstead** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Undead** led by Jasper Brightblade
...
- **Gold**: 1,929 gp
- **Experience**: 2,000 XP
- **Magic Items**: Cursed Tome of Power
