---
updated: '2025-08-13T01:18:32.486169+00:00'
created: 2025-08-11
type: monster
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 22\
      \ (4d8 + 4) piercing damage, and the target is [grappled](/03_Mechanics/CLI/conditions.md#Grappled)\
      \ (escape DC 15). Until this grapple ends, the target is [restrained](/03_Mechanics/CLI/conditions.md#Restrained),\
  ...
  - "desc": "The hunter emits a pulse of energy that helps it better locate its magical\
      ...
      \ from the hunter and gains no benefit from the [invisible](/03_Mechanics/CLI/conditions.md#Invisible)\
...
"source":
  - "SCC"
"image": "/03_Mechanics/CLI/bestiary/monstrosity/token/mage-hunter-scc.webp"
```
^statblock

## Player-Facing Summary

Mage hunter scc is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of mage hunter scc as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around mage hunter scc.

## Adventure Hooks

- A rumor ties mage hunter scc to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at mage hunter scc to avert a public scandal.
- A map overlay reveals a hidden approach to mage hunter scc active only during specific tides/storms.
