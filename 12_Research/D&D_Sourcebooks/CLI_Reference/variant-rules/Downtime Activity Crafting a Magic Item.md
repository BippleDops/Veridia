...
The creation of a magic item is a lengthy, expensive task. To start, a character must have a formula that describes the construction of the item. The character must also be a spellcaster with spell slots and must be able to cast any spells that the item can produce. Moreover, the character must meet a level minimum determined by the item's rarity, as shown in the Crafting Magic Items table. For example, a 3rd-level character could create a [[/03_Mechanics/CLI/items/wand-of-magic-missiles-xdmg|wand of magic missiles]] (an uncommon item), as long as the character has spell slots and can cast [[/03_Mechanics/CLI/spells/magic-missile-xphb|magic missile]]. That same character could make a [[/03_Mechanics/CLI/items/1-weapon-xdmg|+1 weapon]] (another uncommon item), no particular spell required.

You can decide that certain items also require special materials or locations to be created. For example, a character might need [[/03_Mechanics/CLI/items/alchemists-supplies-xphb|alchemist's supplies]] to brew a particular potion, or the formula for a [[/03_Mechanics/CLI/items/flame-tongue-xdmg|flame tongue]] might require that the weapon be forged with lava.
...
If a spell will be produced by the item being created, the creator must expend one spell slot of the spell's level for each day of the creation process. The spell's material components must also be at hand throughout the process. If the spell normally consumes those components, they are consumed by the creation process. If the item will be able to produce the spell only once, as with a [[/03_Mechanics/CLI/items/spell-scroll-xdmg|spell scroll]], the components are consumed only once by the process. Otherwise, the components are consumed once each day of the item's creation.
