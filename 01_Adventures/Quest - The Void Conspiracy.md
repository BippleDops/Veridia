...
### The Invitation
The party is approached by **Sage Lyralei Voidwatcher**, one of Aethermoor's few experts on dimensional theory. She's noticed the pattern and believes these incidents are connected to experiments with "void manipulation"—the practice of reaching into the empty spaces between realities to alter what exists.
...
**The  Institute** (Hidden beneath Crystalhaven)
...
- *Defenses*: Void guardians, reality mazes,  servants, dimensional traps
...
Legends speak of Quest   The Void Conspiracy as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Quest   The Void Conspiracy.
