...
## Appearance
Average height and stocky, with Braided elaborately red hair and Blue eyes. Weathered skin. Weather-beaten face showing hard life.

**Clothing**: Practical leather armor, well-worn but maintained
**Accessories**: Lucky rabbit's foot

## Personality
- **Traits**: Never uses people's real names; Flirts with everyone regardless of interest; Laughs at the most inappropriate times; Speaks to inanimate objects
...
- **Quirks**: Counts everything obsessively, Collects buttons, Can't sit still
- **Fear**: Deep water
...
### Felicia Blackstone the Risen (Criminal - Accomplice)
...
### Skills
Deception, Stealth, Nature

### Attacks
- Poisoned blade: +5 to hit, 1d6+2 slashing
- Hidden dagger: +6 to hit, 1d4+2 slashing
