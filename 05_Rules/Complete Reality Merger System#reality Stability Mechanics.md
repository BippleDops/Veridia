...
improvements: 20
status: active
aliases: ["Complete Reality Merger System#reality Stability Mechanics"]
priority: normal
category: 05 Rules
subcategory: Complete Reality Merger System#Reality Stability Mechanics.Md
related: []
cssclass: standard
publish: false
...
**Complexity**: Moderate
**Purpose**: Enhance gameplay in specific situations ## Description Complete Reality Merger System#Reality Stability Mechanics provides a structured approach to handling specific game situations that benefit from additional mechanical depth. This system integrates with existing D&D 5e rules while adding meaningful choices and consequences. ### Basic Resolution
...
*Tags*: #mechanics #rules #homebrew #variant #system ## Rule Summary Complete_Reality_Merger_System#Reality_Stability_Mechanics provides a systematic approach to handling specific game situations. This mechanic integrates with core D&D 5e rules while adding depth to gameplay. ## When to Use Apply this rule when:
...
- A merchant needs help delivering before the festival ## Edge Cases & Rulings ### Q: What if a player has multiple inspiration sources?
