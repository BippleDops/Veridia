...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["INDEX (The Wild Beyond the Witchlight)"]
status: active
priority: normal
...
modified: '2025-08-14'
status: active
updated: '2025-08-13T12:48:04.963520'
world: Both
...
**Type**: Campaign **Level Range**: 1-8 **Themes**: fey, carnival, whimsical, roleplaying **Integration Status**: Available ## Description

Feywild carnival and fey adventure ### 🎭 NPCs```dataview

TABLE WITHOUT ID file.link as "NPC", status as "Status", world as "Adapted To"

FROM "The_Wild_Beyond_the_Witchlight/NPCs"

WHERE type = "Character"

SORT file.name```### 👹 Monsters & Creatures file.link as "Monster", cr as "CR", status as "Status"

FROM "The_Wild_Beyond_the_Witchlight/Monsters" WHERE type = "Monster"

SORT cr ### 🗺️ Locations file.link as "Location", threat_level as "Danger",

FROM "The_Wild_Beyond_the_Witchlight/Locations"

WHERE type = "Location" ### ⚔️ Items & Equipment file.link as "Item", rarity as "Rarity",

FROM "The_Wild_Beyond_the_Witchlight/Items"

WHERE type = "Item"

SORT rarity ### 📜 Adventures & Scenarios file.link as "Adventure", suggested_level as "Level", status as "Status" FROM "The_Wild_Beyond_the_Witchlight/Adventures"
...
- Connections to overarching campaign themes ## Plot Hooks - Someone is searching for an heir for money
