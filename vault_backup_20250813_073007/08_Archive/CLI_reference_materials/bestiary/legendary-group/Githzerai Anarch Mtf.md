...
- world/both
type: note
updated: '2025-08-13T12:34:20.142851+00:00'
world: Both
---
...
- The anarch casts the [[/03_Mechanics/CLI/spells/lightning-bolt-xphb|lightning bolt]] spell (at 5th level), but the anarch can change the damage type from lightning to cold, fire, psychic, radiant, or thunder. If the spell deals damage other than fire or lightning, it doesn't ignite flammable objects.  
- The anarch casts the [[/03_Mechanics/CLI/spells/creation-xphb|creation]] spell (as a 9th-level spell) using the unformed substance of Limbo instead of shadow material. If used in Limbo, the object remains until the anarch's [[/03_Mechanics/CLI/conditions#Concentration|concentration]] is broken, regardless of its composition. If the anarch moves more than 120 feet from the object, its [[/03_Mechanics/CLI/conditions#Concentration|concentration]] breaks.  
