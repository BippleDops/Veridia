---
aliases: ["Investigate the Pirates", "investigate the pirates", "Investigate Pirates", "Pirates the Investigate"]
tags: [generated]
id: QUEST0006
created: 2025-08-15T04:09:51.366Z
generator: mega_generator_10k
---
# Investigate the Pirates

*Defend Quest for levels 1-5*

**ID**: QUEST0006

## Quest Giver
**Gareth Goldleaf the Terrible** - Mysterious stranger
- **Location**: Merchant guild hall
- **Motivation**: Seeking redemption

## Objectives
### Primary
Protect the sunken temple from the orc horde for three days
...
## Key Locations
- **Marshton** (City): Key location for quest progression
- **NewHaven** (Dungeon): Key location for quest progression
- **FortHaven** (Wilderness): Key location for quest progression
- **PortHaven** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Constructs** led by Gareth Brightblade the Mad
  - Strength: 10 combatants
