...
*Kill Quest for levels 1-5*

**ID**: QUEST0009

## Quest Giver
**Jora Goldleaf** - Desperate noble
...
## Key Locations
- **Groveton** (City): Key location for quest progression
- **Havenshire** (Dungeon): Key location for quest progression
- **Bridgeshire** (Wilderness): Key location for quest progression
- **EastBridge** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Bandits** led by Jora Brightblade
...
- **Gold**: 886 gp
- **Experience**: 1,000 XP
- **Magic Items**: Blessed Shield of Power
