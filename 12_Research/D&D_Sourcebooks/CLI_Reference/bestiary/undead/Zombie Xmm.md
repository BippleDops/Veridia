...
> [!figure] Asset
![](04_Resources/Assets/Creatures/creature-creature-zombie-xmm-v1-zombie-xmm.svg)

# Zombie Xmm

## Overview
This document contains important information regarding Zombie Xmm and its role within the greater narrative.

## Description
Zombie Xmm represents a significant element within the campaign world, offering various opportunities for engagement and development.
