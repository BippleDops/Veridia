...
## Appearance
Tall and heavyset, with Partially shaved silver hair and Black eyes. Brown skin. Burn scars on one side of face.

**Clothing**: Performer's costume, bright and eye-catching
**Accessories**: Pocket watch, Spectacles on chain

## Personality
- **Traits**: Collects unusual and worthless objects; Always hungry and eating something
...
- **Quirks**: Sneezes when lying, Always rhymes when speaking, Counts everything obsessively
- **Fear**: The undead
...
### Wynne Winterborn the Risen (Family - Spouse)
...
### Attacks
- Longsword: +3 to hit, 1d8+2 slashing
- Longbow: +4 to hit, 1d8+2 piercing

### Special Abilities
- Uncanny Dodge: Half damage from one attack
- Evasion: No damage on successful DEX save
- Spellcasting: 3 spell slots, knows Invisibility, Magic Missile, Scorching Ray, Misty Step, Shield
