...
"actions":
  - "desc": "Melee Attack Roll: +4, reach 5 ft. Hit: 5 (1d6 + 2) Slashing damage,\
      \ plus 2 (d4) Slashing damage if the attack roll had [Advantage](/03_Mechanics/CLI/variant-rules/advantage-xphb.md)."
    "name": "Scimitar"
  - "desc": "Ranged Attack Roll: +4, range 80/320 ft. Hit: 5 (1d6 + 2) Piercing\
      \ damage, plus 2 (d4) Piercing damage if the attack roll had [Advantage](/03_Mechanics/CLI/variant-rules/advantage-xphb.md)."
    "name": "Shortbow"
"bonus_actions":
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/fey/token/goblin-warrior-xmm.webp"
```
^statblock
...
Goblin warrior xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of goblin warrior xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around goblin warrior xmm.

## Adventure Hooks

- A rumor ties goblin warrior xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at goblin warrior xmm to avert a public scandal.
- A map overlay reveals a hidden approach to goblin warrior xmm active only during specific tides/storms.
