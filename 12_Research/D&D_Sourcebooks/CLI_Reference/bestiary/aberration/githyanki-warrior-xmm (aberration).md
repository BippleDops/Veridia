...
"actions":
  ...
  - "desc": "The githyanki casts one of the following spells, requiring no spell components\
      ...
      \n2/day: [[nondetection-xphb (spells)]] (self\
      \ only)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/aberration/token/githyanki-warrior-xmm.webp"
```
^statblock
...
Githyanki warrior xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
