...
**Can't Harm the Charmer.** You can't attack the charmer or target the charmer with damaging abilities or [[magical effect xphb|magical effects]].
...
**Damage.** If you take damage, you must succeed on a Constitution [[saving throw xphb|saving throw]] to maintain Concentration. The DC equals 10 or half the damage taken (round down), whichever number is higher, up to a maximum DC of 30.
...
**Speed Reduced.** Your [[speed xphb|Speed]] is reduced by a number of feet equal to 5 times your Exhaustion level.
...
**Ability Checks and Attacks Affected.** You have [[disadvantage xphb|Disadvantage]] on ability checks and attack rolls while the source of fear is within line of sight.
...
**Attacks Affected.** You have [[disadvantage xphb|Disadvantage]] on attack rolls against any target other than the grappler.
...
**Inactive.** You can't take any [[action xphb|action]], [[bonus action xphb|Bonus Action]], or [[reaction xphb|Reaction]].
...
**Surprise.** If you're Invisible when you roll [[initiative xphb|Initiative]], you have [[advantage xphb|Advantage]] on the roll.
...
**Saving Throws Affected.** You automatically fail Strength and Dexterity [[saving throw xphb|saving throws]].
...
**Resist Damage.** You have [[resistance xphb|Resistance]] to all damage.
...
**Restricted Movement.** Your only movement options are to [[crawling xphb|crawl]] or to spend an amount of movement equal to half your [[speed xphb|Speed]] (round down) to right yourself and thereby end the condition. If your [[speed xphb|Speed]] is 0, you can't right yourself.
