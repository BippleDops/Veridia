---
aliases: ["Baron's Secret", "baron's secret", "Secret Baron's"]
...
## Quest Giver
**Ewan Goldleaf** - Mysterious stranger
...
## Key Locations
- **Hillton** (City): Key location for quest progression
- **LowerHaven** (Dungeon): Key location for quest progression

## Opposition
### Enemies
- **Corrupt Guards** led by Ewan Brightblade
  - Strength: 11 combatants
...
- **Gold**: 721 gp
- **Experience**: 1,000 XP
- **Magic Items**: Eldritch Blade of Power
