...
"actions": - "desc": "Melee Attack Roll: +6, reach 5 ft. Hit: 13 (`dice: 2d8` + 4) Bludgeoning\ \ damage plus 10 (`dice: 3d6`) Fire damage." "name": "Hooves" - "desc": "The nightmare and up to three willing creatures within 5 feet of it teleport\ \ to the Ethereal Plane from the Material Plane or vice versa." "name": "Ethereal Stride"
"source": - "XMM"
