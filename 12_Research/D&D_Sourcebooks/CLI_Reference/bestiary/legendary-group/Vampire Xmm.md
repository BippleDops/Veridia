...
- **Children of the Night.** The vampire exerts influence over the animals in its domain. From dusk until dawn, Medium or smaller Beasts have the [[/03_Mechanics/CLI/conditions#Charmed|Charmed]] condition while within 1 mile of the lair.  
- **Looming Shadows.** Shadows within 1 mile of the lair seem to move as if alive. Any creature (excluding the vampire and its allies) that finishes a [[/03_Mechanics/CLI/variant-rules/short-rest-xphb|Short Rest]] while within 1 mile of the lair must succeed on a DC 15 Wisdom saving throw or gain no benefit from that rest.  
- **Mists.** The area within 1 mile of the lair is [[/03_Mechanics/CLI/variant-rules/lightly-obscured-xphb|Lightly Obscured]] by a persistent, creeping fog. The vampire and any creatures of its choice are unaffected by the fog.  
