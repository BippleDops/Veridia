...
- world/both
type: monster
updated: '2025-08-13T12:34:20.186026+00:00'
world: Both
---
...
# [[3-Mechanics\CLI\bestiary\dragon/white-dragon-wyrmling-xmm|White Dragon Wyrmling]]
...
"actions":
  ...
  - "desc": "Melee Attack Roll: +4, reach 5 ft. Hit: 6 (1d8 + 2) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "Constitution Saving Throw: DC 12, each creature in a 15-foot [[/03_Mechanics/CLI/variant-rules/cone-area-of-effect-xphb|Cone]].\
...
White dragon wyrmling xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of white dragon wyrmling xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around white dragon wyrmling xmm.

## Adventure Hooks

- A rumor ties white dragon wyrmling xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at white dragon wyrmling xmm to avert a public scandal.
- A map overlay reveals a hidden approach to white dragon wyrmling xmm active only during specific tides/storms.
