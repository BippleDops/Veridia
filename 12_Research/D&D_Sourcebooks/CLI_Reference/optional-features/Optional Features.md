...
- world/both
type: note
updated: '2025-08-13T12:34:06.137921+00:00'
world: Both
---
...
Optional features is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of optional features as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around optional features.

## Adventure Hooks

- A rumor ties optional features to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at optional features to avert a public scandal.
- A map overlay reveals a hidden approach to optional features active only during specific tides/storms.
