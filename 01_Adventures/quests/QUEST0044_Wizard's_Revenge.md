---
aliases: ["Wizard's Revenge", "wizard's revenge", "Revenge Wizard's"]
tags: [generated]
id: QUEST0044
...
*Negotiate Quest for levels 3-7*

**ID**: QUEST0044

## Quest Giver
**Ewan Darkwater** - Guild representative
- **Location**: Temple district
- **Motivation**: Following divine mandate

## Objectives
### Primary
Broker peace between the merchant guild and the thieves guild

### Secondary
- Gather intelligence on enemy plans

### Hidden Objective
*DM Only: Employer has ulterior motives*
...
## Key Locations
- **UpperHill** (City): Key location for quest progression
- **Valehollow** (Dungeon): Key location for quest progression
- **Marshhollow** (Wilderness): Key location for quest progression
- **NewHill** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Corrupt Guards** led by Ewan Shadowmere
  - Strength: 14 combatants
...
- **Other**: Guild membership

## Consequences
- **Success**: Peace treaty holds
...
---
*Generated: 2025-08-15T03:20:13.159Z*
