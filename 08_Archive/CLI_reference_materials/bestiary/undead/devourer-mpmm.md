---
updated: '2025-08-13T01:18:32.840190+00:00'
created: 2025-08-11
type: monster
...
"actions":
  ...
  - "desc": "The devourer chooses a living Humanoid with 0 hit points that it can\
      ...
      \ [restrained](/03_Mechanics/CLI/conditions.md#Restrained) and has disadvantage\
      ...
      \ fewer Hit Dice, it becomes a [zombie](/03_Mechanics/CLI/bestiary/undead/zombie-xmm.md).\
      \ If it had 3 to 5 Hit Dice, it becomes a [ghoul](/03_Mechanics/CLI/bestiary/undead/ghoul-xmm.md).\
      \ Otherwise, it becomes a [wight](/03_Mechanics/CLI/bestiary/undead/wight-xmm.md).\
...
"source":
  - "MPMM"
  - "VGM"
"image": "/03_Mechanics/CLI/bestiary/undead/token/devourer-mpmm.webp"
```
^statblock
...
Devourer mpmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of devourer mpmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around devourer mpmm.

## Adventure Hooks

- A rumor ties devourer mpmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at devourer mpmm to avert a public scandal.
- A map overlay reveals a hidden approach to devourer mpmm active only during specific tides/storms.
