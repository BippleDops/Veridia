...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Encounter and Loot Generators"]
status: active
priority: normal
...
| 5 | Rumor surge about [[Port Meridian docks |
...
- Coin Purse:`dice: `dice: 3d6`*10|Gold (gp)`- Gem Cache:`dice: `dice: 2d6`*25|Gem Value (gp)`- Scroll Rarity:`dice: `dice: 1d6`|1-3 Common,4-5 Uncommon,6 Rare`Party level modifier:`dice: `dice: 2d6`*{level}|Parcel (gp)`### Network Position

**Direct Connections**: 0 faction relationships
**Network Influence**: 0 degrees of separation reach
**Relationship Complexity**: Low ### Network Strategy
...
**Diplomatic Priorities**: Key relationships requiring attention ## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:*
