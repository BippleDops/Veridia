---
aliases: ["Captain's Secret", "captain's secret", "Secret Captain's"]
...
## Quest Giver
**Tara Darkwater** - Dying adventurer
...
## Key Locations
- **PortVale** (City): Key location for quest progression
- **NorthMarsh** (Dungeon): Key location for quest progression
- **Bridgemoor** (Wilderness): Key location for quest progression
- **EastMarsh** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Demons** led by Tara Shadowmere
