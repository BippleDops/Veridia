...
updated: '2025-08-13T12:34:04.961971+00:00'
world: Both
---
...
If confronted, Justran Daehl denies the charge vehemently. He claims that any letter the characters present as evidence is "a clear forgery" until he sees a chance to escape. The cult spy is equivalent to a [[/03_Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm|bandit captain]]. If the encounter takes place at the Helm and the characters don't make a strong case against him, five [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]] (tavern regulars) come to his defense. They aren't cult servants, just bystanders mistaken about Justran and trying to help the cellarer who keeps them in drink.
...
If caught in a fight he knows he's going to lose, [[/03_Mechanics/CLI/bestiary/npc/windharrow-pota|Windharrow]] flees to area A19.
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1–2 | `2d4` [[/03_Mechanics/CLI/bestiary/humanoid/howling-hatred-initiate-pota|Howling Hatred initiates]] (see area A3) |
...
Crushing Wave cultists who guard the lake landing (area C1) bunk here. Six double bunks serve nine reavers, a priest, a fathomer, and a Dark Tide knight named Eyon. At any given time, five [[/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota|Crushing Wave reavers]] and one [[/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-priest-pota|Crushing Wave priest]] are here (see chapter 7 for the cultists' statistics).
...
This guard post is manned by a [[/03_Mechanics/CLI/bestiary/humanoid/one-eyed-shiver-pota|one-eyed shiver]] named Khalt, a [[/03_Mechanics/CLI/bestiary/humanoid/dark-tide-knight-pota|Dark Tide knight]] named Gordol, and three [[/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota|Crushing Wave reavers]] (see chapter 7 for all). Khalt is in charge, and he runs a tight ship. These reavers are armed with light crossbows instead of javelins (+4 to hit, `1d8 + 2` piercing damage), and Gordol also has a light crossbow (+7 to hit, `1d8 + 3` piercing damage).
...
Eight [[/03_Mechanics/CLI/bestiary/humanoid/scout-xmm|lizardfolk]] are here now, including the leader of the tribe, a warrior with 36 hit points named [[/03_Mechanics/CLI/bestiary/npc/tornscale-pota|Tornscale]]. They are armed with javelins, maces, and shields. Five more lizardfolk lurk around area C25, keeping guard. [[/03_Mechanics/CLI/bestiary/npc/tornscale-pota|Tornscale]] and its followers are loyal to the sea hag Thuluna Maah (area C14). They hate and resent the human members of the cult. If the characters are disguised as water cultists when they venture into this area, the Blackmaws are outraged by the invasion of their privacy and attack just as ferociously as they would attack the cult's enemies.

If the lizardfolk lose at least two of their number in a fight here, [[/03_Mechanics/CLI/bestiary/npc/tornscale-pota|Tornscale]] sends one of the remaining warriors to warn Thuluna and summon help.
...
[[/03_Mechanics/CLI/bestiary/npc/bronzefume-pota|Bronzefume]] prefers to attack boats rather than people. Given a choice between attacking a character and damaging a boat that character is on, she opts for the boat. Destroying a small skiff takes up her actions for `d4` rounds, during which she ignores characters who retreat.

#### Treasure

A large wooden chest lies open on the bottom in the western end of the lake. It contains [[/03_Mechanics/CLI/bestiary/npc/bronzefume-pota|Bronzefume]]'s hoard of 700 gp, 440 ep, six chrysoprase gemstones worth 40 gp each, and four large onyxes worth 70 gp each.
...
The first time the characters visit, one [[/03_Mechanics/CLI/bestiary/humanoid/fathomer-pota|fathomer]] (see chapter 7) and three [[/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm|cultists]] are here, sorting through the newest pile of looted cargo. The sounds of fighting here alerts the lizardfolk in area C13 or the cultists in area C23, who investigate soon after fighting begins.

If faced with a dangerous band of attackers, the cultists attempt to reach the gong. Striking the gong summons [[/03_Mechanics/CLI/bestiary/npc/bronzefume-pota|Bronzefume]] from area C21. She surfaces by the quay on her turn 3 rounds after the gong sounds, then joins the fight.
...
This area serves as the kitchen for the Crushing Wave temple. The cultists prepare their meals here and dine at the tables in area C22. When the characters arrive, two [[/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota|Crushing Wave reavers]] (see chapter 7) and four [[/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm|cultists]] are here. If the hour is late, most are asleep in their bunks, but one or two cultists attend to chores such as baking or cleaning regardless of the time. The extra bunks belong to the cultists working in area C22.
...
This chamber has been equipped with implements to torture defeated enemies, cult servants who fail their insane leaders, or the occasional innocent victim. This grim chamber is the domain of a [[/03_Mechanics/CLI/bestiary/humanoid/stonemelder-pota|stonemelder]] (see chapter 7) named Heldorm and the three [[/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm|cultists]] who assist him.
...
- Orna, a female human [[/03_Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota|Black Earth guard]] (see chapter 7) who dared to strike a Black Earth priest a few days ago. Greedy and brutal, she is now enraged against the cult.  
- Droth, a male human mercenary [[/03_Mechanics/CLI/bestiary/humanoid/tough-xmm|thug]] in the service of the Howling Hatred cult. He is virtually catatonic but shuffles from place to place if led.  
...
A dozen Black Earth cultists are quartered here, but only four [[/03_Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota|Black Earth guards]] and a [[/03_Mechanics/CLI/bestiary/humanoid/black-earth-priest-pota|Black Earth priest]] (see chapter 7 for both) are present at any given time. Two guards are sleeping and unarmored; they have AC 10 and won't have time to don their armor if an alarm is raised.
...
Earth cultists typically eat alone or in pairs, helping themselves to a stew kept simmering all day and whatever other provisions are available. Two [[/03_Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota|Black Earth guards]] (see chapter 7) currently eat at the middle table, while three [[/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm|cultists]] work in the kitchen.
...
This is the lair and study of a fire genasi named [[/03_Mechanics/CLI/bestiary/npc/bastian-thermandar-pota|Bastian Thermandar]] (see chapter 7), second in command of the fire cult. He is responsible for guarding the northern half of the complex.
...
A dozen fire temple cultists bunk here, but only four [[/03_Mechanics/CLI/bestiary/humanoid/eternal-flame-guardian-pota|Eternal Flame guardians]] (see chapter 7) are present when the characters arrive. Two must awaken, then stand and move to join any battle; they have AC 12, since they have no time to don armor.
...
This room has been claimed by three cult priests. At any given time, two [[/03_Mechanics/CLI/bestiary/humanoid/eternal-flame-priest-pota|Eternal Flame priests]] (see chapter 7) are present. If the characters catch them unaware, one is eating at the table while the other is sitting at a desk, consulting a tome and writing.
...
The symbol on the tapestry is the symbol of fire; show it to the players. Each furnished cell to the north houses an [[/03_Mechanics/CLI/bestiary/humanoid/eternal-flame-guardian-pota|Eternal Flame guardian]], and each of the furnished cells to the south houses a [[/03_Mechanics/CLI/bestiary/humanoid/flamewrath-pota|flamewrath]] (see chapter 7 for both). Combat in one of the cells attracts the attention of the other cultists nearby.
...
Two [[/03_Mechanics/CLI/bestiary/humanoid/eternal-flame-guardian-pota|Eternal Flame guardians]] (see chapter 7) are drinking and playing cards at the table. They attack anyone who isn't wearing cult apparel and suspiciously question anyone disguised as a cult member.
...
Ignatia, a [[/03_Mechanics/CLI/bestiary/humanoid/flamewrath-pota|flamewrath]] (see chapter 7), lives here. She leads the warriors outside and serves as the watch commander for the hobgoblins guarding the south barricades (area E27).

#### Prisoner

Unless the characters have somehow set the temple on high alert, Ignatia is questioning a [[/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota|Crushing Wave reaver]] who was caught sneaking close to Eternal Flame cult territory. The reaver, Orgaal, is unarmed and has 4 hit points remaining.
...
Eight [[/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm|cultists]] and two [[/03_Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm|cult fanatics]] are here.
