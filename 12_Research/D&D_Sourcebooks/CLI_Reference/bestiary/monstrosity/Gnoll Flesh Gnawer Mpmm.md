...
> [!figure] Creature
![]([[04_Resources|04_Resources]]/[[Assets|Assets]]/Creatures/creature-creature-gnoll-flesh-gnawer-mpmm-gnoll-flesh-gnawer-mpmm.svg)
...
"[[actions|actions]]":
  ...
  - "desc": "Until the end of the turn, the gnoll's speed increases by 60 feet and\
      \ it doesn't provoke [[[[actions#Opportunity%20Attack|actions#Opportunity%20Attack]]|opportunity attacks]]."
    "name": "Sudden Rush"
"bonus_actions":
...
"source":
  - "MPMM"
  - "VGM"
"image": "/03_Mechanics/CLI/[[Bestiary|Bestiary]]/monstrosity/token/gnoll-flesh-gnawer-mpmm.webp"
```
^statblock
...
Gnoll flesh gnawer mpmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## [[Lore|Lore]] Details

Legends speak of gnoll flesh gnawer mpmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or [[Whispers|Whispers]] on the wind—that herald change around gnoll flesh gnawer mpmm.
