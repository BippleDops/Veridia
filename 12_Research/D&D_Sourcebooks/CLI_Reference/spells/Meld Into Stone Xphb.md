...
Meld into stone xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of meld into stone xphb as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around meld into stone xphb.

## Adventure Hooks

- A rumor ties meld into stone xphb to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at meld into stone xphb to avert a public scandal.
- A map overlay reveals a hidden approach to meld into stone xphb active only during specific tides/storms.
