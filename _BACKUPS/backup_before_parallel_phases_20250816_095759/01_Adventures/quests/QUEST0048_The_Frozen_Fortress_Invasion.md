...
## Quest Giver
**Ivan Darkwater** - Mysterious stranger
...
- **Grovehollow** (Dungeon): Key location for quest progression
- **NorthVale** (Wilderness): Key location for quest progression
- **SouthVale** (Temple): Key location for quest progression
