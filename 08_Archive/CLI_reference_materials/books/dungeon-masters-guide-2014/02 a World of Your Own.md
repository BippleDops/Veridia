...
- world/both
type: note
updated: '2025-08-12T23:37:34.796659'
world: Both
---
...
![A Sample Pantheon; Dawn War Deities](/03_Mechanics/CLI/tables/a-sample-pantheon-dawn-war-deities.md)
...
![Forms of Government](/03_Mechanics/CLI/tables/forms-of-government.md)
...
![Government; Sample Hierarchy of Noble Titles](/03_Mechanics/CLI/tables/government-sample-hierarchy-of-noble-titles.md)
...
![Examples of Faction Ranks](/03_Mechanics/CLI/tables/examples-of-faction-ranks.md)
...
![World-Shaking Events](/03_Mechanics/CLI/tables/world-shaking-events.md)
...
![Rise or Fall of a Leader or an Era; Leader Types](/03_Mechanics/CLI/tables/rise-or-fall-of-a-leader-or-an-era-leader-types.md)
...
![Cataclysmic Disasters](/03_Mechanics/CLI/tables/cataclysmic-disasters.md)
...
![Assault or Invasion; Invading Forces](/03_Mechanics/CLI/tables/assault-or-invasion-invading-forces.md)
...
![Extinction or Depletion](/03_Mechanics/CLI/tables/extinction-or-depletion.md)
...
![New Organizations](/03_Mechanics/CLI/tables/new-organizations.md)
...
![Discovery, Expansion, Invention; Discoveries](/03_Mechanics/CLI/tables/discovery-expansion-invention-discoveries.md)
...
> 
> ![The Calendar of Harptos](/03_Mechanics/CLI/tables/the-calendar-of-harptos.md)
...
Dedicated spellcasters learn 3rd-level spells at the start of this tier. Suddenly characters can fly, damage large numbers of foes with [fireball](/03_Mechanics/CLI/spells/fireball-xphb.md) and [lightning bolt](/03_Mechanics/CLI/spells/lightning-bolt-xphb.md) spells, and even breathe underwater. They master 5th-level spells by the end of the tier, and spells such as [teleportation circle](/03_Mechanics/CLI/spells/teleportation-circle-xphb.md), [scrying](/03_Mechanics/CLI/spells/scrying-xphb.md), [flame strike](/03_Mechanics/CLI/spells/flame-strike-xphb.md), [legend lore](/03_Mechanics/CLI/spells/legend-lore-xphb.md), and [raise dead](/03_Mechanics/CLI/spells/raise-dead-xphb.md) can have a significant impact on their adventures. They start acquiring more permanent magic items (uncommon and rare ones) as well, which will serve them for the rest of their careers.
...
Dedicated spellcasters gain access to 6th-level spells at 11th level, including spells that completely change the way adventurers interact with the world. Their big, flashy spells are significant in combat-[disintegrate](/03_Mechanics/CLI/spells/disintegrate-xphb.md), [blade barrier](/03_Mechanics/CLI/spells/blade-barrier-xphb.md), and [heal](/03_Mechanics/CLI/spells/heal-xphb.md), for example-but behind-the-scenes spells such as [word of recall](/03_Mechanics/CLI/spells/word-of-recall-xphb.md), [find the path](/03_Mechanics/CLI/spells/find-the-path-xphb.md), [contingency](/03_Mechanics/CLI/spells/contingency-xphb.md), [teleport](/03_Mechanics/CLI/spells/teleport-xphb.md), and [true seeing](/03_Mechanics/CLI/spells/true-seeing-xphb.md) alter the way players approach their adventures. Each spell level after that point introduces new effects with an equally large impact. The adventurers find rare magic items (and very rare ones) that bestow similarly powerful abilities.
...
Dedicated spellcasters at this tier wield earthshaking 9th-level spells such as [wish](/03_Mechanics/CLI/spells/wish-xphb.md), [gate](/03_Mechanics/CLI/spells/gate-xphb.md), [storm of vengeance](/03_Mechanics/CLI/spells/storm-of-vengeance-xphb.md), and [astral projection](/03_Mechanics/CLI/spells/astral-projection-xphb.md). Characters have several rare and very rare magic items at their disposal, and begin discovering legendary items such as a [vorpal sword](/03_Mechanics/CLI/items/vorpal-sword-xdmg.md) or a [staff of the magi](/03_Mechanics/CLI/items/staff-of-the-magi-xdmg.md).
...
![Starting at Higher Level; Starting Equipment](/03_Mechanics/CLI/tables/starting-at-higher-level-starting-equipment.md)
...
![Wuxia Weapon Names](/03_Mechanics/CLI/tables/wuxia-weapon-names.md)
