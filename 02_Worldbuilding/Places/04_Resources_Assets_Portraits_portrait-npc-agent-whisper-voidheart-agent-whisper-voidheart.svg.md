---
title: 04 Resources Assets Portraits portrait npc agent whisper voidheart agent whisper
  voidheart.svg
aliases:
...
04_Resources/Assets/Portraits/portrait-npc-agent-whisper-voidheart-agent-whisper-voidheart.svg stands as a significant port in the region, serving both strategic and economic purposes. Its location provides advantages for trade, defense, and regional influence.
...
### Founding
Established generations ago as a strategic settlement, 04_Resources/Assets/Portraits/portrait-npc-agent-whisper-voidheart-agent-whisper-voidheart.svg has grown from humble beginnings to its current significance.
...
- First mentioned: ![[04_Resources/Assets/Portraits/portrait-npc-agen...
...
### Landmarks
- **Central Structure**: The defining feature of 04_Resources_Assets_Portraits_portrait-npc-agent-whisper-voidheart-agent-whisper-voidheart.svg
...
### Common Knowledge
- What everyone knows about 04_Resources_Assets_Portraits_portrait-npc-agent-whisper-voidheart-agent-whisper-voidheart.svg
