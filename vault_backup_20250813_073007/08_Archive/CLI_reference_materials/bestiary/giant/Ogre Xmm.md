...
- world/surface
type: monster
updated: '2025-08-13T12:34:19.547078+00:00'
world: Both
---
...
# [[3-Mechanics\CLI\bestiary\giant/ogre-xmm|Ogre]]
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/giant/token/ogre-xmm.webp"
```
^statblock
...
Ogre xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of ogre xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around ogre xmm.

## Adventure Hooks

- A rumor ties ogre xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at ogre xmm to avert a public scandal.
- A map overlay reveals a hidden approach to ogre xmm active only during specific tides/storms.
