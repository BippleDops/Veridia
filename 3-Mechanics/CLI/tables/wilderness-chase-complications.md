...
| 3 | You run through a [swarm of insects](/3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) (see the Monster Manual for game statistics, with the DM choosing whichever kind of insects makes the most sense). The swarm makes an opportunity attack against you (+3 to hit; `4d4` piercing damage on a hit). |
