...
- **Trident.** *Melee or Ranged Weapon Attack:* +7 to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* 6 (`dice: 1d6` + 3) piercing damage, or 7 (`dice: 1d8` + 3) piercing damage if used with two hands.
...
Ongoing situations affecting Current Riders Guild:
