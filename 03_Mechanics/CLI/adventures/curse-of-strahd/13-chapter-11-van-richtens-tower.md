...
![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/104-cos11-01.webp#center)
...
Following in the vampire hunter's footsteps is his protégé, [Ezmerelda d'Avenir](/03_Mechanics/CLI/bestiary/npc/ezmerelda-davenir-cos.md), who has taken to living in the tower while she searches for her mentor. She isn't present when the characters arrive, however.
...
The wagon radiates an aura of conjuration magic if it is scrutinized with a [detect magic](/03_Mechanics/CLI/spells/detect-magic-xphb.md) spell. A character who casts an [identify](/03_Mechanics/CLI/spells/identify-xphb.md) spell on the wagon learns the command words needed to operate it.

> [!gallery]
> ![Map 11.1: Van Richten's Tower (Area V)](/03_Mechanics/CLI/adventures/curse-of-strahd/img/105-027.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/curse-of-strahd/img/106-cos1101.webp#gallery)
...
The wagon has a hidden trapdoor in its underbelly that can be detected by a character who scuttles under the wagon and succeeds on a DC 13 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check. The trapdoor opens into the wagon and is the only safe way inside.
...
- A wooden trunk covered with claw marks that holds a [battleaxe](/03_Mechanics/CLI/items/battleaxe-xphb.md), a [flail](/03_Mechanics/CLI/items/flail-xphb.md), a [morningstar](/03_Mechanics/CLI/items/morningstar-xphb.md), a [light crossbow](/03_Mechanics/CLI/items/light-crossbow-xphb.md), and 10 silvered crossbow bolts  
- A narrow wardrobe containing three sets of [fine clothes](/03_Mechanics/CLI/items/fine-clothes-xphb.md), two sets of [traveler's clothes](/03_Mechanics/CLI/items/travelers-clothes-xphb.md), several pairs of shoes, a harlequin mask, and three wigs  
- A [climber's kit](/03_Mechanics/CLI/items/climbers-kit-xphb.md), a [disguise kit](/03_Mechanics/CLI/items/disguise-kit-xphb.md), a [healer's kit](/03_Mechanics/CLI/items/healers-kit-xphb.md), and a [poisoner's kit](/03_Mechanics/CLI/items/poisoners-kit-xphb.md)  
...
- A tiny wooden box containing a [deck of tarokka cards](/03_Mechanics/CLI/decks/tarokka-deck-cos.md) (see appendix E) wrapped in silk  
- A set of copper pots and pans (worth 50 gp)  
- Three sets of [manacles](/03_Mechanics/CLI/items/manacles-xphb.md)  
- A [shovel](/03_Mechanics/CLI/items/shovel-xphb.md)  
- A wooden chest containing a gold [holy symbol](/03_Mechanics/CLI/items/holy-symbol-xphb.md) of the Morninglord (worth 100 gp), three [vials of holy water](/03_Mechanics/CLI/items/holy-water-xphb.md), three vials of perfume, two vials of [antitoxin](/03_Mechanics/CLI/items/antitoxin-xphb.md), a [50-foot coil of hempen rope](/03_Mechanics/CLI/items/rope-xphb.md), a [tinderbox](/03_Mechanics/CLI/items/tinderbox-xphb.md), a [steel mirror](/03_Mechanics/CLI/items/mirror-xphb.md), a sharpened wooden stake, and a [spyglass](/03_Mechanics/CLI/items/spyglass-xphb.md)  
- Two [spell scrolls](/03_Mechanics/CLI/items/spell-scroll-xdmg.md) ([major image](/03_Mechanics/CLI/spells/major-image-xphb.md) and [remove curse](/03_Mechanics/CLI/spells/remove-curse-xphb.md))  
...
![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/107-cos11-02.webp#center)
...
![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/108-cos11-03.webp#center)
...
If the arm positions are done out of order, a [young blue dragon](/03_Mechanics/CLI/bestiary/dragon/young-blue-dragon-xmm.md) magically appears within 30 feet of the door and attacks all creatures it can see. The characters can keep trying to open the door while the dragon is attacking them. The dragon disappears if it is reduced to 0 hit points or if the characters open the door.
...
Van Richten spent several months in this room, reviewing a lifetime's worth of research on [Strahd von Zarovich](/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos.md)—notes that, once he committed them to memory, he burned in the stove. He also burned his journals. Ezmerelda searched the room, hoping to find a clue to her mentor's plan or whereabouts. Among the things she found here was a rolled-up map of Barovia and a burned page from van Richten's journal, which she took and hid in her wagon (area V1).

The standing armor is a suit of [animated armor](/03_Mechanics/CLI/bestiary/construct/animated-armor-xmm.md). It is [incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated) until someone speaks the command word ("Khazan") within 10 feet of it, whereupon the armor follows the commands of the one who activated it. If 24 hours pass without its receiving a new instruction from its controller, the animated armor becomes [incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated) until someone reactivates it. If it is reduced to 0 hit points, the armor falls to pieces and is destroyed.

A lavender aroma emanates from the wooden chest, which is unlocked and safe to open. It contains the severed head of a human Vistana named Yan. Its flesh has a waxy complexion and has been embalmed with magic oils. If a [speak with dead](/03_Mechanics/CLI/spells/speak-with-dead-xphb.md) spell is cast on his head (which would need to be taken somewhere away from the tower's *spell drain effect*), Yan reveals that he was banished from his clan for stealing. A half-elf bard named [Rictavio](/03_Mechanics/CLI/bestiary/npc/rictavio-cos.md) offered Yan a ride in his carnival wagon. The two traveled together for several days, but their time together was tense. When it was clear that [Rictavio](/03_Mechanics/CLI/bestiary/npc/rictavio-cos.md) was looking for a road to Barovia, Yan tried to steal the wagon as well as [Rictavio](/03_Mechanics/CLI/bestiary/npc/rictavio-cos.md)'s pet monkey, but [Rictavio](/03_Mechanics/CLI/bestiary/npc/rictavio-cos.md) got the better of him and drove a sword through his gullet.

The magic oils preserving Yan's head allow it to remember conversations it has while under the effect of [speak with dead](/03_Mechanics/CLI/spells/speak-with-dead-xphb.md). [Rictavio](/03_Mechanics/CLI/bestiary/npc/rictavio-cos.md) has cast [speak with dead](/03_Mechanics/CLI/spells/speak-with-dead-xphb.md) on the head twice to ask questions about the Vistani of Barovia. Yan believes that the half-elf plans to cause great harm to the Vistani and begs the characters to warn his people. He doesn't know where his body is.
...
Leading the hunt is [Kiril Stoyanovich](/03_Mechanics/CLI/bestiary/npc/kiril-stoyanovich-cos.md), a [werewolf](/03_Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) with 90 hit points. Accompanying him are six normal [werewolves](/03_Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) and nine [wolves](/03_Mechanics/CLI/bestiary/beast/wolf-xmm.md). While in wolf form, the werewolves are indistinguishable from ordinary wolves. They either remain in wolf form or assume hybrid form.
...
[Ezmerelda d'Avenir](/03_Mechanics/CLI/bestiary/npc/ezmerelda-davenir-cos.md) (see appendix D) returns to Van Richten's Tower after confronting Strahd in Castle Ravenloft and barely escaping with her life. She arrives on the back of a [riding horse](/03_Mechanics/CLI/bestiary/beast/riding-horse-xmm.md) stolen from the Vistani camp outside Vallaki (chapter 5, area N9).
