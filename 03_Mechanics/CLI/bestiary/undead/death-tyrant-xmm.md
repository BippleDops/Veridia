...
"actions":
  ...
  - "desc": "The death tyrant randomly shoots one of the following magical rays at\
      ...
      \ target has the [Charmed](/03_Mechanics/CLI/conditions.md#Charmed) condition\
      ...
      \ has the [Paralyzed](/03_Mechanics/CLI/conditions.md#Paralyzed) condition and\
      ...
      \ its [Speed](/03_Mechanics/CLI/variant-rules/speed-xphb.md) is halved; and it\
      \ can take either an action or a [Bonus Action](/03_Mechanics/CLI/variant-rules/bonus-action-xphb.md)\
      ...
      \ has the [Restrained](/03_Mechanics/CLI/conditions.md#Restrained) condition\
      \ until the start of the death tyrant's next turn or until the death tyrant\
      \ has the [Incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated) condition.\
      ...
      \ Construct or an Undead). Failure: The target has the [Unconscious](/03_Mechanics/CLI/conditions.md#Unconscious)\
...
"bonus_actions":
  - "desc": "The death tyrant's central eye emits an imperceptible, magical wave of\
      \ negative energy in a 150-foot [Cone](/03_Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ Creatures in that area can't regain [Hit Points](/03_Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ until the start of the death tyrant's next turn. An intact Humanoid corpse\
      \ there instantly rises as a [Zombie](/03_Mechanics/CLI/bestiary/undead/zombie-xmm.md)\
...
"regional_effects":
  ...
  - "desc": "- Negative Energy Suffusion. Whenever a creature within 1 mile of\
      ...
      \ allies) that finishes a [Short Rest](/03_Mechanics/CLI/variant-rules/short-rest-xphb.md)\
