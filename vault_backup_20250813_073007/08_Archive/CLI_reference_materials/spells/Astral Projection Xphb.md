...
- world/both
type: note
updated: '2025-08-13T12:34:20.767057+00:00'
world: Both
---
...
You and up to eight willing creatures within range project your astral bodies into the Astral Plane (the spell ends instantly if you are already on that plane). Each target's body is left behind in a state of suspended animation; it has the [[/03_Mechanics/CLI/conditions#Unconscious|Unconscious]] condition, doesn't need food or air, and doesn't age.
...
Any damage or other effects that apply to an astral form have no effect on the target's body and vice versa. If a target's body or astral form drops to 0 [[/03_Mechanics/CLI/variant-rules/hit-points-xphb|Hit Points]], the spell ends for that target. The spell ends for all the targets if you take a [[/03_Mechanics/CLI/actions#Magic|Magic]] action to dismiss it.

When the spell ends for a target who isn't dead, the target reappears in its body and exits the state of suspended animation.

**Classes**: [[/03_Mechanics/CLI/lists/list-spells-classes-monk|Monk]]; [[/03_Mechanics/CLI/lists/list-spells-classes-warlock|Warlock]]; [[/03_Mechanics/CLI/lists/list-spells-classes-divine-soul-xge "subclass=XGE;class=XPHB"|Sorcerer (Divine Soul)]]; [[/03_Mechanics/CLI/lists/list-spells-classes-cleric|Cleric]]; [[/03_Mechanics/CLI/lists/list-spells-classes-bard|Bard]]; [[/03_Mechanics/CLI/lists/list-spells-classes-wizard|Wizard]]
...
Astral projection xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
