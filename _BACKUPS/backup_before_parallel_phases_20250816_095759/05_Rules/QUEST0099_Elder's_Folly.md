...
## Quest Giver
**Tara Brightblade the Terrible** - Dying adventurer
...
## Key Locations
- **Grovethorpe** (City): Key location for quest progression
- **Haventon** (Dungeon): Key location for quest progression

## Opposition
### Enemies
- **Demons** led by Tara Fireborn
...
- **Gold**: 4,150 gp
- **Experience**: 5,000 XP
- **Magic Items**: Divine Tome of the Dawn
