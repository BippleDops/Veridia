---
aliases: ["Baron's Request", "baron's request", "Request Baron's"]
tags: [generated]
id: QUEST0084
...
## Quest Giver
**Ewan Brightblade** - Dying adventurer
...
## Key Locations
- **UpperFalls** (City): Key location for quest progression
- **LowerFalls** (Dungeon): Key location for quest progression
- **Marshwick** (Wilderness): Key location for quest progression
- **NewFalls** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Corrupt Guards** led by Ewan Fireborn
  - Strength: 16 combatants
