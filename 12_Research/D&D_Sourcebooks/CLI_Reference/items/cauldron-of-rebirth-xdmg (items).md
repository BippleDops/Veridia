...
You can use the cauldron as a [[spellcasting-focus-xphb (variant-rules)]] for your spells, and it functions as a suitable component for the [[Scrying Xphb]] spell.
...
When you finish a [[long-rest-xphb]], you can use the cauldron to create a [[potion-of-greater-healing-xdmg (items)]], which takes 1 minute. The potion lasts for 24 hours, then loses its magic if not consumed.
...
If you place the corpse of a Humanoid into the cauldron and cover the corpse with 200 pounds of salt (which costs 10 GP) for at least 8 hours, the salt is consumed and the creature returns to life as if by [[raise-dead-xphb (spells)]] at the next dawn. Once used, this property can't be used again for 7 days.
