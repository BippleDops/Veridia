...
- world/both
type: note
updated: '2025-08-13T12:34:21.280755+00:00'
world: Both
---
...
If you dump one or more beans out of the bag, they explode in a 10-foot-radius [[/03_Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb|Sphere]] centered on them. All the dumped beans are destroyed in the explosion, and each creature in the [[/03_Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb|Sphere]], including you, makes a DC 15 Dexterity saving throw, taking `5d4` Force damage on a failed save or half as much damage on a successful one.
...
| dice: 1d100 | Effect |
|-------------|--------|
| 01 | `5d4` toadstools sprout. If a creature eats a toadstool, roll any die. On an odd roll, the eater must succeed on a DC 15 Constitution saving throw or take `5d6` Poison damage and have the [[/03_Mechanics/CLI/conditions#Poisoned|Poisoned]] condition for 1 hour. On an even roll, the eater gains `5d6` [[/03_Mechanics/CLI/variant-rules/temporary-hit-points-xphb|Temporary Hit Points]] for 1 hour. |
...
| 11-20 | A [[/03_Mechanics/CLI/bestiary/plant/treant-xmm|Treant]] sprouts. Roll any die. On an odd roll, the treant is Chaotic Evil. On an even roll, the treant is Chaotic Good. |
...
| 61-70 | A hungry [[/03_Mechanics/CLI/bestiary/monstrosity/bulette-xmm|Bulette]] burrows up and attacks. |
...
| 91-95 | A pyramid with a 60-foot-square base bursts upward. Inside is a burial chamber containing a [[/03_Mechanics/CLI/bestiary/undead/mummy-xmm|Mummy]], a [[/03_Mechanics/CLI/bestiary/undead/mummy-lord-xmm|Mummy Lord]], or some other Undead of the DM's choice. Its sarcophagus contains treasure of the DM's choice. |
