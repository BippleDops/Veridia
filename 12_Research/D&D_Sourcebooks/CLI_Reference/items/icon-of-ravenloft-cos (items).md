...
While within 30 feet of the icon, a creature is under the effect of a [[Protection From Evil and Good Xphb]] spell against fiends and undead. Only a creature attuned to the icon can use its other properties.
...
You can use an action to cast an [[augury-xphb (spells)]] spell from the icon, with no material components required. Once used, this property can't be used again until the next dawn.
