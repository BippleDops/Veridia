...
The streets of Greenest are overrun by forces consisting of [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) and [acolytes](/3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) accompanied by monstrous allies: [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) with [ambush drakes](/3-Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D) and [giant lizards](/3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md). These raiders move through town without fear, pillaging as they go. As characters travel through the embattled village, they can run into raiders and townsfolk. Use these guidelines to determine if characters have an encounter.

If characters use cover and stealth to avoid encounters, have each character attempt a DC 10 Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check. For every two individual checks that fail, the characters have one encounter on the way to their destination. Roll a `d8` on the Chapter 1 Encounters table to determine each encounter. If characters use the stream bed for cover for most of the trip, these characters have advantage on their Dexterity checks.
...
| dice: d8 | Encounter |
|----------|-----------|
| 1 | 6 [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) |
| 2 | 3 [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) and 1 [ambush drake](/3-Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D) |
| 3 | 6 [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) |
| 4 | 4 [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) and 1 [guard](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) |
| 5 | 2 [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) and 1 [acolyte](/3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)* |
| 6 | 3 [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) and 1 [acolyte](/3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)* |
| 7 | `d6` townsfolk being hunted by raiders (roll a `d6` to determine the raiding group) |
| 8 | `d6` townsfolk hiding |
^encounter

* Acolytes have [command](/3-Mechanics/CLI/spells/command-xphb.md) prepared instead of [sanctuary](/3-Mechanics/CLI/spells/sanctuary-xphb.md).
...
Characters have random encounters with raiders when they enter Greenest, but this one should be their first mission of the chapter. It begins when a terrified human family (father, mother, and three young children) dash across their path, hounded by seven [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md).
...
The woman is [Linan Swift](/3-Mechanics/CLI/bestiary/npc/linan-swift-hotdq.md), and her husband is Cuth. Linan is a [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) but with 8 hit points. Her attack with the spear is `+2` to hit for `d6` piercing damage. Her husband is down to 2 hit points from an earlier fight. The children move at speed 20. They can be carried, but a character carrying a child has disadvantage on attack rolls and cannot wield a two-handed weapon.
...
To reach the keep, the characters must make it past three groups of raiders. A group consists of `d6` [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) and `d4` [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md). If the group contains six kobolds, one is a [winged kobold (urd)](/3-Mechanics/CLI/bestiary/dragon/winged-kobold-xmm.md).
...
To secure the sally port, characters must battle through two groups of foes. The first fight occurs against three [acolytes](/3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md), three [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md), and one [ambush drake](/3-Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D), which are guarding the sally port's 10-foot-by-20-foot ready room against exactly this type of counterattack. After characters seize the room, they discover that the door is heavily damaged. The fastest repair is with five castings of [mending](/3-Mechanics/CLI/spells/mending-xphb.md) (taking five minutes). If none of the characters can do this, an NPC in the keep knows the cantrip. Someone must find and fetch her to the ready room.

Before the door can be repaired, a second group of raiders consisting of two [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md), three [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md), and three [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) attacks. These foes can come from outside the keep, or they might be a group of infiltrators trying to fight its way back outside. If characters barricade the door with barrels or other heavy objects while awaiting repairs, they might hold off attackers until the repairs are finished and avoid this fight entirely.
...
Characters earn 50 XP each for driving away Lennithon, but reduce that award to 25 XP if 10 or more defenders were killed during the attack. For their role in driving off the dragon, the characters receive four [potions of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md) from the grateful Governor Nighthill.
...
The ambushers are waiting in the loft for heroes to enter the mill. When the heroes are inside, the guards launch a volley of spears from above, then leap down to fight hand-to-hand. The ambushers have a good chance to gain a surprise round for their spear volley; a successful DC 20 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check is needed to notice them before the attack. Characters who scan the loft for hidden enemies upon entering the mill have advantage on the check.
...
The speaker is [Langdedrosa Cyanwrath](/3-Mechanics/CLI/bestiary/npc/langdedrosa-cyanwrath-hotdq.md) (see appendix D for statistics) a half-blue dragon who serves the Cult of the Dragon. Cyanwrath has a personal troop of sixteen [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md). A character who makes a successful DC 15 Intelligence ([Arcana](/3-Mechanics/CLI/skills.md#Arcana)) or Intelligence ([Nature](/3-Mechanics/CLI/skills.md#Nature)) check recognizes the creature as a half-dragon from descriptions.
...
If a character steps up to the challenge and fights Cyanwrath, each party member earns 50 XP. If not, characters receive nothing for this encounter. A team of healers with healer's kits and +4 bonuses to Wisdom ([Medicine](/3-Mechanics/CLI/skills.md#Medicine)) checks attend to the wounded or dying character, and Governor Nighthill gratefully offers two [potions of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md) to the wounded character. If characters do something that costs the life of a hostage, Governor Nighthill is furious with them and offers no more help.
