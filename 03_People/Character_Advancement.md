...
- **Mannerisms**: *[Distinctive habits or behaviors]* --- title: Character Advancement
type: player-resource
tags:
- player-resource
- active created: '2025-08-14'
modified: '2025-08-14' --- ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 07_Player_Resources-specific enhancement ## Experience Points | Level | XP Required |
|-------|------------|
| 1 | 0 |
| 2 | 300 |
| 3 | 900 |
| 4 | 2,700 |
| 5 | 6,500 | ## Milestone Leveling Level up at story milestones ## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:* - Can be adapted to fit current story needs
- Scalable threat/reward based on party level
- Multiple entry points for different play styles
- Connections to overarching campaign themes ## Plot Hooks - A journal reveals a betrayal about this place - A journal reveals ancient history about this place ## 07_Player_Resources Specific Content Contextual improvement based on 07_Player_Resources ## 07_Player_Resources Specific Content Contextual improvement based on 07_Player_Resources ## Stats```statblock creature: Custom NPC```### Quick Stats - **AC**: *[Armor Class]*
- **HP**: *[Hit Points]*
