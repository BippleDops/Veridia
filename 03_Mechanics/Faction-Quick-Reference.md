...
- world/aethermoor
type: Mechanics
updated: '2025-08-12T23:37:41.103594'
world: Aethermoor
---
...
Faction Quick Reference is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of Faction Quick Reference as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Faction Quick Reference.

## Adventure Hooks

- A rumor ties Faction Quick Reference to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at Faction Quick Reference to avert a public scandal.
- A map overlay reveals a hidden approach to Faction Quick Reference active only during specific tides/storms.
