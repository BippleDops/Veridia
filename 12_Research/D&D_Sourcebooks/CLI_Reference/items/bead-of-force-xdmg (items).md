...
An enclosed creature can take a [[actions#Utilize|Utilize]] action to push against the sphere's wall, moving the sphere up to half the creature's [[Fly Speed Xphb]]. The sphere can be picked up, and its magic causes it to weigh only 1 pound, regardless of the weight of creatures inside.
