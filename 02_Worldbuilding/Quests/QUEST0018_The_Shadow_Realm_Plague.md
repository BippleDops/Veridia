...
## Quest Giver
**Soren Goldleaf the Young** - Guild representative
...
## Key Locations
- **Fallsshire** (City): Key location for quest progression
- **PortBridge** (Dungeon): Key location for quest progression
...
- **Gold**: 697 gp
- **Experience**: 1,000 XP
- **Magic Items**: Cursed Crown of Power
- **Other**: Property deed
