...
- A creature that starts its turn in the fog must succeed on a DC 20 Constitution saving throw or gain one level of [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion) (see "appendix A" in the "Player's Handbook"). This [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion) can't be removed while the creature is in the fog.  
...
The land of Barovia resides in its own demiplane, isolated from all other planes, including the Material Plane. No spell—not even [wish](/3-Mechanics/CLI/spells/wish-xphb.md)—allows one to escape from Strahd's domain. [Astral projection](/3-Mechanics/CLI/spells/astral-projection-xphb.md), [teleport](/3-Mechanics/CLI/spells/teleport-xphb.md), [plane shift](/3-Mechanics/CLI/spells/plane-shift-xphb.md), and similar spells cast for the purpose of leaving Barovia simply fail, as do effects that banish a creature to another plane of existence. These restrictions apply to magic items and artifacts that have properties that transport or banish creatures to other planes. Magic that allows transit to the Border Ethereal, such as the [etherealness](/3-Mechanics/CLI/spells/etherealness-xphb.md) spell and the Etherealness feature of incorporeal undead, is the exception to this rule. A creature that enters the Border Ethereal from Strahd's domain is pulled back into Barovia upon leaving that plane.

For the purpose of spells whose effects change across or are blocked by planar boundaries (such as [sending](/3-Mechanics/CLI/spells/sending-xphb.md)), Strahd's domain is considered its own plane. Magic that summons creatures or objects from other planes functions normally in Barovia, as does magic that involves an extradimensional space. Any spells cast within such an extradimensional space (such as that created by [Mordenkainen's magnificent mansion](/3-Mechanics/CLI/spells/mordenkainens-magnificent-mansion-xphb.md)) are subject to the same restrictions as magic cast in Barovia.
...
> [!note] 
> 
> [Alarm](/3-Mechanics/CLI/spells/alarm-xphb.md): Instead of hearing a mental ping when the alarm is triggered, the caster hears a scream.
> 
> [Bigby's hand](/3-Mechanics/CLI/spells/bigbys-hand-xphb.md): The conjured hand is skeletal.
> 
> [Find familiar](/3-Mechanics/CLI/spells/find-familiar-xphb.md): The familiar is undead—not a celestial, fey, or fiend—and is immune to features that turn undead.
> 
> [Find steed](/3-Mechanics/CLI/spells/find-steed-xphb.md): The summoned steed is undead—not a celestial, fey, or fiend—and is immune to features that turn undead.
> 
> [Find the path](/3-Mechanics/CLI/spells/find-the-path-xphb.md): A child's spirit appears and guides the caster to the desired location. The spirit can't be harmed and doesn't speak.
> 
> [Fog cloud](/3-Mechanics/CLI/spells/fog-cloud-xphb.md): Misty, harmless claws form in the fog.
> 
> [Gust of wind](/3-Mechanics/CLI/spells/gust-of-wind-xphb.md): A ghastly moan accompanies the summoned wind.
> 
> [Mage hand](/3-Mechanics/CLI/spells/mage-hand-xphb.md): The summoned hand is skeletal.
> 
> [Maze](/3-Mechanics/CLI/spells/maze-xphb.md): The surfaces of the demiplane's maze are made of mortared skulls and bones.
> 
> [Phantom steed](/3-Mechanics/CLI/spells/phantom-steed-xphb.md): The steed resembles a skeletal horse.
> 
> [Rary's telepathic bond](/3-Mechanics/CLI/spells/rarys-telepathic-bond-xphb.md): Characters linked together by the spell can't shake the feeling that something vile is telepathically eavesdropping on them.
> 
> [Revivify](/3-Mechanics/CLI/spells/revivify-xphb.md): A creature restored to life by a [revivify](/3-Mechanics/CLI/spells/revivify-xphb.md) spell screams upon regaining consciousness, as though waking from some horrible nightmare.
> 
> [Spirit guardians](/3-Mechanics/CLI/spells/spirit-guardians-xphb.md): The spirits appear as ghostly, skeletal warriors.
> 
> [Wall of stone](/3-Mechanics/CLI/spells/wall-of-stone-xphb.md): A wall created by the spell has ghastly faces sculpted into it, as though tortured spirits were somehow trapped within the stone.
^0a7
...
The curse is a repayment for an injustice or a slight. The target must succeed on a Wisdom saving throw to avoid the curse. The saving throw DC is 8 + the Vistana's proficiency bonus + the Vistana's Charisma modifier. The curse lasts until ended with a [remove curse](/3-Mechanics/CLI/spells/remove-curse-xphb.md) spell, a [greater restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell, or similar magic. It doesn't end when the target dies. If a cursed target is returned to life, the curse remains in effect.
...
- The target is [blinded](/3-Mechanics/CLI/conditions.md#Blinded), [deafened](/3-Mechanics/CLI/conditions.md#Deafened), or both. When this curse ends, the Vistana takes `5d6` psychic damage.  

### Evil Eye

As an action, a Vistana can target a creature within 10 feet that the Vistana can see. This magical ability, which the Vistani call the Evil Eye, duplicates the duration and effect of the [animal friendship](/3-Mechanics/CLI/spells/animal-friendship-xphb.md), [charm person](/3-Mechanics/CLI/spells/charm-person-xphb.md), or [hold person](/3-Mechanics/CLI/spells/hold-person-xphb.md) spell (Vistana's choice), but requires neither somatic nor material components. The spell save DC is 8 + the caster's proficiency bonus + the caster's Charisma modifier. If the target succeeds on the save, the Vistana is [blinded](/3-Mechanics/CLI/conditions.md#Blinded) until the end of the Vistana's next turn.
...
| 3 | `d6` [scouts](/3-Mechanics/CLI/bestiary/humanoid/barovian-scout-cos.md) |
| 4 | Hunting trap |
| 5 | Grave |
| 6 | False trail |
...
| 9 | Trinket |
| 10 | Hidden bundle |
| 11 | `d4` [swarm of ravens](/3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) (50%) or 1 [wereraven](/3-Mechanics/CLI/bestiary/humanoid/wereraven-vrgr.md) (see appendix D) in raven form (50%) |
| 12 | `d6` [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) |
| 13 | `3d6` [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) |
| 14 | `d4` [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
| 15 | Corpse |
| 16 | `d6` [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) in human form |
| 17 | 1 [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) with `2d6` [twig blights](/3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) |
| 18 | `2d4` [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) |
| 19 | `d6` [scarecrows](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) |
| 20 | 1 [revenant](/3-Mechanics/CLI/bestiary/undead/revenant-xmm.md) |
^daytime-random-encounters-in-barovia
...
| d12 + d8 | Encounter |
|----------|-----------|
| 2 | 1 [ghost](/3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) |
| 3 | Hunting trap |
| 4 | Grave |
| 5 | Trinket |
| 6 | Corpse |
| 7 | Hidden bundle |
| 8 | Skeletal rider |
| 9 | `d8` [swarm of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) |
| 10 | `d6` [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) |
| 11 | `3d6` [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) |
| 12 | `d4` [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
| 13 | 1 [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) and `2d6` [twig blights](/3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) |
| 14 | `2d4` [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) |
| 15 | `d6` [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) in wolf form |
| 16 | `3d6` [zombies](/3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) |
| 17 | `d6` [scarecrows](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) |
| 18 | `d8` [Strahd zombies](/3-Mechanics/CLI/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
| 19 | 1 [will-o'-wisp](/3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) |
| 20 | 1 [revenant](/3-Mechanics/CLI/bestiary/undead/revenant-xmm.md) |
^nighttime-random-encounters-in-barovia
...
If at least one character has a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 16 or higher, read:
...
> 
> Every day and night that the characters remain in Barovia, one or more of the vampire's spies check on them and attempt to return to Strahd with a report. When a spy appears, characters who have a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score equal to or greater than the spy's Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check notice it. A spy does not constitute an encounter if the characters are unaware of its presence. If they do notice it, the spy's goal is usually escape, not combat. A secondary goal for a spy might be to acquire some physical object—a possession, an article of clothing, or even some part of a character's body such as a lock of hair—that Strahd can use to improve the efficacy of his [scrying](/3-Mechanics/CLI/spells/scrying-xphb.md) spell. If one of Strahd's spies is confronted by the party, the spy attempts to grab some accessible item from a character before fleeing. If Strahd acquires such an item, he uses his [scrying](/3-Mechanics/CLI/spells/scrying-xphb.md) spell to learn as much as he can about the party before planning his next attack, and to verify what his spies have already told him.
^strahds-spies

### Berserkers

These wild mountain folk are covered head to toe in thick gray mud, which makes them hard to see in the fog and well hidden in the mountains they call home. While so camouflaged, they have advantage on Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) checks made to hide. Characters whose passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) scores are higher than the berserker's Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check can spot the nearest [berserker](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md).
...
The area is lightly obscured by fog. If more than one dire wolf is present, the others aren't far behind and can be seen as dark shadows in the fog. The [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) of Barovia are cruel, overgrown wolves and Strahd's loyal servants. They can't be [charmed](/3-Mechanics/CLI/conditions.md#Charmed) or [frightened](/3-Mechanics/CLI/conditions.md#Frightened).
...
The Barovian wilderness is home to [druids](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) who worship Strahd because of his ability to control the weather and the beasts of Barovia. The druids are savage and violent, and each controls a host of [twig blights](/3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md), which fights until destroyed. If all the twig blights are destroyed or the druid loses more than half of its hit points, the druid flees, heading toward Yester Hill (area Y).
...
Have each of the characters in the front rank of the party's marching order make a DC 15 Wisdom ([Survival](/3-Mechanics/CLI/skills.md#Survival)) check. If one or more of them succeeds, read:
...
The woods crawl with [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) that serve the evil druids of Barovia. If the characters are moving quietly and not carrying light sources, they can try to hide from these blights.
...
From a distance, the [revenant](/3-Mechanics/CLI/bestiary/undead/revenant-xmm.md) looks like a zombie and might be mistaken for such. A character within 30 feet of the revenant who succeeds on a DC 10 Wisdom ([Insight](/3-Mechanics/CLI/skills.md#Insight)) check can see the intelligence and hate in its sunken eyes. The revenant is clad in tattered chain mail that affords the same protection as leather armor.
...
If at least one character has a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 11 or higher, read:
...
If more than one [scarecrow](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) is present, the others are close by. If none of the characters has a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 11 or higher, the scarecrows catch the party by surprise.
...
The human [skeleton](/3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) and [warhorse skeleton](/3-Mechanics/CLI/bestiary/undead/warhorse-skeleton-xmm.md) are all that remain of a rider and mount, both of whom perished trying to escape through the fog that surrounds Barovia. They are doomed to ride through the valley in search of another way out, without hope of salvation. The skeletons ignore the characters unless attacked.
...
This [wereraven](/3-Mechanics/CLI/bestiary/humanoid/wereraven-vrgr.md) in raven form watches the characters from a distance. Compare its Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check result to the characters' passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) scores to see whether it remains hidden from the party.
...
How the [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) act depends on the form they have taken.
...
Werewolves in wolf form follow the party from a safe distance for several hours. If their Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) checks exceed the characters' passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) scores, the werewolves attack with surprise when the characters decide to take a short or long rest. Otherwise, they wait until the characters are weakened by another random encounter before moving in for the easy kill.
...
The light is a [will-o'-wisp](/3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) that enters the ruined tower and becomes [invisible](/3-Mechanics/CLI/conditions.md#Invisible), hoping to lure the characters inside to their doom.
...
If the characters disturb the chest, `3d6` [zombies](/3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) erupt from the earthen floor and attack. Once the zombies appear, the will-o'-wisp becomes visible and joins the fray.
...
Characters have a few minutes to steel themselves before these [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) attack. They heed the will of Strahd and can't be [charmed](/3-Mechanics/CLI/conditions.md#Charmed) or [frightened](/3-Mechanics/CLI/conditions.md#Frightened).
...
These unfortunate Barovians fell prey to the evils of the land and now shamble from place to place as a [ravenous mob](/3-Mechanics/CLI/bestiary/undead/zombie-xmm.md).
...
> 
> **Secret Doors.** If there are obvious clues to a secret door's presence, such as scratch marks on a nearby wall or footprints leading to it, a character with a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 15 or higher notices the secret door. Otherwise, finding a secret door requires a search of the area and a successful DC 15 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check.
> 
...
If the characters are following the road on foot, the party member who has the highest passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score notices something:
...
If the characters linger in the woods, they hear a lone wolf howl far off in the forest. Each round, one more wolf adds its voice to the howling, with the sound getting progressively closer to the party. If the characters are still in the woods after 5 rounds of howling, five [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) arrive and attack. If the characters are trying to leave Barovia, these dire wolves are joined by a pack of twenty [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md). The wolves and the dire wolves stop their attack if the characters return to the road and head toward the village of Barovia (area E).
...
The eight [draft horses](/3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) drinking from the river are used to pull the Vistani wagons and aren't easily startled.
...
The two black [draft horses](/3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) are under Strahd's control. The horses wait for the characters to pile into the carriage if they so desire. There is room inside for eight of them. If they get into the carriage, the horses draw it down the road to area J. The horses can't be discouraged from their course, not even by a skilled teamster.
...
A patch of [green slime](/3-Mechanics/CLI/traps-hazards/green-slime-xdmg.md) (see ""Dungeon Hazards"" in chapter 5 of the "Dungeon Master's Guide") clings to the portcullis in the entry tunnel, and can be spotted with a successful DC 20 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check. The slime will not fall on characters entering the castle, but it does fall on the first character who leaves by this route.
...
Characters who act quickly can save [Arabelle](/3-Mechanics/CLI/bestiary/npc/arabelle-cos.md) before she drowns. A character on the shore must succeed on a DC 15 Strength ([Athletics](/3-Mechanics/CLI/skills.md#Athletics)) check to reach her in time. The DC is 10 for characters who took a rowboat out onto the lake.
...
[The Mad Mage of Mount Baratok](/3-Mechanics/CLI/bestiary/npc/the-mad-mage-of-mount-baratok-cos.md) (CN male human [archmage](/3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md)) came to Barovia more than a year ago to free its people from Strahd's tyranny, but he underestimated Strahd's hold over the land and the creatures in it. After a battle between the two in Castle Ravenloft, Strahd drove the Mad Mage to the mountains and sent the wizard hurling over Tser Falls (area H). The wizard, his staff and spellbook lost, survived the fall and retreated into the mountains, hoping to regain his power, only to be driven mad by the realization that he no longer has any hope of defeating Strahd or freeing the people of the vampire's damned realm.
...
Under normal circumstances, a [greater restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell cast on the Mad Mage would restore his wits and ends the madness, allowing him to remember that he is none other than Mordenkainen, an [archmage](/3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) of Oerth and the leader of a powerful group of adventurers called the Circle of Eight. But in this case, the Mad Mage has cast a [mind blank](/3-Mechanics/CLI/spells/mind-blank-xphb.md) spell on himself. As long as that spell remains in effect, his sanity can't be restored by any spell. If the characters surmise that powerful magic is preventing them from restoring the Mad Mage's wits, they can, with a successful DC 15 Charisma ([Persuasion](/3-Mechanics/CLI/skills.md#Persuasion)) check, convince the Mad Mage to divulge the reason why their spell failed. A character can also ascertain the cause of the spell's failure with a successful DC 18 Intelligence ([Arcana](/3-Mechanics/CLI/skills.md#Arcana)) check. The Mad Mage's [mind blank](/3-Mechanics/CLI/spells/mind-blank-xphb.md) spell has a remaining duration of `3d6` hours, after which his madness can be cured normally.

The Mad Mage has a different spell list from that of the [archmage](/3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) in the "Monster Manual", and he has already used one 1st-level spell slot to cast [mage armor](/3-Mechanics/CLI/spells/mage-armor-xphb.md) on himself, one 4th-level spell slot to cast [polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md) on himself, one 7th-level spell slot to cast [Mordenkainen's magnificent mansion](/3-Mechanics/CLI/spells/mordenkainens-magnificent-mansion-xphb.md) (see "The Mad Mage's Mansion"), and one 8th-level spell slot to cast [mind blank](/3-Mechanics/CLI/spells/mind-blank-xphb.md) on himself.

> [!note] 
> 
> Cantrips (at will): [fire bolt](/3-Mechanics/CLI/spells/fire-bolt-xphb.md), [light](/3-Mechanics/CLI/spells/light-xphb.md), [mage hand](/3-Mechanics/CLI/spells/mage-hand-xphb.md), [prestidigitation](/3-Mechanics/CLI/spells/prestidigitation-xphb.md), [shocking grasp](/3-Mechanics/CLI/spells/shocking-grasp-xphb.md)
> 
> 1st level (4 slots): [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md), [mage armor](/3-Mechanics/CLI/spells/mage-armor-xphb.md), [magic missile](/3-Mechanics/CLI/spells/magic-missile-xphb.md), [shield](/3-Mechanics/CLI/spells/shield-xphb.md)
> 
> 2nd level (3 slots): [mirror image](/3-Mechanics/CLI/spells/mirror-image-xphb.md), [misty step](/3-Mechanics/CLI/spells/misty-step-xphb.md), [web](/3-Mechanics/CLI/spells/web-xphb.md)
> 
> 3rd level (3 slots): [counterspell](/3-Mechanics/CLI/spells/counterspell-xphb.md), [fly](/3-Mechanics/CLI/spells/fly-xphb.md), [lightning bolt](/3-Mechanics/CLI/spells/lightning-bolt-xphb.md)
> 
> 4th level (3 slots): [Mordenkainen's faithful hound](/3-Mechanics/CLI/spells/mordenkainens-faithful-hound-xphb.md), [polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md), [stoneskin](/3-Mechanics/CLI/spells/stoneskin-xphb.md)
> 
> 5th level (3 slots): [Bigby's hand](/3-Mechanics/CLI/spells/bigbys-hand-xphb.md), [cone of cold](/3-Mechanics/CLI/spells/cone-of-cold-xphb.md), [scrying](/3-Mechanics/CLI/spells/scrying-xphb.md)
> 
> 6th level (1 slot): [true seeing](/3-Mechanics/CLI/spells/true-seeing-xphb.md)
> 
> 7th level (1 slot): [Mordenkainen's magnificent mansion](/3-Mechanics/CLI/spells/mordenkainens-magnificent-mansion-xphb.md)
> 
> 8th level (1 slot): [mind blank](/3-Mechanics/CLI/spells/mind-blank-xphb.md)
> 
> 9th level (1 slot): [time stop](/3-Mechanics/CLI/spells/time-stop-xphb.md)
^128

#### The Mad Mage's Mansion

If the characters rescue the [archmage](/3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) from his madness, he invites them to his "mansion." He leads them up the mountain to an invisible doorway that serves as the entrance to his extradimensional lair, created using the [Mordenkainen's magnificent mansion](/3-Mechanics/CLI/spells/mordenkainens-magnificent-mansion-xphb.md) spell. There, he provides them with food and sanctuary away from the prying eyes of Strahd and his spies. Characters are free to take a short or long rest, during which time they aren't disturbed.
...
The [archmage](/3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) has never had his fortune read by [Madam Eva](/3-Mechanics/CLI/bestiary/npc/madam-eva-cos.md) and doesn't care to, but if he is told about the [Holy Symbol of Ravenkind](/3-Mechanics/CLI/items/holy-symbol-of-ravenkind-cos.md), the [Tome of Strahd](/3-Mechanics/CLI/items/tome-of-strahd-cos.md), and the [Sunsword](/3-Mechanics/CLI/items/sunsword-cos.md), he insists that these items be recovered before he and the party confront Strahd. If Strahd is defeated and Mordenkainen survives, the archmage gladly accompanies the characters back to their world if they invite him, if only not to disappoint them.
