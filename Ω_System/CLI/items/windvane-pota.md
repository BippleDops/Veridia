...
---
# Windvane
*Weapon ([spear](/3-Mechanics/CLI/items/spear-xphb.md)), legendary (requires attunement)*  
...
- **Range**: 20/60
- **Properties**: [Finesse](/3-Mechanics/CLI/item-properties.md#Finesse), [Thrown](/3-Mechanics/CLI/item-properties.md#Thrown), [Versatile](/3-Mechanics/CLI/item-properties.md#Versatile)
- **Weight**: 3.0 lbs.
...
- You can cast [dominate monster](/3-Mechanics/CLI/spells/dominate-monster-xphb.md) (save DC 17) on an [air elemental](/3-Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md). Once you have done so, Windvane can't be used this way again until the next dawn.  
