...
improvements: 20
status: active
aliases: ["Mechanics Dimensional Travel"]
priority: normal
category: 05 Rules
subcategory: Mechanics Dimensional Travel.Md
related: []
cssclass: standard
publish: false
...
*Tags*: #mechanics #rules #homebrew #variant #system ## Rule Summary 03_Mechanics_Dimensional_Travel provides a systematic approach to handling specific game situations. This mechanic integrates with core D&D 5e rules while adding depth to gameplay. ## When to Use Apply this rule when:
...
- Connections to overarching campaign themes ## Prophecy Connection Mentioned in The First Prophecy of Shadows ## Balance Analysis ### Damage Output Comparison
