...
type: note
created: 2025-07-23
updated: '2025-08-13T01:18:32.250540+00:00'
...
![](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/053-poa05-01.webp#center)
...
Use this event only if the fire node is still active. The characters find themselves—and perhaps a settlement they care about—in the path of three [fire elementals](/03_Mechanics/CLI/bestiary/elemental/fire-elemental-xmm.md) and five [smoke mephits](/03_Mechanics/CLI/bestiary/elemental/smoke-mephit-xmm.md). The elementals go for the nearest large combustible objects, while the smoke mephits scatter and use their cinder breath to start small peripheral fires.
...
If the characters try to slip into town without being spotted, they quickly meet a bowyer named Reetha (a human [commoner](/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). She wants nothing to do with the Black Earth cult and despairs that her neighbors knuckled under to the cultists. Reetha tells the characters that most townspeople are just scared, and that cultists have taken over the Harvest Inn.
...
Five [Crushing Wave reavers](/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md) and a [Howling Hatred priest](/03_Mechanics/CLI/bestiary/humanoid/howling-hatred-priest-pota.md) wearing a [balloon pack](/03_Mechanics/CLI/items/balloon-pack-pota.md) watch the outer camp. (See chapter 7 for the cultists' statistics and rules for the [balloon pack](/03_Mechanics/CLI/items/balloon-pack-pota.md).) The figures tied to the posts are five air and water cultists. Each has 1 hit point remaining and wears a wooden placard that reads, "I am punished."

Haayon the [cloud giant](/03_Mechanics/CLI/bestiary/giant/cloud-giant-xmm.md), two [Feathergale knights](/03_Mechanics/CLI/bestiary/humanoid/feathergale-knight-pota.md) (see chapter 7), and six loyal [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) gather inside the pavilion. Behind the pavilion are two [hippogriffs](/03_Mechanics/CLI/bestiary/monstrosity/hippogriff-xmm.md) that serve the knights as mounts. The giant and his minions hear any fighting that breaks out in the outer part of the camp but don't join the fray until their turns during the fourth round.
...
Haayon's pavilion contains two large wooden chests filled with the valuables he has confiscated from those who failed his judgment. The chests holds 260 gp, a pouch with six citrines worth 60 gp each, and another pouch containing two [potions of flying](/03_Mechanics/CLI/items/potion-of-flying-xdmg.md).
...
- [Rhundorth](/03_Mechanics/CLI/bestiary/npc/rhundorth-pota.md) is in the Black Geode (area G15).  
...
> [!gallery]
> ![Map 5.1: Fane of the Eye](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/054-05-01.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/055-pam20_faneeye_dm-zf-0998-75774-1-011-0.webp#gallery)
...
The odd backpacks are five [balloon packs](/03_Mechanics/CLI/items/balloon-pack-pota.md) (see chapter 7) left here by the cultists.
...
After 80 feet, the pit tapers into a tunnel (area N1 of the Howling Caves, described later in this chapter). Chaotic gusts blow up and down the shaft, too weak to pose an actual hazard. Climbing the rough pit walls requires successful DC 10 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) checks.
...
Those suspended in the whirlwind are [restrained](/03_Mechanics/CLI/conditions.md#Restrained) and battered by windblown debris. At the start of each of its turns, a creature [restrained](/03_Mechanics/CLI/conditions.md#Restrained) by the whirlwind takes `d10` bludgeoning damage. A creature in the whirlwind can use its action to attempt a DC 20 Strength check. If successful, the creature ends the [restrained](/03_Mechanics/CLI/conditions.md#Restrained) condition on it, falls 20 feet to the floor, and escapes the whirlwind. A creature outside the whirlwind can attempt a similar check to pull another creature from the whirlwind, assuming it has the ability to reach a target 20 feet in the air. The whirlwind lasts 1 minute and then collapses, releasing creatures caught within it.

While the whirlwind rages, four [flying swords](/03_Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm.md) animate from the debris scattered around the cave. The flying swords attack creatures outside the whirlwind.
...
Three [harpies](/03_Mechanics/CLI/bestiary/monstrosity/harpy-xmm.md) nest on the highest ledges. These wicked creatures guard the cave for the Cult of the Howling Hatred. The bodies are those whom the harpies lured to destruction. When the harpies spot intruders, they begin to sing.

Those who are affected by the harpies' song are compelled to climb. The nests are 80 feet above the floor. The first 40 feet of the climb require a DC 10 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) checks, but after that, the DC is 15.
...
The harpies have collected loot in their nests, including 560 sp, 220 gp, a gold bracelet (50 gp), a silver ewer (10 gp), a pair of silver earrings shaped like skulls (each worth 10 gp), and a [potion of superior healing](/03_Mechanics/CLI/items/potion-of-superior-healing-xdmg.md).

### F5. Rust Monster Pit

> [!readaloud] 
> 
> A low, thin mist clings to the floor of this cave, and the walls glisten with moisture. Several sets of crude bronze manacles are anchored to the walls, and three hold haggard human captives. The captives are [unconscious](/03_Mechanics/CLI/conditions.md#Unconscious), although they groan and writhe slowly.
> 
...
A character searching the floor notices the pit with a successful DC 10 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check.

A character unaware of the pit falls into it. The pit is 10 feet deep and contains a [rust monster](/03_Mechanics/CLI/bestiary/monstrosity/rust-monster-xmm.md) that wandered into this cave after being driven out of area F9. The rust monster is heavily obscured by the mist and makes a surprise attack against a creature that falls into the pit, gaining advantage on its attack roll if its target is [prone](/03_Mechanics/CLI/conditions.md#Prone).
...
This cavern is the center of the Crushing Wave cult's presence in the fane. Two [water weirds](/03_Mechanics/CLI/bestiary/elemental/water-weird-xmm.md) lurk in the pool and guard the area for the cult. They attack anyone approaching the water who fails to give the water cult's hand sign. The pool is 20 feet deep. Swimming in the pool requires DC 10 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) checks due to the swirling currents. Any creature that fails such a check is swept into the stream.

The stream is 4 feet deep, cold, and swift. Any creature without a swimming speed that moves into the stream for the first time on a turn or starts its turn there must succeed on a DC 10 Strength saving throw or be swept 40 feet downstream. Swimming against the current requires a successful DC 10 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) check.
...
A [lizard king](/03_Mechanics/CLI/bestiary/elemental/lizardfolk-sovereign-xmm.md) named Drexa leads the Blackmaw tribe, a group of lizardfolk devoted to the Crushing Wave cult. A [lizardfolk shaman](/03_Mechanics/CLI/bestiary/elemental/lizardfolk-geomancer-xmm.md) named Sskesh advises Drexa, and eight [lizardfolk](/03_Mechanics/CLI/bestiary/humanoid/scout-xmm.md) warriors make their nests in this area.

Armed with morningstars, shields, and javelins, the Blackmaws are vile savages that torture, kill, and eat their enemies.

#### Roleplaying Drexa

Although the lizardfolk here are evil and bellicose, Drexa believes he should be one of the leaders of the Crushing Wave. He resents that such a position wasn't given to him. Those who look likely to overthrow [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md), or who have proof they have done so, might be able to convince Drexa to help them. Drexa has seen failed coups before, and he sides with the characters only if he's sure to wind up on top.
...
A creature swept over the falls lands in a water-filled basin (area P1 of the Plunging Torrents, described later in this chapter), taking no damage. At the start of its turn in the basin, the creature must succeed on a DC 15 Strength saving throw or be driven 10 feet underwater and [restrained](/03_Mechanics/CLI/conditions.md#Restrained) there. The creature can use its action to make a DC 15 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) check, ending the [restrained](/03_Mechanics/CLI/conditions.md#Restrained) condition on a success.

The stairs that hug the edge of the pit, though slippery, provide a much safer route down to area P1.

![](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/056-poa05-03.webp#center)
...
The influences of elemental earth and elemental water meet in this cavern, producing a muddy bog crowded with enormous fungi. Most of the fungi are harmless, and some are even edible. However, three [violet fungi](/03_Mechanics/CLI/bestiary/plant/violet-fungus-xmm.md) cluster where the footpaths intersect.

A [grell](/03_Mechanics/CLI/bestiary/aberration/grell-xmm.md) lurks in the upper reaches of the chamber, watching for lone travelers or stragglers it might be able to pick off. The creature quietly drifts down and attacks the rearmost member of a party that is otherwise occupied.

#### Shelf Path

Because dangerous fungi often lurk near the footpaths, denizens of the fane who pass through this chamber have found another way around. The shelf fungi adhering to the walls are surprisingly sturdy and offer a 3-foot-wide path that circles the eastern side of the chamber. Any character with a passive Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) score of 15 or higher spots the shelf path, and exploration reveals it automatically.
...
The crypt contains Hendrel's bones, interred here as a warning to Besilmer's enemies. His tomb is also the center of a [hallow](/03_Mechanics/CLI/spells/hallow-xphb.md) spell, which extends to the doors of the room. Any good-aligned humanoid who heeds the tomb's carving receives the effect of a 5th-level [aid](/03_Mechanics/CLI/spells/aid-xphb.md) spell. A creature can benefit from this effect only once per day.
...
The eastern passage descends to area G1 of the Black Geode (described later in this chapter). To protect their sanctum, earth cultists stationed two [hill giants](/03_Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) here. Each giant wears ring mail (AC 14).
...
The **minotaur **is [Zegdar](/03_Mechanics/CLI/bestiary/npc/zegdar-pota.md), chief of the Emberhorn tribe. He has 117 hit points, wears a chain mail hauberk (AC 16), has an Intelligence score of 11, speaks Undercommon, and is blessed by [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md). The blessing grants the minotaur immunity to fire damage as well as the following additional action option:
...
[Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) has directed Wyx, a simpering [nothic](/03_Mechanics/CLI/bestiary/aberration/nothic-xmm.md), to act as [Zegdar](/03_Mechanics/CLI/bestiary/npc/zegdar-pota.md)'s adviser. Wyx flatters [Zegdar](/03_Mechanics/CLI/bestiary/npc/zegdar-pota.md) so that he does his job and doesn't become a problem. The rest of the Emberhorns hate Wyx, but [Zegdar](/03_Mechanics/CLI/bestiary/npc/zegdar-pota.md) sees the nothic as proof of his importance.

#### Trophies

The Emberhorn minotaurs take trophies by hewing the hands from their smaller defeated foes. To dedicate the victory to [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md), the minotaurs roast the hands in coals.

#### Treasure

[Zegdar](/03_Mechanics/CLI/bestiary/npc/zegdar-pota.md)'s iron coffer contains 130 sp, 220 gp, and ten flawed hematite gemstones worth 5 gp each.
...
This room houses three Emberhorn [minotaurs](/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) waiting to receive the "blessing of [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md)" (the ability to breathe clouds of burning embers).
...
Any loud noise in here causes the minotaurs in area F17 to investigate. One goes to warn [Zegdar](/03_Mechanics/CLI/bestiary/npc/zegdar-pota.md) in area F14, and the other joins battle as soon as possible.
...
![](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/057-poa05-04.webp#center)

Two [minotaurs](/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) of the Emberhorn tribe stand guard in this chamber, defending the fire cult's foothold in the fane. They have the Burning Breath special action (see area F14), having received the "blessing of [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md)."

Long before dwarves established their stronghold in the caves above the fane, these caverns belonged to drow who were drawn here by the area's elemental energies. This chamber was a conjuring room where drow summoned demons using the circles etched in the floor. Any character who makes a successful DC 15 Intelligence ([Arcana](/03_Mechanics/CLI/skills.md#Arcana)) check recognizes the nature of the circles, and that they are ancient and damaged to the point of uselessness.

#### Reinforcements

Any loud noise in here causes the minotaurs in area F16 to investigate. One goes to warn [Zegdar](/03_Mechanics/CLI/bestiary/npc/zegdar-pota.md) in area F14, and the other two join battle as soon as possible.
...
A [glyph of warding](/03_Mechanics/CLI/spells/glyph-of-warding-xphb.md) protects the sarcophagus. A character can find the glyph with a successful DC 18 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check. Triggered by any attempt to open the coffin, the glyph casts [Mordenkainen's sword](/03_Mechanics/CLI/spells/mordenkainens-sword-xphb.md) (melee spell attack +10). The sword attacks any creature within 30 feet of the sarcophagus, starting with the triggering creature. It disappears after 1 minute.
...
Drow carved this chamber and raised this idol to honor Ghaunadaur, a dark god associated with oozes. A character must succeed on a DC 20 Intelligence ([Religion](/03_Mechanics/CLI/skills.md#Religion)) check to identify this obscure deity.

The "crystal" is worthless glass. Any creature that removes or destroys the stone must succeed on a DC 15 Wisdom saving throw or be subjected to Ghaunadaur's curse. The curse is like a [polymorph](/03_Mechanics/CLI/spells/polymorph-xphb.md) spell, except it turns the offender into an [ochre jelly](/03_Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) that lacks the Split reaction. A [greater restoration](/03_Mechanics/CLI/spells/greater-restoration-xphb.md) or [remove curse](/03_Mechanics/CLI/spells/remove-curse-xphb.md) spell ends this effect.
...
This chamber has been a battleground for the elemental cults as they seek to consolidate control of the fane. The Cult of the Howling Hatred presently holds the room, which is guarded by an [air elemental myrmidon](/03_Mechanics/CLI/bestiary/elemental/air-elemental-myrmidon-mpmm.md) (see chapter 7).
...
- [Aerisi Kalinoth](/03_Mechanics/CLI/bestiary/npc/aerisi-kalinoth-pota.md). The air prophet is accompanied by [Windharrow](/03_Mechanics/CLI/bestiary/npc/windharrow-pota.md) (if he escaped the Temple of Howling Hatred), two [hurricanes](/03_Mechanics/CLI/bestiary/humanoid/hurricane-pota.md), and three [Howling Hatred initiates](/03_Mechanics/CLI/bestiary/humanoid/howling-hatred-initiate-pota.md).  
- [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md). He is mounted on a [giant crocodile](/03_Mechanics/CLI/bestiary/beast/giant-crocodile-xmm.md) and accompanied by four [Crushing Wave reavers](/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md).  
- [Marlos Urnrayle](/03_Mechanics/CLI/bestiary/npc/marlos-urnrayle-pota.md). The earth prophet is accompanied by two [gargoyles](/03_Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) and two [Sacred Stone monks](/03_Mechanics/CLI/bestiary/humanoid/sacred-stone-monk-pota.md) wearing gargoyle masks.  
- [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md). The fire prophet has a [flameskull](/03_Mechanics/CLI/bestiary/undead/flameskull-xmm.md) and two [razerblasts](/03_Mechanics/CLI/bestiary/humanoid/razerblast-pota.md) under her command.  
...
These caves belonged to deep gnomes who had started to explore the Besilmer ruins when the air cult arrived. When the air cult seized the caves below Tyar-Besil, the svirfneblin organized resistance. Their attempt was futile. As soon as [Aerisi Kalinoth](/03_Mechanics/CLI/bestiary/npc/aerisi-kalinoth-pota.md) understood the power of the [devastation orbs](/03_Mechanics/CLI/items/devastation-orb-pota.md), she tested one on the svirfneblin. The resulting cyclone obliterated the outpost, and its chaotic after effects imbued the caves with elemental power which blows through the caves to this day.
...
> [!gallery]
> ![Map 5.2: Howling Caves](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/058-05-02.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/059-poa6.webp#gallery)
...
The shaft leads to area A18 in the Temple of Howling Hatred. An [air elemental](/03_Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md) is bound to this area and cycles beneath the shaft like a red cyclone. Everywhere it moves, it spatters the walls with blood, bone, and viscera.

The corpses are sacrifices to [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md), hurled down the shaft by air cultists. The symbol of elemental air is cut into each victim's forehead. The characters can find an intact head and see the symbol in gory relief.
...
The chasm is 50 feet deep, and the lower 40 feet of it is heavily obscured by fog. At the bottom of the chasm are blunt rocks and cave floor. The walls are rough and can be climbed with a successful DC 10 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) check.
...
Thunder momentarily fills the chasm. Each creature in the chasm must make a DC 15 Constitution saving throw. On a failure, it takes 10 (`3d6`) thunder damage and is [deafened](/03_Mechanics/CLI/conditions.md#Deafened) for 1 minute. On a success, the creature takes half damage and isn't [deafened](/03_Mechanics/CLI/conditions.md#Deafened).
...
This svirfneblin settlement was the test site for [Aerisi Kalinoth](/03_Mechanics/CLI/bestiary/npc/aerisi-kalinoth-pota.md)'s first [devastation orb](/03_Mechanics/CLI/items/devastation-orb-pota.md). Four [specters](/03_Mechanics/CLI/bestiary/undead/specter-xmm.md) of deep gnomes who perished here wander the ruins. The power of the air node imbued them with elemental energy, so their attacks deal lightning damage instead of necrotic. They attack any creature that enters the cavern.
...
The fissures magically pull the air from the cave and the lungs of any creature that comes within 30 feet of the back of the cave. Such a creature must succeed on a DC 15 Constitution saving throw or be unable to breathe. The creature can't breathe normally again unless it succeeds on the saving throw, made again at the end of each minute. A [remove curse](/03_Mechanics/CLI/spells/remove-curse-xphb.md) spell also ends the effect, as does [bottled breath](/03_Mechanics/CLI/items/bottled-breath-pota.md) (see chapter 7).

#### Treasure

The drow wears a suit of [elven chain](/03_Mechanics/CLI/items/elven-chain-xdmg.md) and carries a pair of fine daggers decorated with rubies (1,000 gp each), as well as a scroll of [primordial ward](/03_Mechanics/CLI/spells/primordial-ward-xge.md) (see appendix B). See area N7 for more information on this drow.
...
This gruesome display is the work of a [nycaloth](/03_Mechanics/CLI/bestiary/fiend/nycaloth-xmm.md) that takes sadistic delight in torturing captives. It guards the outer reaches of the Howling Caves against intruders.
...
The humans are two [Howling Hatred initiates](/03_Mechanics/CLI/bestiary/humanoid/howling-hatred-initiate-pota.md) (see chapter 7) who angered Aerisi one time too many. They're sullen and silent if interrogated. They flee for the surface at the first opportunity.

Feathergale knights captured the [aarakocra](/03_Mechanics/CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md), named Kazra and brought her here for interrogation. She wants only to fly under the open sky once again and pleads with the characters to escort her back to the surface.

The [drow mage](/03_Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md), Balix, is a historian and companion to the dead scout in area N5. They came to see the Fane of the Eye and to find out if surfacers were here, and they walked into a cult ambush. He wants nothing to do with the cults, the surface world, or anything other than returning to the nearest drow community. He uses his innate [darkness](/03_Mechanics/CLI/spells/darkness-xphb.md) spell to retreat as soon as possible.

#### Treasure

Among the debris is a spider silk pouch with 23 pp and a [necklace of prayer beads](/03_Mechanics/CLI/items/necklace-of-prayer-beads-xdmg.md). The necklace holds one *bead of blessing*, one *bead of curing*, one *bead of summons*, and one *bead of wind walking*.
...
Among the myriad fungi, several are magical and act as potions if eaten. One aqua-spotted toadstool acts as a [potion of longevity](/03_Mechanics/CLI/items/potion-of-longevity-xdmg.md). Two amber toadstools flecked with gray work as [potions of heroism](/03_Mechanics/CLI/items/potion-of-heroism-xdmg.md). Three pale lavender toadstools are like [potions of healing](/03_Mechanics/CLI/items/potion-of-healing-xdmg.md). These magical toadstools regrow over the course of the next year.

Eating any other toadstool forces the eater to make a DC 15 Constitution saving throw after `2d4` minutes. Failure indicates the consumer is [poisoned](/03_Mechanics/CLI/conditions.md#Poisoned). A creature [poisoned](/03_Mechanics/CLI/conditions.md#Poisoned) in this way can repeat the saving throw at the end of each hour, ending the effect on a success.
...
The natural column rises 20 feet and is slick with water and fungus, so it requires successful DC 15 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) checks to climb unaided. The casket is covered with a patch of yellow mold (see chapter 5, "[Adventure Environments](/03_Mechanics/CLI/traps-hazards/yellow-mold-xdmg.md)," in the *Dungeon Master's Guide*).
...
Godwyd's shortsword is a [dragon slayer](/03_Mechanics/CLI/items/dragon-slayer-xdmg.md). Removing the blade causes a low moan to rise from the casket, but nothing else happens.
...
The chasm is 100 feet deep. The strong wind makes walking on the narrow ledges treacherous. Any creature doing so must succeed on a DC 10 Dexterity ([Acrobatics](/03_Mechanics/CLI/skills.md#Acrobatics)) check. A creature that fails this check falls from the ledge into the chasm. Normally, the chasm would be easy to climb, but the wind makes it so the climb requires successful DC 10 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) checks. A creature that fails such a check falls from the chasm wall.
...
A [Howling Hatred priest](/03_Mechanics/CLI/bestiary/humanoid/howling-hatred-priest-pota.md) and eight [Howling Hatred initiates](/03_Mechanics/CLI/bestiary/humanoid/howling-hatred-initiate-pota.md) (see chapter 7 for both) are here, but they are too swept up in their "windhugging" to fret about intruders. They attack only if the characters disturb them. This wind here is loud enough that sounds of combat in this cave can't be heard elsewhere.
...
As the characters explore this area, a [black pudding](/03_Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) pours out of a narrow crack in the wall behind them, cutting off their escape. It fights until slain.
...
Prisoners are kept here until they can be sacrificed to [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md) in area N19. Two [invisible](/03_Mechanics/CLI/conditions.md#Invisible) [barlguras](/03_Mechanics/CLI/bestiary/fiend/barlgura-xmm.md) guard the prisoners. The demons lurk among the columns in the upper reaches of the cave, dropping down to attack intruders who dare free the prisoners. If they spot the characters, the two women warn characters of the "[invisible](/03_Mechanics/CLI/conditions.md#Invisible) demons" that guard them.

#### Light

Two braziers light this area with [continual flame](/03_Mechanics/CLI/spells/continual-flame-xphb.md) spells.

#### Prisoners

Two humans are kept here, the symbol of air cut into each one's forehead. One is Nerise Gladham, a farmer (an unarmed [commoner](/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) with 2 hit points remaining). The other is Deseyna Norvael, a high-ranking Waterdhavian diplomat (an unarmed [noble](/03_Mechanics/CLI/bestiary/humanoid/noble-xmm.md) with 4 hit points remaining) who was part of the Mirabar delegation. Both prisoners want only to escape this area and return to civilization.
...
The characters spot the green light ([continual flame](/03_Mechanics/CLI/spells/continual-flame-xphb.md)) from the brazier here before arriving.
...
Four emaciated [Howling Hatred priests](/03_Mechanics/CLI/bestiary/humanoid/howling-hatred-priest-pota.md) (see chapter 7)—Aerisi's most devout cultists—guard this area. Periods of sustaining themselves upon only air have warped their bodies. Their eyes bulge from cavernous sockets, and skin stretches across jutting bone. Because of their devotion, they are immune to the wind's effects.
...
![](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/060-poa05-06.webp#center)

If the characters defeated Aerisi, two [air elemental myrmidons](/03_Mechanics/CLI/bestiary/elemental/air-elemental-myrmidon-mpmm.md) (see chapter 7) defend this cave.

If Aerisi is here but isn't the only prophet still alive, use the "Encounter with Aerisi" section. Use the "Encounter with [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md)" section if Aerisi is the only remaining prophet. In either encounter, the air elemental myrmidons aren't present.

#### Encounter with Aerisi

[Aerisi Kalinoth](/03_Mechanics/CLI/bestiary/npc/aerisi-kalinoth-pota.md) (see chapter 7) stands next to the air portal, protected by an [air elemental myrmidon](/03_Mechanics/CLI/bestiary/elemental/air-elemental-myrmidon-mpmm.md). While attempting to call [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md) into the world, she tries to stay out of the characters' reach while casting her destructive spells. The myrmidons focus on thwarting and killing ranged attackers and spellcasters.

Aerisi refuses to flee at this point, and trying to do so through the air portal with [Windvane](/03_Mechanics/CLI/items/windvane-pota.md) would be disastrous. When the characters defeat her, she vanishes in a scream of wind, but [Windvane](/03_Mechanics/CLI/items/windvane-pota.md) remains, as does the portal.

#### Encounter with Yan-C-Bin

When the characters arrive, [Aerisi Kalinoth](/03_Mechanics/CLI/bestiary/npc/aerisi-kalinoth-pota.md) is alone. She holds [Windvane](/03_Mechanics/CLI/items/windvane-pota.md) aloft and cries, "With this key, I call forth my lord and master!" The moon elf then bows as [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md) (see chapter 7) flies through the portal. The Prince of Evil Air appears as a gaunt, dark-gray man with white hair and glowing eyes. In this form [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md) smiles, and his eyes flash with lightning. As Aerisi gloats, [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md) focuses on destroying the characters.

#### The Air Portal

The thundercloud surrounds a silvery window, which is a portal to the Plane of Air that leads directly to the steps of [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md)'s [invisible](/03_Mechanics/CLI/conditions.md#Invisible) castle. This portal is 30 feet from the floor.

Those who pass through the portal arrive on the steps of [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md)'s [invisible](/03_Mechanics/CLI/conditions.md#Invisible) fortress, where [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md) comes forth to destroy them. Although [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md) can enter the world only when the proper ritual is complete, the characters can easily flee through the portal.

Characters can close the portal only by hurling [Windvane](/03_Mechanics/CLI/items/windvane-pota.md) into it, destroying the weapon in the process. If the portal closes while [Yan-C-Bin](/03_Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md) remains in the world, he is forced back to the Elemental Plane of Air.

#### Treasure

Aerisi has decked herself in royal finery. She wears a platinum torc (worth 1,600 gp), gold and sapphire rings (four, each worth 1,000 gp), and a diadem (6,400 gp) from Evereska. She carries [Windvane](/03_Mechanics/CLI/items/windvane-pota.md) (see chapter 7).
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1 | 1 [giant octopus](/03_Mechanics/CLI/bestiary/beast/giant-octopus-xmm.md) (see area P11) |
| 2–3 | `d4` [ice mephits](/03_Mechanics/CLI/bestiary/elemental/ice-mephit-xmm.md) (see area P14) |
| 4 | 1 [water weird](/03_Mechanics/CLI/bestiary/elemental/water-weird-xmm.md) (see area P16) |
| 5 | 1 [Dark Tide knight](/03_Mechanics/CLI/bestiary/humanoid/dark-tide-knight-pota.md) mounted on a [water weird](/03_Mechanics/CLI/bestiary/elemental/water-weird-xmm.md) (see area P16) |
| 6 | `d4` [swarms of quippers](/03_Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md) |
| 7–20 | None |
^encounter
...
> [!gallery]
> ![Map 5.3: The Plunging Torrents](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/061-05-03.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/062-poa8.webp#gallery)
...
A character who has a passive Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) score of 10 or higher notices the water symbol engraved above the northeast passageway.
...
The 7-foot globe of water floats 1 foot above water level and is stationary until a creature touches it, whereupon it envelops the creature and carries it to area P20 via the northeast tunnel (passing though areas P12, P14, and P16). The globe has a flying speed of 10 feet, and a creature contained within gains the benefit of a [water breathing](/03_Mechanics/CLI/spells/water-breathing-xphb.md) spell for as long as it remains in the globe. Any time during the trip, the creature inside the globe can swim out of it as an action. The globe carries only the one creature and bursts upon reaching its destination. A globe is immune to damage, though [dust of dryness](/03_Mechanics/CLI/items/dust-of-dryness-xdmg.md) destroys it.
...
Seven [giant crabs](/03_Mechanics/CLI/bestiary/beast/giant-crab-xmm.md) dwell in this cavern. Three are in plain sight on the rocky ledge to the northwest. Two crabs cling underwater to each span of net. Characters observing the water must roll a successful DC 14 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check to spot the submerged crabs, which climb their nets to attack any creatures that pass within reach. Once combat starts, all the crabs attack.
...
Four [kuo-toa](/03_Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) worship at the altar, while a [kuo-toa monitor](/03_Mechanics/CLI/bestiary/aberration/kuo-toa-monitor-xmm.md) guards the northeast doors. The kuo-toa try to capture victims for their aboleth god (see area P6).
...
This is where the aboleth in area P6 comes to feed on sacrifices. A [kuo-toa archpriest](/03_Mechanics/CLI/bestiary/aberration/kuo-toa-archpriest-xmm.md) armed with a [trident of fish command](/03_Mechanics/CLI/items/trident-of-fish-command-xdmg.md) and two [kuo-toa](/03_Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) attend their god here. They attempt to capture the characters and chain them to the altar. The rough-hewn landing on which the altar sits is 20 feet above water level.
...
An [aboleth](/03_Mechanics/CLI/bestiary/aberration/aboleth-xmm.md) named Yngukulub the Devourer has allied itself with [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) and the Cult of the Crushing Wave. Deranged kuo-toa bring the aboleth sacrifices, and when they lack a proper sacrifice, they willingly feed themselves to their hungry god.

Yngukulub obeys [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) because it awaits the day when [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md) drowns the civilized world and crushes the temples of the gods. In the dark age that results from the triumph of [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md), aboleths can return to their proper place as rulers of the world.

If [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) was defeated in the Temple of the Crushing Wave, the aboleth guards the water portal in area P20. Otherwise, it is here.
...
Lying on the floor of the aboleth's cave are 180 pp, 1,700 ep, and a [tentacle rod](/03_Mechanics/CLI/items/tentacle-rod-xdmg.md).
...
Four [kuo-toa](/03_Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) and a [kuo-toa whip](/03_Mechanics/CLI/bestiary/aberration/kuo-toa-whip-xmm.md) have filled the pit with a [swarm of quippers](/03_Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md). They ritually feed creatures to the quippers at times when they and the aboleth are sated. Their ritual is nonsense: gasping, muttering, and croaking with no basis in any known language. The kuo-toa attempt to push characters to the pit.
...
A [roper](/03_Mechanics/CLI/bestiary/aberration/roper-xmm.md) and four [piercers](/03_Mechanics/CLI/bestiary/aberration/piercer-xmm.md) cling to the cavern ceiling among the stalactites. A character who pays close attention to the stalactites and succeeds on a DC 20 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check spots the symbol of water etched into the creatures' tough flesh.

The roper attacks first. As it snares prey with its tendrils, it pulls its prey under the nearby piercers, which then drop from the ceiling. The piercers have advantage on attack rolls made against creatures [grappled](/03_Mechanics/CLI/conditions.md#Grappled) by the roper.
...
The water is only 5 feet deep in this cavern. The walls of the plateaus are wet but rough, and can be climbed with successful DC 10 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) checks.

Two [Crushing Wave reavers](/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md) (see chapter 7) keep watch atop the plateaus. Each has five javelins. They are slaves of the aboleth, and slime covers their translucent flesh. They aren't afraid to die.

Unless they are drawn to area P20 to protect the aboleth, two [chuuls](/03_Mechanics/CLI/bestiary/aberration/chuul-xmm.md) lurk behind the plateaus. They step out of hiding and attack interlopers as soon as the Crushing Wave reavers start hurling javelins. If a chuul paralyzes a foe, it allows the current to take the helpless creature over the falls and into area P20.
...
Eight [Crushing Wave reavers](/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md) (see chapter 7) occupy the cage with the drowned corpses of four other cultists.

[Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) locked weak and disobedient cultists inside the cage in a ritual meant to strengthen them. The cultists attack if the characters free them, using bare hands until they can seize weapons. They surrender if reduced to half their number.
...
This cave is the lair of a [giant octopus](/03_Mechanics/CLI/bestiary/beast/giant-octopus-xmm.md). It spends most of its time hunting, so it has only a ten percent chance each hour to be in its lair.

Submerged tunnels connect this cave to areas P12 and P18. Characters swimming underwater spot them automatically.

#### Secret Passage

A one-way secret door blocks access to a submerged tunnel that ends at another similar door. A successful DC 15 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check is sufficient to find either door, but they open only from the other side.
...
[Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) uses this cave to dispose of those who oppose or displease him.
...
The corpse belongs to a Crushing Wave initiate who got too close to the underwater gate while inspecting its manacles and was [paralyzed](/03_Mechanics/CLI/conditions.md#Paralyzed) and clawed to death by the ghast in area P13. A search of the corpse reveals a ring with two keys—one that unlocks the gate, and another that unlocks the gate's manacles.
...
Seven [ghouls](/03_Mechanics/CLI/bestiary/undead/ghoul-xmm.md) and a [ghast](/03_Mechanics/CLI/bestiary/undead/ghast-xmm.md) gnaw on the bones in this cave. When a creature enters their lair, the ghouls dive in to devour it and escape confinement.
...
A [one-eyed shiver](/03_Mechanics/CLI/bestiary/humanoid/one-eyed-shiver-pota.md) (see chapter 7) and seven [ice mephits](/03_Mechanics/CLI/bestiary/elemental/ice-mephit-xmm.md) inhabit this cave. The one-eyed shiver, called the Eye of Anguish by the other cultists, oversees the torture of prisoners. The ice mephits assist him.
...
Two [water weirds](/03_Mechanics/CLI/bestiary/elemental/water-weird-xmm.md) hidden beneath the water's surface serve as bonded mounts for two [Dark Tide knights](/03_Mechanics/CLI/bestiary/humanoid/dark-tide-knight-pota.md) (see chapter 7) who live in the hut on the island. One knight is standing guard on the island when the characters first arrive; the other one is resting inside the hut.
...
The ceiling is 30 feet above the eater's surface. A [water elemental myrmidon](/03_Mechanics/CLI/bestiary/elemental/water-elemental-myrmidon-mpmm.md) (see chapter 7) lurks under the water but rises to attack trespassers not dressed as water cultists.
...
A [hydra](/03_Mechanics/CLI/bestiary/monstrosity/hydra-xmm.md) nests among the wrecks, and it attacks any intruder that isn't [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md).

#### Wrecked Ships

[Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md) channeled the power of the water node to deliver these vessels to [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) as a demonstration of her power. One of the wrecks is the Tethyrian merchant galley that once conscripted a young [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) into brutal indenture. The other is the same Calishite pirate vessel that attacked the Tethyrian merchant galley, an event that caused Gar to be cast adrift and lose his arm to a shark.

The wrecks form solid ground, but in most places they are difficult terrain, slick with rain where they aren't full of holes and splintered wood. Any character who attempts a complex maneuver, or takes the Dash or [Disengage](/03_Mechanics/CLI/actions.md#Disengage) action, must succeed on a DC 10 Dexterity ([Acrobatics](/03_Mechanics/CLI/skills.md#Acrobatics)) check or fall from the wreckage.
...
The Calishite pirate ship carries a chest laden with treasure. Characters searching the wreck find the chest, which contains a [+1 scimitar](/03_Mechanics/CLI/items/1-weapon-xdmg.md), an [alchemy jug](/03_Mechanics/CLI/items/alchemy-jug-xdmg.md), 1,200 gp, a diamond worth 5,000 gp, and two small rubies worth 1,000 gp each.

The hold of the Tethyrian merchant vessel is gutted, its supplies long gone. One of the skeletons aboard wears a suit of fine scale mail decorated with shell motifs. This scale mail is [mariner's armor](/03_Mechanics/CLI/items/mariners-armor-xdmg.md).
...
![](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/063-poa05-08.webp#center)
...
If the characters previously defeated [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md), use the "Encounter with the Aboleth" section. If Gar has retreated to the node and the characters have defeated two other elemental prophets, use the "Encounter with [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md)" section. If Gar is the sole remaining prophet, use the "Encounter with [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md)" section.
...
The [aboleth](/03_Mechanics/CLI/bestiary/aberration/aboleth-xmm.md) from area P6 and the two [chuuls](/03_Mechanics/CLI/bestiary/aberration/chuul-xmm.md) from area P9 guard the portal. The creatures are submerged in the southwest corner of the cave when the characters first arrive. The aboleth hopes to kill or enslave the characters, seize [Drown](/03_Mechanics/CLI/items/drown-pota.md), and replace [Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) as [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md)'s prophet.

#### Encounter with Gar Shatterkeel

[Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) (see chapter 7) stands on the island before the water portal, beginning his ritual to call forth [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md). He is guarded by a [water elemental](/03_Mechanics/CLI/bestiary/elemental/water-elemental-xmm.md) and three [crocodiles](/03_Mechanics/CLI/bestiary/beast/crocodile-xmm.md) that circle the island, attacking any creatures that approach.

Gar makes a final stand here. He can't retreat to the Plane of Water with [Drown](/03_Mechanics/CLI/items/drown-pota.md), and he refuses to abandon his grim mission. When the characters defeat him, he turns to inky water and courses away. [Drown](/03_Mechanics/CLI/items/drown-pota.md) remains where he fell.

#### Encounter with Olhydra

[Gar Shatterkeel](/03_Mechanics/CLI/bestiary/npc/gar-shatterkeel-pota.md) stands on the island, unguarded. He holds his trident aloft and cries, "With this key I call forth my mistress!" A dark flow emerges from the portal, forming an immense water elemental with pearly, malignant eyes. This is [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md), Princess of Evil Water (see chapter 7). [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md) focuses on remaining in the world to work evil, especially keeping [Drown](/03_Mechanics/CLI/items/drown-pota.md) away from the characters.

##### Rising Water

When [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md) appears, the water in the lake rises 2 feet at the end of each round. Since the waterfalls in the cavern are 40 feet high, the lake rises to the level of areas P9, P16, and P18 after 20 rounds. Once the water reaches the tops of the waterfalls, the water stops at 60 feet deep.

#### The Water Portal

The water portal is a 13-foot-diameter globe of water that floats above the island.

Characters who pass through the portal arrive underwater on the Elemental Plane of Water, where [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md) comes forth to destroy them. Characters can retreat through the portal; however, [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md) can't pass through the portal until the ritual is complete.

Characters can close the portal only by hurling [Drown](/03_Mechanics/CLI/items/drown-pota.md) into it, destroying [Drown](/03_Mechanics/CLI/items/drown-pota.md) in the process. If the portal closes while [Olhydra](/03_Mechanics/CLI/bestiary/npc/olhydra-pota.md) remains in the world, she is forced back to the Plane of Water. No more watery globes form within the Plunging Torrents, and the water in the node returns to normal levels. Over the course of the next few days, much of the remaining water siphons out into the surrounding earth.

## The Black Geode

The Black Geode is a natural cavern distinguished by the seams of luminous violet crystal. [Marlos Urnrayle](/03_Mechanics/CLI/bestiary/npc/marlos-urnrayle-pota.md) used [Ironfang](/03_Mechanics/CLI/items/ironfang-pota.md) to transform these caverns into an earth node. In the Black Geode's largest cavern lies a portal that leads to [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md)'s domain on the Elemental Plane of Earth. Bizarre creatures from that place have crossed through the gate and now inhabit the caverns, while the raw energy of the elemental plane seeps out and is slowly transforming the Black Geode into a reflection of [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md)'s domain.
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1 | 1 [burrowshark](/03_Mechanics/CLI/bestiary/humanoid/burrowshark-pota.md) riding a [bulette](/03_Mechanics/CLI/bestiary/monstrosity/bulette-xmm.md) (see area G13) |
| 2 | 1 [stonemelder](/03_Mechanics/CLI/bestiary/humanoid/stonemelder-pota.md) and `1d3 + 1` [Black Earth guards](/03_Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota.md) (see area G12) |
| 3 | `d2` [earth elementals](/03_Mechanics/CLI/bestiary/elemental/earth-elemental-xmm.md) |
| 4 | 1 [umber hulk](/03_Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm.md) (bursts out of a nearby wall) |
| 5 | Bleeding earth |
| 6 | Ceiling collapse |
| 7 | Crystal extrusion |
| 8 | Fissure |
...
A tremor causes part of the ceiling to collapse above one random party member. If the party includes NPCs, be sure to count them as well. The target must succeed on a DC 15 Dexterity saving throw or take 21 (`6d6`) bludgeoning damage and be knocked [prone](/03_Mechanics/CLI/conditions.md#Prone) and buried. While buried in this way, the target is [restrained](/03_Mechanics/CLI/conditions.md#Restrained) and unable to breathe or stand up. A creature can take an action to extricate itself or another buried creature, doing so with a successful DC 15 Strength check.
...
> [!gallery]
> ![Map 5.4: The Black Geode](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/064-05-04.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/065-poa4.webp#gallery)
...
Two [Black Earth guards](/03_Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota.md) (see chapter 7) stand in front of the statues. Characters not wearing disguises are recognized for who they really are. Characters disguised as earth cultists or cult prisoners must make a Charisma ([Deception](/03_Mechanics/CLI/skills.md#Deception)) check contested by the guards' Wisdom ([Insight](/03_Mechanics/CLI/skills.md#Insight)) checks; if all the characters succeed, the guards are fooled and allow them to pass.

If combat erupts here, two [earth elementals](/03_Mechanics/CLI/bestiary/elemental/earth-elemental-xmm.md) burst up from the middle of the floor and join the battle. These elementals have veins of glowing purple crystal; each sheds bright light in a 15-foot radius and dim light for another 15 feet beyond that.
...
A [stonemelder](/03_Mechanics/CLI/bestiary/humanoid/stonemelder-pota.md) (see chapter 7) named Keltar keeps vigil with a [xorn](/03_Mechanics/CLI/bestiary/elemental/xorn-xmm.md) he discovered hiding in area G17. If the characters attack either, both retaliate in kind. The xorn flees once it has fewer than 20 hit points, but Keltar fights to the death.

#### Roleplaying Keltar

Keltar believes the xorn, called Gorx, is an emissary from [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md) sent to test the cult's worth. In fact, the creature wandered through the earth portal out of curiosity. Since Keltar was eager to please Gorx, it has done nothing to dissuade him.

The xorn has convinced Keltar that [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md) wants tribute, and so Keltar extracts offerings from everyone who passes through. Keltar is so obsessed with offerings that he ignores the appearance of passersby and the usual pass phrase. When he notices the characters, he asks, "Do you bring an offering?"

Making an offering involves throwing precious metals or gems into the xorn's maw. Keltar soberly informs contributors the treasure is transported to [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md)'s domain.

The xorn can smell the party's wealth, and so it demands a tribute of 500 gp in Terran. If the party complies, Keltar asks, "Is our prince satisfied with the offering?" to which Gorx replies, "The prince finds this sacrifice pleasing." Keltar believes the xorn has deemed the party worthy, so he allows them to pass. He also helpfully responds to inquiries. If the characters are undisguised, he directs them toward area G3, as another test of their worthiness. Keltar directs the characters toward area G6 if he believes them to be cultists and also reminds them of the pass phrase to cross the stone bridge (area G9) safely: "We walk in the shadow of [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md)!"
...
The xorn's stomach still contains some undigested offerings: 9 gp, three egg-sized chunks of rough moonstone worth 25 gp each, three carnelians worth 50 gp each, and a cracked amethyst worth 100 gp. Keltar carries two more carnelians and hides a folded scroll of [investiture of stone](/03_Mechanics/CLI/spells/investiture-of-stone-xge.md) (see appendix B) in a pocket.
...
A [roper](/03_Mechanics/CLI/bestiary/aberration/roper-xmm.md) hangs from the ceiling above the debris. It ate several cultists before the others started avoiding the area. Eager for more humanoid flesh, the roper attempts to subdue as many of the adventurers as it can. It closes its eye and retracts it tendrils when reduced to 20 hit points, hoping the characters leave it alone.

#### Treasure

Scattered amid the broken weapons and armor are 65 gp, a brass statuette of an imp with onyx eyes worth 180 gp, and a [ring of swimming](/03_Mechanics/CLI/items/ring-of-swimming-xdmg.md).
...
Any creature entering the cave for the first time on a turn or starting its turn inside must succeed on a DC 10 Wisdom saving throw or suffer the effects of a [confusion](/03_Mechanics/CLI/spells/confusion-xphb.md) spell. Once a creature succeeds on its saving throw, it is immune to this effect for 24 hours.
...
The "secret" entrance to area G5 is a tunnel cloaked by a 6th-level [major image](/03_Mechanics/CLI/spells/major-image-xphb.md) spell to look like a solid stone wall. Discovering its nature from a distance requires a DC 19 Intelligence ([Investigation](/03_Mechanics/CLI/skills.md#Investigation)) check, although direct interaction immediately reveals the illusion.
...
Earth cultists call this river of elemental mud the Mudflow. The river is 6 feet wide, 3 feet deep, and descends a total of 40 feet by the time it reaches area G11. Any creature that enters the river for the first time on a turn or ends its turn there must make a DC 10 Strength saving throw or fall [prone](/03_Mechanics/CLI/conditions.md#Prone) and be swept 20 feet toward area G11. A creature that is [prone](/03_Mechanics/CLI/conditions.md#Prone) in the mud must use an action and succeed on a DC 15 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) check to stand up. Standing isn't possible within the section of tunnel between this cave and area G11; that stretch of the river is completely submerged in mud.

A creature can use an action to pull itself or another creature within its reach out of the Mudflow, doing so on a successful DC 15 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) check.
...
The western portion of the cave is 10 feet higher than the eastern portion, and the ledge can be scaled with a successful DC 10 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) check. The stone staircase leading up to the ledge is on the north side of the Mudflow.
...
The crowned helmet is an ancient dwarven relic (see "Treasure" below) that radiates strong magic when scrutinized with a [detect magic](/03_Mechanics/CLI/spells/detect-magic-xphb.md) spell. As soon as someone tries to take it, the [ghost](/03_Mechanics/CLI/bestiary/undead/ghost-xmm.md) of a duergar treasure hunter named Reulek appears and uses his Horrifying Visage, screaming, "Thieves! Learn from my folly! Even in death, the dwarves of Besilmer guard their fabled treasure!" As the ghost intones these words, four [specters](/03_Mechanics/CLI/bestiary/undead/specter-xmm.md) of dead drow killed here long ago in a cave collapse materialize and attack the living.
...
The golden-spiked helm is the [Lost Crown of Besilmer](/03_Mechanics/CLI/items/lost-crown-of-besilmer-pota.md) (see chapter 7).
...
Two [galeb duhrs](/03_Mechanics/CLI/bestiary/elemental/galeb-duhr-xmm.md) guard the bridge—one at each end. They look like ordinary boulders until they open their eyes and move. To cross the bridge without rousing the galeb duhrs, someone among the passersby must speak the cult's pass phrase: "We walk in the shadow of [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md)!" Otherwise, the galeb duhrs wait until intruders are halfway across the bridge before attacking, first by animating the boulders set near them and commanding them to roll across the bridge.
...
Eight [hook horrors](/03_Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) hide in crevices along the walls, communicating with one another using a series of indecipherable clicks and clacks. The hook horrors attack any creature that tries to cross their territory or falls from the bridge.

#### Secret Way

Hidden at the back of one hook horror's crevice is a narrow passage leading 20 feet up to area G7. The opening to this tunnel requires a successful DC 15 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check to spot, although a character who explores the crevice by entering it finds the hidden tunnel without an ability check.
...
An [earth elemental myrmidon](/03_Mechanics/CLI/bestiary/elemental/earth-elemental-myrmidon-mpmm.md) (see chapter 7) stands guard, ignoring the taunts of six [mud mephits](/03_Mechanics/CLI/bestiary/elemental/mud-mephit-xmm.md). The myrmidon is protective of the pool and attacks intruders. The mephits join in, but unlike the myrmidon, each one reduced to fewer than 10 hit points flees.

See area G6 for rules about moving through the river of mud. A creature that ends its turn in the swirling pool must succeed on a DC 15 Strength saving throw or be sucked down into the Elemental Plane of Earth and lost. A creature tethered by a rope can be pulled 10 feet toward the edge of the pool with a successful DC 15 Strength ([Athletics](/03_Mechanics/CLI/skills.md#Athletics)) check.

#### Development

If the characters observe the cave unnoticed for a few minutes, they see the myrmidon lean over the pool and pluck a fledgling [mud mephit](/03_Mechanics/CLI/bestiary/elemental/mud-mephit-xmm.md) from the muck. The pool has a noncumulative five percent chance of spawning a new mud mephit each hour.
...
At any given time, the cave contains two [Black Earth guards](/03_Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota.md), one [burrowshark](/03_Mechanics/CLI/bestiary/humanoid/burrowshark-pota.md), and one [stonemelder](/03_Mechanics/CLI/bestiary/humanoid/stonemelder-pota.md) (see chapter 7 for these cultists' statistics). The guards are in the southern part of the cave, the others in the northern section. If [Hellenrae](/03_Mechanics/CLI/bestiary/npc/hellenrae-pota.md) (see chapter 7) has not been defeated, she is here in place of the stonemelder. The cultists are meditating, using the crystals as foci. They are too entranced to hear sounds of combat in areas G9 or G13.
...
There is a fifty percent chance that a [burrowshark](/03_Mechanics/CLI/bestiary/humanoid/burrowshark-pota.md) (see chapter 7) named Rorgrin is here, along with his trained [bulette](/03_Mechanics/CLI/bestiary/monstrosity/bulette-xmm.md) mount; otherwise they're in area G14. If they are here, Rorgrin and his mount are in plain view and attack intruders on sight.

The enclosures to the north and south are kennels enclosed by 10-foot-high walls. The south kennels are empty. The northern kennels contain three young bulettes (use [rhinoceros](/03_Mechanics/CLI/bestiary/beast/rhinoceros-xmm.md) statistics, but they bite instead of gore). These bulettes are sleeping if Rorgrin isn't present. A character can sneak past the sleeping bulettes by succeeding on a DC 11 Dexterity ([Stealth](/03_Mechanics/CLI/skills.md#Stealth)) check. The bulettes awaken on a failed check or if one or more of them is attacked. If Rorgrin is in area G14, the roused bulettes hiss at strangers, alerting Rorgrin to their presence.
...
If the party didn't encounter Rorgrin in area G13, they find the [burrowshark](/03_Mechanics/CLI/bestiary/humanoid/burrowshark-pota.md) here with his trained [bulette](/03_Mechanics/CLI/bestiary/monstrosity/bulette-xmm.md) mount. Half the time, the pair is asleep.

#### Treasure

Stashed under his leather saddle "pillow," Rorgrin keeps a small leather bag containing 91 gp, two garnets (worth 100 gp each), and a [potion of thunder resistance](/03_Mechanics/CLI/items/potion-of-thunder-resistance-xdmg.md).
...
Two [stonemelders](/03_Mechanics/CLI/bestiary/humanoid/stonemelder-pota.md) (see chapter 7) work here, along with a dwarf master smith [Rhundorth](/03_Mechanics/CLI/bestiary/npc/rhundorth-pota.md)—one of the delegates from Mirabar (see below). If [Miraj Vizann](/03_Mechanics/CLI/bestiary/npc/miraj-vizann-pota.md) (see chapter 7) survives, he is here in place of one stonemelder. Three [nothics](/03_Mechanics/CLI/bestiary/aberration/nothic-xmm.md) watch from the shadows, ready to provide arcane insight during the forging process. The nothics are unwilling servants and flee toward area G16 if given the opportunity.

[Rhundorth](/03_Mechanics/CLI/bestiary/npc/rhundorth-pota.md) has the statistics of a [guard](/03_Mechanics/CLI/bestiary/humanoid/guard-xmm.md) but is unarmed and unarmored (AC 11). His Strength is 18, and he speaks Common and Dwarvish. If given a choice of weapons, he prefers a warhammer (+6 to hit, `1d8 + 4` bludgeoning damage, or `1d10 + 4` bludgeoning damage while using two hands). He is lawful good.

#### Roleplaying Rhundorth

[Rhundorth](/03_Mechanics/CLI/bestiary/npc/rhundorth-pota.md) was conscripted to toil here, helping the earth cult craft armor and weapons in exchange for a promise that other delegates in the earth cult's custody wouldn't be harmed. He knows the sage Bruldenthar was left in the mines of the Sacred Stone Monastery, and Lady Deseyna was captured by air cult raiders. He also reports that the moon elf Teresiel was handed over to the fire cult a couple of tendays ago.
...
Characters searching the worktables find several crystal staffs, stone morningstars, and pieces of rock armor, as well as a [+1 breastplate](/03_Mechanics/CLI/items/1-armor-xdmg.md) crafted from polished crystal. It bears the symbol of earth, and it heightens its wearer's urges to act in a selfish, greedy, or wicked way.
...
![](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/066-poa05-10.webp#center)

If [Marlos Urnrayle](/03_Mechanics/CLI/bestiary/npc/marlos-urnrayle-pota.md) has been defeated elsewhere, this cavern is guarded by two [earth elemental myrmidons](/03_Mechanics/CLI/bestiary/elemental/earth-elemental-myrmidon-mpmm.md) (see chapter 7) that stand before the monolith in plain view. If Marlos has retreated to this cavern and the characters have defeated two other prophets, use the "Encounter with Marlos Urnrayle" section. Use the "Encounter with Ogrémoch" section if Marlos is the last remaining prophet.

#### Encounter with Marlos Urnrayle

[Marlos Urnrayle](/03_Mechanics/CLI/bestiary/npc/marlos-urnrayle-pota.md) (see chapter 7) stands before the earth portal, attempting to summon [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md). The characters find him with his back turned and the hood of his rich cloak pulled up, so he looks like a finely dressed cult priest. Two [Black Earth guards](/03_Mechanics/CLI/bestiary/humanoid/black-earth-guard-pota.md) (see chapter 7) attend him, and four [gargoyles](/03_Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) cling to the four nearest columns. Marlos continues incantations until he becomes aware of the characters. Then, he pulls back his hood and attacks.
...
The prophet stands his ground here. He can't flee through the earth portal with [Ironfang](/03_Mechanics/CLI/items/ironfang-pota.md), and his pride doesn't allow him to relinquish his power in the node. When the characters defeat him, he turns to mud and melts away. [Ironfang](/03_Mechanics/CLI/items/ironfang-pota.md) and the portal remain.

#### Encounter with Ogrémoch

[Marlos Urnrayle](/03_Mechanics/CLI/bestiary/npc/marlos-urnrayle-pota.md) appears much as he does in the previous section. When the characters arrive, he holds [Ironfang](/03_Mechanics/CLI/items/ironfang-pota.md) aloft and intones, "With this key, I call forth the Mountain of Doom, the great and terrible [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md)!" He steps back as the earth portal liquifies and the colossal form of [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md) emerges (see chapter 7). [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md) focuses on destroying the characters with little concern for the consequences to Marlos. The elemental prince's aim is to remain in the world and consolidate power here before sowing chaos.

#### The Earth Portal

The monolith is a portal leading to the Elemental Plane of Earth. Part of the monolith is in a liquid state at any given time, and any creature that touches the liquid stone is pulled into the Plane of Earth, near [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md)'s dwelling place. The Prince of Evil Earth can attack intruders on his home plane but can't pursue them through the portal into the world until the proper ritual is complete.

Characters can close the portal only by striking the monolith with [Ironfang](/03_Mechanics/CLI/items/ironfang-pota.md). When the elemental weapon strikes the monolith, it chips the otherwise indestructible stone, causing the portal to implode in a grinding display, showering the area with pulverized rock and crystal. [Ogrémoch](/03_Mechanics/CLI/bestiary/npc/ogremoch-pota.md) is forced back to his home plane when this event happens, serving the cult. Cultists other than Marlos cower and flee. After the portal is destroyed, [Ironfang](/03_Mechanics/CLI/items/ironfang-pota.md) turns to rust and disintegrates.

When the portal implodes, an [earthquake](/03_Mechanics/CLI/spells/earthquake-xphb.md) spell is triggered, centered at the point where the monolith once stood. Five minutes later, this entire cavern collapses, killing and burying any creatures still inside. The bridge at area G9 collapses as well, while other areas of the Black Geode remain intact. Cut off from the influence of the Plane of Earth, the Black Geode no longer experiences tremors and weird magical effects, reverting to its natural state over a few days.

## The Weeping Colossus

The Weeping Colossus sits in the heart of a volcanic fissure. During the height of the dwarven civilization of Besilmer, lava filled this entire area, and the heat and magma rose into the lowest levels of the city where the foundries were located. When [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) arrived with her cult, she used her connection with [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md), the Prince of Evil Fire, to settle the magma and form the chambers left behind. Now, the fissure and lava tubes serve as the fire node, an extension of the Elemental Plane of Fire, resulting in lava flows, ash storms, gouts of liquid fire, and other strange elemental effects.

> [!gallery]
> ![Map 5.5: The Weeping Colossus](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/067-05-05.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/067-05-05-2.webp#gallery)
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1–2 | 1 [fire elemental](/03_Mechanics/CLI/bestiary/elemental/fire-elemental-xmm.md) |
| 3 | `d8` [magmin](/03_Mechanics/CLI/bestiary/elemental/magmin-xmm.md) |
| 4 | `d3` [salamanders](/03_Mechanics/CLI/bestiary/elemental/salamander-xmm.md) (see area W7) |
| 5 | Crust break |
| 6 | Flame gout |
| 7 | Lava rain |
| 8 | Smoke cloud |
...
A bubble of gas spontaneously ignites, creating a burst of flame identical to a [burning hands](/03_Mechanics/CLI/spells/burning-hands-xphb.md) spell. The cone starts in the space of a random character and shoots in a random direction.
...
A discharge of noxious fumes erupts from a nearby vent. The effects are identical to a [stinking cloud](/03_Mechanics/CLI/spells/stinking-cloud-xphb.md) spell.
...
One [flamewrath](/03_Mechanics/CLI/bestiary/humanoid/flamewrath-pota.md) watches from the tunnel labeled "a," while one [Eternal Flame priest](/03_Mechanics/CLI/bestiary/humanoid/eternal-flame-priest-pota.md) is positioned at the tunnel labeled "b." A [razerblast](/03_Mechanics/CLI/bestiary/humanoid/razerblast-pota.md) stands watch in the middle passage. (See chapter 7 for the cultists' statistics.) The guards attack intruders who fail to use the pass phrase, "Hail the heart of fire!"
...
One [razerblast](/03_Mechanics/CLI/bestiary/humanoid/razerblast-pota.md) (see chapter 7) and one [fire giant](/03_Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) lounge here, off duty from keeping watch over area W1. When the characters first enter this chamber, the fire giant is dozing on the upper shelf. The razerblast sits near the jet of flame, treating it like a campfire.

#### Hidden Exit

The passageway toward area W5 is hidden behind the basalt pillar and positioned high up along the wall. A character with a passive Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) score of 15 or higher notices it. Otherwise, the characters have to look in the right place. Crude holds are cut into the pillar and the wall, so they can be climbed like a ladder to the passage.

#### Treasure

The giant has a satchel made of chain mail. Inside are 600 gp, thirteen bloodstones worth 50 gp, and a [potion of invisibility](/03_Mechanics/CLI/items/potion-of-invisibility-xdmg.md).
...
[Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) sacrifices prisoners here by forcing them to cross the causeway to the eastern ledge, then ringing the gong to alert the molten roper in area W4.
...
A [roper](/03_Mechanics/CLI/bestiary/monstrosity/molten-magma-roper-pota.md) made of molten magma lurks in the middle of the lava pool, peeking up occasionally or rising to the sound of the gong. It has immunity to fire damage and vulnerability to cold damage, and its bite attack deals fire damage instead of piercing damage. A hit from the roper's tendril deals 4 (`d8`) fire damage, and a creature takes the same damage each time it ends its turn [grappled](/03_Mechanics/CLI/conditions.md#Grappled) by the roper.
...
Most of the skulls are ordinary skulls with [continual flame](/03_Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on them. However, four of the skulls are actually [flameskulls](/03_Mechanics/CLI/bestiary/undead/flameskull-xmm.md). They attack if the prisoners in area W6 try to escape. Otherwise, they remain motionless.
...
Levers are hidden in secret niches behind skulls at the points marked "c" and "d" on the map. Finding a lever requires a successful DC 15 Intelligence ([Investigation](/03_Mechanics/CLI/skills.md#Investigation)) check. Pulling either lever opens a small vent in the center of the ceiling, and natural air currents draw the fumes out of the chamber in a few moments. Characters to notice the steady airflow. The vent closes again 1 minute after a lever is pulled, and the chamber refills with fumes after 5 minutes.
...
The ceiling here is 20 feet high. The fire is a ring-shaped [wall of fire](/03_Mechanics/CLI/spells/wall-of-fire-xphb.md) spell made permanent (until dispelled) by [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md). A creature that ends its turn in this room but outside the ring takes `5d8` fire damage. A creature takes the same damage when it enters the wall for the first time on a turn or ends its turn there.

[Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) can control this wall, lowering it (or parts of it) to deposit or extract prisoners and then raising it again. The wall radiates no heat inside the ring, so the prisoners are unharmed while they remain there.

#### Prisoners

Four prisoners are here and awaiting their fate as sacrifices. The prisoners include two Waterdhavian caravan merchants named Kharloss and Jarlee (use the [noble](/03_Mechanics/CLI/bestiary/humanoid/noble-xmm.md) statistics), a [Crushing Wave reaver](/03_Mechanics/CLI/bestiary/humanoid/crushing-wave-reaver-pota.md) named Dirana, and a moon elf [druid](/03_Mechanics/CLI/bestiary/humanoid/druid-xmm.md) named Teresiel. They have been stripped of their armor and weapons, which the cultists tossed into the lava.
...
Teresiel is a member of the Emerald Enclave. She managed to conceal on her person a tiny leather packet that holds nine yellow seeds. Under the scrutiny of a detect magic spell, each seed radiates an aura of conjuration magic. Plating a seed in fertile earth causes it grow into an [awakened tree](/03_Mechanics/CLI/bestiary/plant/awakened-tree-xmm.md) after `d6` rounds. The awakened tree understands one language known to its creator and follows its creator's commands to the best of its ability. Teresiel doesn't relinquish with the seeds willingly and is determined to deliver them to the abbey at Goldenfields. She asks the characters to help her complete the delivery.

#### Development

If the characters leave any prisoners here, [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) sacrifices the remaining captives to the magma roper (area W4) within a day. If the prison is empty, the ring of fire is a low flame near the floor.

Characters captured within the node are stripped of their gear and brought here. If they fail to escape within 24 hours, [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) comes with the cultists in area W8, takes the prisoners to area W4, and feeds them to the magma roper
...
Four [salamanders](/03_Mechanics/CLI/bestiary/elemental/salamander-xmm.md) and eight [fire snakes](/03_Mechanics/CLI/bestiary/elemental/salamander-fire-snake-xmm.md) swim in the lava, which they use as a breeding pool. The salamanders lob their spears at anyone other than [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) and her guards who crosses the room, while the fire snakes have no way to attack creatures on the catwalks. If seriously wounded, the salamanders and fire snakes dive below the lava and remain out of sight.
...
Inside the column is a rock that has the symbol of fire carved into it. A character with a passive Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) score of 15 or higher notices it. Under the rock is a small brass box—one of [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md)'s emergency stashes—containing two [potions of greater healing](/03_Mechanics/CLI/items/potion-of-greater-healing-xdmg.md) and a [potion of gaseous form](/03_Mechanics/CLI/items/potion-of-gaseous-form-xdmg.md).
...
This room serves as a place of reflection and worship. Two [Eternal Flame priests](/03_Mechanics/CLI/bestiary/humanoid/eternal-flame-priest-pota.md) and one [razerblast](/03_Mechanics/CLI/bestiary/humanoid/razerblast-pota.md) (see chapter 7 for both) are praying to [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md) when the characters first arrive. Unless the characters are disguised as fire cultists, they are attacked on sight. The efreeti, if present, also joins the battle.
...
The [efreeti](/03_Mechanics/CLI/bestiary/elemental/efreeti-xmm.md) from area E13 in the Temple of Eternal Flame (see chapter 4) lives here.
...
The chest contains 750 gp, a [potion of speed](/03_Mechanics/CLI/items/potion-of-speed-xdmg.md), and a tin tube containing a [scroll](/03_Mechanics/CLI/items/spell-scroll-xdmg.md) of [immolation](/03_Mechanics/CLI/spells/immolation-xge.md) (see appendix B).
...
[Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) relaxes here and brings guests along when it suits her.

#### Treasure

An [elixir of health](/03_Mechanics/CLI/items/elixir-of-health-xdmg.md) is inside the pocket of a robe hanging in the armoire. Six paintings by a noted Calishite artist named Talik al'Hamud adorn the walls; the heat has ruined them, but they are still worth 25 gp apiece.
...
A [young red dragon](/03_Mechanics/CLI/bestiary/dragon/young-red-dragon-xmm.md), Halinaxus, sits upon the point of rock, contemplating whether he can abide serving the fire prophet. [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) and Halinaxus have a truce as they negotiate the terms of Halinaxus's assistance.

#### Roleplaying Halinaxus

The dragon is intrigued by the potential power of the cult. He considers how he might someday take over. Halinaxus also loves the prizes [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) has hinted at giving him, so he is willing to bide his time and watch events unfold.
...
Halinaxus has accumulated a loose pile of loot. On his perch are 160 pp, eleven red garnets (100 gp each), a [potion of invulnerability](/03_Mechanics/CLI/items/potion-of-invulnerability-xdmg.md), and a [wand of fear](/03_Mechanics/CLI/items/wand-of-fear-xdmg.md).
...
![](/03_Mechanics/CLI/adventures/princes-of-the-apocalypse/img/068-poa05-12.webp#center)

If [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) has been defeated, Halinaxus (see area W11) guards the fire portal and fights to the death to protect it. A [fire elemental myrmidon](/03_Mechanics/CLI/bestiary/elemental/fire-elemental-myrmidon-mpmm.md) (see chapter 7) stands before the altar in plain view, rushing forward to attack anyone other than [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) who approaches the portal. If [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) has retreated to this cavern and the characters have defeated two other prophets, use the "Encounter with Vanifer" section. Use the "Encounter with Imix" section if [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) is the last remaining prophet. In either case, the myrmidon isn't present.

#### Encounter with Vanifer

[Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) (see chapter 7) stands before the obsidian altar, watched over by Halinaxus (see area W11). Incinerath, a [fire elemental](/03_Mechanics/CLI/bestiary/elemental/fire-elemental-xmm.md) with 150 hit points, protects [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md). The elemental considers itself an avatar of [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md). [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) prefers to let Halinaxus and Incinerath fight while she casts spells from behind a [wall of fire](/03_Mechanics/CLI/spells/wall-of-fire-xphb.md).

[Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) doesn't dissemble, ask for mercy, or try to escape. Instead, she is sly and contemptuous. Halinaxus and Incinerath are arrogant blowhards but fearless in battle.

If [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) is defeated, she turns to smoke with a mournful scream and dissipates. [Tinderstrike](/03_Mechanics/CLI/items/tinderstrike-pota.md) falls to the ground, and the portal remains.

#### Encounter with Imix

This encounter features the same antagonists as described in the "Encounter with Vanifer," above. When the characters arrive, [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md) holds [Tinderstrike](/03_Mechanics/CLI/items/tinderstrike-pota.md) aloft and cries, "With this key, I call forth my master, the Eternal Flame!" The fire portal flares, and a gout of flame strikes Incinerath. With a howl of glee, the elemental transforms into [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md) (see chapter 7). The Prince of Evil Elemental Fire then focuses on destroying the characters with little concern for the consequences to [Vanifer](/03_Mechanics/CLI/bestiary/npc/vanifer-pota.md). [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md) wants to annihilate the characters, but he also knows he must keep the fire portal open. He summons fire elementals to aid him.

#### The Fire Portal

The fire portal is the giant ball of flame floating just above the head of the weeping colossus, 80 feet from the ground. It leads to the Elemental Plane of Fire, where [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md) dwells. [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md) attacks any enemy who comes through the portal. However, he can't pursue them into the world until the proper ritual is complete.

Characters can close the portal only by hurling [Tinderstrike](/03_Mechanics/CLI/items/tinderstrike-pota.md) into it. Once struck, the portal flares, consumes [Tinderstrike](/03_Mechanics/CLI/items/tinderstrike-pota.md), and implodes. It sucks all fire elementals, including [Imix](/03_Mechanics/CLI/bestiary/npc/imix-pota.md), back to the Elemental Plane of Fire. With the portal collapsed, the node gradually returns to its natural state. A small river of lava still flows from area W1 through areas W3, W4, W7, and W11 into area W12. The Weeping Colossus might remain, or the closing of the portal might shatter the stone titan.
...
The factions the characters are affiliated with take a more active role in thwarting Elemental Evil. Reports from characters who survived the first battle carry great weight with them, and it's possible that a faction was scrying near the node at just the right time and saw how the battle unfolded. If the characters need better gear or spells cast on their behalf, the factions get to work. No one wants a second assault to fail for lack of [potions of fire resistance](/03_Mechanics/CLI/items/potion-of-fire-resistance-xdmg.md), for example.
