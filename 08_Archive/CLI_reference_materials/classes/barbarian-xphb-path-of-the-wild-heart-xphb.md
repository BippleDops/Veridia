...
type: note
created: 2025-07-23
updated: '2025-08-13T01:18:32.123450+00:00'
...
You can cast the [Beast Sense](/03_Mechanics/CLI/spells/beast-sense-xphb.md) and [Speak with Animals](/03_Mechanics/CLI/spells/speak-with-animals-xphb.md) spells but only as Rituals. Wisdom is your spellcasting ability for them.
...
While your Rage is active, you have [Resistance](/03_Mechanics/CLI/variant-rules/resistance-xphb.md) to every damage type except Force, Necrotic, Psychic, and Radiant.

#### Eagle

When you activate your Rage, you can take the [Disengage](/03_Mechanics/CLI/actions.md#Disengage) and [Dash](/03_Mechanics/CLI/actions.md#Dash) actions as part of that [Bonus Action](/03_Mechanics/CLI/variant-rules/bonus-action-xphb.md). While your Rage is active, you can take a [Bonus Action](/03_Mechanics/CLI/variant-rules/bonus-action-xphb.md) to take both of those actions.

#### Wolf

While your Rage is active, your allies have [Advantage](/03_Mechanics/CLI/variant-rules/advantage-xphb.md) on attack rolls against any enemy of yours within 5 feet of you.

### Aspect of the Wilds (Level 6)

You gain one of the following options of your choice. Whenever you finish a [Long Rest](/03_Mechanics/CLI/variant-rules/long-rest-xphb.md), you can change your choice.

#### Owl

You have [Darkvision](/03_Mechanics/CLI/senses.md#Darkvision) with a range of 60 feet. If you already have [Darkvision](/03_Mechanics/CLI/senses.md#Darkvision), its range increases by 60 feet.

#### Panther

You have a [Climb Speed](/03_Mechanics/CLI/variant-rules/climb-speed-xphb.md) equal to your [Speed](/03_Mechanics/CLI/variant-rules/speed-xphb.md).

#### Salmon

You have a [Swim Speed](/03_Mechanics/CLI/variant-rules/swim-speed-xphb.md) equal to your [Speed](/03_Mechanics/CLI/variant-rules/speed-xphb.md).

### Nature Speaker (Level 10)

You can cast the [Commune with Nature](/03_Mechanics/CLI/spells/commune-with-nature-xphb.md) spell but only as a [Ritual](/03_Mechanics/CLI/variant-rules/ritual-xphb.md). Wisdom is your spellcasting ability for it.
...
While your Rage is active, you have a [Fly Speed](/03_Mechanics/CLI/variant-rules/fly-speed-xphb.md) equal to your [Speed](/03_Mechanics/CLI/variant-rules/speed-xphb.md) if you aren't wearing any armor.

#### Lion

While your Rage is active, any of your enemies within 5 feet of you have [Disadvantage](/03_Mechanics/CLI/variant-rules/disadvantage-xphb.md) on attack rolls against targets other than you or another Barbarian who has this option active.
