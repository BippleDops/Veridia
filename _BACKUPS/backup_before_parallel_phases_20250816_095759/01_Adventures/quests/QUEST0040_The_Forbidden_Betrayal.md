...
---
# The Forbidden Betrayal

*Fetch Quest for levels 3-7*

**ID**: QUEST0040

## Quest Giver
**Aldric Darkwater the Young** - Powerful merchant
...
## Key Locations
- **Havenhollow** (City): Key location for quest progression
- **Bridgehollow** (Dungeon): Key location for quest progression
- **EastHill** (Wilderness): Key location for quest progression
- **WestHill** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Cultists** led by Aldric Shadowmere
...
- **Gold**: 2,527 gp
- **Experience**: 3,000 XP
- **Magic Items**: Ancient Gauntlet of Power
