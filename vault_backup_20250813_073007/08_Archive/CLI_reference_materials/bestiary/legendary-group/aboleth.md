...
- world/both
type: note
updated: '2025-08-13T12:34:20.116497+00:00'
world: Both
---
...
- As an action, the aboleth can create an illusory image of itself within 1 mile of the lair. The copy can appear at any location the aboleth has seen before or in any location a creature [[/03_Mechanics/CLI/conditions#Charmed|charmed]] by the aboleth can currently see. Once created, the image lasts for as long as the aboleth maintains [[/03_Mechanics/CLI/conditions#Concentration|concentration]], as if [[/03_Mechanics/CLI/conditions#Concentration|concentrating]] on a spell. Although the image is intangible, it looks, sounds, and can move like the aboleth. The aboleth can sense, speak, and use telepathy from the image's position as if present at that position. If the image takes any damage, it disappears.  
