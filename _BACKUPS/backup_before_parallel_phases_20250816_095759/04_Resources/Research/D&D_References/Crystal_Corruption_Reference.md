...
|--------|------------------|------------|-------|
| **Direct Crystal Contact** | 25% | `dice: 1d4` days | Unprotected skin contact |
| **Crystal Dust Inhalation** | 15% | `dice: 1d6` days | Breathing crystal particles |
| **Infected Bodily Fluids** | 40% | `dice: 1d3` days | Blood, saliva, tears |
| **Crystal-Tainted Food/Water** | 10% | `dice: 1d8` days | Contaminated supplies |
| **Magical Crystal Exposure** | 50% | `dice: 1d2` days | Magical crystals more virulent |
...
| **Lead-Lined Equipment** | 60% reduction | 2× normal cost | Permanent | ### Environmental Protection
