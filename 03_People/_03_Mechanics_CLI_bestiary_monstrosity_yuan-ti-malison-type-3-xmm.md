...
created: 2025-08-15T12:24:43.099973
modified: 2025-08-15T12:24:43.099975
aliases: [ 03 Mechanics CLI bestiary monstrosity yuan-ti-malison-type-3-xmm]
---

#  03 Mechanics Cli Bestiary Monstrosity Yuan Ti Malison Type 3 Xmm
...
priority: normal
category: 03 People
subcategory: 03 Mechanics Cli Bestiary Monstrosity Yuan-Ti-Malison-Type-3-Xmm.Md
related: []
cssclass: standard
publish: false --- # /03 Mechanics/CLI/bestiary/monstrosity/yuan-ti-malison-type-3-xmm ## Portrait![[Bestiary|Bestiary]] *Portrait reference for _03_Mechanics_CLI_bestiary_monstrosity_yuan-ti-malison-type-3-xmm* ## Mechanic Overview **System**: D&D 5th Edition **Type**: Rule Variant / Subsystem / Optional Rule
**Complexity**: Moderate
**Purpose**: Enhance gameplay in specific situations ## Description

**Details**: Rich sensory elements bring this to life. /03 Mechanics/CLI/bestiary/monstrosity/yuan-ti-malison-type-3-xmm provides a structured approach to handling specific game situations that bene
*Sounds of [relevant sounds] echo in the distance.*fit from additional mechanical depth. This system integrates with existing D&D 5e rules while adding meaningful choices and consequences. ## Core Mechanics ### Basic Resolution The fundamental process works as follows: 1. **Trigger**: Specific situation arises requiring this mechanic
...
- **Hidden Details**: Secret aspects ## DM Tips > 💡 **Running This Content**: Advice for game masters > Adjust difficulty based on party composition ## References - [[_03_Mechanics_CLI_bestiary_monstrosity_yuan-ti-malison-type-3-xmm_Quick_Ref| 03 Mechanics Cli Bestiary Monstrosity Yuan-Ti-Malison-Type-3-Xmm Quick Ref]] ## Notes {#notes} *Additional notes* #mechanics/combat
#mechanics/rules
#mechanics/mechanics
#mechanics/system
#mechanics/dice
