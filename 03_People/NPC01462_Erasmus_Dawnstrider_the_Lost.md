...
## Appearance
Towering and compact, with Partially shaved gray hair and Heterochromic eyes. Scarred skin. Burn scars on one side of face.
...
- **Quirks**: Hums when nervous, Sneezes when lying
- **Fear**: Poverty
...
## Relationships
### Gavril Zephyrblade the Redeemed (Criminal - Informant)
...
### Hilda Stormwind the Seeker (Family - Sibling)
...
### Skills
Perception, Stealth, Survival, Investigation
...
- Evasion: No damage on successful DEX save
- Spellcasting: 3 spell slots, knows Shield, Fireball, Scorching Ray, Hold Person, Sleep
