...
|-----------|-----------|
| 1–10 | No encounter |
| 11 | 1 [[behir-xmm|behir]] |
| 12 | `2d4` [[flumph-xmm|flumphs]] |
| 13 | [[gnoll-warrior-xmm|Gnoll]] pack |
| 14 | `d4` [[grell-xmm|grells]] |
| 15 | `d4` [[hezrou-xmm|hezrous]] |
| 16 | `4d8` [[manes-xmm|manes]] |
| 17 | `2d4` [[minotaur-of-baphomet-xmm|minotaurs]] |
| 18 | 1 [[modron-monodrone-xmm|monodrone]] |
| 19 | `2d6` [[quaggoth-xmm|quaggoths]] |
| 20 | `d4` [[shrieker-fungus-xmm|shriekers]] |
^encounter

#### Behir

This long-bodied reptile is either prowling a tunnel or resting in a cave when the characters encounter it. The [[behir-xmm|behir]] retreats if reduced to 80 or fewer hit points.

#### Flumphs

This cloister of [[flumph-xmm|flumphs]] feeds on the psychic energy they detect from a nearby [[mind-flayer-xmm|mind flayer]] that has enslaved `2d4` [[quaggoth-xmm|quaggoths]]. The flumphs warn adventurers who communicate with them about the nearby threats, but it is up to the characters whether they wish to engage those threats.

#### Gnoll Pack

![](/03_Mechanics/CLI/adventures/out-of-the-abyss/img/100-ooa14-02.webp#center)

A [[gnoll-fang-of-yeenoghu-xmm|gnoll fang of Yeenoghu]] named [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] made his way into the Labyrinth shortly after Yeenoghu was summoned to the Underdark. [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]] brought with him a pack of hyenas and had them feast on the corpses of his slain victims. This heinous act transformed the hyenas into ten [[gnoll-warrior-xmm|gnolls]]. [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr's]] pack now prowls the Labyrinth in search of Yeenoghu, slaughtering anything and anyone they happen upon.
...
The encounter with [[/03_Mechanics/CLI/bestiary/npc/kurr-oota|Kurr]]'s pack occurs only once. Any subsequent occurrence of this encounter is with a pack of `3d6` [[gnoll-warrior-xmm|gnolls]]. These gnolls came to the Underdark with Yeenoghu. They cackle and scream the demon lord's name as they tear into their prey.

#### Grells

The [[grell-xmm|grells]] drop from an overhead shaft to feed.

#### Hezrous

These demons are tearing apart an iron ore cart, a rusted section of mining track, or some other old fixture. Party members can attempt to slip past the demons without arousing their attention. Doing so requires a successful DC 11 Dexterity ([[skills#Stealth|Stealth]]) check. On a failed check, the [[hezrou-xmm|demons]] detect the party member and attack.

#### Manes

Characters can hear the mewling of this vile mob long before it appears. The [[manes-xmm|manes]] scour the Labyrinth for easy prey and move like a tide of putrid flesh.

#### Minotaurs

These [[minotaur-of-baphomet-xmm|minotaurs]] roams the Labyrinth, slaying creatures in the name of Baphomet.

#### Monodrone

This modron has become separated from its fellows (see "March to Nowhere"), and there is a 75 percent chance that it is looking to rejoin them. If the characters can understand its language, the [[modron-monodrone-xmm|monodrone]] repeatedly says, "We are on the march!"
...
Searching through the remains turns up two empty potion bottles and a [[potion-of-mind-reading-xdmg|potion of mind reading]].
...
The two [[shadow-demon-xmm|shadow demons]] lurk in the darkness of this room and attack the first character who enters, likely taking their prey by surprise.

### Battlements

The top of the tower features an open space surrounded by a crenelated wall. If the four [[gargoyle-xmm|gargoyles]] have not yet attacked the adventurers, they do so here.
...
[[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] is a [[gnoll-warrior-xmm|gnoll]] with the following modifications:

- [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] has 11 hit points.  
- He has a walking speed of 25 feet.  
- He has disadvantage on Wisdom checks and Wisdom saving throws because of the physical and mental abuse he has suffered. A [[lesser-restoration-xphb|lesser restoration]] spell rids him of these effects.  
...
Any aggressive action sends [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] skittering back into the maze and to his masters. If the characters capture him, he shrieks and screams, drawing one [[minotaur-of-baphomet-xmm|minotaur]] to investigate the racket.
...
If the adventurers show pity or kindness, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] becomes confused, as he has never experienced such things. A character can befriend the gnoll with a successful DC 20 Charisma ([[skills#Persuasion|Persuasion]]) check. If any character uses magical healing on [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]], the check is automatically successful.

If the characters befriend [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]], he warns them to turn back, flee, and never return. He says his masters are vile minotaurs who wait in the maze, eager to kill all trespassers. If asked, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] explains that the minotaurs spared his life in exchange for leading travelers into the maze. If the characters insist on entering the maze, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] goes with them, trying to keep his new friends safe. If the characters defeat the minotaurs and move deeper into the Labyrinth, [[/03_Mechanics/CLI/bestiary/npc/gash-oota|Gash]] can accompany them as a follower and guide, giving the characters advantage on Wisdom ([[skills#Survival|Survival]]) checks to avoid becoming lost in the Labyrinth.
...
When the characters enter the maze, have them choose their pace (fast, normal, or slow). It takes 1 hour to navigate the maze at a fast pace, 2 hours at a normal pace, or 3 hours at a slow pace. Halfway through the journey, the navigator must make a DC 15 Wisdom ([[skills#Survival|Survival]]) check. A fast pace imposes a −5 penalty to the check. A slow pace grants a +5 bonus. On a success, the characters find their way out. On a failure, the characters must start the journey from the beginning.
...
A frenzied group of `2d4` [[gnoll-warrior-xmm|gnolls]] is lost in the maze. The gnolls attack any creatures they see.

#### Minotaurs

These bloodthirsty [[minotaur-of-baphomet-xmm|minotaurs]] are hunting gnolls but attack any other creatures they happen upon.
...
If the characters stay hidden and observe, Yeenoghu leaves in short order. He is restless and eager for new prey. Yeenoghu gathers up most of the gnolls and hyenas and leads them down a tunnel on the right side of the cavern. Eight [[gnoll-warrior-xmm|gnolls]] led by a [[gnoll-pack-lord-xmm|gnoll pack lord]] remain in the cavern, feasting on the goristro's corpse.
...
This chamber houses the [[conditions#Petrified|petrified]] remains of eight fallen angels, condemned by the gods to pass the ages in the dark depths. Each appears to have been carved from stone in some position of fear, suffering, hatred, or longing. Each statue is spotted with lichen and marred by mineral deposits, which have crystallized out of the water dripping from the ceiling over uncounted years.

Even though they are transformed into stone statues, the fallen angels remain very much alive, their [[conditions#Petrified|petrified]] bodies having become prisons for their minds and souls. They remember who they were. They know what they did and why they are here. They know everything transpiring around them. Yet they can do nothing. They are trapped forever, and the isolation, darkness, and endless torment of their fate have driven them mad. No spell can undo the angels' curse or free them from their [[conditions#Petrified|petrified]] state.
...
This angel appears to be reaching out as if offering something. A character making contact with the angel must succeed on a DC 15 Charisma saving throw or become [[conditions#Charmed|charmed]] for 1 minute.

While the character is [[conditions#Charmed|charmed]], the angel has a telepathic link with the character as long as it and the character remain on the same plane of existence. The angel issues commands to the character, and the character does its best to obey those commands if it is conscious. The angel typically commands a character to kill, maim, rob, or otherwise harm its companions.
...
A successful DC 15 Intelligence ([[skills#Arcana|Arcana]]) check is needed to activate the device by puzzling out its array of gears and levers. It then takes 12 rounds for the engine to "align itself" and activate its magical effect. If an initiative order hasn't already been established by the time the engine activates, have everyone in the party roll initiative.
...
The engine shuts down if any part of it comes into contact with an [[antimagic-field-xphb|antimagic field]] or if it is targeted by a successful [[dispel-magic-xphb|dispel magic]] (DC 19). Otherwise, it can only be shut down by a [[wish-xphb|wish]] spell or divine intervention.
...
| 11–15 | The engine makes a loud "WHAAAH" sound until the start of its next turn. For as long as the sound lasts, the engine projects an [[antimagic-field-xphb|antimagic field]] (as the spell) around itself. |
| 16–19 | The hollow interior of the engine flickers with crimson light until the end of its turn, whereupon one dead character or NPC of the DM's choice is restored to life, as though subjected to a [[resurrection-xphb|resurrection]] spell. The revived creature appears in a safe, unoccupied space within 120 feet of the engine. |
...
| 28–32 | The engine hums until the end of its turn, at which point a [[green-slaad-xmm|green slaad]] appears in a safe space within 120 feet of the engine. The slaad rolls initiative and, on its turn, attacks any other creatures it sees. |
| 33–35 | The engine groans loudly and turns each creature within 120 feet of it [[conditions#Invisible|invisible]]. A creature's invisibility lasts until it attacks or casts a spell. |
...
| 40–43 | Multicolored arcs of light play across the surface of the engine, which casts a [[polymorph-xphb|polymorph]] spell (save DC 18) on each creature within 20 feet of it. Any creature that fails the saving throw is polymorphed into a [[flying-snake-xmm|flying snake]]. |
...
| 58–60 | The engine flickers with blue light and casts [[faerie-fire-xphb|faerie fire]], targeting all creatures within 20 feet of it (save DC 18). The spell's effect has a duration of 1 minute. |
| 61–66 | The engine spews harmless, multicolored sparks until the start of its next turn. |
| 67–70 | The engine emits a flash of violet light. Each creature within 20 feet of the engine must succeed on a DC 18 Constitution saving throw or be [[conditions#Petrified|petrified]] until the engine's next turn. |
