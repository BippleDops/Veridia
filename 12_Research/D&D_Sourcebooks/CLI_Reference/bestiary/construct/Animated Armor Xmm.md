...
# [[3-Mechanics\CLI\bestiary\construct/animated-armor-xmm|Animated Armor]]
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/construct/token/animated-armor-xmm.webp"
```
^statblock
...
Animated armor xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
