...
| dice: 1d100 | Effect |
|-------------|--------|
| 01-20 | You cast a spell originating from the chosen point. Roll `d10` to determine the spell: on a **1-2**, [Darkness](/3-Mechanics/CLI/spells/darkness-xphb.md); on a **3-4**, [Faerie Fire](/3-Mechanics/CLI/spells/faerie-fire-xphb.md); on a **5-6**, [Fireball](/3-Mechanics/CLI/spells/fireball-xphb.md); on a **7-8**, [Slow](/3-Mechanics/CLI/spells/slow-xphb.md); on a **9-10**, [Stinking Cloud](/3-Mechanics/CLI/spells/stinking-cloud-xphb.md). |
...
| 93-97 | You cast [Polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md), targeting the creature closest to the chosen point of origin. Roll `d4` to determine the target's new form. On a **1**, the new form is a [Black Bear](/3-Mechanics/CLI/bestiary/beast/black-bear-xmm.md); on a **2**, the new form is a [Giant Wasp](/3-Mechanics/CLI/bestiary/beast/giant-wasp-xmm.md); on a **3-4**, the new form is a [Frog](/3-Mechanics/CLI/bestiary/beast/frog-xmm.md). |
