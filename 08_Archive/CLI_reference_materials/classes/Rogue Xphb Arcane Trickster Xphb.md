...
You know three cantrips: [[/03_Mechanics/CLI/spells/mage-hand-xphb|Mage Hand]] and two other cantrips of your choice from the Wizard spell list (see that class's section for its list). [[/03_Mechanics/CLI/spells/mind-sliver-xphb|Mind Sliver]] and [[/03_Mechanics/CLI/spells/minor-illusion-xphb|Minor Illusion]] are recommended.

Whenever you gain a Rogue level, you can replace one of your cantrips, except [[/03_Mechanics/CLI/spells/mage-hand-xphb|Mage Hand]], with another Wizard cantrip of your choice.

When you reach Rogue level 10, you learn another Wizard cantrip of your choice.

#### Spell Slots

The Arcane Trickster Spellcasting table shows how many spell slots you have to cast your level 1+ spells. You regain all expended spell slots when you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]].

#### Prepared Spells of 1st+ Level

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose three level 1 Wizard spells. [[/03_Mechanics/CLI/spells/charm-person-xphb|Charm Person]], [[/03_Mechanics/CLI/spells/disguise-self-xphb|Disguise Self]], and [[/03_Mechanics/CLI/spells/fog-cloud-xphb|Fog Cloud]] are recommended.
...
You can use an [[/03_Mechanics/CLI/items/arcane-focus-xphb|Arcane Focus]] as a [[/03_Mechanics/CLI/variant-rules/spellcasting-focus-xphb|Spellcasting Focus]] for your Wizard spells.

### Mage Hand Legerdemain (Level 3)

When you cast [[/03_Mechanics/CLI/spells/mage-hand-xphb|Mage Hand]], you can cast it as a [[/03_Mechanics/CLI/variant-rules/bonus-action-xphb|Bonus Action]], and you can make the spectral hand [[/03_Mechanics/CLI/conditions#Invisible|Invisible]]. You can control the hand as a [[/03_Mechanics/CLI/variant-rules/bonus-action-xphb|Bonus Action]], and through it, you can make Dexterity ([[/03_Mechanics/CLI/skills#Sleight%20of%20Hand|Sleight of Hand]]) checks.

### Magical Ambush (Level 9)

If you have the [[/03_Mechanics/CLI/conditions#Invisible|Invisible]] condition when you cast a spell on a creature, it has [[/03_Mechanics/CLI/variant-rules/disadvantage-xphb|Disadvantage]] on any saving throw it makes against the spell on the same turn.

### Versatile Trickster (Level 13)

You gain the ability to distract targets with your [[/03_Mechanics/CLI/spells/mage-hand-xphb|Mage Hand]]. When you use the Trip option of your Cunning Strike on a creature, you can also use that option on another creature within 5 feet of the spectral hand.

### Spell Thief (Level 17)

You gain the ability to magically steal the knowledge of how to cast a spell from another spellcaster.

Immediately after a creature casts a spell that targets you or includes you in its area of effect, you can take a [[/03_Mechanics/CLI/variant-rules/reaction-xphb|Reaction]] to force the creature to make an Intelligence saving throw. The DC equals your spell save DC. On a failed save, you negate the spell's effect against you, and you steal the knowledge of the spell if it is at least level 1 and of a level you can cast (it doesn't need to be a Wizard spell). For the next 8 hours, you have the spell prepared. The creature can't cast it until the 8 hours have passed.

Once you steal a spell with this feature, you can't use this feature again until you finish a [[/03_Mechanics/CLI/variant-rules/long-rest-xphb|Long Rest]].
