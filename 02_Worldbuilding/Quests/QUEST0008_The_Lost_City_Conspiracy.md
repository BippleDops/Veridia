...
## Quest Giver
**Ivan Goldleaf** - Powerful merchant
...
## Key Locations
- **FortHaven** (City): Key location for quest progression
- **PortHaven** (Dungeon): Key location for quest progression
- **NorthBridge** (Wilderness): Key location for quest progression
- **Bridgeshire** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Cultists** led by Ivan Brightblade
...
- **Gold**: 526 gp
- **Experience**: 1,000 XP
- **Magic Items**: Ancient Shield of Power
- **Other**: Property deed
