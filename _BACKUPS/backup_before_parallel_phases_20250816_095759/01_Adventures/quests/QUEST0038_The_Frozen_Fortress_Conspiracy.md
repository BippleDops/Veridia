...
# The Frozen Fortress Conspiracy
...
## Quest Giver
**Nathaniel Goldleaf** - Powerful merchant
...
### Hidden Objective
*DM Only: Quest giver plans betrayal*
...
- **NorthHill** (Wilderness): Key location for quest progression
- **SouthHill** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Constructs** led by Nathaniel Brightblade
  - Strength: 27 combatants
