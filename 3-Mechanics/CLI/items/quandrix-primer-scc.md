...
The Quandrix Primer is a magic textbook created at Strixhaven's Quandrix College. The primer has 3 charges, and it regains `d3` expended charges daily at dawn. If you make an Intelligence ([Arcana](/3-Mechanics/CLI/skills.md#Arcana)) or an Intelligence ([Nature](/3-Mechanics/CLI/skills.md#Nature)) check while holding the primer, you can expend 1 charge to give yourself a `d4` bonus to the check, immediately after you roll the `d20`.
