...
Making a template is simple. Get a piece of paper or card stock, and cut it in the shape of the area of effect you're using. Every 5 feet of the area equals 1 inch of the template's size. For example, the 20-foot-radius sphere of the [fireball](/03_Mechanics/CLI/spells/fireball-xphb.md) spell, which has a 40-foot diameter, would translate into a circular template with an 8-inch diameter.
...
Spellcasting xge is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of spellcasting xge as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around spellcasting xge.

## Adventure Hooks

- A rumor ties spellcasting xge to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at spellcasting xge to avert a public scandal.
- A map overlay reveals a hidden approach to spellcasting xge active only during specific tides/storms.
