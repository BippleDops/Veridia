...
title: armor-of-necrotic-resistance-xdmg (items)
type: item
tags: 
- item
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["armor-of-necrotic-resistance-xdmg (items)"]
status: active
priority: normal
...
title: armor of necrotic resistance xdmg
aliases:
...
updated: '2025-08-12T23:37:36.623153'
world: Both

--- > [!figure] Item
![](04_Resources/Assets/Items/item-artifact-armor-of-necrotic-resistance-xdmg-armor-of-necrotic-resistance-xdmg.svg) # Armor of Necrotic Resistance

*Rare (requires attunement)* You have [[boon-of-energy-resistance-xphb (feats)]] to necrotic damage while you wear this armor. **Variants**:
...
- [Studded Leather Armor of Necrotic Resistance](#Studded%20Leather%20Armor%20of%20Necrotic%20Resistance) ### Studded Leather Armor of Necrotic Resistance - **Armor Class**: 12 + Dex modifier

- **Weight**: 13.0 lbs. *Source: Dungeon Master's Guide (2024) p. 231. Available in the SRD and the Free Rules (2024)* ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Armor of necrotic resistance xdmg is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of armor of necrotic resistance xdmg as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around armor of necrotic resistance xdmg. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Prophecy Connection Mentioned in The Second Prophecy of Depths ## Plot Hooks - A corpse reveals a conspiracy about the government
