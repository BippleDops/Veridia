...
- world/both
type: note
updated: '2025-08-13T12:34:19.189476+00:00'
world: Both
---
...
**Shield Bash.** If you attack a creature within 5 feet of you as part of the [[/03_Mechanics/CLI/actions#Attack|Attack]] action and hit with a Melee weapon, you can immediately bash the target with your Shield if it's equipped, forcing the target to make a Strength saving throw (DC 8 plus your Strength modifier and Proficiency Bonus). On a failed save, you either push the target 5 feet from you or cause it to have the [[/03_Mechanics/CLI/conditions#Prone|Prone]] condition (your choice). You can use this benefit only once on each of your turns.
...
Shield master xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
