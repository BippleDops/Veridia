...
"traits":
  ...
  - "desc": "If destroyed, the aboleth gains a new body in 5d10 days, reviving with\
      \ all its [Hit Points](/03_Mechanics/CLI/variant-rules/hit-points-xphb.md) in\
  ...
  - "desc": "While underwater, the aboleth is surrounded by mucus. Constitution Saving\
      \ Throw: DC 14, each creature in a 5-foot [Emanation](/03_Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      ...
      \ the target can breathe air and water, and it can't regain [Hit Points](/03_Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "Intelligence Saving Throw: DC 16, one creature within 30 feet that\
      \ is [Charmed](/03_Mechanics/CLI/conditions.md#Charmed) or [Grappled](/03_Mechanics/CLI/conditions.md#Grappled)\
      ...
      \ is a Humanoid and is reduced to 0 [Hit Points](/03_Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ by this action."
    "name": "Consume Memories"
  - "desc": "Wisdom Saving Throw: DC 16, one creature the aboleth can see within\
      \ 30 feet. Failure: The target has the [Charmed](/03_Mechanics/CLI/conditions.md#Charmed)\
      \ condition until the aboleth dies or is on a different plane of existence from\
      \ the target. While [Charmed](/03_Mechanics/CLI/conditions.md#Charmed), the target\
...
"legendary_actions":
  - "desc": "The aboleth makes one Tentacle attack."
    "name": "Lash"
  - "desc": "If the aboleth has at least one creature [Charmed](/03_Mechanics/CLI/conditions.md#Charmed)\
      \ or [Grappled](/03_Mechanics/CLI/conditions.md#Grappled), it uses Consume Memories\
      \ and regains 5 (d10) [Hit Points](/03_Mechanics/CLI/variant-rules/hit-points-xphb.md)."
    "name": "Psychic Drain"
"regional_effects":
  ...
  - "desc": "- Foul Water. Water sources within 1 mile of the lair are supernaturally\
      ...
      \ must succeed on a DC 15 Constitution saving throw or have the [Poisoned](/03_Mechanics/CLI/conditions.md#Poisoned)\
      \ condition for 1 hour.  \n- Psionic Projection. While in its lair, the\
      \ aboleth can cast [Project Image](/03_Mechanics/CLI/spells/project-image-xphb.md),\
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/aberration/token/aboleth-xmm.webp"
```
^statblock
