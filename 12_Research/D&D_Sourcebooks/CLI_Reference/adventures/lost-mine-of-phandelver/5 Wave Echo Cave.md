...
| Roll | Result |
|------|--------|
| 1-3 | [[stirge-xmm|Stirges]] (`2d4`) |
| 4-5 | [[ghoul-xmm|Ghouls]] (`d4`) |
| 6 | [[grick-xmm|Gricks]] (`d4`) |
| 7-8 | [[bugbear-warrior-xmm|Bugbears]] (`d4`) |
| 9 | [[skeleton-xmm|Skeletons]] (`d6`) |
| 10 | [[zombie-xmm|Zombies]] (`d6`) |
| 11-12 | [[ochre-jelly-xmm|Ochre Jelly]] (1) |
^wandering-monsters
...
None unless otherwise indicated. The boxed text assumes that the characters have light sources or [[senses#Darkvision|darkvision]].
...
Tharden wears a pair of [[boots-of-striding-and-springing-xdmg|boots of striding and springing]]. In his haste to explore the rest of Wave Echo Cave, Nezznar overlooked them.
...
Clinging to the ceiling like bats are ten [[stirge-xmm|stirges]]. The monsters find scant living prey in the mines, and they are ravenous. If the characters are looking down at the skeletons on the floor, the stirges are likely get the drop on them. Any character who isn't watching the ceiling is [[conditions#Surprised|surprised]] unless his or her passive Wisdom ([[skills#Perception|Perception]]) score is higher than the stirges' Dexterity ([[skills#Stealth|Stealth]]) check total (roll once for all of them). Characters who aren't [[conditions#Surprised|surprised]] hear a flapping noise as the stirges descend to attack.
...
In the round after any living creature enters this chamber, the bones begin to stir and knit together, forming nine [[skeleton-xmm|skeletons]]. They fight until destroyed.
...
Behind the counter sits a locked iron strongbox, requiring [[thieves-tools-xphb|thieves' tools]] and a successful DC 20 Dexterity check to open. This pay chest was overlooked in the fighting and contains 600 cp, 180 sp, 90 ep, and 60 gp.
...
Three [[ghoul-xmm|ghouls]] from the pack in 9 are here, cracking and gnawing on the ancient bones of the fallen in the vain hope that some tasty morsel of marrow remains. The ghouls, eager for a fresh meal, attack immediately.
...
Most of the fungi is harmless, and the green-glowing fungi allow creatures to see the entire cavern without the aid of [[senses#Darkvision|darkvision]] or a light source.

### Poison Gas

Whenever a creature attempts to cross the cavern, the carpets of fungi that cover most of the floor release poisonous gas into the air. Each creature in the cavern must succeed on a DC 11 Constitution saving throw or take `3d6` poison damage and be [[conditions#Poisoned|poisoned]] for 10 minutes (see the rulebook for more information on the [[conditions#Poisoned|poisoned]] condition). The gas disperses after 1 minute, but until then, any living creature that ends its turn in the cavern must repeat the saving throw.
...
Seven [[ghoul-xmm|ghouls]] lurk in the shadows on the western ledge.
...
The skeleton wears two platinum rings (75 gp each) and clutches a [[wand-of-magic-missiles-xdmg|wand of magic missiles]] in its bony fingers.
...
Five [[bugbear-warrior-xmm|bugbears]] reside in this chamber. They are loyal minions of Nezznar. This room marks the front line in the Black Spider's assault on Wave Echo Cave, and the bugbears are here to prevent ghouls, zombies, or other undead from troubling their master in his lair (19).
...
The largest bugbear carries a pouch containing 15 cp. 13ep, and a [[potion-of-vitality-xdmg|potion of vitality]].
...
Any character proficient in [[skills#Arcana|Arcana]] can sense a subtle aura of magic in this cavern. (A [[detect-magic-xphb|detect magic]] spell reveals the same.) The aura becomes stronger as one approaches the northern building (15).
...
Mormesk was a powerful mage until he met his end in the spell battle at the climax of the orc attack. Centuries of anger have [[conditions#Poisoned|poisoned]] his soul, transforming him into a hate-filled apparition.
...
On the worktable in the southeast corner of the room are the last items the spectator was charged to protect: [[lightbringer-lmop|Lightbringer]] and [[dragonguard-lmop|Dragonguard]].
...
Three [[bugbear-warrior-xmm|bugbears]] are stationed here. Two of them are clearing rock on the rift floor while one more stands guard in the western half of the cavern. A [[doppelganger-xmm|doppelganger]] named Vhalak supervises the operation in the guise of a male drow. If a fight breaks out in the main cavern, the two bugbears in the rift climb up the ropes to join the fray.
...
[[/03_Mechanics/CLI/bestiary/npc/nezznar-the-black-spider-lmop|Nezznar the Black Spider]] is joined by four [[giant-spider-xmm|giant spiders]] that defend their master to the death. If they are expecting trouble, the spiders hide behind pillars, and Nezznar casts [[invisibility-xphb|invisibility]] on himself and stands near the table. Make a Dexterity ([[skills#Stealth|Stealth]]) check for the spiders. When intruders appear, the spiders try to entangle them in webs before closing to melee range. Nezznar joins the fray on the round after the spiders attack.

If the [[doppelganger-xmm|doppelganger]] from 18 retreated to this area, it assumes the guise of [[/03_Mechanics/CLI/bestiary/npc/nundro-rockseeker-lmop|Nundro Rockseeker]] so that Nezznar can use the "dwarf" as leverage to force the party's surrender (although the drow won't actually harm the doppelganger). See the "Roleplaying Nezznar" section for more information on the drow villain.
...
Nezznar carries a [[potion-of-healing-xdmg|potion of healing]] and a [[spider-staff-lmop|spider staff]]. In addition, the drow carries an iron key with a head shaped like an anvil. This key unlocks the door to 20.
...
The door to this room is locked, requiring [[thieves-tools-xphb|thieves' tools]] and a successful DC 15 Dexterity check to open. Nezznar (19) carries the key.
