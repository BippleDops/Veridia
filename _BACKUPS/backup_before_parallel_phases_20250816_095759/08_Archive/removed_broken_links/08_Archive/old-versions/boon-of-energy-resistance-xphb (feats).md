...
title: boon-of-energy-resistance-xphb (feats)
type: note
tags: 
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["boon-of-energy-resistance-xphb (feats)"]
status: active
priority: normal
...
updated: '2025-08-12T23:37:34.504622'
world: Both

--- # Boon of Energy Resistance

*Source: Player's Handbook (2024) p. 210* **Prerequisite**: 19th You gain the following benefits. **Ability Score Increase.** Increase one ability score of your choice by 1, to a maximum of 30. **Energy Resistances.** You gain Resistance to two of the following damage types of your choice: Acid, Cold, Fire, Lightning, Necrotic, Poison, Psychic, Radiant, or Thunder. Whenever you finish a Long Rest, you can change your choices. **Energy Redirection.** When you take damage of one of the types chosen for the Energy Resistances benefit, you can take a Reaction to direct damage of the same type toward another creature you can see within 60 feet of yourself that isn't behind Total Cover. If you do so, that creature must succeed on a Dexterity saving throw (**DC 8** plus your Constitution modifier and Proficiency Bonus) or take damage equal to``dice: 2d12``plus your Constitution modifier. ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Boon of energy resistance xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of boon of energy resistance xphb as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around boon of energy resistance xphb. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Plot Hooks - A journal reveals a conspiracy about this place

- An heirloom has gone missing and evil awakens
- Strange dreams suggest ancient magic
- A document has gone missing and evil awakens ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research ## References - [[Dragon Turtle Xmm
...
- [[armor-of-acid-resistance-xdmg (items)
- [armor-of-cold-resistance-xdmg (items)]]
- [[armor-of-fire-resistance-xdmg (items)
- [armor-of-force-resistance-xdmg (items)]]
- [[armor-of-invulnerability-xdmg (items)
- [armor-of-lightning-resistance-xdmg (items)]]
- [[armor-of-necrotic-resistance-xdmg (items)
- [armor-of-poison-resistance-xdmg (items)]]
- [[armor-of-psychic-resistance-xdmg (items)
- [armor-of-radiant-resistance-xdmg (items)]]
...
- [boots-of-the-winterlands-xdmg (items)]]
...
- [[potion-of-acid-resistance-xdmg (items)
- [potion-of-cold-resistance-xdmg (items)]]
- [[potion-of-fire-resistance-xdmg (items)
- [potion-of-force-resistance-xdmg (items)]]
- [[potion-of-invulnerability-xdmg (items)
- [potion-of-lightning-resistance-xdmg (items)]]
- [[potion-of-necrotic-resistance-xdmg (items)
- [potion-of-poison-resistance-xdmg (items)]]
- [[potion-of-psychic-resistance-xdmg (items)
- [potion-of-radiant-resistance-xdmg (items)]]
- [[potion-of-resistance-xdmg (items)
- [potion-of-thunder-resistance-xdmg (items)]]
...
- [ring-of-fire-resistance-xdmg (items)]]
- [[ring-of-force-resistance-xdmg (items)
- [ring-of-lightning-resistance-xdmg (items)]]
- [[ring-of-necrotic-resistance-xdmg (items)
...
- [[shield-of-missile-attraction-xdmg (items)
...
- [Extreme Heat Xdmg]]
- [[Frigid Water Xdmg
- [extreme-cold-xdmg (traps-hazards)]]
