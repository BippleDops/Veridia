...
accessibility:
  ...
  content_warnings: []
  pronunciation: Save-Transform Reality
  safety_tools:
  - Lines & Veils
  - X-Card
---
...
Save Transform Reality is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of Save Transform Reality as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Save Transform Reality.

## Adventure Hooks

- A rumor ties Save Transform Reality to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at Save Transform Reality to avert a public scandal.
- A map overlay reveals a hidden approach to Save Transform Reality active only during specific tides/storms.
