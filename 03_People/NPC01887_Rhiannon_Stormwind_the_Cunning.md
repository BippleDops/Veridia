...
## Appearance
Below average and muscular, with Mohawk silver hair and Amber eyes. Dark skin. Unusual eye color for their race.

**Clothing**: Assassin's garb, all in black
**Accessories**: Lucky rabbit's foot

## Personality
- **Traits**: Never uses people's real names; Incredibly optimistic despite evidence; Collects unusual and worthless objects; Sees doom and gloom everywhere
- **Ideal**: Honor: My word is my bond, and I never break an oath
- **Bond**: I will become the greatest that ever lived
- **Flaw**: I believe I'm invincible
- **Quirks**: Afraid of the dark, Collects buttons, Writes everything down
- **Fear**: The dark
...
### Erasmus Ravenheart the Cunning (Criminal - Informant)
- **Status**: Complicated history
- **History**: Teacher and student relationship
- **Secret**: One is mind-controlled

### Vesper Zephyrblade the Strong (Professional - Employer)
...
### Attacks
- Poisoned blade: +9 to hit, 1d6+5 slashing
- Hidden dagger: +7 to hit, 1d4+5 slashing
...
- Death Throes: Explodes on death for 2d6 damage
- Death Throes: Explodes on death for 2d6 damage
- Spellcasting: 9 spell slots, knows Fireball, Invisibility, Charm Person, Misty Step, Lightning Bolt, Magic Missile, Sleep, Scorching Ray
