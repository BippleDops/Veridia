...
title: Lord Marcus Shadowbane (D&D_References)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Lord Marcus Shadowbane (D&D References)"]
status: active
priority: normal
...
--- > [!figure] Portrait ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Lord Marcus Shadowbane is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of Lord Marcus Shadowbane as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Lord Marcus Shadowbane. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Semantic Connections
...
- [[Border Fortresses]] ## Related *Links to related content will be added here.* ## Relationships - **Mentor**: [[Npc]]

- **Ally**: [[Captain Marina Saltborn]]
- **Enemy**: [[Uniting the Factions]]
- **Victim**: [[Npc]]
- **Victim**: [[Lord Marcus Shadowbane]] ## Plot Hooks - Someone is blackmailing an heir for power
