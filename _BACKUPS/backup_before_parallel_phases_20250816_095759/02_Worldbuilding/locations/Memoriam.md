...
**Rejuvenation.** Solemneth's connection to Memoriam means she reforms within the Eternal Spire after `dice: 1d10` days if destroyed, unless all memories stored in the memorial are purged.
...
**Actions**
- **Paralyzing Touch.** *Melee Spell Attack:* +12 to hit, reach 5 ft., one creature. *Hit:* 10 (`dice: 3d6`) cold damage. The target must succeed on a **DC 18** Constitution saving throw or be paralyzed for 1 minute.
...
**Actions**
- **Life Drain.** *Melee Spell Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 21 (`dice: 4d8` + 3) necrotic damage. The target must make a **DC 14** Constitution saving throw. On failure, its hit point maximum is reduced by the damage taken.
...
- Protective wards that deal radiant damage to living creatures (`dice: 2d6` per round)
...
Ongoing situations affecting Memoriam:
