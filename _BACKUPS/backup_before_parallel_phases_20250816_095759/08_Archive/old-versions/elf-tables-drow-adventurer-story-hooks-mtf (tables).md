...
title: elf-tables-drow-adventurer-story-hooks-mtf (tables)
type: note
tags: 
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["elf-tables-drow-adventurer-story-hooks-mtf (tables)"]
status: active
priority: normal
...
updated: '2025-08-12T23:37:33.475142'
world: Both

--- # Elf Tables; Drow Adventurer Story Hooks

*Source: Mordenkainen's Tome of Foes p. 64* **Drow Adventurer Story Hooks**`dice: [](elf-tables-drow-adventurer-story-hooks-mtf.md#^drow-adventurer-story-hooks)`| dice: d8 | Hook |
|----------|------|
...
^drow-adventurer-story-hooks ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Elf tables drow adventurer story hooks mtf is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of elf tables drow adventurer story hooks mtf as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around elf tables drow adventurer story hooks mtf. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Plot Hooks - A shipment has gone missing and truth emerges
