...
If [Rezmir](/3-Mechanics/CLI/bestiary/npc/rezmir-hotdq.md) survived the earlier chapter, the half-dragon meets with [Captain Othelstan](/3-Mechanics/CLI/bestiary/npc/captain-othelstan-hotdq.md) in Parnast to receive a full report on the status of the cult raids and to inform the captain of the possible arrival of adventurers. Tracking her successfully requires a DC 23 Wisdom ([Survival](/3-Mechanics/CLI/skills.md#Survival)) check. If the adventurers ignore the lodge in favor of following [Rezmir](/3-Mechanics/CLI/bestiary/npc/rezmir-hotdq.md) to Parnast, skip to chapter 8.
...
The lodge stands in a forest, among tall pines and in excellent hunting territory. The building can be accessed through the front door, kitchen door, the shuttered windows (DC 10 Dexterity check or a shutter bangs), or a hole in the moss-covered roof (above area 17) that's visible from the kennel and stables. Climbing up to the hole requires a successful DC 15 Strength ([Athletics](/3-Mechanics/CLI/skills.md#Athletics)) check.
...
If the party lingers outside the lodge or explores the woods nearby, it finds company. Those with a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 12 or higher are not [surprised](/3-Mechanics/CLI/conditions.md#Surprised) by the rush of a group of two [trolls](/3-Mechanics/CLI/bestiary/giant/troll-xmm.md) and three [ambush drakes](/3-Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D for Statistics) that has been wandering the area. The combat alerts Talis that she has company. The trolls serve as the lodge's bouncers, and anyone who is not expected is eaten.
...
Opening the door requires a [knock](/3-Mechanics/CLI/spells/knock-xphb.md) spell or a successful DC 20 Strength check; hammering on it brings the occupants over to open it, but they might be a surprise. When the door opens, read:
...
> 
> Sometimes when a troll loses a limb, it regenerates two limbs to replace the one it lost. This can result in trolls with multiple arms. A [four-armed troll](/3-Mechanics/CLI/bestiary/npc/trepsin-hotdq.md) uses the [troll](/3-Mechanics/CLI/bestiary/giant/troll-xmm.md) stat block, except that it is a challenge rating 6 monster (2,300 XP) and has the following action instead of the troll's normal Multiattack action:
> 
...
The lower floor has heavy, mud-stained carpets and dark wooden walls. These are the common spaces for visitors and for servants. Characters can enter the lodge through the front door, the kitchen door, or a shuttered window. Opening a shutter without alerting the lodge's occupants requires a successful DC 12 Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check.
...
The heavy carpet near the entryway is stained with the muddy boots of returning hunters. The two demonic statues are [gargoyles](/3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md), and they attack creatures that enter the hall with weapons drawn.

#### Treasure

The freestanding suits of elven armor are warded with freezing runes that can be detected with a successful DC 20 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check. Any character that touches one of the suits or passes between them must make a DC 15 Constitution saving throw. On a failed saving throw, the character takes `d12` cold damage and is [restrained](/3-Mechanics/CLI/conditions.md#Restrained) (frozen in place) for 1 minute. The character may use an action on his or her turn to make a DC 15 Strength check, ending the effect early on a success.

Each suit of plate armor is mounted on a crude wooden stand vaguely shaped like a headless elf. A freezing rune can be removed with [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 15), whereupon the armor becomes nonmagical.
...
The black armor is a [helmed horror](/3-Mechanics/CLI/bestiary/construct/helmed-horror-xmm.md) built to serve the cult, and disguised by an illusion to appear as ordinary armor. It detects as magical and attacks if disturbed or if commanded to do so by Talis or someone else wearing purple Cult of the Dragon robes.

The helmed horror has an [Evard's black tentacles](/3-Mechanics/CLI/spells/evards-black-tentacles-xphb.md) spell stored in it. It is programmed to cast this spell when confronted by three or more adversaries, and can do so only once. (See the helmed horror's stat block for details on its Spell Storing trait.)
...
These four [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) are Talis's servants. They know how to cook, and they can put up a fight. If attacked, one cultist runs to the drake kennels (area 2) to fetch [Trepsin](/3-Mechanics/CLI/bestiary/npc/trepsin-hotdq.md) and his drakes. Those reinforcements arrive 3 rounds later.
...
A successful DC 18 Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check reveals a hollow space under the floorboards that contains a strongbox, inside which is stored the lodge's fine dining silver: 24 place settings of butter knife, soup spoon, fork, and dessert spoon—but no knives.
...
This human [priest](/3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) of Amaunator has not been abused, which makes him a little nervous. He says he arrived here from Hillsfar to the east, as part of a pilgrimage to a shrine on the coast, and this is why Talis singled him out for good treatment—he's unlikely to know anything useful.
...
The tapestry here is worth about 400 gp, but weighs 40 pounds. Additionally, the griffon's head does contain something unusual: a stash of two [potions of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
The twenty-four [kobold servants](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) are the lodge's maids, grooms and cooks. They work primarily at night. The servants avoid combat, but they spy on every visitor and report back to Talis if they see anything suspicious.
...
[Talis the White](/3-Mechanics/CLI/bestiary/npc/talis-the-white-hotdq.md) (See appendix D for statistics). She stands behind her bodyguards and uses a [wand of winter](/3-Mechanics/CLI/items/wand-of-winter-hotdq.md) (see appendix C). Talis's bodyguards include two human [veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) named Maelgot and Sorvic, and a [dragonclaw](/3-Mechanics/CLI/bestiary/humanoid/dragonclaw-hotdq.md) (see appendix D) named Kusphia. If Talis is slain, the veterans surrender, but Kusphia fights to the death to avenge her slain mistress.
...
Talis keeps a locked chest in this room and she carries the only key. It can also be opened by a character using [thieves' tools](/3-Mechanics/CLI/items/thieves-tools-xphb.md) with a successful DC 21 Dexterity check. When opened, light spills out from the [+1 chain mail](/3-Mechanics/CLI/items/1-armor-xdmg.md) within it. The armor's light also shines on the chest's 4,000 gp and a [spell scroll](/3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [scorching ray](/3-Mechanics/CLI/spells/scorching-ray-xphb.md).
...
The veterans who serve Talis have taken these well-furnished quarters for their own: they are Maelgot, Sorvic, and Wessic the Wizened. Wessic, a human [veteran](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) of sixty years, is resting here the first time the characters show up; the others are in area 16. Wessic sleeps in his armor and keeps his weapon stowed under his bed, within easy reach. If awakened, he fights fiercely and shouts loudly for help; this usually brings Talis and the other guards, but not the [Trepsin](/3-Mechanics/CLI/bestiary/npc/trepsin-hotdq.md) the troll or the lodge's human and kobold servants. If reduced to half his hit points, he attempts to surrender.
...
The nest abuts a chimney that leads down to Talis's bedchamber (area 18) and belongs to a mated pair of [perytons](/3-Mechanics/CLI/bestiary/monstrosity/peryton-xmm.md). Several times during the day, the perytons leave their nest to hunt for food. There's a 50 percent chance that the nest is empty during the day; at night, both perytons are roosting here.
...
The nest provides reasonable traction and a good perch for the perytons, but the sloped roof is tricky to stand on. At the start of its turn or whenever it takes damage, a creature standing on the roof must succeed on a DC 10 Dexterity saving throw. On a failed saving throw, the creature falls [prone](/3-Mechanics/CLI/conditions.md#Prone) on the roof; if the saving throw fails by 5 or more, the creature slips and falls off the roof, taking `2d6` bludgeoning damage and landing [prone](/3-Mechanics/CLI/conditions.md#Prone) on the ground.

#### Treasure

The nest contains bones, old bits of armor, a punctured helmet, and other detritus. Digging around for 1 minute or more also reveals two treasures: an ancient [arrow-catching shield](/3-Mechanics/CLI/items/arrow-catching-shield-xdmg.md) and a bag of tarnished silverware worth 100 gp.
