---
aliases: ["Investigate the Demons", "investigate the demons", "Investigate Demons", "Demons the Investigate"]
tags: [generated]
id: QUEST0056
...
## Quest Giver
**Quinn Darkwater** - Mysterious stranger
...
## Key Locations
- **OldVale** (City): Key location for quest progression
- **Peakridge** (Dungeon): Key location for quest progression
- **FortVale** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Cultists** led by Quinn Shadowmere
