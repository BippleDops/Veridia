...
## Quest Giver
**Willem Darkwater** - Powerful merchant
...
- **WestMarsh** (Dungeon): Key location for quest progression
- **Hillmoor** (Wilderness): Key location for quest progression
- **Valemoor** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Constructs** led by Willem Shadowmere
