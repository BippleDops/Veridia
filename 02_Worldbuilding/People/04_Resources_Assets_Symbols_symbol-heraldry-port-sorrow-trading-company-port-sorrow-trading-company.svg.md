---
title: 04 Resources Assets Symbols symbol heraldry port sorrow trading company port
  sorrow trading company.svg
aliases:
- 04 Resources Assets Symbols symbol heraldry port sorrow trading company port sorrow
  trading companysvg
type: npc
tags:
- character
...
04_Resources/Assets/Symbols/symbol-heraldry-port-sorrow-trading-company-port-sorrow-trading-company.svg has established themselves as a notable figure in their domain. Their expertise and reputation precede them, making them a valuable contact for those who earn their respect.
...
04_Resources_Assets_Symbols_symbol-heraldry-port-sorrow-trading-company-port-sorrow-trading-company.svg presents a distinctive figure. Their bearing suggests both competence and experience. Notable features include:
...
- First mentioned in: ![[04_Resources/Assets/Symbols/symbol-heraldry-por...
...
- [[04_Resources_Assets_Locations_location-city-guildmaster-harwick-guildmaster-harwick.png]]: *bitter rival*
- [[The Emerald Sage Willowbark]]: *mentor*
- [[The_Crimson_Pearl]]: *former lover*
...
### Known Associates
- [[Memory Merchant Valeria Siltweave]] (rival)
