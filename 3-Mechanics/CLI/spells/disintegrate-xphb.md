...
A creature targeted by this spell makes a Dexterity saving throw. On a failed save, the target takes `10d6 + 40` Force damage. If this damage reduces it to 0 [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md), it and everything nonmagical it is wearing and carrying are disintegrated into gray dust. The target can be revived only by a [True Resurrection](/3-Mechanics/CLI/spells/true-resurrection-xphb.md) or a [Wish](/3-Mechanics/CLI/spells/wish-xphb.md) spell.
