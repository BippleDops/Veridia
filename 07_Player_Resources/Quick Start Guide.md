...
### Resources
- Full Player Handbook: [[02_Worldbuilding/Lore/Player Handbook]]
- Character Creation: [[07_Player_Resources/Character Creation Extended]]
- Faction Details: [[07_Player_Resources/Faction Guide]]
- World Lore: [[07_Player_Resources/World Primer]]
- Rules Reference: [[02_Worldbuilding/Lore/Complete Rules Reference]]
...
Quick Start Guide is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of Quick Start Guide as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Quick Start Guide.

## Adventure Hooks

- A rumor ties Quick Start Guide to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at Quick Start Guide to avert a public scandal.
- A map overlay reveals a hidden approach to Quick Start Guide active only during specific tides/storms.
...
- [[07_Player_Resources/Character Creation Extended]]
- [[07_Player_Resources/Faction Guide]]
- [[07_Player_Resources/World Primer]]
