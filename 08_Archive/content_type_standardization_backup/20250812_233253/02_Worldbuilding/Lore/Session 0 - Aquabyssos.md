...
### Core Mechanics
- Character creation with aquatic adaptation considerations
- Pressure and depth limitation establishment
- Inter-species relationship guidelines
- Campaign theme and tone agreement
- Safety tool implementation
- World knowledge baseline establishment

### Requirements
- All players must participate in full Session 0 process
- Character concepts must be setting-appropriate
- Basic understanding of aquatic survival principles
- Agreement to campaign social contract
- Completion of safety tool discussion

### Effects
- Establishes clear campaign expectations and boundaries
- Ensures character concepts work within setting parameters
- Creates shared understanding of world basics
- Implements safety measures for potentially difficult content
- Sets foundation for collaborative storytelling
...
## Key Figures
- **Campaign Masters Guild**: Developers of standardized Session 0 procedures
- **The Depth Wardens**: Contributors to safety protocol development
- **Cultural Ambassadors**: Providers of inter-species relationship guidance
- **Pressure Adaptation Specialists**: Technical consultants for character creation guidelines
...
### Known Mysteries
- Why some character concepts seem naturally suited to the Deep Mother's influence
- The correlation between player choices in Session 0 and campaign outcomes
- Patterns in character creation that predict successful adaptation to underwater life

### Hidden Truths
- Session 0 character choices may unconsciously reflect ancient bloodline connections
- Certain character concept combinations have historically led to campaign-altering events
- The collaborative world-building process sometimes reveals information not intended by the DM
- Players who resist Session 0 preparation often face greater corruption exposure risks
...
## Session 0 Checklist
### Character Creation
- [ ] Aquatic adaptation method established
- [ ] Background connections to Aquabyssos or Aethermoor
- [ ] Inter-party relationships defined
- [ ] Pressure tolerance and depth limitations set
- [ ] Cultural knowledge appropriate to character background

### World Orientation
- [ ] Basic geography and political structure explained
- [ ] Inter-species relationships and social norms covered
- [ ] Survival mechanics and adaptation requirements discussed
- [ ] Current events and campaign starting situation established
- [ ] Available resources and support networks identified

### Campaign Framework
- [ ] Themes and tone agreement reached
- [ ] Content boundaries and safety tools implemented
- [ ] Player expectations and DM style aligned
- [ ] Communication protocols established
- [ ] Schedule and commitment level confirmed

### Safety Considerations
- [ ] Pressure and claustrophobia comfort levels discussed
- [ ] Isolation and underwater themes addressed
- [ ] Corruption and body horror boundaries established
- [ ] Political and social conflict comfort zones identified
- [ ] Emergency protocols for content issues agreed upon

## Character Creation Guidelines
### Species Considerations
- **Aquatic Native Species**: Natural advantages but may face political complications
- **Surface Dwellers**: Require adaptation methods but bring unique perspectives
- **Hybrid or Enhanced**: Magical or technological augmentation options available
- **Constructed Beings**: Special considerations for pressure and water exposure

### Background Integration
- Connect character histories to ongoing world events
- Establish relationships with key NPCs and organizations
- Consider depth adaptation training and specializations
- Address cultural knowledge and social connections
- Plan character growth arcs that utilize setting elements

### Mechanical Considerations
- Aquatic movement and combat capabilities
- Pressure resistance and depth adaptation scores
- Communication methods across species barriers
- Equipment modifications for underwater use
- Magical or technological adaptation requirements
...
Legends speak of Session 0   Aquabyssos as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Session 0   Aquabyssos.
