...
# The Crystal Cave Invasion

*Escort Quest for levels 5-9*

**ID**: QUEST0098

## Quest Giver
**Soren Brightblade** - Desperate noble
...
## Key Locations
- **Fallsthorpe** (City): Key location for quest progression
- **Grovethorpe** (Dungeon): Key location for quest progression
- **Haventon** (Wilderness): Key location for quest progression
- **SouthHaven** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Undead** led by Soren Fireborn
...
- **Gold**: 3,405 gp
- **Experience**: 5,000 XP
- **Magic Items**: Cursed Tome of the Dawn
- **Other**: Noble title
