...
# Journeys through the Radiant Citadel - Integration Index
...
## Description
Anthology of culturally diverse adventures
...
TABLE WITHOUT ID
    ...
    cr as "CR",
    status as "Status"
FROM "Journeys_through_the_Radiant_Citadel/Monsters"  
WHERE type = "Monster"
SORT cr
```
...
TABLE WITHOUT ID
    ...
    status as "Status" 
FROM "Journeys_through_the_Radiant_Citadel/Adventures"
