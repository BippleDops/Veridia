...
type: note
created: 2025-07-23
updated: '2025-08-13T01:18:32.263084+00:00'
...
![](/03_Mechanics/CLI/adventures/hoard-of-the-dragon-queen/img/006-tod-01-01.webp#center)
...
> [!gallery]
> ![Map 1.1: Greenest](/03_Mechanics/CLI/adventures/hoard-of-the-dragon-queen/img/007-map-1-1-greenest.webp#gallery)
> ![Player Version](/03_Mechanics/CLI/adventures/hoard-of-the-dragon-queen/img/008-map-1-1-greenest-player.webp#gallery)

### Important Characters

#### Governor Nighthill

![Tarbaw Nighthill](/03_Mechanics/CLI/adventures/hoard-of-the-dragon-queen/img/009-tod-01-02.webp#center)
...
The streets of Greenest are overrun by forces consisting of [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) and [acolytes](/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) accompanied by monstrous allies: [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) with [ambush drakes](/03_Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D) and [giant lizards](/03_Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md). These raiders move through town without fear, pillaging as they go. As characters travel through the embattled village, they can run into raiders and townsfolk. Use these guidelines to determine if characters have an encounter.

If characters use cover and stealth to avoid encounters, have each character attempt a DC 10 Dexterity ([Stealth](/03_Mechanics/CLI/skills.md#Stealth)) check. For every two individual checks that fail, the characters have one encounter on the way to their destination. Roll a `d8` on the Chapter 1 Encounters table to determine each encounter. If characters use the stream bed for cover for most of the trip, these characters have advantage on their Dexterity checks.
...
| dice: d8 | Encounter |
|----------|-----------|
| 1 | 6 [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) |
| 2 | 3 [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) and 1 [ambush drake](/03_Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D) |
| 3 | 6 [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) |
| 4 | 4 [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) and 1 [guard](/03_Mechanics/CLI/bestiary/humanoid/guard-xmm.md) |
| 5 | 2 [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) and 1 [acolyte](/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)* |
| 6 | 3 [guards](/03_Mechanics/CLI/bestiary/humanoid/guard-xmm.md) and 1 [acolyte](/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)* |
| 7 | `d6` townsfolk being hunted by raiders (roll a `d6` to determine the raiding group) |
| 8 | `d6` townsfolk hiding |
^encounter

* Acolytes have [command](/03_Mechanics/CLI/spells/command-xphb.md) prepared instead of [sanctuary](/03_Mechanics/CLI/spells/sanctuary-xphb.md).
...
Characters have random encounters with raiders when they enter Greenest, but this one should be their first mission of the chapter. It begins when a terrified human family (father, mother, and three young children) dash across their path, hounded by seven [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md).
...
The woman is [Linan Swift](/03_Mechanics/CLI/bestiary/npc/linan-swift-hotdq.md), and her husband is Cuth. Linan is a [commoner](/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) but with 8 hit points. Her attack with the spear is `+2` to hit for `d6` piercing damage. Her husband is down to 2 hit points from an earlier fight. The children move at speed 20. They can be carried, but a character carrying a child has disadvantage on attack rolls and cannot wield a two-handed weapon.
...
To reach the keep, the characters must make it past three groups of raiders. A group consists of `d6` [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) and `d4` [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md). If the group contains six kobolds, one is a [winged kobold (urd)](/03_Mechanics/CLI/bestiary/dragon/winged-kobold-xmm.md).
...
Characters can clear the cellar door with a few minutes' work. The lock is stiff but opens with the key; without the key, the character can open the lock with a successful DC 10 Dexterity check and a set of [thieves' tools](/03_Mechanics/CLI/items/thieves-tools-xphb.md). The disused tunnel is choked with webs but is otherwise clear. A few yards inside the stream end is a nest of two [swarms of rats](/03_Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md). The rats attack when disturbed, and the surviving rats flee when half their number die.

Years of exposure and neglect have corroded the lock on the exit grate. Even with the key, a successful DC 10 Dexterity check is needed to open the lock. Without the key, the DC increases to 20. If the roll misses by 5 or more, the key or [thieves' tools](/03_Mechanics/CLI/items/thieves-tools-xphb.md) break off in the lock so that unlocking it becomes impossible. Then only a successful DC 15 Strength check can force the grate open.

#### Foes

A group of cultists is searching the stream banks for hiding townsfolk when the characters emerge from the tunnel. If characters open the lock with the key or with [thieves' tools](/03_Mechanics/CLI/items/thieves-tools-xphb.md), the first one to exit notices the raiders approaching without being spotted in return; the characters can keep out of sight in the tunnel or try to ambush the raiders after they pass. If the check fails, the raiders spot the character; roll initiative and proceed with combat. If the grate had to be broken open with a Strength check, the raiders hear the noise and find cover; they wait for the characters to exit the tunnel, then gain a surprise round. The raiders' group consists of two [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) and six [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md). If any cultists are still alive at the beginning of the fourth round of the fight, one of them runs to fetch help. Ten minutes later, two [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md), ten [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md), and one [ambush drake](/03_Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D) arrive to guard the tunnel.
...
To secure the sally port, characters must battle through two groups of foes. The first fight occurs against three [acolytes](/03_Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md), three [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md), and one [ambush drake](/03_Mechanics/CLI/bestiary/dragon/ambush-drake-hotdq.md) (see appendix D), which are guarding the sally port's 10-foot-by-20-foot ready room against exactly this type of counterattack. After characters seize the room, they discover that the door is heavily damaged. The fastest repair is with five castings of [mending](/03_Mechanics/CLI/spells/mending-xphb.md) (taking five minutes). If none of the characters can do this, an NPC in the keep knows the cantrip. Someone must find and fetch her to the ready room.

Before the door can be repaired, a second group of raiders consisting of two [guards](/03_Mechanics/CLI/bestiary/humanoid/guard-xmm.md), three [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md), and three [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) attacks. These foes can come from outside the keep, or they might be a group of infiltrators trying to fight its way back outside. If characters barricade the door with barrels or other heavy objects while awaiting repairs, they might hold off attackers until the repairs are finished and avoid this fight entirely.
...
The [adult blue dragon](/03_Mechanics/CLI/bestiary/dragon/adult-blue-dragon-xmm.md) Lennithon accompanied this raid but is not an enthusiastic participant. Its chief contribution has been its Frightful Presence, but that becomes less effective as the night wears on and defenders overcome their fear. Shortly before midnight, the dragon launches a final assault against the citadel. [Frulam Mondath](/03_Mechanics/CLI/bestiary/npc/frulam-mondath-hotdq.md) orders the attack, knowing that the adventurers are in the keep at the time. Lennithon doesn't consider this to be its fight, and it isn't keen on tangling with adventurers for another's benefit.
...
Characters earn 50 XP each for driving away Lennithon, but reduce that award to 25 XP if 10 or more defenders were killed during the attack. For their role in driving off the dragon, the characters receive four [potions of healing](/03_Mechanics/CLI/items/potion-of-healing-xdmg.md) from the grateful Governor Nighthill.
...
- Captured kobolds are terrified; they say whatever they think the questioner wants to hear. They know that they're working for the Cult of the Dragon and for the "dragon lady" ([Rezmir](/03_Mechanics/CLI/bestiary/npc/rezmir-hotdq.md)), and that they're after loot.  
...
Roll a `d6` on the Chapter 1 Encounters table to determine the strength of the raiders that are trying to set fire to the mill. Any kobolds in this force run away as soon as two or more raiders are killed. If characters observe the mill for a minute or more before attacking, allow them to attempt DC 15 Wisdom ([Insight](/03_Mechanics/CLI/skills.md#Insight)) or Charisma ([Performance](/03_Mechanics/CLI/skills.md#Performance)) checks. If successful, a character realizes that the raiders are making a demonstration of starting a fire, but it's for show. A few fires are burning around the building, but they could be extinguished easily.

This act of burning the mill is a ruse. Mondath has been informed that heroes are aiding the town, and she wants to lure them into an ambush. More raiders—one [cultist](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) and one [guard](/03_Mechanics/CLI/bestiary/humanoid/guard-xmm.md) per character—are hiding inside the mill, waiting for the characters to show up.
...
The ambushers are waiting in the loft for heroes to enter the mill. When the heroes are inside, the guards launch a volley of spears from above, then leap down to fight hand-to-hand. The ambushers have a good chance to gain a surprise round for their spear volley; a successful DC 20 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check is needed to notice them before the attack. Characters who scan the loft for hidden enemies upon entering the mill have advantage on the check.
...
The speaker is [Langdedrosa Cyanwrath](/03_Mechanics/CLI/bestiary/npc/langdedrosa-cyanwrath-hotdq.md) (see appendix D for statistics) a half-blue dragon who serves the Cult of the Dragon. Cyanwrath has a personal troop of sixteen [kobolds](/03_Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md). A character who makes a successful DC 15 Intelligence ([Arcana](/03_Mechanics/CLI/skills.md#Arcana)) or Intelligence ([Nature](/03_Mechanics/CLI/skills.md#Nature)) check recognizes the creature as a half-dragon from descriptions.
...
If a character steps up to the challenge and fights Cyanwrath, each party member earns 50 XP. If not, characters receive nothing for this encounter. A team of healers with healer's kits and +4 bonuses to Wisdom ([Medicine](/03_Mechanics/CLI/skills.md#Medicine)) checks attend to the wounded or dying character, and Governor Nighthill gratefully offers two [potions of healing](/03_Mechanics/CLI/items/potion-of-healing-xdmg.md) to the wounded character. If characters do something that costs the life of a hostage, Governor Nighthill is furious with them and offers no more help.
