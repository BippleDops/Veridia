...
# The Wild Beyond the Witchlight - Integration Index
...
## Description
Feywild carnival and fey adventure
...
TABLE WITHOUT ID
    ...
    cr as "CR",
    status as "Status"
FROM "The_Wild_Beyond_the_Witchlight/Monsters"  
WHERE type = "Monster"
SORT cr
```
...
TABLE WITHOUT ID
    ...
    status as "Status" 
FROM "The_Wild_Beyond_the_Witchlight/Adventures"
