...
When you attack a creature with this magic weapon and roll a 20 on the `d20` for the attack roll, that target takes an extra 15 Necrotic damage if it isn't a Construct or an Undead, and you gain [[temporary-hit-points-xphb (variant-rules)]] equal to the amount of Necrotic damage taken.
...
Sword of life stealing xdmg is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
