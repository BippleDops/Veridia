...
## Appearance
Above average and slender, with Tied back auburn hair and Amber eyes. Olive skin. Piercing gaze that seems to see through you.

**Clothing**: Sailor's outfit with salt stains
**Accessories**: Decorated dagger

## Personality
- **Traits**: Never uses people's real names; Sees doom and gloom everywhere; Believes in every conspiracy theory
...
- **Quirks**: Always carries a lucky charm, Counts everything obsessively, Never eats meat
- **Fear**: Betrayal
...
## Current Situation
- **Occupation**: Bodyguard
- **Resources**: Survival skills, Magic items, Treasure maps
...
### Felicia Blackstone the Scholar (Professional - Employee)
...
### Attacks
- Longsword: +7 to hit, 1d8+2 slashing
...
- Spellcasting: 4 spell slots, knows Charm Person, Scorching Ray, Fly, Hold Person, Magic Missile, Shield
