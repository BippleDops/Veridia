...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["INDEX (Baldur's Gate Descent into Avernus)"]
status: active
priority: normal
...
**Type**: Campaign **Level Range**: 1-13 **Themes**: planar, devils, redemption, war **Integration Status**: Available ## Description

Planar adventure through the Nine Hells ### 🎭 NPCs```dataview
...
FROM "Baldur's_Gate_Descent_into_Avernus/Monsters" WHERE type = "Monster"
...
SORT rarity ### 📜 Adventures & Scenarios file.link as "Adventure", suggested_level as "Level", status as "Status" FROM "Baldur's_Gate_Descent_into_Avernus/Adventures"
...
- Connections to overarching campaign themes ## Secret Connections *[Hidden from players]* Connected to The Hidden Alliance - Manipulate succession ## 12_Research Specific Content Contextual improvement based on 12_Research
