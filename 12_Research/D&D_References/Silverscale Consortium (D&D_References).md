...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Silverscale Consortium (D&D References)"]
status: active
priority: normal
...
--- > [!figure] Heraldry # The Silverscale Consortium
...
- Survived three attempts at nationalization ### Expansion Period (150-50 Years Ago)

**The Economic Wars**
- Absorbed 17 competing guilds
- Established continental trade routes
- Created crystal futures market
- Introduced debt-based noble ficing
- Survived assassination of three directors ### Modern Domice (Last 50 Years)
...
- Smuggling operations (secret) #### Banking & Fice
...
- Vault services
- Investment schemes
- Foreclosure enforcement #### Information Brokerage
...
- Competitor sabotage
- Prophecy trading
- Memory markets (Aquabyssos branch) #### Private Military
...
- Corporate espionage
- Assassination (denied) #### Research & Development
...
- Forbidden experiments ### Public Activities

1. **Crystal Trade**: Maintain market domice
