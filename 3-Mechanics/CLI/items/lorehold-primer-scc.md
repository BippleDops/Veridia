...
The Lorehold Primer is a magic textbook created at Strixhaven's Lorehold College. The primer has 3 charges, and it regains `d3` expended charges daily at dawn. If you make an Intelligence ([History](/3-Mechanics/CLI/skills.md#History)) or Intelligence ([Religion](/3-Mechanics/CLI/skills.md#Religion)) check while holding the primer, you can expend 1 charge to give yourself `d4` bonus to the check, immediately after you roll the `d20`.
