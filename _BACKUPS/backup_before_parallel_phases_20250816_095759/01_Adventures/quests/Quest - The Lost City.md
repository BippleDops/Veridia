...
subcategory: Quest - The Lost City.Md
related: []
cssclass: standard
publish: false
...
status: active
world: Both
updated: '2025-08-13T01:18:34.640787+00:00'
...
- Hidden goals ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Quest The Lost City is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. Subsequently, ## Lore Details Legends speak of Quest The Lost City as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Quest The Lost City. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Prophecy Connection Mentioned in The Second Prophecy of Depths ## Plot Hooks - A document has gone missing and evil awakens

- A merchant needs help investigating before dawn
- The authorities needs help investigating before the new moon ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research ## Background
