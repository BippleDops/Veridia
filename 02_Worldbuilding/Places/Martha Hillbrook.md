...
accessibility:
  ...
  - X-Card
  - Open Door
  screen_reader_summary: Martha Hillbrook is a notable location in Aquabyssos shaped
    by tidal politics and Convergence anomalies. This entry is structured for fast
    table use.
obsidianUIMode: preview
updated: '2025-08-13T12:34:16.783766+00:00'
world: Aquabyssos
---
...
Martha Hillbrook is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of Martha Hillbrook as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Martha Hillbrook.

## Adventure Hooks

- A rumor ties Martha Hillbrook to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at Martha Hillbrook to avert a public scandal.
- A map overlay reveals a hidden approach to Martha Hillbrook active only during specific tides/storms.
...
- [[Void Currents]]
- [[04_Resources_Assets_Locations_location-city-reality-anchor-network-reality-anchor-network.svg]]
- [[04_Resources_Assets_Locations_location-city-living-stone-living-stone.svg]]
...
Martha Hillbrook is a notable location characterized by its unique features and strategic importance. The area serves as a hub for local activity and holds significance in the broader region.
...
### Landmarks
- **Central Structure**: The defining feature of Martha Hillbrook
...
### Founding
Martha Hillbrook was established in the distant past, growing from humble beginnings to its current state.
...
Ongoing situations affecting Martha Hillbrook:
...
### Common Knowledge
- What everyone knows about Martha Hillbrook
