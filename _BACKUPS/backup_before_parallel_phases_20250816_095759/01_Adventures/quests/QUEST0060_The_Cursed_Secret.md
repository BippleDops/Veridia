---
aliases: ["The Cursed Secret", "the cursed secret", "Secret Cursed The"]
...
## Quest Giver
**Ulric Darkwater** - Worried parent
...
## Key Locations
- **Havenmoor** (City): Key location for quest progression
- **Bridgemoor** (Dungeon): Key location for quest progression
- **Watchmoor** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Corrupt Guards** led by Ulric Shadowmere
...
- **Gold**: 2,210 gp
- **Experience**: 4,000 XP
- **Magic Items**: Eldritch Circlet of Power
...
---
*Generated: 2025-08-15T03:21:04.090Z*
