...
> [!figure] Item
![](04_Resources/Assets/Generated/Items/item-artifact-military-saddle-xphb-military-saddle-xphb.svg)
...
A saddle comes with a bit, a bridle, reins, and any other equipment needed to use the saddle. A Military Saddle gives [Advantage](/03_Mechanics/CLI/variant-rules/advantage-xphb.md) on any ability check you make to remain mounted.
...
Military saddle xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
