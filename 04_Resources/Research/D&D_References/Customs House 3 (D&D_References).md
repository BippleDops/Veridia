...
title: Customs House 3 (D&D_References)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Customs House 3 (D&D References)"]
status: active
priority: normal
...
- **Depth Patrol Headquarters**: Base for Aquabyssos border enforcement units ### The Merged Center
...
- **Neutral Ground**: Protected by treaties from both worlds **The Gateway Arch**
...
- **Dual Jurisdiction**: Staffed by officers from both worlds ### Trade Facilitation

**Legal Commerce Processing**

The Customs House manages the growing trade between worlds: **Documentation Requirements:**
...
- **Cultural Compliance**: Assurance that imports respect local values and laws **Processing Procedures:**
...
- **Criminal Screening**: Background checks preventing dangerous individuals from crossing ### Intelligence Gathering
...
- Can operate effectively in both air and water environments **Depth Patrol Customs Division (18 members)**
...
- Cross-trained to work with crystal-based Aethermoor technology **Joint Investigation Unit (12 members)**
...
- Emergency interpreters for crisis situations **Technical Specialists**
...
- Maintece crews keeping dual-reality facilities functional ### Major Trade Categories **Aethermoor Exports to Aquabyssos:**
...
- **Information Storage**: Crystal-based data preservation systems **Aquabyssos Exports to Aethermoor:**
...
- **Pressure Vessels**: Containers capable of maintaining various environmental conditions **Hybrid Innovations:**
...
- **Memory Crystals**: Storage devices combining both worlds' information technologies ### Economic Impact **Trade Volume Statistics (Annual):**
...
- **Employment**: 2,000 direct jobs, 10,000 indirect positions **Regional Effects:**
...
- **Corruption Extractors**: Chemicals that both cause and cure shadow corruption **Prohibited Information:**
...
- **Royal Intelligence**: Classified information about government possession ### Smuggling Methods **Concealment Techniques:**
...
- **Consciousness Riding**: Hiding illegal personalities in legitimate minds **Corruption of Officials:**
...
- **Ideological Conversion**: Converting officials to smuggling organization beliefs ### Law Enforcement Response **Detection Systems:**
...
- **Temporal Tracking**: Methods following objects across time distortions **Enforcement Actions:**
...
- **Public Trials**: High-profile prosecutions deterring other smugglers ### Governmental Conflicts **Jurisdiction Disputes:**
...
- **Research Opportunities**: Studying Marina's condition to help others ### [[Shadow Corruption]]
...
- **Intelligence Sharing**: Tracking corruption spread patterns ### Late Campaign
...
- Shape post-convergence role of interdimensional trade --- *"Where two worlds meet, opportunity and danger walk hand in hand through the same door."*

*- Chief Inspector Dual-Current Thane* ## Player-Facing Summary Customs House is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of Customs House as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Customs House. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Secret Connections *[Hidden from players]* Connected to The Shadow Alliance - Control trade routes ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research
