...
*Infiltrate Quest for levels 5-9*

**ID**: QUEST0087

## Quest Giver
**Hilda Brightblade the Brave** - Mysterious stranger
...
## Key Locations
- **NewFalls** (City): Key location for quest progression
- **FortFalls** (Dungeon): Key location for quest progression
- **Grovewick** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Elementals** led by Hilda Fireborn the Elder
