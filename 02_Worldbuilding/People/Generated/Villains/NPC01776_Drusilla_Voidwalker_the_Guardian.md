...
## Relationships
### Brenna Youngblood the Wanderer (Political - Spy)
...
### Idris Stormwind the Risen (Family - Child)
- **Status**: One-sided affection
...
- Dark Blessing: Resistance to one damage type
- Dark Blessing: Resistance to one damage type
- Spellcasting: 10 spell slots, knows Scorching Ray, Invisibility, Misty Step, Fly, Lightning Bolt, Counterspell, Fireball
