--- aliases:
- NPC Name Generatorpng class: Unknown
created: 2025-08-14
...
race: Unknown
tags:
- npc title: NPC Name Generator.png
type: npc
updated: 2025-08-14
status: active
priority: normal
...
related: []
cssclass: standard
publish: false --- # NPC_Name_Generator.png_1 ## Portrait![[Npc|portrait_npc_name_generator.png_1_(03_people).png]] *Portrait reference for NPC_Name_Generator.png_1 (03_People)* ## Overview ## Description {#description} Detailed description pending. NPC_Name_Generator.png_1 is a notable figure in the realm, known for their unique skills and complex motivations. ## Appearance - **Age**: Middle-aged
...
- **Flaws**: Tendency to overthink situations ## Background Born into modest circumstances, NPC_Name_Generator.png_1 rose through dedication and cunning to their current position. ## Abilities - **Skills**: Investigation, Persuasion, Insight
...
- **Skills**: *[Skill proficiencies]* ## References - [[NPC_Name_Generator.png_1 (03_People)_Quick_Ref|Npc Name Generator.Png 1 (03 People) Quick Ref]] ## Notes {#notes} *Additional notes* #mechanics/combat
#story/plot
#story/background
#world/location
#character/npc
