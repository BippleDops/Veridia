---
updated: '2025-08-13T01:18:32.961567+00:00'
created: 2025-08-11
type: monster
...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6 (1d6\
      ...
      \ creature is visible within 30 feet, it takes the [Dash](/03_Mechanics/CLI/actions.md#Dash)\
      \ action, moving toward the nearest creature.  \n- 3–4 Paralysis. The target\
      \ is [paralyzed](/03_Mechanics/CLI/conditions.md#Paralyzed) until the end of\
...
"source":
  - "MPMM"
  - "MTF"
"image": "/03_Mechanics/CLI/bestiary/construct/token/clockwork-iron-cobra-mpmm.webp"
```
^statblock
...
Clockwork iron cobra mpmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of clockwork iron cobra mpmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around clockwork iron cobra mpmm.

## Adventure Hooks

- A rumor ties clockwork iron cobra mpmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at clockwork iron cobra mpmm to avert a public scandal.
- A map overlay reveals a hidden approach to clockwork iron cobra mpmm active only during specific tides/storms.
