...
- Training exercises using echo dimension scenarios #### Echo Encounter Types`dice: 1d12`| d12 | Encounter | | status: active
aliases: ["Session 11 the Echo Wars"]
priority: normal
...
| 11-12 | Dimensional anomaly affecting both realities | #### Reality Flux Effects`dice: 1d8`| d8 | Effect | |----|--------|
