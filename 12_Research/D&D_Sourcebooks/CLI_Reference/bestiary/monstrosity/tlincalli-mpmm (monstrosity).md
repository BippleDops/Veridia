...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 6\
      \ (1d6 + 3) piercing damage, and the target is [[conditions#Grappled|grappled]]\
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 6\
      ...
      \ succeed on a DC 14 Constitution saving throw or be [[conditions#Poisoned|poisoned]]\
      \ for 1 minute. If it fails the saving throw by 5 or more, the target is also\
      \ [[conditions#Paralyzed|paralyzed]] while [[conditions#Poisoned|poisoned]].\
