...
On its turn, the stone moves 60 feet in one direction, changing course if redirected by an obstacle. The stone can move through creatures' spaces, and creatures can move through the stone's space, treating it as [[/03_Mechanics/CLI/variant-rules/difficult-terrain-xphb|Difficult Terrain]]. Whenever the stone enters a creature's space for the first time on a turn or a creature enters the stone's space while the stone is rolling, that creature must succeed on a DC 15 Dexterity saving throw or take 55 (`10d10`) Bludgeoning damage and have the [[/03_Mechanics/CLI/conditions#Prone|Prone]] condition.
...
As a [[/03_Mechanics/CLI/actions#Study|Study]] action, a creature can examine the section of floor that forms the pressure plate and make a DC 15 Intelligence ([[/03_Mechanics/CLI/skills#Investigation|Investigation]]) check, deducing the pressure plate's function on a successful check. Wedging an Iron Spike or a similar object under the pressure plate prevents the trap from triggering.

## Destroy the Stone

The stone is a Large object that has AC 17, HP 100, a [[/03_Mechanics/CLI/variant-rules/damage-threshold-xphb|Damage Threshold]] of 10, and [[/03_Mechanics/CLI/variant-rules/immunity-xphb|Immunity]] to Poison and Psychic damage.

## Slow the Stone

As an action, a creature can try to slow down the stone with a DC 20 Strength ([[/03_Mechanics/CLI/skills#Athletics|Athletics]]) check. If the check is successful, the distance the stone moves on its turn is reduced by 15 feet. If that distance drops to 0, it stops moving and is no longer a threat.
