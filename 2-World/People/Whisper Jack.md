...
occupation: Master Thief & Information Broker
...
appearance:
  ...
  distinguishing: Never shows his true face in public, always wears different disguises, has a distinctive scar on his left hand from a job gone wrong
personality:
  traits: 
    - Master of disguise and deception
    - Surprisingly honorable within his own moral code
    - Collects information like others collect coins
  ideals: 
    - Information should flow freely (for the right price)
    - Loyalty must be earned and maintained
  bonds: 
    - The Undercity children he protects and trains
    - His word is his bond - never breaks a deal
  flaws: 
    - Cannot resist a challenging heist
    - Paranoid about his true identity being discovered
motivation: "To maintain the balance of power in Shadowhaven while building a network that protects the city's forgotten people"
secrets: 
  - Was once a legitimate merchant's son before his family was destroyed by corrupt nobles
  - Secretly feeds information to city guards about truly dangerous criminals
  - Has a hidden vault containing enough evidence to topple three council members
  - Is planning his greatest heist yet - stealing something from the Arcane District that could change everything
firstMet: 
lastSeen: 
sessions: []
# Combat Stats
...
allies: 
  - "[[Orphan Network]]"
  - "[[Captain Marcus Steelhart]]" (secretly)
enemies: 
  - "[[Councillor Elara Brightwater]]"
  - "[[Lord Blackwater]]" (deceased - revenge complete)
family: 
  - "[[The Brightwater Family]]" (responsible for his family's downfall)
# Visual
image_path: z_Assets/Characters/whisper_jack_disguise.jpg
voice_reference: Changes with each disguise, but naturally has a smooth baritone
# Meta
created: 2025-01-25 11:00
modified: 2025-01-25 11:00
---
