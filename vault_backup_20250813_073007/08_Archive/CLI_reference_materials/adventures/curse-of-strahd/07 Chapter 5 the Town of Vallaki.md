...
- world/both
type: note
updated: '2025-08-13T12:34:19.212236+00:00'
world: Both
---
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/047-013.webp#gallery|Map 5.1: Vallaki (Area N)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/048-cos05-02-player.webp#gallery|Player Version]]
...
Two town [[/03_Mechanics/CLI/bestiary/humanoid/guard-xmm|guards]] (LG male and female humans) stand just inside each gate. Instead of spears, they carry pikes (reach 10 ft., `1d10 + 1` piercing damage on a hit). These weapons are long enough to stab creatures through the bars of the gate. The guards greet all visitors with suspicion, particularly those who arrive at night. If the characters arrive at night, one or more of them must succeed on a DC 20 Charisma ([[/03_Mechanics/CLI/skills#Persuasion|Persuasion]]) check to convince the guards to unlock the gate and let them enter.

If trouble breaks out at one of the gates, the guards there cry out, "To arms!" Their shouts are echoed across Vallaki, putting the entire town on alert within minutes. Vallaki has twenty-four human [[/03_Mechanics/CLI/bestiary/humanoid/guard-xmm|guards]], half of whom are on duty at any given time (six stand watch at the gates, six patrol the walls). The town can also muster a militia of fifty able-bodied human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]] armed with clubs, daggers, and torches.
...
|-----------|----------|
| 1–3 | None |
| 4–5 | `2d4` [[/03_Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm|swarms of rats]] |
...
A house of Vallakian townsfolk contains `d4` adults (male and female human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]) and `d8`−1 children (male and female human noncombatants). Anyone who listens at the door hears chatter from within. Townsfolk won't willingly invite strangers into their homes, but they will speak with characters from behind closed doors or while standing in their vestibules.

#### Cultists

A cult haven contains `2d4` Vallakian adults (LE male and female [[/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm|cultists]]) and one [[/03_Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm|cult fanatic]] (LE male or female) who leads them in prayer or orchestrates ritual sacrifices. These cultists worship devils and consider [[/03_Mechanics/CLI/bestiary/npc/lady-fiona-wachter-cos|Lady Fiona Wachter]] (see area N4) to be their spiritual leader.
...
- The burgomaster, [[/03_Mechanics/CLI/bestiary/npc/baron-vargas-vallakovich-cos|Baron Vargas Vallakovich]], has decreed that the Festival of the Blazing Sun will be held in the town square (area N8) in three days. The previous festival, which he called the Wolf's Head Jamboree, was less than a week ago.  
...
- The burgomaster's henchman, [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]], has a history of violence as well as a fiendish deformity: a monstrous arm with which he can conjure fire. Fear of Izek keeps the baron's enemies at bay.  
- No one hates the burgomaster more than [[/03_Mechanics/CLI/bestiary/npc/lady-fiona-wachter-cos|Lady Fiona Wachter]], who is often quoted as saying, "I'd rather serve the devil than a madman." She owns an old house in town (area N4) but rarely leaves her estate. Her two adult sons, Nikolai and Karl, are local troublemakers. Lady Wachter also has a mad daughter whom she keeps locked away. The burgomaster doesn't confront Fiona or her offspring because he is afraid of Lady Wachter, whose family has old ties to Strahd.  
...
- It's too dangerous to go fishing on Lake Zarovich (chapter 2, area L), but the threat of Strahd's wolves hasn't stopped [[/03_Mechanics/CLI/bestiary/npc/bluto-krogarov-cos|Bluto Krogarov]], the town drunk, from trying. He sets out each morning and returns every evening, but hasn't caught any fish in a while.  
- There have been no recent sightings of [[/03_Mechanics/CLI/bestiary/npc/the-mad-mage-of-mount-baratok-cos|the Mad Mage of Mount Baratok]] (chapter 2, area M). Folks used to see him skulking along the north shore of Lake Zarovich, shooting lightning bolts into the water to kill the fish. (If the characters seem interested in meeting this wizard, locals recommend that they use the fishing boats on the south shore to cross the lake, because it's shorter and a lot less dangerous than walking around the lake.)  
...
Father Lucian Petrovich (LG male human [[/03_Mechanics/CLI/bestiary/humanoid/priest-xmm|priest]]) oversees the church and does his best to raise spirits. Assisting him is an orphan and altar boy named Yeska (LG male human noncombatant). A brawny lad with a perpetually furrowed brow named [[/03_Mechanics/CLI/bestiary/npc/milivoj-cos|Milivoj]] (see below) tends the grounds and digs graves.

At night, the church is packed with `2d6 + 6` [[/03_Mechanics/CLI/conditions#Frightened|frightened]] Vallakian adults (male and female human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]) and `2d6` equally terrified Vallakian children (male and female human noncombatants). Father Lucian offers his nightly congregation his prayers and the promise of St. Andral's protection. Among Father Lucian's nightly flock is a sad old woman named Willemina Rikalova. Her son, the shoemaker Udo Lukovich, has been imprisoned for speaking out against the burgomaster (see area N3m). She prays that her son will be set free.

![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/049-cos05-03.webp#center|Milivoj]]

[[/03_Mechanics/CLI/bestiary/npc/milivoj-cos|Milivoj]] (N male human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]) is rarely seen without a shovel, which he wields like a club. Modify his statistics as follows:
...
[[/03_Mechanics/CLI/bestiary/npc/milivoj-cos|Milivoj]] rejects the burgomaster's proclamation that "All will be well!" and is frustrated that he can't protect his younger siblings. He wants to be free of Barovia's curse but sees no hope of escape.
...
The culprit is [[/03_Mechanics/CLI/bestiary/npc/milivoj-cos|Milivoj]], whom Father Lucian correctly suspects. But the priest has been reluctant to confront [[/03_Mechanics/CLI/bestiary/npc/milivoj-cos|Milivoj]] because the lad is so temperamental. Father Lucian has not reported the theft for fear of the distress that the news might cause, and he doesn't want to ruin the burgomaster's festival. If the party includes a good-aligned cleric or paladin, Father Lucian mentions the theft in the hope that the characters can provide assistance.

St. Andral's crypt is a 10-foot-square, 5-foot high chamber beneath the chapel. To reach the crypt, [[/03_Mechanics/CLI/bestiary/npc/milivoj-cos|Milivoj]] used his shovel to pry up the chapel floorboards. (The boards have since been replaced.) If one of the characters confronts [[/03_Mechanics/CLI/bestiary/npc/milivoj-cos|Milivoj]] and succeeds on a DC 10 Charisma ([[/03_Mechanics/CLI/skills#Intimidation|Intimidation]]) check, he admits that Yeska told him about the bones. He also admits to passing along the information to [[/03_Mechanics/CLI/bestiary/npc/henrik-van-der-voort-cos|Henrik van der Voort]], the local coffin maker (area N6), and to stealing the bones for Henrik in return for money to help feed his younger sisters and brothers.

The theft of the bones has left the church vulnerable to attack by Strahd's minions (see "St. Andral's Feast" in the "Special Events" section at the end of this chapter). If the bones are returned to their resting place, St. Andral's church once again becomes hallowed ground, as though the building was protected by a [[/03_Mechanics/CLI/spells/hallow-xphb|hallow]] spell.
...
The Blue Water Inn is Vallaki's main gathering place for locals, especially at night. The innkeeper, [[/03_Mechanics/CLI/bestiary/npc/urwin-martikov-cos|Urwin Martikov]], considers the inn a sanctuary from the evils of this land. In the event of trouble, the windows and doors can all be barred shut from within.
...
Urwin fails to mention that his cantankerous father, [[/03_Mechanics/CLI/bestiary/npc/davian-martikov-cos|Davian Martikov]], owns the local winery and vineyard, the Wizard of Wines (chapter 12). There's bad blood between Urwin and his father (whom Urwin and Danika refer to as "the old crow"). Although Urwin could easily visit the winery himself, he considers dealing with his father to be a worthy test of the characters' competence, and he makes good on his promise if they complete the quest and return with his wine shipment.

Urwin sends a [[/03_Mechanics/CLI/bestiary/humanoid/wereraven-vrgr|wereraven]] in raven form to observe the party's progress from a distance. If the characters get in trouble, the wereraven reports to Urwin at once.
...
From noon to dusk, the taproom holds `2d4` local patrons (male and female [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]). Between dusk and midnight, `2d8` Vallakians are here. In addition, one or more of the following people might be present during this time.

##### Wolf Hunters

[[/03_Mechanics/CLI/bestiary/npc/szoldar-szoldarovich-cos|Szoldar Szoldarovich]] and [[/03_Mechanics/CLI/bestiary/npc/yevgeni-krushkin-cos|Yevgeni Krushkin]] (N male human [[/03_Mechanics/CLI/bestiary/humanoid/scout-xmm|scouts]]) are local hunters who frequent the Blue Water Inn. They kill wolves and sell the meat for a living, and their work is dangerous and bloody. Both men are grim and have haunted looks in their eyes.
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/052-cos05-05.webp#gallery|Szoldar Szoldarovich]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/053-cos05-06.webp#gallery|Yevgeni Krushkin]]

##### Wachter Brothers

Nikolai and Karl Wachter (N male human [[/03_Mechanics/CLI/bestiary/humanoid/noble-xmm|nobles]]) are brothers of noble birth. They are brash drunkards always looking for trouble, though they are smart enough not to pick fights with well-armed strangers. Their mother, Fiona Wachter (see area N4), is an influential figure in town, but her sons never talk about her. They'd rather listen to tales of the characters' harrowing adventures or hear about how the characters plan to free Vallaki from the burgomaster's madness.

##### Rictavio

The lone guest of the Blue Water Inn at present is a colorfully dressed half-elf bard who goes by the name [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]]—a false identity adopted by the legendary vampire hunter Rudolph van Richten (see appendix D). He regales tavern patrons with stories so outrageous as to be hardly believable, yet he asserts they are true indeed. [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] claims to be a carnival ringmaster from a distant land. He's been staying at the inn for almost a month, taking advantage of [[/03_Mechanics/CLI/bestiary/npc/urwin-martikov-cos|Urwin Martikov]]'s generosity and good nature. When he arrived, he was accompanied by a monkey named [[/03_Mechanics/CLI/bestiary/npc/piccolo-cos|Piccolo]]. The monkey wasn't welcome at the inn, so [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] gave it to the local toymaker (see area N7).

[[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] admits to having no musical talent but manages to entertain locals nonetheless with his stories of faraway places. Twice each day, at dawn and again at dusk, he leaves the inn with a couple of apples and a cooked wolf steak wrapped in a handkerchief. He claims the food is for his portly friend, "the destitute toymaker" (area N7) and his pet monkey. In fact, the apples are for his horse Drusilla (area N2f), and the steak is for his captured saber-toothed tiger (area N5).

During his stay at the inn, [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] is quietly gathering information on the Keepers of the Feather, trying to figure out the identities of all the wereravens in town. He's also trying to learn as much as he can about the Vistani, particularly the ones living in the camp just outside town (area N9). Once he concludes that they are in league with Strahd, [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] plans to unleash his trained saber-toothed tiger upon them, with or without the support of the wereravens.

[[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] wears a [[/03_Mechanics/CLI/items/hat-of-disguise-xdmg|hat of disguise]] and a [[/03_Mechanics/CLI/items/ring-of-mind-shielding-xdmg|ring of mind shielding]] to conceal his identity. He carries an iron key that unlocks the door to his carnival wagon (area N5).
...
[[/03_Mechanics/CLI/bestiary/npc/urwin-martikov-cos|Urwin Martikov]], who prepares most of the meals, is found here throughout the day. He occasionally receives help from his two boys, but they are easily distracted. A cupboard against the east wall holds most of the inn's supply of cutlery and dishware, none of it valuable. A door in the west wall leads outside and is usually barred from the inside.
...
Any character who has a horse can keep it here for 1 sp per night. The gray mare is a [[/03_Mechanics/CLI/bestiary/beast/draft-horse-xmm|draft horse]] named Drusilla, and she likes apples. The horse belongs to [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] (see area N2c).
...
Characters who search the loft thoroughly find three pitchforks and a locked wooden chest buried under a pile of hay (see "Treasure" below), next to a secret door. If the characters tamper with the chest, the ravens gather into four [[/03_Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm|swarms of ravens]] and attack. If two swarms are killed, the others flee. Otherwise, they cease their attacks if the characters leave the chest alone. If the fighting continues for more than 3 rounds, [[/03_Mechanics/CLI/bestiary/npc/urwin-martikov-cos|Urwin Martikov]] and two other wereravens hear the ruckus and investigate (in human form).
...
Inside the locked chest are 140 ep, 70 pp, two [[/03_Mechanics/CLI/items/elixir-of-health-xdmg|elixirs of health]], three [[/03_Mechanics/CLI/items/potion-of-healing-xdmg|potions of healing]], and a [[/03_Mechanics/CLI/items/bag-of-tricks-gray-xdmg|gray bag of tricks]]. The coins are embossed with the profiled likeness of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]].
...
Guests aren't told about the inn's secret hallway. [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] knows of its existence because he has heard the Martikov boys opening and closing the secret door closest to his room (area N2n).
...
[[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] has a key to this room, which is locked at all times. Urwin and Danika carry spare keys. The door's lock can be picked, but discretion is called for because the door is in plain view of the taproom below.
...
[[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] sleeps here between midnight and dawn. At dawn, he leaves to check on his horse (area N2f) and his wagon (area N5), returning to the inn around noon. Between noon and dusk, there's a 40 percent chance he is here; otherwise, he's in the taproom (area N2c). At dusk, he leaves the inn to tend to his horse and his wagon again, then returns to his room to retire for the night.

[[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] is too clever to leave anything valuable or incriminating in his room. The footlocker and the wardrobe contain nothing but common clothes and travel wear.

##### Rictavio's Journal

The journal on the desk is a bit of artifice that [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] created to perpetuate the illusion that he is an entertainer in search of new acts for his traveling carnival. His writing makes frequent mention of conversations with Drusilla (which the journal fails to mention is the name of [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]]'s horse) and recounts many long and tedious journeys by wagon. [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] has also written about various "oddities" he has seen in his travels, including the following:
...
![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/054-cos05-07.webp#center|The Martikov Family]]
...
Urwin carries the key to the locked iron strongbox. The lock can be picked with thieves' tools and a successful DC 20 Dexterity check. The box contains a sack of 150 ep (each coin bearing the profiled visage of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]]), six pieces of jewelry (worth 250 gp each), and three [[/03_Mechanics/CLI/items/potion-of-healing-xdmg|potions of healing]].
...
If the characters knock on the front doors, a maid (LG female human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]) lets them in, escorts them to the den (area N3e), and leaves to fetch the baron.

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/055-015.webp#gallery|Map 5.3: Burgomaster's Mansion (Area N3)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/056-cos502.webp#gallery|Player Version]]
...
The burgomaster, [[/03_Mechanics/CLI/bestiary/npc/baron-vargas-vallakovich-cos|Baron Vargas Vallakovich]] (NE male human [[/03_Mechanics/CLI/bestiary/humanoid/noble-xmm|noble]]), is a ruthless heel who prides himself on his good breeding and finely honed leadership skills. He stages repeated celebrations to foster happiness, and his "All will be well!" catchphrase has become a sad and tiresome punchline. Baron Vallakovich has convinced himself that if he can make everyone in Vallaki happy, the town will slip free of Strahd's dark grasp.

The baron has a brittle ego, and he lashes out at anyone who pokes fun at his festivals or treats him disrespectfully. He has two pet mastiffs that follow him everywhere, as well as a murderous and deformed henchman named [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]] (see appendix D). In addition to his weapons, Izek carries an iron ring of keys that unlock the stocks in the town square (area N8).

If the characters get on his bad side, the baron accuses them of being "spies of the devil Strahd" and sends twelve [[/03_Mechanics/CLI/bestiary/humanoid/guard-xmm|guards]] to arrest them, seize their weapons, and run them out of town. If the guards fail in their duty, the baron sends Izek to rally a mob of thirty [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]] to lynch the party. If the commoners also fail, the baron summons the twelve remaining guards to defend his mansion, giving characters the run of the town.
...
![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/057-cos05-09.webp#center|The Baroness and Baron]]
...
At the risk of sacrificing her sanity, the baron's wife, Lydia Petrovna (LG female human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]), has embraced her husband's philosophy of happiness. She laughs at the baron's every comment, to the extent that it has become a nervous reflex, and she tries to spread good cheer by throwing daily tea-and-sandwich parties in the parlor for her "dearest friends," many of them poor folk who tolerate the baroness only because they crave something warm to eat and drink. Lydia is a gods-fearing woman and the younger sister of the town priest, Father Lucian Petrovich. She is a descendant of Tasha Petrovna, a priest entombed in Castle Ravenloft (chapter 4, area K84, crypt 11).

##### The Baronet

The baron's miserable son, [[/03_Mechanics/CLI/bestiary/npc/victor-vallakovich-cos|Victor Vallakovich]] (NE male human [[/03_Mechanics/CLI/bestiary/humanoid/mage-xmm|mage]]), has confined himself to the attic (area N3t), where he is content to avoid the unwanted attention of his mother and the disapproving glares of his father. Years ago, Victor found an old spellbook in the mansion's library and used it to teach himself magic. He has been busy constructing a [[/03_Mechanics/CLI/spells/teleportation-circle-xphb|teleportation circle]] in the hope of escaping Barovia and leaving his parents to their doom.
...
The women seated at the table are eight Vallakian peasants (female [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]) invited to spend time with the baroness, Lydia Petrovna, who is bribing them with tea and cake. Lydia has assigned these women the task of stitching children's costumes and weaving together a wicker sun for the Festival of the Blazing Sun.
...
The household staff consists of a maid (LG female human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]) and a cook (LG male human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]). The other two beds belonged to the butler and the baroness's lady-in-waiting, both of whom have gone missing (see area N3t). The trunks contain the staff's clothing and uniforms.
...
The door to this room is locked. [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]] carries the only key.

The following description assumes the characters have met [[/03_Mechanics/CLI/bestiary/npc/ireena-kolyana-cos|Ireena Kolyana]] (see chapter 3, area E4). If the characters haven't met her, don't read the last sentence.

> [!readaloud] 
> 
> Dolls. This room is full of pretty little dolls with powder-white skin and auburn hair, some of them dressed beautifully, others plainly. Some of the dolls fill a long bookshelf, and others are arranged in neat rows on wall-mounted shelves. Still others are piled atop a bed and a heavy wooden chest. What's most odd is that all of the dolls, apart from their clothing, look the same. They all look like [[/03_Mechanics/CLI/bestiary/npc/ireena-kolyana-cos|Ireena Kolyana]].
^379

The burgomaster's monstrous henchman, [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]] (see appendix D), sleeps here at night. During the day, he is in town taking care of his master's business. Izek's chest is unlocked and contains a heap of wrinkled clothes, under which is a nonmagical shortsword.
...
Each doll has a small tag stitched into its clothing that reads "Is No Fun, Is No Blinsky!" Izek had the local toymaker, [[/03_Mechanics/CLI/bestiary/npc/gadof-blinsky-cos|Gadof Blinsky]] (area N7), craft the dolls in Ireena's likeness.
...
The man is a Vallakian shoemaker named Udo Lukovich (LN male human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]). He was arrested during the Wolf's Head Jamboree for carrying a sign that suggested that Vallakians should feed the baron to the wolves.
...
A [[/03_Mechanics/CLI/spells/detect-magic-xphb|detect magic]] spell reveals that the gilded mirror on the wall radiates an aura of conjuration magic. None of the mansion's current occupants are aware of this fact, because the mirror's magic hasn't been used in generations. Casting an [[/03_Mechanics/CLI/spells/identify-xphb|identify]] spell on the mirror reveals that an assassin's ghost is magically bound to it. The spell also reveals the forgotten rhyme needed to summon the ghost:
...
Anyone who inspects the carving and succeeds on a DC 14 Intelligence ([[/03_Mechanics/CLI/skills#Investigation|Investigation]]) check notices a small, nearly invisible glyph etched into the skull's forehead. This is a [[/03_Mechanics/CLI/spells/glyph-of-warding-xphb|glyph of warding]] (`5d8` lightning damage) that triggers if anyone other than Victor opens the door.

The voice belongs to Victor. He is reading aloud from his spellbook. Anyone who listens at the door and succeeds on a DC 14 Intelligence ([[/03_Mechanics/CLI/skills#Arcana|Arcana]]) check can tell he's badly pronouncing some kind of teleportation spell.
...
If the characters trigger the [[/03_Mechanics/CLI/spells/glyph-of-warding-xphb|glyph of warding]] or otherwise announce their arrival, Victor casts a [[/03_Mechanics/CLI/spells/greater-invisibility-xphb|greater invisibility]] spell on himself and hides in a corner. Otherwise, he's visible. If the characters can see Victor, read:
...
For practice and for fun, Victor dug up some old cat bones behind the Wachter estate (see area N4) and animated them, creating six cat skeletons (use the [[/03_Mechanics/CLI/bestiary/beast/cat-xmm|cat]] stat block, but give them [[/03_Mechanics/CLI/senses#Darkvision|darkvision]] out to a range of 60 feet and immunity to poison damage, [[/03_Mechanics/CLI/conditions#Exhaustion|exhaustion]], and the [[/03_Mechanics/CLI/conditions#Poisoned|poisoned]] condition). The skeletons attack only when Victor commands them to.
...
The sheets of parchment are covered with elaborate diagrams of teleportation circles. Victor drew them in an effort to learn the [[/03_Mechanics/CLI/spells/teleportation-circle-xphb|teleportation circle]] spell, which he's still trying to master (see "Teleportation Circle" below).
...
Victor's spellbook contains incomplete text for a [[/03_Mechanics/CLI/spells/teleportation-circle-xphb|teleportation circle]] spell, along with the sigil sequences of three permanent teleportation circles, the locations of which aren't described. There's not enough text to prepare the spell properly, but that hasn't stopped Victor from trying to learn to cast it.

Victor recently inscribed his own version of a teleportation circle on the floor. It's hidden under the rug so that his parents don't find it. In the past couple of weeks, Victor has managed to imbue the circle with magic, but he failed to account for several factors. His circle doesn't fade after use, nor does it function like the [[/03_Mechanics/CLI/spells/teleportation-circle-xphb|teleportation circle]] spell. If the circle is used in the casting of a [[/03_Mechanics/CLI/spells/teleportation-circle-xphb|teleportation circle]] spell, whether the actual spell or Victor's version of it, any creature standing on the circle when the spell is cast takes `3d10` force damage and isn't teleported anywhere. If this damage reduces the creature to 0 hit points, the creature is disintegrated. Any character who studies the circle and succeeds on a DC 15 Intelligence ([[/03_Mechanics/CLI/skills#Arcana|Arcana]]) check realizes that Victor's circle is horribly flawed and potentially deadly when used.

Victor has tested his circle on two reluctant servants (compelled by his [[/03_Mechanics/CLI/spells/suggestion-xphb|suggestion]] spell), in both cases linking his circle to one of the other circles whose sigils are in his spellbook. Each servant was torn apart before Victor's eyes before vanishing in a flash of purple light. Victor doesn't know how to fix the circle but plans to make more modifications to it before testing it again.

##### Treasure

Victor's spellbook contains all the spells Victor has prepared (see the [[/03_Mechanics/CLI/bestiary/humanoid/mage-xmm|mage]] stat block in the "Monster Manual") as well as the following spells: [[/03_Mechanics/CLI/spells/animate-dead-xphb|animate dead]], [[/03_Mechanics/CLI/spells/blight-xphb|blight]], [[/03_Mechanics/CLI/spells/cloudkill-xphb|cloudkill]], [[/03_Mechanics/CLI/spells/darkvision-xphb|darkvision]], [[/03_Mechanics/CLI/spells/glyph-of-warding-xphb|glyph of warding]], [[/03_Mechanics/CLI/spells/levitate-xphb|levitate]], [[/03_Mechanics/CLI/spells/remove-curse-xphb|remove curse]], and [[/03_Mechanics/CLI/spells/thunderwave-xphb|thunderwave]].
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/058-016.webp#gallery|Map 5.4: Wachterhaus (Area N4)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/059-cos503.webp#gallery|Player Version]]
...
[[/03_Mechanics/CLI/bestiary/npc/lady-fiona-wachter-cos|Lady Fiona Wachter]] (LE female human [[/03_Mechanics/CLI/bestiary/humanoid/priest-xmm|priest]] with AC 10 and no armor) makes no secret of her family's long-standing loyalty to the von Zarovich line. She believes that [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] is no tyrant but, at worst, a negligent landlord. She would happily serve Strahd as burgomaster of Vallaki, but she knows that [[/03_Mechanics/CLI/bestiary/npc/baron-vargas-vallakovich-cos|Baron Vargas Vallakovich]] won't give up his birthright without a fight.
...
![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/060-cos05-11.webp#center|Fiona Wachter and Majesto]]

Another secret of Fiona's is that she sleeps with the corpse of her dead husband, Nikolai, who died of sickness nearly three years ago and whom Fiona cherished. Lady Wachter casts [[/03_Mechanics/CLI/spells/gentle-repose-xphb|gentle repose]] spells on the corpse to keep it from deteriorating.

If the characters come to Wachterhaus looking for help to overthrow the burgomaster, Lady Wachter is all ears and suggests they start by killing the baron's evil henchman, [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]]. She's happy to take care of the rest. If they come looking for a way to defeat Strahd, Lady Wachter turns them away, stating in no uncertain terms that she is not, nor ever will be, Strahd's enemy.

Lady Wachter has a different list of prepared spells from that of the [[/03_Mechanics/CLI/bestiary/humanoid/priest-xmm|priest]] in the "Monster Manual":

> [!note] 
> 
> - Cantrips (at will): [[/03_Mechanics/CLI/spells/light-xphb|light]], [[/03_Mechanics/CLI/spells/mending-xphb|mending]], [[/03_Mechanics/CLI/spells/thaumaturgy-xphb|thaumaturgy]]  
> - 1st level (4 slots): [[/03_Mechanics/CLI/spells/command-xphb|command]], [[/03_Mechanics/CLI/spells/purify-food-and-drink-xphb|purify food and drink]], [[/03_Mechanics/CLI/spells/sanctuary-xphb|sanctuary]]  
> - 2nd level (3 slots): [[/03_Mechanics/CLI/spells/augury-xphb|augury]], [[/03_Mechanics/CLI/spells/gentle-repose-xphb|gentle repose]], [[/03_Mechanics/CLI/spells/hold-person-xphb|hold person]]  
> - 3rd level (2 slots): [[/03_Mechanics/CLI/spells/animate-dead-xphb|animate dead]], [[/03_Mechanics/CLI/spells/create-food-and-water-xphb|create food and water]]  
^39e

##### Fiona's Sons

Fiona sees a lot of her husband in her sons, Nikolai and Karl (N male human [[/03_Mechanics/CLI/bestiary/humanoid/noble-xmm|nobles]]), who have grown into young men with a fondness for wine and trouble. They aren't home during the day, because they don't like attending to their mother or listening to her tiresome prattle. The characters might encounter them at the Blue Water Inn (area N2) or wandering about town. The brothers are home most nights, passed out in their beds after hours of heavy drinking.
...
Fiona employs a money-grubbing [[/03_Mechanics/CLI/bestiary/humanoid/spy-xmm|spy]] named Ernst Larnak (LE male human) to keep her informed about everything that happens in town. Ernst knows Lady Wachter's secrets, and he would blackmail her in a heartbeat if their relationship went sour.
...
Anyone who searches the closet and makes a successful DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check finds a secret door in the south wall. The door can be pulled open to reveal a stone staircase (area N4g) that leads to the cellar.
...
The portrait above the mantel depicts Lord [[/03_Mechanics/CLI/bestiary/npc/nikolai-wachter-cos|Nikolai Wachter]], Fiona's late husband (of whom his sons are the spitting image). The other portraits depict Lady Wachter, her sons, her daughter, and various deceased family members.
...
Lady Wachter's husband, Nikolai, lies in his bed, impeccably dressed, quite deceased, and under the effect of the [[/03_Mechanics/CLI/spells/gentle-repose-xphb|gentle repose]] spell. Nothing of value is on him.

The closet contains shelves of fancy footwear and many fine garments, including a black ceremonial robe with a hood (similar to the ones worn by the cult fanatics in area N4t). On a high shelf rests a locked iron chest. Lady Wachter hides the key to the chest on a tiny hook in the fireplace, under the mantel. A character who takes a minute to search the fireplace finds the key with a successful DC 10 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check. Use of the key disables a poison needle trap hidden in the lock (see ""Sample Traps"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). A creature that triggers the trap and fails the saving throw against the needle's poison falls [[/03_Mechanics/CLI/conditions#Unconscious|unconscious]] for 1 hour instead of being [[/03_Mechanics/CLI/conditions#Poisoned|poisoned]] for 1 hour.
...
Eight [[/03_Mechanics/CLI/bestiary/beast/cat-xmm|cats]] have the run of the library. These family pets have vicious dispositions, attacking anyone who tries to pick them up. Characters who have a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 10 or higher notice that one cat has a small key hanging from its collar. The key opens the locked chest in area N4q.
...
- Five scrolls—notarized deeds for parcels of land given to the Wachter family by Count [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]] nearly four centuries ago  
- A supple leather case containing an unbound manuscript titled *The Devil We Know*—a poetic manifesto written by [[/03_Mechanics/CLI/bestiary/npc/lady-fiona-wachter-cos|Lady Fiona Wachter]] attesting that the worship of devils can bring happiness, success, freedom, wealth, and longevity  
...
Characters who have the [[/03_Mechanics/CLI/items/tome-of-strahd-cos|Tome of Strahd]] (see appendix C) realize that the handwriting in Lady Lovina's letter is identical to Strahd's handwriting, suggesting that Strahd and Lord Vasili are one and the same.
...
The four people are town residents (LE male and female human [[/03_Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm|cult fanatics]]) whom Lady Wachter has seduced with promises of power, wealth, and long life. They are members of her "book club," eagerly waiting for Lady Wachter to join them, read passages from her manifesto (see area N4q), and maybe conjure up a few coins. Resting on the fifth chair, quietly eavesdropping on the cultists, is the lady's [[/03_Mechanics/CLI/conditions#Invisible|invisible]] [[/03_Mechanics/CLI/bestiary/fiend/imp-xmm|imp]], [[/03_Mechanics/CLI/bestiary/npc/majesto-cos|Majesto]].
...
> 
> Parked at the south end of the stockyard is a sturdy carnival wagon, its colorful paint peeling off. Faded lettering on its sides spells out the words "[[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]]'s Carnival of Wonders." A heavy padlock secures the back door.
^3ca

The stockyard is a general store and a facility where storage sheds can be rented. It is owned by a middle-aged married couple, Gunther and Yelena Arasek (LG male and female [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]]). They sell items from the "Adventuring Gear" table in the "Player's Handbook" that have a price of 25 gp or less, but at five times the price.

#### Rictavio's Carnival Wagon

The colorful half-elf bard [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] (see area N2 and appendix D) paid Gunther and Yelena a generous amount of gold to watch his carnival wagon, no questions asked. If the characters approach the wagon, read:
...
[[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] carries the key to the wagon door. The lock can be picked but is rigged with a poison needle trap (see ""Sample Traps"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide").

Inside the wagon is a [[/03_Mechanics/CLI/bestiary/beast/saber-toothed-tiger-xmm|saber-toothed tiger]] with 84 hit points. It is clad in specially fitted half plate (AC 17) and has been trained to hunt Strahd's Vistani servants.

The wagon also contains the torn-up remains of a doll. A character who makes a successful DC 10 Intelligence ([[/03_Mechanics/CLI/skills#Investigation|Investigation]]) check discovers that the doll was once a colorfully dressed Vistani effigy. Stitched into its tattered pants is a slogan: "Is No Fun, Is No Blinsky!"

[[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] isn't ready to unleash the tiger on the Vistani just yet. He feeds it by dropping wolf steaks down a 1-foot-square hatch in the wagon's roof. A character who climbs atop the wagon can spot the hatch without needing to make an ability check.

If the tiger is released, it begins stalking through the streets until its keen sense of smell locates either [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] (area N2) or [[/03_Mechanics/CLI/bestiary/npc/piccolo-cos|Piccolo]] (area N7). The tiger doesn't attack anyone who isn't a Vistana except in self-defense. It attacks Vistani on sight. [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] can make the tiger break off its attack and lure it back into the wagon.

![](/03_Mechanics/CLI/adventures/curse-of-strahd/img/061-cos05-12.webp#center)

#### Treasure

The front seat of the wagon conceals a secret compartment that requires a successful DC 15 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check to find and open. The compartment holds several items:
...
- A [[/03_Mechanics/CLI/items/healers-kit-xphb|healer's kit]]  
- Three wooden [[/03_Mechanics/CLI/items/holy-symbol-xphb|holy symbols]] inlaid with silver and in the shape of a sunburst (worth 50 gp each)  
- A silvered [[/03_Mechanics/CLI/items/shortsword-xphb|shortsword]]  
- A [[/03_Mechanics/CLI/items/hand-crossbow-xphb|hand crossbow]] inlaid with mother-of-pearl (worth 250 gp)  
- A bundle of twenty silvered [[/03_Mechanics/CLI/items/bolts-20-xphb|crossbow bolts]]  
- A worn leather case with gold buckles (worth 100 gp) containing three sharpened wooden stakes, a sack of garlic, a jar of salt, a box of holy wafers, six [[/03_Mechanics/CLI/items/holy-water-xphb|vials of holy water]], a polished steel mirror, and a bone scroll tube with a silver stopper and chain (worth 25 gp). The tube contains a [[/03_Mechanics/CLI/items/scroll-of-protection-xdmg|spell scroll of protection from fiends]] and a [[/03_Mechanics/CLI/items/scroll-of-protection-xdmg|spell scroll of protection from undead]].  
...
[[/03_Mechanics/CLI/bestiary/npc/henrik-van-der-voort-cos|Henrik van der Voort]] (LE male human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]) is a mediocre carpenter and a troubled, lonely man. He profits from the deaths of others, and no one desires his company, because of the ghastly nature of his handiwork. One night several months ago, Strahd visited Henrik in the guise of an imposing, well-dressed nobleman named Vasili von Holtz and promised the coffin maker "good business" in exchange for his help. Since then, Henrik's workshop has become the lair of a pack of vampire spawn—former adventurers who were turned by Strahd. These vampires are lying low for the time being.

![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/062-cos05-14.webp#center|Henrik Van Der Voort]]

The vampires plan to attack St. Andral's church (see "St. Andral's Feast" in the "Special Events" section at the end of this chapter). When Henrik learned about the sacred bones buried under the church, the vampire spawn ordered him to steal the bones, which Henrik paid [[/03_Mechanics/CLI/bestiary/npc/milivoj-cos|Milivoj]] the gravedigger (see area N1) to do.
...
If the characters report the theft of the bones to the burgomaster, Baron Vallakovich dispatches four [[/03_Mechanics/CLI/bestiary/humanoid/guard-xmm|guards]] to arrest Henrik and retrieve the bones. If the guards show up during daylight hours, Henrik surrenders himself and the bones without a fight, claiming that vampires forced him to steal the bones. If the guards come at night, Henrik surrenders himself and tells the guards where the bones are hidden, but he won't retrieve the bones himself for fear of being killed by the vampires.

> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/063-cos05-13.webp#gallery|Map 5.5: Coffin Maker's Shop (Area N6)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/064-cos504.webp#gallery|Player Version]]
...
The wardrobe in the southeast corner has a secret compartment in its base, requiring a successful DC 15 Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) check to find. Inside the compartment are two sacks—a large one containing the bones of St. Andral and a small one containing 30 sp and 12 ep. All of the coins bear the profiled visage of [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd von Zarovich]].
...
Vallaki's toymaker, [[/03_Mechanics/CLI/bestiary/npc/gadof-blinsky-cos|Gadof Blinsky]] (CG male human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoner]]), calls himself "a wizard of tiny wonders," but he has been consumed by despair lately because no one seems to like him or want his toys. His fascination for eerie playthings causes most other locals to avoid him. The burgomaster enables Blinsky to stay in business by giving him a couple of gold pieces a month to make festival decorations.

![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/065-cos05-15.webp#center|Gadof Blinsky and Piccolo]]

Blinsky is a heavyset man who wears a moth-eaten jester's cap during store hours, more out of habit than to humor visitors. In the past six months, the only paying customer who has set foot in the store is a visitor from a faraway land named [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] (see area N2), who came in two weeks ago and bought a stuffed Vistana doll. Realizing that the toymaker was lonely, [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] gave Blinsky his pet monkey, [[/03_Mechanics/CLI/bestiary/npc/piccolo-cos|Piccolo]] (use the [[/03_Mechanics/CLI/bestiary/beast/baboon-xmm|baboon]] stat block in the "Monster Manual"). Overjoyed, Blinsky has begun training the monkey to fetch toys from hard-to-reach shelves. The toymaker has also fitted [[/03_Mechanics/CLI/bestiary/npc/piccolo-cos|Piccolo]] with a custom-tailored ballerina tutu.
...
The Wolf's Head Jamboree has already occurred, making the square's proclamations out of date. If the characters linger, they see the burgomaster's henchman, [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]] (see appendix D), arrive with two town [[/03_Mechanics/CLI/bestiary/humanoid/guard-xmm|guards]]. Izek orders one guard to tear down all of the old proclamations while the other posts the following new one:
...
The townsfolk in the stocks were arrested for "malicious unhappiness" (spreading negative opinions about the upcoming festival). An iron padlock secures each set of stocks, and [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]] carries the keys on an iron ring.

Three men, two women, and two boys are trapped in the stocks—all of them tired, wet, and famished. The five adults have the statistics of human [[/03_Mechanics/CLI/bestiary/humanoid/commoner-xmm|commoners]], and the children are noncombatants. The plaster donkey heads they wear are meant to encourage ridicule.

Freeing one or more prisoners without the baron's consent is a crime. If the characters are witnessed doing so, Izek rallies the town [[/03_Mechanics/CLI/bestiary/humanoid/guard-xmm|guards]] (twenty-four in all) and orders the characters to leave town at once or suffer the consequences. If the characters stand their ground, Izek orders the guards to beat them into submission, seize their weapons, and cast them out of Vallaki to be "food for the wolves."
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/066-018.webp#gallery|Map 5.6: Vistani Camp (Area N9)]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/067-cos505.webp#gallery|Player Version]]
...
The Vistani in this camp all serve Strahd. The elders have died, leaving a pair of brothers named [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] and [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]] in charge. Both men are evil and willing to do whatever Strahd demands of them.

These Vistani have two problems. First, [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]]'s seven-year-old daughter, [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]], recently disappeared from the camp. Consequently, half of the Vistani are out searching for her when the characters arrive. Second, the Vistani have exhausted their supply of wine and are eager to obtain more. Characters who help them with either problem earn the Vistani's respect.

##### Dusk Elves

The dusk elf race is all but forgotten, and the few survivors live in secret places such as this. They have dark skin and hair, but otherwise they are similar to [[/03_Mechanics/CLI/races/elf-xphb|wood elves]] (as described in the "Player's Handbook"). One of Strahd's old brides, [[/03_Mechanics/CLI/bestiary/npc/patrina-velikovna-cos|Patrina Velikovna]], used to live here. Her brother, [[/03_Mechanics/CLI/bestiary/npc/kasimir-velikov-cos|Kasimir Velikov]], still does.

The dusk elves reside in small homes built into the hillside and are mostly self-sufficient. They are skilled trackers, and many of them are away from camp when the characters arrive, helping the Vistani search for [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]]. Strahd has tasked the Vistani with keeping an eye on the dusk elves, and the dusk elves know they aren't safe in Barovia without the Vistani's "protection." Strahd has also forbidden the Vistani from helping the dusk elves escape his domain.
...
> [!gallery]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/068-cos05-18.webp#gallery|Luvash]]
> ![[/03_Mechanics/CLI/adventures/curse-of-strahd/img/069-cos05-17.webp#gallery|Arrigal]]
...
The cloaked figures are three [[/03_Mechanics/CLI/bestiary/humanoid/guard-xmm|guards]] (N male dusk elves). If the characters seem friendly and are looking for someone to talk to, the guards direct them inside to Kasimir or point them toward the Vistani camp on the hilltop.

[[/03_Mechanics/CLI/bestiary/npc/kasimir-velikov-cos|Kasimir Velikov]] (see appendix D) is the leader of the dusk elves. His hovel has a decorated vestibule and a comfortable room beyond with a fireplace. Wooden statuettes of elven deities stand in cubbyholes along one wall. A tapestry of a forest hangs on the opposite wall.

Kasimir confesses that he is burdened by dreams sent to him by his dead sister, [[/03_Mechanics/CLI/bestiary/npc/patrina-velikovna-cos|Patrina Velikovna]], whose spirit has languished in the catacombs below Castle Ravenloft for centuries. Kasimir believes that Patrina has repented for her many sins, and he yearns not only to free her but also to restore her to life.
...
Kasimir wears a [[/03_Mechanics/CLI/items/ring-of-warmth-xdmg|ring of warmth]] and has a leather-bound spellbook containing all the spells he has prepared (see appendix D) plus the following spells: [[/03_Mechanics/CLI/spells/arcane-lock-xphb|arcane lock]], [[/03_Mechanics/CLI/spells/comprehend-languages-xphb|comprehend languages]], [[/03_Mechanics/CLI/spells/hold-person-xphb|hold person]], [[/03_Mechanics/CLI/spells/identify-xphb|identify]], [[/03_Mechanics/CLI/spells/locate-object-xphb|locate object]], [[/03_Mechanics/CLI/spells/nondetection-xphb|nondetection]], [[/03_Mechanics/CLI/spells/polymorph-xphb|polymorph]], [[/03_Mechanics/CLI/spells/protection-from-evil-and-good-xphb|protection from evil and good]], and [[/03_Mechanics/CLI/spells/wall-of-stone-xphb|wall of stone]].
...
The cloaked figure is a [[/03_Mechanics/CLI/bestiary/humanoid/guard-xmm|guard]] (N male dusk elf). If the characters appear friendly and are looking for someone to talk to, the guard directs them to Kasimir's hovel (area N9a). Under no circumstances does the guard willingly allow strangers to enter the house he protects.

Each hovel is configured similarly to Kasimir's hovel. All are currently unoccupied. (Except for the nine guards left behind to watch the homes, the dusk elves are out searching for [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]].)
...
The two men in studded leather armor are the leaders of the Vistani camp—the brothers [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] (CE male human [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-captain-cos|bandit captain]]) and [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]] (NE male human [[/03_Mechanics/CLI/bestiary/humanoid/assassin-xmm|assassin]]). If you used the "Plea for Help" adventure hook, the characters have already met [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]]. [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] is the older of the two and the brother whom the other Vistani fear most. Each brother carries a key that unlocks one of the padlocks of the treasure wagon (area N9i).

[[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] is punishing a Vistana named Alexei (CN male human [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|bandit]] with 3 hit points remaining) for failing to keep a watchful eye on his daughter. The characters' arrival distracts [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]], and he forgets about Alexei long enough to play the role of host—until such time as the characters become tiresome or threatening. Alexei blames himself for not watching the little brat more closely and has accepted his punishment. If the characters try to rescue him, he screams at them to stop, not wanting to appear weak in front of [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] and [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]].

In addition to [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]], [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]], and Alexei, there are six intoxicated Vistani (CN male and female human [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|bandits]]) lying [[/03_Mechanics/CLI/conditions#Unconscious|unconscious]] in the tent. A drunk Vistana awakens only if the Vistana takes 5 damage or more and has at least 1 hit point remaining afterward.

##### Dealing with Luvash

[[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] is unhappy because his seven-year-old daughter, [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]], has vanished. She's been gone for a little more than a day. Because everyone in the camp was drunk and [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]] was away, no one remembers seeing or hearing anything strange. [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] is determined to find her, no matter what the cost, and most of his camp is out scouring the woods when the characters arrive. (Missing from the camp are twelve [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|bandits]]. Each hour that passes, `d4` of them return to camp with no news on [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]]'s whereabouts.)

If an alarm is sounded, nine Vistani [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|bandits]] (NE male and female humans) emerge from three of the surrounding wagons (area N9g) and arrive at the tent with weapons drawn in 2 rounds.

[[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] won't meddle in the characters' affairs without Strahd's consent, and he is quite content to let the vampire deal with them. For a hefty price, he offers to sell the characters potions that allow safe passage through the deadly fog that surrounds the valley; he keeps them in the treasure wagon (area N9i). The potions don't work, of course.

If the characters rescue [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]] from Lake Zarovich (chapter 2, area L) and see her safely returned to camp, [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] is overjoyed and offers to repay the favor. He doesn't sell them the fake potions. ("Um, they aren't as potent as they could be.") Instead, he lets them choose a treasure from the Vistani treasure wagon (area N9i).

If the characters ask something of the Vistani but have not earned [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]]'s goodwill, he agrees to do business with them if they accomplish one of two tasks: either find his missing daughter or procure six barrels of wine and bring them to the camp. [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] suggests they can get the wine in Vallaki, or go straight to the source—the Wizard of Wines winery. He isn't picky when it comes to the quality of the wine.

##### Dealing with Arrigal

[[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]] is a much more dangerous creature than his brute of a brother. If the characters have something in their possession that is either useful or harmful to Strahd and [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]] becomes aware of it, he tries to deprive the characters of this item, stalking them if necessary and going as far as to kill one or more of them if he thinks he can escape with the item in his possession. If he succeeds, he takes one of the riding horses (area N9d) and delivers the item to Strahd at Castle Ravenloft.
...
Twenty-four [[/03_Mechanics/CLI/bestiary/beast/draft-horse-xmm|draft horses]] and six [[/03_Mechanics/CLI/bestiary/beast/riding-horse-xmm|riding horses]] are tethered here.
...
[[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]]'s wagon is a mess inside. Empty wineskins, dirty clothes, and mangy furs are strewn about. A small hammock strung across the width of the wagon under the driver's seat serves as [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]]'s bed. A burlap doll with button eyes lies in the hammock; [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]] has no other possessions.
...
Each of these wagons contains `d4` sleeping Vistani (CN male and female human [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|bandits]]). These Vistani wake up if their wagon is shaken or if they take damage and have at least 1 hit point remaining.
...
Each of these wagons contains three Vistani (CN male and female human [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|bandits]]). The Vistani are playing a dice game for favors, since they have no money. They respond to sounds of alarm by drawing their weapons and heading to the tent (area N9c).
...
The Vistani keep all their treasure in this wagon. The door to the wagon has two locks, each of which requires a different key. [[/03_Mechanics/CLI/bestiary/npc/luvash-cos|Luvash]] carries one key, [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]] the other. Each lock is rigged with a poison needle trap (see ""Sample Traps"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide").
...
- An onyx jewelry box with gold filigree (worth 250 gp) containing six pieces of cheap jewelry (worth 50 gp each) and a [[/03_Mechanics/CLI/items/potion-of-poison-xdmg|potion of poison]] in an unlabeled crystal vial (worth 100 gp)  
...
Karl and [[/03_Mechanics/CLI/bestiary/npc/nikolai-wachter-cos|Nikolai Wachter]] (see areas N2 and N4) are young, foolish men from a proud noble family. The drunken brothers sneak into Arasek's Stockyard (area N5) while everyone else is attending the festival in the town square. On a dare, one of them rocks the wagon. The saber-toothed tiger locked inside becomes enraged and smashes through the wagon door. The characters and everyone else in town hear the screams of the young men as the tiger escapes. The tiger flees the stockyard without harming the Wachters and begins to prowl the streets, looking for an escape. Reports of a tiger running loose in the streets ruin the festival and send townsfolk scurrying for their homes.

The saber-toothed tiger doesn't harm anyone until it takes damage, whereupon it attacks the perceived source of the damage. If he is still alive, [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]] gathers six town guards and hunts down the beast with the intention of killing it. Meanwhile, [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] does his best to lure the beast back to his wagon while assuring townsfolk that it won't harm them.
...
After the burgomaster learns that the tiger belongs to [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]], he commands his guards to arrest the mysterious bard. If [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] thinks the characters can help him, he asks them to distract the burgomaster and the guards while he gathers his horse, wagon, and tiger (in that order). If the characters ask [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] where he plans to go, he tells them about an old tower to the west where he can lie low (see chapter 11, "Van Richten's Tower").

### Lady Wachter's Wish

Ernst Larnak (see area N4) begins shadowing the characters. Characters who have a passive Wisdom ([[/03_Mechanics/CLI/skills#Perception|Perception]]) score of 14 or higher notice him doing so. If they confront him, he claims that he keeps a watchful eye on all strangers, though he doesn't mention the name of his employer. If the characters threaten him, he backs off and reports to Lady Wachter after he believes he's not being watched or pursued.
...
If the characters have rescued [[/03_Mechanics/CLI/bestiary/npc/arabelle-cos|Arabelle]] (see chapter 2, area L), the Vistani return Lady Wachter's gold to Ernst and do nothing.

Otherwise, a [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|Vistana bandit]] watches the road east of Vallaki and reports back to camp if the characters are sighted leaving. The Vistani, worried that the characters might be more than a match for them, send one emissary on horseback to race ahead of the characters and inform Strahd. If [[/03_Mechanics/CLI/bestiary/npc/arrigal-cos|Arrigal]] is alive, he makes the ride himself. Otherwise, the rider is a young [[/03_Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos|Vistana bandit]] named Alexei (see area N9c).

### St. Andral's Feast

The characters can prevent this special event from occurring by returning the bones of St. Andral to the church (area N1) or by destroying the vampire spawn hiding in the coffin maker's shop (area N6). If the characters stay in Vallaki for three days or more and don't retrieve the bones or destroy the vampire spawn, [[/03_Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos|Strahd]] visits the coffin maker's shop the following evening and orchestrates an attack on the church.

The vampire spawn begin the attack that night. They cling to the outer walls and roof of St. Andral's church while four [[/03_Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm|swarms of bats]] enter the church through the belfry and terrify the congregation. As the townsfolk flee the church, the vampire spawn leap down and attack them.
...
If Father Lucian dies, locals bury his body in the church cemetery, whereupon it rises the following night as a [[/03_Mechanics/CLI/bestiary/undead/vampire-spawn-xmm|vampire spawn]] under Strahd's control. If [[/03_Mechanics/CLI/bestiary/npc/rictavio-cos|Rictavio]] (area N2) learns of the priest's death, he suggests that the characters burn the priest's body to ensure that it doesn't rise from the dead.

#### Development

The attack on St. Andral's church terrorizes and demoralizes the town. After a few days, fear turns to misdirected rage as townsfolk blame the burgomaster. Baron Vallakovich's "All will be well!" mantra can't protect him from their wrath. Barring intervention by the characters, the burgomaster's mansion is set ablaze, and the baron, his wife, and his son are dragged to the town square, thrown in the stocks, and stoned to death. If he is alive, [[/03_Mechanics/CLI/bestiary/npc/izek-strazni-cos|Izek Strazni]] flees the town to avoid a similar fate. Where he hides is up to you, but likely locations include Old Bonegrinder (chapter 6), Argynvostholt (chapter 7), or the ruins of Berez (chapter 10).
