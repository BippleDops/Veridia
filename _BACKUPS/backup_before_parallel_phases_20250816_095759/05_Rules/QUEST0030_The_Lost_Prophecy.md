...
## Quest Giver
**Ezra Goldleaf** - Dying adventurer
...
## Key Locations
- **Havenstead** (City): Key location for quest progression
- **SouthGate** (Dungeon): Key location for quest progression
- **Watchstead** (Wilderness): Key location for quest progression
- **Gatestead** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Constructs** led by Ezra Brightblade the Merciful
...
- **Gold**: 1,778 gp
- **Experience**: 2,000 XP
- **Magic Items**: Glorious Orb of Power
