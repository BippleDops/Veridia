...
## Appearance
Very tall and athletic, with Wild and unkempt gray hair and Hazel eyes. Unusual hue skin. Missing ear from old battle.
...
- **Quirks**: Never sleeps in the same place twice, Counts everything obsessively
- **Fear**: Heights
...
### Nerys Xendar the Wanderer (Criminal - Target)
- **Status**: Strong and trusting
- **History**: Arranged partnership that grew genuine
- **Secret**: One is a shapeshifter

### Fiora Lightbringer the Mystic (Political - Puppet)
...
### Skills
Animal Handling, Perception, Survival, Performance
