...
## Quest Giver
**Helena Goldleaf** - Guild representative
...
## Key Locations
- **WestGate** (City): Key location for quest progression
- **Hillstead** (Dungeon): Key location for quest progression
- **LowerGate** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Bandits** led by Helena Brightblade
  - Strength: 23 combatants
...
- **Gold**: 1,246 gp
- **Experience**: 2,000 XP
- **Magic Items**: Blessed Tome of Power
