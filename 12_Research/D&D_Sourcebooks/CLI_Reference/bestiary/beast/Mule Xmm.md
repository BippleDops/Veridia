...
# [[3-Mechanics\CLI\bestiary\beast/mule-xmm|Mule]]
...
- A rumor ties mule xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at mule xmm to avert a public scandal.
- A map overlay reveals a hidden approach to mule xmm active only during specific tides/storms.
