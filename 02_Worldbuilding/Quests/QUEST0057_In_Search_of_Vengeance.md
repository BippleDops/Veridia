...
## Quest Giver
**Rhea Darkwater** - Powerful merchant
...
## Key Locations
- **NewVale** (City): Key location for quest progression
- **FortVale** (Dungeon): Key location for quest progression

## Opposition
### Enemies
- **Bandits** led by Rhea Shadowmere the Strong
...
- **Gold**: 2,574 gp
- **Experience**: 3,000 XP
- **Magic Items**: Blessed Circlet of Power
