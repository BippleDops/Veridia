...
title: INDEX (Waterdeep_Dungeon_of_the_Mad_Mage)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["INDEX (Waterdeep Dungeon of the Mad Mage)"]
status: active
priority: normal
...
**Type**: Campaign **Level Range**: 5-20 **Themes**: dungeon, magic, exploration, mystery **Integration Status**: Available ## Description

Mega-dungeon beneath Waterdeep ### 🎭 NPCs```dataview
...
FROM "Waterdeep_Dungeon_of_the_Mad_Mage/Monsters" WHERE type = "Monster"
...
SORT rarity ### 📜 Adventures & Scenarios file.link as "Adventure", suggested_level as "Level", status as "Status" FROM "Waterdeep_Dungeon_of_the_Mad_Mage/Adventures"
