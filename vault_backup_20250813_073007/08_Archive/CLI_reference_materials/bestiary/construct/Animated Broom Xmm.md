...
- world/both
type: monster
updated: '2025-08-13T12:34:20.251880+00:00'
world: Both
---
...
# [[3-Mechanics\CLI\bestiary\construct/animated-broom-xmm|Animated Broom]]
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/construct/token/animated-broom-xmm.webp"
```
^statblock
...
Animated broom xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of animated broom xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around animated broom xmm.

## Adventure Hooks

- A rumor ties animated broom xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at animated broom xmm to avert a public scandal.
- A map overlay reveals a hidden approach to animated broom xmm active only during specific tides/storms.
