...
# [[3-Mechanics\CLI\bestiary\monstrosity/trapper-mpmm|Trapper]]
...
"traits":
  - "desc": "If the trapper is motionless on a floor, wall, or ceiling at the start\
      ...
      \ 18 Intelligence ([[/03_Mechanics/CLI/skills#Investigation|Investigation]])\
...
"actions":
  - "desc": "One Large or smaller creature within 10 feet of the trapper must succeed\
      \ on a DC 13 Dexterity saving throw or be [[/03_Mechanics/CLI/conditions#Grappled|grappled]]\
      \ (escape DC 14). Until the grapple ends, the target takes 13 (3d6 + 3) bludgeoning\
      \ damage plus 3 (d6) acid damage at the start of each of its turns. While [[/03_Mechanics/CLI/conditions#Grappled|grappled]]\
      \ in this way, the target is [[/03_Mechanics/CLI/conditions#Restrained|restrained]],\
      \ [[/03_Mechanics/CLI/conditions#Blinded|blinded]], and deprived of air. The\
