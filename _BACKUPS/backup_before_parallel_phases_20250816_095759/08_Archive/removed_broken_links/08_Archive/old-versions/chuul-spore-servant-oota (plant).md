...
title: chuul-spore-servant-oota (plant)
type: note
tags:
- note
...
updated: '2025-08-12T23:37:35.385595'
world: Both
...
"languages": ""
"cr": "4"
"actions": - "desc": "The spore servant makes two pincer attacks." "name": "Multiattack" - "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 11\ \ (`dice: 2d6` + 4) bludgeoning damage. The target is [[conditions#Grappled|grappled\ \ (Escape **DC 14**) if it is a Large or smaller creature and the spore servant\ \ doesn't have two other creatures [conditions#Grappled|grappled]]." "name": "Pincer"
"source": - "Oot A"
