...
## Appearance
Below average and compact, with Partially shaved gray hair and Brown eyes. Scarred skin. Prominent scar across the face.
...
- **Quirks**: Always cold, wears extra layers, Always barefoot, Can't sit still
- **Fear**: Poverty
- **Dream**: Finding true love

## Background
Believes their evil acts serve a greater good A chance encounter last winter changed their perspective on everything.
...
### Cedric Stormwind the Scholar (Personal - Best friend)
- **Status**: Complicated history
- **History**: Bitter rivals who learned respect
- **Secret**: One is a shapeshifter

### Erasmus Voidwalker the Wise (Political - Patron)
...
### Skills
Deception, Intimidation, Stealth, Perception

### Attacks
- Poisoned blade: +7 to hit, 1d6+3 slashing
- Hidden dagger: +7 to hit, 1d4+3 slashing
...
- Spellcasting: 5 spell slots, knows Fireball, Lightning Bolt, Shield, Scorching Ray, Invisibility, Sleep, Fly, Charm Person, Hold Person
