...
- **Age**: Approximately 400 years old (formed during the Century of Storms)
- **Distinctive Features**:
  - **Living water body**: Translucent blue-green flesh that flows like water
  - **Current-stream hair**: Long hair that moves like underwater currents
  - **Tidal eyes**: Eyes that shift from deep blue to foam white with emotions
  - **Flowing robes**: Clothing made of controlled water that never drips
  - **Pressure aura**: Air pressure changes around him as currents shift
- **Voice**: Sounds like distant ocean waves, with undertones of rushing water

## Personality
- **Core Nature**: Pragmatic, efficient, values flow and movement over stagnation
- **Business Philosophy**: "Everything flows, everything moves, nothing remains static"
- **Values**: Fair trade, reliable navigation, mutual benefit, oceanic harmony
- **Approach**: Direct negotiation, logical solutions, minimal waste of time
- **Dislikes**: Delays, corruption, artificial barriers, those who oppose natural flow

## Abilities & Resources

### Elemental Water Magic
- **Current Control**: Absolute mastery over water movement within miles
- **Pressure Manipulation**: Can create crushing depths or lifting flows
- **Elemental Form**: Can become pure water to travel instantly through currents
- **Storm Summoning**: Calls underwater tempests and maelstroms
- **Navigation Mastery**: Knows every current in the known oceanic realm

### The Current Riders Guild
- **Economic Control**: Regulates 80% of underwater trade routes
...
- **Currency Flows**: Controls movement of wealth between settlements
- **Resource Allocation**: Determines which areas receive supplies
- **Route Security**: Guild provides protection for approved traders

## Relationships

### The Current Council (Inner Circle)
- **Captain Marina Swiftcurrent** - His lieutenant and potential successor
- **Navigator Torrent Deepfinder** - Master of the deepest routes
- **Merchant-Prince Coral Goldflow** - Handles surface world trade
...
## Secrets
> [!warning] DM Only
> - Is actually a fragment of the original oceanic consciousness, given individual form
> - Can communicate with all water sources across multiple realms simultaneously
...
## Combat Tactics
- Prefers negotiation and economic pressure over violence
- When forced to fight: environmental control through water manipulation
- Creates whirlpools, water spouts, and pressure barriers
- Can escape through any water source instantly
- Calls upon Current Rider allies and water elementals

### Stats (Level 14 Storm Sorcerer/Ranger)
**CR 13**
- **AC**: 16 (Natural Armor + fluid defense)
- **HP**: 126 (14d8 + 56)
- **Speed**: 30 ft, swim 120 ft
- **STR**: 14, **DEX**: 18, **CON**: 18, **INT**: 16, **WIS**: 20, **CHA**: 22
- **Saving Throws**: Dex +9, Cha +11
- **Skills**: Persuasion +11, Navigation +13, Insight +10, Survival +10
- **Damage Resistances**: Cold, Thunder; Bludgeoning, Piercing, Slashing from nonmagical attacks
- **Damage Immunities**: Lightning (while in water)
- **Senses**: Tremorsense 120 ft (in water), Darkvision 120 ft
- **Languages**: Common, Aquan, Primordial, Draconic

### Special Abilities
- **Current Master**: Can control water currents within 2 miles
- **Elemental Form**: Can become water for 1 hour, 3/day
- **Pressure Wave**: Creates damaging pressure waves in water
- **Trade Tongue**: Speaks and understands all merchant languages
- **Tidal Knowledge**: Knows the location and cargo of every ship in his territory

### Legendary Actions (3 per turn)
- **Current Strike**: Makes a water whip attack (3d8 bludgeoning)
- **Navigate**: Moves without provoking opportunity attacks
- **Trade Offer**: Attempts to convince enemy to negotiate instead of fight

## Quest Hooks
1. Rare cargo missing from secure trade route - investigation needed
2. New deep current discovered, but dangerous creatures guard it
3. Rival elemental challenging his control over profitable routes
4. Surface world wants to establish underwater trade post
5. Ancient current leads to mysterious location with valuable secrets

## Speaking Style
*"Trade flows like water - block it, and it finds another path. Work with it, and everyone prospers."* - To new merchants

*"The currents remember every ship, every cargo, every promise made and broken. I am the currents."* - Warning to cheaters

*"Surface or depth, the ocean connects all things. Perhaps it's time our people did the same."* - Private diplomatic thought

## DM Notes
- Excellent patron for trade-focused adventures
- Can provide transportation and information across vast areas
- His network makes him invaluable for gathering intelligence
- Economic power can be leverage in political situations
