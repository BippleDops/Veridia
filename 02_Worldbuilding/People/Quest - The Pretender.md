...
accessibility:
  ...
  - coercion
  - memory manipulation
  pronunciation: Quest - The Pretender
  safety_tools:
  - Lines & Veils
  - X-Card
  - Open Door
  screen_reader_summary: Quest - The Pretender is an NPC entangled with faction politics
...
![[04_Resources/Assets/04_Resources/Assets/Art/NPCs/Quest_-_The_Pretender.png|Quest - The Pretender Portrait]]
...
- Failure Still Progresses: Even when rebuffed, Quest - The Pretender sends a warning of a raid that creates a time-sensitive window.
...
Quest - The Pretender presents a distinctive figure. Their bearing suggests both competence and experience. Notable features include:
...
Quest - The Pretender's path to their current position involved:
...
Quest - The Pretender harbors secrets that could change everything:
...
Quest - The Pretender is currently engaged in:
...
1. **The Request**: Quest - The Pretender needs assistance with a delicate matter
...
5. **The Crisis**: Quest - The Pretender is caught in a situation requiring intervention
...
- [[04_Resources_Assets_Locations_location-city-captain-trawl-netcaster-v1-captain-trawl-netcaster.svg]]: *secret ally*
- [[The Emperor]]: *secret ally*
- [[04_Resources_Assets_Symbols_symbol-heraldry-factional-conflicts-factional-conflicts.svg]]: *bitter rival*
