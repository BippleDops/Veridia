...
- **Healing.** The temple sells [Spell Scrolls](/3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Greater Restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) for 3,200 GP apiece and [Spell Scrolls](/3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Remove Curse](/3-Mechanics/CLI/spells/remove-curse-xphb.md) for 300 GP apiece, and the priests have `d3` copies of each scroll in stock on any given day. The priests also have [Cure Wounds](/3-Mechanics/CLI/spells/cure-wounds-xphb.md) and [Lesser Restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spells prepared, which they customarily cast for free.  
