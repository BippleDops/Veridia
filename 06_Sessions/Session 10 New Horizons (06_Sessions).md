...
> Complex magical infrastructure maintains stable but limited connections between worlds. A joint council governs inter-dimensional affairs. The heroes serve as advisors but political tensions run high as both worlds struggle with shared goverce.
...
1. ** Zones**: Areas where magic and life simply cease to exist
...
**Mystical Path** - [[Shard Resoce Tracking]]  
...
actions:
  - name: Multiattack
    desc: The Void Lord makes three  Touch attacks or casts two spells.
  - name:  Touch
...
legendary_actions:
  - name: Move
    ...
    desc: The Void Lord makes one  Touch attack.
