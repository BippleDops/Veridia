...
Roll:`dice: 1d100|Encounter Roll`| d100 | Result |
|------|--------|
...
| 96–00 | Boss-level encounter | Quick difficulty:`dice: 1d4|1=Easy,2=Medium,3=Hard,4=Deadly`## Loot (d100)

Roll:`dice: 1d100|Loot Roll`| 01–15 | Coins only (2d10×10 gp) →`dice: 2d10*10|Gold (gp)`|
...
Roll:`dice: 1d12|Urban Event`| d12 | Result |
...
- Coin Purse:`dice: 3d6*10|Gold (gp)`- Gem Cache:`dice: 2d6*25|Gem Value (gp)`- Scroll Rarity:`dice: 1d6|1-3 Common,4-5 Uncommon,6 Rare`Party level modifier:`dice: 2d6*{level}|Parcel (gp)`## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:*
