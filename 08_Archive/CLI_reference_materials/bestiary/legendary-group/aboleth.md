...
- The aboleth casts [phantasmal force](/03_Mechanics/CLI/spells/phantasmal-force-xphb.md) (no components required) on any number of creatures it can see within 60 feet of it. While maintaining [concentration](/03_Mechanics/CLI/conditions.md#Concentration) on this effect, the aboleth can't take other lair actions. If a target succeeds on the saving throw or if the effect ends for it, the target is immune to the aboleth's phantasmal force lair action for the next 24 hours, although such a creature can choose to be affected.  
