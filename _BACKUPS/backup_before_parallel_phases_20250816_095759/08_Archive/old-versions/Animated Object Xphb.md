...
"actions": - "desc": "Melee Attack Roll: Bonus equals your spell attack modifier, reach 5\ \ ft. Hit: Force damage equal to `dice: 1d4` + 3, `dice: 2d6` + 3 + your spellcasting ability\ \ modifier (Large), or `dice: 2d12` + 3 + your spellcasting ability modifier (Huge)." "name": "Slam"
"source": - "XPHB"
