...
## Appearance
Very tall and imposing, with Braided elaborately unusual color hair and Black eyes. Olive skin. Warm smile that puts people at ease.

**Clothing**: Fine silk robes with gold embroidery
**Accessories**: Decorated dagger, Lucky rabbit's foot

## Personality
- **Traits**: Speaks to inanimate objects; Believes in every conspiracy theory
- **Ideal**: Knowledge: Understanding the world is the key to controlling it
- **Bond**: My hometown is the most important thing
- **Flaw**: I'll do anything to avoid a real fight
- **Quirks**: Counts everything obsessively, Always rhymes when speaking, Never eats meat
...
- Uncanny Dodge: Half damage from one attack
- Spellcasting: 4 spell slots, knows Counterspell, Magic Missile, Invisibility, Lightning Bolt, Shield
