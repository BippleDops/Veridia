...
- world/both
type: note
updated: '2025-08-13T12:34:18.475063+00:00'
world: Both
---
...
| 11-15 | When you first attune to the artifact, it gives you a quest determined by the DM. You must complete this quest as if affected by the [[/03_Mechanics/CLI/spells/geas-xphb|geas]] spell. Once you complete the quest, you are no longer affected by this property. |
| 16-20 | The artifact houses a bodiless life force that is hostile toward you. Each time you use an action to use one of the artifact's properties, there is a 50 percent chance that the life force tries to leave the artifact and enter your body. If you fail a DC 20 Charisma saving throw, it succeeds, and you become an NPC under the DM's control until the intruding life force is banished using magic such as the [[/03_Mechanics/CLI/spells/dispel-evil-and-good-xphb|dispel evil and good]] spell. |
...
| 26-30 | The artifact imprisons a [[/03_Mechanics/CLI/bestiary/aberration/death-slaad-xmm|death slaad]] (see the Monster Manual). Each time you use one of the artifact's properties as an action, the slaad has a 10 percent chance of escaping, whereupon it appears within 15 feet of you and attacks you. |
...
| 76-80 | When you become attuned to the artifact, one of your ability scores is reduced by 2 at random. A [[/03_Mechanics/CLI/spells/greater-restoration-xphb|greater restoration]] spell restores the ability to normal. |
| 81-85 | Each time you become attuned to the artifact, you age `3d10` years. You must succeed on a DC 10 Constitution saving throw or die from the shock. If you die, you are instantly transformed into a [[/03_Mechanics/CLI/bestiary/undead/wight-xmm|wight]] (see the Monster Manual) under the DM's control that is sworn to protect the artifact. |
...
| 96-00 | When you become attuned to the artifact, there is a 10 percent chance that you attract the attention of a god that sends an avatar to wrest the artifact from you. The avatar has the same alignment as its creator and the statistics of an [[/03_Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm|empyrean]] (see the Monster Manual). Once it obtains the artifact, the avatar vanishes. |
^major-detrimental-properties
