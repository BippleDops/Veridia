...
## Appearance
Above average and stocky, with Mohawk auburn hair and Green eyes. Dark skin. Piercing gaze that seems to see through you.

**Clothing**: Noble's finery, slightly out of current fashion
**Accessories**: Ornate walking stick, Decorated dagger

## Personality
- **Traits**: Incredibly optimistic despite evidence; Never backs down from any challenge; Compulsive liar about minor things
...
## Relationships
### Aeliana Keenblade the Cunning (Criminal - Informant)
- **Status**: Complicated history
- **History**: Grew up together in the same neighborhood
- **Secret**: One murdered the other's family

### Felicia Xendar (Criminal - Target)
- **Status**: Strong and trusting
- **History**: Bonded over shared tragedy
- **Secret**: One is mind-controlled

### Lyanna Ironwood (Criminal - Informant)
...
- Spellcasting: 6 spell slots, knows Shield, Hold Person, Fireball, Charm Person, Fly, Lightning Bolt, Magic Missile
