...
- **Quirks**: Hums when nervous, Always carries a lucky charm, Collects buttons
- **Fear**: The undead
...
## Relationships
### Thalia Ironwood the Redeemed (Political - Spy)
- **Status**: Professional only
- **History**: Accidentally bound by magic
- **Secret**: Actually related by blood

### Xander Goldleaf the Wise (Criminal - Fence)
