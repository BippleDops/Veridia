---
aliases: ["The Sacred Heir", "the sacred heir", "Heir Sacred The"]
...
## Key Locations
- **LowerBridge** (City): Key location for quest progression
- **Marshshire** (Dungeon): Key location for quest progression
- **NewBridge** (Wilderness): Key location for quest progression
- **Fallsshire** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Elementals** led by Petra Brightblade
