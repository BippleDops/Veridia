...
## Quest Giver
**Petra Brightblade the Elder** - Religious leader
...
## Key Locations
- **LowerGrove** (City): Key location for quest progression
- **Marshthorpe** (Dungeon): Key location for quest progression
- **Peakthorpe** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Elementals** led by Petra Fireborn the Wise
...
- **Gold**: 3,959 gp
- **Experience**: 5,000 XP
- **Magic Items**: Hidden Orb of the Dawn
