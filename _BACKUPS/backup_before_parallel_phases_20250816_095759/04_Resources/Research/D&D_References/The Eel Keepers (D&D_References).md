...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["The Eel Keepers (D&D References)"]
status: active
priority: normal
...
--- > [!figure] View # The Eel Keepers *"In the dance of current and coil, we find our calling."* ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Overview

The Eel Keepers are a specialized guild of animal handlers who manage, train, and breed the various eel species used throughout Aquabyssos for communication, transportation, and defense. Their expertise with these creatures makes them indispensable to the city's infrastructure. This ancient guild has served the underwater kingdom for over 300 years, developing techniques passed down through generations of master trainers who understand the subtle art of eel communication and control. ## Organization
...
**Support Staff**: 15 maintece and administrative workers ## Guild Structure
...
**Defense Division**: Military and guard eel specialization ## Services Provided
...
**Training Services**: Custom eel training for private clients ## Guild Facilities
...
**Guild Hall**: Administrative center and member meeting place ## Eel Varieties Managed
...
**Deep Dwellers**: Specialized for extreme depth operations ## Training Methods
...
**Specialized Commands**: Complex instruction sets for specific tasks ## Guild Traditions
...
**The Deep Watch**: Solemn remembrance of keepers lost in service ## Relationships
...
**Deep Patrol**: Specialized eels for extreme depth missions ## Adventure Hooks
