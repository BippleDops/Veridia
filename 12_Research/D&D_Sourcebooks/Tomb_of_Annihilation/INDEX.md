...
# Tomb of Annihilation - Integration Index
...
## Description
Jungle exploration and dungeon crawl in Chult
...
TABLE WITHOUT ID
    ...
    cr as "CR",
    status as "Status"
FROM "Tomb_of_Annihilation/Monsters"  
WHERE type = "Monster"
SORT cr
```
...
TABLE WITHOUT ID
    ...
    status as "Status" 
FROM "Tomb_of_Annihilation/Adventures"
