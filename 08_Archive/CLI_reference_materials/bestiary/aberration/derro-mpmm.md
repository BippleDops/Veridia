---
updated: '2025-08-13T01:18:32.632549+00:00'
created: 2025-08-11
type: monster
...
"actions":
  - "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 3 (d6)\
      ...
      \ to deal no damage and knock it [prone](/03_Mechanics/CLI/conditions.md#Prone)."
    "name": "Hooked Spear"
...
"source":
  - "MPMM"
  - "MTF"
"image": "/03_Mechanics/CLI/bestiary/aberration/token/derro-mpmm.webp"
```
^statblock
...
Derro mpmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of derro mpmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around derro mpmm.

## Adventure Hooks

- A rumor ties derro mpmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at derro mpmm to avert a public scandal.
- A map overlay reveals a hidden approach to derro mpmm active only during specific tides/storms.
