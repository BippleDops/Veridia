...
## Appearance
Short and compact, with Shaved black hair and Red eyes. Freckled skin. Prominent scar across the face.
...
- **Quirks**: Speaks to animals like people, Writes everything down, Sneezes when lying
- **Fear**: The dark
...
## Relationships
### Ysara Oakenshield the Guardian (Professional - Partner)
- **Status**: Strained but maintaining
- **History**: Grew up together in the same neighborhood
- **Secret**: One murdered the other's family

### Lyanna Emberfall the Fallen (Criminal - Handler)
...
### Hilda Ashford the Cunning (Professional - Employer)
...
### Attacks
- Shortsword: +4 to hit, 1d6+1 slashing
