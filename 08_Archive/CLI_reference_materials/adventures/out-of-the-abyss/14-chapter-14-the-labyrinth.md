...
updated: '2025-08-13T01:18:32.277796+00:00'
world: Both
status: active
---
...
![](/03_Mechanics/CLI/adventures/out-of-the-abyss/img/099-ooa14-01.webp#center)
...
|-----------|-----------|
| 1–10 | No encounter |
| 11 | 1 [behir](/03_Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) |
| 12 | `2d4` [flumphs](/03_Mechanics/CLI/bestiary/aberration/flumph-xmm.md) |
| 13 | [Gnoll](/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) pack |
| 14 | `d4` [grells](/03_Mechanics/CLI/bestiary/aberration/grell-xmm.md) |
| 15 | `d4` [hezrous](/03_Mechanics/CLI/bestiary/fiend/hezrou-xmm.md) |
| 16 | `4d8` [manes](/03_Mechanics/CLI/bestiary/fiend/manes-xmm.md) |
| 17 | `2d4` [minotaurs](/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) |
| 18 | 1 [monodrone](/03_Mechanics/CLI/bestiary/construct/modron-monodrone-xmm.md) |
| 19 | `2d6` [quaggoths](/03_Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md) |
| 20 | `d4` [shriekers](/03_Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md) |
^encounter

#### Behir

This long-bodied reptile is either prowling a tunnel or resting in a cave when the characters encounter it. The [behir](/03_Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) retreats if reduced to 80 or fewer hit points.

#### Flumphs

This cloister of [flumphs](/03_Mechanics/CLI/bestiary/aberration/flumph-xmm.md) feeds on the psychic energy they detect from a nearby [mind flayer](/03_Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) that has enslaved `2d4` [quaggoths](/03_Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md). The flumphs warn adventurers who communicate with them about the nearby threats, but it is up to the characters whether they wish to engage those threats.

#### Gnoll Pack

![](/03_Mechanics/CLI/adventures/out-of-the-abyss/img/100-ooa14-02.webp#center)

A [gnoll fang of Yeenoghu](/03_Mechanics/CLI/bestiary/fiend/gnoll-fang-of-yeenoghu-xmm.md) named [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) made his way into the Labyrinth shortly after Yeenoghu was summoned to the Underdark. [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) brought with him a pack of hyenas and had them feast on the corpses of his slain victims. This heinous act transformed the hyenas into ten [gnolls](/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md). [Kurr's](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) pack now prowls the Labyrinth in search of Yeenoghu, slaughtering anything and anyone they happen upon.

Unknown to his gnoll progeny, [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) has succumbed to a form of madness that quells his feral demeanor. He's lost his appetite for carnage and is overcome with guilt for all of the creatures he has slain. When his pack happens upon the party, he sends his gnolls into battle but doesn't partake of the violence, hoping that the characters slaughter his brethren. Once they are dead, [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) bows his head solemnly, begs Yeenoghu's forgiveness (first in his own language and then in Abyssal), and then throws himself at the party's mercy.

[Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) is suffering from a form of indefinite madness (see ""Madness"" in chapter 8 of the *Dungeon Master's Guide*) which, if cured, reverts him to a typically feral gnoll. While afflicted with madness, [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) can't bring himself to kill any living creature except in self-defense. If the characters spare his life, [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) can act as a guide, for he has explored a great deal of the Labyrinth and can lead the characters along a safe route to an Underdark shanty town (see "Filthriddens"). Characters have no random encounters if they follow [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) along this route, although they periodically stumble upon the corpses and bones of Underdark creatures slain by his gnolls.

The encounter with [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md)'s pack occurs only once. Any subsequent occurrence of this encounter is with a pack of `3d6` [gnolls](/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md). These gnolls came to the Underdark with Yeenoghu. They cackle and scream the demon lord's name as they tear into their prey.

#### Grells

The [grells](/03_Mechanics/CLI/bestiary/aberration/grell-xmm.md) drop from an overhead shaft to feed.

#### Hezrous

These demons are tearing apart an iron ore cart, a rusted section of mining track, or some other old fixture. Party members can attempt to slip past the demons without arousing their attention. Doing so requires a successful DC 11 Dexterity ([Stealth](/03_Mechanics/CLI/skills.md#Stealth)) check. On a failed check, the [demons](/03_Mechanics/CLI/bestiary/fiend/hezrou-xmm.md) detect the party member and attack.

#### Manes

Characters can hear the mewling of this vile mob long before it appears. The [manes](/03_Mechanics/CLI/bestiary/fiend/manes-xmm.md) scour the Labyrinth for easy prey and move like a tide of putrid flesh.

#### Minotaurs

These [minotaurs](/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) roams the Labyrinth, slaying creatures in the name of Baphomet.

#### Monodrone

This modron has become separated from its fellows (see "March to Nowhere"), and there is a 75 percent chance that it is looking to rejoin them. If the characters can understand its language, the [monodrone](/03_Mechanics/CLI/bestiary/construct/modron-monodrone-xmm.md) repeatedly says, "We are on the march!"
...
These [quaggoths](/03_Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md) are hungry and attack the party regardless of its size. If there are five or more quaggoths in the group, one of them is a quaggoth thonot (see the "Variant: Quaggoth Thonot" sidebar in the "Quaggoth" entry of the *Monster Manual*). If the thonot dies, the other quaggoths immediately break off their attack and begin feasting on the thonot's remains, hoping to gain its psionic power.

#### Shriekers

The [shriekers](/03_Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md) sound off when bright light or a creature is within 30 feet of them. Their shrieking has a 75 percent chance of attracting other monsters, in which case roll again on the Labyrinth Encounters table, treating another shrieker encounter as "no encounter."
...
Searching through the remains turns up two empty potion bottles and a [potion of mind reading](/03_Mechanics/CLI/items/potion-of-mind-reading-xdmg.md).
...
The two [shadow demons](/03_Mechanics/CLI/bestiary/fiend/shadow-demon-xmm.md) lurk in the darkness of this room and attack the first character who enters, likely taking their prey by surprise.

### Battlements

The top of the tower features an open space surrounded by a crenelated wall. If the four [gargoyles](/03_Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) have not yet attacked the adventurers, they do so here.
...
This wretched gnoll is named [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md). Thanks to treachery he committed against his kind, the minotaurs spared his life. However, their mercy comes with regular abuse and torment. The gnoll now sees himself as a loyal and willing servant of the brutes, and he is eager to lead gnolls and anyone else to his minotaur masters.

[Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) is a [gnoll](/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) with the following modifications:

- [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) has 11 hit points.  
- He has a walking speed of 25 feet.  
- He has disadvantage on Wisdom checks and Wisdom saving throws because of the physical and mental abuse he has suffered. A [lesser restoration](/03_Mechanics/CLI/spells/lesser-restoration-xphb.md) spell rids him of these effects.  

Cringing and mewling, [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) approaches the party with arms out and head down. He speaks in both Gnoll and Abyssal. If the characters can't understand him, he pantomimes helpful gestures and beckons them to follow him.

> [!readaloud] 
> 
> "Powerful masters," the gnoll whines. "You honor us by your presence. Seek you passage through the maze? The Spiral of the Great Horned King? I can help. Yes. Trust [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) and he will see you through the maze, he will."
^4aa

Any aggressive action sends [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) skittering back into the maze and to his masters. If the characters capture him, he shrieks and screams, drawing one [minotaur](/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) to investigate the racket.

Accepting [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md)'s offer transforms the cringing gnoll into a dutiful guide. He leads the characters through passage after passage, choosing directions seemingly at random until the characters encounter the minotaurs. If the battle turns against the minotaurs, [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) flees.

If the adventurers show pity or kindness, [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) becomes confused, as he has never experienced such things. A character can befriend the gnoll with a successful DC 20 Charisma ([Persuasion](/03_Mechanics/CLI/skills.md#Persuasion)) check. If any character uses magical healing on [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md), the check is automatically successful.

If the characters befriend [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md), he warns them to turn back, flee, and never return. He says his masters are vile minotaurs who wait in the maze, eager to kill all trespassers. If asked, [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) explains that the minotaurs spared his life in exchange for leading travelers into the maze. If the characters insist on entering the maze, [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) goes with them, trying to keep his new friends safe. If the characters defeat the minotaurs and move deeper into the Labyrinth, [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) can accompany them as a follower and guide, giving the characters advantage on Wisdom ([Survival](/03_Mechanics/CLI/skills.md#Survival)) checks to avoid becoming lost in the Labyrinth.

### Into the Maze

![](/03_Mechanics/CLI/adventures/out-of-the-abyss/img/101-ooa14-03.webp#center)
...
When the characters enter the maze, have them choose their pace (fast, normal, or slow). It takes 1 hour to navigate the maze at a fast pace, 2 hours at a normal pace, or 3 hours at a slow pace. Halfway through the journey, the navigator must make a DC 15 Wisdom ([Survival](/03_Mechanics/CLI/skills.md#Survival)) check. A fast pace imposes a −5 penalty to the check. A slow pace grants a +5 bonus. On a success, the characters find their way out. On a failure, the characters must start the journey from the beginning.
...
If [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) was attacked by the characters and fled into the maze, he does his best to bring threats down on them, in which case roll two d20s and take the higher result. If [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) is friendly to the party and accompanying them, he tries to steer them away from danger, in which case roll two d20s and take the lower result.
...
| 11–12 | Corpse |
| 13–14 | Gnawed bones |
| 15–17 | `2d4` [gnolls](/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) |
| 18–20 | `d6` [minotaurs](/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) |
^encounter
...
A frenzied group of `2d4` [gnolls](/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) is lost in the maze. The gnolls attack any creatures they see.

#### Minotaurs

These bloodthirsty [minotaurs](/03_Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) are hunting gnolls but attack any other creatures they happen upon.
...
Filthriddens was, until recently, a shanty town of Underdark exiles and refugees. The greatest threat to inhabitants—apart from food shortages—was the minotaurs that raided the settlement from time to time, dragging off screaming prisoners to meet a grisly fate. The recent arrival of the demon lords changed things. A group of minotaurs was on its way to raid Filthriddens when Yeenoghu and a pack of his frenzied followers tore through this part of the Labyrinth, catching the minotaurs off guard and slaughtering them. The sole witness to this carnage was [Grisha](/03_Mechanics/CLI/bestiary/npc/grisha-oota.md), an escaped human slave of the drow. Yeenoghu's intercession saved him from the minotaurs.

Yeenoghu and his pack moved on, but [Grisha](/03_Mechanics/CLI/bestiary/npc/grisha-oota.md) took the head of a slain minotaur and brought it back to Filthriddens. The skull became a talisman as [Grisha](/03_Mechanics/CLI/bestiary/npc/grisha-oota.md) named Yeenoghu as the new protector and patron of Filthriddens. Residents who opposed this dark worship were exiled or executed in short order. The cult of Yeenoghu now controls the settlement, and [Grisha](/03_Mechanics/CLI/bestiary/npc/grisha-oota.md) rules with an iron fist. He senses the power of Yeenoghu in all things—and particularly in the way in which cultists have begun to rise as undead ghouls after death.

### Grisha's Greeting

Filthriddens lies 48 miles from the Spiral of the Horned King, deeper in the Labyrinth. [Kurr](/03_Mechanics/CLI/bestiary/npc/kurr-oota.md) (see "Random Encounters") or [Gash](/03_Mechanics/CLI/bestiary/npc/gash-oota.md) (see "Gash the Gnoll") might lead the characters here if they don't find it on their own.
...
[Grisha](/03_Mechanics/CLI/bestiary/npc/grisha-oota.md) (see appendix C) can recount the history of Filthriddens and how Yeenoghu saved its denizens from the oppression of the minotaurs. He can also reveal how he spent years as a slave of the drow. [Grisha](/03_Mechanics/CLI/bestiary/npc/grisha-oota.md) seeks new disciples to grow his cult's power.

Twelve [cultists](/03_Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) (a mix of shield dwarves, halflings, and humans) support [Grisha](/03_Mechanics/CLI/bestiary/npc/grisha-oota.md) if a fight breaks out. Ten of them are hidden in the shanties. Two more stand next to a zurkhwood door, beyond which lies a small side cave where cultists who have died and risen as undead are kept. If battle erupts, the cultists open the door and release six [ghouls](/03_Mechanics/CLI/bestiary/undead/ghoul-xmm.md). The ghouls ignore the cultists as long as there are other creatures to feed on.
...
As the party travels deeper into the Labyrinth, any character with a passive Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) score of 15 or higher hears the sounds of marching feet off in the distance. To investigate the source of the noise, the characters must travel for 15 minutes through cramped tunnels requiring as much climbing as crawling. At the end of this time, the adventurers emerge onto a shelf 15 feet up the wall of a broad, straight tunnel some 20 feet high.
...
Twelve [monodrones](/03_Mechanics/CLI/bestiary/construct/modron-monodrone-xmm.md) and a [tridrone](/03_Mechanics/CLI/bestiary/construct/modron-tridrone-xmm.md) have been wandering the Labyrinth since the last Great Modron March. The modrons became separated from their fellows and trapped here. Unable to find their way back to Mechanus, the modrons have been pressing on (and on), knowing that they must find their way back or be destroyed in the process.
...
> 
> On the shores of an underground lake, a pack of frenzied gnolls and hyenas surrounds a demon standing nearly twenty feet tall, with massive arms, clawed hands, cloven hooves, and the head of a bull. This is a goristro, whose heart [Vizeran DeVir](/03_Mechanics/CLI/bestiary/npc/vizeran-devir-oota.md) has instructed you to claim.
> 
...
[Yeenoghu](/03_Mechanics/CLI/bestiary/npc/yeenoghu-mpmm.md) (see appendix D) has been wandering the Underdark since he was first summoned, and the adventurers have run across him and his pack. The characters' only advantage at this moment is that they haven't yet been detected. Considering their level at this stage of the adventure, the players might be creating new characters quite soon if they dare confront the demon lord.

If the characters stay hidden and observe, Yeenoghu leaves in short order. He is restless and eager for new prey. Yeenoghu gathers up most of the gnolls and hyenas and leads them down a tunnel on the right side of the cavern. Eight [gnolls](/03_Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) led by a [gnoll pack lord](/03_Mechanics/CLI/bestiary/fiend/gnoll-pack-lord-xmm.md) remain in the cavern, feasting on the goristro's corpse.
...
The close brush with Yeenoghu pays dividends to the adventurers by delivering two components of Vizeran's ritual into their hands. The first is the heart of the goristro, which the characters can remove from its corpse. The massive heart is the size of a small trunk and weighs nearly one hundred pounds. Any characters close to it while it is being transported imagine that they can occasionally hear it beating. A character who carries the heart, even in a [bag of holding](/03_Mechanics/CLI/items/bag-of-holding-xdmg.md) or similar extradimensional space, makes saving throws against madness with disadvantage.

The second component takes the form of a few spatters of a demon lord's blood. A successful DC 10 Wisdom ([Perception](/03_Mechanics/CLI/skills.md#Perception)) check finds some of Yeenoghu's black blood on the fallen goristro's horns.
...
This chamber houses the [petrified](/03_Mechanics/CLI/conditions.md#Petrified) remains of eight fallen angels, condemned by the gods to pass the ages in the dark depths. Each appears to have been carved from stone in some position of fear, suffering, hatred, or longing. Each statue is spotted with lichen and marred by mineral deposits, which have crystallized out of the water dripping from the ceiling over uncounted years.

Even though they are transformed into stone statues, the fallen angels remain very much alive, their [petrified](/03_Mechanics/CLI/conditions.md#Petrified) bodies having become prisons for their minds and souls. They remember who they were. They know what they did and why they are here. They know everything transpiring around them. Yet they can do nothing. They are trapped forever, and the isolation, darkness, and endless torment of their fate have driven them mad. No spell can undo the angels' curse or free them from their [petrified](/03_Mechanics/CLI/conditions.md#Petrified) state.

![](/03_Mechanics/CLI/adventures/out-of-the-abyss/img/102-ooa14-04.webp#center)
...
A successful DC 15 Intelligence ([Arcana](/03_Mechanics/CLI/skills.md#Arcana)) check is needed to activate the device by puzzling out its array of gears and levers. It then takes 12 rounds for the engine to "align itself" and activate its magical effect. If an initiative order hasn't already been established by the time the engine activates, have everyone in the party roll initiative.
...
The engine shuts down if any part of it comes into contact with an [antimagic field](/03_Mechanics/CLI/spells/antimagic-field-xphb.md) or if it is targeted by a successful [dispel magic](/03_Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 19). Otherwise, it can only be shut down by a [wish](/03_Mechanics/CLI/spells/wish-xphb.md) spell or divine intervention.
...
| 11–15 | The engine makes a loud "WHAAAH" sound until the start of its next turn. For as long as the sound lasts, the engine projects an [antimagic field](/03_Mechanics/CLI/spells/antimagic-field-xphb.md) (as the spell) around itself. |
| 16–19 | The hollow interior of the engine flickers with crimson light until the end of its turn, whereupon one dead character or NPC of the DM's choice is restored to life, as though subjected to a [resurrection](/03_Mechanics/CLI/spells/resurrection-xphb.md) spell. The revived creature appears in a safe, unoccupied space within 120 feet of the engine. |
...
| 28–32 | The engine hums until the end of its turn, at which point a [green slaad](/03_Mechanics/CLI/bestiary/aberration/green-slaad-xmm.md) appears in a safe space within 120 feet of the engine. The slaad rolls initiative and, on its turn, attacks any other creatures it sees. |
| 33–35 | The engine groans loudly and turns each creature within 120 feet of it [invisible](/03_Mechanics/CLI/conditions.md#Invisible). A creature's invisibility lasts until it attacks or casts a spell. |
...
| 40–43 | Multicolored arcs of light play across the surface of the engine, which casts a [polymorph](/03_Mechanics/CLI/spells/polymorph-xphb.md) spell (save DC 18) on each creature within 20 feet of it. Any creature that fails the saving throw is polymorphed into a [flying snake](/03_Mechanics/CLI/bestiary/monstrosity/flying-snake-xmm.md). |
...
| 58–60 | The engine flickers with blue light and casts [faerie fire](/03_Mechanics/CLI/spells/faerie-fire-xphb.md), targeting all creatures within 20 feet of it (save DC 18). The spell's effect has a duration of 1 minute. |
| 61–66 | The engine spews harmless, multicolored sparks until the start of its next turn. |
| 67–70 | The engine emits a flash of violet light. Each creature within 20 feet of the engine must succeed on a DC 18 Constitution saving throw or be [petrified](/03_Mechanics/CLI/conditions.md#Petrified) until the engine's next turn. |
