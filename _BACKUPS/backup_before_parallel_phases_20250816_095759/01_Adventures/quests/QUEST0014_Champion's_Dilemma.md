---
aliases: ["Champion's Dilemma", "champion's dilemma", "Dilemma Champion's"]
tags: [generated]
id: QUEST0014
...
## Quest Giver
**Osric Goldleaf** - Religious leader
...
## Key Locations
- **UpperBridge** (City): Key location for quest progression
- **LowerBridge** (Dungeon): Key location for quest progression
- **OldBridge** (Wilderness): Key location for quest progression
- **NewBridge** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Constructs** led by Osric Brightblade
...
---
*Generated: 2025-08-15T03:20:13.155Z*
