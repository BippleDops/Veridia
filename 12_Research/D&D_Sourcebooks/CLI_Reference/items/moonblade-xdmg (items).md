...
| 81-85 | The *Moonblade* scores a [[critical hit xphb|Critical Hit]] on a roll of 19 or 20 on the `d20`. |
| 86-95 | You can take a [[bonus action xphb|Bonus Action]] to cause the *Moonblade* to flash brightly. Each other creature that is within 30 feet of you and not behind [[cover xphb|Total Cover]] must succeed on a DC 15 Constitution saving throw or have the [[conditions#Blinded|Blinded]] condition for 1 minute. A creature repeats the save at the end of each of its turns, ending the effect on itself on a success. You can't use this property again until you finish a [[short rest xphb|Short]] or [[long rest xphb|Long Rest]]. |
| 96-99 | The Moonblade has the properties of a [[ring of spell storing xdmg|Ring of Spell Storing]]. |
| 100 | You can take a [[actions#Magic|Magic]] action to conjure a spectral entity that resembles a shadowy elf if you don't already have one serving you. The entity appears in an unoccupied space within 120 feet of you. It uses the [[shadow xmm|Shadow]] stat block with these changes: it is a Fey, has a Neutral alignment, and doesn't create new shadows. You control this entity, deciding how it acts and moves. It remains until it drops to 0 [[hit points xphb|Hit Points]] or you dismiss it as a [[actions#Magic|Magic]] action. |
^moonblade-properties
