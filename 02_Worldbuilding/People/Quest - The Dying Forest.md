...
## Initial Information
- Trees die from the inside out, bark turning coal-black
- Animals exhibit aggressive, unnatural behavior before fleeing
- Strange purple mist seen drifting between diseased trees
- Ancient stone markers throughout forest show cracks
- Local farmers report nightmares and crop failures
...
- Unnatural silence in affected areas

**Deep Forest Findings:**
...
- Twisted fey creatures serving unknown master

## The Source
**The Blighted Heart:** Deep within the forest lies a corrupted World Tree, infected by Far Realm energy leaked through a planar rift. The corruption spreads through root networks, transforming the forest into an aberrant ecosystem.

### Primary Antagonist
**The Whisper Grove:** Collective consciousness of corrupted dryads and treants, led by the fallen archdruid Malachar who opened the rift seeking greater power.
...
4. **Malachar the Fallen** (CR 8) - Final boss in the corrupted World Tree

## Challenges and Obstacles
- **Environmental:** Toxic spores requiring Constitution saves
- **Navigation:** Shifting paths and illusions hiding true routes
- **Madness:** Exposure to Far Realm energy causes temporary insanity
- **Time Pressure:** Corruption spreads 1 mile per day
...
**Diplomatic Route:** Redeem Malachar through persuasion and restoration magic
...
**Environmental:** Restored forest provides ongoing benefits to region

## Complications
- Corrupted animals follow party back to civilization
- Other adventuring party already in forest with different agenda
- Government wants to burn entire forest to stop spread
- Fey court demands party answer for disturbing their realm
- Malachar's corruption was actually containing worse evil

## Follow-up Adventures
- Investigate similar corruption in other forests
- Explore the Far Realm connection further
- Deal with political fallout from government vs druid conflict
