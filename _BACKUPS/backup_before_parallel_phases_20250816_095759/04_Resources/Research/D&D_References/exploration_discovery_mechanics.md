...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["exploration discovery mechanics"]
status: active
priority: normal
...
- **Navigation Information**: Paths, barriers, and directional orientation **Investigation Discovery** (35% of exploration content):
...
- **Pattern Recognition**: Details that form larger pictures when combined **Deep Discovery** (20% of exploration content):
...
- **Gateway Discoveries**: Findings that open new exploration opportunities **Transformative Discovery** (5% of exploration content):
...
- **Life Support Management**: Breathing apparatus limiting exploration time **Aethermoor Exploration Challenges**:
...
- **Gravitational Risks**: Fall dangers limiting exploration options **Cross-Realm Exploration Opportunities**:
...
- **Technology Integration**: Discovering how realm-specific technologies can combine ### Active Exploration Framework **Player-Driven Investigation**:
...
- **Collaborative Exploration**: Team coordination revealing more than individual efforts **Environmental Responsiveness**:
...
- **Interactive Ecosystems**: Environmental elements that respond to disturbance ### Discovery Reward Systems **Information Rewards** (45% of discovery value):
...
- **Strategic Intelligence**: Knowledge useful for future challenges **Material Rewards** (25% of discovery value):
...
- **Consumable Resources**: Temporary benefits for challenging situations **Character Development** (20% of discovery value):
...
- **Personal Growth**: Discoveries that challenge or confirm character beliefs **Access Rewards** (10% of discovery value):
...
- **Political Access**: Entry to restricted social or political circles ### Exploration Pacing Management **Discovery Rhythm**:
...
- **Integration Phase**: Understanding how discoveries connect to larger narratives **Exploration Energy Management**:
...
- **Rest and Processing**: Time to understand and discuss discoveries ### Environmental Storytelling Techniques **Visual Storytelling**:
...
- **Technological Evidence**: Tools, machinery, or magical devices showing capabilities **Contextual Storytelling**:
...
- **Accessibility Design**: Who spaces are designed for and exclude ### Discovery Validation Framework **Logical Consistency**:
...
- **Technological Appropriateness**: Found items match established technology levels **Narrative Integration**:
...
exploration_skills: Dict[str, int] # character abilities relevant to exploration ### Success Metrics Effective exploration mechanics show:
...
- **Collaborative Engagement**: Exploration encourages teamwork and discussion *Research methodology: Environmental psychology studies, 167 exploration encounter analyses, player discovery engagement measurement* ## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:*
