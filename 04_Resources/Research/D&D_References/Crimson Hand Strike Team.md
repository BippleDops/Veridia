...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Crimson Hand Strike Team"]
status: active
priority: normal
...
The modern Crimson Hand operates at the cutting edge of military technology and magical capability, with access to experimental equipment and techniques not available to other Aethermoor forces. Recent operations have focused on containing the spread of crystal corruption, investigating deep-sea anomalies, and maintaining the delicate balance of power between Aethermoor and Aquabyssos. The team's current composition includes specialists in underwater operations, reality manipulation resistance, diplomatic assassination, and artifact containment, reflecting the diverse threats facing Aethermoor in the contemporary period. ### In Aquabyssos

While the general population of Aquabyssos remains unaware of the Crimson Hand's existence, certain intelligence networks have detected signs of their operations. These glimpses have created a mythology around mysterious Surface agents capable of extraordinary feats, leading to both respect and concern within Aquabyssos security circles. The few Aquabyssos officials who are aware of the team's existence view them as both a threat and a necessary balance to their own covert operations, creating a complex dynamic of mutual deterrence. ### In Aethermoor

Within Aethermoor, the Crimson Hand exists as a whispered legend among military circles, with most personnel believing them to be either fictional or highly exaggerated. This deliberate cultivation of ambiguity serves the unit's operational security while maintaining their psychological impact on potential threats. The team's successes are typically attributed to other causes or credited to different organizations, ensuring their continued invisibility while building their reputation among those who know the truth. ### Operation Depth Strike

A classified mission to neutralize a threat within Aquabyssos that conventional forces could not approach, demonstrating the team's unique capabilities. ### The Reality Breach Incident

The Crimson Hand's intervention prevented a catastrophic reality alteration event, though the full details remain classified at the highest levels. ### The Coral Gardens Extraction
...
Direct contact with team members or their operations creates complex moral and political choices for the party. ### Late Campaign

The team's true capabilities and hidden knowledge become crucial to resolving major campaign threats and political crises. ### Running This Element

Use the Crimson Hand as mysterious antagonists, reluctant allies, or complex moral challenges. Their capabilities should feel threatening but not insurmountable, and their motivations should create interesting dilemmas. ### Common Questions

**Q:** How do players detect Crimson Hand operations?
**A:** Through exceptional investigation skills, magical detection, or deliberate team revelation for recruitment purposes. **Q:** Can player characters join the Crimson Hand?
**A:** Only under extraordinary circumstances and with full understanding of the moral and practical implications. ### Customization Options

Adjust the team's morality and methods to match your campaign tone - noble defenders, necessary evils, or ruthless pragmatists depending on the story needs. ## Player-Facing Summary Crimson Hand Strike Team is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of Crimson Hand Strike Team as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Crimson Hand Strike Team. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related Notes - [[Similar Topic 1]]

- [[Contrasting Approach]]
- [[Advanced Version]]
- [[Historical Context]] ## 12_Research Specific Content Contextual improvement based on 12_Research ## References - [[Aethermoor - Session 04 The Silverscale Gambit]]
