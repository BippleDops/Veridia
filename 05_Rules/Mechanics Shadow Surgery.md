...
improvements: 20
status: active
aliases: ["Mechanics Shadow Surgery"]
priority: normal
category: 05 Rules
subcategory: Mechanics Shadow Surgery.Md
related: []
cssclass: standard
publish: false
...
*Tags*: #mechanics #rules #homebrew #variant #system ## Rule Summary 03_Mechanics_Shadow_Surgery provides a systematic approach to handling specific game situations. This mechanic integrates with core D&D 5e rules while adding depth to gameplay. ## When to Use Apply this rule when:
...
- Connections to overarching campaign themes ## Plot Hooks - A document has gone missing and chaos spreads

- Strange accidents suggest ancient magic
- A document has gone missing and truth emerges
- Someone is hunting an heir for power ## Edge Cases & Rulings ### Q: What if a player has multiple inspiration sources?
