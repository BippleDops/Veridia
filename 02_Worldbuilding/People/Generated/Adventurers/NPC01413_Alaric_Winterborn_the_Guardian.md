...
## Appearance
Short and delicate, with Dreadlocks auburn hair and Blue eyes. Olive skin. Birthmark shaped like a constellation.

**Clothing**: Mage robes covered in arcane symbols
**Accessories**: Multiple earrings

## Personality
- **Traits**: Speaks to inanimate objects; Always speaks in metaphors and riddles; Believes in every conspiracy theory
...
## Current Situation
- **Occupation**: Monster slayer
- **Resources**: Monster lore, Combat experience, Magic items
...
### Gavril Thornweave the Scholar (Political - Ally)
...
### Delara Jadeclaw the Wanderer (Family - Cousin)
- **Status**: Strained but maintaining
- **History**: Former lovers who remained friends
- **Secret**: One murdered the other's family

### Qadim Keenblade the Redeemed (Political - Ally)
- **Status**: One-sided affection
...
### Skills
Perception, Stealth, Investigation

### Attacks
- Longsword: +5 to hit, 1d8+3 slashing
- Longbow: +4 to hit, 1d8+3 piercing

### Special Abilities
- Uncanny Dodge: Half damage from one attack
- Evasion: No damage on successful DEX save
- Evasion: No damage on successful DEX save
- Spellcasting: 5 spell slots, knows Hold Person, Fireball, Sleep, Charm Person, Misty Step, Scorching Ray, Shield
