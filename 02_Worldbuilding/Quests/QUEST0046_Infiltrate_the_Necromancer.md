...
---
# Infiltrate the Necromancer

*Defend Quest for levels 3-7*

**ID**: QUEST0046

## Quest Giver
**Gareth Darkwater** - Worried parent
...
## Key Locations
- **Marshhollow** (City): Key location for quest progression
- **NewHill** (Dungeon): Key location for quest progression
- **Fallshollow** (Wilderness): Key location for quest progression
- **Grovehollow** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Constructs** led by Gareth Shadowmere
...
- **Gold**: 2,380 gp
- **Experience**: 3,000 XP
- **Magic Items**: Glorious Gauntlet of Power
- **Other**: Property deed
