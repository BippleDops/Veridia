...
- **Unstable Formations**: Loud noises trigger collapse (**DC 15** Dex save, `dice: `dice: 2d10`` damage)
...
- **Lightning Barrage**: Random targets take `dice: `dice: 2d10`` lightning damage
...
- **2 Failures**: Temporal displacement, lose `dice: `dice: 1d4`` hours
...
args: ["`dice: `dice: 8d20``"] ### Environmental Effect Generator

label: Generate Random Environmental Effect
id: environmental-effect
args: ["`dice: `dice: 1d20``"] ### Social Encounter Tracker

INPUT[progress Bar(min Value(0), max Value(10):social-progress]

Label: Social Encounter Progress --- ### Shard-Influenced Random Encounters`dice: `dice: `dice: 1d20```| d20 | Encounter Type | Description |
...
| 7-8 | Reality Fluctuation | Physics work differently for `dice: `dice: 1d6`` minutes |
...
| 19-20 | Convergence Tremor | Minor reality merger event affects immediate area | ### Combat Complication Table`dice: `dice: `dice: 1d12```| d12 | Complication |
...
| 11-12 | Shard energy surge empowers or debuffs combatants | ### Social Encounter Complications`dice: `dice: `dice: 1d10```| d10 | Complication |
...
`dice: `dice: 1d20`` # Encounter type

`dice: `dice: 1d12`` # Complication level

`dice: `dice: 1d6`` # Environmental factor ### Shard Corruption Checks

`dice: `dice: 1d20``+Wis # Corruption resistance

`dice: `dice: 1d6`` # Corruption severity ### Initiative Rolling

`dice: `dice: 1d20``+Dex # Individual initiative

`dice: `dice: 4d20`` # Group initiative for multiple creatures ### Environmental Effect Duration

`dice: `dice: 1d6`` # Rounds for temporary effects

`dice: `dice: 1d10`` # Minutes for extended effects

`dice: `dice: 1d4`` # Hours for long-term changes --- ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:*
