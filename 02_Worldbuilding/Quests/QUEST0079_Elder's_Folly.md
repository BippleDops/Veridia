...
## Quest Giver
**Ophelia Darkwater** - Military officer
...
## Key Locations
- **PortPeak** (City): Key location for quest progression
- **Havenwick** (Dungeon): Key location for quest progression
...
- **Gold**: 2,480 gp
- **Experience**: 4,000 XP
- **Magic Items**: Hidden Shield of the Dawn
