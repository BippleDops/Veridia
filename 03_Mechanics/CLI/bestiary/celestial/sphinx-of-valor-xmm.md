...
"actions":
  ...
  - "desc": "The sphinx emits a magical roar. Whenever it roars, the roar has a different\
      \ effect, as detailed below (the sequence resets when it takes a [Long Rest](/03_Mechanics/CLI/variant-rules/long-rest-xphb.md)):\n\
      \n- First Roar. Wisdom Saving Throw: DC 20, each enemy in a 500-foot [Emanation](/03_Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. Failure: The target has the [Frightened](/03_Mechanics/CLI/conditions.md#Frightened)\
      \ condition for 1 minute.  \n- Second Roar. Wisdom Saving Throw: DC 20,\
      \ each enemy in a 500-foot [Emanation](/03_Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. Failure: The target has the [Paralyzed](/03_Mechanics/CLI/conditions.md#Paralyzed)\
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      \ [Heroes' Feast](/03_Mechanics/CLI/spells/heroes-feast-xphb.md), [Zone of Truth](/03_Mechanics/CLI/spells/zone-of-truth-xphb.md)"
    "name": "Spellcasting"
"legendary_actions":
