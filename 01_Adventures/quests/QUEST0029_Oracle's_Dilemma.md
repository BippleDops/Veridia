---
aliases: ["Oracle's Dilemma", "oracle's dilemma", "Dilemma Oracle's"]
tags: [generated]
id: QUEST0029
...
## Quest Giver
**Delilah Goldleaf** - Worried parent
...
## Key Locations
- **Groveford** (City): Key location for quest progression
- **NorthGate** (Dungeon): Key location for quest progression
- **Bridgestead** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Wild Beasts** led by Delilah Brightblade
