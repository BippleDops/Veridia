...
improvements: 20
status: active
aliases: ["Educational Systems and Institutions"]
priority: normal
category: 05 Rules
subcategory: Educational Systems And Institutions.Md
related: []
cssclass: standard
publish: false
...
**Complexity**: Moderate
**Purpose**: Enhance gameplay in specific situations ## Description Educational Systems and Institutions provides a structured approach to handling specific game situations that benefit from additional mechanical depth. This system integrates with existing D&D 5e rules while adding meaningful choices and consequences. ### Basic Resolution
...
*Tags*: #mechanics #rules #homebrew #variant #system ## Rule Summary Educational_Systems_and_Institutions provides a systematic approach to handling specific game situations. This mechanic integrates with core D&D 5e rules while adding depth to gameplay. ## When to Use Apply this rule when:
...
- Someone is blackmailing a witness for love ## Examples of Play ### Basic Example
...
- Maintain consistency across sessions ## References - [[Child Life in the Realms]]
