...
*Source: Dungeon Master's Guide (2024) p. 222* **Magic Item's Creator or Intended User**`dice: [](magic-item-special-features-magic-items-creator-or-intended-user-xdmg.md#^magic-items-creator-or-intended-user)`| dice: `dice: 1d20` | Creator or Intended User |
|------------|--------------------------|
...
| 13 | Fey. The item is exquisitely crafted from the finest materials and glows with a pale radiance in moonlight, shedding [[Light Xphb]] in a 5-foot radius. Any metal in the item is silver or mithral rather than iron or steel. |
