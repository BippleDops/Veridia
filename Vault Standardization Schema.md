---
created: null
updated: '2025-08-13T12:34:03.138492+00:00'
world: Both
status: draft
tags:
- both
...
### Standardized Naming Convention (✅ APPLIED TO 5,081 FILES)

All markdown files follow consistent naming standards for improved organization and searchability:

#### General Rules
- **Separator**: Use spaces as word separators (not underscores or hyphens)
- **Case**: Title Case with smart capitalization
- **Length**: Target 15-45 characters (optimal for readability)
- **Characters**: Only alphanumeric, spaces, hyphens, apostrophes, and ampersands
- **Structure**: Descriptive and specific names that indicate content

#### Content-Specific Patterns

**Adventures**
```
Adventure Name - Chapter Title.md
Quest - Specific Mission Name.md
Session - Campaign Arc Name.md
```

**NPCs (People)**
```
Character Full Name.md
Title Character Name.md
Ruler Name the Descriptor.md
```

**Locations (Places)**
```
Location Name.md
Region - Specific Place.md
The Geographic Feature.md
```

**Factions (Groups)**
```
Organization Full Name.md
The Faction Title.md
Guild or Society Name.md
```

**Lore**
```
Historical Event Name.md
Topic or Concept Name.md
The Legend or Myth Title.md
```

**Items**
```
Item Name.md
The Artifact Title.md
Equipment Type - Specific Name.md
```

**Mechanics**
```
System Name Rules.md
Mechanic Type Guidelines.md
Rule Category Reference.md
```

**Templates**
```
Template - Purpose Type.md
Framework for Content Type.md
Structure - Specific Use.md
```

#### Examples of Good Names
- `Queen Seraphina Lumengarde.md`
- `The Crystal Throne.md`
- `Port Meridian - Harbor District.md`
- `Shadow Magic Rules.md`
- `Template - NPC Character Sheet.md`

#### Examples of Poor Names (Corrected)
- `q.md` → `Quest Title.md`
- `file_with_underscores.md` → `File with Underscores.md`
- `ALLCAPSNAME.md` → `All Caps Name.md`
- `file-with-lots-of-hyphens.md` → `File with Lots of Hyphens.md`

### Implementation Notes
- **Backup Created**: All original files backed up before renaming
- **Links Updated**: Internal links automatically updated to maintain references
- **Consistency**: 5,081 files standardized across all content types
- **Standards Applied**: Title Case, space separators, appropriate length
