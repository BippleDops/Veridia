...
*Negotiate Quest for levels 5-9*

**ID**: QUEST0092

## Quest Giver
**Magnus Brightblade the Terrible** - Dying adventurer
...
### Hidden Objective
*DM Only: Success triggers larger conflict*
...
## Key Locations
- **Watchthorpe** (City): Key location for quest progression
- **WestGrove** (Dungeon): Key location for quest progression
- **Hillthorpe** (Wilderness): Key location for quest progression
- **LowerGrove** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Corrupt Guards** led by Magnus Fireborn
...
- **Gold**: 3,755 gp
- **Experience**: 5,000 XP
- **Magic Items**: Eldritch Orb of the Dawn
- **Other**: Noble title
...
---
*Generated: 2025-08-15T03:21:04.093Z*
