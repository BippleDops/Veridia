...
**Crystal Resoce (3/day).** Matthias strikes his hammer against a crystal surface, creating a harmonic frequency that can either stabilize corrupted crystals (healing `dice: 2d8` HP to crystal-based creatures) or disrupt hostile [[Crystal Magic (dispel magic effect).
