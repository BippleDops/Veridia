...
> Warning lights flash as the tube system attempts to divert you into a maintece cylinder—a dead end that would trap you for manual "processing."
...
**Environment**: Complex intersection area with multiple tubes, switching stations, and maintece areas.

**New Opportunities**:
- **Multiple Paths**: Choice of routes affects arrival time and pursuit difficulty
- **Obstacles**: Use switching mechanisms and maintece systems against pursuers
...
- **Maintece Tunnels**: Slowest but most opportunities for ambush/sabotage
...
- **Political Targets**: Conspiracy remts may seek revenge
