...
updated: '2025-08-13T01:18:31.966106+00:00'
world: Both
status: active
---
...
|-------------|----------------|
| 1–5 | Roll `d6` times on [Magic Item Table A](/03_Mechanics/CLI/tables/magic-item-table-a.md). |
| 6–10 | Roll `d4` times on [Magic Item Table B](/03_Mechanics/CLI/tables/magic-item-table-b.md). |
| 11–15 | Roll `d4` times on [Magic Item Table C](/03_Mechanics/CLI/tables/magic-item-table-c.md). |
| 16–20 | Roll `d4` times on [Magic Item Table D](/03_Mechanics/CLI/tables/magic-item-table-d.md). |
| 21–25 | Roll `d4` times on [Magic Item Table E](/03_Mechanics/CLI/tables/magic-item-table-e.md). |
| 26–30 | Roll `d4` times on [Magic Item Table F](/03_Mechanics/CLI/tables/magic-item-table-f.md). |
| 31–35 | Roll `d4` times on [Magic Item Table G](/03_Mechanics/CLI/tables/magic-item-table-g.md). |
