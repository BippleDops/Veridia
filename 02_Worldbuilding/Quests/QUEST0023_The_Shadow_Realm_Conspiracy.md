...
## Quest Giver
**Xara Goldleaf** - Religious leader
...
## Key Locations
- **Gateford** (City): Key location for quest progression
- **UpperWatch** (Dungeon): Key location for quest progression

## Opposition
### Enemies
- **Elementals** led by Xara Brightblade
