...
aliases:
- 04 Resources Assets Vehicles vehicle ship cerulean passenger dirigible cerulean passenger dirigiblesvg
...
priority: normal
category: 05 Rules
subcategory: Assets Vehicles Vehicle Ship Cerulean Passenger Dirigible Cerulean Passenger Dirigible.Svg.Md
related: []
cssclass: standard
publish: false
...
*Tags*: #mechanics #rules #homebrew #variant #system ## Rule Summary 04_Resources_Assets_Vehicles_vehicle-ship-cerulean-passenger-dirigible-cerulean-passenger-dirigible.svg provides a systematic approach to handling specific game situations. This mechanic integrates with core D&D 5e rules while adding depth to gameplay. ## When to Use Apply this rule when:
