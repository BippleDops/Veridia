...
created: 2025-08-15T12:24:46.223824
modified: 2025-08-15T12:24:46.223824
aliases: [Quest - The Debtor's Revolt]
---
...
subcategory: Quest - The Debtor'S Revolt.Md
related: []
cssclass: standard
publish: false
...
**Experience Points**: 500 XP per character Improvements - Create treasure parcels for each major encounter ### Structure Improvements - Add three-act structure with rising action ### Choices Improvements - Add meaningful decision points with consequences ### Roleplay Improvements - Include ethical challenges without clear answers ### Soundtrack Improvements - Suggest music/ambiance for each scene ### Accessibility Improvements - Include content warnings and safety tools ### Worldbuilding Improvements - Connect to three other adventures in the vault ### Session_Zero Improvements - Add session zero integration questions ### Backup Improvements - Add 'What if players skip this?' contingency ### Level_Range Improvements - Provide scaling for different level ranges ### Art Improvements - Add AI art prompts for key scenes ## Adventure Overview An exciting quest that challenges heroes to save the realm. --- *Last Updated: 2025-08-14 19:03* ## DM Notes *Private notes for campaign integration:*

- Can be adapted to fit current story needs
- Scalable threat/reward based on party level
- Multiple entry points for different play styles
- Connections to overarching campaign themes ## Plot Hooks - A map reveals a conspiracy about this place

- An heirloom has gone missing and chaos spreads
- A corpse reveals a conspiracy about a local noble ## Critical Decisions 1. **The Prisoner's Dilemma**: Save the hostages OR pursue the villain
