...
status: active
world: Both
updated: '2025-08-13T01:18:36.437445+00:00'
...
Educational facilities where citizens from both realms can learn about each other's civilizations through exhibits, interactive experiences, and structured programs designed to promote understanding and cooperation.
...
**Appearance**: A veteran engineer whose equipment includes modifications for operating in both environments
**Personality**: Pragmatic problem-solver dedicated to maintaining portal operations
**Goals**: Ensuring portal security while expanding opportunities for cooperation

### Surface Liaison Ambassador Skyward Cloudwalker
**Role**: Primary Surface World Representative and Diplomatic Coordinator
...
### The Infiltration Investigation
Evidence suggests that agents from a third party are using the portal for unknown purposes, possibly planning operations against both civilizations.
...
**Mechanical Effect**: Characters unfamiliar with portal travel must make Constitution saving throws (DC 13) or suffer disadvantage on physical checks for 1 hour.

### Dimensional Instability
Portal malfunctions can create temporary reality distortions.
**Mechanical Effect**: During instability events, creatures must make Wisdom saves (DC 15) or become confused for 1d4 rounds.
...
**Mechanical Properties**: Provide advantage on Charisma checks with portal authorities.

### Inter-Realm Communication Devices
Technology allowing long-distance communication between surface and underwater locations.
**Mechanical Properties**: Function as magical communication tools with enhanced range.
...
**Cultural Adaptation**: Wisdom (Insight) DC 15 to understand cultural nuances.
...
- [[Surface Portal Alpha|02 Worldbuilding/Places/Surface Portal Alpha]]
