...
- **Instant Health.** You allow yourself and up to twenty creatures that you can see to regain all [[hit-points-xphb (variant-rules)]], and you end all effects on them listed in the [[greater-restoration-xphb (spells)]] spell.  
- **Resistance.** You grant up to ten creatures that you can see [[boon-of-energy-resistance-xphb (feats)]] to one damage type that you choose. This [[boon-of-energy-resistance-xphb (feats)]] is permanent.  
...
### CLI Reference
See: `[[spells|wish-xphb (spells)-phb]]` in CLI_Reference/spells/
