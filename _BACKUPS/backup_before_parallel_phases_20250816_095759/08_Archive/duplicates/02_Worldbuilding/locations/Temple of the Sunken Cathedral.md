...
**Seating Capacity**: The sanctuary seats exactly 343 congregants (7×7×7), though the pews appear to accommodate only 200 individuals when empty.
...
**The Deep Resoce**: Once per day, a cultist of sufficient rank can use the chamber to speak directly with Deep Mother, receiving answers to three questions at the cost of `dice: 1d6` sanity per question.
...
#### The Deep Calling (Monthly)

A major summoning ceremony designed to manifest one of Deep Mother's lesser servants. These creatures are sent to accomplish specific tasks - espionage, recruitment, elimination of threats, or reality breach creation.

**Requirements**: Blood sacrifice, 7 transformation pool preparations, stellar alignment
**Duration**: Full night (sunset to sunrise)
**Risk**: 25% chance of summoning entity more powerful than intended

#### The Reality Revision (Seasonal)

Quarterly ceremony attempting to make permanent changes to local reality. Past successes include making water flow upward in certain districts, causing buildings to exist in multiple time periods simultaneously, and creating zones where thoughts become temporary realities.

**Requirements**: Multiple reality breach sites, 343 participants, Deep Mother's direct attention
...
**Special**: Can communicate with visitors tele[[pathically, often offering prophetic warnings or advice
...
- Local fishing has been poor since the "incident"
...
- Biological specimens showing unknown evolutionary adaptations
...
- Present moral complexity rather than simple good vs evil
