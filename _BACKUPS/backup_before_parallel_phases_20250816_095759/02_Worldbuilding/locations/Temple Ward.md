...
**AC**: 16 (Natural Armor) | **HP**: 68 (`dice: 8d8` + 32)
...
**Actions**:
- **Divine Strike**: +6 to hit, reach 5 ft., `dice: 2d8` + 3 radiant damage
- **Healing Light** (3/Day): Heal target for `dice: 4d8` + 4 hit points
...
- **Completion**: Achieving de[[Sired spiritual outcome
...
**Economics**: Noble families fund major temple construction and maintece
