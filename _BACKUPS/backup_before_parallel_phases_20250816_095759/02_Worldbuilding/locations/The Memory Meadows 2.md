...
**Mechanical Effect**: Consuming memory kelp requires a **DC 18** WIS save. Success grants advantage on all INT checks for 24 hours and `dice: `dice: 1d4`` random memories. Failure means the character begins forgetting their own memories, losing one Bond or Ideal permanently.
...
- **Frequency**: Every `dice: `dice: 3d6`` days
- **Duration**: `dice: `dice: 2d4`` hours
...
- **Young Memories**: Age backwards `dice: `dice: 1d4`` years
- **Ancient Memories**: Age forward `dice: `dice: 2d6`` years
