...
"traits":
  ...
  - "desc": "Creatures within 60 feet of the dracolich can't regain [[hit-points-xphb (variant-rules)]]."
    "name": "Life Suppression"
  - "desc": "The dracolich has [[Advantage Xphb]]\
  ...
  - "desc": "The dracolich has a magical gem. If the dracolich is destroyed while\
      ...
      \ body in d20 days, regaining all its [[hit-points-xphb (variant-rules)]]\
      \ and appearing within 5 feet of the gem.\n\nThe gem is a Tiny object that has\
      \ AC 20; HP 50; and [[immunity-xphb (variant-rules)]]\
      \ to Necrotic, Poison, and Psychic damage. The gem regains all its [[hit-points-xphb (variant-rules)]]\
      \ at the end of every turn, but it turns to dust if reduced to 0 [[hit-points-xphb (variant-rules)]].\
...
"actions":
  ...
  - "desc": "Melee Attack Roll: +13, reach 10 ft. Hit: 18 (2d10 + 7) Slashing\
    ...
    "name": "Rend"
  - "desc": "Constitution Saving Throw: DC 20, each creature in a 60-foot [[Area of Effect Xphb]].\
  ...
  - "desc": "The dracolich casts one of the following spells, requiring no Material\
      ...
      \ 2 version)\n\n1/day each: [[create-undead-xphb (spells)]]\
      \ (level 8 version), [[finger-of-death-xphb (spells)]]"
    "name": "Spellcasting"
"legendary_actions":
  - "desc": "The dracolich moves up to half its [[Fly Speed Xphb]],\
      \ and it makes one Rend attack."
    "name": "Pounce"
  - "desc": "The dracolich uses Spellcasting to cast [[Ray of Sickness Xphb]]\
      \ (level 2 version). The dracolich can't take this action again until the start\
      \ of its next turn."
    "name": "Sickening Ray"
  - "desc": "Wisdom Saving Throw: DC 19, each creature in a 30-foot [[Area of Effect Xphb]]\
