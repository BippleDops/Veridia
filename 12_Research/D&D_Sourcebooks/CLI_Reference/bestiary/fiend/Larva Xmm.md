...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/fiend/token/larva-xmm.webp"
```
^statblock
...
Larva xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of larva xmm as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around larva xmm.

## Adventure Hooks

- A rumor ties larva xmm to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at larva xmm to avert a public scandal.
- A map overlay reveals a hidden approach to larva xmm active only during specific tides/storms.
