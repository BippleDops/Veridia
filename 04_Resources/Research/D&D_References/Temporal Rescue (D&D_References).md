...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Temporal Rescue (D&D References)"]
status: active
priority: normal
...
**Rescue Window**: 72 hours before temporal anchoring becomes permanent ## Time Magic Mechanics
...
**Emergency Return**: Emergency evacuation possible but risky ## Mission Parameters
...
**Equipment**: Temporal stabilizers, communication devices, period-appropriate gear ## Temporal Hazards
...
**Future Bleed**: Anachronistic elements appearing in wrong time period ## Navigation Methods
...
**Local Contacts**: Period-appropriate allies who can provide assistance ## Historical Context
...
**Major Events**: Important occurrences that must proceed as recorded ## Paradox Management
...
**Documentation**: Recording changes to assess future impact ## Extraction Methods
...
**Temporal Camouflage**: Hiding extraction within historical events ## Opposition Forces
...
**Chronological Immune System**: Universe's response to timeline damage ## Equipment and Preparation
...
**Emergency Protocols**: Plans for various failure scenarios ## Success Conditions
...
**Catastrophic Failure**: Rescue team also trapped or timeline destroyed ## Consequences and Rewards
...
**Experience Points**: 4,000-7,000 XP based on execution quality ## Long-term Impact
...
**Temporal Expertise**: Team becomes known for time-related problem solving ## Adventure Hooks
