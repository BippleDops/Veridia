...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Artificer (D&D References)"]
status: active
priority: normal
...
**Safety**: Reinforced walls, explosion containment, emergency teleportation circles ## Signature Inventions
...
**Memory Storage Gems**: Crystals that can record and replay experiences ## Notable Clients
...
**Various Adventuring Parties**: Custom gear for specific missions ## Relationships
...
**Apprentices**: Mentoring relationships with promising young inventors ## Adventure Hooks
