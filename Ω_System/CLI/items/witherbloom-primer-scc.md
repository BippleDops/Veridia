...
The Witherbloom Primer is a magic textbook created at Strixhaven's Witherbloom College. The primer has 3 charges, and it regains `d3` expended charges daily at dawn. If you make an Intelligence ([Nature](/3-Mechanics/CLI/skills.md#Nature)) or Wisdom ([Survival](/3-Mechanics/CLI/skills.md#Survival)) check while holding the primer, you can expend 1 charge to give yourself a `d4` bonus to the check, immediately after you roll the `d20`.
