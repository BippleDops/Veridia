...
*Negotiate Quest for levels 1-5*

**ID**: QUEST0012

## Quest Giver
**Magnus Goldleaf** - Military officer
...
### Hidden Objective
*DM Only: Third party manipulating events*
...
## Key Locations
- **EastBridge** (City): Key location for quest progression
- **Gateshire** (Dungeon): Key location for quest progression
- **UpperBridge** (Wilderness): Key location for quest progression
- **LowerBridge** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Corrupt Guards** led by Magnus Brightblade
...
- **Gold**: 892 gp
- **Experience**: 1,000 XP
- **Magic Items**: Eldritch Shield of Power
