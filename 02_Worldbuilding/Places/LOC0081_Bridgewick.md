...
**Atmosphere**: Tense atmosphere hiding secrets in every shadow
...
## Important NPCs
- **Vera Ravencrest** - Innkeeper: Key figure in local affairs
- **Willem Ravencrest** - Merchant: Key figure in local affairs
- **Xara Ravencrest the Elder** - Priest: Key figure in local affairs
...
### Trade
- **Exports**: Textiles, Wine
- **Imports**: Silk, Exotic foods
