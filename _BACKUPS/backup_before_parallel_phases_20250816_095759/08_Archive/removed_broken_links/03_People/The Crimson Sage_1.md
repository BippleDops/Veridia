...
**Hit Points** 285 (`dice: `dice: 30d8`` + 150)
...
### Legendary Abilities
**Divine Essence.** The Crimson Sage is the shattered god Aetheron. Cannot be truly killed - reforms in `dice: `dice: 1d10`` days if destroyed.
...
**Staff of Shattered Divinity.** *Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 12 (`dice: `dice: 2d8`` + 2) bludgeoning damage plus 21 (`dice: `dice: 6d6``) force damage. Can cast any spell through the staff.
...
**Temporal Glimpse.** Show target a vision of their past, present, or potential future. Can be used to provide information or inflict trauma (`dice: `dice: 8d6`` psychic damage, **DC 22** Wisdom save for half).
