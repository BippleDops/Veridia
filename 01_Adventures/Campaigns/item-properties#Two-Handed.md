---
title: item-properties#Two-Handed
type: note
tags:
- auto-generated
- linked
...
- [[antimatter-rifle-xdmg (items)]]
- [[automatic-rifle-xdmg (items)]]
- [[berserker-axe-xdmg (items)]]
- [[blackrazor-xdmg (items)]]
- [[energy-bow-xdmg (items)]]
- [[glaive-xphb (items)]]
- [[greataxe-xphb (items)]]
- [[greatclub-xphb (items)]]
- [[greater-silver-sword-mtf (items)]]
- [[greatsword-xphb (items)]]
- [[halberd-xphb (items)]]
- [[hazirawn-hotdq (items)]]
- [[heavy-crossbow-xphb (items)]]
- [[hunting-rifle-xdmg (items)]]
- [[laser-rifle-xdmg (items)]]
- [[light-crossbow-xphb (items)]]
- [[light-repeating-crossbow-oota (items)]]
- [[longbow-xphb (items)]]
- [[maul-xphb (items)]]
- [[musket-xphb (items)]]
- [[oathbow-xdmg (items)]]
