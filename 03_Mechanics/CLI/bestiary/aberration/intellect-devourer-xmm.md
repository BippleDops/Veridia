...
"actions":
  ...
  - "desc": "Intelligence Saving Throw: DC 12, one Small or Medium creature within\
      \ 5 feet that has the [Incapacitated](/03_Mechanics/CLI/conditions.md#Incapacitated)\
      \ condition, is a Humanoid or Beast, and has 10 [Hit Points](/03_Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      ...
      \ brain by means of a [Wish](/03_Mechanics/CLI/spells/wish-xphb.md) spell. By\
...
"source":
  - "XMM"
"image": "/03_Mechanics/CLI/bestiary/aberration/token/intellect-devourer-xmm.webp"
```
^statblock
...
Intellect devourer xmm is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.
