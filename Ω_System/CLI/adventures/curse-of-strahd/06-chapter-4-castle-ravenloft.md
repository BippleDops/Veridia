...
| 4 | 1 black [cat](/3-Mechanics/CLI/bestiary/beast/cat-xmm.md) |
| 5 | 1 [broom of animated attack](/3-Mechanics/CLI/bestiary/construct/broom-of-animated-attack-cos.md) (see appendix D) |
| 6 | `1d4 + 1` [flying swords](/3-Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm.md) |
| 7 | Blinsky toy |
| 8 | [Unseen servant](/3-Mechanics/CLI/spells/unseen-servant-xphb.md) |
| 9 | `d4` [commoners](/3-Mechanics/CLI/bestiary/humanoid/barovian-commoner-cos.md) |
| 10 | `2d6` [crawling claws](/3-Mechanics/CLI/bestiary/undead/crawling-claw-xmm.md) |
| 11 | `d6` [shadows](/3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) |
| 12 | `d6` [swarms of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) |
...
| 15 | `d4` [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
| 16 | Trinket |
| 17 | Giant spider cocoon |
| 18 | 1 [Barovian witch](/3-Mechanics/CLI/bestiary/humanoid/barovian-witch-cos.md) (see appendix D) |
| 19 | `1d4 + 1` [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) |
...
Angry [villagers](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) who have entered the castle brandish torches and pitchforks in a ridiculous display of force. Everywhere they go, they shout for justice. They follow the characters unless prevented from doing so. As long as these Barovians are with the adventurers, random encounters occur on a roll of 9 or higher.
...
If the characters capture or kill the [cat](/3-Mechanics/CLI/bestiary/beast/cat-xmm.md), this encounter doesn't occur again. If this result comes up again, treat it as no encounter.
...
The [crawling claws](/3-Mechanics/CLI/bestiary/undead/crawling-claw-xmm.md) gang up on one party member. During the confusion, one of the claws tries to crawl into the character's backpack and hide there. It makes a Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check contested by the character's passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score. If the claw loses the contest, the character sees the claw enter the backpack. If the claw wins the contest, it waits until the character takes a long rest before scuttling out to attack.
...
[Ezmerelda](/3-Mechanics/CLI/bestiary/npc/ezmerelda-davenir-cos.md) has cast a [greater invisibility](/3-Mechanics/CLI/spells/greater-invisibility-xphb.md) spell on herself and is stealthily exploring the castle. Choose one character in the back rank of the party's marching order, and read the following text to that character's player:
...
If more than two [flying swords](/3-Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm.md) are encountered, the others aren't far behind. These weapons drift about the castle and attack intruders within range of their [blindsight](/3-Mechanics/CLI/senses.md#Blindsight).
...
| 4 | A Barovian lunatic (CN male [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). If freed, he cackles until silenced or until a [calm emotions](/3-Mechanics/CLI/spells/calm-emotions-xphb.md) spell is cast on him. A [lesser restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spell cures his madness, at which point he tries to flee the castle. |
| 5 | A dead Barovian that serves as host to a [swarm of insects (spiders)](/3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md). The baby giant spiders (each one the size of a tarantula) crawl out of the Barovian's gaping mouth or burst forth from its distended belly. |
...
If [Rahadin](/3-Mechanics/CLI/bestiary/npc/rahadin-cos.md) was killed or captured in a previous encounter, this encounter doesn't occur. Otherwise, Strahd's mysterious chamberlain approaches quietly. A character whose passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score meets or exceeds [Rahadin](/3-Mechanics/CLI/bestiary/npc/rahadin-cos.md)'s Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check hear him.
...
If one or more characters have a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 16 or higher, read:
...
If more than one [shadow](/3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) is present, the others are close by but hidden in the darkness. These undead shadows follow the characters but do not attack unless attacked first. They otherwise obey Strahd's commands.
...
Any character who has a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score lower than 19 is [surprised](/3-Mechanics/CLI/conditions.md#Surprised) as Strahd appears seemingly out of nowhere. The vampire prefers to attack a [surprised](/3-Mechanics/CLI/conditions.md#Surprised) character, choosing the one closest to him. Otherwise, see appendix D for the vampire's tactics.
...
These [bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) are the servants of Strahd. They attack the characters without provocation.
...
This unseen servant was created by Strahd and is permanent until destroyed (see the [unseen servant](/3-Mechanics/CLI/spells/unseen-servant-xphb.md) spell in the "Player's Handbook"). Roll a `d6` to determine what the servant is carrying, or choose one of the options below.

`dice: [](06-chapter-4-castle-ravenloft.md#^items)`

| dice: d6 | Items |
|----------|-------|
| 1 | A tarnished silver platter with a lid (worth 25 gp). If a character comes within 5 feet of the servant, it lifts the lid, revealing a bunch of moldy scones. The first character to eat a scone gains inspiration. On later occurrences of this encounter, the platter holds a [crawling claw](/3-Mechanics/CLI/bestiary/undead/crawling-claw-xmm.md) that attacks the nearest character. |
| 2 | A silver goblet (worth 50 gp) filled to the brim with wine. A character who drinks the wine must make a DC 15 Constitution saving throw, taking 44 (`8d10`) poison damage on a failed save, or half as much damage on a successful one. On future occurrences of this encounter, the wine acts as a [potion of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md). |
...
| 5 | A crystal dinner bell (worth 25 gp). The unseen servant rings the bell if the characters come within 10 feet of it. The sound attracts `d4` hungry [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) (see below), which arrive in `1d4 + 1` rounds. |
...
If any character has a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 16 or higher, the party isn't [surprised](/3-Mechanics/CLI/conditions.md#Surprised). In that case, read:
...
These minions of Strahd—former adventurers all—creep along ceilings and drop down on unsuspecting prey. The [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) fight until destroyed.
...
If the characters are moving quietly and not carrying light sources, they can try to hide from the [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md). These undead soldiers once served as guard captains in Castle Ravenloft. They still wear bits of tattered livery, and they attack the living on sight.
...
Characters who enter a gate tower find themselves on a flagstone floor with a hollow tower stretching high above them. The mechanisms for raising and lowering the drawbridge and portcullis fill both gate towers. The latch mechanism in each tower is magically activated by a word that only Strahd knows. It can also be activated with a successful casting of [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 14). Neither the drawbridge nor the portcullis will move until both latches are activated.
...
If a character who has a passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score of 15 or higher peers over the wall, add:
...
Gustav's corpse wears a handsome, fur-lined black cloak embroidered with golden thread (worth 250 gp) and a suit of [chain mail](/3-Mechanics/CLI/items/chain-mail-xphb.md), both nonmagical. Gustav's black mace is a [mace of terror](/3-Mechanics/CLI/items/mace-of-terror-xdmg.md).
...
Both suits of armor are mechanical traps, each one activated by a pressure plate hidden in the floor in front of its alcove. A character who searches for traps in one of these locations notices both pressure plates with a successful DC 15 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check.
...
The Heart of Sorrow is held aloft by the will of Strahd. Casting [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) on it has no effect.
...
Strahd senses if any damage is done to the Heart of Sorrow and sends four [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) to destroy those responsible. These vampire spawn are former adventurers whom Strahd defeated long ago. They use their Spider Climb feature to scuttle along the tower walls and arrive in 3 rounds.
...
A secret door in the south wall leads to area K13. It is hidden by dust and cobwebs, and requires a successful DC 16 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check to find.
...
Characters who examine the ceiling can, with a successful DC 20 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check, spot pulleys and a rope that run the full length of the corridor along the ceiling, well hidden by the cobwebs. These items are explained in "Flight of the Vampire" below.
...
The staircase climbs from area K16 to area K28. It seems unstable but is sturdy. The creatures in area K28 can't be [surprised](/3-Mechanics/CLI/conditions.md#Surprised) by anyone climbing the creaky steps.
...
The figure is [Lief Lipsiege](/3-Mechanics/CLI/bestiary/npc/lief-lipsiege-cos.md) (CE male human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), an accountant. He is chained to the heavy wooden desk and has no interest in the characters or their concerns. Under no circumstances does he voluntarily leave the room. Lief pulls the rope the instant he feels threatened.
...
| dice: d4 | Creature |
|----------|----------|
| 1 | `d6` [shadows](/3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) |
| 2 | `d4` [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) |
| 3 | `d4` [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
| 4 | 1 [wraith](/3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) and `1d4 + 1` [specters](/3-Mechanics/CLI/bestiary/undead/specter-xmm.md) |
^creature
...
The room contains hundreds of worthless books and scrolls describing accounting procedures. The first character who spends at least 10 minutes searching the room and succeeds on a DC 15 Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check finds a book with a bloodstained leather cover. The pages of this book have been hollowed out, creating a hole in which Lief has hidden the iron key that unlocks the four wooden chests in this room.

Two of the locked chests contain 10,000 cp each. A third chest contains 1,000 gp. The fourth chest holds 500 pp, hidden under which is a [manual of bodily health](/3-Mechanics/CLI/items/manual-of-bodily-health-xdmg.md).
...
The maid, [Helga Ruvak](/3-Mechanics/CLI/bestiary/npc/helga-ruvak-cos.md), is a [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) who claims to be the daughter of the village bootmaker, kidnapped and forced into service by Strahd. She pleads, on her hands and knees if necessary, to be saved from this awful place.
...
The dark figures are four [swarms of rats](/3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) piled atop one another to form manlike shapes (two swarms per alcove). These rats are under Strahd's control and attack anyone that tries to move through this area.
...
- Strahd's hate assumes a corporeal form, bursts out of the cake (the symbol of Sergei and Tatyana's love), and escapes through the window. "Strahd's hate" has the statistics of an [invisible stalker](/3-Mechanics/CLI/bestiary/elemental/invisible-stalker-xmm.md) and tries to kill whichever character is carrying the groom figurine.  
...
The lute, though old and covered in dust, has survived the passage of time. It is a magic [instrument of the bards](/3-Mechanics/CLI/items/instrument-of-the-bards-xdmg.md) called a [Doss lute](/3-Mechanics/CLI/items/instrument-of-the-bards-doss-lute-xdmg.md).
...
Most of the hall is full of giant spider [webs](/3-Mechanics/CLI/traps-hazards/webs-xdmg.md) (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). Characters who stray from the unobstructed path through the webs risk becoming stuck.

#### Secret Doors

At the west end of the hall are two secret doors.

The secret door on the west wall can't be opened from this side, except by magic (such as a [knock](/3-Mechanics/CLI/spells/knock-xphb.md) spell). See area K38 for more information on this secret door. If the characters pass through this door coming from area K38, it closes and locks behind them if they don't take measures to prop it open.

A narrow secret door at the western end of the south wall is hidden behind a mass of webs. If these webs are cleared away, characters can search for the secret door, finding it with a successful DC 15 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check. The door can be pulled open to reveal area K31b.
...
The rope is attached to a great bell mounted in a wooden framework 50 feet overhead. Pulling the rope or attempting to climb it brings forth a loud, long "GONG." That sound causes five [giant spiders](/3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) to drop from their webs and attack. The spiders attack only if they are attacked or if the bell is sounded.

Most of the belfry is filled with giant spider [webs](/3-Mechanics/CLI/traps-hazards/webs-xdmg.md) (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). Characters who blunder into them risk becoming stuck.
...
The plundered riches of Strahd's secret hoard lie within this adamantine tower, which is actually a [Daern's instant fortress](/3-Mechanics/CLI/items/daerns-instant-fortress-xdmg.md) (see chapter 7, "Treasure," of the "Dungeon Master's Guide"). Only Strahd knows the command word to alter its shape and size, which can't be done until every bit of treasure inside it is removed. Only Strahd can open the two means of entry: a sealed adamantine door set into the base of the tower on the north side, and an adamantine trapdoor on the roof.
...
The ground floor of the [Daern's instant fortress](/3-Mechanics/CLI/items/daerns-instant-fortress-xdmg.md) contains 50,000 cp, 10,000 sp, 10,000 gp, 1,000 pp, 15 assorted gems (100 gp each), and a [+2 shield](/3-Mechanics/CLI/items/2-shield-xdmg.md) emblazoned with a stylized silver dragon that is the emblem of the Order of the Silver Dragon (see chapter 7). The shield whispers warnings to its bearer, granting a +2 bonus to initiative if the bearer isn't [incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated).

The upper floor of the tower contains 10 pieces of jewelry (250 gp each) in a red velvet sack, an [alchemy jug](/3-Mechanics/CLI/items/alchemy-jug-xdmg.md), a [helm of brilliance](/3-Mechanics/CLI/items/helm-of-brilliance-xdmg.md), a [rod of the pact keeper, +1](/3-Mechanics/CLI/items/1-rod-of-the-pact-keeper-xdmg.md), and an unlocked wooden coffer with four compartments, each one containing a [potion of greater healing](/3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md).
...
The figure on the bed is [Gertruda](/3-Mechanics/CLI/bestiary/npc/gertruda-cos.md) (NG female human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), the daughter of [Mad Mary](/3-Mechanics/CLI/bestiary/npc/mad-mary-cos.md) (see chapter 3, area E3). [Gertruda](/3-Mechanics/CLI/bestiary/npc/gertruda-cos.md) is oblivious to any danger to herself—especially from Strahd, who has [charmed](/3-Mechanics/CLI/conditions.md#Charmed) her. Sheltered by her mother, she was never allowed to leave home as a child. She finally slipped away and made her way to the castle, drawn by its majesty.
...
If the characters loiter on the parapets or atop the castle walls for more than 5 minutes, they encounter [Strahd's animated armor](/3-Mechanics/CLI/bestiary/npc/strahds-animated-armor-cos.md) (see appendix D) making the rounds. It patrols the parapets and the outer walls of Ravenloft day and night. Under a darkened sky, characters without [darkvision](/3-Mechanics/CLI/senses.md#Darkvision) are more likely to hear the clatter of the armor approaching before they can see it.
...
The ornate rug is actually a [rug of smothering](/3-Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm.md). It attacks creatures, other than undead, that move across it or anyone who tries to move it or otherwise disturb it. Underneath the rug is a bare stone floor.
...
The youthful man on the couch is [Escher](/3-Mechanics/CLI/bestiary/npc/escher-cos.md), a dashing [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) to whom Strahd has shown favor in the past. [Escher](/3-Mechanics/CLI/bestiary/npc/escher-cos.md) is feeling somewhat neglected of late and has retreated here until Strahd's mood improves. If attacked, he hurls himself out the window and lands like a cat on the roof of the keep (area K53). He leads pursuers right to Strahd, wherever the lord of the castle happens to be (and regardless of whether the characters are ready to face Strahd).
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `d4` [Barovian witches](/3-Mechanics/CLI/bestiary/humanoid/barovian-witch-cos.md) from area K56. They try to subdue the party with [sleep](/3-Mechanics/CLI/spells/sleep-xphb.md) spells. A witch retreats to area K56 if wounded.
...
The trapdoor can be found after a search of the room and a successful DC 13 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check. Locating the trapdoor doesn't enable someone to discover its opening mechanism. The door has a hidden lock and can be opened by pulling down on the hook from which the black cloak hangs. Once it has been found, the trapdoor can be opened by pulling on the hook, or it can be unlocked by someone using thieves' tools, a [knock](/3-Mechanics/CLI/spells/knock-xphb.md) spell, or similar magic. It swings down when unlocked.
...
A character must succeed on a DC 15 Dexterity ([Acrobatics](/3-Mechanics/CLI/skills.md#Acrobatics)) check to traverse the roof. The check succeeds automatically if the character crawls. If the check fails by 5 or more, the character slides off the edge of the roof and falls 40 feet to the castle parapet (area K46).
...
The three [cats](/3-Mechanics/CLI/bestiary/beast/cat-xmm.md) are familiars of the witches in area K56. If the familiars see the characters here, the witches are alerted to their presence.
...
The [Barovian witches](/3-Mechanics/CLI/bestiary/humanoid/barovian-witch-cos.md) (see appendix D) that dwell in this area have sworn themselves to Strahd's service in exchange for arcane power. Seven witches are present when the characters arrive, minus any that might have been encountered and defeated in area K50. If the witches are expecting the characters, they cast [invisibility](/3-Mechanics/CLI/spells/invisibility-xphb.md) spells and stand quietly in the corners of the room, hoping that the cauldron draws their prey inside. Although they prefer to attack at range with their spells, they can grow magic claws using [alter self](/3-Mechanics/CLI/spells/alter-self-xphb.md).
...
Each witch carries a [potion of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md) that she made herself. There is a 30 percent chance that a potion has "gone bad," in which case it's actually a [potion of poison](/3-Mechanics/CLI/items/potion-of-poison-xdmg.md).
...
> [!note] 
> 
> 1st level: [burning hands](/3-Mechanics/CLI/spells/burning-hands-xphb.md), [charm person](/3-Mechanics/CLI/spells/charm-person-xphb.md), [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md), [find familiar](/3-Mechanics/CLI/spells/find-familiar-xphb.md), [fog cloud](/3-Mechanics/CLI/spells/fog-cloud-xphb.md), [mage armor](/3-Mechanics/CLI/spells/mage-armor-xphb.md), [protection from evil and good](/3-Mechanics/CLI/spells/protection-from-evil-and-good-xphb.md), [ray of sickness](/3-Mechanics/CLI/spells/ray-of-sickness-xphb.md), [sleep](/3-Mechanics/CLI/spells/sleep-xphb.md), [Tasha's hideous laughter](/3-Mechanics/CLI/spells/tashas-hideous-laughter-xphb.md), [unseen servant](/3-Mechanics/CLI/spells/unseen-servant-xphb.md), [witch bolt](/3-Mechanics/CLI/spells/witch-bolt-xphb.md)
> 
> 2nd level: [alter self](/3-Mechanics/CLI/spells/alter-self-xphb.md), [arcane lock](/3-Mechanics/CLI/spells/arcane-lock-xphb.md), [cloud of daggers](/3-Mechanics/CLI/spells/cloud-of-daggers-xphb.md), [darkness](/3-Mechanics/CLI/spells/darkness-xphb.md), [enlarge/reduce](/3-Mechanics/CLI/spells/enlarge-reduce-xphb.md), [invisibility](/3-Mechanics/CLI/spells/invisibility-xphb.md), [knock](/3-Mechanics/CLI/spells/knock-xphb.md), [misty step](/3-Mechanics/CLI/spells/misty-step-xphb.md)
^23d
...
Characters who remain on the roof are accosted by ten [swarms of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md), which arrive in 3 rounds. If the characters descend into the tower, the bats don't follow and instead fly into the high tower (area K59), descend its central shaft (area K18a), and roost in the catacombs (area K84).
...
A character who searches for traps while crossing the hall and succeeds on a DC 15 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check detects seams in the floor, walls, and ceiling that suggest that the middle section isn't attached to the rest of the hall. A character who makes a successful DC 15 Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check discerns that the trap can't be disarmed from this location.

The middle 10-foot section of the hall is a cleverly hidden elevator compartment, open to the north and south so that it appears to be part of the passageway. When the trap is sprung, two steel portcullises drop from the ceiling at lightning speed to seal off the compartment, trapping within those creatures that triggered the trap. An instant later, the closed-off elevator is propelled up the western half of a 20-foot-wide, 170-foot-tall shaft (area K31a) to the sounds of turning gears and rattling chains. Magic sleep gas fills the compartment as it rises, and a creature trapped inside must succeed on a DC 15 Constitution saving throw or fall [unconscious](/3-Mechanics/CLI/conditions.md#Unconscious) as though affected by a [sleep](/3-Mechanics/CLI/spells/sleep-xphb.md) spell.
...
All creatures trapped inside the elevator (including [unconscious](/3-Mechanics/CLI/conditions.md#Unconscious) ones) must roll initiative. The compartment takes 1 round to reach the top of the shaft, stopping just beneath area K47. Each creature inside has one turn to act before the compartment comes to a dead stop. Their initiative rolls determine the order in which the occupants act. Conscious party members can take whatever actions they like. They might search for a way out, wake sleeping party members, cast spells, or take other actions. [Unconscious](/3-Mechanics/CLI/conditions.md#Unconscious) ones can do nothing.

A character who uses an action to search the ceiling of the elevator finds a secret trapdoor with a successful DC 10 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check. The trapdoor opens downward.
...
Five of these casks are rotted and empty. The wine name burned on each is Red Dragon Crush. Lining the interior of the sixth one is a patch of [yellow mold](/3-Mechanics/CLI/traps-hazards/yellow-mold-xdmg.md) (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). A character who inspects the cask closely and succeeds on a DC 13 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check sees yellow mold in the cracks between the planks of the cask. If this cask is smashed open, the yellow mold releases a cloud of spores.

##### Southern Casks

Two of these casks are rotted and empty. The wine name burned on each is Purple Grapemash No. 3. The middle one is home to a purplish [black pudding](/3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) that bursts forth if the cask is broken open.
...
If a character looks into the pot, three human [zombies](/3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) rise up from the bubbling depths and attack. The zombies are slowly being boiled to death, and each has only 13 hit points remaining. If [Cyrus Belview](/3-Mechanics/CLI/bestiary/npc/cyrus-belview-cos.md) (see area K62) is present when the zombies attack, he grabs a heavy club and tries to beat them back into the pot. Cyrus explains that he just isn't the cook he used to be, and his meals tend to get out of hand these days.
...
The yellow lichen is harmless. When one or more characters reach the midpoint of the hall, ten human [skeletons](/3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) leap from the alcoves and attack.
...
A [shadow demon](/3-Mechanics/CLI/bestiary/fiend/shadow-demon-xmm.md) also haunts this room. In the round after the characters engage [Rahadin](/3-Mechanics/CLI/bestiary/npc/rahadin-cos.md), the demon leaps out and attacks the nearest character from behind. The character doesn't notice the demon, unless the character's passive Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) score meets or exceeds the demon's Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check. Both [Rahadin](/3-Mechanics/CLI/bestiary/npc/rahadin-cos.md) and the shadow demon fight until slain.
...
The rusty iron door connecting this hall to area K73 is submerged in 5 feet of water and requires a successful DC 10 Strength ([Athletics](/3-Mechanics/CLI/skills.md#Athletics)) check to open.
...
A search of the corpse yields a sheathed [longsword](/3-Mechanics/CLI/items/longsword-xphb.md) and two belt pouches, one containing five gemstones (50 gp each) and the other containing a [potion of heroism](/3-Mechanics/CLI/items/potion-of-heroism-xdmg.md).
...
A secret door is 5 feet up from the floor on the north wall of this cell. The secret door can't be opened from this side without the use of a [knock](/3-Mechanics/CLI/spells/knock-xphb.md) spell or similar magic. Behind the secret door is a chute of polished black marble that slants upward (area K82).
...
Clinging to the floor of this cell is a [gray ooze](/3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md) that attacks anything that enters. While underwater, the ooze is effectively [invisible](/3-Mechanics/CLI/conditions.md#Invisible).
...
The source of the underwater glow is a sentient lawful good [+1 shortsword](/3-Mechanics/CLI/items/1-weapon-xdmg.md) (Intelligence 11, Wisdom 13, Charisma 13). It has hearing and normal vision out to a range of 120 feet. It communicates by transmitting emotion to the creature carrying or wielding it.
...
- While attuned to the weapon, the sword's wielder can use the sword to cast the [crusader's mantle](/3-Mechanics/CLI/spells/crusaders-mantle-xphb.md) spell. Once used, this property of the sword can't be used again until the next dawn.  
...
This cell is linked to a teleport trap in area K73. The skeletal remains of a dwarf fighter lie at the bottom of the cell, enclosed in rusted plate armor. The dwarf's nonmagical but usable [battleaxe](/3-Mechanics/CLI/items/battleaxe-xphb.md) lies nearby.
...
The brazier's flame is magical and sheds no warmth. A successful casting of [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 16) extinguishes the flame for 1 hour. The fire is permanently extinguished if the brazier is destroyed. The brazier has AC 17, 25 hit points, immunity to poison and psychic damage, and resistance to all other damage.
...
Inscribed on the landing, hidden under years of dust, is a [glyph of warding](/3-Mechanics/CLI/spells/glyph-of-warding-xphb.md). If the characters brush away the dust, someone can spot the glyph with a successful DC 15 Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check.

The glyph triggers the first time a living creature passes over it. Triggering it activates a [major image](/3-Mechanics/CLI/spells/major-image-xphb.md) spell, conjuring an illusion of [Strahd von Zarovich](/3-Mechanics/CLI/bestiary/npc/strahd-von-zarovich-cos.md) that appears either halfway up the stairs leading to area K72 or halfway down the stairs leading to area K78, so that the vampire appears in front of the triggering character. When "Strahd" appears, read:
...
Near the midpoint of the tunnel is a trapdoor hidden under a layer of fog. Characters can't spot the trapdoor passively, but an active search accompanied by a successful DC 20 Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check locates it. Unless the trapdoor is fastened shut with an iron spike or by some other means, it opens when 100 pounds of weight or more is placed on it. When the trapdoor opens, everyone who is standing on it slides into the marble chute below (area K82). The trapdoor then resets.
...
The catacombs are home to tens of thousands of bats. The bats hang here during daytime hours and fly out in the evening through the high tower's central shaft (area K18a) to hunt at night. They will not attack intruders unless they are provoked or are specifically commanded to do so by Strahd. If one or more bats within a 10-foot square on the map are attacked or caught in the area of a harmful spell, `2d4` [swarms of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) form in that area and attack. No more swarms can be formed in that square until the next dawn, when more bats arrive to replenish those that were killed.

#### Teleport Traps

Invisible teleport traps are located between crypts 37 and 38, between crypt 37 and the wall south of it, and between crypt 38 and the wall south of it. The traps can't be perceived except with a [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md) spell, which reveals an aura of conjuration magic in the trapped areas. Although the traps can't be disarmed, a successful casting of [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 16) on a trap suppresses its magic for 1 minute, allowing characters to move safely through its area. A trap is also suppressed while wholly or partly in the area of an [antimagic field](/3-Mechanics/CLI/spells/antimagic-field-xphb.md).

These teleport traps form a protective ring around the entrance to Strahd's tomb (area K86). Any creature that enters one of these 10-foot-square spaces is instantly teleported away, switching places with one of the [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md) in crypt 14. The wight materializes in the creature's previous location and attacks any living creature it sees.
...
Prince Ariel was a terrible man who longed to fly. He attached artificial wings to a harness and empowered the device with magic, but the apparatus still couldn't bear his weight, and he plunged from the Pillarstone of Ravenloft to his death. His evil [ghost](/3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) attacks the characters on sight. If Ariel succeeds in possessing a character, his host climbs the high tower (area K18) until it reaches the peak (area K59), then hurls itself down the tower's central shaft (area K18a), screaming, "I can fly!" the whole way down.
...
A [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the thighbone radiates an aura of evocation magic. See appendix C for more information on [Saint Markovia's thighbone](/3-Mechanics/CLI/items/saint-markovias-thighbone-cos.md).
...
Endorovich's spirit is trapped inside one of the gargoyles. If anyone disturbs the bones on the slab, one of the [gargoyles](/3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) awakens and attacks. If the gargoyle is reduced to 0 hit points, Endorovich's spirit moves to the second gargoyle, which then awakens and attacks. Both gargoyles have maximum hit points (77). Once the second [gargoyle](/3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) is destroyed, Endorovich's spirit is laid to rest.
...
If the characters explore this crypt after summoning the ghost of Pidlwick in area K36, they find a small, flat wooden box on the marble slab next to Pidlwick's bones. The box contains a full [deck of illusions](/3-Mechanics/CLI/items/deck-of-illusions-xdmg.md).
...
The stoppered drinking horn is a water-resistant [powder horn](/3-Mechanics/CLI/items/gunpowder-powder-horn-xdmg.md) loaded with gunpowder, and the "weird-looking scepter" is a [musket](/3-Mechanics/CLI/items/musket-xphb.md). The fat pouch contains 20 silver marbles (silvered bullets for the musket). For more information on firearms and explosives, see chapter 9, ""Dungeon Master's Workshop"," of the "Dungeon Master's Guide".
...
The glider has AC 12, 1 hit point, and a 15-foot wingspan. Any damage causes it to break and become inoperable. A [mending](/3-Mechanics/CLI/spells/mending-xphb.md) cantrip can repair the damage, provided all the broken pieces are present.
...
This vault contains fifteen [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md) (one per coffin), minus any that have been teleported away (see "Teleport Traps" at the start of this section). Lifting a coffin's lid requires an action and a successful DC 15 Strength check.

Each wight remains inactive until it is teleported away or until its coffin is opened, whereupon it attacks.

The bones and rusty swords cover the floor to a depth of 6 inches, and are the remains of servants who swore to avenge Stahbal Indi-Bhak's family. Whenever a wight is killed in this vault, some of the bones knit together, forming `2d6` animated human [skeletons](/3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md). These skeletons attack intruders on sight but have no ranged attacks. There are enough bones and swords in the room for one hundred skeletons to form in this manner.
...
The skull's [black opal eye-gems](/3-Mechanics/CLI/items/black-opal-xdmg.md) are worth 1,000 gp apiece. The skull also has eight amber teeth worth 100 gp each.

Any creature that stands inside the crypt and boldly speaks the name "Khazan" causes the Pillarstone of Ravenloft to tremble as a [staff of power](/3-Mechanics/CLI/items/staff-of-power-xdmg.md) materializes above the marble slab and hovers in place. The first creature to grab hold of the staff must make a DC 17 Constitution saving throw, taking 44 (`8d10`) lightning damage on a failed save, or half as much damage on a successful one. Afterward, the [staff of power](/3-Mechanics/CLI/items/staff-of-power-xdmg.md) can be held and used normally. If no one grabs the staff within 1 round of its appearance, it vanishes, never to return.
...
This [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) is an old wife of Strahd's. Once she realizes that the characters aren't her husband, Sasha tears away her web shroud like an unloved wedding dress and attacks.
...
The spectral elf is a [banshee](/3-Mechanics/CLI/bestiary/undead/banshee-xmm.md) that attacks the characters on sight, using her wail immediately. Once awakened, the banshee is free to roam Castle Ravenloft, but she can't travel more than 5 miles from this crypt.
...
Reducing the banshee to 0 hit points causes it to discorporate. Patrina's spirit can't rest, however, until she is formally wed to Strahd; the banshee re-forms in her crypt 24 hours later. Casting a [hallow](/3-Mechanics/CLI/spells/hallow-xphb.md) spell on the crypt prevents the banshee from returning for as long as the spell lasts.
...
A [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md) spell cast here reveals that Intree's skull radiates a faint aura of necromancy magic. As long as the skull remains in the crypt, it will answer up to five questions put to it, as though a [speak with dead](/3-Mechanics/CLI/spells/speak-with-dead-xphb.md) spell had been cast on it. This property recharges each day at dawn. Unlike Stefan Gregorovich in crypt 25, Intree was well educated and astute. If the skull is questioned about Strahd or the castle, the information it provides is true.
...
Three [giant wolf spiders](/3-Mechanics/CLI/bestiary/beast/giant-wolf-spider-xmm.md) infest this otherwise empty crypt. The spiders make no noise and leap out to attack anyone who moves in front of the crypt's gaping doorway.
...
A patch of [brown mold](/3-Mechanics/CLI/traps-hazards/brown-mold-xdmg.md) (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide") fills the crypt. Characters within 5 feet of the crypt's open doorway are affected.
...
Hidden under the brown mold next to the baron's bones is a [luck blade](/3-Mechanics/CLI/items/luck-blade-xdmg.md) with one wish remaining. If a creature uses the wish to try to escape from Barovia, the spell fails. If a creature uses the sword to wish for Strahd's destruction, the wish doesn't destroy Strahd but rather teleports him to within 5 feet of the sword.
...
The floor of the crypt is actually the cover of a 30-foot-deep spiked pit. The cover opens if 100 pounds of weight or more are placed on it. It splits down the middle, east to west, and its doors are spring-loaded. After a victim or victims fall into the pit, its doors snap shut. (See ""Sample Traps"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide" the rules on locking pits and spiked pits.) The spikes at the bottom of the pit are made of iron but aren't [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned).

##### Treasure

A human skeleton (the remains of a dead adventurer) wrapped in bits of studded leather armor lies amid the spikes at the bottom of the pit. A shattered lantern and a rusty [crowbar](/3-Mechanics/CLI/items/crowbar-xphb.md) lie nearby. Tied to the corpse's leather belt is a [50-foot coil of hempen rope](/3-Mechanics/CLI/items/rope-xphb.md), a [dagger](/3-Mechanics/CLI/items/dagger-xphb.md) in a worn scabbard, a pouch containing 25 pp, and a stoppered wooden tube containing a [spell scroll](/3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [magic circle](/3-Mechanics/CLI/spells/magic-circle-xphb.md).
...
A [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that both alcoves radiate strong auras of conjuration magic.
...
An [invisible](/3-Mechanics/CLI/conditions.md#Invisible) [imp](/3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) is perched atop the owlbear. If someone tries to open the sarcophagus, the imp says in Common, "I wouldn't do that if I were you!" The imp is magically bound to King Dostron's remains and must watch over them for several more centuries before its contract are fulfilled. It isn't obligated to protect the contents of the crypt (so it will not attack), and it delights in telling lies and engaging in mischief. For instance, it warns the characters that the sarcophagus is trapped, and that opening the lid will free a pit fiend bound within.
...
The floor here is an illusion that hides a 20-foot-deep pit. The sides of the pit are polished smooth; a creature without a climbing speed can't move along them without the aid of magic or a climber's kit. At the bottom of the pit are six starving [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md). A permanent [silence](/3-Mechanics/CLI/spells/silence-xphb.md) spell suppresses sound in the pit. The silence can be dispelled, as can the illusory floor (DC 14 for both).
...
The compartment under the slab holds a small, black leather case containing three [spell scrolls](/3-Mechanics/CLI/items/spell-scroll-xdmg.md) ([cone of cold](/3-Mechanics/CLI/spells/cone-of-cold-xphb.md), [fireball](/3-Mechanics/CLI/spells/fireball-xphb.md), and [lightning bolt](/3-Mechanics/CLI/spells/lightning-bolt-xphb.md)).
...
Three [hell hounds](/3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) lunge forth and attack, fighting to the death. In the round after they attack, General Grislek's [wraith](/3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) emerges from the crypt, uttering commands to the hounds in Infernal. Once these evil creatures are slain, the characters can inspect the crypt more closely.
...
A [mending](/3-Mechanics/CLI/spells/mending-xphb.md) cantrip can repair the spear, which is broken into three pieces of roughly equal length. If repaired, it can be wielded as a silvered, nonmagical spear.
...
The [nightmare](/3-Mechanics/CLI/bestiary/fiend/nightmare-xmm.md), [Beucephalus](/3-Mechanics/CLI/bestiary/npc/beucephalus-cos.md), is Strahd's steed. It has 104 hit points. If the characters slay it, Strahd hunts them down mercilessly. When the steed wants to leave the castle, it flies up the central shaft of the high tower (area K18a), exiting through the gash in the tower roof (area K59).
...
Sergei's embalmed body is clothed in shining [+2 plate armor](/3-Mechanics/CLI/items/2-armor-xdmg.md).
...
Lying under the earth near the east wall of the tomb are three [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) brides dressed in soiled gowns and wearing dirt-encrusted jewelry (see "Treasure" below). They rise to attack anyone who approaches Strahd's coffin.

A [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the western and eastern alcoves radiate strong auras of conjuration magic. The central alcove is nonmagical.
