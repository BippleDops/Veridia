...
modified: 2025-08-14
status: active
aliases: ["03 Mechanics Conditions"]
priority: normal
category: 03 People
subcategory: 03 Mechanics Conditions.Md
related: []
cssclass: standard
publish: false --- # 03 Mechanics/Conditions ## Portrait![[Conditions|Conditions]] *Portrait reference for 03_Mechanics_Conditions* ## Mechanic Overview **System**: D&D 5th Edition **Type**: Rule Variant / Subsystem / Optional Rule
**Complexity**: Moderate
**Purpose**: Enhance gameplay in specific situations ## Description 03 Mechanics/Conditions provides a structured approach to handling specific game situations that benefit from additional mechanical depth. This system integrates with existing D&D 5e rules while adding meaningful choices and consequences. ## Core Mechanics ### Basic Resolution The fundamental process works as follows: 1. **Trigger**: Specific situation arises requiring this mechanic
...
| 4 | Option D |
| 5 | Option E |
| 6 | Option F | ## Conditions Reference (PHB p.290-292) ### Common Conditions {#conditions-reference-(phb-p.290-292)-###-common-conditions} - **Blinded**: Can't see, auto-fail sight checks, disadvantage on attacks
...
6. Death ## References - [[03_Mechanics_Conditions_Quick_Ref|03 Mechanics Conditions Quick Ref]] ## Notes {#notes} *Additional notes* #mechanics/combat
#mechanics/rules
#mechanics/mechanics
#mechanics/system
#mechanics/dice
