...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Black Market Price Guide"]
status: active
priority: normal
...
![](04_Resources/Assets/Symbols/black-market-operations.svg) # Black Market Price Guide

*Where Everything Has a Price, and Nothing Is Too Dark to Sell* > *"The black market isn't a place - it's a state of mind. It's the economy that exists in the shadows between legal and illegal, moral and necessary, survival and damnation."* - [[The Whisper Syndicate|02 Worldbuilding/Groups/The Whisper Syndicate]] operative ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Overview

The underground economies of [[Aethermoor|02 Worldbuilding/Places/Aethermoor]] and [[Aquabyssos|02 Worldbuilding/Places/Aquabyssos]] operate parallel to legitimate commerce, offering goods and services that are illegal, restricted, or morally questionable. These markets thrive in the gaps left by legal regulation, providing everything from simple contraband to horrifying services that no civilized society would permit. #### Street Level Operations
...
**Risk Level**: High detection probability, moderate penalties **Common Operations**:
...
- **Survival Services**: Food, shelter, and protection for desperate people #### Mid-Tier Criminal Networks
...
**Risk Level**: Moderate detection, severe penalties if caught **Specialized Markets**:
...
- **Professional Thievery**: Custom stealing jobs for specific targets #### Elite Criminal Organizations
...
**Risk Level**: Low detection (due to influence), catastrophic penalties if exposed **Exclusive Services**:
...
- **Government Infiltration**: Placing agents in positions of authority #### Basic Fencing Operations
...
**Security**: Minimal security, high risk of exposure **Item Categories**:
...
- **Information**: Documents, letters, business records #### Professional Fencing Networks
...
**Security**: Multiple layers of protection and false documentation **Specialized Services**:
...
- **Insurance Fraud**: Coordinating with corrupt insurance agents #### Elite Antiquities Laundering
...
**Security**: Complete false histories and academic backing **Premium Services**:
...
- **Historical Documentation**: Creating complete false histories for ancient items #### Surface Realm Substances **Crystalized Euphoria** (per dose):
...
- **Legal Status**: Illegal, possession carries 100 gp fine and 30 days imprisonment **Nightmare Powder** (per dose):
...
- **Legal Status**: Illegal, used as torture device and interrogation aid **Memory Wine** (per bottle):
...
- **Legal Status**: Restricted to licensed healers, illegal sale carries 5 years imprisonment #### Deep Realm Bio-Substances **Pressure Sickness** (per injection):
...
- **Legal Status**: Military restricted, civilian possession is capital crime **Depth Madness** (per dose):
...
- **Legal Status**: Banned in all depth zones, possession carries death penalty **Living Memory** (per vial):
...
- **Legal Status**: Harvesting is murder, possession carries life imprisonment #### Illegal Weaponry **Poison Weapons** (various types):
...
- **Availability**: Assassin guilds and professional killers only **Magical Weapon Enhancements** (illegal modifications):
...
- **Legal Risk**: Possession carries exile, use carries death penalty **Military-Grade Equipment** (restricted to authorized forces):
...
- **Penalties**: Treason charges for unauthorized possession #### Enchanted Contraband **Curse Items** (deliberately harmful magical objects):
...
- **Moral Status**: Universally condemned, possession indicates evil intent **Forbidden Magical Knowledge** (spell scrolls and formulae):
...
- **Academic Ban**: Possession by scholars results in academic exile #### Political Intelligence **Government Secrets** (per document or piece of information):
...
- **Personal Scandals**: 500-5,000 gp for embarrassing information about officials **Economic Intelligence**:
...
- **Corporate Espionage**: 2,000-20,000 gp for competitor business intelligence #### Criminal Intelligence **Law Enforcement Information**:
...
- **Corruption Networks**: 5,000-25,000 gp for information about corrupt officials **Rival Criminal Organization Data**:
...
- **Safe House Locations**: 2,000-10,000 gp for hideout and storage facility locations #### Professional Criminal Services **Assassination Services**:
...
- **Perfect Crime**: +100% surcharge for completely untraceable killings **Theft and Burglary**:
...
- **Custom Theft**: 25% of stolen item value for acquiring specific objects **Kidnapping and Extortion**:
...
- **Psychological Torture**: 500-2,000 gp per week for mental coercion services #### Corruption Services **Official Bribery**:
...
- **Judicial Corruption**: 2,000-20,000 gp for influencing legal proceedings **False Documentation**:
...
- **International Documentation**: 1,000-5,000 gp for cross-realm travel papers #### Illegal Gambling Houses **Underground Casinos**:
...
- **Protection Money**: 10-20% of winnings demanded by criminal organizations **Fighting Pits**:
...
- **Exotic Contests**: 1,000-10,000 gp for unusual combat scenarios **Rigging Methods and Costs**:
...
- **Dealer Corruption**: 200-1,000 gp per month for corrupted game operators #### Sports and Event Betting **Fight Rigging**:
...
- **Medical Manipulation**: 1,000-5,000 gp for pre-fight drugging or injury **Race Fixing**:
...
- **Information Networks**: 1,000-5,000 gp for insider information on race fixes #### Surface Realm Black Markets **Crystal Heights Underground**:
...
- **Art Forgery**: Fake masterworks sold to competitive collectors **Harbor District Shadow Economy**:
...
- **Document Fraud**: False papers for illegal immigrants and fugitives **Undercity Survival Markets**:
...
- **Identity Erasure**: Complete elimination of personal history and identity #### Depth Realm Criminal Commerce **Twilight Zone Shadow Trade**:
...
- **Information Laundering**: Cleaning stolen intelligence for resale **Bathyal Zone Industrial Crime**:
...
- **Environmental Destruction**: Illegal dumping and resource extraction **Abyssal Zone Extreme Markets**:
...
- **Existence Erasure**: Complete removal of individuals from all records #### Investigation Costs
...
**Deep Cover Operations**: 10,000-50,000 gp for long-term infiltration missions #### Corruption and Counter-Corruption
...
**Witness Protection**: 2,000-10,000 gp per year per protected witness #### Security Measures
...
**Communication Security**: 1,000-5,000 gp for encrypted criminal communications #### Violence and Intimidation
...
**Property Destruction**: 200-2,000 gp for targeted vandalism and arson #### Law Enforcement Pressure
...
**Legal Alternative**: Black market prices drop 60-80% if legal alternatives appear #### Political Instability
...
**Social Upheaval**: Revolutionary periods create massive market volatility #### Seasonal and Cultural Factors
...
**Academic Calendar**: Student demand for performance drugs creates seasonal spikes #### Criminal Organization Competition
...
**Alliance Formation**: Criminal cooperation stabilizes prices within 10-20% ranges #### Cross-Realm Criminal Trade
...
**Political Relations**: Diplomatic tensions increase criminal cooperation costs 100-400% #### Investigation Scenarios
...
20: **Market Innovation** - New type of illegal good or service becomes available ### Criminal Organization Generator (d12)
...
11-12: **Foreign Infiltrators** - International criminals operating locally ### Black Market Complication Table (d10)
...
10: **Personal Betrayal** - Trusted criminal associates reveal their true loyalties ## Player-Facing Summary Black markets represent the shadow economy that exists parallel to legitimate commerce, offering opportunities for profit, adventure, and moral complexity. Understanding these markets provides access to restricted resources while creating ethical dilemmas about supporting criminal enterprises. ## Lore Details Criminal legends speak of the "True Market" - a mythical exchange where the fundamental laws of reality can be bought and sold. Some say this market exists in the spaces between legal and illegal, where moral absolutes become negotiable commodities and even concepts like justice and truth have fluctuating exchange rates. Deep-sea criminals tell stories of "pressure crimes" that can only be committed at extreme depths, where the physical laws become malleable enough for impossible thefts and unthinkable violations. These crimes supposedly leave no evidence that can exist at normal pressures, making prosecution impossible. ## DM Notes Use black markets as more than just sources of illegal goods - make them complex economic systems with their own rules, cultures, and moral frameworks. Criminal organizations should have logical motivations and sophisticated operations that rival legitimate businesses in complexity. Consider the moral ambiguity inherent in black markets - they often provide services that people genuinely need but cannot obtain through legal channels. This creates opportunities for players to wrestle with ethical questions about law, justice, and survival. The interconnected nature of legal and illegal economies means that disrupting black markets can have unexpected consequences for legitimate businesses and ordinary citizens, allowing for complex plots where simple solutions create new problems. ## Related *Links to related content will be added here.* ## Plot Hooks - Someone is hunting information for revenge
