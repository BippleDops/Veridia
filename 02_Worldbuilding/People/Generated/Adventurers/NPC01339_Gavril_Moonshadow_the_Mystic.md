...
## Appearance
Very short and athletic, with Tied back black hair and Red eyes. Pale skin. Intricate tattoos covering arms.

**Clothing**: Merchant's outfit with many hidden pockets
**Accessories**: Prayer beads

## Personality
- **Traits**: Never uses people's real names; Collects unusual and worthless objects; Extremely superstitious about everything
...
## Relationships
### Ysara Crystalbrook the Mystic (Family - Parent)
...
### Skills
Athletics, Stealth, Survival, Intimidation
...
- Evasion: No damage on successful DEX save
- Action Surge: Extra action once per combat
- Spellcasting: 5 spell slots, knows Hold Person, Fly, Scorching Ray, Charm Person, Invisibility
