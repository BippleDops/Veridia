...
## Appearance
Below average and delicate, with Long and flowing white hair and Gray eyes. Tan skin. Prominent scar across the face.

**Clothing**: Merchant's outfit with many hidden pockets
**Accessories**: Silver ring with family crest, Pocket watch

## Personality
- **Traits**: Speaks to inanimate objects; Sees doom and gloom everywhere; Never uses people's real names; Always hungry and eating something
...
## Relationships
### Pyria Nightfall the Fallen (Criminal - Informant)
- **Status**: Complicated history
- **History**: Bonded over shared tragedy
- **Secret**: Share a terrible crime

### Aeliana Ironforge the Lost (Criminal - Handler)
- **Status**: Strained but maintaining
- **History**: United by common enemy
- **Secret**: One murdered the other's family

### Pyria Ironwood the Risen (Family - Spouse)
- **Status**: Complicated history
- **History**: United by common enemy
