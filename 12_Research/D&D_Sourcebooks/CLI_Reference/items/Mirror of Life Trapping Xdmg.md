...
---
title: Mirror of Life Trapping Xdmg
aliases:
...
When this 4-foot-tall, 2-foot-wide mirror is viewed indirectly, its surface shows faint images of creatures. The mirror weighs 50 pounds, and it has AC 11, HP 10, [[immunity-xphb|Immunity]] to Poison and Psychic damage, and [[vulnerability-xphb|Vulnerability]] to Bludgeoning damage. It shatters and is destroyed when reduced to 0 [[hit-points-xphb|Hit Points]].
...
Any creature other than you that sees its reflection in the activated mirror while within 30 feet of the mirror must succeed on a DC 15 Charisma saving throw or be trapped, along with anything it is wearing or carrying, in one of the mirror's twelve extradimensional cells. A creature that knows the mirror's nature makes the save with [[advantage-xphb|Advantage]], and Constructs succeed on the save automatically.
