---
title: 04 Resources Assets Locations location city deep current flowmaster v1 deep
  current flowmaster.svg
aliases:
- 04 Resources Assets Locations location city deep current flowmaster v1 deep current
  flowmastersvg
type: npc
tags:
- character
...
04_Resources/Assets/Locations/location-city-deep-current-flowmaster-v1-deep-current-flowmaster.svg has established themselves as a notable figure in their domain. Their expertise and reputation precede them, making them a valuable contact for those who earn their respect.
...
04_Resources_Assets_Locations_location-city-deep-current-flowmaster-v1-deep-current-flowmaster.svg presents a distinctive figure. Their bearing suggests both competence and experience. Notable features include:
...
- [[Enforcer Chief Mako Ironjaw]]: *mentor*
- [[Trade Captain Current]]: *childhood friend*
