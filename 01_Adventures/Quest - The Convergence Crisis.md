...
subcategory: Quest - The Convergence Crisis.Md
related: []
cssclass: standard
publish: false
...
*When Two Worlds Collide* ## Quest Giver
...
- Risk: Each use merges part of wielder with the crown #### Blade of Severance (Legendary Weapon)
...
- Can cut portals between dimensions (requires 1 hour ritual) #### Robes of Dual Existence (Legendary)
...
- Immunity to convergence and separation effects #### Staff of Reality Anchoring (Legendary)
...
- Stores knowledge of all dimensional boundaries and their stability #### The Mediator's Compass (Very Rare)
...
- Reveals true nature of any creature from another dimension #### Ring of Perpetual Choice (Artifact)
...
- Curse: Must make Wisdom save each day or become paralyzed by infinite possibilities ### Path A: Complete Convergence Success
...
- Party becomes founding figures of post-convergence world **Long-term Effects**:
...
- External cosmic threats now face unified resistance ### Path B: Controlled Separation with Communication
...
- Crisis experience creates lasting alliance against future threats **Long-term Effects**:
...
- Model established for interaction with other discovered dimensions ### Path C: Emergency Forced Separation
...
- Massive trauma from sudden separation affects survivors **Long-term Effects**:
...
- Neither realm prepared for external cosmic threats ### Path D: Selective Regional Convergence
...
- New forms of goverce needed for multi-reality territories
- Ongoing tension between convergence supporters and opponents **Long-term Effects**:
...
- Experimental ground for future controlled convergence projects ### Path E: The Cosmic Ascension
...
- New responsibilities include interaction with other cosmic entities **Long-term Effects**:
...
3. [[The Convergence Seekers|02 Worldbuilding/Groups/The Convergence Seekers]] - Primary faction driving crisis
...
9. [[Purist Coalition|02 Worldbuilding/Groups/Purist Coalition]] - Faction violently opposing merger
10. [[Silverscale Consortium|02 Worldbuilding/Groups/Silverscale Consortium]] - Corporate interests in crisis
...
23. [[The Hadal Depths|02 Worldbuilding/Places/The Hadal Depths]] - Deep Mother's physical location
24. [[The Shadowmere|02 Worldbuilding/Places/The Shadowmere]] - Zone affected by convergence
25. [[Port Meridian|02 Worldbuilding/Places/Port Meridian]] - Trade hub dealing with crisis refugees
26. [[The Verdant Reach|02 Worldbuilding/Places/The Verdant Reach]] - Natural area resisting merger
27. [[The Azure Coast]] - Coastal region experiencing reality storms
28. [[Memory Meadows]] - Dream realm affected by convergence
29. [[The Deepmind|02 Worldbuilding/Places/The Deepmind]] - Consciousness nexus monitoring crisis
30. [[pat|02 Worldbuilding/Lore/pat]] - Neutral zone for cross-realm negotiations
31. [[Queen Seraphina Lumengarde|02 Worldbuilding/People/Queen Seraphina Lumengarde]] - Crystal Throne ruler's response
32. [[The Crimson Sage|02 Worldbuilding/People/The Crimson Sage]] - Aetheron's perspective on convergence
33. [[Pressure Angel Benthia]] - Divine messenger warning of consequences
34. [[The Azure Prophet Nerissa]] - Seer predicting convergence outcomes ### Epic Campaign Requirements
...
**Player Investment**: Characters should have personal stakes in both worlds' survival ### Session Structure & Pacing

**Act I (8-10 sessions)**: Investigation, discovery, and alliance building
**Act II (6-8 sessions)**: Exploration of hybrid zones and rescue operations **Act III (8-10 sessions)**: Infiltration, revelation, and factional conflicts
**Act IV (10-12 sessions)**: Major battles, political maneuvering, and critical choices
**Act V (8-12 sessions)**: Final convergence events, cosmic encounters, and resolution ### Managing Reality-Altering Stakes
...
**Scope Control**: Don't overwhelm players with too many simultaneous crisis points ### Handling Multiple Factions
...
**Consequence Integration**: Show how faction relationships affect available endings ### Reality Alteration Mechanics
...
**Physics Flexibility**: Allow creative solutions to impossible situations ### Campaign Conclusion Considerations
...
**Sequel Potential**: Leave hooks for future cosmic-level adventures ### Player Comfort & Content
...
**Long Commitment**: Confirm group willing to invest in 40+ session arc ### Customization & Scaling Options
...
**Action Focus**: Add more epic battles and reduce investigation/dialogue scenes ## Player-Facing Summary Quest The Convergence Crisis is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of Quest The Convergence Crisis as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around Quest The Convergence Crisis. ## Related *Links to related content will be added here.* ## 12_Research Specific Content Contextual improvement based on 12_Research ## Background
...
| 4 | Option D |
| 5 | Option E |
| 6 | Option F | ## References - [[Memory Harvester Kythara]]
