---
aliases: ["Escape the Tyrant", "escape the tyrant", "Escape Tyrant", "Tyrant the Escape"]
tags: [generated]
id: QUEST0041
...
*Kill Quest for levels 3-7*

**ID**: QUEST0041

## Quest Giver
**Brenna Darkwater** - Mysterious stranger
...
## Key Locations
- **SouthHill** (City): Key location for quest progression
- **EastHill** (Dungeon): Key location for quest progression
- **Gatehollow** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Bandits** led by Brenna Shadowmere
  - Strength: 26 combatants
...
- **Gold**: 1,935 gp
- **Experience**: 3,000 XP
- **Magic Items**: Blessed Gauntlet of Power
