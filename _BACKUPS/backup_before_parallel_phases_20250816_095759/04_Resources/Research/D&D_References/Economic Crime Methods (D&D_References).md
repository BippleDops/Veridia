...
title: Economic Crime Methods (D&D_References)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Economic Crime Methods (D&D References)"]
status: active
priority: normal
...
![](04_Resources/Assets/Symbols/economic-crime-methods.svg) # Economic Crime Methods

*The Art of Stealing Without Taking, and Profiting Without Producing* > *"The most elegant crime is the one where the victim thanks you for robbing them. The perfect ficial crime is when the system itself pays you to destroy it."* - [[Banker Titus Goldcurrent|02 Worldbuilding/People/Banker Titus Goldcurrent ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Overview

Economic crime in [Aethermoor|02 Worldbuilding/Places/Aethermoor]] and [[Aquabyssos|02 Worldbuilding/Places/Aquabyssos has evolved into sophisticated methodologies that exploit the complex ficial systems connecting both realms. These crimes range from simple fraud to elaborate schemes that manipulate entire economic sectors, often operating within legal gray areas that make detection and prosecution extremely difficult. #### Crystal Valuation Manipulation
...
- Net savings: 50-80% of original tax obligation #### Trade Route Misdeclaration
...
**Detection Risk**: Moderate (physical inspection required) **Common Techniques**:
...
- **Weight Manipulation**: Using magical lightening to reduce declared cargo mass #### Property Valuation Schemes
...
**Detection Risk**: Low (requires comprehensive market analysis) #### Pressure Manufacturing Hidden Production
...
**Detection Risk**: High (requires sophisticated monitoring systems) **Concealment Methods**:
...
- **Quality Misrepresentation**: Claiming defective products to reduce taxable value #### Current Transport Fee Avoidance

**Method**: Using unofficial transport networks to avoid current usage fees
**Participants**: [The Current Merchants|02 Worldbuilding/People/The Current Merchants]], independent traders, smugglers
**Savings**: 15-40% reduction in transport-related taxation
**Detection Risk**: Moderate (patrol monitoring can detect unauthorized current usage) **Evasion Techniques**:
...
- **Bribery Networks**: Corrupting current monitors to ignore unauthorized usage #### Imperial Tribute Manipulation
...
**Detection Risk**: Low (imperial bureaucracy overwhelmed and distant) #### Currency Exchange Manipulation
...
**Detection Risk**: Very Low (legal gray area between jurisdictions) **Arbitrage Techniques**:
...
- **Double Deduction**: Claiming same business expenses as deductions in both tax systems #### International Trade Laundering
...
**Detection Risk**: Extremely Low (requires international cooperation to investigate) #### Merchant Front Businesses
...
**Sophistication Level**: Low to Moderate **Operational Process**:
...
4. **Documentation**: Creating complete paper trails for false transactions **Cost Structure**:
...
- Net cleaning rate: 55-70% of original criminal proceeds #### Gaming and Entertainment Laundering
...
**Sophistication Level**: Moderate **Specialized Techniques**:
...
- **High-Roller False Personas**: Creating fake wealthy gamblers to justify large cash movements #### International Trading Schemes
...
**Sophistication Level**: High **Complex Mechanisms**:
...
- **Quality Manipulation**: Claiming premium prices for standard goods, excess goes to criminals #### Ficial Institution Infiltration
...
**Sophistication Level**: Very High **Institutional Methods**:
...
- **Regulatory Capture**: Controlling ficial regulators to prevent investigation #### Crystal Energy Washing
...
**Sophistication Level**: Very High **Magical Techniques**:
...
- **Divination Fraud**: Claiming criminal money as payment for fortune telling and prophecy #### Memory and Experience Laundering
...
**Sophistication Level**: Extreme **Experience-Based Methods**:
...
- **Consciousness Trading**: Complex schemes involving personality and consciousness modification #### Surface Realm Currency Forgery
...
**Economic Impact**: Can destabilize entire economic sectors if produced in volume **Crystal Currency Counterfeiting**:
...
- **Distribution Networks**: Establishing channels to introduce counterfeit currency to markets **Technical Requirements**:
...
- Labor specialization: Teams of 5-15 specialists for major operations #### Depth Realm Pearl Forgery
...
**Detection**: Sophisticated because authentic pearls are living organisms **Bio-Currency Counterfeiting**:
...
- **Biological Documentation**: Forging breeding and cultivation records for fake currency #### Official Documentation Fraud
...
**Legal Consequences**: Treason charges for government documents, exile for major fraud **Sophisticated Forgery Techniques**:
...
- **Bureaucratic Templates**: Obtaining genuine blank forms for completion with false information #### Identity Creation Services
...
**Quality Levels**: Basic (casual inspection), Professional (detailed investigation), Perfect (expert forensic analysis) **Identity Package Components**:
...
**Social Impact**: Can cause famines, economic depressions, or infrastructure failures **Cornering Process**:
...
5. **Profit Extraction**: Selling at inflated prices while maintaining artificial scarcity **Risk Management**:
...
- Social unrest: Popular anger about essential goods scarcity #### Stock and Investment Manipulation
...
**Regulation**: Minimal due to complexity and limited government oversight capacity #### Market Intelligence Manipulation
...
**Profitability**: 100-1000% returns for those controlling information flows **Information Warfare Techniques**:
...
- **Source Credibility Management**: Building and destroying credibility of information sources #### Rumor Campaign Management
...
**Effectiveness**: Can cause 20-200% changes in targeted market values #### Cargo and Shipment Fraud
...
**Profitability**: 150-300% of legitimate cargo value for successful claims **Fraud Techniques**:
...
- **Investigator Corruption**: Bribing insurance investigators to approve fraudulent claims #### Property and Business Insurance Fraud
...
**Annual Fraud Volume**: Estimated 10-20% of all insurance claims are partially or completely fraudulent #### Ponzi and Pyramid Investment Schemes
...
**Collapse Timing**: Usually 2-5 years before mathematical impossibility forces scheme collapse **Scheme Mechanics**:
...
- **Collapse Phase**: When recruitment fails to keep up with payment obligations #### Banking Embezzlement Operations
...
**Detection Timeline**: Often years or decades before discovery due to sophisticated concealment #### Systematic Bribery Networks
...
**Organizational Structure**: Hierarchical networks matching government bureaucracy **Bribery Network Operations**:
...
- **Security**: Protecting corruption network from investigation and exposure #### Policy Influence Operations
...
**Investment**: 100,000-1,000,000 gp for major policy influence campaigns #### Guild and Professional Organization Corruption
...
**Permanence**: Can provide decades of protection for criminal enterprises #### Academic and Certification Corruption
...
**Detection Difficulty**: High, because corruption occurs within trusted expert institutions #### Industrial Espionage Operations
...
**International Scope**: Often involves cross-realm technology transfer and espionage #### Patent and Innovation Fraud
...
**Legal Complexity**: Difficult to prosecute due to technical complexity and corrupted oversight #### Communication System Infiltration
...
**Detection**: Extremely difficult due to magical rather than physical evidence #### Data Manipulation and Storage Crimes
...
**Permanence**: Changes to magical storage can be nearly impossible to detect or reverse #### Investigation Scenarios
...
4. **The Market Manipulation**: Artificial commodity shortages are causing social unrest and political instability #### Moral Complexity Adventures
...
4. **The Whistle Blower**: Protecting individuals exposing economic crimes against powerful criminal organizations #### Infiltration and Undercover Operations
...
4. **The Corruption Network**: Mapping and exposing systematic government and professional corruption ### Economic Crime Event Generator (d20)
...
20: **Criminal War** - Competing economic crime organizations come into conflict ### Economic Crime Complexity Generator (d12)
...
11-12: **Systemic Economic Crime** - Fundamental corruption of economic systems themselves ### Economic Crime Consequences Table (d10)
...
10: **Systemic Collapse** - Major economic crime threatens fundamental economic stability ## Player-Facing Summary Economic Crime Methods represent sophisticated approaches to illegal profit that exploit the complex ficial systems connecting both realms. Understanding these methods provides insight into the darker side of commerce while creating opportunities for adventure involving investigation, infiltration, and moral complexity. ## Lore Details Ancient criminal texts speak of the "Perfect Crime" - a theoretical economic fraud so sophisticated that it actually improves the economy while stealing from it, creating value while destroying it, and benefiting everyone while harming everyone. Some economists argue that such a crime would be indistinguishable from legitimate innovation. Deep-sea criminal philosophers maintain that at extreme depths, the pressure makes economic crimes physically manifest, creating visible distortions in reality that reflect the moral distortions of ficial fraud. They claim that the most sophisticated economic criminals eventually become unable to exist at normal pressures. ## DM Notes Use economic crimes as more than just background elements - make them active forces that shape the political and social landscape of your campaign. Economic crime can provide adventure hooks that combine mystery, politics, moral complexity, and social commentary. Consider how different types of economic crime create different kinds of moral questions for player characters. Tax evasion, money laundering, and market manipulation each involve different ethical issues and create different types of victims. The sophisticated nature of economic crime allows for complex plots that develop over multiple sessions, requiring careful investigation, strategic thinking, and difficult moral decisions. These crimes often involve legitimate institutions and respected individuals, creating ambiguity about who can be trusted. ## Related *Links to related content will be added here.* ## Plot Hooks - Strange sightings suggest a curse
