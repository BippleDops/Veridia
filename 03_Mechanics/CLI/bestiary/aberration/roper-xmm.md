...
"actions":
  ...
  - "desc": "Melee Attack Roll: +7, reach 5 ft. Hit: 17 (3d8 + 4) Piercing damage."
    "name": "Bite"
  - "desc": "Melee Attack Roll: +7, reach 60 ft. Hit: The target has the [Grappled](/03_Mechanics/CLI/conditions.md#Grappled)\
      \ condition (escape DC 14) from one of six tentacles, and the target has the\
      \ [Poisoned](/03_Mechanics/CLI/conditions.md#Poisoned) condition until the grapple\
      \ ends.\n\nThe tentacle can be damaged, freeing a creature it has [Grappled](/03_Mechanics/CLI/conditions.md#Grappled)\
      \ when destroyed (AC 20, HP 10, [Immunity](/03_Mechanics/CLI/variant-rules/immunity-xphb.md)\
