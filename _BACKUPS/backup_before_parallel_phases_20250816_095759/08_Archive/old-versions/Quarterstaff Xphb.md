...
updated: '2025-08-13T12:34:07.236386+00:00'
world: Both

--- # Quarterstaff

*Weapon* ![](/03_Mechanics/CLI/items/img/quarterstaff.webp#right) - **Damage**: - One-handed: `dice: 1d6` bludgeoning - Two-handed: `dice: 1d8` bludgeoning
- **Properties**: [[item properties#Versatile|Versatile]]
- **Cost**: 2 sp
- **Weight**: 4.0 lbs. *Source: Player's Handbook (2024) p. 215. Available in the SRD and the Free Rules (2024)* ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Player-Facing Summary Quarterstaff xphb is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices. ## Lore Details Legends speak of quarterstaff xphb as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around quarterstaff xphb. ## DM Notes Play up tactile detail: sounds, pressure/wind changes, and meaningful symbology. Offer two clear approaches (stealth vs. Parley) and one wildcard complication tied to a faction clock. Reward scouting and map use. ## Related *Links to related content will be added here.* ## Secret Connections *[Hidden from players]* Connected to The Hidden Alliance - Achieve immortality ## Plot Hooks - An heirloom has gone missing and evil awakens
...
- [[enspelled-staff-cantrip-xdmg (items)
- [enspelled-staff-level-1-xdmg (items)]]
- [[enspelled-staff-level-2-xdmg (items)
- [enspelled-staff-level-3-xdmg (items)]]
- [[enspelled-staff-level-4-xdmg (items)
- [enspelled-staff-level-5-xdmg (items)]]
- [[enspelled-staff-level-6-xdmg (items)
- [enspelled-staff-level-7-xdmg (items)]]
