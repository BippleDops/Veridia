...
updated: '2025-08-13T01:18:31.494279+00:00'
world: Both
status: active
---
...
| Skeleton | +2 Dex, -4 Int, -4 Cha | Vulnerable to bludgeoning damage, immune to poison damage and [exhaustion](/03_Mechanics/CLI/conditions.md#Exhaustion), can't be poisoned, darkvision 60 ft., can't speak but understands the languages it knew in life |
...
Creating npcs from scratch npc features is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of creating npcs from scratch npc features as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around creating npcs from scratch npc features.

## Adventure Hooks

- A rumor ties creating npcs from scratch npc features to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at creating npcs from scratch npc features to avert a public scandal.
- A map overlay reveals a hidden approach to creating npcs from scratch npc features active only during specific tides/storms.
