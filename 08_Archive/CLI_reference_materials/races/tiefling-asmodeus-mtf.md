...
updated: '2025-08-13T01:18:34.456097+00:00'
world: Both
status: active
---
...
You know the [thaumaturgy](/03_Mechanics/CLI/spells/thaumaturgy-xphb.md) cantrip. Once you reach 3rd level, you can cast the [hellish rebuke](/03_Mechanics/CLI/spells/hellish-rebuke-xphb.md) spell as a 2nd-level spell with this trait; you regain the ability to cast it when you finish a long rest. Once you reach 5th level, you can also cast the [darkness](/03_Mechanics/CLI/spells/darkness-xphb.md) spell once per day with this trait; you regain the ability to cast it when you finish a long rest. Charisma is your spellcasting ability for these spells.
...
Tiefling asmodeus mtf is a undersea element of the setting, known for bioluminescent glow and pressure-glass. Its presence anchors ongoing storylines and offers clear player choices.

## Lore Details

Legends speak of tiefling asmodeus mtf as a nexus where past and present converge. Locals describe subtle omens—shifts in currents, a dimming of lanternfish, or whispers on the wind—that herald change around tiefling asmodeus mtf.

## Adventure Hooks

- A rumor ties tiefling asmodeus mtf to a missing shipment, linking factions with competing claims.
- An NPC seeks discreet help at tiefling asmodeus mtf to avert a public scandal.
- A map overlay reveals a hidden approach to tiefling asmodeus mtf active only during specific tides/storms.
