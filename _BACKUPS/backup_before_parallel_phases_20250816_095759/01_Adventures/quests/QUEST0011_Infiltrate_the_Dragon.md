...
## Quest Giver
**Lyra Goldleaf** - Military officer
...
## Key Locations
- **SouthBridge** (City): Key location for quest progression
- **Watchshire** (Dungeon): Key location for quest progression
- **Gateshire** (Wilderness): Key location for quest progression

## Opposition
### Enemies
- **Demons** led by Lyra Brightblade
