...
title: Trade Goods Catalog (D&D_References)
type: note
tags:
- note
...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Trade Goods Catalog (D&D References)"]
status: active
priority: normal
...
--- > [!figure] Trade Goods
![](04_Resources/Assets/Items/items-trade-goods-catalog.svg) # Trade Goods Catalog

*The Merchant's Bible: Everything Has a Price* > *"Show me a man's inventory and I'll tell you his dreams, his fears, and the exact price of his soul."* - [[Banker Titus Goldcurrent|02 Worldbuilding/People/Banker Titus Goldcurrent]] ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Overview
...
- **Perfect Crystals** (each): 2,000+ gp | Legendary magical items and unique applications **Mechanical Effects**:
...
- **Energy Storage**: Can store spell slots for later use (requires special preparation) **Quality Variations**:
...
- **Ancient Crystals**: +500% price, contain residual magic from lost civilizations **Market Factors**:
...
- **Market Notes**: Popular with adventurers, steady demand **Crystal-Woven Textiles** (per yard)
...
- **Market Notes**: High demand from nobility and extreme environment explorers **Crystal Communication Devices** (Pair)
...
- **Market Notes**: Essential for long-distance trade coordination #### Alchemical Reagents

**Tier**: 1-3 (depending on rarity and potency) **Common Reagents** (per ounce):
...
- **Charcoal, Alchemical**: 2 gp | Absorption applications, filtration **Uncommon Reagents** (per ounce):
...
- **Troll Blood**: 75 gp | Regeneration potions, durability enhancement **Rare Reagents** (per ounce):
...
- **Temporal Dust**: 2,000 gp | Time magic, age manipulation, temporal protection **Mechanical Effects**:
...
- **Magical Research**: Essential for creating new spells and magical items #### Living Components **Awakened Plants** (per specimen):
...
- **Market Notes**: Growing demand for sustainable magical solutions **Trained Familiar Creatures** (each):
...
- **Market Notes**: Popular with merchants needing reliable assistants #### Luxury Textiles

**Tier**: 2-4 (depending on material and craftsmanship) **Silkwind Luxury Fabrics** (per yard):
...
- **Phase Linen**: 200 gp | Becomes translucent at will, advantage on stealth checks **Mechanical Effects**:
...
- **Status Symbols**: Certain fabrics identify the wearer as part of specific social classes #### Masterwork Items **Precision Tools** (various):
...
- **Merchant's Calculation Engine**: 600 gp | Advantage on all ficial and mathematical checks #### Pressure-Enhanced Materials

**Tier**: 3-4 (unique manufacturing process limits availability) **Deepsteel** (per pound):
...
- **Market Notes**: Only produced in extreme deep-sea forges, limited supply **Pressure Glass** (per pound):
- **Base Price**: 100 gp per pound - **Properties**: Transparent, harder than steel, magical conductivity
- **Weight**: Same as regular glass
- **Applications**: Windows, lenses, magical focuses, art objects
- **Market Notes**: Revolutionary material changing both realms' architecture **Compressed Crystals** (various sizes):
- **Base Price**: Standard crystal price × 3
- **Properties**: 5x the magical capacity in 1/3 the space
- **Special**: Unstable if damaged, can explode for 3d6 force damage
- **Applications**: Compact magical devices, energy storage, weapons
- **Market Notes**: High demand from space-conscious applications #### Pressure-Forged Equipment **Abyssal Armor** (various types):
...
- **Market Notes**: Essential for extreme depth exploration and combat **Depth Weapons** (various types):
...
- **Market Notes**: Highly prized by underwater combatants and surface marines #### Living Light Sources

**Tier**: 2-3 (renewable but requires maintece) **Glow Pearls** (each):
...
- **Market Notes**: Popular alternative to torches and lanterns **Luminous Paint** (per jar):
...
- **Market Notes**: Revolutionary for underwater construction and art #### Bio-Tech Devices **Living Computers** (various complexity):
...
- **Market Notes**: Cutting-edge technology changing business and research **Organic Communication Networks** (per node):
...
- **Market Notes**: Revolutionizing long-distance business coordination #### Experience Containers

**Tier**: 3-5 (depending on experience value and rarity) **Skill Memory Pearls** (each):
...
- **Market Notes**: Extremely valuable for temporary expertise needs **Memory Experience Orbs** (each):
...
- **Market Notes**: Popular but controversial due to privacy concerns **Knowledge Crystals** (each):
...
- **Market Notes**: Highly sought after by scholars and merchants #### Cognitive Enhancement Items **Thought Accelerator Pearls** (each):
...
- **Market Notes**: Popular with negotiators and researchers **Emotional Regulation Devices** (each):
- **Base Price**: 1,500 gp
- **Effect**: Immunity to fear and charm effects for 4 hours
- **Special**: Provides advantage on Wisdom saves and Insight checks
- **Market Notes**: Essential equipment for diplomatic and business negotiations #### Communication Devices

**Tier**: 2-3 (essential for cross-cultural commerce) **Universal Translator Amulets** (each):
- **Base Price**: 800 gp
...
- **Market Notes**: Essential for international traders and diplomats **Cultural Etiquette Guides** (each):
...
- **Market Notes**: Wise investment for anyone doing cross-cultural business #### Environmental Adaptation Gear **Dual-Environment Suits** (each):
...
- **Market Notes**: Essential for Bridge Market operations and cross-realm business **Pressure Adaptation Potions** (each):
...
- **Market Notes**: Required for deep-sea business travel and exploration #### Documentation Services

**Tier**: 2-3 (prices vary with political climate) **Cross-Realm Trading Licenses** (per year):
...
- **Market Notes**: Essential for legitimate cross-realm commerce **Cultural Immunity Certificates** (each):
- **Base Price**: 1,000 gp
...
- **Market Notes**: Insurance against costly cultural mistakes #### Forbidden Knowledge

**Tier**: 4-5 (extreme legal risk increases value) **Banned Spell Scrolls** (each):
...
- **Market Notes**: Extreme profits but extreme risks **Government Secrets** (per document):
...
- **Market Notes**: High demand from foreign governments and competing merchants #### Dangerous Substances **Corruption Crystals** (per ounce):
...
- **Market Notes**: Extreme legal penalties for possession **Mind Control Substances** (per dose):
...
- **Market Notes**: High demand from criminals and corrupt officials #### Concealment Services

**Tier**: 2-4 (pricing based on risk and sophistication) **Hidden Compartment Construction** (per cubic foot):
...
- **Market Notes**: Standard service for any serious smuggling operation **False Identity Documentation** (per identity):
...
- **Market Notes**: Essential for criminals operating across jurisdictions #### Transportation Services **No-Questions-Asked Shipping** (per pound/mile):
...
- **Market Notes**: Premium service for high-risk cargo #### Crisis Response Items

**Tier**: 1-3 (prices spike dramatically during emergencies) **Preserved Food Rations** (per week supply):
- **Normal Price**: 10 gp per person per week
- **Crisis Price**: 50-200 gp per person per week
- **Shelf Life**: 5 years with proper storage
- **Market Notes**: Essential stockpile item, massive price swings during disasters **Medical Emergency Kits** (each):
- **Normal Price**: 50 gp
- **Crisis Price**: 200-500 gp
- **Contents**: Healing potions, bandages, surgical tools, antidotes
- **Market Notes**: Critical during plagues, wars, and natural disasters #### Weather Protection **Storm Season Equipment** (various):
...
- **Market Notes**: Seasonal demand creates 200-400% price increases #### Celebration Supplies

**Tier**: 1-2 (demand spikes during cultural events) **Festival Decorations** (various):
...
- **Market Notes**: 300-500% price increases during festival seasons **Celebration Foods and Drinks** (various):
...
- **Market Notes**: Extreme demand during specific cultural celebrations #### Resource Contracts

**Tier**: 3-4 (sophisticated ficial instruments) **Crystal Futures Contracts** (per contract):
...
- **Market Notes**: Professional traders and large merchants only **Transportation Capacity Bonds** (per bond):
...
- **Market Notes**: Essential for businesses requiring reliable shipping #### Exotic Investments **Exploration Rights** (per expedition):
...
- **Market Notes**: High-risk, high-reward investments for wealthy speculators **Political Stability Derivatives** (per contract):
...
- **Market Notes**: Technically illegal but widely practiced #### Authentication Methods
...
- **Availability**: Major cities and trading centers only **Expert Appraisal** (per item):
...
- **Availability**: Most trading centers have qualified appraisers #### Detection and Prevention
...
- **Expert Networks**: Professional authentication services and fraud detection #### Commerce Investigations
...
4. **The Cultural Contamination**: Foreign goods are being deliberately modified to cause cultural offense and damage diplomatic relations #### Economic Espionage
...
4. **The Embargo Enforcement**: Political trade restrictions are being violated through complex smuggling networks #### Cargo Manifest Generator (d20)
...
20: **Mystery Goods** - Unknown or secret cargo requiring investigation #### Price Fluctuation Events (d12)
...
11-12: **Market Manipulation** - Deliberate price control by merchants or criminal organizations #### Market Condition Calculator

**Base Price** × **Supply Modifier** × **Demand Modifier** × **Quality Modifier** × **Distance Modifier** = **Final Price** **Quick Reference Multipliers**:
...
- Perfect goods during desperate need: ×10.0 to ×20.0 #### Trade Route Profitability

**Profit Margin** = (Sale Price - Purchase Price - Transport Cost - Insurance - Bribes - Taxes) ÷ Initial Investment **Typical Margins**:
- Safe routes, common goods: 20-50%
- Moderate routes, quality goods: 50-150%
- Dangerous routes, luxury goods: 150-500%
- Extreme routes, contraband: 500-2000% (with massive risk) ## Player-Facing Summary The Trade Goods Catalog represents the lifeblood of inter-realm commerce, encompassing everything from essential commodities to exotic luxuries, from legal merchandise to dangerous contraband. Understanding these goods, their values, and the forces that control their flow provides the key to success in the complex world of cross-realm trade. ## Lore Details Merchant legends speak of the Perfect Inventory, a mythical collection containing one example of every trade good that has ever existed or ever could exist. Some say this cosmic warehouse exists somewhere between the realms, accessible only to those who have achieved perfect understanding of the true nature of value and exchange. Ancient trade records describe goods that seem to violate natural laws: weapons that become sharper with use, textiles that adapt to their wearer's needs, and foods that provide perfect nutrition regardless of quantity. These legendary items reportedly appear in markets during times of great need, but always at prices that test the moral boundaries of those who would purchase them. Deep-sea merchants tell stories of cargo that carries memories of everyone who has ever owned it, allowing skilled traders to read the emotional and historical significance of items simply by handling them. This psychometric commerce supposedly allows for more accurate pricing and authentication, but also creates ethical dilemmas about privacy and the ownership of experiences. ## DM Notes Use the trade goods catalog as more than just a price list - make it a living system that responds to campaign events and drives plot development. Price changes can reflect larger political and economic developments, while the search for specific goods can motivate adventures and character decisions. Consider how the complex web of legitimate and criminal commerce creates moral ambiguity for characters. The same trade route might carry both essential medicines and illegal weapons, forcing characters to make difficult choices about which aspects of commerce to support or oppose. The economic complexity allows for sophisticated plots involving market manipulation, supply chain disruption, and the far-reaching consequences of seemingly simple commercial decisions. Use trade goods as a way to connect distant events and demonstrate how individual character actions can have widespread economic and social impacts. ## Related *Links to related content will be added here.* ## Prophecy Connection Mentioned in The Second Prophecy of Stars ## 12_Research Specific Content Contextual improvement based on 12_Research ## 12_Research Specific Content Contextual improvement based on 12_Research
