...
- **Breathing Apparatus Required**: Without magical assistance, creatures drown in `dice: `dice: 1d4`` rounds
...
args: ["`dice: `dice: 1d20``"]```**Memory Echo Results**`dice: `dice: `dice: 1d20```:
...
- **Lightning Barrage**: Random lightning strikes deal `dice: `dice: 3d10`` damage
...
- **Gravity Wells**: Gravity direction shifts every `dice: `dice: 1d6`` minutes **Void Exposure**:
...
- **Sacrifice vs. Selfishness**: Understanding when personal sacrifice serves the greater good --- ### Environmental Hazard Generation`dice: `dice: `dice: 1d12```| d12 | Hazard Type |
...
| 11-12 | Social (politics, witnesses, complications) | ### Discovery Complications`dice: `dice: `dice: 1d20```| d20 | Complication |
...
| 19-20 | Location begins to collapse/phase out | ### Shard Resoce Effects`dice: `dice: `dice: 1d8```| d8 | Effect |
...
| 7-8 | Reality becomes unstable for `dice: `dice: 1d6`` rounds | --- ### Environmental Challenge Tracker```meta-bind
