...
## Quest Giver
**Ivan Darkwater** - Religious leader
...
## Key Locations
- **FortHill** (City): Key location for quest progression
- **PortHill** (Dungeon): Key location for quest progression
- **NorthVale** (Wilderness): Key location for quest progression
- **Bridgeridge** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Cultists** led by Ivan Shadowmere
...
- **Gold**: 2,110 gp
- **Experience**: 3,000 XP
- **Magic Items**: Ancient Pendant of Power
- **Other**: Noble title
