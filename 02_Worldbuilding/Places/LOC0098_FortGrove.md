...
**Atmosphere**: Quiet atmosphere hiding secrets in every shadow
...
## Important NPCs
- **Nathaniel Ravencrest the Just** - Merchant: Key figure in local affairs
- **Ophelia Ravencrest** - Priest: Key figure in local affairs
