...
- **Merchant Background**: `dice: 3d4` × 10 gp in mixed currencies plus business contacts
- **Noble Background**: `dice: 5d4` × 10 gp plus family credit line (1,000 gp)
- **Criminal Background**: `dice: 2d4` × 10 gp plus access to black market currencies
- **Guild Artisan**: `dice: 2d4` × 10 gp plus guild credit (500 gp)
