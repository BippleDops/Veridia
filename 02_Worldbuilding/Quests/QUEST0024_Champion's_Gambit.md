...
*Fetch Quest for levels 2-6*

**ID**: QUEST0024

## Quest Giver
**Yorick Goldleaf** - Powerful merchant
...
## Key Locations
- **Hillford** (City): Key location for quest progression
- **LowerWatch** (Dungeon): Key location for quest progression
- **OldWatch** (Wilderness): Key location for quest progression
- **NewWatch** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Cultists** led by Yorick Brightblade
...
- **Gold**: 1,408 gp
- **Experience**: 2,000 XP
- **Magic Items**: Ancient Orb of Power
- **Other**: Noble title
