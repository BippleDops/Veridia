...
*Escort Quest for levels 1-5*

**ID**: QUEST0002

## Quest Giver
**Cedric Goldleaf** - Religious leader
...
## Key Locations
- **EastHaven** (City): Key location for quest progression
- **WestHaven** (Dungeon): Key location for quest progression
- **UpperHaven** (Wilderness): Key location for quest progression
- **Valeton** (Temple): Key location for quest progression

## Opposition
### Enemies
- **Undead** led by Cedric Brightblade
