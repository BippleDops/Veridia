...
*Source: Dungeon Master's Guide (2024) p. 139* **Adventure Connections**`dice: [](linking-adventures-adventure-connections-xdmg.md#^adventure-connections)`| dice: 1d6 | Adventure Connection |
|-----------|----------------------|
