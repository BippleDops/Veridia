...
# Candlekeep Mysteries - Integration Index
...
## Description
Collection of book-based mystery adventures
...
TABLE WITHOUT ID
    ...
    cr as "CR",
    status as "Status"
FROM "Candlekeep_Mysteries/Monsters"  
WHERE type = "Monster"
SORT cr
```
...
TABLE WITHOUT ID
    ...
    status as "Status" 
FROM "Candlekeep_Mysteries/Adventures"
