...
created: '2025-01-15'
modified: '2025-01-15'
aliases: ["Quick Reference and Handouts"]
status: active
priority: normal
...
*Essential Tables, References, and Player Materials* > [!info] How to Use This Document
...
> - **5e Integration**: References to official sources and compatible mechanics ### Shard Effects Summary | Shard | Primary Effect | Corruption Sign | Mechanical Benefit | Curse Risk |
...
| **Unity** | Collective consciousness | Individual fade | Shared abilities | Loss of self | ### Corruption Progression Quick Guide | Level | Symptoms | Mechanical Effect | Treatment DC |
...
| **8+** | Complete corruption | Character becomes NPC | 25+ | ### Environmental Challenge DCs | Environment | Easy | Medium | Hard | Deadly |

|-------------|------|--------|------|--------|
| **Aquabyssos Depths** | 10 | 13 | 16 | 20 |
| **Aethermoor Heights** | 12 | 15 | 18 | 22 |
| **Shard Proximity** | 15 | 18 | 21 | 25 |
| **Reality Distortion** | 18 | 21 | 24 | 27 | ### NPC Reaction Guide | Relationship | DC | Typical Response | Special Modifiers |
...
| **Allied** | 8-9 | Devoted support | -5 if personally invested | ### Session Pacing Guide | Session Type | Scenes | Combat | Social | Exploration |

|--------------|--------|--------|--------|-------------|
| **Action-Heavy** | 3-4 | 60% | 20% | 20% |
| **Balanced** | 4-5 | 40% | 30% | 30% |
| **Investigation** | 5-6 | 20% | 40% | 40% |
| **Social Drama** | 3-4 | 10% | 70% | 20% | ### Random Shard Manifestations`dice: `dice: 1d20``| d20 | Manifestation | Effect Duration | Mechanical Impact |

|-----|---------------|----------------|-------------------|
| 1 | Gravity fluctuation | `dice: 1d4` rounds | Flying speed 30 ft or fall prone |
| 2 | Memory echo | 1 minute | See past events in location |
| 3 | Crystal growth | Permanent | Difficult terrain in 20 ft radius |
| 4 | Storm burst | `dice: 1d6` rounds | Lightning damage, wind effects |
| 5 | Shadow multiplication | 10 minutes | Everyone has visible shadow duplicate |
| 6 | Reality overlap | `dice: 1d4` minutes | See/interact with other world |
| 7 | Life surge | 1 hour | All creatures regain max HP |
| 8 | Unity field | `dice: 1d10` minutes | Telepathic communication within 60 ft |
| 9 | Time distortion | Variable | Initiative order reverses |
| 10 | Emotional amplification | 1 hour | All emotions doubled in intensity |
| 11 | Matter phase shift | `dice: 1d4` rounds | Objects become incorporeal |
| 12 | Sensory enhancement | 1 hour | All senses doubled in range |
| 13 | Magic amplification | `dice: 1d6` rounds | All spells cast at +1 level |
| 14 | Corruption wave | Instant | All present make corruption saves |
| 15 | Dimensional echo | 1 minute | Parallel selves briefly visible |
| 16 | Energy drain | `dice: 1d4` hours | All creatures exhausted |
| 17 | Reality anchor | 1 day | Magic functions perfectly |
| 18 | Consciousness link | 1 hour | Surface thoughts shared |
| 19 | Environmental shift | `dice: 1d6` hours | Weather/atmosphere changes |
| 20 | Shard resoce | Special | All nearby shards activate | ### NPC Complications`dice: `dice: 1d12``| d12 | Complication | Resolution Method | Story Impact |
...
| 12 | Future vision | Interpretation | Prophecy/Warnings | ### Quick Encounter Hooks`dice: `dice: 1d10``| d10 | Hook | Setting | Complexity |
...
| 10 | Multiple complications at once | Any | Very Complex | ### Weather and Environmental Effects`dice: `dice: 1d8``| d8 | Effect | Duration | Impact |

|----|--------|----------|--------|
| 1 | Pressure storm | `dice: 2d6` hours | Constitution saves every hour |
| 2 | Memory fog | `dice: 1d4` hours | Wisdom saves to maintain identity |
| 3 | Crystal rain | `dice: 1d6` hours | Corruption saves for extended exposure |
| 4 | Wind shear | `dice: 1d8` hours | Flying becomes dangerous |
| 5 | Shadow eclipse | `dice: 1d4` hours | Light sources dimmed, stealth enhanced |
| 6 | Void pockets | `dice: 1d6` hours | Random teleportation effects |
| 7 | Life bloom | `dice: 1d12` hours | Accelerated healing but exhaustion |
| 8 | Unity aurora | `dice: 1d6` hours | Enhanced cooperation but identity blur | ### Investigation Clues Generator`dice: `dice: 1d16``| d16 | Clue Type | Information Revealed | Discovery Method |
...
| 16 | Dimensional echoes | Other-world influences | Religion | ### Handout 1: World Primer for Players > [!note] The Twin Realms of Cordelia
...
> **Aethermoor** - The Sky Kingdom > - Floating cities and mountain peaks above the clouds
...
> - Emergency crossings during crises ### Handout 2: The Seven Shards - What Players Know Initially > [!note] Ancient Legends of Power
...
> Most scholars dismiss these as mythology, but recent strange events have some wondering if the legends might be true... ### Handout 3: Faction Overview for Players > [!note] Major Powers and Organizations
...
> - **Memory Keepers**: Historians with hidden knowledge ### Handout 4: Signs of Shard Corruption > [!warning] Warning Signs of Supernatural Influence
...
> *If you observe these symptoms in yourself or others, seek immediate medical attention.* ### Handout 5: Cross-Realm Travel Guide > [!note] Essential Information for Inter-Dimensional Travelers
...
> - Items that could affect dimensional stability ### Handout 6: Economic Exchange Rates > [!note] Current Exchange Rates (Updated Weekly)
...
> *Note: Prices fluctuate based on availability, quality, and political situation* #### Aquabyssos Names`dice: `dice: 1d20``| d20 | Male | Female | Family |
...
| 16-20 | Maelstrom, Benthic, Pelagic | Thalassa, Nerida, Oceania | Voidcaller, Crystalward, Shadowmere | #### Aethermoor Names`dice: `dice: 1d20``| 1-5 | Thalassius, Storm, Wind, Sky, Gale | Lyralei, Tempest, Aurora, Zephyr | Windweaver, Stormbreaker, Skywright |
...
| 16-20 | Tornado, Hurricane, Typhoon | Ventus, Aeria, Altus, Stella | Stormcaller, Windrider, Crystalwind | ### Quick NPCs`dice: `dice: 1d12``| d12 | Role | Motivation | Secret | Quirk |
...
| 12 | Mystic | Understanding | Manipulated by shard | Sees things others can't | ### Treasure Value Quick Reference | Item Type | Mundane | Uncommon | Rare | Very Rare | Legendary |
...
| **Consumable** | 1-50 gp | 51-250 gp | 251-2,500 gp | 2,501-25,000 gp | 25,001+ gp | ### Dice Roller Quick Commands```dice-roller

dice: `dice: 1d20`+0

Quick d20 roll for saves, checks, and attacks```dice: `dice: 4d6`dl1

Ability score generation (drop lowest) dice: `dice: 1d100`

Percentile roll for special events dice: `dice: 1d4`+1, `dice: 1d6`+2, `dice: 1d8`+3, `dice: 1d10`+4, `dice: 1d12`+5

Damage progression by spell level ### Meta-Bind Quick Buttons```meta-bind-button

label: Random Encounter
id: random-encounter
action: type: command command: dice-roller
args: ["`dice: 1d20`"] label: Weather Check
id: weather-check type: command args: ["`dice: 1d8`"] label: Corruption Save
id: corruption-save
args: ["`dice: 1d20`+5"] ### Dataview Quick Queries```dataview
...
LIMIT 5 TABLE relationship, corruption-level, last-seen

WHERE contains(tags, "npc") AND contains(tags, "important") ### Compatible Sourcebooks **Core Integration**:

- **Player's Handbook**: Base rules and character options
- **Dungeon Master's Guide**: Magic items, environmental hazards
- **Monster Manual**: Creature stats for reskinning **Enhanced Content**:
...
- **Fizban's Treasury of Dragons**: Lair actions, regional effects **Adventure Integration**:
- **Tomb of Annihilation**: Death curse mechanics for corruption
- **Curse of Strahd**: Horror atmosphere and NPC corruption
- **Out of the Abyss**: Sanity rules and reality distortion ### Adventure League Compliance **AL-Legal Alternatives**:
...
- Character options limited to AL-approved sources **Documentation Requirements**:
- Track all magic item rewards
- Note any temporary boons or supernatural gifts
- Record character advancement milestones
- Maintain session logs for continuity ### Encounter Balance Guidelines **Party Level Adjustments**:
...
- **Levels 13+**: Epic scope, reality-threatening consequences **Encounter Multipliers** (from DMG p. 82):
- Single enemy: x1
- Pair of enemies: x1.5
- Group of 3-6: x2
- Group of 7-10: x2.5
- Group of 11+: x3 --- ### Session Panic Tools When you need something immediately: 1. **NPC**: Roll on Quick NPCs table (d12)

2. **Complication**: Roll on NPC Complications (d12)
3. **Environment**: Roll on Weather Effects (d8)
4. **Hook**: Roll on Encounter Hooks (d10)
5. **Name**: Roll on appropriate name table (d20) ### One-Minute Encounters **Combat**: "Shard-corrupted [creature] attacks because [roll complication]"

**Social**: "[Random NPC] approaches with [roll motivation] but hides [roll secret]"
**Exploration**: "[Random manifestation] blocks progress and requires [skill check]" ### Campaign Save Points If campaign goes off rails, return to:

- Discovery of any new shard
- Major NPC relationship change
- Reality distortion event
- Faction political development
- Character corruption milestone --- ## 🔧 Deep Evaluation Improvements *20 targeted improvements identified* ### Connection Improvements - Add cross-references to related notes ### Enhancement Improvements - Add 12_Research-specific enhancement ## Related *Links to related content will be added here.* ## DM Notes *Private notes for campaign integration:*

- Can be adapted to fit current story needs
- Scalable threat/reward based on party level
- Multiple entry points for different play styles
- Connections to overarching campaign themes ## Prophecy Connection Mentioned in The First Prophecy of Shadows ## Plot Hooks - A map reveals the truth about the government
